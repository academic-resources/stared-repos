...
earlier adventurers. The only exit is to the south.""",
    ...
    "dungeon": Room(
        "Unlocked Creepy Dungeon",
        """You've found an unlocked prison cell where someone perished.""",
    ),
    "hall": Room(
        "Decrepit Royal Hall",
        """You've found a large hall that might have once held royal parties.""",
    ),
}
...
item = {
    ...
    "potion": Item(
        "potion", "life-giving serum of undetermined age in an old glass bottle."
    ),
}
