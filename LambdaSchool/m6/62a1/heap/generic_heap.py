class Heap:
    ...
    def _bubble_up(self, index):
        ...
        while index:
            # save parent
            p = parent(index)
            current_index_value, current_parent_value = (
                self.storage[index],
                self.storage[p],
            )
    ...
    def _sift_down(self, index):
        ...
        while True:
            ...
            value_child_right = (
                self.storage[index_child_right]
                if index_child_right < len(self.storage)
                else None
            )
            ...
            value_child_left = (
                self.storage[index_child_left]
                if index_child_left < len(self.storage)
                else None
            )
            ...
            # if both are NOT empty, do this stuff
                ...
                max_value_index = (
                    index_child_right
                    if self.comparator(value_child_right, value_child_left)
                    else index_child_left
                )
                max_value = (
                    value_child_right
                    if self.comparator(value_child_right, value_child_left)
                    else value_child_left
                )
            ...
            if self.comparator(max_value, current_value):
                # swap values
                self.storage[max_value_index], self.storage[index] = (
                    current_value,
                    max_value,
                )
