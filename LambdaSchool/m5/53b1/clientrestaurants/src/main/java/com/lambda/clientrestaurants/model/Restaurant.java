package com.lambda.clientrestaurants.model;
...
public class Restaurant extends Auditable
{
    ...
    {
        return "Restaurant{" + "restaurantid=" + restaurantid + ", name='" + name + '\'' + ", address='" + address + '\'' + ", city='" + city + '\'' + ", state='" + state + '\'' + ", ourEmail='" + ourEmail + '\'' + ", telephone='" + telephone + '\'' + ", restaurantPayments=" + restaurantPayments + ", menus=" + menus + '}' + "\n";
    }
}