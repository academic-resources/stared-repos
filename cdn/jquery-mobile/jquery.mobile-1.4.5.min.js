    ...
    !(function (a) {
        ...
        (function (a, b) {
            function d(b, c) {
                ...
                return "area" === h
                    ? ((d = b.parentNode),
                      (f = d.name),
                      b.href && f && "map" === d.nodeName.toLowerCase()
                          ? ((g = a("img[usemap=#" + f + "]")[0]), !!g && e(g))
                          : !1)
            ...
            (a.ui = a.ui || {}),
                ...
                (a.support.selectstart =
                    "onselectstart" in c.createElement("div")),
                a.fn.extend({
            ...
            var d = function (b, c) {
                var d = b.parent(),
                    ...
                    f = function () {
                        ...
                        return !(
                            "fixed" === c.position && c.updatePagePadding === !0
                        );
                    },
                ...
                return (
                    0 === h.length &&
                        g.length > 0 &&
                        (e = e.concat(g.toArray())),
                    0 === j.length &&
                        i.length > 0 &&
                        (e = e.concat(i.toArray())),
            ...
            a.extend(a.mobile, {
                ...
                removeActiveLinkClass: function (b) {
                    !a.mobile.activeClickedLink ||
                        (a.mobile.activeClickedLink.closest(
                            "." + a.mobile.activePageClass
                        ).length &&
                            !b) ||
                        a.mobile.activeClickedLink.removeClass(
                ...
                resetActivePageHeight: function (b) {
                    ...
                    (b = d(
                        c,
                        "number" == typeof b ? b : a.mobile.getScreenHeight()
                    )),
                        c.css("min-height", ""),
                        c.height() < b && c.css("min-height", b - (f - e));
                },
                loading: function () {
                    var b =
                            this.loading._widget ||
                            a(a.mobile.loader.prototype.defaultHtml).loader(),
                    ...
                    enhanceWithin: function () {
                        ...
                        a.mobile.nojs && a.mobile.nojs(this),
                            ...
                            a.mobile.degradeInputsWithin &&
                                a.mobile.degradeInputsWithin(this),
                            a.fn.buttonMarkup &&
                                this.find(a.fn.buttonMarkup.initSelector)
                                    .not(d)
                                    .jqmEnhanceable()
                                    .buttonMarkup(),
                            a.fn.fieldcontain &&
                            ...
                            a.each(a.mobile.widgets, function (b, f) {
                                if (f.initSelector) {
                                    var g = a.mobile.enhanceable(
                                        e.find(f.initSelector)
                                    );
                                    g.length > 0 && (g = g.not(d)),
                                        g.length > 0 &&
                                            (c[f.prototype.widgetName] = g);
                                }
                            });
                        for (b in c) c[b][b]();
                        return this;
                        ...
                        for (e in g[h])
                            (f = g[h][e]),
                                g[h].hasOwnProperty(e) &&
                                    f !== b &&
                                    (c[e] = a.isPlainObject(f)
                                        ? a.isPlainObject(c[e])
                                            ? a.widget.extend({}, c[e], f)
                                            : a.widget.extend({}, f)
                                        : f);
                    return c;
                }),
                (a.widget.bridge = function (c, e) {
                    ...
                    a.fn[c] = function (g) {
                        ...
                        return (
                            (g =
                                !h && i.length
                                    ? a.widget.extend.apply(null, [g].concat(i))
                                    : g),
                            this.each(
                                h
                                    ? function () {
                    ...
                    option: function (c, d) {
                        ...
                        if ("string" == typeof c)
                            if (
                                ...
                                for (
                                    f = h[c] =
                                        a.widget.extend({}, this.options[c]),
                                        g = 0;
                                    g < e.length - 1;
                                    g++
                                )
            ...
            a.extend(a.mobile, {
                ...
                getAttribute: function (b, c) {
                    ...
                    (b = b.jquery ? b[0] : b),
                        b &&
                            b.getAttribute &&
                            (d = b.getAttribute("data-" + a.mobile.ns + c));
                    try {
                        d =
                            "true" === d
                                ? !0
                ...
                _getCreateOptions: function () {
                    ...
                    if (!a.mobile.getAttribute(f, "defaults"))
                        for (d in this.options)
                            (e = a.mobile.getAttribute(f, d.replace(b, c))),
                                null != e && (g[d] = e);
                    return g;
                },
            }),
        ...
        (function (a) {
            ...
            a.widget("mobile.loader", {
                ...
                show: function (d, e, f) {
                    ...
                    this.resetHtml(),
                        "object" === a.type(d)
                            ? ((i = a.extend({}, this.options, d)),
                              (d = i.theme))
                            : ((i = this.options), (d = d || i.theme)),
                        (h = e || (i.text === !1 ? "" : i.text)),
                        ...
                        this.element.attr(
                            ...
                            b +
                                ...
                                d +
                                " ui-loader-" +
                                (g || e || d.text ? "verbose" : "default") +
                                (i.textonly || f ? " ui-loader-textonly" : "")
                        ),
                        i.html
                            ? this.element.html(i.html)
                            : this.element.find("h1").text(h),
                        ...
                        this.window.bind(
                            "scroll",
                            a.proxy(this.checkLoaderPosition, this)
                        );
                },
                hide: function () {
                ...
                (f = (function () {
                    function c() {
                        var d = e(),
                            h = n(j);
                        d !== j
                            ? (m((j = d), h), a(b).trigger(g))
                            : h !== j &&
                              (location.href =
                                  location.href.replace(/#.*/, "") + h),
        ...
        (function (a, d) {
            ...
            function h() {
                ...
                return (
                    e.length
                        ? (g = e.attr("href"))
                        : (e = f = a("<base>", { href: d }).appendTo("head")),
                    (b = a("<a href='testurl' />").prependTo(m)),
                    (c = b[0].href),
            ...
            function k() {
                ...
                return ((d.indexOf("iPhone") > -1 ||
                    ...
                    (a.operamini &&
                        "[object OperaMini]" ===
                            {}.toString.call(a.operamini)) ||
                    (i && 7458 > j) ||
                    (c.indexOf("Android") > -1 && f && 533 > f) ||
                    (h && 6 > h) ||
                    ("palmGetResource" in b && f && 534 > f) ||
                    (c.indexOf("MeeGo") > -1 &&
                        c.indexOf("NokiaBrowser/8.5.0") > -1)
                    ? !1
                    : !0;
            }
            var l,
            ...
            a.extend(a.mobile, { browser: {} }),
                ...
                a.extend(a.support, {
                    pushState:
                        ...
                        !(
                            b.navigator.userAgent.indexOf("Firefox") >= 0 &&
                            b.top !== b
                        ) &&
                ...
                (l = (function () {
                    ...
                    return (
                        a.indexOf("Nokia") > -1 &&
                        (a.indexOf("Symbian/3") > -1 ||
                            a.indexOf("Series60/5") > -1) &&
                    ...
                    return (
                        ((a.support.mediaquery && a.support.cssPseudoElement) ||
                            (a.mobile.browser.oldIE &&
                                a.mobile.browser.oldIE >= 8)) &&
                        (a.support.boundingRect ||
                            null !== a.fn.jquery.match(/1\.[0-7+]\.[0-9+]?/))
                    );
                }),
                (a.mobile.ajaxBlacklist =
                    (b.blackberry && !b.WebKitPoint) || q || l),
                l &&
                    a(function () {
                ...
                (a.event.special.navigate = c =
                    {
                        ...
                        setup: function () {
                            c.bound ||
                                ((c.bound = !0),
                                c.isPushStateEnabled()
                                    ? ((c.originalEventName = "popstate"),
                                      d.bind("popstate.navigate", c.popstate))
                                    : c.isHashChangeEnabled() &&
                                      ((c.originalEventName = "hashchange"),
                                      d.bind(
                                          "hashchange.navigate",
                                          c.hashchange
                                      )));
            ...
            (a.mobile.path = d =
                {
                    ...
                    isSameDomain: function (a, b) {
                        return (
                            d.parseUrl(a).domain.toLowerCase() ===
                            d.parseUrl(b).domain.toLowerCase()
                        );
                    },
                    ...
                    makeUrlAbsolute: function (a, b) {
                        ...
                        var e = d.parseUrl(a),
                            ...
                            h = e.protocol
                                ? e.doubleSlash
                                : e.doubleSlash || f.doubleSlash,
                            i = e.authority || f.authority,
                            j = "" !== e.pathname,
                            k = d.makePathAbsolute(
                                e.pathname || f.filename,
                                f.pathname
                            ),
                        ...
                        return (
                            d.isEmbeddedPage(e)
                                ? (c = e.hash
                                      ...
                                      .replace(/^#/, "")
                                      .replace(/\?.*$/, ""))
                                : d.isSameDomain(e, this.documentBase) &&
                                  (c = e.hrefNoHash
                    ...
                    get: function (a) {
                        return (
                            a === c && (a = d.parseLocation().hash),
                            d.stripHash(a).replace(/[^\/]*\.[^\/*]+$/, "")
                        );
                    },
                    set: function (a) {
                        location.hash = a;
                    ...
                    squash: function (a, b) {
                        ...
                        return (
                            b ||
                                (i
                                    ? (b = d.getLocation())
                                    : ((h = d.getDocumentUrl(!0)),
                                      (b = d.isPath(h.hash)
                                          ? d.squash(h.href)
                                          : h.href))),
                            (e = i ? d.stripHash(a) : a),
                            (e = d.isPath(j.hash) ? d.stripHash(j.hash) : e),
                            (g = e.indexOf(this.uiStateKey)),
                            g > -1 && ((l = e.slice(g)), (e = e.slice(0, g))),
                            (c = d.makeUrlAbsolute(e, b)),
                            (f = this.parseUrl(c).search),
                            i
                                ? ((d.isPath(k) ||
                                      0 ===
                                          k
                    ...
                    isPreservableHash: function (a) {
                        return (
                            0 === a.replace("#", "").indexOf(this.uiStateKey)
                        );
                    },
                    ...
                    isFirstPageUrl: function (b) {
                        var e = d.parseUrl(
                                d.makeUrlAbsolute(b, this.documentBase)
                            ),
                            f =
                ...
                (e = a("head").find("base")),
                (d.documentBase = e.length
                    ? d.parseUrl(
                          d.makeUrlAbsolute(e.attr("href"), d.documentUrl.href)
                      )
                    : d.documentUrl),
                (d.documentBaseDiffers =
                    d.documentUrl.hrefNoHash !== d.documentBase.hrefNoHash),
                (d.getDocumentBase = function (b) {
                    return b
                        ? a.extend({}, d.documentBase)
                        : d.documentBase.href;
                }),
                a.extend(a.mobile, {
                ...
                a.extend(a.mobile.History.prototype, {
                    ...
                    closest: function (a) {
                        var c,
                            d = this.activeIndex;
                        return (
                            (c = this.find(a, this.stack.slice(0, d))),
                            c === b &&
                                ((c = this.find(a, this.stack.slice(d), !0)),
                                (c = c === b ? c : c + d)),
                            c
                        );
                    },
                    direct: function (c) {
                        var d = this.closest(c.url),
                            e = this.activeIndex;
                        d !== b &&
                            ((this.activeIndex = d), (this.previousIndex = e)),
                            e > d
                                ? (c.present || c.back || a.noop)(
                                      this.getActive(),
                                      "back"
                                  )
                                : d > e
                                ? (c.present || c.forward || a.noop)(
                                      this.getActive(),
                                      "forward"
                                  )
                                : d === b &&
                                  c.missing &&
                                  c.missing(this.getActive());
                    },
                });
        })(a),
        (function (a) {
            ...
            (a.mobile.Navigator = function (b) {
                ...
                a.extend(a.mobile.Navigator.prototype, {
                    squash: function (e, f) {
                        ...
                        return (
                            (h = d.squash(e)),
                            (g = a.extend({ hash: i, url: h }, f)),
                            b.history.replaceState(g, g.title || c.title, h),
                            g
                        );
                    },
                    hash: function (a, b) {
        ...
        (function (a, b) {
            ...
            a.each(["animation", "transition"], function (c, g) {
                ...
                a.each(f, function (c, f) {
                    ...
                    (d[g].duration = a.camelCase(
                        d[g].prefix + g + "-duration"
                    )),
                    (d[g].event = a.camelCase(d[g].prefix + g + "-end")),
                    "" === d[g].prefix &&
                        (d[g].event = d[g].event.toLowerCase());
            }),
                (a.support.cssTransitions = d.transition.prefix !== b),
                (a.support.cssAnimations = d.animation.prefix !== b),
                a(e).remove(),
                (a.fn.animationComplete = function (e, f, g) {
                    var h,
                        i,
                        j = this,
                        k = function () {
                    ...
                    return (a.support.cssTransitions && "transition" === l) ||
                        (a.support.cssAnimations && "animation" === l)
                        ? (g === b &&
                              (a(this).context !== c &&
                                  (i =
                                      3e3 *
                                      parseFloat(a(this).css(d[l].duration))),
                              (0 === i || i === b || isNaN(i)) &&
                                  (i = a.fn.animationComplete.defaultDuration)),
                          (h = setTimeout(function () {
                              a(j).off(d[l].event, k), e.apply(j);
                          }, i)),
                          a(this).one(d[l].event, k))
        ...
        (function (a, b, c, d) {
            ...
            function f(b, c) {
                ...
                if (
                    (o.search(/mouse(down|up)|click/) > -1 &&
                        !b.which &&
                        (b.which = 1),
                    -1 !== o.search(/^touch/) &&
                        ((h = e(f)),
            ...
            function o(b, c, d) {
                var e;
                return (
                    ((d && d[b]) || (!d && h(c.target, b))) &&
                        ((e = f(c, b)), a(c.target).trigger(e)),
                    e
                );
            }
            function p(b) {
            ...
            function s(b) {
                if (!M) {
                    ...
                    (J =
                        J ||
                        Math.abs(c.pageX - H) > f ||
                        Math.abs(c.pageY - I) > f),
                ...
                (a.event.special.swipe = {
                    ...
                    getLocation: function (a) {
                        ...
                        return (
                            ...
                            (0 === a.pageX &&
                                Math.floor(e) > Math.floor(a.pageX))
                                ? ((e -= c), (f -= d))
                                ...
                                if (!a.event.special.swipe.eventInProgress) {
                                    ...
                                    (e.move = function (b) {
                                        g &&
                                            !b.isDefaultPrevented() &&
                                            ((d =
                                                a.event.special.swipe.stop(b)),
                                            i ||
                                                ((i =
                                                    a.event.special.swipe.handleSwipe(
                                                        g,
                                                        d,
                                                        c,
                                                        h
                    ...
                    teardown: function () {
                        ...
                        (b = a.data(this, "mobile-events")),
                            b &&
                                ...
                                b.length--,
                                0 === b.length &&
                                    a.removeData(this, "mobile-events")),
                            c &&
                                (c.start && a(this).off(i, c.start),
                                c.move && f.off(k, c.move),
                                c.stop && f.off(j, c.stop));
                    },
                }),
                a.each(
                    {
            ...
            var b,
                ...
                f = function () {
                    (c = new Date().getTime()),
                        (d = c - g),
                        d >= e
                            ? ((g = c), a(this).trigger("throttledresize"))
                            : (b && clearTimeout(b),
                              (b = setTimeout(f, e - d)));
                },
                g = 0;
        ...
        (function (a) {
            var b = a("head").children("base"),
                c = {
                    ...
                    set: function (b) {
                        a.mobile.dynamicBaseEnabled &&
                            a.support.dynamicBaseTag &&
                            c.element.attr(
                                "href",
                                a.mobile.path.makeUrlAbsolute(
                                    b,
                                    a.mobile.path.documentBase
                                )
                            );
                    },
                    rewrite: function (b, d) {
                        ...
                        d.find(c.linkSelector).each(function (b, c) {
                            ...
                            (g = g.replace(
                                ...
                                /^(\w+:|#|\/)/.test(g) || a(c).attr(d, e + g);
                        });
                    },
                    reset: function () {
                        c.element.attr(
                            "href",
                            a.mobile.path.documentBase.hrefNoSearch
                        );
                    },
                };
            a.mobile.base = c;
        ...
        (function (a, b) {
            ...
            (a.widget = (function (c) {
                return function () {
                    ...
                    return (
                        (d.initSelector =
                            d.prototype.initSelector !== b
                                ? d.prototype.initSelector
                                : ":jqmData(role='" + e + "')"),
                ...
                a.extend(a.widget, c),
                a.mobile.document.on("create", function (b) {
                ...
                a.widget("mobile.page", {
                        ...
                        this.options.role &&
                            ...
                            this.element
                                ...
                                .each(function () {
                                    ...
                                    (d.options.contentTheme =
                                        f ||
                                        d.options.contentTheme ||
                                        (d.options.dialog && d.options.theme) ||
                                        ("dialog" ===
                                            d.element.jqmData("role") &&
                                            d.options.theme)),
                    ...
                    _setOptions: function (c) {
                        c.theme !== b &&
                            this.element
                                ...
                                .addClass("ui-page-theme-" + c.theme),
                            c.contentTheme !== b &&
                                this.element
                                    .find(
                                        "[data-" + a.mobile.ns + "='content']"
                                    )
                                    .removeClass(
                    ...
                    setContainerBackground: function (a) {
                        this.element
                            .parent()
                            .pagecontainer({ theme: a || this.options.theme });
                    },
            ...
            a.widget("mobile.pagecontainer", {
                ...
                _recordScroll: function () {
                    if (this.setLastScrollEnabled) {
                        ...
                        d &&
                            ...
                            (c = this._getDefaultScroll()),
                            (d.lastScroll = b > a ? c : a));
                    }
                },
                ...
                _handleNavigate: function (b, c) {
                    var d = a.mobile.path.stripHash(b),
                        ...
                        f =
                            0 === e.stack.length
                                ? "none"
                                : this._transitionFromHistory(c.direction),
                        g = {
                            changeHash: !1,
                            fromHashChange: !0,
                            reverse: "back" === c.direction,
                        };
                    a.extend(g, c, { transition: f }),
                        (e.activeIndex > 0 &&
                            d.indexOf(a.mobile.dialogHashKey) > -1 &&
                            ((d = this._handleDialog(g, c)), d === !1)) ||
                            this._changeContent(this._handleDestination(d), g);
                },
                    ...
                    return (
                        ...
                        d
                            .attr(
                                ...
                                this._createDataUrl(c)
                            )
                            .attr(
                                "data-" + this._getNs() + "external-page",
                                !0
                            ),
                        d
                    );
                ...
                load: function (b, c) {
                    var e,
                        ...
                        j =
                            c && c.reload === d && c.reloadPage !== d
                                ? { reload: c.reloadPage }
                                : {},
                        k = a.extend({}, this._loadDefaults, c, j),
                        l = null,
                        m = a.mobile.path.makeUrlAbsolute(
                            b,
                    ...
                    return (
                        k.data &&
                            "get" === k.type &&
                            ((m = a.mobile.path.addSearchParams(m, k.data)),
                            (k.data = d)),
                        k.data && "post" === k.type && (k.reload = !0),
                        (e = this._createFileUrl(m)),
                        (f = this._createDataUrl(m)),
                        (l = this._find(m)),
                        0 === l.length &&
                        a.mobile.path.isEmbeddedPage(e) &&
                        !a.mobile.path.isFirstPageUrl(e)
                            ? (i.reject(m, k), i.promise())
                            : (this._getBase().reset(),
                              l.length && !k.reload
                                  ? (this._enhance(l, k.role),
                                    i.resolve(m, k, l),
                                    k.prefetch || this._getBase().set(b),
                                    i.promise())
                                  : ((h = {
                                        url: b,
                                        absUrl: m,
                ...
                _releaseTransitionLock: function () {
                    (f = !1),
                        e.length > 0 &&
                            a.mobile.changePage.apply(null, e.pop());
                },
                ...
                transition: function (b, g, h) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            (j =
                                (h.dataUrl &&
                                    a.mobile.path.convertUrlToDataUrl(
                                        h.dataUrl
                                    )) ||
                                b.jqmData("url")),
                            (k = j),
                        ...
                        (r = !1),
                            q &&
                                m &&
                                (m.url &&
                                    m.url.indexOf(a.mobile.dialogHashKey) >
                                        -1 &&
                                    this.activePage &&
                            ...
                            !o &&
                                r &&
                                (a.mobile.navigate.history.getActive().pageUrl =
                                    k),
                            j &&
                                !h.fromHashChange &&
                ...
                _findBaseWithDefault: function () {
                    var b =
                        this.activePage &&
                        a.mobile.getClosestBaseUrl(this.activePage);
        ...
        (function (a, d) {
            ...
            (a.mobile.loadPage = function (b, c) {
                ...
                return (
                    (c = c || {}),
                    (d = c.pageContainer || a.mobile.pageContainer),
                    (c.deferred = a.Deferred()),
                    d.pagecontainer("load", b, c),
                    c.deferred.promise()
                );
            }),
                (a.mobile.back = function () {
                    ...
                    c.app.backHistory
                        ? c.app.backHistory()
                        : a.mobile.pageContainer.pagecontainer("back");
                }),
                ...
                (a.mobile._registerInternalEvents = function () {
                        ...
                        return !a.mobile.ajaxEnabled ||
                            ...
                            : ((d =
                              ...
                              d ||
                                  ...
                                  "get" === g &&
                                      (d =
                                          a.mobile.path.parseUrl(
                                              d
                                          ).hrefNoSearch),
                                  d === a.mobile.path.documentBase.hrefNoHash &&
                                      (d = i.hrefNoSearch)),
                              (d = a.mobile.path.makeUrlAbsolute(
                                  d,
                                  a.mobile.getClosestBaseUrl(b)
                              )),
                              a.mobile.path.isExternal(d) &&
                              !a.mobile.path.isPermittedCrossDomainRequest(i, d)
                                  ? !1
                                  : (c ||
                                        ((e = b.serializeArray()),
                                        j &&
                    ...
                    a.mobile.document.delegate("form", "submit", function (b) {
                        ...
                        b.isDefaultPrevented() ||
                            ((d = c(a(this))),
                            d &&
                                (a.mobile.changePage(d.url, d.options),
                                b.preventDefault()));
                    }),
                            ...
                            if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                                ...
                                ~g.className.indexOf("ui-link-inherit")
                                    ...
                                    d.length > 0 &&
                                        ...
                                        a.mobile.activeClickedLink.addClass(
                                            a.mobile.activeBtnClass
                                        ));
                            }
                        }),
                        a.mobile.document.bind("click", function (c) {
                            if (
                                ...
                                if (
                                    (a.mobile.activeClickedLink &&
                                        a.mobile.activeClickedLink[0] ===
                                            c.target.parentNode &&
                                        p(),
                                    n &&
                                        !(c.which > 1) &&
                                        o.jqmHijackable().length)
                                ) {
                                    if (o.is(":jqmData(rel='back')"))
                                        return a.mobile.back(), !1;
                                    if (
                                        ((f = a.mobile.getClosestBaseUrl(o)),
                                        (g = a.mobile.path.makeUrlAbsolute(
                                            o.attr("href") || "#",
                                            f
                                        )),
                                        !a.mobile.ajaxEnabled &&
                                            !a.mobile.path.isEmbeddedPage(g))
                                    )
                                        return void p();
                                    if (
                                        !(
                                            -1 === g.search("#") ||
                                            (a.mobile.path.isExternal(g) &&
                                                a.mobile.path.isAbsoluteUrl(g))
                                        )
                                    ) {
                                        if (((g = g.replace(/[^#]*#/, "")), !g))
                                            return void c.preventDefault();
                                        g = a.mobile.path.isPath(g)
                                            ? a.mobile.path.makeUrlAbsolute(
                                                  g,
                                                  f
                                              )
                                    ...
                                    if (
                                        ((h =
                                            o.is("[rel='external']") ||
                                            o.is(":jqmData(ajax='false')") ||
                                            o.is("[target]")),
                                        (j =
                                            h ||
                                            (a.mobile.path.isExternal(g) &&
                                                !a.mobile.path.isPermittedCrossDomainRequest(
                                                    i,
                                                    g
                                                ))))
                                    )
                ...
                "complete" === c.readyState ? h() : a.mobile.window.load(h),
            ...
            (a.mobile.Transition = function () {
                ...
                a.extend(a.mobile.Transition.prototype, {
                    ...
                    doneIn: function () {
                        this.beforeDoneIn(),
                            this.$to
                                .removeClass("out in reverse " + this.name)
                                .height(""),
                    ...
                    startIn: function (b, c, d, e) {
                        this.hideIn(function () {
                            this.$to.addClass(
                                a.mobile.activePageClass + this.toPreClass
                            ),
                    ...
                    transition: function () {
                        ...
                        return (
                            ...
                            (b =
                                ...
                                "none" === this.name ||
                                Math.max(
                                    a.mobile.window.scrollTop(),
                                    this.toScroll
                                ) > a.mobile.getMaxScrollForTransition()),
                            this.toggleViewportClass(),
                            this.$from && !b
                                ? this.startOut(d, c, b)
                                : this.doneOut(d, c, b, !0),
        ...
        (function (a) {
            ...
            (a.mobile.transitionHandlers = {
                ...
                (a.mobile.getMaxScrollForTransition =
                    a.mobile.getMaxScrollForTransition || b);
        })(a),
        (function (a) {
                    ...
                    (b = a(b)),
                        b
                            ...
                            .each(function () {
                                ...
                                a.mobile.degradeInputs[g] &&
                                    ((b = a("<div>").html(f.clone()).html()),
                                    (c = b.indexOf(" type=") > -1),
                                    (d = c ? /\s+type=["']?\w+['"]?/ : /\/?>/),
                                    (e =
                                        ' type="' +
            ...
            a.widget("mobile.page", a.mobile.page, {
                ...
                _setOptions: function (b) {
                    var d,
                        ...
                        f = this.options;
                    b.corners !== c &&
                        this._inner.toggleClass("ui-corner-all", !!b.corners),
                        b.overlayTheme !== c &&
                            a.mobile.activePage[0] === this.element[0] &&
                            ((f.overlayTheme = b.overlayTheme),
                            this._handlePageBeforeShow()),
                        b.closeBtnText !== c &&
                            ((d = f.closeBtn), (e = b.closeBtnText)),
                        b.closeBtn !== c && (d = b.closeBtn),
                        d && this._setCloseBtn(d, e),
                        this._super(b);
                },
                _handlePageBeforeShow: function () {
        ...
        (function (a, b, c) {
            a.widget("mobile.dialog", {
                ...
                _handleVClickSubmit: function (b) {
                    var c,
                        d = a(b.target).closest(
                            "vclick" === b.type ? "a" : "form"
                        );
                    d.length &&
                        !d.jqmData("transition") &&
                        ((c = {}),
                        (c["data-" + a.mobile.ns + "transition"] =
                            (a.mobile.navigate.history.getActive() || {})
                                .transition ||
                            a.mobile.defaultDialogTransition),
                        (c["data-" + a.mobile.ns + "direction"] = "reverse"),
                        d.attr(c));
                },
                _create: function () {
                    var b = this.element,
                ...
                close: function () {
                    ...
                    this._isCloseable &&
                        ((this._isCloseable = !1),
                        a.mobile.hashListeningEnabled && b.activeIndex > 0
                            ? a.mobile.back()
                            : a.mobile.pageContainer.pagecontainer("back"));
                },
            });
            ...
            a.widget("mobile.collapsible", {
                ...
                _getOptions: function (b) {
                    ...
                    (b = a.extend({}, b)),
                        e.length &&
                            !f &&
                            (this._ui.accordionWidget = f =
                                e.data("mobile-collapsibleset"));
                    for (d in b)
                        (b[d] =
                            null != b[d]
                                ? b[d]
                                ...
                                ? a.mobile.getAttribute(
                                      e[0],
                                      d.replace(c, "-$1").toLowerCase()
                                  )
                                : null),
                            null == b[d] &&
                                (b[d] = a.mobile.collapsible.defaults[d]);
                    return b;
                },
                ...
                _enhance: function (b, c) {
                    ...
                    return (
                        b.addClass(
                            "ui-collapsible " +
                                (f.inset ? "ui-collapsible-inset " : "") +
                                (f.inset && f.corners ? "ui-corner-all " : "") +
                        ...
                        (e = f.collapsed
                            ? f.collapsedIcon
                                ? "ui-icon-" + f.collapsedIcon
                                : ""
                            : f.expandedIcon
                            ? "ui-icon-" + f.expandedIcon
                            : ""),
                        (c.status = a(
                ...
                _applyOptions: function (a) {
                    ...
                    a.collapsed !== b &&
                        ...
                        (c = i.hasClass("ui-collapsible-collapsed")),
                        c
                            ? n.expandCueText !== b && m.text(n.expandCueText)
                            : n.collapseCueText !== b &&
                              m.text(n.collapseCueText),
                        (h =
                            n.collapsedIcon !== b
                                ? n.collapsedIcon !== !1
                                : j.collapsedIcon !== !1),
                        ...
                        n.theme !== b &&
                            ...
                            (e = this._themeClassFromOption(
                                "ui-btn-",
                                n.theme
                            )),
                            l.removeClass(f).addClass(e)),
                        n.contentTheme !== b &&
                            ((f = this._themeClassFromOption(
                                "ui-body-",
                                j.contentTheme
                            ...
                            k.content.removeClass(f).addClass(e)),
                        n.inset !== b &&
                            (i.toggleClass("ui-collapsible-inset", n.inset),
                            (g = !(!n.inset || (!n.corners && !j.corners)))),
                        n.corners !== b &&
                            (g = !(!n.corners || (!n.inset && !j.inset))),
                        ...
                        _create: function () {
                            ...
                            a.extend(this, { _classes: "" }),
                                c.enhanced ||
                                    ...
                                    this.element
                                        .find(a.mobile.collapsible.initSelector)
                                        .collapsible()),
                                this._on(b, {
                                    collapsibleexpand:
                                        "_handleCollapsibleExpand",
                                });
                        },
                        _themeClassFromOption: function (a, b) {
                            return b ? ("none" === b ? "" : a + b) : "";
                        ...
                        _setOptions: function (a) {
                            ...
                            return (
                                ...
                                a.inset !== b &&
                                    (d = !(
                                        !a.inset ||
                                        (!a.corners && !this.options.corners)
                                    )),
                                a.corners !== b &&
                                    (d = !(
                                        !a.corners ||
                                        (!a.inset && !this.options.inset)
                                    )),
                                d !== b && e.toggleClass("ui-corner-all", d),
                                (c = this._super(a)),
                                this.element
            ...
            a.fn.grid = function (b) {
                return this.each(function () {
                    ...
                    (c = h[i]),
                        ...
                        g
                            .filter(":nth-child(" + c + "n+1)")
                            .addClass("ui-block-a"),
                        c > 1 &&
                            g
                                .filter(":nth-child(" + c + "n+2)")
                                .addClass("ui-block-b"),
                        c > 2 &&
                            g
                                .filter(":nth-child(" + c + "n+3)")
                                .addClass("ui-block-c"),
                        c > 3 &&
                            g
                                .filter(":nth-child(" + c + "n+4)")
                                .addClass("ui-block-d"),
                        c > 4 &&
                            g
                                .filter(":nth-child(" + c + "n+5)")
                                .addClass("ui-block-e");
                });
            };
        })(a),
                    ...
                    d
                        ...
                        d.delegate("a", "vclick", function () {
                            ...
                            b.hasClass("ui-state-disabled") ||
                                ...
                                b.hasClass(a.mobile.activeBtnClass) ||
                ...
                a.extend(
                    {
                            ...
                            (b += a.options.inset ? " ui-listview-inset" : ""),
                                a.options.inset &&
                                    ...
                                    (b += a.options.shadow
                                        ? " ui-shadow"
                                        : "")),
                                a.element.addClass(" ui-listview" + b),
                                a.refresh(!0);
                        },
                        ...
                        refresh: function (c) {
                            ...
                            for (
                                x.theme &&
                                    y.addClass("ui-group-theme-" + x.theme),
                                    z &&
                                        (A || 0 === A) &&
                                        ((n = parseInt(A, 10) - 1),
                                        y.css(
                                ...
                                (g = w.eq(e)),
                                    (h = ""),
                                    (c ||
                                        g[0].className.search(
                                            /\bui-li-static\b|\bui-li-divider\b/
                                        ) < 0) &&
                                        ((l = this._getChildrenByTagName(
                                            g[0],
                                            "a",
                                            "A"
                                        )),
                                        ...
                                        (i = b(g[0], "theme")),
                                        l.length &&
                                        l[0].className.search(/\bui-btn\b/) <
                                            0 &&
                                        !m
                                            ? ((j = b(g[0], "icon")),
                                              (k = j === !1 ? !1 : j || x.icon),
                                              l.removeClass("ui-link"),
                                              (d = "ui-btn"),
                                              i && (d += " ui-btn-" + i),
                                              l.length > 1
                                                  ? ((h = "ui-li-has-alt"),
                            ...
                            C.each(function () {
                                ...
                                E && C.not("[class*='ui-body-']").addClass(E),
                                this._addThumbClasses(w),
                                this._addThumbClasses(w.find(".ui-btn")),
                                this._afterListviewRefresh(),
                                this._addFirstLastClasses(
                                    w,
                                    this._getVisibles(w, c),
                                    c
                                );
                        },
                    },
            ...
            a.widget("mobile.listview", a.mobile.listview, {
                ...
                _beforeListviewRefresh: function () {
                    this.options.autodividers &&
                        (this._replaceDividers(), this._superApply(arguments));
                },
                _replaceDividers: function () {
                    var b,
                        ...
                        i = this.element;
                    for (
                        i.children("li:jqmData(role='list-divider')").remove(),
                            d = i.children("li"),
                            b = 0;
                        b < d.length;
                        b++
                        ...
                        (e = d[b]),
                            (f = this.options.autodividersSelector(a(e))),
                            f &&
                                h !== f &&
                                ((g = c.createElement("li")),
                                g.appendChild(c.createTextNode(f)),
                                g.setAttribute(
                                    "data-" + a.mobile.ns + "role",
                                    "list-divider"
                                ),
            ...
            a.widget("mobile.listview", a.mobile.listview, {
                ...
                _afterListviewRefresh: function () {
                    var a,
                        ...
                        f = !0;
                    if (
                        (this._superApply(arguments), this.options.hideDividers)
                    )
                        for (
                ...
                a.extend(
                    {
                        ...
                        _create: function () {
                            ...
                            ("checkbox" === f || "radio" === f) &&
                                ...
                                (c.iconpos =
                                    d(b, "iconpos") ||
                                    e.element.attr(
                                        "data-" + a.mobile.ns + "iconpos"
                                    ) ||
                                    c.iconpos),
                                (c.mini = d(b, "mini") || c.mini),
                                a.extend(this, {
                                    input: b,
                                    label: e.element,
                        ...
                        _handleLabelVMouseOver: function (a) {
                            this.label.parent().hasClass("ui-state-disabled") &&
                                a.stopPropagation();
                        },
                        ...
                        _hasIcon: function () {
                            ...
                            return d &&
                                ((b = this.element.closest(
                                    ":mobile-controlgroup," +
                                        d.prototype.initSelector
                                )),
                                b.length > 0)
                                ? ((c = a.data(b[0], "mobile-controlgroup")),
                                  "horizontal" !==
                                      (c
                                          ? c.options.type
                                          : b.attr(
                                                "data-" + a.mobile.ns + "type"
                                            )))
                                : !0;
                        },
                        refresh: function () {
                            ...
                            this._hasIcon()
                                ? (f.push(c), e.push(d))
                                : (f.push(d), (b ? e : f).push(c)),
                                b
                                    ? (e.push(this.checkedClass),
                                      f.push(this.uncheckedClass))
                                    : (e.push(this.uncheckedClass),
                                      f.push(this.checkedClass)),
                                this.widget().toggleClass(
                                    "ui-state-disabled",
                        ...
                        _setOptions: function (a) {
                            ...
                            a.disabled !== b &&
                                ...
                                a.mini !== b &&
                                    e.toggleClass("ui-mini", !!a.mini),
                                a.theme !== b &&
                                    c
                                        .removeClass("ui-btn-" + d.theme)
                                        .addClass("ui-btn-" + a.theme),
                                a.wrapperClass !== b &&
                                    e
                                        .removeClass(d.wrapperClass)
                                        .addClass(a.wrapperClass),
                                a.iconpos !== b && f
                                    ? c
                                          .removeClass(
                                              "ui-btn-icon-" + d.iconpos
                                          )
                                          .addClass("ui-btn-icon-" + a.iconpos)
                                    : f ||
                                      c.removeClass("ui-btn-icon-" + d.iconpos),
                                this._super(a);
                        },
                    },
                    a.mobile.behaviors.formReset
            ...
            a.widget("mobile.button", {
                ...
                _create: function () {
                    this.element.is(":disabled") &&
                        (this.options.disabled = !0),
                        this.options.enhanced || this._enhance(),
                        a.extend(this, { wrapper: this.element.parent() }),
                        this._on({
                            focus: function () {
                ...
                _button: function () {
                    ...
                    return a(
                        "<div class='ui-btn ui-input-btn" +
                            (b.wrapperClass ? " " + b.wrapperClass : "") +
                            (b.theme ? " ui-btn-" + b.theme : "") +
                            (b.corners ? " ui-corner-all" : "") +
                            (b.shadow ? " ui-shadow" : "") +
                            (b.inline ? " ui-btn-inline" : "") +
                            (b.mini ? " ui-mini" : "") +
                            (b.disabled ? " ui-state-disabled" : "") +
                            (c ? " " + c : "") +
                            "' >" +
                            this.element.val() +
                            "</div>"
                ...
                _setOptions: function (c) {
                    ...
                    c.theme !== b &&
                        d
                            ...
                            .addClass("ui-btn-" + c.theme),
                        c.corners !== b &&
                            d.toggleClass("ui-corner-all", c.corners),
                        c.shadow !== b && d.toggleClass("ui-shadow", c.shadow),
                        c.inline !== b &&
                            d.toggleClass("ui-btn-inline", c.inline),
                        c.mini !== b && d.toggleClass("ui-mini", c.mini),
                        c.disabled !== b &&
                            (this.element.prop("disabled", c.disabled),
            ...
            a.widget("mobile.textinput", {
                ...
                _classesFromOptions: function () {
                    ...
                    return (
                        b.push(
                            "ui-body-" +
                                (null === a.theme ? "inherit" : a.theme)
                        ),
                        a.corners && b.push("ui-corner-all"),
                        a.mini && b.push("ui-mini"),
                        a.disabled && b.push("ui-state-disabled"),
                        a.wrapperClass && b.push(a.wrapperClass),
                        b
                    );
                },
                _wrap: function () {
                ...
                _setOptions: function (a) {
                    ...
                    this._super(a),
                        (a.disabled !== b ||
                            ...
                            a.theme !== b ||
                            a.wrapperClass !== b) &&
                            (c.removeClass(this.classes.join(" ")),
                            (this.classes = this._classesFromOptions()),
                            c.addClass(this.classes.join(" "))),
                        a.disabled !== b &&
                ...
                a.extend(
                    {
                        ...
                        _create: function () {
                            var e,
                                ...
                                q =
                                    ...
                                    a.mobile.getAttribute(p[0], "theme"),
                                r = q ? " ui-bar-" + q : " ui-bar-inherit",
                                s =
                                    this.options.corners || p.jqmData("corners")
                                        ? " ui-corner-all"
                                        : "",
                                t =
                                    this.options.mini || p.jqmData("mini")
                                        ? " ui-mini"
                                        : "",
                            ...
                            if (
                                ...
                                for (
                                    k = p.attr("tabindex"),
                                        ...
                                        f.className = "ui-slider-inneroffset",
                                        g = 0,
                                ...
                                for (
                                    G.appendChild(f),
                                        F.addClass("ui-slider-handle-snapping"),
                                        e = p.find("option"),
                                        i = 0,
                                        j = e.length;
                                    j > i;
                                    ...
                                    (l = i ? "a" : "b"),
                                        ...
                                        n.appendChild(
                                            c.createTextNode(e[i].innerHTML)
                                        ),
                                        a(n).prependTo(H);
                                o._labels = a(".ui-slider-label", H);
                            }
                            p.addClass(
                                v ? "ui-slider-switch" : "ui-slider-input"
                            ),
                                this._on(p, {
                                ...
                                H.bind(
                                    "vmousedown",
                                    a.proxy(this._sliderVMouseDown, this)
                                ).bind("vclick", !1),
                                this._on(c, {
                        ...
                        _setOptions: function (a) {
                            a.theme !== d && this._setTheme(a.theme),
                                ...
                                a.corners !== d && this._setCorners(a.corners),
                                a.mini !== d && this._setMini(a.mini),
                                a.highlight !== d &&
                        ...
                        refresh: function (b, d, e) {
                            ...
                            if (
                                ...
                                (p = m
                                    ? parseFloat(l.attr("max"))
                                    : n.length - 1),
                                (q =
                                    m && parseFloat(l.attr("step")) > 0
                                        ? parseFloat(l.attr("step"))
                                        : 1),
                                "object" == typeof b)
                            ) {
                                if (
                                ...
                                null == b &&
                                    (b = m
                                        ? parseFloat(l.val() || 0)
                                        : l[0].selectedIndex),
                                    (k = ((parseFloat(b) - o) / (p - o)) * 100);
                            if (
                                !isNaN(k) &&
                                ((r = (k / 100) * (p - o) + o),
                                (s = (r - o) % q),
                                (t = r - s),
                                2 * Math.abs(s) >= q && (t += s > 0 ? q : -q),
                                (u = 100 / ((p - o) / q)),
                                ...
                                if (
                                    ((y = !1),
                                    m
                                        ? ((y = parseFloat(l.val()) !== r),
                                          l.val(r))
                                        : ((y = l[0].selectedIndex !== r),
                                          (l[0].selectedIndex = r)),
            ...
            a.widget("mobile.slider", a.mobile.slider, {
                ...
                _setOption: function (a, c) {
                    this._super(a, c),
                        "showValue" === a
                            ? this.handle.html(
                                  c && !this.options.mini ? this._value() : ""
                              )
                            : "popupEnabled" === a &&
                              c &&
                              !this._popup &&
                ...
                a.extend(
                    {
                        ...
                        _enhance: function () {
                            ...
                            f
                                ...
                                .text(i),
                                g.addClass("ui-flipswitch-off").text(j),
                                b
                                    .addClass(
                        ...
                        _setOptions: function (a) {
                            ...
                            a.onText !== b && this.on.text(a.onText),
                                a.offText !== b && this.off.text(a.offText),
                                a.disabled !== b &&
                                    this.widget().toggleClass(
                                        "ui-state-disabled",
                                        a.disabled
                ...
                a.extend(
                    {
                        ...
                        _create: function () {
                            var b = this.element,
                                ...
                                g =
                                    a.data(d.get(0), "mobile-slider") ||
                                    a.data(d.slider().get(0), "mobile-slider"),
                                h =
                                    a.data(e.get(0), "mobile-slider") ||
                                    a.data(e.slider().get(0), "mobile-slider"),
                                i = g.slider,
                                j = h.slider,
                                k = g.handle,
                                l = a(
                            ...
                            d.addClass("ui-rangeslider-first"),
                                e.addClass("ui-rangeslider-last"),
                                b.addClass(c),
                                i.appendTo(l),
                                j.appendTo(l),
                                f.insertBefore(b),
                                ...
                                this.refresh(),
                                this._on(
                                    this.element.find("input.ui-slider-input"),
                                    {
                        ...
                        _slidebeforestart: function (b) {
                            (this._sliderTarget = !1),
                                a(b.originalEvent.target).hasClass(
                                    "ui-slider-track"
                                ) &&
                        ...
                        _setOptions: function (a) {
                            a.theme !== b && this._setTheme(a.theme),
                                a.trackTheme !== b &&
                                    this._setTrackTheme(a.trackTheme),
                                a.mini !== b && this._setMini(a.mini),
                                a.highlight !== b &&
                                    this._setHighlight(a.highlight),
                                a.disabled !== b &&
                                    this._setDisabled(a.disabled),
        ...
        (function (a, b) {
            a.widget("mobile.textinput", a.mobile.textinput, {
                ...
                clearButton: function () {
                    return a(
                        "<a href='#' tabindex='-1' aria-hidden='true' class='ui-input-clear ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all'></a>"
                    )
                ...
                a.extend(
                    {
                        ...
                        _destroy: function () {
                            ...
                            a.length > 0 &&
                                (a.is(".ui-btn-left, .ui-btn-right") &&
                                    this.element.addClass(
                                        a.hasClass("ui-btn-left")
                                            ? "ui-btn-left"
                                            : "ui-btn-right"
                                    ),
                        ...
                        _create: function () {
                            ...
                            this.setButtonText(),
                                d.nativeMenu &&
                                    b.opera &&
                                    b.opera.version &&
                                    f.addClass("ui-select-nativeonly"),
                                this.isMultiple &&
                                    (this.buttonCount = a("<span>")
                                        .addClass("ui-li-count ui-body-inherit")
                                        .hide()
                                        .appendTo(
                                            f.addClass("ui-li-has-count")
                                        )),
                                (d.disabled || this.element.attr("disabled")) &&
                                    this.disable(),
        ...
        (function (a, c) {
            ...
            a.widget("mobile.popup", {
                ...
                _create: function () {
                    ...
                    (d.history =
                        ...
                        d.enhanced
                            ...
                            : ((this._ui = this._enhance(b, c)),
                              this._applyTransition(d.transition)),
                        (this._setTolerance(d.tolerance)._ui.focusElement =
                            this._ui.container),
                        this._on(this._ui.screen, {
                            vclick: "_eatEventAndClose",
                        }),
                        this._on(this.window, {
                            orientationchange: a.proxy(
                                this,
                ...
                _enhance: function (b, c) {
                    ...
                    return (
                        g.appendChild(f.screen[0]),
                        g.appendChild(f.container[0]),
                        c &&
                            (f.screen.attr("id", c + "-screen"),
                            f.container.attr("id", c + "-popup"),
                            f.placeholder
                                .attr("id", c + "-placeholder")
                                .html("<!-- placeholder for " + c + " -->")),
                        this._page[0].appendChild(g),
                        f.placeholder.insertAfter(b),
                        b
                            .detach()
                            .addClass(
                                "ui-popup " +
                                    ...
                                    " " +
                                    (d.shadow ? "ui-overlay-shadow " : "") +
                                    (d.corners ? "ui-corner-all " : "")
                            )
                    ...
                    if (this._isOpen) {
                        if (d !== e.container[0]) {
                            if (((c = a(d)), !a.contains(e.container[0], d)))
                                return (
                                    a(this.document[0].activeElement).one(
                                        "focus",
                                        a.proxy(function () {
                                            this._safelyBlur(d);
                                        }, this)
                ...
                _setOptions: function (a) {
                    ...
                    return (
                        ...
                        a.overlayTheme !== c &&
                            ...
                            this._isOpen && e.addClass("in")),
                        a.shadow !== c &&
                            d.toggleClass("ui-overlay-shadow", a.shadow),
                        a.corners !== c &&
                            d.toggleClass("ui-corner-all", a.corners),
                        a.transition !== c &&
                            (this._currentTransition ||
                                this._applyTransition(a.transition)),
                        a.tolerance !== c && this._setTolerance(a.tolerance),
                        a.disabled !== c && a.disabled && this.close(),
                        this._super(a)
                    );
                },
                ...
                _calculateFinalLocation: function (a, b) {
                    ...
                    return (
                        ...
                        (c.top -= Math.min(
                            c.top,
                            Math.max(0, c.top + f.cy - this.document.height())
                        )),
                        c
                    );
                },
                ...
                _animate: function (b) {
                    return (
                        ...
                        this._fallbackTransition)
                            ? void this._ui.container
                                  .addClass(b.containerClassToAdd)
                                  .removeClass(b.classToRemove)
                                  .animationComplete(
                                      a.proxy(
                                          b.prerequisites.container,
                                          "resolve"
                                      )
                                  )
                ...
                _closePopup: function (c, d) {
                    ...
                    (c && c.isDefaultPrevented()) ||
                        ...
                        c &&
                            ...
                            this._myUrl !== a.mobile.path.makeUrlAbsolute(f)
                                ? (h = !0)
                                : c.preventDefault()),
                        this.window.off(g.closeEvents),
                        ...
                        : ((a.mobile.popup.active = this),
                          ...
                          j.history
                              ? ((h = a.mobile.navigate.history),
                                ...
                                (f = e ? e.hasClass("ui-dialog") : !1),
                                (this._myUrl = c = h.getActive().url),
                                (g =
                                    c.indexOf(d) > -1 &&
                                    !f &&
                                    h.activeIndex > 0)
                                    ? (i._open(b),
                                      i._bindContainerClose(),
                                      this)
                                    : (-1 !== c.indexOf(d) || f
                                          ? (c =
                                                a.mobile.path.parseLocation()
                                                    .hash + d)
                                          : (c +=
                                                c.indexOf("#") > -1
                                                    ? d
                ...
                (a.mobile.popup.handleLink = function (b) {
                    var c,
                        d = a.mobile.path,
                        e = a(
                            d.hashToSelector(d.parseUrl(b.attr("href")).hash)
                        ).first();
                    e.length > 0 &&
                        e.data("mobile-popup") &&
                        ((c = b.offset()),
                ...
                a.mobile.document.on("pagebeforechange", function (b, c) {
                    "popup" === c.options.role &&
                        (a.mobile.popup.handleLink(c.options.link),
                        b.preventDefault());
                });
        })(a),
        (function (a, b) {
            ...
            a.widget("mobile.selectmenu", a.mobile.selectmenu, {
                ...
                _handleButtonVclickKeydown: function (b) {
                    this.options.disabled ||
                        ...
                        (("vclick" === b.type ||
                            (b.keyCode &&
                                (b.keyCode === a.mobile.keyCode.ENTER ||
                                    b.keyCode === a.mobile.keyCode.SPACE))) &&
                            (this._decideFormat(),
                ...
                _handleListItemClick: function (b) {
                    ...
                    (f.selected = this.isMultiple ? !f.selected : !0),
                        this.isMultiple &&
                            c
                                .find("a")
                                .toggleClass("ui-checkbox-on", f.selected)
                                .toggleClass("ui-checkbox-off", !f.selected),
                        this.isMultiple ||
                            d === e ||
                        ...
                        : ((c = this.selectId),
                          ...
                          (n = a(
                              "<div data-" +
                                  ...
                                  "><div data-" +
                                  a.mobile.ns +
                                  "role='header'><div class='ui-title'></div></div><div data-" +
                                  a.mobile.ns +
                          ...
                          (q = a(
                              "<div class='ui-header ui-bar-" +
                                  (v.theme ? v.theme : "inherit") +
                                  "'></div>"
                          ).prependTo(o)),
                          (r = a("<h1 class='ui-title'></h1>").appendTo(q)),
                          this.isMultiple &&
                              (u = a("<a>", {
                                  role: "button",
                                  text: v.closeText,
                          ...
                          this.refresh(),
                          this._origTabIndex === b &&
                              (this._origTabIndex =
                                  null ===
                                  this.select[0].getAttribute("tabindex")
                                      ? !1
                ...
                _focusMenuItem: function () {
                    ...
                    0 === b.length &&
                        (b = this.list.find("li:not(" + d + ") a.ui-btn")),
                        b.first().focus();
                },
                _decideFormat: function () {
                    ...
                    e > h - 80 || !a.support.scrollTop
                        ? (b.menuPage.appendTo(a.mobile.pageContainer).page(),
                          (b.menuPageContent = b.menuPage.find(".ui-content")),
                          (b.menuPageClose = b.menuPage.find(".ui-header a")),
                          b.thisPage.unbind("pagehide.remove"),
                          0 === f &&
                              g > h &&
                              b.thisPage.one("pagehide", function () {
                          ...
                          (b.menuType = "page"),
                          b.menuPageContent.append(b.list),
                          b.menuPage
                              .find("div .ui-title")
                              .text(b.label.getEncodedText() || b.placeholder))
                        : ((b.menuType = "overlay"),
                          b.listbox.one({
                            ...
                            i.hasClass("ui-screen-hidden") ||
                                ...
                                !t ||
                                    (h.getAttribute("value") &&
                                        0 !== k.length &&
                                        !i.jqmData("placeholder")) ||
                                    ((t = !1),
                                    (B = !0),
                                    null === h.getAttribute(z) &&
                                        (this._removePlaceholderAttr = !0),
                                    h.setAttribute(z, !0),
                                    r.hidePlaceholderMenuItems &&
                                        m.push("ui-screen-hidden"),
                                    s !== k && (s = q.placeholder = k)),
                                ...
                                p.appendChild(l),
                                A.appendChild(p));
                    q.list[0].appendChild(A),
                        this.isMultiple || s.length
        ...
        (function (a, b) {
            function c(a, b) {
                ...
                return (
                    c.push("ui-btn"),
                    a.theme && c.push("ui-btn-" + a.theme),
                    a.icon &&
                        ((c = c.concat([
                            "ui-icon-" + a.icon,
                            "ui-btn-icon-" + a.iconpos,
                        ])),
                        a.iconshadow && c.push("ui-shadow-icon")),
                    a.inline && c.push("ui-btn-inline"),
                    a.shadow && c.push("ui-shadow"),
                    a.corners && c.push("ui-corner-all"),
                    a.mini && c.push("ui-mini"),
                    c
                );
            }
            function d(a) {
                ...
                for (a = a.split(" "), c = 0; c < a.length; c++)
                    (e = !0),
                        ...
                        d !== b
                            ? ((e = !1), (i[d] = !0))
                            : 0 === a[c].indexOf("ui-btn-icon-")
                            ? ((e = !1),
                              (h = !1),
                              (i.iconpos = a[c].substring(12)))
                            : 0 === a[c].indexOf("ui-icon-")
                            ? ((e = !1), (i.icon = a[c].substring(8)))
                            : 0 === a[c].indexOf("ui-btn-") && 8 === a[c].length
                            ? ((e = !1), (i.theme = a[c].substring(7)))
                            : "ui-btn" === a[c] && ((e = !1), (g = !0)),
                        e && j.push(a[c]);
                return (
                    h && (i.icon = ""),
                    { options: i, unknownClasses: j, alreadyEnhanced: g }
                );
            }
            function e(a) {
                return "-" + a.toLowerCase();
                ...
                a.extend(
                    {
                        ...
                        _create: function () {
                            var b = this.element,
                                c = this.options,
                                d =
                                    a.mobile.page.prototype.keepNativeSelector();
                            a.fn.buttonMarkup &&
                                this.element
                                    .find(a.fn.buttonMarkup.initSelector)
                                    .not(d)
                                    .buttonMarkup(),
                                a.each(
                                    this._childWidgets,
                            ...
                            return (
                                ...
                                a.theme !== b &&
                                    e
                                        ...
                                        .addClass(
                                            this._themeClassFromOption(a.theme)
                                        ),
                                a.corners !== b &&
                                    e.toggleClass("ui-corner-all", a.corners),
                                a.mini !== b &&
                                    e.toggleClass("ui-mini", a.mini),
                                a.shadow !== b &&
                        ...
                        refresh: function () {
                            ...
                            a.mobile.checkboxradio &&
                                b
                                    .find(":mobile-checkboxradio")
                                    .checkboxradio("refresh"),
                                this._addFirstLastClasses(
                                    c,
                                    this.options.excludeInvisible
                                        ? this._getVisibles(c, d)
                                        : c,
                                    d
                                ),
                        ...
                        _destroy: function () {
                            ...
                            return c.enhanced
                                ...
                                : ((a = this._ui),
                                  ...
                                  this._removeFirstLastClasses(b),
        ...
        (function (a, b) {
            a.widget("mobile.toolbar", {
                initSelector:
                    ":jqmData(role='footer'), :jqmData(role='header')",
                options: {
                    theme: null,
                    addBackBtn: !1,
                    backBtnTheme: null,
                ...
                _create: function () {
                    var b,
                        c,
                        d = this.element.is(":jqmData(role='header')")
                            ? "header"
                            : "footer",
                ...
                _setOptions: function (a) {
                    if (
                        (a.addBackBtn !== b && this._updateBackButton(),
                        null != a.backBtnTheme &&
                            this.element
                                .find(".ui-toolbar-back-btn")
                                .addClass("ui-btn ui-btn-" + a.backBtnTheme),
                        a.backBtnText !== b &&
                            this.element
                ...
                _btnMarkup: function () {
                    this.element
                        ...
                        .attr("data-" + a.mobile.ns + "role", "button"),
                ...
                _addHeaderButtonClasses: function () {
                    ...
                    (this.leftbtn =
                        a.hasClass("ui-btn-left") &&
                        !a.hasClass("ui-toolbar-back-btn")),
                        ...
                        (this.rightbtn =
                            this.rightbtn ||
                            a.eq(1).addClass("ui-btn-right").length);
                },
                ...
                _destroy: function () {
                    ...
                    this.element
                        ...
                        (a = this.options.theme
                            ? this.options.theme
                            : "inherit"),
                        this.element.removeClass("ui-bar-" + a),
                        this.element
            ...
            a.widget("mobile.toolbar", a.mobile.toolbar, {
                ...
                _addTransitionClass: function () {
                    ...
                    a &&
                        "none" !== a &&
                        ("slide" === a &&
                            (a = this.element.hasClass("ui-header")
                                ? "slidedown"
                                : "slideup"),
                ...
                _handlePageBeforeHide: function (b, c) {
                    ...
                    h.disablePageZoom && a.mobile.zoom.enable(!0),
                        ...
                        h.trackPersistentToolbars &&
                            ((d = a(".ui-footer-fixed:jqmData(id)", this.page)),
                            ...
                            (g =
                                ...
                                a()),
                            (f.length || g.length) &&
                                (f.add(g).appendTo(a.mobile.pageContainer),
                ...
                updatePagePadding: function (c) {
                    ...
                    this.options.fullscreen ||
                        ((c =
                            ...
                            this.page ||
                            d.closest(".ui-page")),
                        (c = this.page ? this.page : ".ui-page-active"),
                        a(c).css(
                            "padding-" + (e ? "top" : "bottom"),
                            d.outerHeight() + f
                        ));
                },
                ...
                _bindToggleHandlers: function () {
                    ...
                    g.bind("vclick", function (b) {
                        e.tapToggle &&
                            !a(b.target).closest(e.tapToggleBlacklist).length &&
                            d.toggle();
                    }).bind("focusin focusout", function (g) {
                        screen.width < 1025 &&
                            a(g.target).is(e.hideDuringFocus) &&
                            !a(g.target).closest(
        ...
        (function (a) {
            a.widget("mobile.toolbar", a.mobile.toolbar, {
                ...
                _viewportOffset: function () {
                    ...
                    return (
                        b ||
                            (c =
                                Math.round(
                                    c - this.window.height() + a.outerHeight()
                                ) - 60),
                        c
                    );
                },
                ...
                _triggerRedraw: function () {
                    var b = parseFloat(
                        a(".ui-page-active").css("padding-bottom")
                    );
            ...
            a.widget("mobile.popup", a.mobile.popup, {
                ...
                _addArrow: function () {
                    var a,
                        ...
                        d = c();
                    return (
                        (a = this._themeClassFromOption("ui-body-", b.theme)),
                        d.ar.addClass(
                            a + (b.shadow ? " ui-overlay-shadow" : "")
                        ),
                        d.arEls.hide().appendTo(this.element),
                        d
                    );
                },
                _unenhance: function () {
                ...
                _tryAnArrow: function (a, b, c, d, e) {
                    ...
                    return d.arFull[a.dimKey] > d.guideDims[a.dimKey]
                        ...
                        : ((i[a.fst] =
                              c[a.fst] +
                              (d.arHalf[a.oDimKey] + d.menuHalf[a.oDimKey]) *
                                  a.offsetFactor -
                              d.contentBox[a.fst] +
                              (d.clampInfo.menuSize[a.oDimKey] -
                                  d.contentBox[a.oDimKey]) *
                                  a.arrowOffsetFactor),
                          (i[a.snd] = c[a.snd]),
                          (f =
                              d.result ||
                              this._calculateFinalLocation(i, d.clampInfo)),
                          (g = { x: f.left, y: f.top }),
                          (j[a.fst] =
                              g[a.fst] + d.contentBox[a.fst] + a.tipOffset),
                          (j[a.snd] = Math.max(
                              f[a.prop] +
                          ...
                          e
                              ? (j.ct
                                ...
                                d ||
                                    ...
                                    (h[f[e.dir].fst] = j.ct.offset()),
                                    (h[f[e.dir].snd] = {
                                        left: g.left + c.contentBox.x,
                                        top: g.top + c.contentBox.y,
                                    })),
                                e.result)
                              : (j.arEls.hide(), this._super(b)))
                        : this._super(b);
                },
                _setOptions: function (a) {
                    var c,
                    ...
                    if (a.arrow !== b) {
                        ...
                        e &&
                            !a.arrow &&
                            (e.arEls.remove(), (this._ui.arrow = null));
                    }
                    return (
                        (e = this._ui.arrow),
                        e &&
                            (a.theme !== b &&
                                ...
                                (c = this._themeClassFromOption(
                                    "ui-body-",
                                    a.theme
                                )),
                                e.ar.removeClass(d).addClass(c)),
                            a.shadow !== b &&
                                e.ar.toggleClass(
                                    "ui-overlay-shadow",
                                    a.shadow
        ...
        (function (a, c) {
            a.widget("mobile.panel", {
                ...
                _createModal: function () {
                    var b = this,
                        c = b._parentPage
                            ? b._parentPage.parent()
                            : b.element.parent();
                    b._modal = a(
                        "<div class='" + b.options.classes.modal + "'></div>"
                    )
                ...
                _handleClick: function (b) {
                    ...
                    b.currentTarget.href.split("#")[1] === e &&
                        ...
                        (d = a(b.target)),
                        d.hasClass("ui-btn") &&
                            (d.addClass(a.mobile.activeBtnClass),
                            this.element.one(
                ...
                _bindSwipeEvents: function () {
                    ...
                    a.options.swipeClose &&
                        ("left" === a.options.position
                            ...
                            e = function () {
                                c._off(c.document, "panelclose"),
                                    ...
                                    a.support.cssTransform3d &&
                                        d.animate &&
                                        "overlay" !== d.display &&
                                        (c._wrapper.addClass(d.classes.animate),
                                        c
                                            ._fixedToolbars()
                                            .addClass(d.classes.animate)),
                                    !b && a.support.cssTransform3d && d.animate
                                        ? (
                                              c._wrapper || c.element
                                          ).animationComplete(f, "transition")
                                        : setTimeout(f, 0),
                                    d.theme &&
                                        "overlay" !== d.display &&
                                        c
                                    ...
                                    c.element
                                        .removeClass(d.classes.panelClosed)
                                        .addClass(d.classes.panelOpen),
                                    c._positionPanel(!0),
                                    (c._pageContentOpenClasses =
                                        c._getPosDisplayClasses(
                                            d.classes.pageContentPrefix
                                        )),
                                    "overlay" !== d.display &&
                                        (c
                                            ._page()
                ...
                _destroy: function () {
                    ...
                    "overlay" !== c.display &&
                        ...
                        0 ===
                            b.not(".ui-panel-display-overlay").not(this.element)
                                .length && this._wrapper.children().unwrap(),
                        this._open &&
                            (this._fixedToolbars().removeClass(
                                c.classes.pageContentPrefix + "-open"
                            ),
                            a.support.cssTransform3d &&
                                c.animate &&
                                this._fixedToolbars().removeClass(
                            ...
                            this._page()
                                .parent()
                                .removeClass(c.classes.pageContainer),
                            c.theme &&
                                this._page()
                                    .parent()
                                    .removeClass(
            ...
            a.widget("mobile.table", {
                ...
                _create: function () {
                    this.options.enhanced ||
                        ...
                        a.extend(this, { headers: b, allHeaders: b }),
                        this._refresh(!0);
                },
        ...
        (function (a) {
            a.widget("mobile.table", a.mobile.table, {
                options: {
                    ...
                    classes: a.extend(
                        a.mobile.table.prototype.options.classes,
                        {
                ...
                _id: function () {
                    return (
                        this.element.attr("id") || this.widgetName + this.uuid
                    );
                },
                ...
                _addToggles: function (b, c) {
                    ...
                    c ? (d = b.find("input")) : g.empty(),
                        this.headers.not("td").each(function () {
                            ...
                            j &&
                                ((h = i.add(i.jqmData("cells"))),
                                h.addClass(f.classes.priorityPrefix + j),
                                (b = (
                                    c
                                        ? d.eq(e++)
                                        : a(
                ...
                _enhanceColToggle: function () {
                    ...
                    return (
                        ...
                        (e = a("<fieldset></fieldset>").controlgroup()),
                        this._addToggles(e, !1),
                        e.appendTo(d),
                        i.appendChild(d[0]),
                        i.appendChild(c[0]),
                        f.before(i),
                ...
                _setToggleState: function () {
                    this._menu.find("input").each(function () {
                        ...
                        (this.checked =
                            "table-cell" ===
                            b.jqmData("cells").eq(0).css("display")),
                            b.checkboxradio("refresh");
                    });
                },
                _destroy: function () {
                    this._super();
            ...
            a.widget("mobile.table", a.mobile.table, {
                ...
                _updateReflow: function () {
                    ...
                    a(b.allHeaders.get().reverse()).each(function () {
                        var d,
                            ...
                            h =
                                f.not(this).filter("thead th").length &&
                        ...
                        i.length > 0 &&
                            (h
                                ? ((d = parseInt(
                                  ...
                                  b._addLabels(
                                      f.filter(e),
                                      c.classes.cellLabels + h,
                                      i
                                  ))
                                : b._addLabels(f, c.classes.cellLabels, i));
                    });
                },
                _addLabels: function (b, c, d) {
                    1 === d.length &&
                        ...
                        b
                            .not(":has(b." + c + ")")
                            .prepend(a("<b class='" + c + "'></b>").append(d));
                },
            });
        })(a),
        (function (a, c) {
            var d = function (b, c) {
                return (
                    ...
                    (
                        "" +
                        (a.mobile.getAttribute(this, "filtertext") ||
                            a(this).text())
                    )
                        .toLowerCase()
                        .indexOf(c)
            ...
            a.widget("mobile.filterable", {
                ...
                _onKeyUp: function () {
                    ...
                    if (e) {
                        if (
                            ...
                            return;
                        this._timer &&
                            (b.clearTimeout(this._timer), (this._timer = 0)),
                ...
                _filterItems: function (b) {
                    ...
                    if (null != b)
                        for (
                            e = j.filterCallback || d, f = k.length, c = 0;
                            f > c;
                            c++
                        )
                ...
                _setInput: function (c) {
                    ...
                    this._timer &&
                        (b.clearTimeout(this._timer), (this._timer = 0)),
                        d && (this._off(d, "keyup change input"), (d = null)),
                        c &&
                            ((d = c.jquery
                                ? c
                                : c.nodeName
                                ? a(c)
                                : this.document.find(c)),
                            this._on(d, {
                                keydown: "_onKeyDown",
                ...
                _setOptions: function (a) {
                    ...
                    this._super(a),
                        a.input !== c && (this._setInput(a.input), (b = !0)),
                        b && this.refresh();
                },
                _destroy: function () {
                    var a = this.options,
        ...
        (function (a, b) {
            ...
            (a.mobile.filterable.prototype.options.filterCallback = function (
                a,
                b
            ) {
                ...
                a.widget("mobile.filterable", a.mobile.filterable, {
                    ...
                    _handleCreate: function (a) {
                        this._setWidget(
                            this.element.data(
                                "mobile-" +
                                    a.type.substring(0, a.type.length - 6)
                            )
                        );
                    },
                    ...
                    _setInput: function (b) {
                        ...
                        if (!b) {
                            ...
                            (d = !1),
                                ...
                                a("<form class='ui-filterable'></form>")
                                    .append(b)
                                    .submit(function (a) {
                ...
                a.widget("mobile.listview", a.mobile.listview, {
                    ...
                    refresh: function () {
                        ...
                        this._superApply(arguments),
                            this.options.filter === !0 &&
                                ((a = this.element.data("mobile-filterable")),
                                a && a.refresh());
                    },
                });
        })(a),
        (function (a, b) {
            ...
            function d(a) {
                return (
                    a.hash.length > 1 &&
                    decodeURIComponent(a.href.replace(f, "")) ===
                        decodeURIComponent(location.href.replace(f, ""))
                );
            }
            var e = 0,
                f = /#.*$/;
                ...
                _panelKeydown: function (b) {
                    this._handlePageNav(b) ||
                        (b.ctrlKey &&
                            ...
                            (b.preventDefault(), this.active.focus()));
                },
                ...
                _processTabs: function () {
                    ...
                    (this.tablist = this._getList()
                        ...
                        this.anchors.each(function (c, e) {
                            ...
                            d(e)
                                ? ((f = e.hash),
                                  (g = b.element.find(b._sanitizeSelector(f))))
                                : ((h = b._tabId(j)),
                                  (f = "#" + h),
                                  (g = b.element.find(f)),
                                  g.length ||
                    ...
                    a.extend(a.mobile, {
                        initializePage: function () {
                            var b = a.mobile.path,
                                ...
                                h = b.stripHash(
                                    b.stripQueryParams(b.parseLocation().hash)
                                ),
                            ...
                            f.length ||
                                ...
                                f.each(function () {
                                    ...
                                    c[0].getAttribute(
                                        ...
                                        c.attr(
                                            "data-" + a.mobile.ns + "url",
                                            c.attr("id") ||
                                                b.convertUrlToDataUrl(
                                                    i.pathname + i.search
                                                )
                                        );
                                }),
                                (a.mobile.firstPage = f.first()),
                                (a.mobile.pageContainer = a.mobile.firstPage
                                    .parent()
                                ...
                                (a(j).is(":jqmData(role='page')") ||
                                    a.mobile.path.isPath(h) ||
                                    h === a.mobile.dialogHashKey)
                                    ? a.event.special.navigate.isPushStateEnabled()
                                        ? ((a.mobile.navigate.history.stack =
                                              []),
                                          a.mobile.navigate(
                                              a.mobile.path.isPath(
                                                  location.hash
                                              )
                                                  ? location.hash
                                                  : location.href
