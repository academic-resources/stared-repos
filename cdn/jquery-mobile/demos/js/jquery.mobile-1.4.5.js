...
(function (root, doc, factory) {
                ...
                function reduce(elem, size, border, margin) {
                    $.each(side, function () {
                        ...
                        if (border) {
                            size -=
                                parseFloat(
                                    $.css(elem, "border" + this + "Width")
                                ) || 0;
                        }
                        if (margin) {
                            size -=
                                parseFloat($.css(elem, "margin" + this)) || 0;
                        }
                    });
                    return size;
                }
            ...
            var pageParent = page.parent(),
                ...
                noPadders = function () {
                    var theElement = $(this),
                        widgetOptions =
                            $.mobile.toolbar &&
                            theElement.data("mobile-toolbar")
                                ? theElement.toolbar("option")
                                : {
                                      position: theElement.attr(
                                          "data-" + $.mobile.ns + "position"
                                      ),
                                      updatePagePadding:
                                          theElement.attr(
                                              "data-" +
                    ...
                    return !(
                        widgetOptions.position === "fixed" &&
                        widgetOptions.updatePagePadding === true
                    );
                },
                externalHeaders = pageParent
                    .children(":jqmData(role='header')")
                    .filter(noPadders),
                internalHeaders = page.children(":jqmData(role='header')"),
                externalFooters = pageParent
        ...
        $.extend($.mobile, {
            ...
            haveParents: function (elements, attr) {
                ...
                for (i = 0; i < count; i++) {
                    ...
                    while (e) {
                        c = e.getAttribute
                            ? e.getAttribute("data-" + $.mobile.ns + attr)
                            : "";
            ...
            loading: function () {
                ...
                var loader =
                        ...
                        $($.mobile.loader.prototype.defaultHtml).loader(),
                ...
                $.each($.mobile.widgets, function (name, constructor) {
                    ...
                    if (constructor.initSelector) {
                        ...
                        var elements = $.mobile.enhanceable(
                            that.find(constructor.initSelector)
                        );
    ...
    (function ($, window, undefined) {
        ...
        $.jqmData = function (elem, prop, value) {
            ...
            if (typeof prop !== "undefined") {
                result = $.data(
                    elem,
                    prop ? $.mobile.nsNormalize(prop) : prop,
                    value
                );
            }
            return result;
                ...
                if (!$.mobile.getAttribute(elem, "defaults")) {
                    for (option in this.options) {
                        value = $.mobile.getAttribute(
                            elem,
                            option.replace(rcapitals, replaceFunction)
                        );
        ...
        $.widget("mobile.loader", {
            ...
            fakeFixLoader: function () {
                ...
                this.element.css({
                    top:
                        ...
                        (activeBtn.length && activeBtn.offset().top) ||
                        100,
                });
            },
            ...
            checkLoaderPosition: function () {
                ...
                if (
                    ...
                    offset.top - scrollTop > screenHeight
                ) {
            ...
            show: function (theme, msgText, textonly) {
                ...
                message =
                    msgText ||
                    (loadSettings.text === false ? "" : loadSettings.text);
                ...
                this.element.attr(
                    ...
                    loaderClass +
                        ...
                        theme +
                        " ui-loader-" +
                        (textVisible || msgText || theme.text
                            ? "verbose"
                            : "default") +
    ...
    (function ($, window, undefined) {
        ...
        $.fn[str_hashchange] = function (fn) {
            return fn
                ? this.bind(str_hashchange, fn)
                : this.trigger(str_hashchange);
        };
  ...
  */
                ...
                (function () {
                    ...
                    self.start = function () {
                        if (!iframe) {
                            ...
                            iframe_src =
                                iframe_src && iframe_src + get_fragment();
    ...
    (function ($, undefined) {
        ...
        function baseTagTest() {
            ...
            if (!base.length) {
                base = fauxEle = $("<base>", { href: fauxBase }).appendTo(
                    "head"
                );
            } else {
                href = base.attr("href");
        ...
        nokiaLTE7_3 = (function () {
            ...
            return (
                ua.indexOf("Nokia") > -1 &&
                (ua.indexOf("Symbian/3") > -1 ||
                    ua.indexOf("Series60/5") > -1) &&
        ...
        $.mobile.gradeA = function () {
            return (
                ...
                ($.support.boundingRect ||
                    $.fn.jquery.match(/1\.[0-7+]\.[0-9+]?/) !== null)
            );
        };
    ...
    (function ($, undefined) {
        ...
        $.mobile.path = path = {
            ...
            isSameDomain: function (absUrl1, absUrl2) {
                return (
                    path.parseUrl(absUrl1).domain.toLowerCase() ===
            ...
            cleanHash: function (hash) {
                return path.stripHash(
                    hash.replace(/\?.*$/, "").replace(dialogHashKey, "")
                );
            },
            ...
            isExternal: function (url) {
                ...
                return !!(
                    u.protocol &&
                    u.domain.toLowerCase() !==
                        this.documentUrl.domain.toLowerCase()
                );
            },
            ...
            squash: function (url, resolutionUrl) {
                ...
                cleanedUrl = path.isPath(uri.hash)
                    ? path.stripHash(uri.hash)
                    : cleanedUrl;
            ...
            isFirstPageUrl: function (url) {
                ...
                var u = path.parseUrl(
                        path.makeUrlAbsolute(url, this.documentBase)
                    ),
    ...
    (function ($, undefined) {
        ...
        $.extend($.mobile.Navigator.prototype, {
            ...
            hash: function (url, href) {
                ...
                if (
                    ...
                    hash =
                        resolved.pathname +
                        resolved.search +
                        (path.isPreservableHash(resolved.hash)
            ...
            go: function (url, data, noEvents) {
                ...
                if (
                    noEvents &&
                    hash !== path.stripHash(path.parseLocation().hash)
                ) {
    ...
    (function ($, undefined) {
        ...
        $.each(["animation", "transition"], function (i, test) {
            ...
            $.each(vendorPrefixes, function (j, prefix) {
                if (
                    testElement.style[$.camelCase(prefix + testName)] !==
                    undefined
                ) {
        ...
        $.fn.animationComplete = function (callback, type, fallbackTime) {
            var timer,
                ...
                animationType =
                    !type || type === "animation" ? "animation" : "transition";
    ...
    (function ($, window, document, undefined) {
        ...
        function createVirtualEvent(event, eventType) {
            ...
            if (t.search(/^touch/) !== -1) {
                ...
                touch =
                    t && t.length ? t[0] : ct && ct.length ? ct[0] : undefined;
        ...
        function triggerVirtualEvent(eventType, event, flags) {
            ...
            if (
                ...
                (!flags &&
                    getClosestElementWithVirtualBinding(
                        event.target,
                        eventType
                    ))
            ) {
    ...
    (function ($, window, undefined) {
        ...
        $.event.special.swipe = {
            ...
            getLocation: function (event) {
                ...
                if (
                    (event.pageY === 0 &&
                        Math.floor(y) > Math.floor(event.pageY)) ||
                    (event.pageX === 0 &&
                        Math.floor(x) > Math.floor(event.pageX))
                ) {
    ...
    (function ($, undefined) {
        ...
        $.widget = (function (orig) {
            return function () {
                ...
                constructor.initSelector =
                    constructor.prototype.initSelector !== undefined
        ...
        $.widget("mobile.page", {
            ...
            _create: function () {
                ...
                if (
                    $.mobile.getAttribute(this.element[0], "role") ===
                        "dialog" &&
                    $.mobile.dialog
                ) {
                    this.element.dialog();
            ...
            _enhance: function () {
                ...
                this.element
                    .find("[" + attrPrefix + "role='content']")
                    .each(function () {
                        var $this = $(this),
                            theme =
                                this.getAttribute(attrPrefix + "theme") ||
                                undefined;
            ...
            bindRemove: function (callback) {
                ...
                if (
                    !page.data("mobile-page").options.domCache &&
            ...
            _setOptions: function (o) {
                if (o.theme !== undefined) {
                    this.element
                        .removeClass("ui-page-theme-" + this.options.theme)
                        .addClass("ui-page-theme-" + o.theme);
                }

                if (o.contentTheme !== undefined) {
                    this.element
                        .find("[data-" + $.mobile.ns + "='content']")
            ...
            setContainerBackground: function (theme) {
                this.element
                    .parent()
                    .pagecontainer({ theme: theme || this.options.theme });
            },
            // Deprecated in 1.4 remove in 1.5
            keepNativeSelector: function () {
                var options = this.options,
                    ...
                    newDefault =
                        keepNativeFactoryDefault === globalValue
                            ? ""
                            : globalValue,
    ...
    (function ($, undefined) {
        $.widget("mobile.pagecontainer", {
            ...
            _filterNavigateEvents: function (e, data) {
                ...
                url =
                    e.originalEvent.type.indexOf("hashchange") > -1
                        ? data.state.hash
                        : data.state.url;
                ...
                if (
                    !url ||
                    url === "#" ||
                    url.indexOf("#" + $.mobile.path.uiStateKey) === 0
                ) {
                    url = location.href;
                }
            ...
            _find: function (absUrl) {
                ...
                page = this.element.children(
                    "[data-" +
                        this._getNs() +
                        "url='" +
                        $.mobile.path.hashToSelector(dataUrl) +
                        "']"
                );
            ...
            _loadSuccess: function (absUrl, triggerData, settings, deferred) {
                ...
                return $.proxy(function (html, textStatus, xhr) {
                    ...
                    if (
                        pageElemRegex.test(html) &&
                        RegExp.$1 &&
                        dataUrlRegex.test(RegExp.$1) &&
                        RegExp.$1
                    ) {
                        fileUrl = $.mobile.path.getFilePath(
                            $("<div>" + RegExp.$1 + "</div>").text()
                        );
            ...
            load: function (url, options) {
                ...
                // If the default behavior is prevented, stop here!
                if (
                    pblEvent.deprecatedEvent.isDefaultPrevented() ||
            ...
            _triggerPageBeforeChange: function (to, triggerData, settings) {
                ...
                returnEvents = this._triggerWithDeprecated(
                    "beforechange",
                    triggerData
                );
                ...
                // If the default behavior is prevented, stop here!
                if (
                    returnEvents.event.isDefaultPrevented() ||
            ...
            transition: function (toPage, triggerData, settings) {
                ...
                url =
                    (settings.dataUrl &&
                        $.mobile.path.convertUrlToDataUrl(settings.dataUrl)) ||
                    toPage.jqmData("url");
        ...
        $.mobile._registerInternalEvents = function () {
            var getAjaxFormData = function ($form, calculateOnly) {
                ...
                url = $.mobile.path.makeUrlAbsolute(
                    url,
                    $.mobile.getClosestBaseUrl($form)
                );

                if (
                    $.mobile.path.isExternal(url) &&
            ...
            $.mobile.document.bind("click", function (event) {
                ...
                if (
                    !$.mobile.ajaxEnabled &&
                    !$.mobile.path.isEmbeddedPage(href)
                ) {
                    httpCleanup();
                ...
                if (
                    href.search("#") !== -1 &&
                    !(
                        $.mobile.path.isExternal(href) &&
                        $.mobile.path.isAbsoluteUrl(href)
                    )
                ) {
                    href = href.replace(/[^#]*#/, "");
                    if (!href) {
                ...
                useDefaultUrlHandling =
                    $link.is("[rel='external']") ||
                    $link.is(":jqmData(ajax='false')") ||
                    $link.is("[target]");
    ...
    (function ($, window, undefined) {
        ...
        $.extend($.mobile.Transition.prototype, {
            ...
            transition: function () {
                ...
                this.toScroll =
                    $.mobile.navigate.history.getActive().lastScroll ||
        ...
        $.widget("mobile.page", $.mobile.page, {
            ...
            _setCloseBtn: function (location, text) {
                ...
                if ("none" === location) {
                    ...
                    btn.removeClass("ui-btn-left ui-btn-right").addClass(
                        "ui-btn-" + location
                    );
                    if (text) {
                        btn.text(text);
    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.collapsible", {
            ...
            _create: function () {
                ...
                if (this.options.enhanced) {
                    ui.heading = this.element.children(
            ...
            _enhance: function (elem, ui) {
                ...
                (ui.originalHeading = elem
                    .children(this.options.heading)
                    .first()),
                    (ui.content = elem
                        .wrapInner(
                            "<div " +
                ...
                if (ui.heading.is("legend")) {
                    ui.heading = $(
                        "<div role='heading'>" + ui.heading.html() + "</div>"
                    );
                    ui.placeholder = $(
            ...
            $.extend(
                {
                    ...
                    _handleCollapsibleExpand: function (event) {
                        var closestCollapsible = $(event.target).closest(
                            ".ui-collapsible"
                        );
                    ...
                    _create: function () {
                        ...
                        if (!opts.enhanced) {
                            ...
                            this.element
                                .find($.mobile.collapsible.initSelector)
                                .collapsible();
                        }
                    ...
                    _destroy: function () {
                        ...
                        this._removeFirstLastClasses(
                            el.children(childCollapsiblesSelector)
                        );
                        el.removeClass(
                    ...
                    _refresh: function (create) {
                        ...
                        this._addFirstLastClasses(
                            collapsiblesInSet,
                            this._getVisibles(collapsiblesInSet, create),
                            create
                        );
                    },
    ...
    (function ($, undefined) {
        $.fn.grid = function (options) {
            return this.each(function () {
                ...
                $kids
                    .filter(":nth-child(" + iterator + "n+1)")
                    .addClass("ui-block-a");

                if (iterator > 1) {
                    $kids
                        .filter(":nth-child(" + iterator + "n+2)")
                        .addClass("ui-block-b");
                }
                if (iterator > 2) {
                    $kids
                        .filter(":nth-child(" + iterator + "n+3)")
                        .addClass("ui-block-c");
                }
                if (iterator > 3) {
                    $kids
                        .filter(":nth-child(" + iterator + "n+4)")
                        .addClass("ui-block-d");
                }
                if (iterator > 4) {
                    $kids
                        .filter(":nth-child(" + iterator + "n+5)")
                        .addClass("ui-block-e");
                }
            });
        };
        ...
        $.widget("mobile.navbar", {
            ...
            _create: function () {
                ...
                $navbtns.each(function () {
                    ...
                    if (icon) {
                        classes +=
                            " ui-icon-" + icon + " ui-btn-icon-" + iconpos;
                    }
            ...
            $.extend(
                {
                    ...
                    _create: function () {
                        ...
                        listviewClasses += t.options.inset
                            ? " ui-listview-inset"
                            : "";
                        ...
                        if (!!t.options.inset) {
                            listviewClasses += t.options.corners
                                ? " ui-corner-all"
                                : "";
                            listviewClasses += t.options.shadow
                                ? " ui-shadow"
                                : "";
                        }
                    ...
                    refresh: function (create) {
                        ...
                        for (pos = 0, numli = li.length; pos < numli; pos++) {
                            ...
                            if (
                                ...
                                isDivider =
                                    getAttr(item[0], "role") === "list-divider";
                                ...
                                if (
                                    ...
                                    if (a.length > 1) {
                                        ...
                                        last = a.last();
                                        splittheme =
                                            getAttr(last[0], "theme") ||
                                            o.splitTheme ||
                                            getAttr(item[0], "theme", true);
            ...
            _replaceDividers: function () {
                ...
                for (i = 0; i < lis.length; i++) {
                    ...
                    if (dividerText && lastDividerText !== dividerText) {
                        ...
                        divider.appendChild(
                            document.createTextNode(dividerText)
                        );
                ...
                if (this.options.hideDividers) {
                    ...
                    for (idx = items.length - 1; idx > -1; idx--) {
                        ...
                        if (item.className.match(rdivider)) {
                            if (hideDivider) {
                                item.className =
                                    item.className + " ui-screen-hidden";
                            }
                            hideDivider = true;
                        } else {
            ...
            $.extend(
                {
                    ...
                    _findLabel: function () {
                        ...
                        if (labelsList && labelsList.length > 0) {
                            ...
                            label = isParent
                                ? parentLabel
                                : $(
                                      this.document[0].getElementsByTagName(
                                          "label"
                                      )
                                  )
                                      .filter(
                    ...
                    _hasIcon: function () {
                        ...
                        if (controlgroupConstructor) {
                            controlgroup = this.element.closest(
                                ":mobile-controlgroup," +
                                    controlgroupConstructor.prototype
                                        .initSelector
                            );
                    ...
                    refresh: function () {
                        var isChecked = this.element[0].checked,
                            ...
                            iconposClass =
                                "ui-btn-icon-" + this.options.iconpos,
                            addClasses = [],
                            removeClasses = [];
        ...
        $.widget("mobile.button", {
            ...
            _setOptions: function (options) {
                ...
                if (
                    ...
                    options.iconshadow !==
                        undefined /* TODO: Deprecated in 1.4, remove in 1.5. */ ||
        ...
        $.mobile.zoom = $.extend(
            {},
            {
                ...
                enable: function (unlock) {
                    if (
                        !disabledInitially &&
                        (!$.mobile.zoom.locked || unlock === true)
                    ) {
    ...
    (function ($, undefined) {
        $.widget("mobile.textinput", {
            ...
            _classesFromOptions: function () {
                ...
                classes.push(
                    "ui-body-" +
                        (options.theme === null ? "inherit" : options.theme)
                );
                if (options.corners) {
            ...
            $.extend(
                {
                    ...
                    _create: function () {
                        ...
                        var self = this,
                            ...
                            trackTheme =
                                ...
                                $.mobile.getAttribute(control[0], "theme"),
                            trackThemeClass = trackTheme
                                ? " ui-bar-" + trackTheme
                                : " ui-bar-inherit",
                            cornerClass =
                                this.options.corners ||
                                control.jqmData("corners")
                                    ? " ui-corner-all"
                                    : "",
                            miniClass =
                                this.options.mini || control.jqmData("mini")
                                    ? " ui-mini"
                                    : "",
                        ...
                        if (isToggleSwitch) {
                            ...
                            for (
                                j = 0, length = domSlider.childNodes.length;
                                j < length;
                                j++
                            ) {
                            ...
                            for (
                                i = 0, optionsCount = options.length;
                                i < optionsCount;
                                i++
                            ) {
                                side = !i ? "b" : "a";
                        ...
                        slider
                            .bind(
                                "vmousedown",
                                $.proxy(this._sliderVMouseDown, this)
                            )
                            .bind("vclick", false);
                    ...
                    refresh: function (val, isfromControl, preventInputUpdate) {
                        ...
                        step =
                            isInput && parseFloat(control.attr("step")) > 0
                                ? parseFloat(control.attr("step"))
                                : 1;
                        ...
                        if (pxStep > 1 && isInput) {
                            percent =
                                (newval - min) * percentPerStep * (1 / step);
                        }
                        if (percent < 0) {
                            percent = 0;
                        }
                        ...
                        if (this._labels) {
                            handlePercent =
                                (this.handle.width() / this.slider.width()) *
                                100;
                            aPercent =
                                percent &&
                                handlePercent +
        ...
        $.widget("mobile.slider", $.mobile.slider, {
            ...
            _positionPopup: function () {
                ...
                this._popup.offset({
                    left:
                        dstOffset.left +
                        (this.handle.width() - this._popup.width()) / 2,
            ...
            _setOption: function (key, value) {
                ...
                if (key === "showValue") {
                    this.handle.html(
                        value && !this.options.mini ? this._value() : ""
                    );
            ...
            $.extend(
                {
                    ...
                    _create: function () {
                        if (!this.options.enhanced) {
                            ...
                            $.extend(this, {
                                ...
                                on: this.element
                                    .find(".ui-flipswitch-on")
                                    .eq(0),
                                off: this.element
                                    .find(".ui-flipswitch-off")
                                    .eq(0),
                    ...
                    _enhance: function () {
                        var flipswitch = $("<div>"),
                            ...
                            onText =
                                type === "INPUT"
                                    ? options.onText
                                    : element.find("option").eq(1).text(),
                            offText =
                                type === "INPUT"
                                    ? options.offText
                                    : element.find("option").eq(0).text();
                        ...
                        flipswitch
                            .addClass(
                                "ui-flipswitch ui-shadow-inset " +
                                    ...
                                    " " +
                                    (element.is(":checked") ||
                                    element.find("option").eq(1).is(":selected")
                    ...
                    refresh: function () {
                        ...
                        if (this.type === "SELECT") {
                            ...
                            direction = this.element.prop("checked")
                                ? "_right"
                                : "_left";
                        }
                    ...
                    _toggle: function () {
                        var direction = this.flipswitch.hasClass(
                            "ui-flipswitch-active"
                        )
                            ? "_left"
                            : "_right";
                    ...
                    _setOptions: function (options) {
                        if (options.theme !== undefined) {
                            var currentTheme = options.theme
                                    ? options.theme
                                    : "inherit",
            ...
            $.extend(
                {
                    ...
                    _create: function () {
                        var $el = this.element,
                            ...
                            _sliderWidgetFirst =
                                $.data(_inputFirst.get(0), "mobile-slider") ||
                                $.data(
                                    _inputFirst.slider().get(0),
                                    "mobile-slider"
                                ),
                            _sliderWidgetLast =
                                $.data(_inputLast.get(0), "mobile-slider") ||
                                $.data(
                                    _inputLast.slider().get(0),
                                    "mobile-slider"
                                ),
                    ...
                    _slidedrag: function (event) {
                        ...
                        if (
                            ...
                            $.data(otherSlider.get(0), "mobile-slider").refresh(
                                event
                            );
                            return false;
                        }
                    ...
                    _slidebeforestart: function (event) {
                        ...
                        if (
                            $(event.originalEvent.target).hasClass(
                                "ui-slider-track"
                            )
                        ) {
    ...
    (function ($, undefined) {
        $.widget("mobile.textinput", $.mobile.textinput, {
            ...
            _setOptions: function (options) {
                ...
                if (
                    options.clearBtnText !== undefined &&
                    this._clearBtn !== undefined
                ) {
                    this._clearBtn
                        .text(options.clearBtnText)
    ...
    (function ($, undefined) {
        $.widget(
            ...
            $.extend(
                {
                    ...
                    _preExtension: function () {
                        var inline =
                                this.options.inline ||
                                this.element.jqmData("inline"),
                            mini =
                                this.options.mini ||
                                this.element.jqmData("mini"),
                            classes = "";
			...
			classes = $el[0].className;
                        ...
                        if (
                            !!~this.element[0].className.indexOf("ui-btn-left")
                        ) {
                            classes = " ui-btn-left";
                        }
                        ...
                        this.selectId =
                            this.select.attr("id") || "select-" + this.uuid;
    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.popup", {
            ...
            _handleDocumentVmousedown: function (theEvent) {
                if (
                    this._isOpen &&
                    $.contains(this._ui.container[0], theEvent.target)
                ) {
            ...
            _create: function () {
                ...
                this._setTolerance(currentOptions.tolerance)._ui.focusElement =
                    this._ui.container;
            ...
            _handleWindowKeyUp: function (theEvent) {
                if (
                    this._isOpen &&
                    theEvent.keyCode === $.mobile.keyCode.ESCAPE
                ) {
            ...
            _expectResizeEvent: function () {
                ...
                if (this._resizeData) {
                    if (
                        windowCoordinates.x ===
                            this._resizeData.windowCoordinates.x &&
                        windowCoordinates.y ===
                            this._resizeData.windowCoordinates.y &&
                        windowCoordinates.cx ===
                            this._resizeData.windowCoordinates.cx &&
                        windowCoordinates.cy ===
                            this._resizeData.windowCoordinates.cy
                    ) {
                ...
                if (value) {
                    ...
                    if (value !== "none") {
                        this._fallbackTransition =
                            $.mobile._maybeDegradeTransition(value);
            ...
            _createPrerequisites: function (
                ...
                $.when(prerequisites.screen, prerequisites.container).done(
                    function () {
                        if (prerequisites === self._prerequisites) {
            ...
            _reposition: function (openOptions) {
                ...
                this._ui.container.offset(
                    this._placementCoords(this._desiredCoords(openOptions))
                );
            },
			...
			*/
            ...
            open: function (options) {
                ...
                currentIsDialog = activePage
                    ? activePage.hasClass("ui-dialog")
                    : false;
                this._myUrl = url = urlHistory.getActive().url;
                hasHash =
                    url.indexOf(hashkey) > -1 &&
                    !currentIsDialog &&
                ...
                if (url.indexOf(hashkey) === -1 && !currentIsDialog) {
                    url =
                        url + (url.indexOf("#") > -1 ? hashkey : "#" + hashkey);
                } else {
    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.selectmenu", $.mobile.selectmenu, {
            _create: function () {
                ...
                o.nativeMenu =
                    o.nativeMenu ||
                    this.element.parents(":jqmData(role='popup'),:mobile-popup")
                        .length > 0;
            ...
            _buildList: function () {
                ...
                for (i = 0; i < numOptions; i++, isPlaceholderItem = false) {
                    ...
                    if (
                        parent !== select &&
                        parent.nodeName.toLowerCase() === "optgroup"
                    ) {
            ...
            $.extend(
                {
                    ...
                    _create: function () {
                        ...
                        $.each(
                            this._childWidgets,
                            $.proxy(function (number, widgetName) {
                        ...
                        if (opts.enhanced) {
                            this._ui = {
                                groupLegend: elem
                                    .children(".ui-controlgroup-label")
                                    .children(),
                    ...
                    _setOptions: function (options) {
                        ...
                        if (options.theme !== undefined) {
                            elem.removeClass(
                                this._themeClassFromOption(this.options.theme)
                            ).addClass(
                                this._themeClassFromOption(options.theme)
                            );
                        }
                    ...
                    refresh: function () {
                        ...
                        if ($.mobile.checkboxradio) {
                            $el.find(":mobile-checkboxradio").checkboxradio(
                                "refresh"
                            );
                        }
                        this._addFirstLastClasses(
    ...
    (function ($, undefined) {
        $.widget("mobile.toolbar", {
            ...
            _addHeaderButtonClasses: function () {
                ...
                this.leftbtn =
                    headerAnchors.hasClass("ui-btn-left") &&
                ...
                this.rightbtn =
                    this.rightbtn ||
                    headerAnchors.eq(1).addClass("ui-btn-right").length;
            },
        ...
        $.widget("mobile.toolbar", $.mobile.toolbar, {
            ...
            _addTransitionClass: function () {
                ...
                if (tclass && tclass !== "none") {
                    ...
                    if (tclass === "slide") {
                        tclass = this.element.hasClass("ui-header")
                            ? "slidedown"
                            : "slideup";
                    }
            ...
            updatePagePadding: function (tbPage) {
                ...
                tbPage =
                    (tbPage && tbPage.type === undefined && tbPage) ||
                    this.page ||
                    $el.closest(".ui-page");
            ...
            hide: function (notransition) {
                var hideClass = "ui-fixed-hidden",
                    ...
                    outclass =
                        "out" +
                        (this.options.transition === "slide" ? " reverse" : "");
            ...
            _bindToggleHandlers: function () {
                ...
                page.bind("vclick", function (e) {
                    if (
                        o.tapToggle &&
                        !$(e.target).closest(o.tapToggleBlacklist).length
                    ) {
                        self.toggle();
                    }
                ...
                if (this.options.position === "fixed") {
                    hasFixed =
                        $("body>.ui-" + this.role + "-fixed")
                            .add(
                                page.find(".ui-" + this.options.role + "-fixed")
                            )
                    ...
                    hasFullscreen =
                        $("body>.ui-" + this.role + "-fixed")
                            .add(
                                page.find(
                                    ".ui-" + this.options.role + "-fullscreen"
                                )
                            )
                            .not(this.element).length > 0;
                    toolbarClasses =
        ...
        $.widget("mobile.toolbar", $.mobile.toolbar, {
            ...
            _viewportOffset: function () {
                var $el = this.element,
                    ...
                    offset = Math.abs(
                        $el.offset().top - this.window.scrollTop()
                    );
                if (!header) {
                    offset =
                        Math.round(
                            offset - this.window.height() + $el.outerHeight()
                        ) - 60;
                }
                return offset;
            },
            ...
            _triggerRedraw: function () {
                var paddingBottom = parseFloat(
                    $(".ui-page-active").css("padding-bottom")
                );
        ...
        $.widget("mobile.popup", $.mobile.popup, {
            ...
            _tryAnArrow: function (p, dir, desired, s, best) {
                ...
                desiredForArrow[p.fst] =
                    desired[p.fst] +
                    (s.arHalf[p.oDimKey] + s.menuHalf[p.oDimKey]) *
                        p.offsetFactor -
                    s.contentBox[p.fst] +
                    (s.clampInfo.menuSize[p.oDimKey] -
                        s.contentBox[p.oDimKey]) *
                        p.arrowOffsetFactor;
                desiredForArrow[p.snd] = desired[p.snd];

                result =
                    s.result ||
                    this._calculateFinalLocation(desiredForArrow, s.clampInfo);
                ...
                diff =
                    Math.abs(desired.x - tip.x) + Math.abs(desired.y - tip.y);
        ...
        $.widget("mobile.panel", {
            options: {
                classes: {
                    ...
                    pageContentPrefix:
                        "ui-panel-page-content" /* Used for wrapper and fixed toolbars position, display and open classes. */,
            ...
            _getFixedToolbars: function () {
                var extFixedToolbars = $("body").children(
                        ".ui-header-fixed, .ui-footer-fixed"
                    ),
                    intFixedToolbars = this._page().find(
                        ".ui-header-fixed, .ui-footer-fixed"
                    ),
            ...
            _handleClick: function (e) {
                ...
                if (
                    e.currentTarget.href.split("#")[1] === panelId &&
                    panelId !== undefined
                ) {
                    e.preventDefault();
                    link = $(e.target);
                    ...
                    var self = this,
                        ...
                        _openPanel = function () {
                            ...
                            self._modalOpenClasses =
                                self._getPosDisplayClasses(o.classes.modal) +
                                " " +
                                o.classes.modalOpen;
                            if (self._modal) {
                                self._modal
                    ...
                    var self = this,
                        ...
                        _closePanel = function () {
                            ...
                            if (o.display !== "overlay") {
                                ...
                                self._fixedToolbars().removeClass(
                                    self._pageContentOpenClasses
                                );
                            }
            ...
            _destroy: function () {
                var otherPanels,
                    o = this.options,
                    multiplePanels =
                        $("body > :mobile-panel").length +
                            $.mobile.activePage.find(":mobile-panel").length >
                        1;
                ...
                if (o.display !== "overlay") {
                    ...
                    if (this._open) {
                        this._fixedToolbars().removeClass(
                            o.classes.pageContentPrefix + "-open"
                        );
    ...
    (function ($, undefined) {
        $.widget("mobile.table", $.mobile.table, {
            ...
            _create: function () {
                ...
                if (this.options.enhanced) {
                    this._menu = $(
                        this.document[0].getElementById(this._id() + "-popup")
                    )
                        .children()
                        .first();
            ...
            _setToggleState: function () {
                this._menu.find("input").each(function () {
                    ...
                    this.checked =
                        checkbox.jqmData("cells").eq(0).css("display") ===
                        "table-cell";
    ...
    (function ($, undefined) {
        $.widget("mobile.table", $.mobile.table, {
            ...
            _addLabels: function (cells, label, contents) {
                if (
                    contents.length === 1 &&
                    contents[0].nodeName.toLowerCase() === "abbr"
                ) {
                ...
                cells
                    .not(":has(b." + label + ")")
                    .prepend(
                        $("<b class='" + label + "'></b>").append(contents)
                    );
            },
        });
    })(jQuery);
    ...
    (function ($, undefined) {
        ...
        var defaultFilterCallback = function (index, searchValue) {
            return (
                (
                    "" +
                    ($.mobile.getAttribute(this, "filtertext") ||
                        $(this).text())
                )
                    .toLowerCase()
            ...
            _onKeyUp: function () {
                ...
                if (search) {
                    (val = search.val().toLowerCase()),
                        (lastval =
                            $.mobile.getAttribute(search[0], "lastval") + "");
            ...
            _filterItems: function (val) {
                ...
                if (val != null) {
                    ...
                    for (idx = 0; idx < length; idx++) {
                        dst = callback.call(filterItems[idx], idx, val)
                            ? hide
                            : show;
                ...
                if (hide.length === 0) {
                    filterItems[
                        opts.filterReveal && val.length === 0
                            ? "addClass"
                            : "removeClass"
                    ]("ui-screen-hidden");
                } else {
    ...
    (function ($, undefined) {
        ...
        $.mobile.filterable.prototype.options.filterCallback = function (
            ...
            return (
                !this.className.match(rDividerListItem) &&
        ...
        $.widget("mobile.filterable", $.mobile.filterable, {
            ...
            _create: function () {
                ...
                for (idx = recognizedWidgets.length - 1; idx > -1; idx--) {
                    ...
                    if ($.mobile[widgetName]) {
                        if (
                            this._setWidget(elem.data("mobile-" + widgetName))
                        ) {
                            break;
                        } else {
                            createHandlers[widgetName + "create"] =
                                "_handleCreate";
                        }
                    }
                }
            ...
            _handleCreate: function (evt) {
                this._setWidget(
                    this.element.data(
                        "mobile-" + evt.type.substring(0, evt.type.length - 6)
                    )
                );
            },
                    ...
                    for (idx in $.mobile.textinput.prototype.options) {
                        if (options[idx] !== undefined) {
                            if (
                                ...
                                textinputOptions[idx] =
                                    this.options.filterTheme;
                            } else {
            ...
            _create: function () {
                ...
                this.element
                    ...
                    .delegate(
                        ...
                        function () {
                            if (
                                $(this).closest("li").is(".ui-state-disabled")
                            ) {
                                this.blur();
                            }
                        }
    ...
    (function ($, window, undefined) {
        ...
        $(function () {
            ...
            $.mobile.defaultHomeScroll =
                !$.support.scrollTop || $.mobile.window.scrollTop() === 1
                    ? 0
                    : 1;
