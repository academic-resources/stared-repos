...
$(function () {
    $.mobile.window.on("scroll", function (e) {
        ...
        if (headTop < headerheight && headTop > 0) {
            ...
            headTop >= headerheight &&
            headTop > 0 &&
            parseInt(headTop + $.mobile.window.height()) <
                parseInt(foot.offset().top)
        ) {
            $("#sorter").css({
                top: "15px",
            ...
            parseInt(headTop + window.innerHeight) >=
                parseInt(foot.offset().top) &&
            parseInt(headTop + window.innerHeight) <=
                parseInt(foot.offset().top) + foot.height()
        ) {
            $("#sorter").css({
                top: "15px",
                height:
