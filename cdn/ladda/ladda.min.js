...
!(function (a, b) {
    "object" == typeof exports
        ? (module.exports = b(require("spin.js")))
    ...
    function b(a) {
        ...
        if (
            (/ladda-button/i.test(a.className) ||
                (a.className += " ladda-button"),
        ...
        var c,
            d = a.querySelector(".ladda-spinner");
        d ||
            ((d = document.createElement("span")),
            (d.className = "ladda-spinner")),
            a.appendChild(d);
        var e,
            f = {
                start: function () {
    ...
    function d(a) {
        for (
            var b = ["input", "textarea", "select"], c = [], d = 0;
            d < b.length;
            d++
        )
    ...
    function e(a, e) {
        ...
        var f = [];
        "string" == typeof a
            ? (f = h(document.querySelectorAll(a)))
            : "object" == typeof a &&
    ...
    function g(b) {
        var c,
            d,
            e = b.offsetHeight;
        0 === e && (e = parseFloat(window.getComputedStyle(b).height)),
            e > 32 && (e *= 0.8),
            b.hasAttribute("data-spinner-size") &&
                (e = parseInt(b.getAttribute("data-spinner-size"), 10)),
            b.hasAttribute("data-spinner-color") &&
                (c = b.getAttribute("data-spinner-color")),
            b.hasAttribute("data-spinner-lines") &&
                (d = parseInt(b.getAttribute("data-spinner-lines"), 10));
        var f = 0.2 * e,
            g = 0.6 * f,
            h = 7 > f ? 2 : 3;
        return new a({
