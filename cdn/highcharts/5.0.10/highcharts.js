...
(function (L, a) {
    "object" === typeof module && module.exports
        ? (module.exports = L.document ? a(L) : a)
        : (L.Highcharts = a(L));
    ...
    (function (a) {
        ...
        a.error = function (r, f) {
            r = a.isNumber(r)
                ? "Highcharts error #" + r + ": www.highcharts.com/errors/" + r
                : r;
            if (f) throw Error(r);
        ...
        a.Fx.prototype = {
            ...
            update: function () {
                ...
                if (this[f + "Setter"]) this[f + "Setter"]();
                    ...
                    a.attr
                        ? a.element && a.attr(f, l, null, !0)
                        : (a.style[f] = l + this.unit);
                q && q.call(a, l, this);
            },
            run: function (a, f, l) {
                var r = this,
                ...
                k() &&
                    1 === B.push(k) &&
                    (k.timerId = setInterval(function () {
            ...
            step: function (a) {
                ...
                if (r.attr && !r.element) r = !1;
                    ...
                    (this.pos = q.easing((f - this.startTime) / u)),
                        (this.now =
            ...
            initPath: function (r, f, l) {
                ...
                function k(a, e) {
                    for (; a.length < p; ) {
                        ...
                        D &&
                            ((h = a.slice(a.length - b)),
                            [].splice.apply(a, [a.length, 0].concat(h)),
                            t--);
                    }
                    a[0] = "M";
                }
                function u(a, e) {
                    for (var c = (p - a.length) / b; 0 < c && c--; )
                        (h = a.slice().splice(a.length / w - b, b * w)),
                            (h[0] = e[p - b - c * b]),
        ...
        a.attr = function (r, f, l) {
            ...
            if (a.isString(f))
                a.defined(l)
                    ? r.setAttribute(f, l)
                    : r && r.getAttribute && (k = r.getAttribute(f));
        ...
        a.getTZOffset = function (r) {
            ...
            return (
                6e4 *
                ((f.hcGetTimezoneOffset && f.hcGetTimezoneOffset(r)) ||
                    f.hcTimezoneOffset ||
                    0)
            );
        };
        ...
        a.destroyObjectProperties = function (a, f) {
            for (var l in a)
                a[l] && a[l] !== f && a[l].destroy && a[l].destroy(),
                    delete a[l];
        };
        ...
        a.setAnimation = function (r, f) {
            f.renderer.globalAnimation = a.pick(
                r,
        ...
        a.getStyle = function (r, f) {
            return "width" === f
                ? Math.min(r.offsetWidth, r.scrollWidth) -
                      a.getStyle(r, "padding-left") -
                      a.getStyle(r, "padding-right")
                : "height" === f
                ? Math.min(r.offsetHeight, r.scrollHeight) -
                  a.getStyle(r, "padding-top") -
                  a.getStyle(r, "padding-bottom")
                : (r = G.getComputedStyle(r, void 0)) &&
                  a.pInt(r.getPropertyValue(f));
        };
        ...
        a.map = function (a, f) {
            for (var l = [], q = 0, k = a.length; q < k; q++)
                l[q] = f.call(a[q], a[q], q, a);
            return l;
        };
        a.offset = function (a) {
            ...
            return {
                top:
                    a.top + (G.pageYOffset || f.scrollTop) - (f.clientTop || 0),
                left:
                    a.left +
                    (G.pageXOffset || f.scrollLeft) -
                    (f.clientLeft || 0),
            };
        };
        a.stop = function (a, f) {
        ...
        a.addEvent = function (r, f, l) {
            ...
            r.addEventListener
                ? r.addEventListener(f, l, !1)
                : r.attachEvent &&
                  (r.hcEventsIE || (r.hcEventsIE = {}),
                  (r.hcEventsIE[l.toString()] = q),
                  r.attachEvent("on" + f, q));
            k[f] || (k[f] = []);
            k[f].push(l);
            return function () {
                a.removeEvent(r, f, l);
        ...
        a.removeEvent = function (r, f, l) {
            function q(a, c) {
                r.removeEventListener
                    ? r.removeEventListener(a, c, !1)
                    : r.attachEvent &&
                      ((c = r.hcEventsIE[c.toString()]),
                      r.detachEvent("on" + a, c));
            }
            function k() {
                var a, c;
                if (r.nodeName)
                    for (c in (f ? ((a = {}), (a[f] = !0)) : (a = d), a))
                        if (d[c]) for (a = d[c].length; a--; ) q(c, d[c][a]);
            }
            var u,
                d = r.hcEvents,
                c;
        ...
        a.fireEvent = function (r, f, l, q) {
            ...
            var u, d;
            l = l || {};
            if (H.createEvent && (r.dispatchEvent || r.fireEvent))
                (k = H.createEvent("Events")),
                    k.initEvent(f, !0, !0),
                    a.extend(k, l),
                ...
                for (
                    ...
                    (d = k[f]) && !1 === d.call(r, l) && l.preventDefault();
        ...
        a.animate = function (r, f, l) {
            ...
            a.isObject(l) ||
                ((q = arguments),
                (l = { duration: q[2], easing: q[3], complete: q[4] }));
            ...
            for (c in f)
                a.stop(r, c),
                    ...
                    (u = null),
                    "d" === c
                        ? ((d.paths = d.initPath(r, r.d, f.d)),
                          (d.toD = f.d),
                          (q = 0),
                          (u = 1))
                        : r.attr
                        ? (q = r.attr(c))
                        : ((q = parseFloat(a.getStyle(r, c)) || 0),
                          "opacity" !== c && (k = "px")),
                    u || (u = f[c]),
        ...
        G.jQuery &&
            (G.jQuery.fn.highcharts = function () {
                ...
                if (this[0])
                    return r[0]
                        ? (new a[a.isString(r[0]) ? r.shift() : "Chart"](
                              this[0],
                              r[0],
                              r[1]
                          ),
    ...
    (function (a) {
        ...
        a.Color.prototype = {
            ...
            init: function (f) {
                ...
                if (
                    (this.input = f =
                        this.names[f && f.toLowerCase ? f.toLowerCase() : ""] ||
                        f) &&
                    f.stops
                )
                    this.stops = H(f.stops, function (d) {
            ...
            get: function (a) {
                ...
                this.stops
                    ? ((k = G(f)),
                      (k.stops = [].concat(k.stops)),
                      B(this.stops, function (u, d) {
    ...
    (function (a) {
        ...
        B.prototype = {
            ...
            init: function (a, g) {
                this.element =
                    "span" === g ? k(g) : n.createElementNS(this.SVG_NS, g);
                this.renderer = a;
            },
            animate: function (v, g, b) {
                g = a.animObject(K(g, this.renderer.globalAnimation, !0));
                0 !== g.duration
                    ? (b && (g.complete = b), G(this, v, g))
                    : (this.attr(v, null, b), g.step && g.step.call(this));
                return this;
            },
            colorGradient: function (v, g, b) {
                ...
                v.radialGradient
                    ? (c = "radialGradient")
                    : v.linearGradient && (c = "linearGradient");
                if (c) {
                    m = v[c];
                    F = e.gradients;
                    d = v.stops;
                    ...
                    F[k]
                        ? (p = F[k].attr("id"))
                        : ((m.id = p = a.uniqueKey()),
                          (F[k] = x = e.createElement(c).attr(m).add(e.defs)),
                          (x.radAttr = M),
                          (x.stops = []),
                          z(d, function (v) {
                              0 === v[1].indexOf("rgba")
            ...
            attr: function (a, g, b, e) {
                ...
                "string" === typeof a &&
                    ...
                    ((v = a), (a = {}), (a[v] = g));
                if ("string" === typeof a)
                    m = (this[a + "Getter"] || this._defaultGetter).call(
                        this,
                        a,
                        c
                    );
                    ...
                    for (v in a)
                        (g = a[v]),
                            ...
                            this.symbolName &&
                                ...
                                (h || (this.symbolAttr(a), (h = !0)), (M = !0)),
                            !this.rotation ||
                                ("x" !== v && "y" !== v) ||
                                (this.doTransform = !0),
                            M ||
                                ((M =
                                    this[v + "Setter"] || this._defaultSetter),
                                M.call(this, g, v, c),
                                this.shadows &&
                                    /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(
                                        v
                                    ) &&
                                    this.updateShadows(v, g, M));
                    this.doTransform &&
            ...
            updateShadows: function (a, g, b) {
                for (var v = this.shadows, e = v.length; e--; )
                    b.call(
                        v[e],
                        "height" === a
                            ? Math.max(g - (v[e].cutHeight || 0), 0)
                            : "d" === a
                            ? this.d
                            : g,
                        a,
            ...
            removeClass: function (a) {
                r(
                    this.element,
                    "class",
                    (r(this.element, "class") || "").replace(a, "")
                );
                return this;
            },
            symbolAttr: function (a) {
                ...
                v.attr({
                    d: v.renderer.symbols[v.symbolName](
                        v.x,
                        v.y,
                        v.width,
                        v.height,
            ...
            setRadialReference: function (a) {
                ...
                v &&
                    v.radAttr &&
                    v.animate(this.renderer.getRadialAttr(a, v.radAttr));
                return this;
            },
            ...
            align: function (a, g, e) {
                ...
                if (a) {
                    if (
                        ((this.alignOptions = a),
                        (this.alignByTranslate = g),
                        !e || E(e))
                    )
                        (this.alignTo = v = e || "renderer"),
                            p(c, this),
                            c.push(this),
                            (e = null);
                } else
            ...
            getBBox: function (a, g) {
                ...
                void 0 !== x &&
                    ((t = x.toString()),
                    -1 === t.indexOf("\x3c") && (t = t.replace(/[0-9]/g, "0")),
                    (t += [
                        "",
                        g || 0,
                        F,
                ...
                if (!v) {
                    ...
                    e.isSVG &&
                        ...
                        g &&
                            ((v.width =
                                Math.abs(e * Math.sin(c)) +
                                Math.abs(a * Math.cos(c))),
                            (v.height =
                                Math.abs(e * Math.cos(c)) +
                                Math.abs(a * Math.sin(c)))));
                    if (t && 0 < v.height) {
            ...
            destroy: function () {
                ...
                a.clipPath &&
                    (z(
                        a.element.ownerSVGElement.querySelectorAll(
                            "[clip-path]"
                        ),
                        function (v) {
                            -1 <
                        ...
                        (c = h.cloneNode(0)),
                            ...
                            e &&
                                (r(
                                    c,
                                    "height",
                                    Math.max(r(c, "height") - m, 0)
                                ),
                                (c.cutHeight = m)),
                            g
                                ? g.element.appendChild(c)
            ...
            titleSetter: function (a) {
                ...
                v ||
                    ((v = n.createElementNS(this.SVG_NS, "title")),
                    this.element.appendChild(v));
                v.firstChild && v.removeChild(v.firstChild);
                v.appendChild(
                    n.createTextNode(String(K(a), "").replace(/<[^>]*>/g, ""))
                );
            },
            ...
            function (a, g, e) {
                ...
                this.stroke && this["stroke-width"]
                    ...
                    : "stroke-width" === g &&
                      0 === a &&
                      this.hasStroke &&
                      (e.removeAttribute("stroke"), (this.hasStroke = !1));
            };
        ...
        A.prototype = {
            ...
            init: function (a, g, b, c, h, F) {
                var v;
                c = this.createElement("svg")
                    .attr({ version: "1.1", class: "highcharts-root" })
                    .css(this.getStyle(c));
                v = c.element;
                a.appendChild(v);
                -1 === a.innerHTML.indexOf("xmlns") &&
                    r(v, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = v;
                this.boxWrapper = c;
                this.alignedObjects = [];
                this.url =
                    (e || m) && n.getElementsByTagName("base").length
                        ? O.location.href
                              .replace(/#.*?$/, "")
                              .replace(/<[^>]*>/g, "")
                              .replace(/([\('\)])/g, "\\$1")
                ...
                this.createElement("desc")
                    .add()
                    .element.appendChild(
                        n.createTextNode("Created with Highcharts 5.0.10")
                    );
                ...
                e &&
                    ...
                    g(),
                    (this.unSubPixelFix = H(O, "resize", g)));
            },
            getStyle: function (a) {
                return (this.style = b(
                    {
            ...
            getSpanWidth: function (a, g) {
                ...
                !Q &&
                    this.forExport &&
                    (v = this.measureSpanWidth(g.firstChild.data, a.styles));
                return v;
            },
            ...
            buildText: function (a) {
                var g = a.element,
                    ...
                    P = function (a) {
                        var v;
                        v = /(px|em)$/.test(a && a.style.fontSize)
                            ? a.style.fontSize
                            : E || e.style.fontSize || 12;
                        return k
                            ? J(k)
                            : e.fontMetrics(v, a.getAttribute("style") ? a : g)
                                  .h;
                    };
                ...
                if (D !== a.textCache) {
                    ...
                    c || w || u || p || -1 !== b.indexOf(" ")
                        ? ((F = /<.*class="([^"]+)".*>/),
                          ...
                          t && a.attr("title", a.textStr),
                          C && C.removeChild(g),
                          w && a.applyTextOutline && a.applyTextOutline(w))
                        : g.appendChild(
                              n.createTextNode(
                                  b
                                      .replace(/&lt;/g, "\x3c")
            ...
            button: function (a, g, e, c, m, h, F, C, t) {
                ...
                v.attr(m).css(b({ cursor: "default" }, p));
            ...
            image: function (a, g, e, c, m) {
                ...
                1 < arguments.length &&
                    b(v, { x: g, y: e, width: c, height: m });
                v = this.createElement("image").attr(v);
                v.element.setAttributeNS
                    ? v.element.setAttributeNS(
                          "http://www.w3.org/1999/xlink",
                          "href",
                          a
                      )
                    : v.element.setAttribute("hc-svg-href", a);
                return v;
            },
            symbol: function (a, g, e, c, m, h) {
                var v = this,
                    ...
                    y =
                        u(g) &&
                        x &&
                        this.symbols[a](Math.round(g), Math.round(e), c, m, h),
                    C = /^url\((.*?)\)$/,
                    d,
                    t;
                x
                    ? ((F = this.path(y)),
                      F.attr("fill", "none"),
                      b(F, { symbolName: a, x: g, y: e, width: c, height: m }),
                      h && b(F, h))
                    : C.test(a) &&
                      ((d = a.match(C)[1]),
                      (F = this.image(d)),
                      (F.imgwidth = K(P[d] && P[d].width, h && h.width)),
                      (F.imgheight = K(P[d] && P[d].height, h && h.height)),
                      (t = function () {
            ...
            fontMetrics: function (a, g) {
                a =
                    a ||
                    (g && g.style && g.style.fontSize) ||
                    (this.style && this.style.fontSize);
                a = /px/.test(a)
                    ? J(a)
                    : /em/.test(a)
                    ? parseFloat(a) *
                      (g ? this.fontMetrics(null, g.parentNode).f : 16)
                    : 12;
                g = 24 > a ? a + 3 : Math.round(1.2 * a);
                return { h: g, b: Math.round(0.8 * g), f: a };
            },
            ...
            label: function (e, c, m, h, F, x, C, d, t) {
                var v = this,
                    ...
                    n = (p.text = v.text("", 0, 0, C).attr({ zIndex: 1 })),
                    k,
                    w,
                    E = 0,
                    f = 3,
                ...
                S = function () {
                    ...
                    P &&
                        (k ||
                            ((p.box = k =
                                v.symbols[h] || M ? v.symbol(h) : v.rect()),
                            k.addClass(
                                ("button" === t ? "" : "highcharts-label-box") +
                                    (t ? " highcharts-" + t + "-box" : "")
                            ),
                            k.add(p),
                            (a = R()),
                            (g.x = a),
                            (g.y = (d ? -r : 0) + a)),
                        (g.width = Math.round(p.width)),
                        (g.height = Math.round(p.height)),
                        k.attr(b(g, K)),
                        (K = {}));
                };
                O = function () {
                    ...
                    u(I) &&
                        w &&
                        ("center" === N || "right" === N) &&
                        (a += { center: 0.5, right: 1 }[N] * (I - w.width));
                    if (a !== n.x || g !== n.y)
                        n.attr("x", a), void 0 !== g && n.attr("y", g);
                    n.x = a;
                    n.y = g;
                };
                U = function (a, g) {
    ...
    (function (a) {
        ...
        f(a.SVGElement.prototype, {
            ...
            htmlUpdateTransform: function () {
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        ...
                        y !== this.cTT &&
                            ((x = a.fontMetrics(b.style.fontSize).b),
                            G(C) && this.setSpanRotation(C, e, x),
                            H(b, { width: "", whiteSpace: m || "nowrap" }),
                            b.offsetWidth > f &&
            ...
            setSpanRotation: function (a, b, p) {
                ...
                h[d + (l ? "Origin" : "-origin")] = h.transformOrigin =
                    100 * b + "% " + p + "px";
                H(this.element, h);
            },
        ...
        a.svg ||
            ((A = {
                ...
                init: function (a, b) {
                    var e = ["\x3c", b, ' filled\x3d"f" stroked\x3d"f"'],
                        ...
                        m = "div" === b;
                    ("shape" === b || m) &&
                        c.push("left:0;top:0;width:1px;height:1px;");
                ...
                getSpanCorrection: function (a, b, c, h, m) {
                    ...
                    m &&
                        "left" !== m &&
                        ((this.xCorr -= a * c * (0 > e ? -1 : 1)),
                        h && (this.yCorr -= d * c * (0 > x ? -1 : 1)),
                        G(this.element, { textAlign: m }));
                },
                pathToVML: function (a) {
                    for (var e = a.length, b = []; e--; )
                        n(a[e])
                            ? (b[e] = Math.round(10 * a[e]) - 5)
                            : "Z" === a[e]
                            ? (b[e] = "x")
                            : ((b[e] = a[e]),
                              !a.isArc ||
                ...
                clip: function (a) {
                    ...
                    a
                        ? ((b = a.members),
                          u(b, e),
                          b.push(e),
                          (e.destroyClip = function () {
                              u(b, e);
                          }),
                          (a = a.getCSS(e)))
                        : (e.destroyClip && e.destroyClip(),
                          (a = {
                ...
                shadow: function (a, b, c) {
                    ...
                    if (a) {
                        ...
                        for (m = 1; 3 >= m; m++)
                            (k = 2 * w + 1 - 2 * m),
                                c && (C = this.cutOffPath(F.value, k + 0.5)),
                                (g = [
            ...
            (A = {
                ...
                color: function (b, c, h, d) {
                    ...
                    b && b.linearGradient
                        ? (x = "gradient")
                        : b && b.radialGradient && (x = "pattern");
                    if (x) {
                        var F,
                            w,
                            f = b.linearGradient || b.radialGradient,
                            C,
                            u,
                            v,
                            D,
                            ...
                            if ("gradient" === x)
                                ...
                                var g = f.r,
                                    ...
                                    g = function () {
                                        L &&
                                            ((T = d.getBBox()),
                                            (G += (L[0] - T.x) / T.width - 0.5),
                                            (V +=
                                                (L[1] - T.y) / T.height - 0.5),
                                            (A *= L[2] / T.width),
                                            (B *= L[2] / T.height));
                                        l =
                                            'src\x3d"' +
                        ...
                        t.test(b) && "IMG" !== c.tagName
                            ? ((p = a.color(b)),
                              d[h + "-opacitySetter"](p.get("a"), h, c),
                              (g = p.get("rgb")))
                            : ((g = c.getElementsByTagName(h)),
                              g.length &&
                                  ((g[0].opacity = 1), (g[0].type = "solid")),
                              (g = b));
                    return g;
                },
                prepVML: function (a) {
                ...
                image: function (a, b, c, h, m) {
                    ...
                    1 < arguments.length &&
                        e.attr({ x: b, y: c, width: h, height: m });
                    return e;
                },
                createElement: function (a) {
                    return "rect" === a
                ...
                symbols: {
                    ...
                    rect: function (a, b, c, h, m) {
                        return D.prototype.symbols[
                            r(m) && m.r ? "callout" : "square"
                        ].call(0, a, b, c, h, m);
                    },
                },
            }),
    ...
    (function (a) {
        ...
        function A() {
            ...
            f.hcMakeTime = function (a, b, c, h, t, n) {
                var p;
                d
                    ? ((p = f.UTC.apply(0, arguments)), (p += r(p)))
                    : (p = new f(
                          a,
                          b,
                          l(c, 1),
        ...
        a.defaultOptions = {
            ...
            global: {
                useUTC: !0,
                VMLRadialGradientURL:
                    "http://code.highcharts.com/5.0.10/gfx/vml-radial-gradient.png",
            },
            chart: {
                borderRadius: 0,
    ...
    (function (a) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                ...
                D
                    ? ((x = { stroke: E, "stroke-width": c.width }),
                      c.dashStyle && (x.dashstyle = c.dashStyle))
                    : t &&
                      (E && (x.fill = E),
                      c.borderWidth &&
                ...
                I.zIndex = m;
                J += "-" + m;
                (E = f.plotLinesAndBandsGroups[J]) ||
                    (f.plotLinesAndBandsGroups[J] = E =
                        r
                            .g("plot-" + J)
                            .attr(I)
                            .add());
            ...
            renderLabel: function (a, f, d, c) {
                ...
                n ||
                    ...
                    (n.zIndex = c),
                    (this.label = n =
                        k.text(a.text, 0, 0, a.useHTML).attr(n).add()),
                    n.css(a.style));
                c = [f[1], f[4], d ? f[6] : f[1]];
                f = [f[2], f[5], d ? f[7] : f[2]];
                d = A(c);
        ...
        a.AxisPlotLineOrBandExtension = {
            getPlotBandPath: function (a, f) {
                ...
                c && d
                    ? (a && ((c.flat = c.toString() === d.toString()), (k = 0)),
                      c.push(
                          n && d[4] === c[4] ? d[4] + k : d[4],
                          n || d[5] !== c[5] ? d[5] : d[5] + k,
                          n && d[1] === c[1] ? d[1] + k : d[1],
        ...
        a.Tick.prototype = {
            addLabel: function () {
                ...
                a.isDatetimeAxis &&
                    b &&
                    (t =
                        k.dateTimeLabelFormats[b.higherRanks[n] || b.unitName]);
                this.isFirst = p;
                this.isLast = h;
            ...
            handleOverflow: function (a) {
                var k = this.axis,
                    ...
                    z = this.label,
                    b = this.rotation,
                    p = { left: 0, center: 0.5, right: 1 }[k.labelAlign],
                    h = z.getBBox().width,
                    t = k.getSlotWidth(),
                    D = t,
                    w = 1,
                ...
                if (b)
                    0 > b && q - p * h < n
                        ? (e = Math.round(q / Math.cos(b * l) - n))
                        : 0 < b &&
                          q + p * h > c &&
                          (e = Math.round((d - q) / Math.cos(b * l)));
                else if (
                    ((d = q + (1 - p) * h),
                    q - p * h < n
                        ? (D = a.x + D * (1 - p) - n)
                    ...
                    D < t &&
                        "center" === k.labelAlign &&
                        (a.x += w * (t - D - p * (t - Math.min(h, D)))),
                    h > D || (k.autoRotation && (z.styles || {}).width))
                )
                    e = D;
                e &&
                    ((x.width = e),
            ...
            getPosition: function (a, f, l, d) {
                ...
                return {
                    x: a
                        ? c.translate(f + l, null, null, d) + c.transB
                        : c.left +
                          c.offset +
                          (c.opposite
                              ? ((d && n.oldChartWidth) || n.chartWidth) -
                                c.right -
                                c.left
                              : 0),
                    y: a
                        ? k - c.bottom + c.offset - (c.opposite ? c.height : 0)
                        : k - c.translate(f + l, null, null, d) - c.transB,
                };
            },
                ...
                A(e) ||
                    (e =
                        0 === p.side
                            ...
                            : 2 === p.side
                            ? w.y + 8
                            : Math.cos(u.rotation * l) *
                              (w.y - u.getBBox(!1, 0).height / 2));
                ...
                n ||
                    ...
                    (this.gridLine = n =
                        t
                            ...
                            .attr(k)
                            .addClass(
                                "highcharts-" + (p ? p + "-" : "") + "grid-line"
                            )
                            .add(d.gridGroup)));
                if (
                    !a &&
                    n &&
                    (a = d.getPlotLinePath(b + h, n.strokeWidth() * l, a, !0))
                )
                    n[this.isNew ? "attr" : "animate"]({ d: a, opacity: f });
            },
                    ...
                    t &&
                        ((this.mark = h =
                            n
                                ...
                                .add(d.axisGroup)),
                        h.attr({ stroke: c, "stroke-width": w })),
                    h[t ? "attr" : "animate"]({
                        d: this.getMarkPath(
                            D,
                            a,
            ...
            renderLabel: function (a, k, l, d) {
                ...
                b &&
                    G(w) &&
                    ((b.xy = a = this.getLabelPosition(w, a, b, n, p, t, d, h)),
                    (this.isFirst && !this.isLast && !f(q.showFirstLabel, 1)) ||
                    (this.isLast && !this.isFirst && !f(q.showLastLabel, 1))
                        ? (D = !1)
                        : !n ||
                          c.isRadial ||
                          p.step ||
        ...
        a.Axis.prototype = {
            ...
            init: function (a, b) {
                ...
                var c = this.options,
                    e = c.type;
                this.labelFormatter =
                    c.labels.formatter || this.defaultLabelFormatter;
                this.userOptions = b;
                ...
                this.crosshair = E(
                    c.crosshair,
                    I(a.options.tooltip.crosshairs)[g ? 0 : 1],
                    !1
                );
                var h;
                ...
                c(a.series, function (g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        ...
                        if (a.isXAxis)
                            ...
                            k(g) &&
                                k(m) &&
                                ((a.dataMin = Math.min(E(a.dataMin, g), g)),
                                (a.dataMax = Math.max(E(a.dataMax, m), m))),
                            k(e) && (a.threshold = e),
            ...
            translate: function (a, b, c, e, h, m) {
                ...
                b
                    ? ((a = (a * F + p - t) / d + e), h && (a = g.lin2val(a)))
                    : (h && (a = g.val2lin(a)),
                      (a = F * (a - e) * d + p + F * t + (w(m) ? d * m : 0)));
                return a;
            },
            ...
            getPlotLinePath: function (a, b, c, e, h) {
                var g = this.chart,
                    ...
                    p,
                    d,
                    t = (c && g.oldChartHeight) || g.chartHeight,
                    f = (c && g.oldChartWidth) || g.chartWidth,
                    n;
                p = this.transB;
                var y = function (a, b, g) {
                    if (a < b || a > g)
                        e ? (a = Math.min(Math.max(b, a), g)) : (n = !0);
                    return a;
                };
                ...
                w(h)
                    ? this.horiz
                        ? ((p = F),
                          (d = t - this.bottom),
                          (a = c = y(a, m, m + this.width)))
                        : ((a = m),
                          (c = f - this.right),
                          (p = d = y(p, F, F + this.height)))
                    : (n = !0);
                return n && !e
                    ? null
                    : g.renderer.crispLine(["M", a, p, "L", c, d], b || 1);
            },
            getLinearTickPositions: function (a, b, c) {
                var g,
                    e = l(Math.floor(b / a) * a);
                c = l(Math.ceil(c / a) * a);
                var h = [];
            ...
            getMinorTickPositions: function () {
                ...
                if (d && d / h < a.len / 3)
                    if (a.isLog)
                        c(this.paddedTicks, function (b, g, c) {
                            g &&
                                m.push.apply(
                                    m,
                                    a.getLogTickPositions(h, c[g - 1], c[g], !0)
                                );
                        });
                    else if (a.isDatetimeAxis && "auto" === b.minorTickInterval)
                        m = m.concat(
                            a.getTimeTicks(
                                a.normalizeTimeTickInterval(h),
                                v,
                                p,
                                b.startOfWeek
                            )
                ...
                0 < this.names.length &&
                    ...
                    c(this.series || [], function (b) {
                        ...
                        if (!b.points || b.isDirtyData)
                            b.processData(), b.generatePoints();
            ...
            setAxisTranslation: function (a) {
                ...
                if (n || t || h)
                    (m = b.getClosest()),
                        d
                            ? ((p = d.minPointOffset),
                              (v = d.pointRangePadding))
                            : c(b.series, function (a) {
                                  var g = t
                                      ? 1
                                      : n
                                      ? E(a.options.pointRange, m, 0)
                                      : b.axisPointRange || 0;
                                  a = a.options.pointPlacement;
                                  h = Math.max(h, g);
                                  b.single ||
                                      ((p = Math.max(p, e(a) ? 0 : g / 2)),
                                      (v = Math.max(v, "on" === a ? 0 : g)));
                              }),
                ...
                b.translationSlope =
                    b.transA =
                    f =
                        b.options.staticScale || b.len / (g + v || 1);
            ...
            setTickInterval: function (b) {
                ...
                A = E(g.userMax, h.max);
                f
                    ? ((g.linkedParent = e[g.coll][h.linkedTo]),
                      (e = g.linkedParent.getExtremes()),
                      (g.min = E(e.min, e.dataMin)),
                      (g.max = E(e.max, e.dataMax)),
                      h.type !== g.linkedParent.options.type && a.error(11, 1))
                    : (!u &&
                          k(q) &&
                          (g.dataMin >= q
                              ? ((r = q), (y = 0))
                              : g.dataMax <= q && ((K = q), (n = 0))),
                      (g.min = E(J, r, g.dataMin)),
                      (g.max = E(A, K, g.dataMax)));
                m &&
                    (g.positiveValuesOnly &&
                        !b &&
                        0 >= Math.min(g.min, E(g.dataMin, g.min)) &&
                        a.error(10, 1),
                    (g.min = l(d(g.min), 15)),
                    (g.max = l(d(g.max), 15)));
                g.range &&
                    ...
                    ((g.userMin =
                        g.min =
                        J =
                            Math.max(g.min, g.minFromRange())),
                    (g.userMax = A = g.max),
                    (g.range = null));
                z(g, "foundExtremes");
                g.beforePadding && g.beforePadding();
                g.adjustForMinRange();
                !(I || g.axisPointRange || g.usePercentage || f) &&
                    k(g.min) &&
                    k(g.max) &&
                    (d = g.max - g.min) &&
                    (!k(J) && y && (g.min -= d * y),
                ...
                u &&
                    k(g.dataMin) &&
                    ((q = q || 0),
                    !k(J) && g.min < q && g.dataMin >= q
                        ? (g.min = q)
                        : !k(A) && g.max > q && g.dataMax <= q && (g.max = q));
                g.tickInterval =
                    g.min === g.max || void 0 === g.min || void 0 === g.max
                        ? 1
                        : f &&
                          !x &&
                          D === g.linkedParent.options.tickPixelInterval
                        ? (x = g.linkedParent.tickInterval)
                        : E(
                              x,
                              this.tickAmount
                                  ? (g.max - g.min) /
                                  ...
                                  : void 0,
                              I ? 1 : ((g.max - g.min) * D) / Math.max(g.len, D)
                          );
                t &&
                    !b &&
                ...
                g.postProcessTickInterval &&
                    (g.tickInterval = g.postProcessTickInterval(
                        g.tickInterval
                    ));
                g.pointRange &&
                    !x &&
                    (g.tickInterval = Math.max(g.pointRange, g.tickInterval));
                b = E(
                    h.minTickInterval,
                    g.isDatetimeAxis && g.closestPointRange
                );
            ...
            setAxisSize: function () {
                var a = this.chart,
                    ...
                    c = /%$/;
                c.test(m) &&
                    (m = Math.round((parseFloat(m) / 100) * a.plotHeight));
                c.test(p) &&
                    (p = Math.round(
                        (parseFloat(p) / 100) * a.plotHeight + a.plotTop
                    ));
                this.left = b;
                this.top = p;
                this.width = h;
            ...
            unsquish: function () {
                ...
                b
                    ? (y =
                          ...
                          (k(d)
                              ? [d]
                              : m < E(a.autoRotationLimit, 80) &&
                                a.autoRotation)) &&
                      c(y, function (a) {
                          var b;
                          if (a === d || (a && -90 <= a && 90 >= a))
                              (f = w(Math.abs(t.h / Math.sin(u * a)))),
                                  (b = f + Math.abs(a / 360)),
                                  b < n && ((n = b), (p = a), (h = f));
                      })
                    : a.step || (h = w(t.h));
            ...
            getSlotWidth: function () {
                ...
                return (
                    (b &&
                        2 > (c.step || 0) &&
                        !c.rotation &&
                        ((this.staggerLines || 1) * this.len) / e) ||
            ...
            renderUnsquish: function () {
                ...
                else if (v && ((k = { width: t + "px" }), !y))
                    for (k.textOverflow = "clip", D = h.length; !d && D--; )
                        if (((l = h[D]), (t = m[l].label)))
                            t.styles && "ellipsis" === t.styles.textOverflow
                                ? t.css({ textOverflow: "clip" })
                                : m[l].labelLength > v &&
                                  t.css({ width: v + "px" }),
                                t.getBBox().height >
                                    this.len / h.length - (n.h - n.f) &&
                                    (t.specCss = { textOverflow: "ellipsis" });
                f.rotation &&
                    ((k = {
                        width:
                            (w > 0.5 * a.chartHeight
            ...
            getOffset: function () {
                ...
                if (n || a.isLinked)
                    c(m, function (b, c) {
                        ...
                        a.staggerLines &&
                            ((q *= a.staggerLines),
                            (a.labelOffset = q * (a.opposite ? -1 : 1)));
                else for (z in p) p[z].destroy(), delete p[z];
                l &&
                    l.text &&
                    !1 !== l.enabled &&
                    (a.addTitle(y),
                    y &&
                        ((w = a.axisTitle.getBBox()[d ? "height" : "width"]),
                        (x = l.offset),
                        (D = k(x) ? 0 : E(l.margin, d ? 5 : 10))));
                a.renderLine();
                ...
                q &&
                    (D =
                        D -
                        e +
                        u * (d ? E(C.y, a.tickRotCorr.y + 8 * u) : C.x));
                a.axisTitleMargin = E(x, D);
                I[t] = Math.max(
                    I[t],
                    a.axisTitleMargin + w + u * a.offset,
                    D,
                    n && m.length && J ? J[0] + u * a.offset : 0
                );
            ...
            getTitlePosition: function () {
                var a = this.horiz,
                    ...
                    t = h.x || 0,
                    f = h.y || 0,
                    n = this.chart.renderer.fontMetrics(
                    ...
                    b =
                        (a ? c + this.height : b) +
                        (a ? 1 : -1) * (p ? -1 : 1) * this.axisTitleMargin +
                        (2 === this.side ? n : 0);
                return {
            ...
            renderTick: function (a, b) {
                ...
                if (!c || (a >= this.min && a <= this.max))
                    g[a] || (g[a] = new J(this, a)),
                        e && g[a].isNew && g[a].render(b, !0, 0.1),
                        g[a].render(b);
            },
            render: function () {
                var a = this,
                ...
                if (a.hasData() || d)
                    a.minorTickInterval &&
                        !a.categories &&
                        c(a.getMinorTickPositions(), function (b) {
                            a.renderMinorTick(b);
                        }),
                        t.length &&
                            (c(t, function (b, c) {
                        ...
                        a._addedPlotLB ||
                            (c(
                                (e.plotLines || []).concat(e.plotBands || []),
                                function (b) {
            ...
            destroy: function (a) {
                ...
                for (m in b.plotLinesAndBandsGroups)
                    b.plotLinesAndBandsGroups[m] =
                        b.plotLinesAndBandsGroups[m].destroy();
                for (p in b)
                    b.hasOwnProperty(p) &&
                        -1 === t(p, b.keepProps) &&
                        delete b[p];
            ...
            drawCrosshair: function (a, b) {
                ...
                this.crosshair && !1 !== (k(b) || !g)
                    ? (g
                          ? k(b) &&
                            (h = this.isXAxis ? b.plotX : this.len - b.plotY)
                          : (h =
                                a &&
                                (this.horiz
                                    ? a.chartX - this.pos
                      ...
                      k(h) &&
                          (c =
                              this.getPlotLinePath(
                                  b && (this.isXAxis ? b.x : E(b.stackY, b.y)),
                                  null,
                                  null,
                                  null,
                                  h
    ...
    (function (a) {
        ...
        B.prototype.getTimeTicks = function (a, q, b, p) {
            var h = [],
                ...
                m;
            if (r(q)) {
                e[A.hcSetMilliseconds](
                    C >= c.second ? 0 : E * Math.floor(e.getMilliseconds() / E)
                );
                if (C >= c.second)
                    e[A.hcSetSeconds](
                        C >= c.minute ? 0 : E * Math.floor(e.getSeconds() / E)
                    );
                if (C >= c.minute)
                    e[A.hcSetMinutes](
                        C >= c.hour
                            ? 0
                            : E * Math.floor(e[A.hcGetMinutes]() / E)
                    );
                if (C >= c.hour)
                    e[A.hcSetHours](
                        C >= c.day ? 0 : E * Math.floor(e[A.hcGetHours]() / E)
                    );
                if (C >= c.day)
                    e[A.hcSetDate](
                        C >= c.month ? 1 : E * Math.floor(e[A.hcGetDate]() / E)
                    );
                C >= c.month &&
                    (e[A.hcSetMonth](
                        C >= c.year ? 0 : E * Math.floor(e[A.hcGetMonth]() / E)
                    ),
                    (w = e[A.hcGetFullYear]()));
                if (C >= c.year) e[A.hcSetFullYear](w - (w % E));
                if (C === c.week)
                    e[A.hcSetDate](
                        e[A.hcGetDate]() - e[A.hcGetDay]() + d(p, 1)
                    );
                w = e[A.hcGetFullYear]();
                p = e[A.hcGetMonth]();
                var y = e[A.hcGetDate](),
        ...
        B.prototype.normalizeTimeTickInterval = function (a, d) {
            ...
            for (
                ...
                (p = c[d[0]]),
                (h = d[1]),
                b[t + 1] && a <= (p * h[h.length - 1] + c[b[t + 1][0]]) / 2);
                t++
            );
    ...
    (function (a) {
        ...
        B.prototype.getLogTickPositions = function (a, l, q, k) {
            ...
            if (0.5 <= a)
                (a = Math.round(a)), (z = this.getLinearTickPositions(a, l, q));
            else if (0.08 <= a)
                for (
                    var d = Math.floor(l),
                        b,
                ...
                (l = c(l)),
                    ...
                    (a = r(
                        ...
                        ((f.tickPixelInterval / (k ? 5 : 1)) * (q - l)) /
                            ((k ? d / this.tickPositions.length : d) || 1)
                    )),
                    (a = G(a, null, A(a))),
    ...
    (function (a) {
        ...
        a.Tooltip.prototype = {
            ...
            move: function (a, d, f, b) {
                var c = this,
                    ...
                    t =
                        ...
                        !c.isHidden &&
                        (1 < Math.abs(a - h.x) || 1 < Math.abs(d - h.y)),
            ...
            getAnchor: function (a, d) {
                ...
                this.followPointer &&
                    d &&
                    (void 0 === d.chartX && (d = b.pointer.normalize(d)),
                    (c = [d.chartX - b.plotLeft, d.chartY - h]));
                c ||
                    (A(a, function (a) {
                        e = a.series.yAxis;
                        x = a.series.xAxis;
                        ...
                        w +=
                            (a.plotLow
                                ...
                                : a.plotY) + (!p && e ? e.top - h : 0);
                    }),
                    (n /= a.length),
                    (w /= a.length),
                    (c = [
                        p ? b.plotWidth - w : n,
                        this.shared && !p && 1 < a.length && d
                            ? d.chartY - h
                            : p
                            ? b.plotHeight - n
                            : w,
            ...
            getPosition: function (a, d, f) {
                var b = this.chart,
                    ...
                    x =
                        !this.followPointer &&
                        q(f.ttBelow, !b.inverted === !!f.negative),
                    l = function (a, b, e, g, m, d) {
                        ...
                        if (x && f) h[a] = g;
                            ...
                            h[a] = Math.min(d - e, 0 > n - t ? n : n - t);
                        else if (f)
                            h[a] = Math.max(m, g + t + e > b ? g : g + t);
                        else return !1;
                    },
                    E = function (a, b, e, g) {
                        var m;
            ...
            refresh: function (a, d) {
                ...
                clearTimeout(this.hideTimer);
                this.followPointer =
                    k(h)[0].series.tooltipOptions.followPointer;
                t = this.getAnchor(h, d);
                d = t[0];
                p = t[1];
                !f || (h.series && h.series.noSharedTooltip)
                    ? (f = h.getLabelConfig())
                    : (A(h, function (a) {
                          a.setState("hover");
                          n.push(a.getLabelConfig());
                      }),
                      (f = { x: h[0].category, y: h[0].y }),
                      (f.points = n),
                      (h = h[0]));
                this.len = n.length;
                f = c.call(f, this);
            ...
            renderSplit: function (c, d) {
                ...
                A(c.slice(0, d.length + 1), function (a, c) {
                    ...
                    var w = c.series || f,
                        ...
                        x =
                            "highcharts-color-" +
                            q(c.colorIndex, y.colorIndex, "none");
                    m ||
                        (w.tt = m =
                            h
                    ...
                    c.isHeader
                        ? ((k = a.height),
                          (y = Math.max(
                              0,
                              Math.min(
                                  c.plotX + p.plotLeft - y / 2,
                                  p.chartWidth - y
                              )
                          )))
                        : (y = c.plotX + p.plotLeft - q(n.distance, 16) - y);
                    0 > y && (t = !1);
                    a =
                        (c.series && c.series.yAxis && c.series.yAxis.pos) +
                        (c.plotY || 0);
                    a -= p.plotTop;
                    b.push({
                ...
                A(b, function (a) {
                    ...
                    a.tt.attr({
                        ...
                        x:
                            t || b.isHeader
                                ? a.x
                                : b.plotX + p.plotLeft + q(n.distance, 16),
                        y: a.pos + p.plotTop,
                        anchorX: b.isHeader
                            ? b.plotX + p.plotLeft
                            : b.plotX + c.xAxis.pos,
            ...
            getDateFormat: function (a, f, k, b) {
                ...
                for (t in d) {
                    ...
                    if (
                        n[t] &&
                        c.substr(n[t]) !== "01-01 00:00:00.000".substr(n[t])
                    )
                        break;
                    "week" !== t && (w = t);
                }
            ...
            getXDateFormat: function (a, d, f) {
                ...
                return (
                    (b
                        ? this.getDateFormat(b, a.x, f.options.startOfWeek, d)
                        : d.day) || d.year
                );
            },
            tooltipFooterHeaderFormatter: function (a, d) {
                ...
                t &&
                    p &&
                    (c = c.replace("{point.key}", "{point.key:" + p + "}"));
                return G(c, { point: a, series: d });
            },
            bodyFormatter: function (a) {
                return f(a, function (a) {
                    var c = a.series.tooltipOptions;
                    return (c.pointFormatter || a.point.tooltipFormatter).call(
                        a.point,
                        c.pointFormat
                    );
                });
        ...
        a.Pointer.prototype = {
            init: function (a, d) {
                ...
                b &&
                    ...
                    (this.followTouchMove = c(d.tooltip.followTouchMove, !0)));
                this.setDOMEvents();
            },
            ...
            normalize: function (a, b) {
                ...
                void 0 === h.pageX
                    ? ((c = Math.max(a.x, a.clientX - b.left)), (b = a.y))
                    : ((c = h.pageX - b.left), (b = h.pageY - b.top));
            ...
            getKDPoints: function (a, b, d) {
                ...
                q(a, function (a) {
                    ...
                    a.visible &&
                        !p &&
                        c(a.options.enableMouseTracking, !0) &&
                        (f = a.searchPoint(
                            d,
                            !e && 0 > a.options.findNearestPointBy.indexOf("y")
                        )) &&
                        f.series &&
                        h.push(f);
                });
                ...
                if (b && h[0] && !h[0].series.noSharedTooltip)
                    for (a = h.length; a--; )
                        (h[a].x !== h[0].x || h[a].series.noSharedTooltip) &&
                            h.splice(a, 1);
                return h;
            },
            ...
            getHoverData: function (b, d, p, f, e, n) {
                ...
                f
                        ...
                        ? ((m = []),
                          q(p, function (a) {
                              ...
                              a.visible &&
                                  ...
                                  c(a.options.enableMouseTracking, !0) &&
                                  (a = a.searchKDTree(
                                      { clientX: h.clientX, plotY: h.plotY },
                                      !b && 1 === a.kdDimensions
                                  )) &&
                                  a.series &&
                                  m.push(a);
                    ...
                    : t && !t.stickyTracking
                    ? (e || (p = [t]),
                      (m = this.getKDPoints(p, e, n)),
                      (h = a.find(m, function (a) {
                          return a.series === t;
                      })))
                    : ((b = a.grep(p, function (a) {
                          return a.stickyTracking;
                      })),
                      (m = this.getKDPoints(b, e, n)),
                      (t = (h = m[0]) && h.series),
                      e && (m = this.getKDPoints(p, e, n)));
                m.sort(function (a, b) {
            ...
            runPointActions: function (b, d) {
                ...
                m = (e = e && f && !f.series.noSharedTooltip)
                    ? d.hoverPoints
                    : f
                    ? [f]
                    : [];
                if (f && (f !== h.hoverPoint || (p && p.isHidden))) {
                    ...
                    t &&
                        !t.directTouch &&
                        (h.hoverPoint &&
                            h.hoverPoint.firePointEvent("mouseOut"),
                    ...
                    n &&
                        ...
                        !p.isHidden &&
                        ((f = p.getAnchor([{}], b)),
                        p.updatePosition({ plotX: f[0], plotY: f[1] }));
                this.unDocMouseMove ||
                    (this.unDocMouseMove = B(l, "mousemove", function (b) {
                        var c = H[a.hoverChartIndex];
                        if (c) c.pointer.onDocumentMouseMove(b);
                    }));
                q(h.axes, function (a) {
                    c(a.crosshair.snap, !0)
                        ? q(m, function (c) {
            ...
            scaleGroups: function (a, b) {
                ...
                q(c.series, function (e) {
                    ...
                    e.xAxis &&
                        ...
                        (e.group.attr(h),
                        e.markerGroup &&
                            (e.markerGroup.attr(h),
                            e.markerGroup.clip(b ? c.clipRect : null)),
                        e.dataLabelsGroup && e.dataLabelsGroup.attr(h));
                });
            ...
            drag: function (a) {
                ...
                (q && q.touch) ||
                    ...
                    (this.hasDragged = Math.sqrt(
                        Math.pow(g - h, 2) + Math.pow(u - e, 2)
                    )),
                    10 < this.hasDragged &&
                        ((l = b.isInsidePlot(g - f, u - m)),
                        b.hasCartesianSeries &&
                            ...
                            (this.selectionMarker = q =
                                b.renderer
                                    .rect(f, m, d ? 1 : n, p ? 1 : k, 0)
                                    .attr({
                                        fill:
                                            c.selectionMarkerFill ||
                                            G("#335cad").setOpacity(0.25).get(),
            ...
            drop: function (a) {
                ...
                c &&
                    (r(c.container, { cursor: c._cursor }),
            ...
            onContainerMouseMove: function (b) {
                ...
                (f(a.hoverChartIndex) &&
                    H[a.hoverChartIndex] &&
                    H[a.hoverChartIndex].mouseIsDown) ||
            ...
            onContainerClick: function (a) {
                ...
                b.cancelClick ||
                    (c && this.inClass(a.target, "highcharts-tracker")
                        ? (u(c.series, "click", k(a, { point: c })),
                          b.hoverPoint && c.firePointEvent("click", a))
                        : (k(a, this.getCoordinates(a)),
                          b.isInsidePlot(a.chartX - h, a.chartY - e) &&
                              u(b, "click", a)));
            },
            setDOMEvents: function () {
                ...
                a.hasTouch &&
                    ...
                    1 === a.chartCount &&
                        B(l, "touchend", b.onDocumentTouchEnd));
            },
            destroy: function () {
                var b;
                this.unDocMouseMove && this.unDocMouseMove();
                ...
                a.chartCount ||
                    (n(l, "mouseup", this.onDocumentMouseUp),
                    n(l, "touchend", this.onDocumentTouchEnd));
    ...
    (function (a) {
        ...
        H(a.Pointer.prototype, {
            pinchTranslate: function (a, f, k, u, d, c) {
                this.zoomHor &&
                    this.pinchTranslateDirection(!0, a, f, k, u, d, c);
                this.zoomVert &&
                    this.pinchTranslateDirection(!1, a, f, k, u, d, c);
            },
            ...
            pinch: function (a) {
                var l = this,
                    ...
                    h =
                        1 === c &&
                        ((l.inClass(a.target, "highcharts-tracker") &&
                            k.runTrackerClick) ||
                            l.runChartClick),
                    t = {};
                1 < c && (l.initiated = !0);
                ...
                "touchstart" === a.type
                    ? (A(d, function (a, b) {
                      ...
                      (l.res = !0))
                    : l.followTouchMove && 1 === c
                    ? this.runPointActions(l.normalize(a))
                    : u.length &&
                      (b ||
                          (l.selectionMarker = b =
                              H({ destroy: r, touch: !0 }, k.plotBox)),
                      l.pinchTranslate(u, d, p, b, t, n),
                      (l.hasPinched = z),
                      l.scaleGroups(p, t),
                ...
                1 === l.touches.length
                    ? ((l = this.normalize(l)),
                      (d = k.isInsidePlot(
                          ...
                          ? (q && this.runPointActions(l),
                            "touchmove" === l.type &&
                                ((q = this.pinchDown),
                                (u = q[0]
                                    ? 4 <=
                                      Math.sqrt(
                                          Math.pow(q[0].chartX - l.chartX, 2) +
                                              Math.pow(
                                                  q[0].chartY - l.chartY,
                                                  2
                                              )
            ...
            r(l.prototype, {
                ...
                onContainerPointerMove: function (a) {
                    z(a, "onContainerTouchMove", "touchmove", function (a) {
                        ...
                        d[a.pointerId].target ||
                            (d[a.pointerId].target = a.currentTarget);
                    });
                },
    ...
    (function (a) {
        ...
        B.prototype = {
            ...
            renderTitle: function () {
                ...
                c.text &&
                    ...
                    this.contentGroup.attr({ translateY: h }));
                this.titleHeight = h;
            },
            setText: function (b) {
                var c = this.options;
            ...
            renderItem: function (a) {
                ...
                g ||
                    ((a.legendGroup = c
                        ...
                        .addClass(
                            "highcharts-" +
                                ...
                                a.colorIndex +
                                (H ? " " + H : "") +
                                (z ? " highcharts-series-" + a.index : "")
                        )
                        .attr({ zIndex: 1 })
                        .add(this.scrollGroup)),
                    (a.legendItem = g =
                        c
                            .text("", y ? n + e : -e, this.baseline || 0, B)
                            .css(k(a.visible ? l : q))
                            .attr({ align: y ? "left" : "right", zIndex: 2 })
                            .add(a.legendGroup)),
                    this.baseline ||
                        ((l = l.fontSize),
                        (this.fontMetrics = c.fontMetrics(l, g)),
                    ...
                    this.setItemEvents && this.setItemEvents(a, g, B),
                    A && this.createCheckboxForItem(a));
                ...
                n = a.checkboxOffset =
                    d.itemWidth ||
                    a.legendItemWidth ||
                    n + e + c.width + m + (A ? 20 : 0);
                this.itemHeight = e = Math.round(
                    a.legendItemHeight || c.height || this.symbolHeight
                );
                f &&
                    this.itemX - r + n >
                        (I || b.spacingBox.width - 2 * r - d.x) &&
                    ((this.itemX = r),
                    (this.itemY += J + this.lastLineHeight + K),
                ...
                f
                    ? (this.itemX += n)
                    : ((this.itemY += J + e + K), (this.lastLineHeight = e));
                this.offsetWidth =
                    I ||
                    Math.max(
                        (f ? this.itemX - r - m : n) + r,
                        this.offsetWidth
                    );
            },
            getAllItems: function () {
                ...
                f(this.chart.series, function (b) {
                    var c = b && b.options;
                    b &&
                        u(c.showInLegend, r(c.linkedTo) ? !1 : void 0, !0) &&
                        (a = a.concat(
                            b.legendItems ||
            ...
            render: function () {
                ...
                a.lastItemY = 0;
                n ||
                    ((a.group = n = h.g("legend").attr({ zIndex: 7 }).add()),
                    (a.contentGroup = h.g().attr({ zIndex: 1 }).add(n)),
                    (a.scrollGroup = h.g().add(a.contentGroup)));
                a.renderTitle();
                l = a.getAllItems();
                c(l, function (a, b) {
                    return (
            ...
            handleOverflow: function (a) {
                var b = this,
                    ...
                    z = function (a) {
                        a
                            ? q.attr({ height: a })
                            : q &&
                              ((b.clipRect = q.destroy()),
                              b.contentGroup.clip());
                        b.contentGroup.div &&
                            (b.contentGroup.div.style.clip = a
                                ? "rect(" + e + "px,9999px," + (e + a) + "px,0)"
                                : "auto");
                    };
                "horizontal" !== n.layout ||
                ...
                a > c && !1 !== r.enabled
                    ? ((this.clipHeight = l =
                          Math.max(c - 20 - this.titleHeight - e, 0)),
                      ...
                      q ||
                          ((q = b.clipRect = d.clipRect(0, e, 9999, 0)),
                          b.contentGroup.clip(q)),
                      z(l),
                      I ||
                          ((this.nav = I =
                              d.g().attr({ zIndex: 1 }).add(this.group)),
                          (this.up = d
                              .symbol("triangle", 0, 0, y, y)
                              .on("click", function () {
                                  b.scroll(-1, m);
                              })
                              .add(I)),
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function (a, c) {
                ...
                c.legendSymbol = this.chart.renderer
                    .rect(
                        d ? (a.symbolWidth - b) / 2 : 0,
                        a.baseline - b + 1,
                        d ? b : a.symbolWidth,
                        b,
                        u(a.options.symbolRadius, b / 2)
                    )
            ...
            drawLineMarker: function (a) {
                ...
                c &&
                    !1 !== c.enabled &&
                    ((b = Math.min(u(c.radius, n), n)),
                    0 === this.symbol.indexOf("url") &&
                        ((c = k(c, { width: f, height: f })), (b = 0)),
                    (this.legendSymbol = c =
                        e
                            .symbol(
                                this.symbol,
        ...
        (/Trident\/7\.0/.test(n.navigator.userAgent) || l) &&
            z(B.prototype, "positionItem", function (a, c) {
                var b = this,
                    d = function () {
    ...
    (function (a) {
        ...
        O.prototype = {
            ...
            initSeries: function (b) {
                ...
                (c = J[b.type || c.type || c.defaultSeriesType]) ||
                    a.error(17, !0);
                c = new c();
                c.init(this, b);
                return c;
            ...
            redraw: function (b) {
                ...
                for (b = e.length; b--; )
                    if (
                        ((y = e[b]),
                        y.options.stacking && ((h = !0), y.isDirty))
                    ) {
                        f = !0;
                        break;
                    }
                if (f)
                    for (b = e.length; b--; )
                        (y = e[b]), y.options.stacking && (y.isDirty = !0);
                n(e, function (a) {
                    a.isDirty &&
            ...
            getChartSize: function () {
                ...
                this.chartHeight = Math.max(
                    0,
                    a.relativeLength(b, this.chartWidth) ||
            ...
            getContainer: function () {
                ...
                this.renderer = new (a[g.renderer] || P)(
                    b,
                    d,
                    m,
                    null,
            ...
            getMargins: function (a) {
                ...
                g &&
                    ...
                    (this.plotTop = Math.max(
                        this.plotTop,
                        g + this.options.title.margin + b[0]
                    ));
            ...
            reflow: function (a) {
                ...
                if (!d && !b.isPrinting && m && e && (g === N || g === r)) {
                    if (m !== b.containerWidth || e !== b.containerHeight)
                        clearTimeout(b.reflowTimeout),
                            (b.reflowTimeout = Q(
                                function () {
                                    b.container &&
                                        b.setSize(void 0, void 0, !1);
                                },
                                a ? 100 : 0
                            ));
                    b.containerWidth = m;
            ...
            setChartSize: function (a) {
                ...
                this.plotWidth = k = Math.max(
                    0,
                    Math.round(e - f - this.marginRight)
                );
                this.plotHeight = y = Math.max(
                    0,
            ...
            drawChartBox: function () {
                ...
                n = { fill: n || "none" };
                if (h || g["stroke-width"])
                    (n.stroke = a.borderColor), (n["stroke-width"] = h);
                ...
                k &&
                    (f
                        ? f.animate(x)
                        : (this.plotBGImage = b.image(k, l, t, q, u).add()));
                r
                    ? r.animate({ width: w.width, height: w.height })
            ...
            propFromSeries: function () {
                ...
                n(["inverted", "angular", "polar"], function (m) {
                    ...
                    for (g = e && e.length; !d && g--; )
                        (c = J[e[g].type]) && c.prototype[m] && (d = !0);
                    a[m] = d;
                });
            },
            linkSeries: function () {
            ...
            isReadyToRender: function () {
                var a = this;
                return F || N != N.top || "complete" === r.readyState
                    ? !0
    ...
    (function (a) {
        ...
        B.prototype = {
            init: function (a, c, f) {
                ...
                a.options.colorByPoint
                    ? ((c = a.options.colors || a.chart.options.colors),
                      (this.color = this.color || c[a.colorCounter]),
                      (c = c.length),
                      (f = a.colorCounter),
                      a.colorCounter++,
            ...
            applyOptions: function (a, c) {
                ...
                void 0 === this.x &&
                    d &&
                    (this.x = void 0 === c ? d.autoIncrement(this) : c);
                return this;
            },
            ...
            },
            {
                ...
                autoIncrement: function () {
                    ...
                    e &&
                        ((a = new f(b)),
                        "day" === e
                            ? (a = +a[f.hcSetDate](a[f.hcGetDate]() + c))
                            : "month" === e
                            ? (a = +a[f.hcSetMonth](a[f.hcGetMonth]() + c))
                            : "year" === e &&
                              (a = +a[f.hcSetFullYear](
                                  a[f.hcGetFullYear]() + c
                              )),
                ...
                getCyclic: function (a, b, c) {
                    var e,
                        ...
                        f = c
                            ? c.length
                            : D(d.options.chart[a + "Count"], d[a + "Count"]);
                    b ||
                        ((e = D(g[m], g["_" + m])),
                        k(e) ||
                ...
                processData: function (b) {
                    ...
                    if (
                        ...
                        this.sorted &&
                        !n &&
                        (!p || d > p || this.forceCrop)
                    )
                        if (c[d - 1] < q || c[0] > x) (c = []), (e = []);
                        else if (c[0] < q || c[d - 1] > x)
                            (m = this.cropData(this.xData, this.yData, q, x)),
                                (c = m.xData),
                                (e = m.yData),
                                (m = m.start),
                                (g = !0);
                    for (p = c.length || 1; --p; )
                        (d = t ? k(c[p]) - k(c[p - 1]) : c[p] - c[p - 1]),
                            0 < d && (void 0 === h || d < h)
                                ? (h = d)
                                : 0 > d && this.requireSorting && a.error(15);
                    this.cropped = g;
                    this.cropStart = m;
                        ...
                        (k = p + q),
                            n
                                ? ((l = new g().init(
                                  ...
                                  (l.dataGroup = this.groupMap[q]))
                                : (l = b[k]) ||
                                  void 0 === a[k] ||
                                  (b[k] = l = new g().init(this, a[k], d[q])),
                            l && ((l.index = k), (t[q] = l));
                    if (b && (f !== (c = b.length) || n))
                        for (q = 0; q < c; q++)
                            q !== p || n || (q += f),
                ...
                getExtremes: function (a) {
                    ...
                    for (t = 0; t < d; t++)
                        if (
                            ...
                            (k =
                                (p(l, !0) || b(l)) &&
                                (!c.positiveValuesOnly || l.length || 0 < l)),
                            (n =
                ...
                translate: function () {
                    ...
                    for (a = 0; a < h; a++) {
                        ...
                        b &&
                            ...
                            H &&
                            H[A] &&
                            ((C = this.getStackIndicator(C, A, this.index)),
                            (G = H[A]),
                            (B = G.points[C.key]),
                            (u = B[0]),
                            (B = B[1]),
                            u === q && C.key === H[A].base && (u = D(t, d.min)),
                            d.positiveValuesOnly && 0 >= u && (u = null),
                            (z.total = z.stackTotal = G.total),
                            (z.percentage = G.total && (z.y / G.total) * 100),
                            (z.stackY = B),
                            G.setOffset(
                                this.pointXOffset || 0,
                                this.barW || 0
                        ...
                        z.isNull ||
                            (void 0 !== w && (E = Math.min(E, Math.abs(x - w))),
                            (w = x));
                    ...
                    if (!1 !== h.enabled || this._hasPointMarkers)
                        for (e = 0; e < a.length; e++)
                            (d = a[e]),
                                ...
                                (l = d.isInside),
                                k && p(c) && null !== d.y
                                    ? ((c = D(f.symbol, this.symbol)),
                                      (d.hasImage = 0 === c.indexOf("url")),
                                      (k = this.markerAttribs(
                                          d,
                                          d.selected && "select"
                                      )),
                                      g
                                          ? g[l ? "show" : "hide"](!0).animate(
                                                k
                                            )
                                          : l &&
                                            (0 < k.width || d.hasImage) &&
                                            (d.graphic = g =
                                                b.renderer
                                                    .symbol(
                                                        c,
                ...
                pointAttribs: function (a, b) {
                    ...
                    b &&
                        ...
                        (e = D(
                            b.lineWidth,
                            c.lineWidth,
                            e + D(b.lineWidthPlus, c.lineWidthPlus, 0)
                        )),
                ...
                destroy: function () {
                    ...
                    u(a.axisTypes || [], function (b) {
                        (k = a[b]) &&
                            k.series &&
                            (d(k.series, a), (k.isDirty = k.forceRedraw = !0));
                    });
                    a.legendItem && a.chart.legend.destroyItem(a);
                    for (e = h.length; e--; )
                        (g = h[e]) && g.destroy && g.destroy();
                    a.points = null;
                    clearTimeout(a.animationTimeout);
                    for (f in a)
                        a[f] instanceof x &&
                            !a[f].survive &&
                            ((e = c && "group" === f ? "hide" : "destroy"),
                            a[f][e]());
                ...
                plotGroup: function (a, b, c, e, d) {
                    ...
                    g.attr({ visibility: c })[h ? "attr" : "animate"](
                        this.getPlotBox()
                    );
                    return g;
                },
                ...
                buildKDTree: function () {
                    ...
                    var b = this,
                        c =
                            -1 < b.options.findNearestPointBy.indexOf("y")
                                ? 2
                                : 1;
                    delete b.kdTree;
                    C(
    ...
    (function (a) {
        function B(a, d, c, f, l) {
            ...
            this.alignOptions = {
                ...
                verticalAlign:
                    d.verticalAlign || (b ? "middle" : c ? "bottom" : "top"),
                y: k(d.y, b ? 4 : c ? 14 : -6),
                x: k(d.x, b ? (c ? -6 : 6) : 0),
            };
            this.textAlign =
                d.textAlign || (b ? (c ? "right" : "left") : "center");
        }
        var A = a.Axis,
            H = a.Chart,
            G = a.correctFloat,
        ...
        B.prototype = {
            ...
            setOffset: function (a, d) {
                var c = this.axis,
                    ...
                    p = c.translate(
                        c.usePercentage ? 100 : this.total,
                        0,
                        0,
                        0,
                        1
                ...
                if ((d = this.label))
                    d.align(this.alignOptions, null, k),
                        (k = d.alignAttr),
                        d[
                            !1 === this.options.crop || f.isInsidePlot(k.x, k.y)
                                ? "show"
                                : "hide"
                        ](!0);
            },
        ...
        H.prototype.getStacks = function () {
            ...
            l(a.series, function (d) {
                !d.options.stacking ||
                    ...
                    (d.stackKey = d.type + k(d.options.stack, ""));
            });
        };
        A.prototype.buildStacks = function () {
            var a = this.series,
                d,
                c = k(this.options.reversedStacks, !0),
                f = a.length,
                l;
            if (!this.isXAxis) {
        ...
        A.prototype.resetStacks = function () {
            ...
            if (!this.isXAxis)
                for (d in a)
                    for (c in a[d])
                        a[d][c].touched < this.stacksTouched
                            ? (a[d][c].destroy(), delete a[d][c])
                            : ((a[d][c].total = null), (a[d][c].cum = null));
        };
        A.prototype.cleanStacks = function () {
            var a, d, c;
            if (!this.isXAxis)
                for (d in (this.oldStacks && (a = this.stacks = this.oldStacks),
                a))
            ...
            if (
                ...
                for (K = 0; K < f; K++)
                    (J = a[K]),
                        ...
                        (y = x[y][J]),
                        null !== g &&
                            ((y.points[A] = y.points[this.index] =
                                [k(y.cum, p)]),
                            r(y.cum) || (y.base = A),
                            (y.touched = e.stacksTouched),
                            0 < E.index &&
                                !1 === this.singleStacks &&
                                (y.points[A][0] =
                                    y.points[this.index + "," + J + ",0"][0])),
                        "percent" === l
                            ? ((m = m ? t : q),
                              w && x[m] && x[m][J]
                                  ? ((m = x[m][J]),
                                    (y.total = m.total =
                                        Math.max(m.total, y.total) +
                                            Math.abs(g) || 0))
                                  : (y.total = G(y.total + (Math.abs(g) || 0))))
                            : (y.total = G(y.total + (g || 0))),
                        (y.cum = k(y.cum, p) + (g || 0)),
        ...
        a.prototype.setPercentStacks = function () {
            ...
            l([d, "-" + d], function (b) {
                for (var d = f.length, h, n; d--; )
                    if (
                        ((h = f[d]),
                        (k = a.getStackIndicator(k, h, a.index, b)),
                        (h = (n = c[b] && c[b][h]) && n.points[k.key]))
                    )
    ...
    (function (a) {
        ...
        k(a.Chart.prototype, {
            ...
            update: function (a, h) {
                ...
                if (m) {
                    ...
                    if ("inverted" in m || "polar" in m)
                        this.propFromSeries(), (p = !0);
                    "alignTicks" in m && (p = !0);
                    for (e in m)
                        m.hasOwnProperty(e) &&
                            (-1 !==
                ...
                e = m && m.width;
                m = m && m.height;
                (c(e) && e !== this.chartWidth) ||
                (c(m) && m !== this.chartHeight)
                    ? this.setSize(e, m)
                    : b(h, !0) && this.redraw();
            },
        ...
        k(H.prototype, {
            update: function (a, c) {
                var e = this.chart;
                a = e.options[this.coll][this.options.index] = z(
                    this.userOptions,
                    a
                );
                this.destroy(!0);
            ...
            {},
            {
                getPointSpline: function (a, H, G) {
                    ...
                    if (
                        ...
                        d += c;
                        k > a && k > f
                            ? ((k = Math.max(a, f)), (d = 2 * f - k))
                            : k < a &&
                              k < f &&
                              ((k = Math.min(a, f)), (d = 2 * f - k));
                        d > G && d > f
                            ? ((d = Math.max(G, f)), (k = 2 * f - d))
                            : d < G &&
                              d < f &&
                              ((d = Math.min(G, f)), (k = 2 * f - d));
                        H.rightContX = u;
                        H.rightContY = d;
                    }
                    H = [
                        "C",
                        B(l.rightContX, l.plotX),
                        B(l.rightContY, l.plotY),
                        B(q, r),
                        B(k, f),
                        r,
                        f,
            ...
            },
            {
                ...
                getColumnMetrics: function () {
                    ...
                    var q = Math.min(
                        ...
                        c = Math.min(
                            ...
                            l(c.pointWidth, e * (1 - 2 * c.pointPadding))
                        );
                    a.columnMetrics = {
                        width: c,
                        offset:
                ...
                translate: function () {
                    var a = this,
                        ...
                        b = a.yAxis,
                        p = (a.translatedThreshold = b.getThreshold(
                            f.threshold
                        )),
                    ...
                    H(a.points, function (d) {
                        ...
                        Math.abs(u) < h &&
                            ...
                            ((u = h),
                            (q =
                                (!b.reversed && !d.negative) ||
                                (b.reversed && d.negative)),
                            (t =
                                Math.abs(t - p) > h ? f - h : p - (q ? h : 0)));
                        d.barX = m;
                        d.pointWidth = r;
                        d.tooltipPos = c.inverted
                            ? [
                                  b.len + b.pos - c.plotLeft - k,
                                  a.xAxis.len - m - n / 2,
                                  u,
                              ]
                            : [m + n / 2, k + b.pos - c.plotTop, u];
                        d.shapeType = "rect";
                        d.shapeArgs = a.crispCol.apply(
                            a,
                            d.isNull ? [d.plotX, b.len / 2, 0, 0] : [m, t, n, u]
                        );
                    });
                },
                getSymbol: a.noop,
                ...
                pointAttribs: function (a, c) {
                    ...
                    c &&
                        ...
                        (h =
                            a.color ||
                            (void 0 !== c &&
                                A(h).brighten(a.brightness).get()) ||
                            h),
                        (l = a[k] || l),
                        (q = a[p] || q),
                        (b = a.dashStyle || b));
                    k = { fill: h, stroke: l, "stroke-width": q };
                ...
                drawPoints: function () {
                    ...
                    H(a.points, function (d) {
                        ...
                        if (r(d.plotY) && null !== d.y) {
                            p = d.shapeArgs;
                            if (h)
                                h[c.pointCount < b ? "animate" : "attr"](f(p));
                            else
                                d.graphic = h = l[d.shapeType](p).add(
                                    d.group || a.group
                                );
                            h.attr(
                                a.pointAttribs(d, d.selected && "select")
                            ).shadow(
                                k.shadow,
                                null,
                        ...
                        (a
                            ? ((k.scaleY = 0.001),
                              ...
                              b
                                  ...
                                  : (k.translateY = a),
                              c.group.attr(k))
                            : ((k[b ? "translateX" : "translateY"] = d.pos),
                              c.group.animate(
                                  k,
                                  G(B(c.options.animation), {
                                      step: function (a, b) {
                                          c.group.attr({
            ...
            },
            {
                ...
                translate: function (a) {
                    ...
                    for (E = 0; E < m; E++) {
                        ...
                        h = (Math.cos(q) * a[2]) / 2;
                        k = (Math.sin(q) * a[2]) / 2;
                        y.tooltipPos = [a[0] + 0.7 * h, a[1] + 0.7 * k];
                            ...
                            b
                                ...
                                : ((c.graphic = b =
                                      d[c.shapeType](h)
                                          ...
                                          .attr(f)
                                          .add(a.group)),
                                  c.visible || b.attr({ visibility: "hidden" }),
                                  b
                                      .attr(k)
            ...
            },
            {
                ...
                setVisible: function (a, d) {
                    ...
                    a !== c.visible &&
                        ...
                        (b.options.data[r(c, b.data)] = c.options),
                        H(
                            [
                                "graphic",
                                "dataLabel",
                        ...
                        c.legendItem && f.legend.colorizeItem(c, a),
    ...
    (function (a) {
                ...
                a.dlProcessOptions && a.dlProcessOptions(d),
                    ...
                    G(k, function (b) {
                        ...
                        if ((e = u(l && l.enabled, n.enabled) && null !== b.y))
                            ...
                            (r = d.format
                                ? f(d.format, k)
                                : d.formatter.call(k, d)),
                            (x = d.style),
                            (p = d.rotation),
                            (x.color = u(d.color, x.color, a.color, "#000000")),
                            "contrast" === x.color &&
                                ((b.contrastColor = m.getContrast(
                                    b.color || a.color
                                )),
                                (x.color =
                                    d.inside || 0 > d.distance || c.stacking
                                        ? b.contrastColor
                                        : "#000000")),
                        ...
                        !h || (e && H(r))
                            ? e &&
                              ...
                              h.attr(k),
                              h.css(x).shadow(d.shadow),
                              h.added || h.add(C),
                              a.alignDataLabel(b, h, d, null, w))
        ...
        c.prototype.alignDataLabel = function (a, c, d, f, k) {
            var b = this.chart,
                ...
                t =
                    this.visible &&
                    (a.series.forceDL ||
                        b.isInsidePlot(h, Math.round(l), e) ||
                        (f &&
                            b.isInsidePlot(
                                h,
                                e ? f.x + 1 : f.y + f.height - 1,
                                e
                            ))),
                D = "justify" === u(d.overflow, "justify");
            t &&
                ((m = d.style.fontSize),
                (m = b.renderer.fontMetrics(m, c).b),
                (f = r(
                    {
                        x: e ? b.plotWidth - l : h,
                ...
                r(d, { width: p.width, height: p.height }),
                n
                    ? ((D = !1),
                      (e = b.renderer.rotCorr(m, n)),
                      (e = {
                      ...
                      "left" === q
                          ? (e.y -= h ? p.height : 0)
                          : "center" === q
                          ? ((e.x -= p.width / 2), (e.y -= p.height / 2))
                          : "right" === q &&
                            ((e.x -= p.width), (e.y -= h ? 0 : p.height)))
                    : (c.align(d, null, f), (e = c.alignAttr)),
                D
                    ...
                    : u(d.crop, !0) &&
                      (t =
                          b.isInsidePlot(e.x, e.y) &&
                          b.isInsidePlot(e.x + p.width, e.y + p.height)),
                d.shape &&
                    !n &&
                    c.attr({ anchorX: a.plotX, anchorY: a.plotY }));
        ...
        c.prototype.justifyDataLabel = function (a, c, d, f, k, l) {
            ...
            n = d.x + q;
            0 > n &&
                ("right" === h ? (c.align = "left") : (c.x = -n), (m = !0));
            n = d.x + f.width - q;
            n > b.plotWidth &&
                ("left" === h ? (c.align = "right") : (c.x = b.plotWidth - n),
                (m = !0));
            n = d.y + q;
            0 > n &&
                ("bottom" === p ? (c.verticalAlign = "top") : (c.y = -n),
                (m = !0));
            n = d.y + f.height - q;
            n > b.plotHeight &&
                ("top" === p
        ...
        n.pie &&
            ((n.pie.prototype.drawDataLabels = function () {
                ...
                b.visible &&
                    ...
                    c.prototype.drawDataLabels.apply(b),
                    G(d, function (a) {
                        a.dataLabel &&
                            a.visible &&
                            (P[a.half].push(a), (a.dataLabel._pos = null));
                    }),
                    G(P, function (c, e) {
                        var d,
                            h,
                        ...
                        if (p)
                            for (
                                b.sortByAngle(c, e - 0.5),
                                    0 < m &&
                                        ((d = Math.max(0, B - z - m)),
                                        (h = Math.min(B + z + m, k.plotHeight)),
                                        (t = l(c, function (a) {
                                            if (a.dataLabel)
                                                return (
                                                    (u =
                                ...
                                (f = c[R]),
                                    ...
                                    (g._attr = { visibility: M, align: L[6] }),
                                    (g._pos = {
                                        x:
                                            O +
                                            n.x +
                                            ({ left: q, right: -q }[L[6]] || 0),
                                        y: v + n.y - 10,
                                    }),
                                    (L.x = O),
                                    (L.y = v),
            ...
            (n.pie.prototype.alignDataLabel = k),
            (n.pie.prototype.verifyDataLabelOverflow = function (a) {
                var b = this.center,
                    ...
                    e;
                null !== f[0]
                    ? (l = Math.max(b[2] - Math.max(a[1], a[3]), k))
                    : ((l = Math.max(b[2] - a[1] - a[3], k)),
                      (b[0] += (a[3] - a[1]) / 2));
                null !== f[1]
                    ? (l = Math.max(
                          Math.min(l, b[2] - Math.max(a[0], a[2])),
                          k
                      ))
                    : ((l = Math.max(Math.min(l, b[2] - a[0] - a[2]), k)),
                      (b[1] += (a[0] - a[2]) / 2));
                l < b[2]
                    ? ((b[2] = l),
                      (b[3] = Math.min(d(c.innerSize || 0, l), l)),
                      this.translate(b),
        ...
        n.column &&
            (n.column.prototype.alignDataLabel = function (a, d, f, k, l) {
                var b = this.chart.inverted,
                    e = a.series,
                    h = a.dlBox || a.shapeArgs,
                    n = u(
                        a.below,
                        a.plotY > u(this.translatedThreshold, e.yAxis.len)
                    ),
                    p = u(f.inside, !!this.options.stacking);
                h &&
                    ((k = q(h)),
                    0 > k.y && ((k.height += k.y), (k.y = 0)),
                    (h = k.y + k.height - e.yAxis.len),
                    0 < h && (k.height -= h),
                    b &&
                        (k = {
                    ...
                    p ||
                        (b
                            ? ((k.x += n ? 0 : k.width), (k.width = 0))
                            : ((k.y += n ? k.height : 0), (k.height = 0))));
                f.align = u(f.align, !b || p ? "center" : n ? "right" : "left");
                f.verticalAlign = u(
                    f.verticalAlign,
                    b || p ? "middle" : n ? "top" : "bottom"
                );
            ...
            for (q = 0; q < f; q++)
                for (k = a[q], l = q + 1; l < f; ++l)
                    if (
                        ...
                        (k.labelrank < r.labelrank ? k : r).newOpacity = 0;
            A(a, function (a) {
                var b, c;
                a &&
                    ((c = a.newOpacity),
        ...
        a = a.TrackerMixin = {
                ...
                a._hasTracking ||
                    (l(a.trackerGroups, function (e) {
                        if (a[e]) {
                            ...
                            a.options.cursor &&
                                a[e].css(G).css({ cursor: a.options.cursor });
                        }
                    }),
                    (a._hasTracking = !0));
            },
            drawTrackerGraph: function () {
                var a = this,
                    ...
                    t = "rgba(192,192,192," + (D ? 0.0001 : 0.002) + ")";
                if (f && !c)
                    for (g = f + 1; g--; )
                        "M" === d[g] &&
                            d.splice(g + 1, 0, d[g + 1] - p, d[g + 2], "L"),
                            ((g && "M" === d[g]) || g === f) &&
                                d.splice(g, 0, "L", d[g - 2] + p, d[g - 1]);
                q
                    ? q.attr({ d: d })
                    : a.graph &&
                      ((a.tracker = n
                          ...
                          .attr({
                              ...
                              fill: c ? t : "none",
                              "stroke-width":
                                  a.graph.strokeWidth() + (c ? 0 : 2 * p),
                              zIndex: 2,
                          })
                          .add(a.group)),
                      l([a.tracker, a.markerGroup], function (a) {
            ...
            zoom: function (a) {
                ...
                !a || a.resetSelection
                    ...
                    : l(a.xAxis.concat(a.yAxis), function (a) {
                          var b = a.axis;
                          f[b.isXAxis ? "zoomX" : "zoomY"] &&
                              ((d = b.zoom(a.min, a.max)),
                              b.displayBtn && (h = !0));
                      });
            ...
            pan: function (a, b) {
                ...
                l("xy" === b ? [1, 0] : [1], function (b) {
                    ...
                    b.series.length &&
                        0 > m &&
                        0 > g &&
                        (b.setExtremes(h, l, !1, !1, { trigger: "pan" }),
                        (e = !0));
                    c[d] = f;
                });
                e && c.redraw(!1);
            ...
            select: function (a, c) {
                ...
                e.firePointEvent(
                    ...
                    function () {
                        ...
                        e.setState(a && "select");
                        c ||
                            l(h.getSelectedPoints(), function (a) {
                                a.selected &&
                                    a !== e &&
                                    ((a.selected = a.options.selected = !1),
                                    (f.options.data[d(a, f.data)] = a.options),
                                    a.setState(""),
                ...
                if (
                    ...
                    if (this.graphic)
                        ...
                        if (a && p) {
                            ...
                            if (g)
                                g[c ? "animate" : "attr"]({ x: z.x, y: z.y });
                            else
                                l &&
                                    ((h.stateMarkerGraphic = g =
                                        u.renderer
                                            .symbol(
                                                l,
                                                z.x,
                        ...
                        g &&
                            (g[
                                a && u.isInsidePlot(d, e, u.inverted)
                                    ? "show"
                                    : "hide"
                            ](),
                            (g.element.point = this));
                    }
                    (d = k.halo) && d.size
                        ? (w ||
                              (h.halo = w =
                          ...
                          w.attr({
                              class:
                                  ...
                                  b(this.colorIndex, h.colorIndex),
                          }),
                          (w.point = this),
                          w.attr(
                              q(
        ...
        q(h.prototype, {
            ...
            setState: function (a) {
                ...
                if (
                    c.state !== a &&
                    (l(
                        [c.group, c.markerGroup, c.dataLabelsGroup],
                        function (b) {
                            b &&
                                (c.state &&
                                    b.removeClass(
                    ...
                    (c.state = a),
                    !h[a] || !1 !== h[a].enabled) &&
                    (a && (k = h[a].lineWidth || k + (h[a].lineWidthPlus || 0)),
                    f && !f.dashstyle)
                )
                    for (
                        k = { "stroke-width": k },
    ...
    (function (a) {
        ...
        B.prototype.matchResponsiveRule = function (a, k) {
            ...
            (
                ...
                function () {
                    return (
                        this.chartWidth <= f(l.maxWidth, Number.MAX_VALUE) &&
                        this.chartHeight <= f(l.maxHeight, Number.MAX_VALUE) &&
                        this.chartWidth >= f(l.minWidth, 0) &&
                        this.chartHeight >= f(l.minHeight, 0)
                    );
                }
