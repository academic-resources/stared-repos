...
(function (d) {
    ...
    (function (c) {
        ...
        var g = c.seriesTypes,
            ...
            h = c.extend,
            k = c.each;
        h(f.lang, { noData: "No data to display" });
        f.noData = {
        ...
        k(
            "bubble gauge heatmap pie treemap waterfall".split(" "),
            function (a) {
                g[a] &&
                    (g[a].prototype.hasData = function () {
        ...
        e.showNoData = function (a) {
            ...
            this.noDataLabel ||
                ...
                this.noDataLabel.attr(b.attr).css(b.style),
                this.noDataLabel.add(),
                this.noDataLabel.align(
                    h(this.noDataLabel.getBBox(), b.position),
                    !1,
                    "plotBox"
                ));
        };
