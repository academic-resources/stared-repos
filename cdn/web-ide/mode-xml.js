                    ...
                    this.add(
                        ...
                        function (e, t, n, r, i) {
                            if (i == '"' || i == "'") {
                                ...
                                var d = !c || c.match(/\s/);
                                if (
                                    (u(p, "attribute-equals") &&
                                        (d || c == ">")) ||
                                    (u(p, "decl-attribute-equals") &&
                                        (d || c == "?"))
                                )
                            ...
                            function (e, t, n, r, i) {
                                if (i == ">") {
                                    ...
                                    if (
                                        ...
                                        return;
                                    if (u(f, "reference.attribute-value"))
                                        return;
                                    if (u(f, "attribute-value")) {
                                        var l =
                                            a.getCurrentTokenColumn() +
                                            f.value.length;
                                        if (o.column < l) return;
                                        if (o.column == l) {
                                            var c = a.stepForward();
                                            if (c && u(c, "attribute-value"))
                                                return;
                                            a.stepBackward();
                                        }
                                    }
                                    if (
                                        /^\s*>/.test(
                                            r.getLine(o.row).slice(o.column)
                                        )
                                    )
                                        return;
                                    while (!u(f, "tag-name")) {
                                    ...
                                    if (u(a.stepBackward(), "end-tag-open"))
                                        return;
                                    var d = f.value;
                                    h == o.row &&
                                        (d = d.substring(0, o.column - p));
                                    if (
                        ...
                        this.add(
                            ...
                            function (e, t, n, r, i) {
                                if (i == "\n") {
                                    ...
                                    if (
                                        f &&
                                        f.type.indexOf("tag-close") !== -1
                                    ) {
                                        if (f.value == "/>") return;
                                        while (
                                            f &&
                                            f.type.indexOf("tag-name") === -1
                                        )
                                            f = a.stepBackward();
                                        if (!f) return;
                                        var l = f.value,
                ...
                (this.getFoldWidget = function (e, t, n) {
                    ...
                    (this._pop = function (e, t) {
                        while (e.length) {
                            ...
                            if (
                                this.optionalEndTags.hasOwnProperty(n.tagName)
                            ) {
                                e.pop();
                                continue;
                            }
                        ...
                        if (!i) {
                            var f = new u(e, n, r.start.column),
                                l = {
                                    row: n,
                                    column:
                                        r.start.column + r.tagName.length + 2,
                                };
                            r.start.row == r.end.row &&
                                (l.column = r.end.column);
