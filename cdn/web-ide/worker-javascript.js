                        ...
                        (function (e) {
                            (function () {
                                ...
                                function An(e) {
                                    var t = ir(e),
                                        ...
                                        s =
                                            r &&
                                            Cn(r) &&
                                            (Xn(e) || (i.nonEnumArgs && Wn(e))),
                                        o = -1,
                                        u = [];
                                    while (++o < n) {
                                        var a = t[o];
                                        ((s && xn(a, r)) || nt.call(e, a)) &&
                                            u.push(a);
                                    }
                                    return u;
                                }
                                ...
                                (function (e) {
                                    ...
                                    (kt.funcDecomp = /\bthis\b/.test(
                                        function () {
                                            return this;
                                        }
                                    )),
                                        (kt.funcNames =
                                            typeof Function.name == "string");
                                    try {
                            ...
                            p = (function () {
                                ...
                                function H() {
                                    P(),
                                        ...
                                        f.option.shelljs &&
                                            (D(S, s.shelljs), D(S, s.node)),
                                        f.option.typed && D(S, s.typed),
                                        f.option.phantom &&
                                            (D(S, s.phantom),
                                            f.option.strict === !0 &&
                                                (f.option.strict = "global")),
                                        f.option.prototypejs &&
                                            D(S, s.prototypejs),
                                        f.option.node &&
                                            (D(S, s.node),
                                            D(S, s.typed),
                                ...
                                function F(e, t, n, r, i, s) {
                                    ...
                                    return (
                                        ...
                                        p.errors.push(l),
                                        j(),
                                        p.errors.length >= f.option.maxerr &&
                                            B("E043", a, u),
                                        l
                                    );
                                }
                                ...
                                function tt(e) {
                                    (e = e || {}),
                                        e.peek
                                            ...
                                            : (et(f.tokens.curr, f.tokens.next),
                                              V(","));
                                    if (
                                ...
                                function wt(e, t, n) {
                                    ...
                                    return (
                                        ...
                                        e.id === "."
                                            ...
                                            : e.id === "{" || e.id === "["
                                            ? (r &&
                                              f.tokens.curr.left.destructAssign
                                                  ? f.tokens.curr.left.destructAssign.forEach(
                                                        function (e) {
                                                            e.id &&
                                                                f.funct[
                                                                    "(scope)"
                                                  ...
                                                  : e.left.value ===
                                                    ...
                                                    F("E031", t),
                                              e.id === "[" &&
                                                  f.nameStack.set(e.right),
                                              !0)
                                            : e.isMetaProperty
                                            ? (q("E031", t), !0)
                                            : e.identifier && !O(e)
                                            ? (f.funct["(scope)"].labeltype(
                                                  e.value
                                              ) === "exception" && F("W022", e),
                                              f.nameStack.set(e),
                                              !0)
                                            : (e === f.syntax["function"] &&
                                                  F("W023", f.tokens.curr),
                                              !1)
                                    );
                                }
                                function Et(e, t, n) {
                                ...
                                function _t(e, t, n, i, s) {
                                    ...
                                    if (f.tokens.next.id === "{") {
                                        V("{"),
                                            f.funct["(scope)"].stack(),
                                            (h = f.tokens.curr.line);
                                        if (f.tokens.next.id !== "}") {
                                            g += f.option.indent;
                                            while (!e && f.tokens.next.from > g)
                                                g += f.option.indent;
                                            if (n) {
                                                l = {};
                                                for (p in f.directive)
                                                    r.has(f.directive, p) &&
                                                        (l[p] = f.directive[p]);
                                                Mt(),
                                                    f.option.strict &&
                                        ...
                                        (f.funct["(noblockscopedvar)"] =
                                            ...
                                            (f.tokens.next.inBracelessBlock =
                                                !0),
                                            (g += f.option.indent),
                                            (o = [At()]),
                                            (g -= f.option.indent),
                                ...
                                function jt() {
                                    return (
                                        (f.funct["(statement)"] &&
                                            f.funct["(statement)"].type ===
                                                "class") ||
                                        (f.funct["(context)"] &&
                                            f.funct["(context)"]["(verb)"] ===
                                                "class")
                                    );
                                }
                                function Ft(e) {
                                ...
                                function Wt(e) {
                                    function i() {
                                        if (
                                            ...
                                            f.tokens.curr.tail &&
                                            f.tokens.curr.context === t
                                        )
                                            return !0;
                                        var e =
                                            f.tokens.next.template &&
                                            f.tokens.next.tail &&
                                            f.tokens.next.context === t;
                                        return (
                                            e && V(),
                                            e || f.tokens.next.isUnclosed
                                        );
                                    }
                                    var t = this.context,
                                        n = this.noSubst,
                                ...
                                function Xt(e) {
                                    ...
                                    return (
                                        ...
                                        f.funct[
                                            "(metrics)"
                                        ].verifyMaxStatementsPerFunction(),
                                        f.funct[
                                            "(metrics)"
                                        ].verifyMaxComplexityPerFunction(),
                                        (f.funct["(unusedOption)"] =
                                            f.option.unused),
                                        (f.option = l),
                                        (f.ignored = c),
                                        (f.funct["(last)"] =
                                            f.tokens.curr.line),
                                        (f.funct["(lastcharacter)"] =
                                            f.tokens.curr.character),
                                        f.funct["(scope)"].unstack(),
                                        f.funct["(scope)"].unstack(),
                                ...
                                function Yt(e) {
                                    ...
                                    if (pn(o, "[")) {
                                        r || V("["),
                                            pn(f.tokens.next, "]") &&
                                                F("W137", f.tokens.curr);
                                        var l = !1;
                                        while (!pn(f.tokens.next, "]"))
                                            u() &&
                                                !l &&
                                                pn(f.tokens.next, ",") &&
                                                (F("W130", f.tokens.next),
                                                (l = !0)),
                                                pn(f.tokens.next, "=") &&
                                                    (pn(f.tokens.prev, "...")
                                                        ? V("]")
                                ...
                                var an = function () {
                                    ...
                                    yn = function (t, i, o) {
                                        ...
                                        W.on("warning", function (e) {
                                            F.apply(
                                                null,
                                                [e.code, e.token].concat(e.data)
                                            );
                                        }),
                                            W.on("error", function (e) {
                                                q.apply(
                                                    null,
                                                    [e.code, e.token].concat(
                                                        e.data
                                                    )
                                                );
                                            }),
                        ...
                        (p.prototype = {
                            ...
                            scanPunctuator: function () {
                                ...
                                switch (e) {
                                    ...
                                    case "{":
                                        return (
                                            this.pushContext(c.Block),
                                            { type: l.Punctuator, value: e }
                                        );
                                    case "}":
                                        return (
                                            this.inContext(c.Block) &&
                                                this.popContext(),
                                            { type: l.Punctuator, value: e }
                                        );
                                    case "#":
                            ...
                            scanComments: function () {
                                ...
                                if (t === "/")
                                    return (
                                        this.skip(this.input.length), u("//", n)
                                    );
                                var a = "";
                                if (t === "*") {
                        ...
                        var r = e("./name-stack.js"),
                            i = {
                                ...
                                inES6: function () {
                                    return (
                                        this.option.moz ||
                                        this.option.esversion >= 6
                                    );
                                },
                                inES5: function (e) {
                                    return e
                                        ? (!this.option.esversion ||
                                              this.option.esversion === 5) &&
                                              !this.option.moz
                                        : !this.option.esversion ||
                                              this.option.esversion >= 5 ||
                                              this.option.moz;
