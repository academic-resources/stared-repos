        ...
        function (e, t, n) {
            ...
            Object.getPrototypeOf ||
                (Object.getPrototypeOf = function (t) {
                    return (
                        t.__proto__ ||
                        (t.constructor ? t.constructor.prototype : o)
                    );
                });
        ...
        function (e, t, n) {
            ...
            (t.buildDom = function o(e, t, n) {
                ...
                (t.scrollbarWidth = function (e) {
                    ...
                    var u = n.offsetWidth;
                    return (
                        o == u && (u = r.clientWidth), s.removeChild(r), o - u
                    );
                }),
                typeof document == "undefined" &&
        ...
        function (e, t, n) {
            ...
            var r = e("../lib/event"),
                ...
                c = function (e, t) {
                    ...
                    var B = function (e) {
                            if (m || !t.onCompositionStart || t.$readOnly)
                                return;
                            (m = {}),
                ...
                h = function (e, t) {
                    ...
                    r.addListener(n, "blur", function (e) {
                        ...
                        t.on("beforeEndOperation", function () {
                            if (
                                t.curOp &&
                                t.curOp.command.name == "insertstring"
                            )
                                return;
                            d && ((E = n.value = ""), q()), C();
                        }),
                    ...
                    var F = function (e) {
                            if (d || !t.onCompositionStart || t.$readOnly)
                                return;
                            d = {};
                            if (b) return;
            ...
            (function () {
                (this.onMouseDown = function (e) {
                    ...
                    (this.select = function () {
                        var e,
                            t = this.editor,
                            n = t.renderer.screenToTextCoordinates(
                                this.x,
                                this.y
                            );
                    ...
                    (this.extendSelectionBy = function (e) {
                        var t,
                            n = this.editor,
                            r = n.renderer.screenToTextCoordinates(
                                this.x,
                                this.y
                            ),
                        ...
                        r.isMultiLine() && r.contains(t.row, t.column)
                            ? ((this.$clickSelection = n.selection.getLineRange(
                              ...
                              (this.$clickSelection.end =
                                  n.selection.getLineRange(r.end.row).end))
                            : (this.$clickSelection = n.selection.getLineRange(
                                  t.row
                              )),
                            this.select();
            ...
            function f(e) {
                ...
                function L() {
                    clearInterval(v),
                        ...
                        t.isFocused() &&
                            !w &&
                            t.renderer.$cursorLayer.setBlinking(
                                !t.getReadOnly()
                            ),
                        (m = null),
                        (g = null),
                    ...
                    r.addListener(
                        ...
                        e.on("mousemove", function (n) {
                            if (t.state || t.$dragDelay || !t.$dragEnabled)
                                return;
                            var r = e.renderer.screenToTextCoordinates(
                                    n.x,
                                    n.y
                                ),
                        ...
                        var o = this,
                            ...
                            f = function (e) {
                                n.off("beforeEndOperation", c),
                                    ...
                                    (o.isMousePressed = !1),
                                    (o.$onCaptureMouseMove = o.releaseMouse =
                                        null),
                ...
                (this.isBidiRow = function (e, t, n) {
                    ...
                    (this.updateRowLine = function (e, t) {
                        ...
                        if (this.session.$useWrapMode) {
                            ...
                            o &&
                                ...
                                t > 0 && o.length
                                    ...
                                    : (this.line = this.line.substring(
                                          0,
                                          o[t]
                                      ))),
                                t == o.length &&
                                    (this.line += this.showInvisibles
                                        ? s
                                        : r.DOT);
                        ...
                        (this.line = this.line.replace(
                            ...
                            function (e, t) {
                                return e === "	" ||
                                    u.isFullWidth(e.charCodeAt(0))
                                    ? ((f =
                                          e === "	"
                                              ? u.getScreenTabSize(t + a)
                                              : 2),
                                      (a += f - 1),
                            ...
                            this.isRtlDir &&
                                ((this.fontMetrics.$main.innerHTML =
                                    this.line.charAt(this.line.length - 1) ==
                                    r.DOT
                                        ? this.line.substr(
                                              0,
                                              this.line.length - 1
        ...
        function (e, t, n) {
            ...
            (function () {
                r.implement(this, s),
                    ...
                    (this.isMultiLine = function () {
                        return (
                            !this.$isEmpty && this.anchor.row != this.cursor.row
                        );
                    }),
                    ...
                    (this.moveCursorLongWordLeft = function () {
                        ...
                        (this.session.nonTokenRe.lastIndex = 0),
                            ...
                            this.session.nonTokenRe.exec(s) &&
                                ((t -= this.session.nonTokenRe.lastIndex),
                                (s = s.slice(
                                    this.session.nonTokenRe.lastIndex
                                )),
                                (this.session.nonTokenRe.lastIndex = 0));
                        if (t <= 0) {
                        ...
                        t === 0 &&
                            (e !== 0 &&
                                (this.session.$bidiHandler.isBidiRow(
                                    ...
                                    ? ((r =
                                          this.session.$bidiHandler.getPosLeft(
                                              n.column
                                          )),
                                      (n.column = Math.round(
                                          r /
    ...
    ace.define(
        ...
        function (e, t, n) {
            ...
            var r = [
                    ...
                    2, 457, 5, 11, 15, 4, 8, 0, 2, 0, 18, 116, 2, 1, 3, 3, 9, 0,
                    2, 2, 2, 0, 2, 19, 2, 82, 2, 138, 2, 4, 3, 155, 12, 37, 3,
                    0, 8, 38, 10, 44, 2, 0, 2, 1, 2, 1, 2, 0, 9, 26, 6, 2, 30,
                    10, 7, 61, 2, 9, 5, 101, 2, 7, 3, 9, 2, 18, 3, 0, 17, 58, 3,
                    100, 15, 53, 5, 0, 6, 45, 211, 57, 3, 18, 2, 5, 3, 11, 3, 9,
                    2, 1, 7, 6, 2, 2, 2, 7, 3, 1, 3, 21, 2, 6, 2, 0, 4, 3, 3, 8,
                    3, 1, 3, 3, 9, 0, 5, 1, 2, 4, 3, 11, 16, 2, 2, 5, 5, 1, 3,
                    21, 2, 6, 2, 1, 2, 1, 2, 1, 3, 0, 2, 4, 5, 1, 3, 2, 4, 0, 8,
                    3, 2, 0, 8, 15, 12, 2, 2, 8, 2, 2, 2, 21, 2, 6, 2, 1, 2, 4,
                    3, 9, 2, 2, 2, 2, 3, 0, 16, 3, 3, 9, 18, 2, 2, 7, 3, 1, 3,
                    21, 2, 6, 2, 1, 2, 4, 3, 8, 3, 1, 3, 2, 9, 1, 5, 1, 2, 4, 3,
                    9, 2, 0, 17, 1, 2, 5, 4, 2, 2, 3, 4, 1, 2, 0, 2, 1, 4, 1, 4,
                    2, 4, 11, 5, 4, 4, 2, 2, 3, 3, 0, 7, 0, 15, 9, 18, 2, 2, 7,
                    2, 2, 2, 22, 2, 9, 2, 4, 4, 7, 2, 2, 2, 3, 8, 1, 2, 1, 7, 3,
                    3, 9, 19, 1, 2, 7, 2, 2, 2, 22, 2, 9, 2, 4, 3, 8, 2, 2, 2,
                    3, 8, 1, 8, 0, 2, 3, 3, 9, 19, 1, 2, 7, 2, 2, 2, 22, 2, 15,
                    4, 7, 2, 2, 2, 3, 10, 0, 9, 3, 3, 9, 11, 5, 3, 1, 2, 17, 4,
                    23, 2, 8, 2, 0, 3, 6, 4, 0, 5, 5, 2, 0, 2, 7, 19, 1, 14, 57,
                    6, 14, 2, 9, 40, 1, 2, 0, 3, 1, 2, 0, 3, 0, 7, 3, 2, 6, 2,
                    2, 2, 0, 2, 0, 3, 1, 2, 12, 2, 2, 3, 4, 2, 0, 2, 5, 3, 9, 3,
                    1, 35, 0, 24, 1, 7, 9, 12, 0, 2, 0, 2, 0, 5, 9, 2, 35, 5,
                    19, 2, 5, 5, 7, 2, 35, 10, 0, 58, 73, 7, 77, 3, 37, 11, 42,
                    2, 0, 4, 328, 2, 3, 3, 6, 2, 0, 2, 3, 3, 40, 2, 3, 3, 32, 2,
                    3, 3, 6, 2, 0, 2, 3, 3, 14, 2, 56, 2, 3, 3, 66, 5, 0, 33,
                    15, 17, 84, 13, 619, 3, 16, 2, 25, 6, 74, 22, 12, 2, 6, 12,
                    20, 12, 19, 13, 12, 2, 2, 2, 1, 13, 51, 3, 29, 4, 0, 5, 1,
                    3, 9, 34, 2, 3, 9, 7, 87, 9, 42, 6, 69, 11, 28, 4, 11, 5,
                    11, 11, 39, 3, 4, 12, 43, 5, 25, 7, 10, 38, 27, 5, 62, 2,
                    28, 3, 10, 7, 9, 14, 0, 89, 75, 5, 9, 18, 8, 13, 42, 4, 11,
                    71, 55, 9, 9, 4, 48, 83, 2, 2, 30, 14, 230, 23, 280, 3, 5,
                    3, 37, 3, 5, 3, 7, 2, 0, 2, 0, 2, 0, 2, 30, 3, 52, 2, 6, 2,
                    0, 4, 2, 2, 6, 4, 3, 3, 5, 5, 12, 6, 2, 2, 6, 67, 1, 20, 0,
                    29, 0, 14, 0, 17, 4, 60, 12, 5, 0, 4, 11, 18, 0, 5, 0, 3, 9,
                    2, 0, 4, 4, 7, 0, 2, 0, 2, 0, 2, 3, 2, 10, 3, 3, 6, 4, 5, 0,
                    53, 1, 2684, 46, 2, 46, 2, 132, 7, 6, 15, 37, 11, 53, 10, 0,
                    17, 22, 10, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2,
                    31, 48, 0, 470, 1, 36, 5, 2, 4, 6, 1, 5, 85, 3, 1, 3, 2, 2,
                    89, 2, 3, 6, 40, 4, 93, 18, 23, 57, 15, 513, 6581, 75,
                    20939, 53, 1164, 68, 45, 3, 268, 4, 27, 21, 31, 3, 13, 13,
                    1, 2, 24, 9, 69, 11, 1, 38, 8, 3, 102, 3, 1, 111, 44, 25,
                    51, 13, 68, 12, 9, 7, 23, 4, 0, 5, 45, 3, 35, 13, 28, 4, 64,
                    15, 10, 39, 54, 10, 13, 3, 9, 7, 22, 4, 1, 5, 66, 25, 2,
                    227, 42, 2, 1, 3, 9, 7, 11171, 13, 22, 5, 48, 8453, 301, 3,
                    61, 3, 105, 39, 6, 13, 4, 6, 11, 2, 12, 2, 4, 2, 0, 2, 1, 2,
                    1, 2, 107, 34, 362, 19, 63, 3, 53, 41, 11, 5, 15, 17, 6, 13,
                    1, 25, 2, 33, 4, 2, 134, 20, 9, 8, 25, 5, 0, 2, 25, 12, 88,
                    4, 5, 3, 5, 3, 5, 3, 2,
                ],
                i = 0,
                s = [];
    ...
    ace.define(
        ...
        function (e, t, n) {
            ...
            function s(e, t) {
                ...
                var n = t.start;
                i(e, t.start) ||
                    r(t, "delta.start must be contained in document");
                var s = t.end;
                t.action == "remove" &&
                    !i(e, s) &&
                    r(
            ...
            t.applyDelta = function (e, t, n) {
                ...
                switch (t.action) {
                    case "insert":
                        ...
                        if (o.length === 1)
                            e[r] =
                                s.substring(0, i) + t.lines[0] + s.substring(i);
                        else {
                        ...
                        return (
                            e >= this.document.getLength()
                                ? ((n.row = Math.max(
                                  ...
                                  (n.column = this.document.getLine(
                                      n.row
                                  ).length))
                                : e < 0
                                ? ((n.row = 0), (n.column = 0))
            ...
            (function () {
                r.implement(this, s),
                    ...
                    (this.replace = function (e, t) {
                        ...
                        var n;
                        return (
                            t ? (n = this.insert(e.start, t)) : (n = e.start), n
                        );
                    }),
            ...
            function u() {
                (this.getFoldAt = function (e, t, n) {
                    ...
                    (this.toggleFoldWidget = function (e) {
                        ...
                        if (n) {
                            t = n.start.row;
                            var i = this.getFoldAt(
                                t,
                                this.getLine(t).length,
                                1
                            );
    ...
    ace.define(
        ...
        function (e, t, n) {
            ...
            (d.$uid = 0),
                function () {
                    ...
                    r.implement(this, u),
                        ...
                        (this.getUndoManager = function () {
                            return (
                                this.$undoManager || this.$defaultUndoManager
                            );
                        }),
                        ...
                        (this.getUseSoftTabs = function () {
                            return (
                                this.$useSoftTabs && !this.$mode.$indentWithTabs
                            );
                        }),
                        ...
                        (this.removeMarker = function (e) {
                            var t =
                                this.$frontMarkers[e] || this.$backMarkers[e];
                            if (!t) return;
                            var n = t.inFront
                                ? this.$frontMarkers
                                : this.$backMarkers;
                        ...
                        (this.highlightLines = function (e, t, n, r) {
                            ...
                            return (
                                (i.id = this.addMarker(i, n, "fullLine", r)), i
                            );
                        }),
                                ...
                                (f = this.getFoldLine(l, f)),
                                    f
                                        ? ((a = []),
                                          ...
                                          (o[f.start.row] =
                                              this.$computeWrapSplits(a, u, i)),
                                          (l = f.end.row + 1))
                                        : ((a = this.$getDisplayTokens(r[l])),
                                          (o[l] = this.$computeWrapSplits(
                                              a,
                                              u,
                                              i
                                          )),
                    ...
                    (this.$computeWrapSplits = function (e, r, i) {
                        ...
                        (this.getDocumentLastRowColumnPosition = function (
                            e,
                            t
                        ) {
                            var n = this.documentToScreenRow(e, t);
                        ...
                        (this.documentToScreenPosition = function (e, t) {
                            ...
                            h && u >= p
                                ? ((d = this.getFoldDisplayLine(h, e, t)),
                                  (i = h.start.row))
                                : ((d = this.getLine(e).substring(0, t)),
                                  (i = e));
                            var v = 0;
                            if (this.$useWrapMode) {
                ...
                e("./edit_session/bracket_match").BracketMatch.call(
                    d.prototype
                ),
                            ...
                            return (
                                ...
                                this.recording
                                    ? (this.macro.pop(),
                                      ...
                                      (this.recording = !1))
                                    : (this.$addCommandToMacro ||
                                          (this.$addCommandToMacro = function (
                                              e
                                          ) {
                                              this.macro.push([
                                                  e.command,
                ...
                },
                {
                    ...
                    exec: function (e) {
                        ...
                        i.row + 1 < e.session.doc.getLength() - 1 &&
                            ...
                            e.clearSelection(),
                            e.session.doc.replace(
                                new s(n.row, 0, i.row + 2, 0),
                                f
                            ),
                            a > 0
                    ...
                    exec: function (e) {
                        ...
                        for (var o = 0; o < r.length; o++)
                            o == r.length - 1 &&
                                ...
                                i.push(
                                    new s(r[o].end.row, r[o].end.column, t, n)
                                ),
                                o === 0
                                    ? (r[o].start.row !== 0 ||
                                          r[o].start.column !== 0) &&
                    ...
                    r.implement(this, d),
                        ...
                        (this.setSession = function (e) {
                            ...
                            (this.session = e),
                                ...
                                (this.curOp = null),
                                t &&
                                    t._signal("changeEditor", {
                                        oldEditor: this,
                                    }),
                                e &&
                                    e._signal("changeEditor", { editor: this }),
                                e &&
                                    e.bgTokenizer &&
                                    e.bgTokenizer.scheduleStart();
                        }),
                        ...
                        (this.onScrollTopChange = function () {
                            this.renderer.scrollToY(
                                this.session.getScrollTop()
                            );
                        }),
                        (this.onScrollLeftChange = function () {
                            this.renderer.scrollToX(
                        ...
                        (this.$handlePaste = function (e) {
                            ...
                            if (
                                ...
                                this.selection.rangeList.ranges.forEach(
                                    function (e) {
                                        r.insert(
                                            { row: e.start.row, column: 0 },
                                            t
                                        );
                                    }
                                );
                        ...
                        (this.jumpToMatching = function (e, t) {
                            ...
                            if (o === "bracket") {
                                ...
                                if (!s || s.type.indexOf("tag-name") === -1)
                                    return;
                                var v = s.value;
                                h = new p(
                                    r.getCurrentTokenRow(),
            ...
            (function () {
                i.implement(this, o),
                    ...
                    (this.updateLineHighlight = function () {
                        ...
                        this.$cursorRow = e;
                        if (this.$cursorCell && this.$cursorCell.row == e)
                            return;
                        this.$cursorCell &&
            ...
            (function () {
                ...
                (this.$padding = 0),
                    ...
                    (this.drawMultiLineMarker = function (e, t, n, r, i) {
                        ...
                        var c =
                            (t.start.column ? 1 : 0) | (t.end.column ? 0 : 8);
                        this.elt(
                            n + (c ? " ace_br" + c : ""),
                            "height:" +
                                o +
                    ...
                    (this.drawSingleLineMarker = function (e, t, n, r, i, s) {
                        ...
                        var o = r.lineHeight,
                            ...
                            f =
                                this.$padding +
                                t.start.column * r.characterWidth;
                        this.elt(
                            n,
                            "height:" +
                                o +
                ...
                (this.$updateOpacity = function (e) {
                    ...
                    (this.update = function (e) {
                        ...
                        for (var n = 0, s = t.length; n < s; n++) {
                            ...
                            if (
                                (o.top > e.height + e.offset || o.top < 0) &&
                                n > 1
                            )
                                continue;
        ...
        function (e, t, n) {
            ...
            var f = function (e, t) {
                a.call(this, e),
                    (this.scrollTop = 0),
                    (this.scrollHeight = 0),
                    (t.$scrollbarWidth = this.width =
                        i.scrollbarWidth(e.ownerDocument)),
                ...
                r.implement(this, a),
                    ...
                    (this.$pollSizeChanges = function () {
                        if (this.$pollSizeChangesTimer || this.$observer)
                            return this.$pollSizeChangesTimer;
                        var e = this;
                        return (this.$pollSizeChangesTimer = o.onIdle(
                            function t() {
            ...
            var y = function (e, t) {
                ...
                (this.canvas = r.element),
                    ...
                    this.scrollBarH.addEventListener("scroll", function (e) {
                        n.$scrollAnimation ||
                            n.session.setScrollLeft(
                                e.data - n.scrollMargin.left
                            );
                    }),
                    (this.scrollTop = 0),
                    (this.scrollLeft = 0),
                ...
                (this.CHANGE_CURSOR = 1),
                    ...
                    (this.updateLines = function (e, t, n) {
                        ...
                        if (
                            ...
                            if (!n) return;
                            this.$changedLines.lastRow =
                                this.layerConfig.lastRow;
                        }
                        if (
                            this.$changedLines.firstRow >
                            this.layerConfig.lastRow
                        )
                            return;
                    ...
                    (this.$renderChanges = function (e, t) {
                        ...
                        e & this.CHANGE_TEXT
                            ...
                            e &
                                (this.CHANGE_MARKER |
                                    this.CHANGE_MARKER_FRONT) &&
                                this.$markerFront.update(n),
                            e &
                                (this.CHANGE_MARKER |
                                    this.CHANGE_MARKER_BACK) &&
                                this.$markerBack.update(n),
                            this._signal("afterRender");
                    }),
                    (this.$autosize = function () {
                        var e =
                                this.session.getScreenLength() *
                                this.lineHeight,
                    ...
                    (this.$computeLayerConfig = function () {
                        var e = this.session,
                            ...
                            o =
                                ...
                                (this.$hScrollBarAlwaysVisible ||
                                    t.scrollerWidth - s - 2 * this.$padding <
                                        0),
                        ...
                        var v = Math.ceil(l / this.lineHeight) - 1,
                            m = Math.max(
                                0,
                                Math.round(
                                    (this.scrollTop - f) / this.lineHeight
                                )
                            ),
                            g = m + v,
                            y,
                    ...
                    (this.updateFrontMarkers = function () {
                        this.$markerFront.setMarkers(
                            this.session.getMarkers(!0)
                        ),
                    ...
                    (this.scrollCursorIntoView = function (e, t, n) {
                        ...
                        f > i
                            ...
                            : f + this.$size.scrollerWidth <
                              i + this.characterWidth
                            ? this.session.setScrollLeft(
                                  Math.round(
                                      i +
                                          this.characterWidth -
                ...
                s.implement(this, i),
                    ...
                    (this.cancel = function () {
                        ...
                        this.selectionBefore &&
                            this.session.selection.fromJSON(
                                this.selectionBefore
                            );
                    });
            }.call(o.prototype),
                        ...
                        k = function () {
                            ...
                            (E = e),
                                ...
                                l.$mouseHandler.$clickSelection &&
                                    ...
                                    C[0].isEmpty() &&
                                    (C[0] =
                                        l.$mouseHandler.$clickSelection.clone()),
        ...
        function (e, t, n) {
            ...
            function m(e) {
                ...
                (e.$onAddRange = e.$onAddRange.bind(e)),
                    ...
                    (e.$checkMultiselectChange =
                        e.$checkMultiselectChange.bind(e)),
                ...
                (this.updateSelectionMarkers = function () {
                    ...
                    (this.$onMultiSelect = function (e) {
                        ...
                        (this.inMultiSelectMode = !0),
                            ...
                            this.keyBinding.addKeyboardHandler(
                                f.keyboardHandler
                            ),
                ...
                (this.getRowLength = function (e) {
                    ...
                    (this.removeLineWidget = function (e) {
                        ...
                        if (this.session.lineWidgets) {
                            ...
                            if (n == e)
                                (this.session.lineWidgets[e.row] =
                                    e.$oldWidget),
                                    e.$oldWidget &&
            ...
            e("./worker/worker_client"),
                ...
                (t.edit = function (e, n) {
                    if (typeof e == "string") {
                        ...
                        if (!e)
                            throw new Error("ace.edit can't find div #" + s);
                    }
