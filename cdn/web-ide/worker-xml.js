...
!(function (e) {
    ...
    ace.define("ace/mode/xml/sax", [], function (e, t, n) {
                    ...
                    default:
                        try {
                            ...
                            !_.closed &&
                                ...
                                y(_, r, p),
                                _.uri === "http://www.w3.org/1999/xhtml" &&
                                !_.closed
                ...
                switch (g) {
                    ...
                    case '"':
                        if (m === f) {
                            ...
                            if (!(v > 0))
                                throw new Error(
                                    "attribute value no end '" + g + "' match"
                                );
        ...
        function y(e, t, n) {
            ...
            while (o--) {
                ...
                c &&
                    (c === "xml" &&
                        (u.uri = "http://www.w3.org/XML/1998/namespace"),
                    c !== "xmlns" && (u.uri = s[c]));
            }
            var l = r.indexOf(":");
            l > 0
                ? ((c = e.prefix = r.slice(0, l)),
                  (h = e.localName = r.slice(l + 1)))
        ...
        function w(e, t, n, r) {
            var i = r[n];
            return (
                i == null && (i = r[n] = e.lastIndexOf("</" + n + ">")), i < t
            );
        }
        function E(e, t) {
            for (var n in e) t[n] = e[n];
    ...
    ace.define("ace/mode/xml/dom", [], function (e, t, n) {
            ...
            switch (e.nodeType) {
                case u:
                    ...
                    if (
                        i ||
                        (h &&
                            !/^(?:meta|link|img|br|hr|input|button)$/i.test(o))
                    ) {
                        t.push(">");
        ...
        var s = "http://www.w3.org/1999/xhtml",
            ...
            x = (b.HIERARCHY_REQUEST_ERR =
                ((w[3] = "Hierarchy request error"), 3)),
            ...
            D = (b.INVALID_MODIFICATION_ERR =
                ((w[13] = "Invalid modification"), 13)),
        ...
        (B.prototype = Error.prototype),
            ...
            (J.prototype = {
                ...
                createDocumentFragment: function () {
                    var e = new ct();
                    return (
                        (e.ownerDocument = this), (e.childNodes = new j()), e
                    );
                },
            ...
            (J.prototype.getElementsByTagName =
                tt.prototype.getElementsByTagName),
