...
!(function (t, n) {
        ...
        return Zr(
            ...
            function (t, n) {
                return (
                    (n -
                        t -
                        (n.getTimezoneOffset() - t.getTimezoneOffset()) * Ay) /
                    zy
                );
            }
        );
    ...
    function fi(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(Kr(n) / 3))) -
                Kr(Math.abs(t))
        );
    }
    function li(t, n) {
    ...
    function ko(t, n) {
        function e() {
            return (
                (i = Math.min(a.length, c.length) > 2 ? Mo : wo),
                (o = u = null),
                r
            );
        }
    ...
    function na(t, n) {
        return arguments.length > 1
            ? this.each(
                  (null == n ? Qu : "function" == typeof n ? ta : Ku)(t, n)
              )
            : this.node()[t];
    }
    function ea(t) {
                    ...
                    f.name === e.name &&
                        (f.state === Nm
                            ? ((f.state = Em),
                              ...
                              delete a[i])
                            : +i < n &&
                              ((f.state = Em), f.timer.stop(), delete a[i]));
            if (
                (Wr(function () {
                    e.state === Nm &&
    ...
    function $a(t, n) {
        ...
        if (((t += ""), arguments.length < 2)) {
            for (
                var r, i = Ba(this.node(), e).tween, o = 0, u = i.length;
                o < u;
                ++o
            )
        ...
        for (var n, e, r, i, o, u = new of(t, 0), a = [u]; (n = a.pop()); )
            if ((r = n._.children))
                for (
                    ...
                    a.push((e = n.children[i] = new of(r[i], i))),
                        (e.parent = n);
    ...
    function Uf() {
        ...
        function o() {
            if (l.apply(this, arguments)) {
                var n,
                    ...
                    o = r.length;
                for (n = 0; n < o; ++n)
                    (e = c(r[n].identifier, i, Da, this, arguments)) &&
                        (Nf(), e("start"));
            }
        }
        function u() {
        ...
        function c(e, r, i, o, u) {
            ...
            if (
                lu(
                    new Pf(n, "beforestart", a, e, _, f[0], f[1], 0, 0, l),
                    function () {
                        return (
    ...
    function el(t, n, e, r) {
        ...
        for (i = 0; i < _; ++i)
            (o = Jm[i]) && (o.halfedges.length || delete Jm[i]);
    }
    function rl() {
    ...
    function vl(t, n) {
        var e,
            ...
            o = t.sort(dl).pop();
        for (
            Km = [], Jm = new Array(t.length), Gm = new If(), Qm = new If();
            ;
    ...
    function Sl() {
        ...
        function e(t, n) {
            return (
                (n = Math.max(m, Math.min(x, n))),
                n === t.k ? t : new ml(n, t.x, t.y)
            );
        }
        function r(t, n, e) {
            var r = n[0] - e[0] * t.k,
        ...
        function s() {
            ...
            if (y.apply(this, arguments)) {
                ...
                wl(),
                    ...
                    o.zoom(
                        "mouse",
                        i(r(e(u, c), o.mouse[0], o.mouse[1]), o.extent)
                    );
            }
        }
        function f() {
    ...
    function Il(n) {
        ...
        return (
            ...
            (o.prototype = {
                ...
                emit: function (t) {
                    lu(
                        new Al(e, t, n.output(this.state.selection)),
                        l.apply,
                        l,
    ...
    function Jp(t, n) {
        ...
        return function (n) {
            ...
            function s() {
                e(y, g, _, m, x, b, l, h, f, p, d, v, pw, n),
                    (w.lineEnd = u),
                    u();
            }
            var f,
            ...
            function r(t) {
                return (
                    ((t = 2 * t - 1) < 0
                        ...
                        : 2 -
                          n * Math.pow(2, -10 * t) * Math.sin((i + t) / e)) / 2
                );
            }
            var i = Math.asin(1 / (n = Math.max(1, n))) * (e /= uv);
            return (
    ...
    Mt.prototype = Tt.prototype = {
        ...
        arc: function (t, n, e, r, i, o) {
            ...
            null === this._x1
                ? this._.push("M", c, ",", s)
                : (Math.abs(this._x1 - c) > dv ||
                      Math.abs(this._y1 - s) > dv) &&
                  this._.push("L", c, ",", s),
                e &&
                    (l > vv
                        ? this._.push(
    ...
    Tr.prototype = Mr.prototype = {
        ...
        on: function (t, n) {
                ...
                u = i.length;
            {
                ...
                for (; ++o < u; )
                    if ((e = (t = i[o]).type) && (e = Sr(r[e], t.name)))
                        return e;
            }
        },
        copy: function () {
    ...
    var Sy = ky.range,
        ...
        Uy = Zr(
            function (t) {
                ...
                n < 0 && (n += Ey),
                    t.setTime(Math.floor((+t - n) / Ey) * Ey + n);
            },
            function (t, n) {
                t.setTime(+t + n * Ey);
            },
    ...
    var Cb,
        ...
        Zb = {
            ...
            polygonEnd: function () {
                (Zb.lineStart = Zb.lineEnd = Zb.point = eh),
                    Wb.add(fb($b)),
                    $b.reset();
            },
            result: function () {
