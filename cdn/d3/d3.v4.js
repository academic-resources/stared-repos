...
(function (global, factory) {
    ...
    function freedmanDiaconis(values, min, max) {
        ...
        return Math.ceil(
            (max - min) /
                (2 *
                    (threshold(values, 0.75) - threshold(values, 0.25)) *
    ...
    function arc() {
        ...
        arc.cornerRadius = function (_) {
            return arguments.length
                ? ((cornerRadius =
                      typeof _ === "function" ? _ : constant$1(+_)),
                  arc)
                : cornerRadius;
        };
        ...
        arc.padAngle = function (_) {
            return arguments.length
                ? ((padAngle = typeof _ === "function" ? _ : constant$1(+_)),
                  arc)
                : padAngle;
        };
    ...
    function line() {
        ...
        line.y = function (_) {
            return arguments.length
                ? ((y$$ = typeof _ === "function" ? _ : constant$1(+_)), line)
                : y$$;
        };

        line.defined = function (_) {
            return arguments.length
                ? ((defined = typeof _ === "function" ? _ : constant$1(!!_)),
                  line)
                : defined;
        };
    ...
    function pie() {
        ...
        function pie(data) {
            var i,
                ...
                da = Math.min(
                    tau$2,
                    Math.max(-tau$2, endAngle.apply(this, arguments) - a0)
                ),
                a1,
    ...
    function symbol() {
        ...
        function symbol() {
            var buffer;
            if (!context) context = buffer = path();
            type.apply(this, arguments).draw(
                context,
        ...
        symbol.size = function (_) {
            return arguments.length
                ? ((size = typeof _ === "function" ? _ : constant$1(+_)),
                  symbol)
                : size;
        };
    ...
    function stack() {
        ...
        stack.value = function (_) {
            return arguments.length
                ? ((value = typeof _ === "function" ? _ : constant$1(+_)),
                  stack)
                : value;
        };
    ...
    var interpolateTransform$1 = interpolateTransform(
        parseCss,
        "px, ",
        "px)",
        "deg)"
        ...
        function newFormat(specifier) {
            ...
            function format(value) {
                ...
                if (type === "c") {
                    ...
                    var valueNegative =
                        (value < 0 || 1 / value < 0) && ((value *= -1), true);
        ...
        function formatPrefix(specifier, value) {
            var f = newFormat(
                ...
                e =
                    Math.max(
                        -8,
                        Math.min(8, Math.floor(exponent$1(value) / 3))
                    ) * 3,
                k = Math.pow(10, -e),
    ...
    function precisionPrefix(step, value) {
        return Math.max(
            0,
            Math.max(-8, Math.min(8, Math.floor(exponent$1(value) / 3))) * 3 -
    ...
    function continuous(deinterpolate$$, reinterpolate) {
        ...
        scale.domain = function (_) {
            return arguments.length
                ? ((domain = map$2.call(_, number$1)), rescale())
                : domain.slice();
        };

        scale.range = function (_) {
            return arguments.length
                ? ((range = slice$3.call(_)), rescale())
                : range.slice();
        };
    ...
    function identity$4() {
        ...
        scale.domain = scale.range = function (_) {
            return arguments.length
                ? ((domain = map$2.call(_, number$1)), scale)
                : domain.slice();
        };
    ...
    function quantize$1() {
        ...
        scale.range = function (_) {
            return arguments.length
                ? ((n = (range = slice$3.call(_)).length - 1), rescale())
                : range.slice();
        };
    ...
    var cubehelix$3 = interpolateCubehelixLong(
        cubehelix(300, 0.5, 0.0),
        cubehelix(-240, 0.5, 1.0)
    );

    var warm = interpolateCubehelixLong(
        cubehelix(-100, 0.75, 0.35),
        cubehelix(80, 1.5, 0.8)
    );

    var cool = interpolateCubehelixLong(
    ...
    function transition_attr(name, value) {
        ...
        return this.attrTween(
            ...
            typeof value === "function"
                ...
                : (fullname.local ? attrConstantNS$1 : attrConstant$1)(
                      fullname,
                      i,
                      value
                  )
    ...
    function transition_style(name, value, priority) {
        var i =
            (name += "") === "transform"
                ? interpolateTransform$1
                : interpolate$1;
        return value == null
            ? this.styleTween(name, styleRemove$1(name, i)).on(
                  "end.style." + name,
                  styleRemoveEnd(name)
              )
            : this.styleTween(
    ...
    function axis(orient, scale) {
        ...
        function axis(context) {
            var values =
                ...
                position = (scale.bandwidth ? center : identity$5)(
                    scale.copy()
                ),
            ...
            if (context !== selection) {
                ...
                tickExit = tickExit
                    ...
                    .attr("transform", function (d) {
                        return transform(
                            position,
                            this.parentNode.__axis || position,
                            d
                        );
                    });
        ...
        axis.tickArguments = function (_) {
            return arguments.length
                ? ((tickArguments = _ == null ? [] : slice$4.call(_)), axis)
                : tickArguments.slice();
        };

        axis.tickValues = function (_) {
            return arguments.length
                ? ((tickValues = _ == null ? null : slice$4.call(_)), axis)
    ...
    function index() {
        ...
        pack.padding = function (x) {
            return arguments.length
                ? ((padding = typeof x === "function" ? x : constant$5(+x)),
                  pack)
                : padding;
        };
    ...
    function index$1() {
        ...
        treemap.paddingInner = function (x) {
            return arguments.length
                ? ((paddingInner =
                      typeof x === "function" ? x : constant$5(+x)),
                  treemap)
                : paddingInner;
        };
        ...
        treemap.paddingTop = function (x) {
            return arguments.length
                ? ((paddingTop = typeof x === "function" ? x : constant$5(+x)),
                  treemap)
                : paddingTop;
        };
        ...
        treemap.paddingLeft = function (x) {
            return arguments.length
                ? ((paddingLeft = typeof x === "function" ? x : constant$5(+x)),
                  treemap)
                : paddingLeft;
        };
    ...
    function collide(radius) {
        ...
        force.radius = function (_) {
            return arguments.length
                ? ((radius = typeof _ === "function" ? _ : constant$6(+_)),
                  force)
                : radius;
        };
    ...
    function link(links) {
        ...
        force.strength = function (_) {
            return arguments.length
                ? ((strength = typeof _ === "function" ? _ : constant$6(+_)),
                  initializeStrength(),
                  force)
                : strength;
        };
        ...
        force.distance = function (_) {
            return arguments.length
                ? ((distance = typeof _ === "function" ? _ : constant$6(+_)),
                  initializeDistance(),
                  force)
                : distance;
        };
    ...
    function x$3(x) {
        ...
        force.x = function (_) {
            return arguments.length
                ? ((x = typeof _ === "function" ? _ : constant$6(+_)),
                  initialize(),
                  force)
                : x;
        };
    ...
    function y$3(y) {
        ...
        force.y = function (_) {
            return arguments.length
                ? ((y = typeof _ === "function" ? _ : constant$6(+_)),
                  initialize(),
                  force)
                : y;
        };
    ...
    function drag() {
        ...
        drag.filter = function (_) {
            return arguments.length
                ? ((filter = typeof _ === "function" ? _ : constant$7(!!_)),
                  drag)
                : filter;
        };
        ...
        drag.container = function (_) {
            return arguments.length
                ? ((container = typeof _ === "function" ? _ : constant$7(_)),
                  drag)
                : container;
        };
        ...
        drag.subject = function (_) {
            return arguments.length
                ? ((subject = typeof _ === "function" ? _ : constant$7(_)),
                  drag)
                : subject;
        };
            ...
            if ((cell = cells[iCell])) {
                ...
                while (iHalfedge < nHalfedges) {
                    ...
                    (start = cellHalfedgeStart(
                        ...
                        (startY = start[1]);
                    if (
                        Math.abs(endX - startX) > epsilon$3 ||
                        Math.abs(endY - startY) > epsilon$3
                    ) {
                        halfedges.splice(
                            iHalfedge,
                            0,
                            edges.push(
                                createBorderEdge(
                                    ...
                                    Math.abs(endX - x0) < epsilon$3 &&
                                        y1 - endY > epsilon$3
                                        ? [
                                              x0,
                                              Math.abs(startX - x0) < epsilon$3
                                                  ? startY
                                                  : y1,
                                          ]
                                        : Math.abs(endY - y1) < epsilon$3 &&
                                          x1 - endX > epsilon$3
                                        ? [
                                              Math.abs(startY - y1) < epsilon$3
                                                  ? startX
                                                  : x1,
                                              y1,
                                          ]
                                        : Math.abs(endX - x1) < epsilon$3 &&
                                          endY - y0 > epsilon$3
                                        ? [
                                              x1,
                                              Math.abs(startX - x1) < epsilon$3
                                                  ? startY
                                                  : y0,
                                          ]
                                        : Math.abs(endY - y0) < epsilon$3 &&
                                          endX - x0 > epsilon$3
                                        ? [
                                              Math.abs(startY - y0) < epsilon$3
                                                  ? startX
                                                  : x0,
                                              y0,
                                          ]
    ...
    function voronoi() {
        ...
        voronoi.x = function (_) {
            return arguments.length
                ? ((x = typeof _ === "function" ? _ : constant$8(+_)), voronoi)
                : x;
        };

        voronoi.y = function (_) {
            return arguments.length
                ? ((y = typeof _ === "function" ? _ : constant$8(+_)), voronoi)
                : y;
        };
    ...
    function zoom() {
        ...
        function constrain(transform, extent) {
            var dx =
                    Math.min(0, transform.invertX(extent[0][0]) - x0) ||
                    Math.max(0, transform.invertX(extent[1][0]) - x1),
                dy =
                    Math.min(0, transform.invertY(extent[0][1]) - y0) ||
                    Math.max(0, transform.invertY(extent[1][1]) - y1);
                ...
                k = Math.max(
                    ...
                    Math.min(
                        ...
                        t.k *
                            Math.pow(
                                2,
                                (-exports.event.deltaY *
                                    (exports.event.deltaMode ? 120 : 1)) /
                                    500
                            )
                    )
                ),
        ...
        zoom.filter = function (_) {
            return arguments.length
                ? ((filter = typeof _ === "function" ? _ : constant$9(!!_)),
                  zoom)
                : filter;
        };
    ...
    function brush$1(dim) {
            ...
            if (group.selection) {
                group
                    ...
                    .tween("brush", function () {
                        ...
                        function tween(t) {
                            state.selection =
                                t === 1 && empty$1(selection1) ? null : i(t);
                            redraw.call(that);
                            emit.brush();
                        }
                ...
                group.each(function () {
                    ...
                    interrupt(that);
                    state.selection =
                        selection1 == null || empty$1(selection1)
                            ? null
                            : selection1;
                    redraw.call(that);
        ...
        function started() {
            if (exports.event.touches) {
                if (
                    exports.event.changedTouches.length <
                    exports.event.touches.length
                )
                    return noevent$2();
            ...
            var that = this,
                ...
                mode =
                    (exports.event.metaKey ? (type = "overlay") : type) ===
                    "selection"
                        ? MODE_DRAG
                        : exports.event.altKey
                        ? MODE_CENTER
                        : MODE_HANDLE,
                    ...
                    case MODE_CENTER: {
                        if (signX)
                            (w1 = Math.max(W, Math.min(E, w0 - dx * signX))),
                                (e1 = Math.max(
                                    W,
                                    Math.min(E, e0 + dx * signX)
                                ));
                        if (signY)
                            (n1 = Math.max(N, Math.min(S, n0 - dy * signY))),
                                (s1 = Math.max(
                                    N,
                                    Math.min(S, s0 + dy * signY)
                                ));
                        break;
                    }
                }
        ...
        brush.filter = function (_) {
            return arguments.length
                ? ((filter = typeof _ === "function" ? _ : constant$10(!!_)),
                  brush)
                : filter;
        };
    ...
    function ribbon() {
        ...
        ribbon.radius = function (_) {
            return arguments.length
                ? ((radius = typeof _ === "function" ? _ : constant$11(+_)),
                  ribbon)
                : radius;
        };
        ...
        ribbon.startAngle = function (_) {
            return arguments.length
                ? ((startAngle = typeof _ === "function" ? _ : constant$11(+_)),
                  ribbon)
                : startAngle;
        };
        ...
        ribbon.endAngle = function (_) {
            return arguments.length
                ? ((endAngle = typeof _ === "function" ? _ : constant$11(+_)),
                  ribbon)
                : endAngle;
        };
    ...
    function linePoint(lambda, phi) {
        ...
        if (p0) {
            ...
            if (
                antimeridian ^
                (sign * lambda2 < lambdai && lambdai < sign * lambda)
            ) {
    ...
    function circle$1() {
        ...
        circle.radius = function (_) {
            return arguments.length
                ? ((radius = typeof _ === "function" ? _ : constant$12(+_)),
                  circle)
                : radius;
        };
        ...
        circle.precision = function (_) {
            return arguments.length
                ? ((precision = typeof _ === "function" ? _ : constant$12(+_)),
                  circle)
                : precision;
        };
    ...
    function clipExtent(x0, y0, x1, y1) {
        ...
        function corner(p, direction) {
            return abs(p[0] - x0) < epsilon$4
                ? direction > 0
                    ? 0
                    : 3
                : abs(p[0] - x1) < epsilon$4
                ? direction > 0
                    ? 2
                    : 1
                : abs(p[1] - y0) < epsilon$4
                ? direction > 0
                    ? 1
                    : 0
                : direction > 0
    ...
    function interpolate$2(a, b) {
        var x0 = a[0] * radians,
            ...
            d =
                2 *
                asin$1(
                    sqrt$1(haversin(y1 - y0) + cy0 * cy1 * haversin(x1 - x0))
                ),
            k = sin$1(d);
    ...
    function index$3() {
        ...
        path.projection = function (_) {
            return arguments.length
                ? ((projectionStream =
                      (projection = _) == null ? identity$7 : _.stream),
                  path)
                : projection;
        };
        ...
        path.context = function (_) {
            ...
            contextStream =
                (context = _) == null ? new PathString() : new PathContext(_);
            if (typeof pointRadius !== "function")
    ...
    function polygonContains(polygon, point) {
        ...
        return (
            (angle < -epsilon$4 || (angle < epsilon$4 && sum$2 < -epsilon$4)) ^
            (winding & 1)
        );
    }
    ...
    function compareIntersection(a, b) {
        return (
            ((a = a.x)[0] < 0 ? a[1] - halfPi$3 - epsilon$4 : halfPi$3 - a[1]) -
        ...
        return {
            ...
            point: function (lambda1, phi1) {
                ...
                if (abs(delta - pi$4) < epsilon$4) {
                    ...
                    stream.point(
                        lambda0,
                        (phi0 = (phi0 + phi1) / 2 > 0 ? halfPi$3 : -halfPi$3)
                    );
    ...
    function clipCircle(radius, delta) {
            ...
            return {
                ...
                point: function (lambda, phi) {
                    var point1 = [lambda, phi],
                        ...
                        c = smallRadius
                            ? v
                                ...
                                : code(lambda, phi)
                            : v
                            ? code(lambda + (lambda < 0 ? pi$4 : -pi$4), phi)
                            : 0;
                    ...
                    if (v !== v0) {
                        ...
                        if (
                            !(c & c0) &&
                            (t = intersect(point1, point0, true))
                        ) {
                            clean = 0;
                            if (smallRadius) {
                                stream.lineStart();
            ...
            if (
                meridian
                    ? polar
                        ? (phi0 + phi1 > 0) ^
                          (q[1] <
                              (abs(q[0] - lambda0) < epsilon$4 ? phi0 : phi1))
                        : phi0 <= q[1] && q[1] <= phi1
        ...
        return clip(
            ...
            clipLine,
            interpolate,
            smallRadius ? [0, -radius] : [-pi$4, radius - pi$4]
        );
    }
        ...
        function resampleLineTo(
            ...
            if (d2 > 4 * delta2 && depth--) {
                var a = a0 + a1,
                    ...
                    phi2 = asin$1((c /= m)),
                    lambda2 =
                        abs(abs(c) - 1) < epsilon$4 ||
                        abs(lambda0 - lambda1) < epsilon$4
                            ? (lambda0 + lambda1) / 2
                            : atan2(b, a),
    ...
    function projectionMutator(projectAt) {
        var project,
            ...
            x1,
            y1,
            postclip = identity$7, // clip extent
            delta2 = 0.5,
        ...
        projection.clipAngle = function (_) {
            return arguments.length
                ? ((preclip = +_
                      ? clipCircle((theta = _ * radians), 6 * radians)
    ...
    function mercatorProjection(project) {
        ...
        m.scale = function (_) {
            return arguments.length
                ? (scale(_), clipAuto && m.clipExtent(null), m)
                : scale();
        };

        m.translate = function (_) {
            return arguments.length
                ? (translate(_), clipAuto && m.clipExtent(null), m)
                : translate();
        };
