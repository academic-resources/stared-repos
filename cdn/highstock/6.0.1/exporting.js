        ...
        k.exporting = {
            ...
            buttons: {
                contextButton: {
                    ...
                    menuItems:
                        "printChart separator downloadPNG downloadJPEG downloadPDF downloadSVG".split(
                            " "
                        ),
                },
            },
        ...
        r(B.prototype, {
                ...
                return this.getSVG(
                    n({ chart: { borderRadius: 0 } }, e.chartOptions, b, {
                        exporting: {
                            ...
                            sourceHeight:
                                (a && a.sourceHeight) || e.sourceHeight,
                        },
                    })
                );
            },
            ...
            contextMenu: function (a, b, e, c, v, m, g) {
                ...
                l ||
                    ...
                    (y = p("div", { className: "highcharts-menu" }, null, l)),
                    u(
                        y,
                        r(
                            {
                    ...
                    h(b, function (a) {
                        "string" === typeof a &&
                            (a = d.options.exporting.menuItemDefinitions[a]);
                        if (f.isObject(a, !0)) {
                            var b;
                            a.separator
                                ? (b = p("hr", null, null, y))
                                : ((b = p(
                                  ...
                                  u(
                                      b,
                                      r({ cursor: "pointer" }, t.menuItemStyle)
                                  ));
                ...
                e + d.exportMenuWidth > k
                    ? (b.right = k - e - v - x + "px")
                    : (b.left = e - x + "px");
                c + m + d.exportMenuHeight > q &&
                "top" !== g.alignOptions.verticalAlign
                    ? (b.bottom = q - c - x + "px")
                    : (b.top = c + m - x + "px");
                u(l, b);
                d.openMenu = !0;
            ...
            addButton: function (a) {
                ...
                if (!1 !== c.enabled) {
                    ...
                    c.text && c.symbol
                        ? (h.paddingLeft = D(h.paddingLeft, 25))
                        : c.text ||
                          r(h, {
                              width: c.width,
                              height: c.height,
                    ...
                    d.add().align(
                        r(c, { width: d.width, x: D(c.x, b.buttonOffset) }),
                        !0,
                        "spacingBox"
                    );
                    b.buttonOffset +=
                        (d.width + c.buttonSpacing) *
                        ("right" === c.align ? -1 : 1);
