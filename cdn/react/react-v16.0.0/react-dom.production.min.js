...
function Nb(Za) {
    ...
    function ab(a) {
        ...
        var b = fa.get(a);
        if (b) return "number" === typeof b.tag ? Uc(b) : Vc(b);
    ...
    function Pe(a) {
        function b() {
            for (; null !== w && 0 === w.current.pendingWorkPriority; ) {
                ...
                if (w === I) return (I = w = null), (y = 0), null;
                w = a;
            }
            a = w;
            for (var b = null, c = 0; null !== a; )
                0 !== a.current.pendingWorkPriority &&
                    (0 === c || c > a.current.pendingWorkPriority) &&
                    ((c = a.current.pendingWorkPriority), (b = a)),
                    (a = a.nextScheduledRoot);
            if (null !== b) {
                for (y = c; -1 < da; ) (bb[da] = null), da--;
                cb = ba;
                ca.current = ba;
                S.current = !1;
                p();
                    ...
                    for (; null !== u; ) {
                        ...
                        if (h & 64)
                            switch (
                                ...
                                case 2:
                                    n.stateNode.componentDidCatch(e.error, {
        ...
        function d(a) {
            for (;;) {
                ...
                var n = a;
                if (
                    !(0 !== n.pendingWorkPriority && n.pendingWorkPriority > y)
                ) {
                    var p = n.updateQueue;
                    p =
                        null === p || (2 !== n.tag && 3 !== n.tag)
                            ? 0
                            : null !== p.first
                            ? p.first.priorityLevel
                            : 0;
            ...
            if (null !== P && 0 < P.size && 2 === y)
                for (; null !== D; ) {
                    ...
                    D =
                        null !== P &&
                        (P.has(a) ||
                            (null !== a.alternate && P.has(a.alternate)))
                            ? f(D)
                            : e(D);
                    if (
                        null === D &&
        ...
        function T(a, b) {
            var c = (db.current = null),
                ...
                p = !1,
                n = null;
            if (3 === a.tag) (c = a), eb(a) && (R = !0);
            else
                for (var e = a["return"]; null !== e && null === c; ) {
                    2 === e.tag
                        ? "function" === typeof e.stateNode.componentDidCatch &&
                          ((d = !0), (n = Ba(e)), (c = e), (p = !0))
                        : 3 === e.tag && (c = e);
                    if (eb(e)) {
                        if (
        ...
        function eb(a) {
            return (
                null !== C &&
                (C.has(a) || (null !== a.alternate && C.has(a.alternate)))
            );
        }
        function fb(a, b) {
            return ed(a, b, !1);
        ...
        function ed(a, b) {
            ...
            for (var c = !0; null !== a && c; ) {
                ...
                null !== a.alternate &&
                    (0 === a.alternate.pendingWorkPriority ||
                        a.alternate.pendingWorkPriority > b) &&
                    ((c = !0), (a.alternate.pendingWorkPriority = b));
                if (null === a["return"])
                    if (3 === a.tag) {
                        var d = a.stateNode;
                        0 === b ||
        ...
        var H = Ue(a),
            ...
            Se = Xe(a, H, fd).completeWork;
        H = Ye(a, T);
        var E = H.commitPlacement,
            Qe = H.commitDeletion,
            bd = H.commitWork,
    ...
    function Ve(a) {
        ...
        var e = a.shouldSetTextContent,
            ...
            fb = a.didNotFindHydratableInstance;
    ...
    function Xe(a, b, c) {
        var d = a.createInstance,
            ...
            q = c.popHydrationState;
        return {
            completeWork: function (a, b, c) {
                var x = b.pendingProps;
                if (null === x) x = b.memoizedProps;
                ...
                switch (b.tag) {
                    ...
                    case 5:
                        ...
                        if (null !== a && null != b.stateNode) {
                            var p = a.memoizedProps,
                                ...
                                pa = T();
                            x = h(v, n, p, x, c, pa);
                            if ((b.updateQueue = x)) b.effectTag |= 4;
                    ...
                    case 7:
                        ...
                        c = [];
                        a: for (
                            (n = b.stateNode) && (n["return"] = b);
                            null !== n;

                        ) {
                            if (5 === n.tag || 6 === n.tag || 4 === n.tag)
                                m("164");
                            else if (9 === n.tag) c.push(n.type);
    ...
    function We(a, b, c, d, e) {
        ...
        function Q(a) {
            var b = a.stateNode;
            b.pendingContext
                ? jd(a, b.pendingContext, b.pendingContext !== b.context)
                : b.context && jd(a, b.context, !1);
            H(a, b.containerInfo);
        }
        function l(a, b) {
            ...
            if (null !== b.child) {
                ...
                for (c["return"] = b; null !== a.sibling; )
                    (a = a.sibling),
                        (c = c.sibling = $b(a, a.pendingWorkPriority)),
                        (c.pendingProps = a.pendingProps),
                        (c["return"] = b);
                c.sibling = null;
            }
        ...
        var q = a.shouldSetTextContent,
            ...
            n = c.tryToClaimNextHydratableInstance;
        a = $e(
            d,
            e,
            function (a, b) {
            ...
            beginWork: function (a, b, c) {
                ...
                switch (b.tag) {
                    ...
                    case 5:
                        ...
                        S.current || (null !== d && E !== d)
                            ? ((E = d.children),
                              q(e, d)
                                  ? (E = null)
                                  : g && q(e, g) && (b.effectTag |= 16),
                              h(a, b),
                              5 !== c && !t && w(e, d)
                                  ? ((b.pendingWorkPriority = 5), (b = null))
                                  : (f(a, b, E),
                                    (b.memoizedProps = d),
                                    (b = b.child)))
                            : (b = l(a, b));
                    ...
                    case 7:
                        ...
                        b.stateNode =
                            null === a
                                ? Yb(b, b.stateNode, e, d)
                                : a.child === b.child
                                ? Xb(b, b.stateNode, e, d)
                                : Zb(b, b.stateNode, e, d);
                        b.memoizedProps = c;
                        return b.stateNode;
                    case 9:
                        return null;
                    ...
                    case 10:
                        a: {
                            c = b.pendingProps;
                            if (S.current) null === c && (c = b.memoizedProps);
                            else if (null === c || b.memoizedProps === c) {
                                b = l(a, b);
                                break a;
                            }
        ...
        return {
            ...
            mountClassInstance: function (a, b) {
                ...
                "function" === typeof d.componentWillMount &&
                    ...
                    h !== d.state && f.enqueueReplaceState(d, d.state, null),
                    (h = a.updateQueue),
                    null !== h && (d.state = ac(c, a, h, d, e, g, b)));
            ...
            updateClassInstance: function (a, b, e) {
                ...
                "function" !== typeof g.componentWillReceiveProps ||
                    (h === k && l === r) ||
                    ((l = g.state),
                    g.componentWillReceiveProps(k, r),
                    g.state !== l && f.enqueueReplaceState(g, g.state, null));
                l = b.memoizedState;
                e =
                    null !== b.updateQueue
                        ? ac(a, b, b.updateQueue, g, l, k, e)
                        : l;
                if (
                    !(
                        h !== k ||
                ...
                if (
                    ...
                    var t = b.stateNode,
                        w = b.type;
                    q =
                        "function" === typeof t.shouldComponentUpdate
                            ? t.shouldComponentUpdate(q, e, r)
    ...
    function fc(a, b, c) {
        ...
        "function" === typeof d
            ? ((f =
              ...
              (f.type = d))
            : "string" === typeof d
            ? ((f = new F(5, e, b)), (f.type = d))
            : "object" === typeof d && null !== d && "number" === typeof d.tag
            ? (f = d)
    ...
    function ad(a, b) {
        var c = a.alternate;
        null === c
            ? ((c = new F(a.tag, a.key, a.internalContextTag)),
              (c.type = a.type),
    ...
    function ac(a, b, c, d, e, f, g) {
        ...
        a = c.callbackList;
        for (
            var h = c.hasForceUpdate, m = !0, l = c.first;
            null !== l && 0 >= gc(l.priorityLevel, g);

        ) {
            c.first = l.next;
            null === c.first && (c.last = null);
            var r;
            if (l.isReplace) (e = nd(l, d, e, f)), (m = !0);
    ...
    function ib(a) {
        ...
        var b = ra[a],
            c;
        for (c in b) if (b.hasOwnProperty(c) && c in pd) return (jc[a] = b[c]);
        return "";
    }
    function Fa(a, b) {
        if (!z || (b && !("addEventListener" in document))) return !1;
        b = "on" + a;
        var c = b in document;
        c ||
    ...
    function rd(a, b) {
        a &&
            (Ga.executeDispatchesInOrder(a, b),
                ...
                if (!ha.plugins[c]) {
                    ...
                    for (var d in c) {
                        ...
                        var f = c[d],
                            g = b,
                            h = d;
                        ha.eventNameDispatchConfigs.hasOwnProperty(h)
                            ? m("99", h)
                            : void 0;
                        ha.eventNameDispatchConfigs[h] = f;
                        var k = f.phasedRegistrationNames;
                        if (k) {
                            for (e in k) k.hasOwnProperty(e) && vd(k[e], g, h);
                            e = !0;
                        } else
                            f.registrationName
                                ? (vd(f.registrationName, g, h), (e = !0))
                                : (e = !1);
                        e ? void 0 : m("98", d, a);
                    }
                }
    ...
    function mc(a) {
        ...
        for (var c = a, d = b; ; ) {
            ...
            if (e.child === f.child) {
                for (var g = e.child; g; ) {
                    if (g === c) return Ad(e), a;
                    if (g === d) return Ad(e), b;
                    g = g.sibling;
                }
                m("188");
            }
    ...
    function Dd(a) {
        if ((a = Ga.getInstanceFromNode(a)))
            if ("number" === typeof a.tag) {
                nb && "function" === typeof nb.restoreControlledState
                    ? void 0
                    : m("194");
                var b = Ga.getFiberCurrentPropsFromNode(a.stateNode);
                nb.restoreControlledState(a.stateNode, a.type, b);
            } else
                "function" !== typeof a.restoreControlledState
                    ? m("195")
                    : void 0,
                    a.restoreControlledState();
    }
    function Ed(a, b) {
        return sd(a, b);
    }
    ...
    function kf(a) {
        if (Id.hasOwnProperty(a)) return !0;
        if (Jd.hasOwnProperty(a)) return !1;
        if (lf.test(a)) return (Id[a] = !0);
        Jd[a] = !0;
        return !1;
    }
    function Kd() {
    ...
    function va(a, b, c) {
        ...
        if (b) {
            ...
            for (c = 0; c < a.length; c++)
                (d = b.hasOwnProperty("$" + a[c].value)),
                    a[c].selected !== d && (a[c].selected = d);
        } else {
            c = "" + c;
            b = null;
    ...
    function Nd(a, b) {
        b = b.priorityLevel;
        var c = null;
        if (null !== a.last && 0 >= gc(a.last.priorityLevel, b)) c = a.last;
        else
    ...
    function hb(a, b) {
        ...
        null !== c
            ? ((a = c.updateQueue), null === a && (a = c.updateQueue = Md()))
            : (a = null);
        pc = d;
        qc = a !== d ? a : null;
        var e = pc;
        c = qc;
        var f = Nd(e, b),
            g = null !== f ? f.next : e.first;
        if (null === c) return oc(e, b, f, g), null;
        d = Nd(c, b);
        a = null !== d ? d.next : c.first;
        oc(e, b, f, g);
        if ((g === a && null !== g) || (f === d && null !== f))
            return (
                null === d && (c.first = b), null === a && (c.last = null), null
            );
        b = {
    ...
    function kd(a, b) {
        ...
        c = c.getChildContext();
        for (var e in c) e in d ? void 0 : m("108", Ba(a) || "Unknown", e);
        return q({}, b, c);
    }
    function F(a, b, c) {
        this.tag = a;
    ...
    function Ja(a, b) {
        ...
        if (null !== c && "function" !== typeof c) {
            if (b._owner) {
                ...
                b &&
                    ("number" === typeof b.tag
                        ? (2 !== b.tag ? m("110") : void 0, (d = b.stateNode))
                        : (d = b.getPublicInstance()));
                d ? void 0 : m("147", c);
                var e = "" + c;
    ...
    function rc(a, b) {
        ...
        function f(b, c) {
            if (a) return (b = $b(b, c)), (b.index = 0), (b.sibling = null), b;
            b.pendingWorkPriority = c;
            b.effectTag = 0;
            b.index = 0;
            b.sibling = null;
        ...
        function k(a, b, c, d) {
            if (null === b || 6 !== b.tag)
                return (
                    (c = ec(c, a.internalContextTag, d)), (c["return"] = a), c
                );
            b = f(b, d);
            b.pendingProps = c;
            b["return"] = a;
        ...
        function r(a, b, c, d) {
            if (null === b || 7 !== b.tag)
                return (
                    (c = dc(c, a.internalContextTag, d)), (c["return"] = a), c
                );
            b = f(b, d);
            b.pendingProps = c;
            b["return"] = a;
        ...
        function t(a, b, c, d) {
            if (
                ...
                return (
                    (c = cc(c, a.internalContextTag, d)), (c["return"] = a), c
                );
            b = f(b, d);
        ...
        function w(a, b, c, d) {
            if (null === b || 10 !== b.tag)
                return (
                    (c = md(c, a.internalContextTag, d)), (c["return"] = a), c
                );
            b = f(b, d);
            b.pendingProps = c;
            b["return"] = a;
        ...
        function z(a, b, c) {
            ...
            if ("object" === typeof b && null !== b) {
                switch (b.$$typeof) {
                    ...
                    case sb:
                        return (
                            (b = dc(b, a.internalContextTag, c)),
                            (b["return"] = a),
                            b
                        );
                    case tb:
                        return (
                            (c = new F(9, null, a.internalContextTag)),
                            (c.type = b.value),
                            (c["return"] = a),
                            c
                        );
        ...
        function A(a, b, c, d) {
            ...
            if ("object" === typeof c && null !== c) {
                ...
                if (vb(c) || Ia(c)) return null !== e ? null : w(a, b, c, d);
                qb(a, c);
            }
            return null;
        }
        ...
        function C(a, f, h, m) {
            for (
                var p = null, n = null, l = f, k = (f = 0), v = null;
                null !== l && k < h.length;
                k++
            ) {
            ...
            if (k === h.length) return d(a, l), p;
            if (null === l) {
                for (; k < h.length; k++)
                    if ((l = z(a, h[k], m)))
                        (f = g(l, f, k)),
                            null === n ? (p = l) : (n.sibling = l),
                            (n = l);
                return p;
            }
        ...
        function x(a, f, h, l) {
            ...
            null == h ? m("151") : void 0;
            for (
                var n = (p = null), k = f, v = (f = 0), r = null, q = h.next();
                null !== k && !q.done;
                v++, q = h.next()
            ) {
        ...
        return function (a, b, e, g) {
                ...
                return (
                    ...
                    null !== b && 6 === b.tag
                        ? (d(a, b.sibling),
                          ...
                          (a = b))
                        : (d(a, b),
                          (e = ec(e, a.internalContextTag, g)),
                          (e["return"] = a),
                          (a = e)),
                    h(a)
                );
            if (vb(e)) return C(a, b, e, g);
            if (Ia(e)) return x(a, b, e, g);
            k && qb(a, e);
            if ("undefined" === typeof e)
                switch (a.tag) {
                    ...
                    case 1:
                        (e = a.type),
                            m("152", e.displayName || e.name || "Component");
                }
            return d(a, b);
        };
    }
    ...
    function sc(a) {
        if (!a) return ba;
        a = fa.get(a);
        return "number" === typeof a.tag
            ? $c(a)
            : a._processChildContext(a._context);
    }
    function Zc(a) {
    ...
    function Rd(a, b) {
        for (var c = 0, d = a; d; d = C(d)) c++;
        d = 0;
        for (var e = b; e; e = C(e)) d++;
        for (; 0 < c - d; ) (a = C(a)), c--;
        for (; 0 < d - c; ) (b = C(b)), d--;
        for (; c--; ) {
    ...
    function Sd(a, b, c) {
        if ((b = Td(a, c.dispatchConfig.phasedRegistrationNames[b])))
            (c._dispatchListeners = sa(c._dispatchListeners, b)),
                (c._dispatchInstances = sa(c._dispatchInstances, a));
    }
    function pf(a) {
        a &&
            a.dispatchConfig.phasedRegistrationNames &&
            wb.traverseTwoPhase(a._targetInst, Sd, a);
    }
    function qf(a) {
    ...
    function Ud(a, b, c) {
        a &&
            ...
            (b = Td(a, c.dispatchConfig.registrationName)) &&
            ((c._dispatchListeners = sa(c._dispatchListeners, b)),
            (c._dispatchInstances = sa(c._dispatchInstances, a)));
    }
    function rf(a) {
    ...
    function xf(a, b) {
        if (wa)
            return "topCompositionEnd" === a || (!tc && Yd(a, b))
                ? ((a = xb.getData()), xb.reset(), (wa = !1), a)
                : null;
        switch (a) {
            case "topPaste":
                return null;
    ...
    function zb(a) {
        ...
        if (xa.updateValueIfChanged(b)) return a;
    }
    function zf(a, b) {
    ...
    function fe(a) {
        "value" === a.propertyName &&
            zb(Ma) &&
            ((a = ce(Ma, a, jb(a))), Ab.batchedUpdates(yf, a));
    }
    function Af(a, b, c) {
        "topFocus" === a
            ? (ee(), (La = b), (Ma = c), La.attachEvent("onpropertychange", fe))
            : "topBlur" === a && ee();
    }
    function Bf(a) {
        if (
    ...
    function ie(a, b) {
        if (uc || null == ya || ya !== Qb()) return null;
        var c = ya;
        "selectionStart" in c && vc.hasSelectionCapabilities(c)
        ...
        return Na && bc(Na, c)
            ? null
            : ((Na = c),
              (a = O.getPooled(je.select, wc, a, b)),
              (a.type = "select"),
              (a.target = ya),
              la.accumulateTwoPhaseDispatches(a),
              a);
    ...
    function Bb(a, b, c, d, e) {
        ...
        if (f) B.updateContainer(b, f, a, e);
        else {
            if (!d && !Ff(c))
    ...
    var w = ka,
            ...
            injectDOMPropertyConfig: function (a) {
                ...
                for (var f in c) {
                    ...
                    g = {
                        ...
                        hasPositiveNumericValue: ua(
                            h,
                            b.HAS_POSITIVE_NUMERIC_VALUE
                        ),
                        hasOverloadedBooleanValue: ua(
                            h,
                            b.HAS_OVERLOADED_BOOLEAN_VALUE
                        ),
                        hasStringBooleanValue: ua(
                            h,
        ...
        aa = {
            ...
            getPropertyInfo: function (a) {
                return aa.properties.hasOwnProperty(a)
                    ? aa.properties[a]
                    : null;
            },
            shouldAttributeAcceptBooleanValue: function (a) {
                if (aa.isReservedProp(a)) return !0;
        ...
        N = {
            ...
            getNodeFromInstance: function (a) {
                ...
                for (var b = []; !a._hostNode; )
                    b.push(a),
                        a._hostParent ? void 0 : m("34"),
                        (a = a._hostParent);
                for (; b.length; a = b.pop()) lc(a, a._hostNode);
                return a._hostNode;
            },
        ...
        t = {
            ...
            invokeGuardedCallbackAndCatchFirstError: function (
                ...
                if (t.hasCaughtError()) {
                    ...
                    t._hasRethrowError ||
                        ((t._hasRethrowError = !0), (t._rethrowError = l));
                }
            },
            ...
            executeDispatchesInOrderStopAtTrue: function (a) {
                a: {
                    ...
                    if (Array.isArray(b))
                        for (
                            var d = 0;
                            d < b.length && !a.isPropagationStopped();
                            d++
                        ) {
                            if (b[d](a, c[d])) {
                                b = c[d];
        ...
        yb = {
            ...
            restoreStateIfNeeded: function () {
                if (Pa) {
                    ...
                    Qa = Pa = null;
                    Dd(a);
                    if (b) for (a = 0; a < b.length; a++) Dd(b[a]);
                }
            },
        },
        zc = !1,
        ...
        ia = {
            ...
            trapBubbledEvent: function (a, b, c) {
                return c
                    ? ue.listen(c, b, ia.dispatchEvent.bind(null, a))
                    : null;
            },
            trapCapturedEvent: function (a, b, c) {
                return c
                    ? ue.capture(c, b, ia.dispatchEvent.bind(null, a))
                    : null;
            },
    ...
    var ye = {
            ...
            topAnimationIteration:
                ib("animationiteration") || "animationiteration",
                ...
                listenTo: function (a, b) {
                    ...
                    for (var d = 0; d < a.length; d++) {
                        ...
                        (c.hasOwnProperty(e) && c[e]) ||
                            ("topWheel" === e
                                ? Fa("wheel")
                                    ? G.trapBubbledEvent("topWheel", "wheel", b)
                                    : Fa("mousewheel")
                                    ? G.trapBubbledEvent(
                                          "topWheel",
                                          "mousewheel",
                                ...
                                : "topScroll" === e
                                ? G.trapCapturedEvent("topScroll", "scroll", b)
                                : "topFocus" === e || "topBlur" === e
                                ? (G.trapCapturedEvent("topFocus", "focus", b),
                                  G.trapCapturedEvent("topBlur", "blur", b),
                                  (c.topBlur = !0),
                                  (c.topFocus = !0))
                                : "topCancel" === e
                                ? (Fa("cancel", !0) &&
    ...
    var Ae = {
            ...
            setValueForStyles: function (a, b) {
                ...
                for (var c in b)
                    if (b.hasOwnProperty(c)) {
                        ...
                        else if ((d = ze && Jf[c])) for (var g in d) a[g] = "";
                        else a[c] = "";
                    }
            },
        },
        ...
        Ac = {
            ...
            setValueForProperty: function (a, b, c) {
                ...
                if (d && A.shouldSetAttribute(b, c)) {
                    ...
                    Ac.setValueForAttribute(
                        a,
                        b,
                        A.shouldSetAttribute(b, c) ? c : null
                    );
            },
        ...
        za = {
            ...
            getHostProps: function (a, b) {
                ...
                if ((b = mf(b.children))) a.children = b;
                return a;
            },
        },
        ja = {
            ...
            postMountWrapper: function (a, b) {
                ...
                null != c
                    ? va(a, !!b.multiple, c)
                    : null != b.defaultValue &&
                      va(a, !!b.multiple, b.defaultValue);
            },
                ...
                for (h in g)
                    if (g.hasOwnProperty(h)) {
                        ...
                        "style" === h
                            ...
                            ? "string" === typeof k
                                ? Dc(a, k)
                                : "number" === typeof k && Dc(a, "" + k)
                            : "suppressContentEditableWarning" !== h &&
                              (Fb.hasOwnProperty(h)
                                  ? null != k && R(d, h)
                                  : e
                                  ? oa.setValueForAttribute(a, h, k)
                                  : null != k &&
                                    oa.setValueForProperty(a, h, k));
                    }
                switch (b) {
                    case "input":
                        xa.track(a);
            ...
            updateProperties: function (a, b, c, d, e) {
                ...
                for (var f = 0; f < b.length; f += 2) {
                    ...
                    "style" === g
                        ...
                        : d
                        ? null != h
                            ? oa.setValueForAttribute(a, g, h)
                            : oa.deleteValueForAttribute(a, g)
                        : null != h
                        ? oa.setValueForProperty(a, g, h)
                        : oa.deleteValueForProperty(a, g);
                }
                switch (c) {
                    case "input":
                        U.updateWrapper(a, e);
    ...
    var Rf = Ge,
        ...
        Wb = null,
        qa = {},
        db = yc.ReactCurrentOwner;
    sc._injectFiber = function (a) {
        $c = a;
    };
    var Tf = Oa.findCurrentHostFiber,
        Uf = Oa.findCurrentHostFiberWithNoPortals;
    sc._injectFiber(function (a) {
        var b;
        a: {
    ...
    var Rb = null,
        He = {
            getOffsets: function (a) {
                ...
                a =
                    h.startContainer === h.endContainer &&
            ...
            setOffsets: function (a, b) {
                if (window.getSelection) {
                    ...
                    if (d && a) {
                        ...
                        c.removeAllRanges();
                        e > b
                            ? (c.addRange(f), c.extend(a.node, a.offset))
                            : (f.setEnd(a.node, a.offset), c.addRange(f));
                    }
                }
            },
        },
        Va = {
            ...
            getSelectionInformation: function () {
                ...
                return {
                    focusedElem: a,
                    selectionRange: Va.hasSelectionCapabilities(a)
                        ? Va.getSelection(a)
                        : null,
                };
            },
    ...
    q(Ka.prototype, {
            ...
            a &&
                (a.preventDefault
                    ...
                    : "unknown" !== typeof a.returnValue &&
                      (a.returnValue = !1),
                (this.isDefaultPrevented = w.thatReturnsTrue));
        },
            ...
            a &&
                (a.stopPropagation
                    ...
                    : "unknown" !== typeof a.cancelBubble &&
                      (a.cancelBubble = !0),
                (this.isPropagationStopped = w.thatReturnsTrue));
        },
        persist: function () {
        ...
        destructor: function () {
            ...
            for (a = 0; a < Ie.length; a++) this[Ie[a]] = null;
        },
    });
    Ka.Interface = Vf;
    ...
    var Wf = z && "TextEvent" in window && !Xa && !uf(),
        ...
        Xf = {
            ...
            extractEvents: function (a, b, c, d) {
                ...
                if (tc)
                    ...
                    wa
                        ? Yd(a, c) && (f = ea.compositionEnd)
                        : "topKeyDown" === a &&
                          229 === c.keyCode &&
                          (f = ea.compositionStart);
                f
                    ? (be &&
                          (wa || f !== ea.compositionStart
                              ? f === ea.compositionEnd &&
                                wa &&
                                (e = xb.getData())
                              : (wa = xb.initialize(d))),
                      (f = Wd.getPooled(f, b, c, d)),
                      e
                          ? (f.data = e)
                          : ((e = Zd(c)), null !== e && (f.data = e)),
                      la.accumulateTwoPhaseDispatches(f),
                      (e = f))
                    : (e = null);
                (a = Wf ? wf(a, c) : xf(a, c))
                    ? ((b = Xd.getPooled(ea.beforeInput, b, c, d)),
                      (b.data = a),
                      la.accumulateTwoPhaseDispatches(b))
                    : (b = null);
                return [e, b];
            },
        },
                ...
                "topMouseOut" === a
                    ? ((a = b),
                      (b = (b = c.relatedTarget || c.toElement)
                          ? N.getClosestInstanceFromNode(b)
                          : null))
                    : (a = null);
                if (a === b) return null;
            ...
            extractEvents: function (a, b, c, d) {
                var e =
                    d.window === d
                        ...
                        ? d
                        : d.ownerDocument;
                if (!e || !ag("onSelect", e)) return null;
    ...
    Y.augmentClass(ne, {
        key: function (a) {
            ...
            return "keypress" === a.type
                ? ((a = $a(a)), 13 === a ? "Enter" : String.fromCharCode(a))
                : "keydown" === a.type || "keyup" === a.type
                ? dg[a.keyCode] || "Unidentified"
                : "";
        },
        location: null,
        ctrlKey: null,
    ...
    X.injection.injectEventPluginOrder(
    ...
    var Kb = A.injection.MUST_USE_PROPERTY,
            ...
            return {
                ...
                updateContainer: function (a, b, g, h) {
                    ...
                    if (a) {
                        ...
                        null !== a &&
                            null !== h.next &&
                            ((h.next = null), (a.last = h));
                        null !== f &&
                            null !== g &&
                            null !== g.next &&
                            ((g.next = null), (f.last = h));
                    }
                    c(e, b);
                },
...
"object" === typeof exports && "undefined" !== typeof module
    ? (module.exports = Nb(require("react")))
    : "function" === typeof define && define.amd
    ? define(["react"], Nb)
    : (this.ReactDOM = Nb(this.React));
