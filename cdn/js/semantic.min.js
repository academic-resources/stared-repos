                ...
                (a = {
                    ...
                    change: {
                        ...
                        settings: function (t, n, o) {
                            (n = "string" == typeof n ? [n] : n || m.modules),
                                (o = o !== i ? o : !0),
                    ...
                    enable: {
                        ...
                        verbose: function (e, t) {
                            (e = e || m.modules),
                                a.debug(
                                    "Enabling verbose debug for modules",
                                    e
                                ),
                    ...
                    disable: {
                        ...
                        verbose: function (e, t) {
                            (e = e || m.modules),
                                a.debug(
                                    "Disabling verbose debug for modules",
                                    e
                                ),
                    ...
                    destroy: function () {
                        a.verbose("Destroying previous site for", h),
                            h.removeData(p);
                    },
                    cache: {},
        ...
        (e.fn.form = function (t) {
                    ...
                    (F = {
                        ...
                        event: {
                            field: {
                                keydown: function (t) {
                                    ...
                                    i == o.escape &&
                                        (F.verbose(
                                            "Escape key pressed blurring field"
                                        ),
                                        n.blur()),
                                        !t.ctrlKey &&
                                            i == o.enter &&
                        ...
                        get: {
                            ancillaryValue: function (e) {
                                return e.type && F.is.bracketedRule(e)
                            ...
                            ruleName: function (e) {
                                return F.is.bracketedRule(e)
                                    ? e.type.replace(
                                          e.type.match(x.regExp.bracket)[0],
                                          ""
                                      )
                                    : e.type;
                            },
                            ...
                            prompt: function (e, t) {
                                var n,
                                    ...
                                    l = -1 !== s.search("{name}");
                                return (
                                    (l || c) && (i = F.get.field(t.identifier)),
                        ...
                        validate: {
                            ...
                            field: function (t, n) {
                                ...
                                return (
                                    t.identifier ||
                                        (F.debug(
                                            "Using field name as identifier",
                                            o
                                        ),
                                        (t.identifier = o)),
                                    a.prop("disabled")
                                        ? (F.debug(
                                              "Field is disabled. Skipping",
                                              o
                                          ),
                                          (r = !0))
                                        : t.optional && "" === e.trim(a.val())
                                        ? (F.debug(
                                              "Field is optional and empty. Skipping",
                                              o
                                          ),
                                          (r = !0))
                                        : t.rules !== i &&
            ...
            (e.fn.form.settings = {
                ...
                rules: {
                    ...
                    email: function (t) {
                        var n = new RegExp(
                            e.fn.form.settings.regExp.email,
                            "i"
                        );
                        return n.test(t);
                    },
                    ...
                    contains: function (t, n) {
                        return (
                            (n = n.replace(
                                e.fn.form.settings.regExp.escape,
                                "\\$&"
                            )),
                        ...
                        if ("string" == typeof t && 0 !== t.length) {
                            ...
                            if (
                                ((i = {
                                    number:
                                        -1 !==
                                        e.inArray(t.length, a.unionPay.length),
                                    pattern:
                                        -1 !== t.search(a.unionPay.pattern),
                                }),
                                i.number && i.pattern)
                            )
                                return !0;
        ...
        (e.fn.accordion = function (n) {
            ...
            return (
                a.each(function () {
                    ...
                    (m = {
                        initialize: function () {
                            m.debug("Initializing", C),
                                m.bind.events(),
                                f.observeChanges && m.observeChanges(),
                                m.instantiate();
                        },
                        instantiate: function () {
                            (T = m), C.data(y, m);
                        ...
                        destroy: function () {
                            m.debug("Destroying previous instance", C),
                        ...
                        bind: {
                            events: function () {
                                m.debug("Binding delegated events"),
                                    C.on(f.on + b, v.trigger, m.event.click);
                            },
                        },
                        event: {
                            click: function () {
                            ...
                            var n =
                                    t !== i
                                        ? "number" == typeof t
                                            ? w.eq(t)
                                            : e(t).closest(v.title)
                                        : e(this).closest(v.title),
                                o = n.next(k),
                                a = o.hasClass(g.animating),
                                r = o.hasClass(g.active),
                                s = r && !a,
                                c = !r && a;
                            m.debug("Toggling visibility of content", n),
                                s || c
                                    ? f.collapsible
                                        ? m.close.call(n)
                                        : m.debug(
                        ...
                        open: function (t) {
                            ...
                            return s
                                ? void m.debug(
                                      "Accordion already open, skipping",
                                      o
                                  )
                                : (m.debug("Opening accordion content", n),
                                  f.onOpening.call(o),
                                  f.exclusive && m.closeOthers.call(n),
                                  n.addClass(g.active),
                        ...
                        close: function (t) {
                            ...
                            (!r && !s) ||
                                c ||
                                (m.debug("Closing accordion content", o),
                                f.onClosing.call(o),
                        ...
                        reset: {
                            ...
                            opacity: function () {
                                m.verbose(
                                    "Removing inline opacity from element",
                                    this
                                ),
                                    e(this).css("opacity", ""),
                                    "" === e(this).attr("style") &&
        ...
        (e.fn.checkbox = function (o) {
            ...
            return (
                r.each(function () {
                    ...
                    (f = {
                        initialize: function () {
                            f.verbose("Initializing checkbox", g),
                                f.create.label(),
                                f.bind.events(),
                                f.set.tabbable(),
                                f.hide.input(),
                        ...
                        refresh: function () {
                            (w = C.children(h.label)),
                                (k = C.children(h.input)),
                                (S = k[0]);
                        },
                        hide: {
                            input: function () {
                                f.verbose(
                                    "Modfying <input> z-index to be unselectable"
                                ),
                                    k.addClass(p.hidden);
                            },
                        },
                        show: {
                            input: function () {
                                f.verbose(
                                    "Modfying <input> z-index to be selectable"
                                ),
                        ...
                        is: {
                            ...
                            indeterminate: function () {
                                return (
                                    k.prop("indeterminate") !== i &&
                                    k.prop("indeterminate")
                                );
                            },
                            checked: function () {
                                return (
                                    k.prop("checked") !== i && k.prop("checked")
                                );
                            },
                            disabled: function () {
                                return (
                        ...
                        set: {
                            ...
                            checked: function () {
                                return (
                                    ...
                                    C.removeClass(p.indeterminate).addClass(
                                        p.checked
                                    ),
                            ...
                            unchecked: function () {
                                return (
                                    ...
                                    C.removeClass(p.indeterminate).removeClass(
                                        p.checked
                                    ),
                                    !f.is.indeterminate() && f.is.unchecked()
                                        ? void f.debug(
                                              "Input is already unchecked"
                                          )
                                        : (f.debug(
                                              "Setting state to unchecked"
                                          ),
                                          k
                                              .prop("indeterminate", !1)
                                              .prop("checked", !1),
                            ...
                            indeterminate: function () {
                                return (
                                    ...
                                    f.is.indeterminate()
                                        ...
                                        : (f.debug(
                                              "Setting state to indeterminate"
                                          ),
                        ...
                        trigger: {
                            change: function () {
                                ...
                                t &&
                                    (f.verbose(
                                        "Triggering native change event"
                                    ),
                    ...
                    (f = {
                        ...
                        bind: {
                            events: function () {
                                "hover" == g.on
                                    ? m
                                          .on("mouseenter" + y, f.show)
                                          .on("mouseleave" + y, f.hide)
                                    : "click" == g.on && m.on(w + y, f.toggle),
                                    f.is.page() &&
                                        (f.debug("Setting as a page dimmer", m),
                                        f.set.pageDimmer()),
                                    f.is.closable() &&
                                        (f.verbose(
                                            "Adding dimmer close event",
                                            d
                                        ),
                                        m.on(w + y, p.dimmer, f.event.click));
                            },
                        },
                        unbind: {
                            events: function () {
                        ...
                        show: function (t) {
                            (t = e.isFunction(t) ? t : function () {}),
                                f.debug("Showing dimmer", d, g),
                                (f.is.dimmed() && !f.is.animating()) ||
                                !f.is.enabled()
                                    ? f.debug(
                                          "Dimmer is already shown or disabled"
                                      )
                                    : (f.animate.show(t),
                                      g.onShow.call(S),
                                      g.onChange.call(S));
                        ...
                        is: {
                            ...
                            animating: function () {
                                return (
                                    d.is(":animated") || d.hasClass(h.animating)
                                );
                            },
                            closable: function () {
                    ...
                    (w = {
                        ...
                        observeChanges: function () {
                            "MutationObserver" in t &&
                                ((x = new MutationObserver(function (e) {
                                    w.debug(
                                        "<select> modified, recreating menu"
                                    ),
                                        w.setup.select();
                                })),
                        ...
                        create: {
                            id: function () {
                                (y = (
                                    ...
                                    (b = "." + y),
                                    w.verbose(
                                        "Creating unique id for element",
                                        y
                                    );
                            },
                        ...
                        select: {
                            firstUnfiltered: function () {
                                w.verbose(
                                    "Selecting first non-filtered element"
                                ),
                                    w.remove.selectedItem(),
                                    B.not(D.unselectable)
                                        .eq(0)
                                        .addClass(S.selected);
                            },
                                    ...
                                    H.parent(D.dropdown).length > 0
                                        ...
                                        : (w.debug(
                                          ...
                                          H.hasClass(S.multiple) &&
                                              H.prop("multiple") === !1 &&
                                              (w.error(O.missingMultiple),
                                              H.prop("multiple", !0)),
                                          H.is("[multiple]") &&
                                              w.set.multiple(),
                                          H.prop("disabled") &&
                                              (w.debug("Disabling dropdown"),
                                              I.addClass(S.disabled)),
                                          H.removeAttr("class")
                                              .detach()
                                              .prependTo(I)),
                                    w.refresh();
                        ...
                        refreshData: function () {
                            w.verbose("Refreshing cached metadata"),
                                B.removeData(E.text).removeData(E.value),
                                I.removeData(E.defaultText)
                                    .removeData(E.defaultValue)
                                    .removeData(E.placeholderText);
                        },
                        toggle: function () {
                        ...
                        bind: {
                            ...
                            keyboardEvents: function () {
                                w.verbose("Binding keyboard events"),
                                    I.on("keydown" + j, w.event.keydown),
                                    w.has.search() &&
                                        I.on(
                                            w.get.inputEvent() + j,
                                            D.search,
                                    ...
                                    w.is.multiple() &&
                                        s.on(
                                            "keydown" + b,
                                            w.event.document.keydown
                                        );
                            },
                            inputEvents: function () {
                                w.verbose("Binding input change events"),
                                    I.on("change" + j, D.input, w.event.change);
                            },
                                ...
                                w.verbose("Binding mouse events"),
                                    ...
                                    w.is.searchSelection()
                                        ? (I.on(
                                              ...
                                              .on("click" + j, D.search, w.show)
                                              .on(
                                                  "focus" + j,
                                                  D.search,
                                                  w.event.search.focus
                                              )
                                              .on(
                                                  "blur" + j,
                                                  D.search,
                                        ...
                                        : ("click" == k.on
                                          ...
                                          I.on(
                                              ...
                                              .on("focus" + j, w.event.focus)
                                              .on("blur" + j, w.event.blur)),
                                    W.on(
                                        "mouseenter" + j,
                                        D.item,
                                        w.event.item.mouseenter
                            ...
                            intent: function () {
                                w.verbose(
                                    "Binding hide intent event to document"
                                ),
                                    l &&
                                        s
                                            .on(
                        ...
                        filterActive: function () {
                            k.useLabels &&
                                B.filter("." + S.active).addClass(S.filtered);
                        },
                            ...
                            if (w.has.query()) {
                                if (i)
                                    return (
                                        ...
                                        void w.event.item.click.call(n)
                                    );
                                w.remove.searchTerm();
                            }
                            w.hide();
                        ...
                        event: {
                            change: function () {
                                $ ||
                                    (w.debug(
                                        "Input changed, updating selection"
                                    ),
                                    w.set.selected());
                            },
                            focus: function () {
                            ...
                            search: {
                                focus: function () {
                                    (Q = !0),
                                        w.is.multiple() &&
                                            w.remove.activeLabel(),
                                        k.showOnFocus && (w.search(), w.show());
                                },
                                blur: function (e) {
                                    (h = n.activeElement === this),
                                        X || h
                                        ...
                                        t == R.leftArrow
                                            ? (!f && !g) || s
                                                ...
                                                : (w.verbose(
                                                  ...
                                                  i.last().addClass(S.active))
                                            : t == R.rightArrow
                                            ? (f &&
                                                  !s &&
                                                  i.first().addClass(S.active),
                                              s &&
                                                  (e.shiftKey
                                                      ? w.verbose(
                            ...
                            keydown: function (e) {
                                ...
                                if (n) {
                                    var i,
                                        ...
                                        u = s.closest(D.menu),
                                        d =
                                            u.hasClass(S.visible) ||
                                            u.hasClass(S.animating) ||
                        ...
                        get: {
                            ...
                            value: function () {
                                var t =
                                    H.length > 0 ? H.val() : I.data(E.value);
                                return e.isArray(t) &&
                                    1 === t.length &&
                                    "" === t[0]
                                    ? ""
                                ...
                                return (
                                    ...
                                    t
                                        ? (t.find(D.menu).length > 0 &&
                                              (w.verbose(
                                                  "Retreiving text of element with sub-menu"
                                              ),
                                              (t = t.clone()),
                            ...
                            selectedItem: function () {
                                var e = B.not(D.unselectable).filter(
                                    "." + S.selected
                                );
                        ...
                        check: {
                            maxSelections: function (e) {
                                return k.maxSelections
                                    ? ((e =
                                          e !== i ? e : w.get.selectionCount()),
                                      e >= k.maxSelections
                                          ? (w.debug(
                                                "Maximum selection count reached"
                                            ),
                                            k.useLabels &&
                                                (B.addClass(S.filtered),
                        ...
                        restore: {
                            ...
                            labels: function () {
                                k.allowAdditions &&
                                    (k.useLabels ||
                                        (w.error(O.labels), (k.useLabels = !0)),
                        ...
                        scrollPage: function (e, t) {
                            ...
                            (o = "up" == e ? m.index(a) - u : m.index(a) + u),
                                (n = "up" == e ? o >= 0 : o < m.length),
                                (i = n
                                    ? m.eq(o)
                                    : "up" == e
                                    ? m.first()
                                ...
                                e &&
                                    ...
                                    o || (n && r)
                                        ? (w.verbose("Hiding placeholder text"),
                                          N.addClass(S.filtered))
                                        : (!e || (n && !r)) &&
                                          (w.verbose(
                                              "Showing placeholder text"
                                          ),
                                          N.removeClass(S.filtered));
                            },
                            loading: function () {
                        ...
                        add: {
                            ...
                            optionValue: function (t) {
                                ...
                                i ||
                                    ...
                                    w.is.single() &&
                                        (w.verbose(
                                            "Removing previous user addition"
                                        ),
                                        H.find(
                                            "option." + S.addition
                                        ).remove()),
                        ...
                        remove: {
                            ...
                            filteredItem: function () {
                                (k.useLabels && w.has.maxSelections()) ||
                                    (k.useLabels && w.is.multiple()
                                        ? B.not("." + S.active).removeClass(
                                              S.filtered
                                          )
                                        : B.removeClass(S.filtered));
                            },
                            optionValue: function (e) {
                                var t = H.find('option[value="' + e + '"]'),
                                    n = t.length > 0;
                                n &&
                                    t.hasClass(S.addition) &&
                                    (x &&
                                        (x.disconnect(),
                                        w.verbose(
                                            "Temporarily disconnecting mutation observer",
                            ...
                            activeLabels: function (e) {
                                (e =
                                    e ||
                                    I.find(D.label).filter("." + S.active)),
                                    w.verbose(
                                ...
                                (t = t || I.find(D.label)),
                                    ...
                                    t.each(function () {
                                        var t = e(this),
                                            ...
                                            o = n !== i ? String(n) : n,
                                            a = w.is.userValue(o);
                                        return k.onLabelRemove.call(t, n) === !1
                                            ? void w.debug(
                            ...
                            tabbable: function () {
                                w.has.search()
                                    ? (w.debug(
                                          "Searchable dropdown initialized"
                                      ),
                        ...
                        has: {
                            ...
                            allResultsFiltered: function () {
                                return (
                                    B.filter(D.unselectable).length === B.length
                                );
                            },
                            query: function () {
                                return "" !== w.get.query();
                        ...
                        is: {
                            ...
                            animating: function (e) {
                                return e
                                    ? e.transition &&
                                          e.transition("is animating")
                                    : W.transition &&
                                          W.transition("is animating");
                            },
                            disabled: function () {
                        ...
                        escape: {
                            regExp: function (e) {
                                return (
                                    (e = String(e)), e.replace(F.escape, "\\$&")
                                );
                            },
                        },
                        setting: function (t, n) {
                            if (
                                (w.debug("Changing setting", t, n),
                                e.isPlainObject(t))
                            )
                                e.extend(!0, k, t);
                            else {
                        ...
                        f
                            ? (Z === i && w.initialize(), w.invoke(m))
                            : (Z !== i && Z.invoke("destroy"), w.initialize());
                }),
                a !== i ? a : r
            );
        }),
                    ...
                    (m = {
                        ...
                        createPlaceholder: function (e) {
                            ...
                            (e = e || m.get.placeholder()),
                                ...
                                m.debug("Creating placeholder for embed", e, t);
                        },
                        createEmbed: function (t) {
                            m.refresh(),
                                ...
                                (A = e("<div/>")
                                    .addClass(p.embed)
                                    .html(m.generate.embed(t))
                                    .appendTo(k)),
                                f.onCreate.call(R, t),
                                m.debug("Creating embed object", A);
                        },
        ...
        (e.fn.modal = function (o) {
                    ...
                    (S = {
                        ...
                        attachEvents: function (t, n) {
                            ...
                            (n = e.isFunction(S[n]) ? S[n] : S.toggle),
                                i.length > 0
                                    ? (S.debug(
                                          "Attaching modal events to element",
                                          t,
                                          n
                                      ),
                        ...
                        bind: {
                            events: function () {
                                S.verbose("Attaching events"),
                                    O.on("click" + F, A.close, S.event.close)
                                        .on(
                                            "click" + F,
                                            A.approve,
                                            S.event.approve
                        ...
                        event: {
                            ...
                            click: function (t) {
                                ...
                                !o &&
                                    a &&
                                    (S.debug(
                                        "Dimmer clicked, hiding all modals"
                                    ),
                                    S.is.active() &&
                                        (S.remove.clickaway(),
                                        T.allowMultiple
                            ...
                            keyboard: function (e) {
                                ...
                                t == n &&
                                    (T.closable
                                        ? (S.debug(
                                              "Escape key pressed hiding modal"
                                          ),
                                          S.hide())
                                        : S.debug(
                        ...
                        hideDimmer: function () {
                            return y.dimmer("is animating") ||
                                ...
                                : void S.debug(
                                      "Dimmer is not visible cannot hide"
                                  );
                        },
                        hideAll: function (t) {
                            var n = r.filter(
                                "." + R.active + ", ." + R.animating
                            );
                            (t = e.isFunction(t) ? t : function () {}),
                                n.length > 0 &&
                        ...
                        cacheSizes: function () {
                            ...
                            (S.cache === i || 0 !== o) &&
                                ...
                                S.debug(
                                    "Caching modal and container sizes",
                                    S.cache
                                );
                        },
                        can: {
                            fit: function () {
                                return (
                                    S.cache.height + 2 * T.padding <
                                    S.cache.contextHeight
                                );
                            },
                        },
                        is: {
                        ...
                        g
                            ? (I === i && S.initialize(), S.invoke(f))
                            : (I !== i && I.invoke("destroy"), S.initialize());
                }),
                a !== i ? a : this
            );
        }),
            (e.fn.modal.settings = {
                ...
                selector: {
                    close: "> .close",
                    approve:
                        ".actions .positive, .actions .approve, .actions .ok",
                    ...
                    (a = {
                        initialize: function () {
                            a.verbose("Initializing element"),
                                b
                                    .on("click" + v, f.close, a.dismiss)
                                    .data(h, a),
                                m.detachable &&
                                    b.parent()[0] !== y[0] &&
                                    b.detach().prependTo(y),
                                m.displayTime > 0 &&
                                    setTimeout(a.hide, m.displayTime),
                                a.show();
                        },
                        destroy: function () {
                            a.verbose("Destroying instance"),
                                b.removeData(h).off(v);
                        },
                        show: function () {
                            a.should.show() &&
                                !b.is(":visible") &&
                                (a.debug("Showing nag", m.animation.show),
                                "fade" == m.animation.show
                                    ? b.fadeIn(m.duration, m.easing)
                                    : b.slideDown(m.duration, m.easing));
                        },
                        hide: function () {
                            a.debug("Showing nag", m.animation.hide),
                                "fade" == m.animation.show
                                    ? b.fadeIn(m.duration, m.easing)
                                    : b.slideUp(m.duration, m.easing);
                        },
                        onHide: function () {
                            a.debug("Removing nag", m.animation.hide),
                                b.remove(),
                                m.onHide && m.onHide();
                        },
                        dismiss: function (e) {
                            m.storageMethod && a.storage.set(m.key, m.value),
                                a.hide(),
                                e.stopImmediatePropagation(),
                                e.preventDefault();
                        },
                        should: {
                            show: function () {
                                return m.persist
                                    ? (a.debug(
                                          "Persistent nag is set, can show nag"
                                      ),
                                      !0)
                                    : a.storage.get(m.key) != m.value.toString()
                                    ? (a.debug(
                            ...
                            set: function (n, o) {
                                ...
                                if (
                                    ...
                                    t.localStorage.setItem(n, o),
                                        a.debug(
                                            "Value stored using local storage",
                                            n,
                                            o
                                        );
                                else if (
                    ...
                    (y = {
                                ...
                                x.popup
                                    ? (n.addClass(w.loading),
                                      ...
                                      x.movePopup &&
                                          ...
                                          n.detach().appendTo(r)))
                                    : (r = x.inline
                                          ? y.get.offsetParent(F)
                                          : y.has.popup()
                                          ? y.get.offsetParent(n)
                                          : l),
                                r.is("html") &&
                                    r[0] !== l[0] &&
                                    (y.debug("Setting page as offset parent"),
                                    (r = l)),
                        ...
                        create: function () {
                            ...
                            t || o || i
                                ? (y.debug("Creating pop-up html"),
                                  ...
                                  x.inline
                                      ? (y.verbose(
                                            "Inserting popup element inline",
                                            n
                                        ),
                                        n.insertAfter(E))
                                      : (y.verbose(
                                  ...
                                  x.onCreate.call(n, j))
                                : 0 !== F.next(C.popup).length
                                ? (y.verbose("Pre-existing popup found"),
                                  (x.inline = !0),
                                  (x.popups = F.next(C.popup).data(
                                      S.activator,
                                      E
                                  )),
                                  y.refresh(),
                        ...
                        toggle: function () {
                            y.debug("Toggling pop-up"),
                                y.is.hidden()
                                    ? (y.debug(
                                          "Popup is hidden, showing pop-up"
                                      ),
                                      y.unbind.close(),
                                      y.show())
                                    : (y.debug(
                                          "Popup is visible, hiding pop-up"
                                      ),
                                      y.hide());
                        },
                        show: function (e) {
                        ...
                        save: {
                            conditions: function () {
                                (y.cache = { title: E.attr("title") }),
                                    y.cache.title && E.removeAttr("title"),
                                    y.verbose(
                        ...
                        get: {
                            html: function () {
                                return (
                                    E.removeData(S.html),
                                    E.data(S.html) || x.html
                                );
                            },
                            title: function () {
                                return (
                                    E.removeData(S.title),
                                    E.data(S.title) || x.title
                                );
                            },
                            content: function () {
                                return (
                                    E.removeData(S.content),
                                    E.data(S.content) ||
                                        E.attr("title") ||
                                        x.content
                                );
                            ...
                            variation: function () {
                                return (
                                    E.removeData(S.variation),
                                    E.data(S.variation) || x.variation
                                );
                            },
                            popup: function () {
                                return n;
                            ...
                            nextPosition: function (e) {
                                ...
                                return (
                                    O ||
                                        (y.verbose(
                                            "All available positions available"
                                        ),
                                        (O = y.get.positions())),
                                    ...
                                    (l || c) &&
                                        (y.debug("Using backup position", u),
                                        (u = r[e])),
                                    u
                                );
                            },
                        ...
                        set: {
                            position: function (e, t) {
                                ...
                                if (
                                    ((t = t || y.get.calculations()),
                                    (e = e || E.data(S.position) || x.position),
                                    (o = E.data(S.offset) || x.offset),
                                    (a = x.distanceAway),
                                    (r = t.target),
                                    (s = t.popup),
                                    (c = t.parent),
                                ...
                                if (
                                    ...
                                    y.debug(
                                        "Calculated popup positioning values",
                                        l
                                    ),
                                    n
                                        .css(l)
                                ...
                                y.debug("Binding popup events to module"),
                                    ...
                                    y.get.startEvent() &&
                                        E.on(
                                            y.get.startEvent() + A,
                                            y.event.start
                                        ).on(y.get.endEvent() + A, y.event.end),
                                    x.target &&
                                        y.debug("Target set to element", F),
                                    c.on("resize" + h, y.event.resize);
                            },
                            popup: function () {
                                y.verbose(
                            ...
                            close: function () {
                                (x.hideOnScroll === !0 ||
                                    ...
                                    "hover" == x.on &&
                                        ...
                                        s.on("touchstart" + h, function (e) {
                                            y.verbose(
                                                "Touched away from popup"
                                            ),
                                                y.event.hideGracefully.call(
                                                    j,
                                                    e
                                                );
                                        })),
                        ...
                        unbind: {
                            close: function () {
                                (x.hideOnScroll === !0 ||
                                    ("auto" == x.hideOnScroll &&
                                        "click" != x.on)) &&
                                    (s.off("scroll" + h, y.hide),
                                    P.off("scroll" + h, y.hide)),
                                    "hover" == x.on &&
                                        q &&
                                        (s.off("touchstart" + h), (q = !1)),
                                    "click" == x.on &&
                                        x.closable &&
                                        (y.verbose(
                                            "Removing close event from document"
                                        ),
                                        s.off("click" + h));
                            },
                        },
                        ...
                        reset: function () {
                            y.remove.visible(),
                                x.preserve
                                    ? e.fn.transition !== i &&
                                      n.transition("remove transition")
                                    : y.removePopup();
                        },
                        setting: function (t, n) {
                            if (e.isPlainObject(t)) e.extend(!0, x, t);
                        ...
                        p
                            ? (z === i && y.initialize(), y.invoke(g))
                            : (z !== i && z.invoke("destroy"), y.initialize());
                }),
                a !== i ? a : this
            );
        }),
            ...
            return (
                a.each(function () {
                    ...
                    (m = {
                        ...
                        destroy: function () {
                            m.verbose("Destroying previous progress for", C),
                        ...
                        read: {
                            ...
                            settings: function () {
                                f.total !== !1 &&
                                    (m.debug(
                                        "Current total set in settings",
                                        f.total
                                    ),
                                    m.set.total(f.total)),
                                    f.value !== !1 &&
                                        (m.debug(
                                            "Current value set in settings",
                                            f.value
                                        ),
                                        m.set.value(f.value),
                        ...
                        increment: function (e) {
                            ...
                            m.has.total()
                                ? ((n = m.get.value()),
                                  ...
                                  (i = n + e),
                                  (t = m.get.total()),
                                  m.debug("Incrementing value", n, i, t),
                                  i > t &&
                                      (m.debug(
                                ...
                                : ((n = m.get.percent()),
                                  ...
                                  (i = n + e),
                                  (t = 100),
                                  m.debug("Incrementing percentage by", n, i),
                                  i > t &&
                                      (m.debug(
                                          "Value cannot increment above 100 percent"
                                      ),
                                      (i = t))),
                                m.set.progress(i);
                        },
                        decrement: function (e) {
                            ...
                            i
                                ...
                                0 > n &&
                                    (m.debug("Value cannot decrement below 0"),
                                    (n = 0)),
                                m.set.progress(n);
                        },
                        has: {
                        ...
                        get: {
                            ...
                            randomValue: function () {
                                return (
                                    m.debug(
                                        "Generating random increment percentage"
                                    ),
                                    Math.floor(
                                        Math.random() * f.random.max +
                                            f.random.min
                                    )
                                );
                            },
                        ...
                        set: {
                            ...
                            percent: function (e) {
                                (e =
                                    ...
                                    m.set.labelInterval(),
                                    m.set.labels(),
                                    f.onChange.call(T, e, m.value, m.total);
                            },
                            labelInterval: function () {
                                ...
                                clearInterval(m.interval),
                                    w.one(a + y, e),
                                    (m.timer = setTimeout(e, f.duration + 100)),
                                    (R = !0),
                            ...
                            label: function (e) {
                                (e = e || ""),
                                    e &&
                                        ((e = m.get.text(e)),
                                        m.debug("Setting label to text", e),
                                        S.text(e));
                            },
                            state: function (e) {
                                (e = e !== i ? e : m.percent),
                                    100 === e
                                        ...
                                        ? (m.verbose(
                                          ...
                                          m.set.active())
                                        : (m.remove.active(),
                                          m.set.label(f.text.active));
                            },
                            barLabel: function (e) {
                                e !== i
                                    ? k.text(m.get.text(e))
                                    : "ratio" == f.label && m.total
                                    ? (m.debug("Adding ratio to bar label"),
                                      k.text(m.get.text(f.text.ratio)))
                                    : "percent" == f.label &&
                                      (m.debug(
                                          "Adding percentage to bar label"
                                      ),
                            ...
                            active: function (e) {
                                (e = e || f.text.active),
                                    ...
                                    m.remove.success(),
                                    e && m.set.label(e),
                                    f.onActive.call(T, m.value, m.total);
                            },
                            success: function (e) {
                                (e = e || f.text.success),
                            ...
                            warning: function (e) {
                                (e = e || f.text.warning),
                                    ...
                                    m.complete(),
                                    e && m.set.label(e),
                                    f.onWarning.call(T, m.value, m.total);
                            },
                            error: function (e) {
                                (e = e || f.text.error),
                                    ...
                                    m.complete(),
                                    e && m.set.label(e),
                                    f.onError.call(T, m.value, m.total);
                            },
                            ...
                            progress: function (e) {
                                var t,
                                    n = m.get.numericValue(e);
                                n === !1 && m.error(b.nonNumeric, e),
                                    m.has.total()
                                        ? (m.set.value(n),
                                          (t = (n / m.total) * 100),
                                          m.debug(
                        ...
                        u
                            ? (A === i && m.initialize(), m.invoke(l))
                            : (A !== i && A.invoke("destroy"), m.initialize());
                }),
                o !== i ? o : this
            );
        }),
        ...
        (e.fn.rating = function (t) {
            ...
            return (
                o.each(function () {
                    ...
                    (d = {
                        initialize: function () {
                            d.verbose("Initializing rating module", m),
                                0 === w.length && d.setup.layout(),
                                m.interactive ? d.enable() : d.disable(),
                                d.set.rating(d.get.initialRating()),
                                d.instantiate();
                        },
                        instantiate: function () {
                            d.verbose("Instantiating module", m),
                                (x = d),
                                C.data(b, d);
                        },
                        destroy: function () {
                        ...
                        get: {
                            ...
                            rating: function () {
                                ...
                                return (
                                    d.verbose("Current rating retrieved", e), e
                                );
                            },
                        },
                        set: {
                    ...
                    (f = {
                        ...
                        bind: {
                            events: function () {
                                f.verbose("Binding events to search"),
                                    ...
                                    S.on("focus" + w, y.prompt, f.event.focus)
                                        .on("blur" + w, y.prompt, f.event.blur)
                                        .on(
                                            "keydown" + w,
                                            y.prompt,
                                            f.handleKeyboard
                        ...
                        handleKeyboard: function (e) {
                            ...
                            if (
                                ...
                                r == s.enter &&
                                    (f.verbose(
                                        "Enter key pressed, executing query"
                                    ),
                                    f.query(),
                                    f.set.buttonPressed(),
                                    T.one("keyup", f.remove.buttonFocus));
                        },
                        setup: {
                            api: function () {
                                var e = {
                            ...
                            result: function (t, n) {
                                ...
                                return (
                                    ...
                                    "category" === g.type
                                        ...
                                        : (f.debug(
                                              "Finding result in results object",
                                              t
                                          ),
                            ...
                            f.has.minimumCharacters()
                                ? (n
                                      ...
                                      : (f.debug("Querying for", t),
                                        e.isPlainObject(g.source) ||
                                        e.isArray(g.source)
                                            ? f.search.local(t)
                                            : f.can.useAPI()
                                            ? f.search.remote(t)
                                            : f.error(x.source)),
                                  g.onSearchQuery.call(E, t))
                                : f.hideResults();
                        },
                        search: {
                            local: function (e) {
                                var t,
                                    n = f.search.object(e, g.content);
                                f.set.loading(),
                                    f.save.results(n),
                            ...
                            remote: function (t) {
                                ...
                                S.api("get request") || f.setup.api(),
                                    e.extend(!0, n, g.apiSettings),
                                    f.debug("Executing search", n),
                                    f.cancel.query(),
                                    S.api("setting", n).api("query");
                            },
                        ...
                        write: {
                            cache: function (e, t) {
                                ...
                                g.cache &&
                                    (f.verbose(
                                        "Writing generated html to cache",
                                        e,
                                        t
                                    ),
                                    (n[e] = t),
                        ...
                        addResults: function (t) {
                            return e.isFunction(g.onResultsAdd) &&
                                ...
                                ? (f.debug(
                                  ...
                                  !1)
                                : (R.html(t),
                                  void (f.can.show() && f.showResults()));
                        },
                        showResults: function () {
                            f.is.visible() ||
                                (f.can.transition()
                                    ? (f.debug(
                                          "Showing results with css animations"
                                      ),
                                      R.transition({
                                          animation: g.transition + " in",
                                          debug: g.debug,
                                    ...
                                    : (f.debug(
                                          "Showing results with javascript"
                                      ),
                        ...
                        hideResults: function () {
                            f.is.visible() &&
                                (f.can.transition()
                                    ? (f.debug(
                                          "Hiding results with css animations"
                                      ),
                                      R.transition({
                                          animation: g.transition + " out",
                                          debug: g.debug,
                                    ...
                                    : (f.debug(
                                          "Hiding results with javascript"
                                      ),
                        ...
                        generateResults: function (t) {
                            ...
                            var n = g.templates[g.type],
                                ...
                                o =
                                    e.isArray(t[b.results]) &&
                                    t[b.results].length > 0,
                                a = "";
                            return (
                                i || o
                                    ? (g.maxResults > 0 &&
                                          (i
                                              ? "standard" == g.type &&
                                                f.error(x.maxResults)
                                              : (t[b.results] = t[
                                                    b.results
                                                ].slice(0, g.maxResults))),
                                      e.isFunction(n)
                                          ? (a = n(t, b))
                                          : f.error(x.noTemplate, !1))
                                    : (a = f.displayMessage(
                                          x.noResults,
                                          "empty"
                                      )),
                                g.onResults.call(E, t),
                                a
                            );
                        },
                        displayMessage: function (e, t) {
                            return (
                                ...
                                f.addResults(g.templates.message(e, t)),
                        ...
                        d
                            ? (P === i && f.initialize(), f.invoke(u))
                            : (P !== i && P.invoke("destroy"), f.initialize());
                }),
                a !== i ? a : this
            );
        }),
            ...
            return (
                r.each(function () {
                    ...
                    (g = {
                        ...
                        set: {
                            defaultSide: function () {
                                (t = k.find("." + v.className.active)),
                                    ...
                                    g.verbose("Next side set to", f);
                            },
                            duration: function (e) {
                                (e = e || v.duration),
                                    (e = "number" == typeof e ? e + "ms" : e),
                                    g.verbose("Setting animation duration", e),
                                    (v.duration || 0 === v.duration) &&
                                        S.add(T).css({
                            ...
                            stageSize: function () {
                                ...
                                g.set.currentStageSize(),
                                    ...
                                    k.css(i),
                                    g.verbose(
                                        "Resizing stage to fit new content",
                                        i
                                    );
                            },
                            nextSide: function (e) {
                                (A = e),
                                    ...
                                    (A = T.index(f)),
                                    0 === f.length &&
                                        (g.set.defaultSide(), g.error(y.side)),
                                    g.verbose("Next side manually set to", f);
                            },
                            active: function () {
                                g.verbose("Setting new side to active", f),
                                    T.removeClass(x.active),
                                    f.addClass(x.active),
                                    v.onChange.call(f[0]),
                                    g.set.defaultSide();
                        ...
                        flip: {
                            up: function () {
                                return !g.is.complete() ||
                                    g.is.animating() ||
                                    v.allowRepeats
                                    ? void (g.is.animating()
                                          ? g.queue("flip up")
                                          : (g.debug("Flipping up", f),
                                            g.set.stageSize(),
                                            g.stage.above(),
                                            g.animate(g.get.transform.up())))
                                    : void g.debug("Side already visible", f);
                            },
                            down: function () {
                                return !g.is.complete() ||
                                    g.is.animating() ||
            ...
            return (
                r.each(function () {
                    ...
                    (w = {
                        ...
                        destroy: function () {
                            w.verbose("Destroying previous module for", D),
                                D.off(P).removeData(F),
                        ...
                        event: {
                            clickaway: function (e) {
                                var t =
                                        z.find(e.target).length > 0 ||
                                        z.is(e.target),
                                    n = O.is(e.target);
                                t &&
                                    (w.verbose("User clicked on dimmed page"),
                                    w.hide()),
                                    n &&
                                        (w.verbose(
                        ...
                        bind: {
                            clickaway: function () {
                                w.verbose(
                                    "Adding clickaway events to context",
                                    O
                                ),
                                    k.closable &&
                            ...
                            scrollLock: function () {
                                k.scrollLock &&
                                    ...
                                    D.on("scroll" + P, w.event.containScroll);
                            },
                        },
                        unbind: {
                            clickaway: function () {
                                w.verbose(
                                    "Removing clickaway events from context",
                                    O
                                ),
                                    O.off(b);
                            },
                        ...
                        setup: {
                            ...
                            layout: function () {
                                0 === O.children(S.pusher).length &&
                                    (w.debug(
                                        "Adding wrapper element for sidebar"
                                    ),
                                    w.error(E.pusher),
                                    ...
                                    O.children()
                                        ...
                                        .wrapAll(z),
                                    w.refresh()),
                                    (0 === D.nextAll(S.pusher).length ||
                                        D.nextAll(S.pusher)[0] !== z[0]) &&
                                        (w.debug(
                                            "Moved sidebar to correct parent element"
                                        ),
                                        w.error(E.movedSidebar, I),
                                        D.detach().prependTo(O),
                                        w.refresh()),
                                    w.clear.cache(),
                                    w.set.pushable(),
                                    w.set.direction();
                        ...
                        show: function (t) {
                            if (
                                ...
                                if (
                                    ...
                                    if (
                                        (w.debug(
                                            "Other sidebars currently visible"
                                        ),
                                        k.exclusive)
                                    ) {
                        ...
                        othersAnimating: function () {
                            return (
                                q.not(D).filter("." + T.animating).length > 0
                            );
                        },
                        ...
                        scrollBack: function () {
                            w.verbose(
                                "Scrolling back to original page position"
                            ),
                                t.scrollTo(0, x);
                        },
                        clear: {
                        ...
                        is: {
                            ...
                            mobile: function () {
                                ...
                                return t
                                    ? (w.verbose(
                                          "Browser was found to be mobile",
                                          e
                                      ),
                                      !0)
                                    : (w.verbose(
                        ...
                        p
                            ? (L === i && w.initialize(), w.invoke(g))
                            : (L !== i && w.invoke("destroy"), w.initialize());
                }),
                a !== i ? a : this
            );
        }),
                    ...
                    (g = {
                        ...
                        observeChanges: function () {
                            ...
                            "MutationObserver" in t &&
                                ...
                                f.observe(A, { childList: !0, subtree: !0 }),
                        ...
                        get: {
                            ...
                            currentElementScroll: function () {
                                return g.elementScroll
                                    ...
                                    : Math.abs(parseInt(C.css("bottom"), 10)) ||
                                      0;
                            },
                            elementScroll: function (e) {
                                e = e || k.scrollTop();
                        ...
                        stick: function (e) {
                            var t = e || k.scrollTop(),
                                ...
                                r = n.context,
                                s =
                                    g.is.bottom() && p.pushing
                                        ? p.bottomOffset
                                        : p.offset,
                                e = { top: t + s, bottom: t + s + a.height },
                                c =
                                    (g.get.direction(e.top),
                                    i ? 0 : g.get.elementScroll(e.top)),
                                l = !i,
                                u = 0 !== o.height;
                            u &&
                        ...
                        bindTop: function () {
                            g.debug(
                                "Binding element to top of parent container"
                            ),
                                g.remove.offset(),
                    ...
                    (b = {
                        ...
                        determineTabs: function () {
                            ...
                            "parent" === x.context
                                ...
                                x.childrenOnly
                                    ...
                                    : ((p = g.find(k.tabs)),
                                      b.debug(
                                          "Searching tab context for tabs",
                                          g,
                                          p
                                      ));
                        },
                                ...
                                e.each(r, function (t, i) {
                                    ...
                                    if ((b.verbose("Looking for tab", i), f)) {
                                        if (
                                            ...
                                            (v = m),
                                            (h = b.utilities.filterArray(r, d)),
                                            p
                                                ? (u = !0)
                                                : ((c = r.slice(0, t + 2)),
                                                  (l =
                                                      b.utilities.arrayToPath(
                                                          c
                                                      )),
                                                  (u = !b.is.tab(l)),
                                                  u &&
                                                      b.verbose(
                                                          "Tab parameters found",
                                                          c
                                                      )),
                                            u && a)
                                        )
                                            return (
                                                o
                                                    ...
                                                    : (b.activate.navigation(m),
                                                      b.fetch.content(m, n)),
                                                !1
                                            );
                                        b.debug("Opened local tab", m),
                                            b.activate.all(m),
                                            b.cache.read(m) ||
                                                (b.cache.add(m, !0),
                                                b.debug(
                                            ...
                                            x.onLoad.call(k[0], m, h, y);
                                    } else {
                                        if (-1 != n.search("/") || "" === n)
                                            return (
                                                b.error(S.missingTab, R, g, m),
                                                !1
                                            );
                                        if (
                                            ((s = e(
                        ...
                        get: {
                            initialPath: function () {
                                return (
                                    r.eq(0).data(w.tab) || p.eq(0).data(w.tab)
                                );
                            },
                            path: function () {
                            ...
                            defaultPathArray: function (e) {
                                return b.utilities.pathToArray(
                                    b.get.defaultPath(e)
                                );
                            },
            ...
            return (
                a.each(function (t) {
                    ...
                    (C = {
                        ...
                        refresh: function () {
                            C.verbose(
                                "Refreshing display type on next animation"
                            ),
                        ...
                        delay: function (e) {
                            ...
                            r ||
                                (r = C.can.transition()
                                    ...
                                    : "static"),
                                (e = e !== i ? e : f.interval),
                                (n = "auto" == f.reverse && r == v.outward),
                                (o =
                                    n || 1 == f.reverse
                                        ? (a.length - t) * f.interval
                                        : t * f.interval),
                        ...
                        animate: function (e) {
                            ...
                            C.can.animate()
                                ...
                                : C.error(p.noAnimation, f.animation, k);
                        },
                        reset: function () {
                            C.debug(
                                "Resetting animation to beginning conditions"
                            ),
                        ...
                        set: {
                            ...
                            inward: function () {
                                C.debug("Setting direction to inward"),
                                    w.removeClass(v.outward).addClass(v.inward);
                            },
                            outward: function () {
                                C.debug("Setting direction to outward"),
                                    w.removeClass(v.inward).addClass(v.outward);
                            },
                            visible: function () {
                        ...
                        remove: {
                            ...
                            looping: function () {
                                C.debug("Transitions are no longer looping"),
                                    C.is.looping() &&
                                        (C.reset(), w.removeClass(v.looping));
                            },
                            transition: function () {
                        ...
                        get: {
                            ...
                            displayType: function () {
                                return f.displayType
                                    ? f.displayType
                                    : (w.data(h.displayType) === i &&
                                          C.can.transition(!0),
                                      w.data(h.displayType));
                            },
                            ...
                            transition: function (t) {
                                ...
                                if (d === i || t) {
                                    if (
                                        ...
                                        C.debug(
                                            "Direction exists for animation",
                                            u
                                        ),
                                            (c = !0);
                                    else {
                                        ...
                                        C.debug("Static animation found", u, l),
                                            (c = !1);
                                    }
                        ...
                        enable: function () {
                            C.verbose("Starting animation"),
                                w.removeClass(v.disabled);
                        },
                        disable: function () {
                            C.debug("Stopping animation"),
                                w.addClass(v.disabled);
                        },
                        setting: function (t, n) {
                            if (
                ...
                return (
                    a.each(function () {
                        ...
                        (v = {
                            ...
                            destroy: function () {
                                v.verbose("Destroying previous module for", E),
                            ...
                            bind: {
                                events: function () {
                                    ...
                                    e
                                        ? (v.verbose(
                                              "Attaching API events to element",
                                              e
                                          ),
                                          T.on(e + k, v.event.trigger))
                                        : "now" == h.on &&
                                          (v.debug(
                                              "Querying API endpoint immediately"
                                          ),
                                          v.query());
                                },
                            },
                            ...
                            query: function () {
                                ...
                                if (v.is.loading()) {
                                    ...
                                    v.debug("Interrupting previous request"),
                                        v.abort();
                                }
                                return (
                                    h.defaultData &&
                                    ...
                                    h.serializeForm &&
                                        (h.data = v.add.formData(h.data)),
                                    (m = v.get.settings()),
                                    m === !1
                                        ? ((v.cancelled = !0),
                                          void v.error(C.beforeSend))
                                        : ((v.cancelled = !1),
                                          (f = v.get.templatedURL()),
                                          f || v.is.mocked()
                                              ? ((f = v.add.urlData(f)),
                                                f || v.is.mocked()
                                                    ? ((m.url = h.base + f),
                                                      ...
                                                      "local" === h.cache &&
                                                      v.read.cachedResponse(f)
                                                          ? (v.debug(
                                                                "Response returned from local cache"
                                                            ),
                                                            (v.request =
                                                                v.create.request()),
                                                            void v.request.resolveWith(
                                                                P,
                                                                [
                                                                    v.read.cachedResponse(
                                                                        f
                                                                    ),
                                                                ]
                                                            ))
                                                          : void (h.throttle
                                                                ? h.throttleFirstRequest ||
                                                                  v.timer
                                                                    ? (v.debug(
                                                                          "Throttling request",
                                                                          h.throttle
                                ...
                                abortedRequest: function (e) {
                                    return e &&
                                        ...
                                        ? (v.verbose(
                                          ...
                                          !0)
                                        : (v.verbose(
                                              "XHR request was not aborted"
                                          ),
                                          !1);
                                },
                                validResponse: function (t) {
                                    return ("json" !== h.dataType &&
                                        "jsonp" !== h.dataType) ||
                            ...
                            was: {
                                ...
                                succesful: function () {
                                    return (
                                        v.request &&
                                        "resolved" == v.request.state()
                                    );
                                },
                                failure: function () {
                                    return (
                                        v.request &&
                                        "rejected" == v.request.state()
                                    );
                                },
                                complete: function () {
                                    return (
                            ...
                            add: {
                                urlData: function (t, n) {
                                    ...
                                    return (
                                        t &&
                                            ((o = t.match(h.regExp.required)),
                                            (a = t.match(h.regExp.optional)),
                                            (n = n || h.urlData),
                                            o &&
                                                (v.debug(
                            ...
                            send: {
                                request: function () {
                                    v.set.loading(),
                                        (v.request = v.create.request()),
                                        v.is.mocked()
                                            ? (v.mockedXHR =
                                                  v.create.mockedXHR())
                                            : (v.xhr = v.create.xhr()),
                                        h.onRequest.call(P, v.request, v.xhr);
                                },
                            },
                            event: {
                                trigger: function (e) {
                                ...
                                xhr: {
                                    always: function () {},
                                        ...
                                        (r = r > 0 ? r : 0),
                                            ...
                                            setTimeout(function () {
                                                v.is.validResponse(t)
                                                    ? v.request.resolveWith(o, [
                                                          t,
                                                          i,
                                                      ])
                                                    : v.request.rejectWith(o, [
                                                          i,
                                                          "invalid",
                                                      ]);
                                            }, r);
                                    ...
                                    fail: function (e, t, n) {
                                        ...
                                        (a = a > 0 ? a : 0),
                                            ...
                                            setTimeout(function () {
                                                v.is.abortedRequest(e)
                                                    ? v.request.rejectWith(i, [
                                                          e,
                                                          "aborted",
                                                          n,
                                                      ])
                                ...
                                request: {
                                        ...
                                        v.debug("Successful API Response", e),
                                            "local" === h.cache &&
                                                f &&
                                                (v.write.cachedResponse(f, e),
                                                v.debug(
                                                    "Saving server response locally",
                                                    v.cache
                                                )),
                                            h.onSuccess.call(P, e, T, t);
                                    },
                                    complete: function (e, t) {
                                        ...
                                        v.was.succesful()
                                            ? ((i = e), (n = t))
                                            : ((n = e),
                                              (i = v.get.responseFromXHR(n))),
                                            v.remove.loading(),
                                            h.onComplete.call(P, i, T, n);
                                    },
                                    fail: function (e, t, n) {
                                        ...
                                        "aborted" == t
                                            ...
                                            : "error" == t &&
                                              ...
                                              h.onError.call(P, r, T, e)),
                                            h.errorDuration &&
                                                "aborted" !== t &&
                                                (v.debug("Adding error state"),
                                                v.set.error(),
                                                v.should.removeError() &&
                                                    setTimeout(
                                                        v.remove.error,
                                                        h.errorDuration
                                                    )),
                                            v.debug("API Request failed", r, e),
                                            h.onFailure.call(P, o, T, e);
                                    },
                                },
                            },
                            create: {
                                request: function () {
                                    return e
                                        .Deferred()
                                        .always(v.event.request.complete)
                                        .done(v.event.request.done)
                                        .fail(v.event.request.fail);
                                },
                                mockedXHR: function () {
                                    var t,
                                        n,
                                    ...
                                    return (
                                        (i = e
                                            .Deferred()
                                            .always(v.event.xhr.complete)
                                            .done(v.event.xhr.done)
                                            .fail(v.event.xhr.fail)),
                                        s
                                            ? (e.isFunction(s)
                                                  ? (v.debug(
                                ...
                                xhr: function () {
                                    ...
                                    return (
                                        (t = e
                                            .ajax(a)
                                            .always(v.event.xhr.always)
                                            .done(v.event.xhr.done)
                                            .fail(v.event.xhr.fail)),
                                        v.verbose("Created server request", t),
                                        t
                                    );
                                },
                            },
                            ...
                            remove: {
                                error: function () {
                                    v.verbose(
                                        "Removing error state from element",
                                        R
                                    ),
                            ...
                            get: {
                                ...
                                settings: function () {
                                    var t;
                                    return (
                                        (t = h.beforeSend.call(P, h)),
                                        t &&
                                            (t.success !== i &&
                                                (v.debug(
                                                    "Legacy success callback detected",
                                                    t
                                                ),
                                                v.error(
                                                    C.legacyParameters,
                                            ...
                                            t.failure !== i &&
                                                (v.debug(
                                                    "Legacy failure callback detected",
                                                    t
                                                ),
                                                v.error(
                                                    C.legacyParameters,
                                ...
                                templatedURL: function (e) {
                                    if (
                                        ((e =
                                            ...
                                            h.action ||
                                            !1),
                                        (f = T.data(y.url) || h.url || !1))
                                    )
                                        return (
                                            v.debug("Using specified url", f), f
                                        );
                                    if (e) {
                                        if (
                                            (v.debug(
                            ...
                            abort: function () {
                                ...
                                e &&
                                    "resolved" !== e.state() &&
                                    (v.debug("Cancelling API request"),
                                    e.abort());
                            },
                            reset: function () {
                            ...
                            u
                                ? (F === i && v.initialize(), v.invoke(l))
                                : (F !== i && F.invoke("destroy"),
                                  v.initialize());
                    }),
                    o !== i ? o : this
                );
                                ...
                                if (n.allows("active") && n.is.enabled()) {
                                    if ((n.refresh(), e.fn.api !== i))
                                        if (
                                            ...
                                            n.debug(
                                                "API Request cancelled by beforesend"
                                            ),
                        ...
                        reset: {
                            text: function () {
                                ...
                                n.is.textEnabled() &&
                                    (n.is.active() && e
                                        ? (n.verbose(
                                              "Resetting active text",
                                              e
                                          ),
                                          n.update.text(e))
                                        : t &&
                                          (n.verbose(
                                              "Resetting inactive text",
                                              e
                                          ),
                                          n.update.text(t)));
                            },
                    ...
                    (g = {
                        ...
                        destroy: function () {
                            g.verbose("Destroying previous module"),
                                ...
                                S.off("scrollchange" + x, g.event.scrollchange),
                        ...
                        observeChanges: function () {
                            "MutationObserver" in t &&
                                ...
                                f.observe(R, { childList: !0, subtree: !0 }),
                                g.debug("Setting up mutation observer", f));
                        },
                        bind: {
                            events: function () {
                        ...
                        event: {
                            ...
                            scroll: function () {
                                p.throttle
                                    ? (clearTimeout(g.timer),
                                      (g.timer = setTimeout(function () {
                                          S.triggerHandler("scrollchange" + x, [
                                              S.scrollTop(),
                                          ]);
                                      }, p.throttle)))
                                    : A(function () {
                        ...
                        disableCallbacks: function () {
                            g.debug("Disabling all callbacks temporarily"),
                                (E = !0);
                        },
                        should: {
                        ...
                        create: {
                            placeholder: function () {
                                g.verbose(
                                    "Creating fixed position placeholder"
                                ),
                                    (r = k
                                        .clone(!1)
                                        .css("display", "none")
                                        .addClass(v.placeholder)
                                        .insertAfter(k));
                            },
                        },
                        show: {
                        ...
                        passed: function (t, n) {
                            ...
                            if (t && n) p.onPassed[t] = n;
                                ...
                                if (t !== i)
                                    return (
                                        g.get.pixelsPassed(t) > o.pixelsPassed
                                    );
                                o.passing &&
                                    e.each(p.onPassed, function (e, t) {
                                        o.bottomVisible ||
                                        o.pixelsPassed > g.get.pixelsPassed(e)
                                            ? g.execute(t, e)
                        ...
                        topVisible: function (e) {
                            ...
                            return (
                                e &&
                                    (g.debug(
                                        "Adding callback for top visible",
                                        e
                                    ),
                                    (p.onTopVisible = e)),
                                t.topVisible
                        ...
                        bottomVisible: function (e) {
                            ...
                            return (
                                e &&
                                    (g.debug(
                                        "Adding callback for bottom visible",
                                        e
                                    ),
                                    (p.onBottomVisible = e)),
                                t.bottomVisible
                        ...
                        topPassed: function (e) {
                            ...
                            return (
                                e &&
                                    (g.debug(
                                        "Adding callback for top passed",
                                        e
                                    ),
                                    (p.onTopPassed = e)),
                                t.topPassed
                        ...
                        bottomPassed: function (e) {
                            ...
                            return (
                                e &&
                                    (g.debug(
                                        "Adding callback for bottom passed",
                                        e
                                    ),
                                    (p.onBottomPassed = e)),
                                t.bottomPassed
                        ...
                        passingReverse: function (e) {
                            ...
                            return (
                                e &&
                                    (g.debug(
                                        "Adding callback for passing reverse",
                                        e
                                    ),
                            ...
                            occurred: function (e) {
                                if (e) {
                                    ...
                                    t[e] !== i &&
                                        t[e] === !0 &&
                                        (g.debug(
                                            "Callback can now be called again",
                                            e
                                        ),
                        ...
                        save: {
                            ...
                            elementCalculations: function () {
                                ...
                                return (
                                    ...
                                    (t.onScreen =
                                        t.topVisible && !t.bottomPassed),
                                    (t.passing =
                                        t.topPassed && !t.bottomPassed),
                            ...
                            screenCalculations: function () {
                                ...
                                return (
                                    ...
                                    (g.cache.screen.bottom =
                                        e + g.cache.screen.height),
                                    g.cache.screen
                                );
                            },
                            screenSize: function () {
                                g.verbose("Saving window position"),
                                    (g.cache.screen = { height: S.height() });
                            },
                            position: function () {
                        ...
                        get: {
                            ...
                            screenSize: function () {
                                return (
                                    g.cache.screen === i && g.save.screenSize(),
                                    g.cache.screen
                                );
                            },
                            scroll: function () {
                                return (
                                    g.cache.scroll === i && g.save.scroll(),
                                    g.cache.scroll
                                );
                            },
                            lastScroll: function () {
