...
(function (n, t) {
    ...
    function tt() {
        ...
        (c.className = c.className.replace(
            ...
            p(i.screens, function (n) {
                t > n
                    ? (i.screensCss.gt && r("gt-" + n),
                      i.screensCss.gte && r("gte-" + n))
                    : t < n
                    ? (i.screensCss.lt && r("lt-" + n),
                      i.screensCss.lte && r("lte-" + n))
                    : t === n &&
                      (i.screensCss.lte && r("lte-" + n),
    ...
    var y = n.document,
        ...
        i = {
            screens: [
                240, 320, 480, 640, 768, 800, 1024, 1280, 1440, 1680, 1920,
            ],
    ...
    (u = n[i.head] =
        ...
        (w = /mobile|android|kindle|silk|midp|phone|(windows .+arm|touch)/.test(
            s
        )),
        ...
        for (f in i.browsers[l])
            if (o === f)
                for (
                    ...
                    h > e
                        ? (i.browserCss.gt && r("gt-" + f + e),
                          i.browserCss.gte && r("gte-" + f + e))
                        : h < e
                        ? (i.browserCss.lt && r("lt-" + f + e),
    ...
    r(o),
        ...
        (b = 0),
        n.addEventListener
            ? n.addEventListener("resize", it, !1)
            : n.attachEvent("onresize", it);
})(window);
