            ...
            function scrollHandler() {
                ...
                if (!options.autoScrolling || options.scrollBar) {
                    ...
                    var initial = Math.abs(
                        currentScroll -
                            document.querySelectorAll(SECTION_SEL)[0].offsetTop
                    );
                    ...
                    if (
                        !currentSection.hasClass(ACTIVE) &&
                        !currentSection.hasClass(AUTO_HEIGHT)
                    ) {
                        isScrolling = true;
        ...
        */
            ...
            function scrollPage(element, callback, isMovementUp) {
                ...
                requestAnimFrame(function () {
                    ...
                    var dtop = element.hasClass(AUTO_HEIGHT)
                        ? dest.top - windowsHeight + element.height()
                        : dest.top;
            ...
            function lazyLoad(destiny) {
                ...
                destiny
                    .find("img[data-src], source[data-src], audio[data-src]")
                    .each(function () {
            ...
            function landscapeScroll(slides, destiny) {
                ...
                if (options.css3) {
                    ...
                    addAnimation(
                        slides.find(SLIDES_CONTAINER_SEL),
            ...
            function responsive() {
                ...
                var isBreakingPointWidth =
                    widthLimit && $window.width() < widthLimit;
            ...
            function isScrolled(type, scrollable) {
                if (type === "top") {
                    ...
                    return (
                        scrollable.scrollTop() + 1 + scrollable.innerHeight() >=
