...
(function (n, m, C, v, e) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = v(m, C))
        : (n.fullpage = v(m, C));
})(this, window, document, function (n, m, C) {
    function v(a, b) {
        for (var c in b)
            b.hasOwnProperty(c) && null !== c && (a.style[c] = b[c]);
        return a;
    }
    function e(a, b) {
        b = b || m;
    ...
    function fa() {
        ...
        return (n.pageYOffset || a.scrollTop) - (a.clientTop || 0);
    }
    function ua(a) {
    ...
    function ta(a, b) {
        !d.autoScrolling || d.scrollBar || (a.self != n && w(a, "fp-slides"))
            ? a.self != n && w(a, "fp-slides")
                ? (a.scrollLeft = b)
                : a.scrollTo(0, b)
            : (a.style.top = b + "px");
    }
    function wa(a, b) {
        ...
        d.autoScrolling && !d.scrollBar
            ? (v(m.body, { overflow: "hidden", height: "100%" }),
              v(m.getElementsByTagName("html")[0], {
                  overflow: "hidden",
                  height: "100%",
              }),
              ga(d.recordHistory, "internal"),
              v(r, { "-ms-touch-action": "none", "touch-action": "none" }),
              c && L(c.offsetTop))
            : (v(m.body, { overflow: "visible", height: "100%" }),
              v(m.getElementsByTagName("html")[0], {
                  overflow: "visible",
                  height: "100%",
              }),
              ga(!1, "internal"),
              v(r, { "-ms-touch-action": "", "touch-action": "" }),
              L(0),
              (c = U(c.offsetTop)),
    ...
    function Sa() {
        ...
        for (b = 0; b < a.length; b++)
            K(a[b], "click onclick touchstart", function (a) {
    ...
    function Ta() {
        ...
        if (!d.autoScrolling || d.scrollBar) {
            for (
                var b = fa(),
                    c = 0,
                    f = Math.abs(b - p(".fp-section")[0].offsetTop),
                    h = p(".fp-section"),
                    k = 0;
                k < h.length;
                ++k
        ...
        if (!d.autoScrolling || d.scrollBar) {
            if (!w(a, "active")) {
                ...
                k = q(a) + 1;
                if ((g = e(".fp-slide.active", a)))
                    var l = g.getAttribute("data-anchor"),
                        m = q(g);
                E &&
                    (B(b, "active"),
                    t(a, "active"),
                    z(d.onLeave) && d.onLeave.call(b, c, k, f),
                    z(d.afterLoad) && d.afterLoad.call(a, h, k),
                    Z(h, 0),
                    d.anchors.length && ((F = h), ka(m, l, h, k)));
                clearTimeout(Ca);
            ...
            d.fitToSection &&
                ...
                (Da = setTimeout(function () {
                    if ((E && !d.autoScrolling) || d.scrollBar)
                        q(e(".fp-section.active")) == q(a) && (u = !0),
                            A(a),
                            (u = !1);
                }, 1e3)));
        }
    ...
    function Ua(a) {
        ...
        la(b) &&
            ...
            E &&
                ...
                (O = b.y),
                (ba = b.x),
                a && Math.abs(ca - ba) > Math.abs(P - O)
                    ? Math.abs(ca - ba) >
                          (("innerWidth" in n
                              ? n.innerWidth
                              : m.documentElement.offsetWidth) /
                              100) *
                              d.touchSensitivity && (ca > ba ? X() : Y())
                    : d.autoScrolling &&
                      Math.abs(P - O) > (R() / 100) * d.touchSensitivity &&
                      (P > O ? aa("down") : O > P && aa("up"))));
    }
    function la(a) {
    ...
    function ya(a) {
        ...
        if ((b = e(".fp-slides", b)) && !G) {
            var c = e(".fp-slide.active", b),
                f = null,
                f = "prev" === a ? va(c) : ua(c);
            if (!f) {
                if (!d.loopHorizontal) return;
                for (
                    var f = c.parentNode.firstChild, h = [];
                    f;
                    f = f.nextSibling
                )
                    1 == f.nodeType && f != c && h.push(f);
    ...
    function A(a, b, c) {
        if (
            ...
            !(
                (q(b.activeSection) == b.sectionIndex && !u) ||
                (d.scrollBar && fa() === b.dtop)
            ))
        ) {
            if (b.activeSlide)
                var f = b.activeSlide.getAttribute("data-anchor"),
                    h = q(b.activeSlide);
            c = p(".fp-section");
            for (var k = 0; k < c.length; k++) B(c[k], "active");
            t(a, "active");
            E = !1;
    ...
    function Xa(a) {
        if (d.css3 && d.autoScrolling && !d.scrollBar)
            Ha("translate3d(0px, -" + a.dtop + "px, 0px)", !0),
                d.scrollingSpeed
                    ? setTimeout(function () {
                          ma(a);
                      }, d.scrollingSpeed)
    ...
    function U(a) {
        var b = {};
        d.autoScrolling && !d.scrollBar
            ? ((b.options = -a), (b.element = e(".fullpage-wrapper")))
            : ((b.options = a), (b.element = n));
        return b;
    }
    function ma(a) {
        z(d.afterLoad) &&
    ...
    function N(a, b) {
        var c = q(b),
            ...
            h = q(f),
            k = f.getAttribute("data-anchor"),
            g = e(".fp-slidesNav", f),
            l = Ja(b),
            m = u;
        if (d.onSlideLeave) {
            var n = e(".fp-slide.active", f),
                r = q(n),
                v;
            v = r == c ? "none" : r > c ? "left" : "right";
            m ||
                "none" === v ||
                (z(d.onSlideLeave) && d.onSlideLeave.call(n, k, h + 1, r, v));
        }
        n = p(".fp-slide", f);
        for (r = 0; r < n.length; r++) B(n[r], "active");
        t(b, "active");
        !d.loopHorizontal &&
            d.controlArrows &&
            (sa(e(".fp-controlArrow.fp-prev", f), 0 !== c),
            sa(e(".fp-controlArrow.fp-next", f), !b.is(":last-child")));
        w(f, "active") && ka(c, l, k, h);
        var x = function () {
            m ||
                (z(d.afterSlideLoad) &&
                    d.afterSlideLoad.call(b, k, h + 1, l, c));
            G = !1;
        };
        d.css3
            ? ((f =
                  "translate3d(-" + Math.round(b.offsetLeft) + "px, 0px, 0px)"),
              (n = e(".fp-slidesContainer", a)),
              Ka(n, 0 < d.scrollingSpeed),
              La(n, f),
              setTimeout(
                  function () {
                      x();
            ...
            : ea(a, Math.round(b.offsetLeft), d.scrollingSpeed, function () {
                  x();
              });
        d.slidesNavigation &&
            (B(e(".active", g), "active"),
    ...
    function $a() {
        if (oa) {
            if ("text" !== m.activeElement.getAttribute("type")) {
                var a = R();
                Math.abs(a - pa) > (20 * Math.max(pa, a)) / 100 &&
                    (za(!0), (pa = a));
            }
        } else
            clearTimeout(Ma),
    ...
    function Z(a, b) {
        if (d.menu) {
            ...
            c &&
                (B(e(".active", c), "active"),
                t(e('[data-menuanchor="' + a + '"]', c), "active"));
        }
        d.navigation &&
            (B(e(".active", x), "active"),
            a
                ? t(e('a[href="#' + a + '"]', x), "active")
                : ((c = p("li", x)[b]), t(e("a", c), "active")));
    }
    function Ba(a) {
        ...
        d.anchors.length &&
            (a
                ? ("undefined" !== typeof c && (e = c),
                  ...
                  (na = b),
                  Oa(e + "/" + b))
                : ("undefined" !== typeof a && (na = b), Oa(c)));
        qa();
    }
    function Oa(a) {
        if (d.recordHistory) location.hash = a;
        else if (oa || ra) history.replaceState(C, C, "#" + a);
        else {
    ...
    function qa(a) {
        a = e(".fp-section.active");
        var b = e(".fp-slide.active", a),
            c = a.getAttribute("data-anchor");
        a = q(a);
        a = String(a);
        d.anchors.length && (a = c);
        b && ((b = Ja(b)), (a = a + "-" + b));
        a = a.replace("/", "-").replace("#", "");
        m.body.className = m.body.className.replace(
    ...
    function da(a, b, c, d, e) {
        a.addEventListener
            ? (a.addEventListener(c, b, !1),
              "undefined" !== typeof e && a.addEventListener(e, b, !1))
            : a.attachEvent(d, b);
    }
    function Ea(a) {
        var b = [];
    ...
    function L(a) {
        d.scrollBar
            ? ((a = U(a)), ta(a.element, a.options, 0))
            : d.css3
            ? Ha("translate3d(0px, -" + a + "px, 0px)", !1)
            : (r.style.top = -a + "px");
    }
    function La(a, b) {
        v(a, {
    ...
    var Ca,
        ...
        Ga = new Date().getTime();
    m.addEventListener
        ? n.addEventListener("hashchange", Ia, !1)
        : n.attachEvent("onhashchange", Ia);
    var Qa;
    ...
    null !== e(".fp-slidesNav a") &&
        K(e(".fp-slidesNav a"), "click onclick touchstart", function (a) {
            J(a);
            a = I(this, function (a) {
    ...
    return {
        initialize: function (a, b) {
            ...
            for (k = 0; k < d.anchors.length; k++)
                (c = d.anchors[k]),
                    (m.getElementById("#" + c) ||
                        ...
                        console.error &&
                        console.error(
                            "fullPage: data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE)."
                        );
            if (d.css3) {
                k = d;
                var c = m.createElement("p"),
                    g,
                    f = {
                ...
                for (var l in f)
                    c.style[l] !== C &&
                        ((c.style[l] = "translate3d(1px,1px,1px)"),
                        (g = n.getComputedStyle(c).getPropertyValue(f[l])));
                m.body.removeChild(c);
                k.css3 = g !== C && 0 < g.length && "none" !== g;
            }
            null !== r
                ? (v(r, { height: "100%", position: "relative" }),
                  t(r, "fullpage-wrapper"),
                  t(e("html"), "fp-enabled"))
                : console &&
                  console.error &&
                  console.error(
                      "fullPage: Error! Fullpage.js needs to be initialized with a selector. For example: fullpage('#fullpage');"
                  );
            da(
                e(".fullpage-wrapper"),
                Wa,
            ...
            if (oa || ra)
                (g = e(".fullpage-wrapper")),
                    m.addEventListener &&
                        ((l = n.PointerEvent
                            ? { down: "pointerdown", move: "pointermove" }
                            : { down: "MSPointerDown", move: "MSPointerMove" }),
                        g.removeEventListener("touchstart"),
                        g.removeEventListener(l.down),
                        g.removeEventListener("touchmove"),
                        g.removeEventListener(l.move),
                        K(g, "touchstart " + l.down, Va),
                        K(g, "touchmove " + l.move, Ua));
            ...
            for (g = 0; g < l.length; g++)
                if (
                    ...
                    (k = p(".fp-slide", c)),
                    (h = k.length),
                    f || null !== e(".fp-section.active") || t(c, "active"),
                    "undefined" !== typeof d.anchors[f] &&
                        (c.setAttribute("data-anchor", d.anchors[f]),
                        w(c, "active") && Z(d.anchors[f], f)),
                    0 < h)
                ) {
                    var y = 100 * h,
                        f = 100 / h;
                    c.innerHTML =
                        '<div class="fp-slides"><div class="fp-slidesContainer">' +
                        c.innerHTML +
                        "</div></div>";
                    k = p(".fp-slide", c);
                    ...
                    if (d.controlArrows && 1 < h) {
                        ...
                        d.loopHorizontal ||
                            (e(".fp-controlArrow.fp-prev", y).style.display =
                                "none");
                    }
            ...
            for (l = 0; l < g.length; l++)
                K(g[l], "click onclick touchstart", Za);
            ...
            d.navigation &&
                ((x.style["margin-top"] = "-" + x.offsetHeight / 2 + "px"),
                (l = p("li", x)[q(e(".fp-section.active"))]),
                t(e("a", l), "active"));
            l = e(".fp-section.active");
            z(d.afterLoad) &&
                d.afterLoad.call(l, l.getAttribute("data-anchor"), q(l) + 1);
                ...
                !d.animateAnchor &&
                    ...
                    (d.autoScrolling
                        ...
                        : (L(0),
                          qa(l),
                          (c = U(k.offsetTop)),
                          ea(c.element, c.options, 0)),
                    Z(l, null),
                    z(d.afterLoad) && d.afterLoad.call(k, l, q(k) + 1),
                    B(g, "active"),
                    t(k, "active")));
            qa();
            da(
