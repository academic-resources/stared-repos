...
(function (c, k) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = k(require("jquery"), c, c.document, c.Math))
        : k(jQuery, c, c.document, c.Math);
    ...
    c.fn.fullpage = function (d) {
        ...
        function Na() {
            ...
            c(".fp-section").each(function (a) {
                ...
                "undefined" !== typeof d.sectionsColor[a] &&
                    b.css("background-color", d.sectionsColor[a]);
                "undefined" !== typeof d.anchors[a] &&
                    b.attr("data-anchor", d.anchors[a]);
                "undefined" !== typeof d.anchors[a] &&
                    b.hasClass("active") &&
                    V(d.anchors[a], a);
                d.menu &&
            ...
            d.navigation && Qa();
            d.scrollOverflow
                ? ("complete" === m.readyState && ma(), n.on("load", ma))
                : na();
        }
        function Pa(a, b, g) {
            var f = 100 * g,
            ...
            1 < g && (d.controlArrows && Ra(a), d.slidesNavigation && Sa(a, g));
            b.each(function (a) {
                c(this).css("width", e + "%");
            ...
            if (!d.autoScrolling || d.scrollBar) {
                for (
                    var b = n.scrollTop(),
                        g = 0,
                        f = p.abs(
                            b - m.querySelectorAll(".fp-section")[0].offsetTop
                        ),
                        e = m.querySelectorAll(".fp-section"),
                        h = 0;
                    h < e.length;
                    ++h
                ) {
                ...
                if (!a.hasClass("active") && !a.hasClass("fp-auto-height")) {
                    ...
                    u &&
                        ...
                        c.isFunction(d.onLeave) && d.onLeave.call(b, g, h, f),
                        c.isFunction(d.afterLoad) && d.afterLoad.call(a, e, h),
                        J(a),
                        V(e, h - 1),
                        d.anchors.length && ((y = e), Y(q, l, e, h)));
                    clearTimeout(Z);
        ...
        function Ta(a) {
            ...
            if (!ra(a.target) && ba(b)) {
                ...
                u &&
                    ...
                    (E = b.y),
                    (L = b.x),
                    a.find(".fp-slides").length && p.abs(M - L) > p.abs(F - E)
                        ? p.abs(M - L) >
                              (n.width() / 100) * d.touchSensitivity &&
                          (M > L
                              ? l.m.right && e.moveSlideRight()
                              : l.m.left && e.moveSlideLeft())
                        : d.autoScrolling &&
                          p.abs(F - E) >
                              (n.height() / 100) * d.touchSensitivity &&
                          (F > E ? K("down", g) : E > F && K("up", g)));
            }
        }
        function ra(a, b) {
            b = b || 0;
        ...
        function ba(a) {
            return (
                "undefined" === typeof a.pointerType || "mouse" != a.pointerType
            );
        }
        function Ua(a) {
            a = a.originalEvent;
        ...
        function ta(a, b) {
            for (
                var d = 0, c = a.slice(p.max(a.length - b, 1)), e = 0;
                e < c.length;
                e++
            )
                d += c[e];
        ...
        function A(a) {
            ...
            if (d.autoScrolling && !N) {
                ...
                var g = a.wheelDelta || -a.deltaY || -a.detail,
                    f = p.max(-1, p.min(1, g)),
                    e =
                        "undefined" !== typeof a.wheelDeltaX ||
                        "undefined" !== typeof a.deltaX,
                    e =
                        p.abs(a.wheelDeltaX) < p.abs(a.wheelDelta) ||
                        p.abs(a.deltaX) < p.abs(a.deltaY) ||
                        !e;
        ...
        function z(a, b, g) {
            requestAnimFrame(function () {
                ...
                if ("undefined" !== typeof f) {
                    var e = a.hasClass("fp-auto-height")
                            ? f.top - q + a.height()
                            : f.top,
                        f = {
                            element: a,
                            ...
                            leavingSection:
                                c(".fp-section.active").index(".fp-section") +
                                1,
                            localIsResizing: v,
                        };
                    if (
                        !(
                            (f.activeSection.is(a) && !v) ||
                            (d.scrollBar &&
                                n.scrollTop() === f.dtop &&
                        ...
                        if (f.activeSlide.length)
                            var h = f.activeSlide.data("anchor"),
                                k = f.activeSlide.index();
                        d.autoScrolling &&
                            d.continuousVertical &&
                            "undefined" !== typeof f.isMovementUp &&
                            ((!f.isMovementUp && "up" == f.yMovement) ||
                                (f.isMovementUp && "down" == f.yMovement)) &&
                            (f.isMovementUp
                                ? c(".fp-section.active").before(
                                      f.activeSection.nextAll(".fp-section")
                                  )
                            ...
                            H(c(".fp-section.active").position().top),
                            wa(),
                            (f.wrapAroundElements = f.activeSection),
                            (f.dest = f.element.position()),
                            (f.dtop = f.dest.top),
        ...
        function Wa(a) {
            if (d.css3 && d.autoScrolling && !d.scrollBar)
                xa("translate3d(0px, -" + a.dtop + "px, 0px)", !0),
                    d.scrollingSpeed
        ...
        function J(a) {
            ...
            b.length && (a = c(b));
            a.find("img[data-src], source[data-src], audio[data-src]").each(
                function () {
        ...
        function G(a, b) {
            ...
            if (d.onSlideLeave) {
                ...
                if (
                    ...
                    !1 === d.onSlideLeave.call(q, k, h + 1, r, t, f)
                ) {
                    w = !1;
                    return;
                }
            ...
            !d.loopHorizontal &&
                d.controlArrows &&
                (e.find(".fp-controlArrow.fp-prev").toggle(0 !== f),
                e
                    .find(".fp-controlArrow.fp-next")
                    .toggle(!b.is(":last-child")));
            ...
            d.css3
                ? ((g = "translate3d(-" + p.round(g.left) + "px, 0px, 0px)"),
                  za(a.find(".fp-slidesContainer"), 0 < d.scrollingSpeed).css(
                      Aa(g)
                  ),
                  (ga = setTimeout(
                      function () {
        ...
        function I(a) {
            ...
            var b = a.closest(".fp-section"),
                ...
                f;
            c.length
                ? (f = c.get(0).scrollHeight)
                : ((f = a.get(0).scrollHeight),
                  d.verticalCentered &&
                      (f = a.find(".fp-tableCell").get(0).scrollHeight));
            b =
                q -
        ...
        function la(a) {
            a.addClass("fp-table").wrapInner(
                '<div class="fp-tableCell" style="height:' + Da(a) + 'px;" />'
            );
        }
        function Da(a) {
            var b = q;
        ...
        function ka() {
            ...
            b.length && (a = a + "-" + f);
            a = a.replace("/", "-").replace("#", "");
            r[0].className = r[0].className.replace(
        ...
        function $a() {
            if (P || Q) {
                ...
                c(".fullpage-wrapper")
                    ...
                    .on("touchstart " + a.down, Ua);
                c(".fullpage-wrapper")
                    .off("touchmove " + a.move)
                    .on("touchmove " + a.move, Ta);
            }
        }
        function ab() {
            if (P || Q) {
        ...
        function bb() {
            ...
            h.find(".fp-tableCell, .fp-slidesContainer, .fp-slides").each(
                function () {
        ...
        e.setAutoScrolling = function (a, b) {
            ...
            d.autoScrolling && !d.scrollBar
                ? (x.css({ overflow: "hidden", height: "100%" }),
                  e.setRecordHistory(C.recordHistory, "internal"),
                  h.css({ "-ms-touch-action": "none", "touch-action": "none" }),
                  g.length && H(g.position().top))
                : (x.css({ overflow: "visible", height: "initial" }),
                  e.setRecordHistory(!1, "internal"),
                  h.css({ "-ms-touch-action": "", "touch-action": "" }),
                  H(0),
        ...
        e.setMouseWheelScrolling = function (a) {
            if (a) {
                ...
                k.addEventListener
                    ...
                    : ((b = "attachEvent"), (a = "on"));
                var c =
                    "onwheel" in m.createElement("div")
                        ? "wheel"
                        : m.onmousewheel !== D
                        ? "mousewheel"
                        : "DOMMouseScroll";
                if ("DOMMouseScroll" == c)
                    m[b](a + "MozMousePixelScroll", A, !1);
                else m[b](a + c, A, !1);
            } else
                m.addEventListener
                    ? (m.removeEventListener("mousewheel", A, !1),
                      m.removeEventListener("wheel", A, !1),
                      m.removeEventListener("MozMousePixelScroll", A, !1))
                    : m.detachEvent("onmousewheel", A);
        };
        e.setAllowScrolling = function (a, b) {
            "undefined" !== typeof b
                ...
                : a
                ? (e.setMouseWheelScrolling(!0), $a())
                : (e.setMouseWheelScrolling(!1), ab());
        };
        ...
        e.setResponsive = function (a) {
            ...
            a
                ? b ||
                  ...
                  c("#fp-nav").hide(),
                  h.addClass("fp-responsive"))
                : b &&
                  (e.setAutoScrolling(C.autoScrolling, "internal"),
                  e.setFitToSection(C.autoScrolling, "internal"),
                  c("#fp-nav").show(),
                  h.removeClass("fp-responsive"));
        };
        var w = !1,
            ...
            B = [],
            N,
            l = { m: { up: !0, down: !0, left: !0, right: !0 } };
        l.k = c.extend(!0, {}, l.m);
        var C = c.extend(!0, {}, d),
            ia,
            ca,
        ...
        t.keydown(function (a) {
            ...
            b.is("textarea") ||
                ...
                !d.keyboardScrolling ||
                !d.autoScrolling ||
                (-1 < c.inArray(a.which, [40, 38, 32, 33, 34]) &&
                    a.preventDefault(),
                (N = a.ctrlKey),
        ...
        d.normalScrollElements &&
            (t.on("mouseenter", d.normalScrollElements, function () {
