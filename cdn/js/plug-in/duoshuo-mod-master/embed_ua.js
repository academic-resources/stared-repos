...
(function (e, t, n) {
    function at(e, t) {
        for (var n in t)
            t[n] && (e[n] ? e[n].set(t[n]) : (e[n] = new et(t[n])));
    }
    function ft(e, t) {
    ...
    var r = e.location,
        ...
        m = function (e) {
            var n = this,
                ...
                f;
            t.selection &&
                ((o = t.selection.createRange()),
                o &&
                    o.parentElement() == n &&
                    ((a = n.value.length),
                    (s = n.value.replace(/\r\n/g, "\n")),
                    (u = n.createTextRange()),
                    u.moveToBookmark(o.getBookmark()),
                    (f = n.createTextRange()),
                    f.collapse(!1),
                    u.compareEndPoints("StartToEnd", f) > -1
                        ? (r = i = a)
                        : ((r = -u.moveStart("character", -a)),
                          (r += s.slice(0, r).split("\n").length - 1),
                          u.compareEndPoints("EndToEnd", f) > -1
                              ? (i = a)
                              : ((i = -u.moveEnd("character", -a)),
                                (i += s.slice(0, i).split("\n").length - 1))))),
                (v.start = r),
                (v.end = i);
        },
        ...
        w = (e.DUOSHUO = {
            ...
            loaded: {
                jQuery:
                    typeof jQuery != "undefined" && jQuery.fn.jquery >= "1.5",
                smilies: !1,
            ...
            parseDate: (function (e) {
                return (
                    (e.parse("2011-10-28T00:00:00+08:00") &&
                        function (t) {
                            return new e(t);
                        }) ||
                ...
                for (; s < i.length; s++) {
                    ...
                    if (u >= 0 && u + r.length == (a = o.indexOf("=") + 1))
                        return decodeURIComponent(
                            o.substring(a, o.length).replace(/\+/g, "")
                        );
                }
                return n;
            },
            ...
            ajax: function (e, t, r, o, u) {
                ...
                (r.v = w.version),
                    a
                        ? (r.jwt = a)
                        : z.remote_auth && (r.remote_auth = z.remote_auth);
                if (s && i && i.parse) {
                    var f = new s();
            ...
            compileStyle: function (e) {
                var t = "",
                    n = {
                        textbox:
                            "#ds-thread #ds-reset .ds-replybox .ds-textarea-wrapper",
                    };
        ...
        x = (w.support = (function () {
            ...
            var i = n.getElementsByTagName("a")[0],
                ...
                u = {
                    ...
                    iOS: f.match(
                        / \((iPad|iPhone|iPod);( U;)? CPU( iPhone)? OS /
                    ),
                    android: f.match(/ \(Linux; U; Android /),
                };
            return (
                (S = !s && typeof n.style.maxHeight == "undefined"),
                (u.authInWin =
                    e.postMessage &&
                    e.screen.width > 800 &&
                    !u.iOS &&
        ...
        L = function (e, t, n, r) {
            w.ajax("GET", e, t, n || function () {}, r);
        },
        A = function (e, t, n, r) {
            w.ajax("POST", e, t, n || function () {}, r);
        },
        O = [],
        M,
        _ = [],
        D = function (t) {
            ...
            _.push(i.stringify(t)),
                M ||
                    ((M = w.webSocket =
                        new WebSocket("ws://ws.duoshuo.com:8201/")),
                    (M.onopen = function () {
                        var e;
                        if (M.readyState === 1)
                    ...
                    (M.onmessage = function (e) {
                        ...
                        switch (r.type) {
                            case "post":
                                for (; t < w.pagelets.length; t++)
                                    (n = w.pagelets[t]),
                                        n.threadId == r.thread_id &&
                                            n.onMessage(r);
                                break;
                            case "notification":
                                O.push(r), lt();
        ...
        j = (w.openDialog = function (e) {
            return (
                w.dialog !== n && w.dialog.el.remove(),
                (w.dialog = new H.Dialog(
                    '<div class="ds-dialog"><div class="ds-dialog-inner ds-rounded"><div class="ds-dialog-body">' +
                        e +
        ...
        V = function () {
            return !z && (z = e.duoshuoQuery) && tt.trigger("queryDefined"), z;
        };
    for (var $ in Object.prototype)
        return alert(
            "Object.prototype\u4e0d\u4e3a\u7a7a\uff0c\u8bf7\u4e0d\u8981\u7ed9Object.prototype\u8bbe\u7f6e\u65b9\u6cd5"
        );
    var J = (w.templates = {
            userUrl: function (e) {
                return e.url;
            ...
            avatarImg: function (e, t) {
                return (
                    ...
                    p(e.name) +
                    '"' +
                    (t ? ' style="width:' + t + "px;height:" + t + 'px"' : "") +
                    "/>"
                );
            },
            avatar: function (e, t) {
            ...
            timeHtml: function (e, t) {
                return e
                    ? t
                        ? '<a href="' +
                          t +
                          '" target="_blank" rel="nofollow" class="ds-time" datetime="' +
                          e +
                          '" title="' +
                          w.fullTime(e) +
                          '">' +
            ...
            serviceIcon: function (e, t) {
                return (
                    '<a href="javascript:void(0)" class="ds-service-icon' +
                    (t ? "-grey" : "") +
                    " ds-" +
                    e +
                    '" data-service="' +
            ...
            loginButtons: function (e) {
                return (
                    '<div class="ds-login-buttons"><p>\u793e\u4ea4\u5e10\u53f7\u767b\u5f55:</p><div class="ds-social-links">' +
                    J.serviceList() +
            ...
            poweredBy: function (e) {
                return (
                    '<p class="ds-powered-by"><a href="http://duoshuo.com" target="_blank" rel="nofollow">' +
                    p(e) +
                    "</a></p>"
                );
            },
            ...
            serviceList: function (e) {
                ...
                return (
                    t +
                    '<li><a class="ds-more-services" href="javascript:void(0)">\u66f4\u591a\u00bb</a></li>' +
                    "</ul>"
                );
            },
            ...
            loginItem: function (e, t) {
                ...
                return (
                    '<li><a href="' +
                    n +
                    '" rel="nofollow" class="ds-service-link ds-' +
                    e +
                    '">' +
                    w.serviceNames[e] +
                    (rt.data.social_uid[e]
                        ? ' <span class="ds-icon ds-icon-ok"></span>'
                        : "") +
                    "</a>" +
                    "</li>"
                );
            ...
            loginUrl: function (e, t) {
                return (
                    ...
                    z.sso &&
                        z.sso.login &&
                        ((t.sso = 1), (t.redirect_uri = z.sso.login)),
            ...
            likePost: function (e) {
                return (
                    '<a class="ds-post-likes" href="javascript:void(0);"><span class="ds-icon ds-icon-like"></span>' +
                    k.like +
                    (e.likes > 0 ? "(" + e.likes + ")" : "") +
                    "</a>"
                );
            ...
            ctxPost: function (e, t, n) {
                ...
                return (
                    ...
                    '"><div class="ds-avatar">' +
                    J.avatar(r) +
                    '</div><div class="ds-ctx-body"><div class="ds-ctx-head">' +
                    J.userAnchor(r) +
                    J.timeHtml(e.created_at, e.url) +
                    (t >= 0
                        ? '<div class="ds-ctx-nth" title="' +
                          w.fullTime(e.created_at) +
                          '">' +
                          (t + 1) +
                          k.floor +
                          "</div>"
                        : "") +
                    '</div><div class="ds-ctx-content">' +
                    e.message +
                    (t >= 0
                        ? '\u3000\u3000\u3000\u3000\u3000\u3000\u3000<div class="ds-comment-actions' +
                          (e.vote > 0 ? " ds-post-liked" : "") +
                          '">' +
                          J.likePost(e) +
                          ' <a class="ds-post-repost" href="javascript:void(0);"><span class="ds-icon ds-icon-share"></span>' +
                          k.repost +
                          "</a>" +
                          ' <a class="ds-post-reply" href="javascript:void(0);"><span class="ds-icon ds-icon-reply"></span>' +
                          k.reply +
                          "</a>" +
                          "</div>"
                        : "") +
    ...
    tt.on("queryDefined", function () {
        ...
        if (o) {
            var t = o["ds_site_" + e],
                n = o["ds_lang_" + e];
            t && nt.reset(i.parse(t)), n && ft(k, i.parse(n));
        }
    }),
        V(),
        ...
        w.require("jQuery", function () {
            function dt(e, t, n) {
                if (e.find(".ds-post[data-post-id=" + t.post_id + "]")[0])
                    return;
                return (
                    e.find(".ds-post-placeholder").remove(),
                    i(J.post(t, n))
                        .hide()
                        [n.order == "asc" ? "appendTo" : "prependTo"](e)
                        .slideDown(function () {})
                );
            }
            function vt(e, t) {
                ...
                this.delegate("a.ds-post-likes", "click", function (e) {
                    ...
                    var t = i(this).parent();
                    return (
                        (liked = t.hasClass("ds-post-liked")),
                        (matches = i(this)
                            .html()
                            .match(/\((\d+)\)/)),
                        (likes =
                            (matches ? parseInt(matches[1]) : 0) +
                            (liked ? -1 : 1)),
                        A("/api/posts/vote", {
                            post_id: t
                                .closest(".ds-ctx-entry, .ds-post-self")
                                .attr("data-post-id"),
                            vote: liked ? 0 : 1,
                        }),
                        i(this).html(
                    ...
                    .delegate("a.ds-post-reply", "click", function (r) {
                        ...
                        if (o.hasClass("ds-reply-active"))
                            ...
                            n
                                ? n.actionsBar.removeClass("ds-reply-active")
                                : ((n = new H.Replybox(e)),
                                  n
                                      .render(!0)
                                      .el.addClass("ds-inline-replybox")
                                      .detach()),
                                n.el
                                    .find("[name=parent_id]")
                                    .val(u.attr("data-post-id")),
                                n.el
                                    .show()
                                    .appendTo(
                                        s.closest(
                                            ".ds-ctx-body, .ds-comment-body"
                                        )
                                    )
                                    .find("textarea")
                                    .focus(),
                                ...
                                t.max_depth <= 1
                                    ? (n.postList = e.postList.el)
                                    : ((n.postList =
                                          u.siblings(".ds-children")),
                                      n.postList[0] ||
                                          (n.postList = i(
                                              '<ul class="ds-children"></ul>'
                                          ).insertAfter(u)));
                        }
                        return !1;
                    })
                    ...
                    .delegate("a.ds-weibo-reposts", "click", function (t) {
                        ...
                        return w.repostDialog(u, a, e, s), !1;
                    })
                    ...
                    x.touch ||
                        this.delegate(
                            "a.ds-comment-context, .ds-avatar, .ds-user-name",
                            "mouseenter",
                            function (t) {
                                var n = this;
                                if (bubbleOutTimer && $.owner == n)
                                    ...
                                    Y = setTimeout(function () {
                                        ...
                                        try {
                                            if (
                                                r.hasClass("ds-comment-context")
                                            )
                                                G.attr("id", "ds-ctx-bubble")
                                                    .attr(
                                                        "data-post-id",
                                                        r.attr("data-post-id")
                                                    )
                                                    .html(
                                                        '<ul id="ds-ctx">' +
                                                            ...
                                                            "</ul>" +
                                                            '<div class="ds-bubble-footer"><a class="ds-ctx-open" href="javascript:void(0);">\u67e5\u770b\u5bf9\u8bdd</a></div>'
                                                    );
                                            else if (
                                                r.hasClass("ds-avatar") ||
                                                r.hasClass("ds-user-name")
                                            ) {
                                                var a = {},
                                                    f = (a.user_id =
                                                        r.attr("data-user-id"));
                                                if (!f) throw "no info";
                                                G.attr("id", "ds-user-card")
                                                    .attr("data-user-id", f)
                                                    .empty(),
                                                    ut[f]
                                                        ? G.html(
            ...
            function bt(e) {
                var n = {
                    require:
                        "site,visitor,nonce,serverTime,lang" +
                        (yt++ ? "" : ",unread,log,extraCss"),
                ...
                for (var r in n)
                    n[r] &&
                        (!S || encodeURIComponent(n[r]).length < 200) &&
                        (e[r] = n[r]);
                return e;
            }
            var i = w.jQuery,
                ...
                l = (w.loadRequire = function (e) {
                    e.serverTime &&
                        (c = new Date().getTime() - e.serverTime * 1e3),
                        e.visitor &&
                            (!rt.data &&
                                e.visitor.user_id &&
                                u &&
                        ...
                        e.lang &&
                            (ft(k, e.lang),
                            ht(
                                "ds_lang_" + z.short_name,
                                e.lang,
                                e.serverTime
                            ));
                    if (e.stylesheets)
                        for (var t = 0; t < e.stylesheets.length; t++)
                            w.injectStylesheet(e.stylesheets[t]);
                    e.nonce && (w.nonce = e.nonce),
                        e.style &&
                            w.setCustomStyle(
                                (e.style || "") +
                                    w.compileStyle(z.component_style)
                            ),
                ...
                O = function (t, n) {
                    ...
                    return e.open(
                        ...
                        "width=" +
                            ...
                            ",height=" +
                            i[1] +
                            ",toolbar=no,menubar=no,location=yes"
                    );
                },
                M = function (e, t) {
                    x.authInWin &&
                        e.find(t || "a.ds-service-link").click(function (e) {
            ...
            if (e.postMessage) {
                ...
                e.addEventListener
                    ...
                    : e.attachEvent && e.attachEvent("onmessage", F);
            }
            (w.scrollTo = function (e) {
                var t = e.offset().top;
                (t < s.scrollTop() || t > s.scrollTop() + s.height()) &&
                    i("html, body").animate(
                        {
                            scrollTop: t - 40,
                        },
            ...
            var R = (w.Widget = Z.extend({
                    ...
                    onload: function (e) {
                        this.el.html(
                            J[this.tmpl].call(
                                J,
                                e.response,
                                i.extend(this.options, e.options)
                            )
                        );
                    },
                    onMessage: function () {},
                ...
                U = function (e) {
                    var t = {
                            "unread-comments": {
                                ...
                                tmpl: function (e) {
                                    return (
                                        ...
                                        '">' +
                                        i
                                            .map(e.authors, J.userAnchor)
                                            .join("\u3001") +
                                        ' \u5728 <a class="ds-read" href="' +
                                        e.thread.url +
                        ...
                        n = j(
                            "<h2>" +
                                t.title +
                                "</h2>" +
                                '<ul class="ds-unread-list"></ul>'
                        );
                    n.on("close", w.resetNotify);
                    var r = n.el
                        .find(".ds-unread-list")
                        .delegate(".ds-delete", "click", function (e) {
                            return (
                    ...
                    i("#ds-notify").hide(),
                        L(t.apiUrl, {}, function (e) {
                            n.el
                                .find(".ds-unread-list")
                                .html(i.map(e.response, t.tmpl).join("\n"));
                        }),
            ...
            (w.resetNotify = function () {
                ...
                e[0] ||
                    (e = i('<div id="ds-notify"></div>')
                        .css(
                            ...
                            }[nt.data.notify_position]
                        )
                        .delegate(".ds-notify-unread a", "click", function (e) {
                            return U(i(this).data("type")), !1;
                        })
                        .appendTo(t.body)),
                    e
                        .html(
                            '<div id="ds-reset"><a class="ds-logo" href="http://duoshuo.com/" target="_blank" title="\u591a\u8bf4"></a><ul class="ds-notify-unread"><li' +
                                (n.comments ? "" : ' style="display:none;"') +
                                '><a data-type="unread-comments" href="javascript:void(0);">\u4f60\u6709' +
                                n.comments +
                                "\u6761\u65b0\u56de\u590d</a></li><li" +
                                (n.notifications
                                    ? ""
                                    : ' style="display:none;"') +
                                '><a data-type="unread-notifications" href="javascript:void(0);">\u4f60\u6709' +
                                n.notifications +
                                "\u6761\u7cfb\u7edf\u6d88\u606f</a></li></ul></div>"
                        )
                        [
                            (n.comments || n.notifications) &&
                            nt.data.notify_position !== "hidden" &&
                            !i(".ds-dialog")[0]
                                ? "show"
                                : "hide"
                        ]();
                ...
                (J.replybox = function (e, t) {
                    ...
                    for (var a in r.repostOptions)
                        r.repostOptions[a] && (i.push(a), (o = 1)),
                            (s += J.serviceIcon(a, !r.repostOptions[a]));
                    return (
                        '<div class="ds-replybox"><a class="ds-avatar"' +
                        (ct()
                        ...
                        '<textarea name="message" title="Ctrl+Enter\u5feb\u6377\u63d0\u4ea4" placeholder="' +
                        p(k.leave_a_message) +
                        '"></textarea>' +
                        ...
                        '<span class="ds-sync">' +
                        (!ct() && s
                            ? '<input id="ds-sync-checkbox' +
                              (t ? "-inline" : "") +
                              '" type="checkbox" name="repost" ' +
                              (o ? 'checked="checked" ' : "") +
                              'value="' +
                              i.join(",") +
                              '"> <label for="ds-sync-checkbox' +
                              (t ? "-inline" : "") +
                              '">' +
                              k.share_to +
                              "</label>" +
                        ...
                        "</span>" +
                        "</div>" +
                        '<button class="ds-post-button" type="submit">' +
                        p(k.post) +
                        "</button>" +
                        ...
                        (n.use_smilies
                            ...
                            : "") +
                        (n.use_images && n.parse_html_enabled
                ...
                (H.Replybox.prototype = {
                    render: function (e) {
                        function T(e) {
                            e.data("submitting", !0),
                                (e
                                    .find(".ds-post-button")
                                    .addClass("ds-waiting")
                                    .html(k.posting)[0].disabled = !0);
                        }
                        function N(e) {
                            e.data("submitting", !1),
                                (e
                                    .find(".ds-post-button")
                                    .removeClass("ds-waiting")
                                    .html(k.post)[0].disabled = !1);
                        }
                        var n = this,
                            r = n.embedThread,
                            s = r.options,
                            u = function (e) {
                                w.require("smilies", function () {});
                            },
                            ...
                            h = B(f.find("textarea"))
                                ...
                                .keyup(g)
                                .keyup(y)
                                .bind("focus mousedown mouseup keyup", m),
                            d = a.find(".ds-add-emote").click(function (e) {
                                var r = w.smiliesTooltip;
                                return (
                                    d
                                        .toggleClass("ds-expanded")
                                        .hasClass("ds-expanded")
                                        ? (r ||
                                              ((r = w.smiliesTooltip =
                                                  new H.SmiliesTooltip()),
                                              r.render(),
                                              w.require("smilies", function () {
                                                  r.reset(
                                                      "\u5fae\u535a-\u9ed8\u8ba4"
                            ...
                            b = a.find(".ds-add-image").click(function (e) {
                                ...
                                if (t.selection) {
                                    (n.value =
                                        r.substring(0, v.start) +
                                        s +
                                        r.substring(v.end, r.length)),
                                    ...
                                    n.value =
                                        r.substring(0, n.selectionStart) +
                                        s +
                                        r.substring(n.selectionEnd);
                            ...
                            S = function (e, t) {
                                var n = j(
                                        '<h2>\u793e\u4ea4\u5e10\u53f7\u767b\u5f55</h2><div class="ds-icons-32">' +
                                            i
                                                .map(
                                                    [
                                                        "weibo",
                                            ...
                                            (s.deny_anonymous
                                                ...
                                                : '<h2>\u4f5c\u4e3a\u6e38\u5ba2\u7559\u8a00</h2><form><div class="ds-control-group"><input type="text" name="author_name" id="ds-dialog-name" value="' +
                                                  p(rt.data.name) +
                                                  '" required />' +
                                                  '<label for="ds-dialog-name">\u540d\u5b57(\u5fc5\u586b)</label>' +
                                                  "</div>" +
                                                  (s.require_guest_email
                                                      ? '<div class="ds-control-group"><input type="email" name="author_email" id="ds-dialog-email" value="' +
                                                        p(rt.data.email) +
                                                        '" required />' +
                                                        '<label for="ds-dialog-email">\u90ae\u7bb1(\u5fc5\u586b)</label>' +
                                                        "</div>"
                                                      : "") +
                                                  (s.require_guest_url
                                ...
                                if (!s.deny_anonymous) {
                                    ...
                                    o.submit(function (e) {
                                        var r = o
                                            .find("input[name=author_email]")
                                            .val();
                                        return (r || s.require_guest_email) &&
                                            !r.match(
                                            ...
                                            ? (alert(
                                              ...
                                              !1)
                                            : (t(w.toJSON(o)), n.close(), !1);
                                    }),
                                        o
                                            .find("input[name=author_name]")[0]
                                            .focus();
                                }
                            };
                        s.deny_anonymous &&
                                ...
                                A(
                                    ...
                                    function (e) {
                                        ...
                                        (s.order == "asc") ==
                                            ...
                                            h.val("").trigger("keyup"),
                                            N(f),
                                            a.hasClass("ds-inline-replybox") &&
                                                (a.detach(),
                                                n.actionsBar.removeClass(
                                                    "ds-reply-active"
                                                ));
                                        if (o)
                                            try {
                                                o.removeItem(
                                                    "ds_draft_" + r.threadId
                                                );
                                            } catch (u) {}
                                    },
                                    function (e) {
                                        N(f), alert(e.errorMessage);
                                    }
                                );
                        };
                        f.submit(function (e) {
                            ...
                            return t == "" ||
                                (!x.placeholder && t == h.attr("placeholder"))
                                ? (alert(
                                      "\u60a8\u8fd8\u6ca1\u5199\u5185\u5bb9\u5462"
                                  ),
                                  !1)
                        ...
                        var L = function (e) {
                            return i(e).hasClass("ds-service-icon-grey")
                                ? null
                        ...
                        return (
                            c.click(function () {
                                return (
                                    i(this)
                                        .toggleClass("ds-service-icon-grey")
                                        .toggleClass("ds-service-icon"),
                ...
                (H.Dialog = Z.extend({
                    init: function (e, t) {
                        (this.el = i("#ds-wrapper"))[0] ||
                            (this.el = _(i('<div id="ds-wrapper"></div>'))),
                            ...
                            e !== n &&
                                i(e).attr("id", "ds-reset").appendTo(this.el);
                    },
                    open: function () {
                        var e = this;
                        e.el.hide().appendTo(t.body).fadeIn(200),
                            ...
                            e.el
                                ...
                                .click(h);
                        var n = function (t) {
                                if (t.which == 27) return e.close(), !1;
                            },
                            r = function (t) {
                                return e.close(), !1;
                            };
                ...
                (J.likeTooltip = function (e) {
                    ...
                    return (
                        '<div class="ds-like-tooltip ds-rounded"><p>\u5f88\u9ad8\u5174\u4f60\u80fd\u559c\u6b22\uff0c\u5206\u4eab\u4e00\u4e0b\u5427\uff1a</p><ul>' +
                        n.slice(0, i).join("") +
                        "</ul><ul>" +
                        n.slice(i).join("") +
                        '</ul><p class="ds-like-tooltip-footer"><a class="ds-like-tooltip-close">\u7b97\u4e86</a></p></div>'
                    );
                }),
                (H.Meta = function (e) {
                    this.embedThread = e;
                ...
                (H.Meta.prototype = {
                    render: function () {
                        var r = this,
                            ...
                            o = s.data,
                            u = (r.el = i(
                                '<div class="ds-meta"><a href="javascript:void(0)" class="ds-like-thread-button ds-rounded' +
                                    (o.user_vote > 0
                                        ? " ds-thread-liked"
                                        : "") +
                        ...
                        return r.resetLikePanel(), ct() && u.hide(), r;
                    },
                    resetLikePanel: function () {
                        this.el
                            .find(".ds-like-panel")
                            .html(J.likePanel(this.embedThread.data));
                    },
                }),
                (J.postListHead = function (e) {
                    var t = e.data,
                        n = e.options;
                    return (
                        '<div class="ds-comments-info"><div class="ds-sort"><a class="ds-order-desc">' +
                        k.latest +
                        '</a><a class="ds-order-asc">' +
                        k.earliest +
                        '</a><a class="ds-order-hot">' +
                        k.hottest +
                        '</a></div><ul class="ds-comments-tabs"><li class="ds-tab"><a class="ds-comments-tab-duoshuo ds-current" href="javascript:void(0);"></a></li>' +
                        (n.show_reposts && t.reposts
                            ? '<li class="ds-tab"><a class="ds-comments-tab-repost" href="javascript:void(0);"></a></li>'
                            : "") +
                        (n.show_weibo && t.weibo_reposts
                            ? '<li class="ds-tab"><a class="ds-comments-tab-weibo" href="javascript:void(0);"></a></li>'
                            : "") +
                        (n.show_qqt && t.qqt_reposts
                            ? '<li class="ds-tab"><a class="ds-comments-tab-qqt" href="javascript:void(0);"></a></li>'
                            : "") +
                        "</ul>" +
                        "</div>"
                    );
                ...
                (H.PostListHead.prototype = {
                    render: function () {
                        var e = this.embedThread,
                            ...
                            s = r
                                .find("ul.ds-comments-tabs")
                                .delegate(".ds-tab a", "click", function (t) {
                                    s
                                        .find("a.ds-current")
                                        .removeClass("ds-current"),
                                        (n.params.page = 1);
                ...
                (H.Paginator = function (e) {
                    ...
                    var t = this,
                        n = (t.el =
                            e.el || i('<div class="ds-paginator"></div>')),
                        r = (t.collection = e.collection);
                    n.delegate("a", "click", function (e) {
                        return (
                            (r.params.page = parseInt(this.innerHTML)),
                            r.refetch(),
                ...
                (H.Paginator.prototype = {
                    reset: function (e) {
                        ...
                        r.push(
                            '<a data-page="' +
                                t +
                                '" href="javascript:void(0);" class="ds-current">' +
                                t +
                                "</a>"
                        );
                        if (t < e.pages) {
                            for (n = t + 1; n <= t + 4 && n < e.pages; n++)
                                i(n);
                            n < e.pages &&
                                r.push('<span class="page-break">...</span>'),
                                i(e.pages);
                        }
                        this.el
                            .html('<div class="ds-border"></div>' + r.join(" "))
                            [e.pages > 1 ? "show" : "hide"]();
                    },
                }),
                (J.smiliesTooltip = function (e) {
                    var t =
                        '<div id="ds-smilies-tooltip"><ul class="ds-smilies-tabs">';
                    for (var n in e) t += "<li><a>" + n + "</a></li>";
                    return (
                        t +
                        '</ul><div class="ds-smilies-container"></div></div>'
                    );
                }),
                ...
                (H.SmiliesTooltip.prototype = {
                    render: function () {
                        ...
                        return (
                            ...
                            n
                                .find(".ds-smilies-container")
                                .delegate("img", "click", function (n) {
                                    var r = e.replybox,
                                        i = r.el.find("textarea")[0],
                                        s = i.value;
                                    if (t.selection) {
                                        (i.value =
                                            s.substring(0, v.start) +
                                            this.title +
                                            s.substring(v.end, s.length)),
                                        ...
                                        var u =
                                            ...
                                            this.title.length;
                                        (i.value =
                                            s.substring(0, i.selectionStart) +
                                            this.title +
                                            s.substring(i.selectionEnd)),
                ...
                (J.postPlaceholder = function () {
                    return (
                        '<li class="ds-post ds-post-placeholder">' +
                        k.no_comments_yet +
                        "</li>"
                    );
                }),
                (J.post = function (e, t) {
                    ...
                    switch (e.source) {
                        case "duoshuo":
                            o +=
                                ...
                                k.repost +
                                "</a>" +
                                '<a class="ds-post-report" href="javascript:void(0);"><span class="ds-icon ds-icon-report"></span>' +
                                k.report +
                                "</a>" +
                                (e.privileges["delete"]
                                    ? '<a class="ds-post-delete" href="javascript:void(0);"><span class="ds-icon ds-icon-delete"></span>' +
                                      k["delete"] +
                                      "</a>"
                                    : "");
                            break;
                        ...
                        case "weibo":
                            o +=
                                '<a class="ds-weibo-comments" href="javascript:void(0);">' +
                                k.comments +
                                (e.type.match(/\-comment$/)
                                    ? ""
                                    : '(<span class="ds-count">' +
                                      e.comments +
                                      "</span>)") +
                                "</a>" +
                                '<a class="ds-weibo-reposts" href="javascript:void(0);">' +
                                k.reposts +
                                (e.type.match(/\-comment$/)
                                    ? ""
                                    : '(<span class="ds-count">' +
                    ...
                    return (
                        ...
                        ">" +
                        J.avatar(n) +
                        (w.sourceName[e.source]
                            ? J.serviceIcon(e.source)
                            : "") +
                        '</div><div class="ds-comment-body"><div class="ds-comment-header">' +
                        (n.url
                        ...
                        show_ua(e.agent) +
                        "</div>" +
                        (t.max_depth == 1 && t.show_context && u.length
                            ? '<ol id="ds-ctx">' +
                              i
                                  .map(u, function (e, t) {
                                      return (
                                          (t == 1 && u.length > 2
                                              ? '<li class="ds-ctx-entry"><a href="javascript:void(0);" class="ds-expand">\u8fd8\u6709' +
                                                (u.length - 2) +
                                                "\u6761\u8bc4\u8bba</a></li>"
                                              : "") +
                                          (ot[e]
                            ...
                            : "") +
                        "<p>" +
                        (u.length >= t.max_depth &&
                        (!t.show_context || t.max_depth > 1) &&
                        e.parent_id &&
                        ot[e.parent_id]
                            ? '<a class="ds-comment-context" data-post-id="' +
                              e.post_id +
                              '" data-parent-id="' +
                              e.parent_id +
                              '">' +
                              k.reply_to +
                              p(K(ot[e.parent_id].data).name) +
                              ": </a>"
                            : "") +
                        e.message +
                        '</p><div class="ds-comment-footer ds-comment-actions' +
                        (e.vote > 0 ? " ds-post-liked" : "") +
                        '">' +
                        o +
                        "</div></div></div>" +
                        (t.max_depth > 1 &&
                        (e.childrenArray || e.children) &&
                        e.source != "weibo" &&
                        e.source != "qqt"
            ...
            var $ = i(
                ...
                G = $.find(".ds-bubble-content").delegate(
                    "a.ds-ctx-open",
                    "click",
                    function (e) {
                        L(
                            ...
                            function (e) {
                                t.el
                                    .find("ol")
                                    .html(
                                        i.map(e.response, J.ctxPost).join("\n")
                                    );
                            }
                        );
                        var t = j(
                            '<h2>\u67e5\u770b\u5bf9\u8bdd</h2><ol id="ds-ctx"></ol>'
                        );
                        return (
                            t.el.find(".ds-dialog").css("width", "600px"),
            ...
            (bubbleOut = function () {
                ...
                (J.userInfo = function (e) {
                    var t = [];
                    return (
                        i.each(e.social_uid, function (e, n) {
                            t.push(
                                '<a href="' +
                                    w.REMOTE +
                                    "/user-proxy/" +
                                    ...
                                    "/" +
                                    n +
                                    '/" target="_blank" class="ds-service-icon ds-' +
                                    e +
                                    '" title="' +
                                    w.sourceName[e] +
                                    '"></a>'
                        ...
                        '<a href="' +
                            p(e.url) +
                            '" class="ds-avatar" target="_blank">' +
                            J.avatarImg(e) +
                            '</a><a href="' +
                            p(e.url) +
                            '" class="ds-user-name ds-highlight" target="_blank">' +
                            p(e.name) +
                            "</a>" +
                            t.join("") +
                            '<p class="ds-user-card-meta"><a href="' +
                            w.REMOTE +
                            "/profile/" +
                            e.user_id +
                            '/" target="_blank"><span class="ds-highlight">' +
                            e.comments +
                            "</span>\u6761\u8bc4\u8bba</a></p>" +
                            (e.description
                                ? '<p class="ds-user-description">' +
                                  p(e.description) +
                                  "</p>"
                                : "")
                    );
                ...
                (w.repostDialog = function (e, t, n, r) {
                    var i = j(
                            '<h2>\u8f6c\u53d1\u5230\u5fae\u535a</h2><div class="ds-quote"><strong>@' +
                                p(K(e.data).name) +
                                "</strong>: " +
                                e.data.message +
                                "</div>" +
                                ...
                                (r
                                    ...
                                    : '<label><input type="checkbox" name="service[]" value="weibo"' +
                                      (rt.data.social_uid.weibo
                                          ? ' checked="checked"'
                                          : "") +
                                      ' /><span class="ds-service-icon ds-weibo"></span>\u65b0\u6d6a\u5fae\u535a</label>  ' +
                                      '<label><input type="checkbox" name="service[]" value="qqt"' +
                                      (rt.data.social_uid.qq
                                          ? ' checked="checked"'
                                          : "") +
                                      ' /><span class="ds-service-icon ds-qqt"></span>\u817e\u8baf\u5fae\u535a</label>') +
                                '<button type="submit">' +
                                k.repost +
                                "</button>" +
                                "</div>" +
                        ...
                        s = i.el.find("form").submit(function (e) {
                            return !r && !s.find("[type=checkbox]:checked")[0]
                                ? (alert(
                                      "\u8fd8\u6ca1\u6709\u9009\u53d1\u5e03\u5230\u54ea\u513f\u5462"
                                  ),
                                  !1)
                    ...
                    return (
                        s
                            .find(".ds-actions [type=checkbox]")
                            .change(function (e) {
                                var t = this.value;
                                if (
                                    this.checked &&
                                    !rt.data.social_uid[t == "qqt" ? "qq" : t]
                                ) {
                                    mt(t);
                                    return;
                                }
                ...
                (J.toolbar = function (e) {
                    ...
                    return (
                        ...
                        (rt.data.url
                            ? '<a class="ds-visitor-name" href="' +
                              p(rt.data.url) +
                              '" target="_blank">' +
                              p(rt.data.name) +
                              "</a>"
                            : '<span class="ds-visitor-name">' +
                              p(rt.data.name) +
                              "</span>") +
                        '<a class="ds-unread-comments-count" href="javascript:void(0);" title="\u65b0\u56de\u590d"></a>' +
                        "</div>" +
                        "</div>"
                    );
                }),
                (H.EmbedThread = R.extend({
                    ...
                    params:
                        "thread-id local-thread-id source-thread-id thread-key category channel-key author-key author-id url limit order max-depth form-position container-url" +
                        (f.match(/MSIE 6\.0/) ? "" : " title image thumbnail"),
                    render: function () {
                        var e = this.el
                                .attr("id", "ds-thread")
                                .append(J.waitingImg()),
                            ...
                            n =
                                e.data("url") ||
                                (!e.attr("data-thread-id") &&
                                    i("link[rel=canonical]").attr("href"));
                        n
                            ? e.data("url", d(n))
                            : e.data("container-url", r.href),
                            t &&
                                t <= 400 &&
                                e.addClass("ds-narrow").data("max-depth", 1);
                    },
                    updateCounter: function (e) {
                        ...
                        for (var n in t)
                            if (!e || e == n) {
                                ...
                                this.el
                                    .find(".ds-comments-tab-" + n)
                                    .html(
                                        this.el.hasClass("ds-narrow")
                                            ? '<span class="ds-service-icon ds-' +
                                                  n +
                                                  '"></span>' +
                                                  r
                                            : (r
                    ...
                    onload: function (t) {
                        var r = this,
                            ...
                            f = (r.innerEl = _(
                                i('<div id="ds-reset"></div>').appendTo(r.el)
                            ));
                        (r.data = t.thread),
                            at(ot, t.parentPosts || t.relatedPosts),
                            at(ut, t.users),
                            ...
                            a.like_thread_enabled &&
                                ((r.meta = new H.Meta(r)),
                                r.meta.render().el.appendTo(f)),
                            a.hot_posts &&
                                t.hotPosts &&
                                t.hotPosts.length &&
                                ((r.hotPosts = new H.HotPosts(
                                    i('<div class="ds-rounded"></div>'),
                                    {
                                        max_depth: 1,
                        ...
                        if (ct()) {
                            var p = i(J.loginButtons()).delegate(
                                "a.ds-more-services",
                                "click",
                                function () {
                                    return (
                                        p
                                            .find(".ds-additional-services")
                                            .toggle(),
                                        !1
                                    );
                                }
                            ...
                            r.toolbar = i(J.toolbar())
                                ...
                                .delegate(
                                    ...
                                    function () {
                                        var e = j(
                                            "<h2>\u7ed1\u5b9a\u66f4\u591a\u5e10\u53f7</h2>" +
                                                J.serviceList(1) +
                                                J.additionalServices(1) +
                                                '<div style="clear:both"></div>'
                                        )
                                            .el.find(".ds-dialog")
                                            .addClass("ds-dialog-bind-more")
                                            .css("width", "300px");
                                        return M(e), !1;
                                    }
                                )
                                .delegate(
                                    ...
                                    "click",
                                    function (e) {
                                        return U("unread-comments"), !1;
                                    }
                                );
                        r.postListHead
                            .render()
                            .el.appendTo(f)
                            [a.formPosition == "top" ? "before" : "after"](
                                '<a name="respond"></a>',
                                r.toolbar || p,
                                l.el
                            )
                            .after(r.postList.el, r.paginator.el),
                            r.updateCounter(),
                            t.alerts &&
                                i.each(t.alerts, function (e, t) {
                                    i(
                                        '<div class="ds-alert">' + t + "</div>"
                                    ).insertBefore(r.toolbar || p);
                                }),
                            a.message && c.val(a.message).focus(),
                            i(J.poweredBy(a.poweredby_text)).appendTo(f),
                            it.on("reset", function () {
                                var e = it.data.comments || 0;
                                f.find("a.ds-unread-comments-count")
                                    .html(e)
                                    .attr(
                                        "title",
                                        e
                                    ...
                                    .css("display", e ? "inline" : "none");
                            }),
                            a.mzadx_id &&
                                (w.require("mzadxN", function () {}),
                                i(
                                    '<div id="MZADX_' +
                                        a.mzadx_id +
                ...
                (J.hotPosts = function (e, t) {
                    return (
                        '<div class="ds-header ds-gradient-bg">' +
                        k.hot_posts_title +
                        "</div><ul>" +
                        i
                            .map(e, function (e) {
                ...
                (J.commentList = function (e, t) {
                    return i
                        .map(e, function (e) {
                            ...
                            return (
                                '<li class="ds-comment' +
                                (t.show_avatars ? " ds-show-avatars" : "") +
                                '" data-post-id="' +
                                e.post_id +
                                '">' +
                                (t.show_avatars
                                    ? '<div class="ds-avatar">' +
                                      J.avatar(n, t.avatar_size) +
                                      "</div>"
                                    : "") +
                                '<div class="ds-meta">' +
                                J.userAnchor(n) +
                                (t.show_time ? J.timeHtml(e.created_at) : "") +
                                "</div>" +
                                (t.show_title
                                    ? '<div class="ds-thread-title">\u5728 <a href="' +
                                      p(e.thread.url + "#comments") +
                                      '">' +
                                      p(e.thread.title) +
                                      '</a> \u4e2d\u8bc4\u8bba</div><div class="ds-excerpt">' +
                                      e.message +
                                      "</div>"
                                    : '<a class="ds-excerpt" title="' +
                                      p(e.thread.title) +
                                      ' \u4e2d\u7684\u8bc4\u8bba" href="' +
                                      p(e.thread.url + "#comments") +
                                      '">' +
                ...
                (H.RecentVisitors = R.extend({
                    ...
                    render: function () {
                        this.el.children().detach(),
                            this.el
                                .attr("id", "ds-recent-visitors")
                                .append((this.waitingEl = i(J.waitingImg())));
                    },
                })),
                ...
                (H.ThreadCount = R.extend({
                    onload: function (e) {
                        var t = this.el,
                            ...
                            r = e.data[n];
                        t[t.data("replace") ? "replaceWith" : "html"](
                            k[
                                n +
                                    "_" +
                                    (r ? (r > 1 ? "multiple" : "one") : "zero")
                            ].replace("{num}", r)
                        );
                    },
                }));
                ...
                V() &&
                    ...
                    i(e).each(function (e, r) {
                        ...
                        if (t.type === "ThreadCount") {
                            ...
                            s.attr("data-channel-key") &&
                                (u = s.attr("data-channel-key") + ":" + u),
                                n.push(u),
                                st[u] || (st[u] = new et({})),
                                st[u].on("reset", function () {
                                    o.onload(this);
                                });
                        } else if (o.uri) {
                            var a = {};
                            i.each(o.params.split(" "), function (e, t) {
                                a[t.replace(/-/g, "_")] =
                                    s.attr("data-" + t) || s.data(t);
                            }),
                                L(o.uri, bt(a), function (e) {
                                    o.load(e);
                                });
                        }
                    }),
                    n.length &&
                        L(
                            ...
                            function (e) {
                                l(e), ft(k, e.options), at(st, e.response);
                            }
                        );
            }),
                (w.initView = function () {
