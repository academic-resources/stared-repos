...
(ruler.prototype.builder = function () {
    var a,
        ...
        o = function (c, g, j, k, l) {
            var m,
                n = function (c, d, e) {
                    ...
                    if (!c.assigned())
                        return void (f > a.rulerHeight && c.assigned(!0));
                    f < a.rulerHeight &&
                        (h.some(function (a, b) {
        ...
        p = function (d, e) {
            ...
            ruler.prototype.utils.addClasss(j, [
                "rul_ruler",
                i,
                "rul_align_" + e,
            ]),
        ...
        q = (function () {
            function b(b, c) {
                ...
                return (
                    ...
                    (d.style.width = ruler.prototype.utils.pixelize(
                        a.rulerHeight + 1
                    )),
                    (d.style.height = ruler.prototype.utils.pixelize(
                        a.rulerHeight
                    )),
                    b.appendChild(d)
                );
        ...
        y = function (b) {
            ...
            d.length > 0 &&
                ((d[0].style.display = c), (d[1].style.display = c));
        };
    return {
        VERTICAL: b,
        HORIZONTAL: c,
        ...
        getGuides: function () {
            return h.map(function (b) {
                return {
                    posX: Math.round(
                        (parseInt(b.line.guideLine.style.left) -
                            d -
                            a.rulerHeight) *
                            f
                    ),
                    posY: Math.round(
                        (parseInt(b.line.guideLine.style.top) -
                            e -
                            a.rulerHeight) *
                            f
                    ),
    ...
    (ruler.prototype.guideLine = function (a, b, c, d, e, f, g) {
        var h,
            ...
            r = (function () {
                return {
                    ...
                    startMoving: function (a) {
                        ruler.prototype.utils.addClasss(i, [
                            "rul_line_dragged",
                        ]),
                            (a = a || window.event);
                        var b = a ? a.clientX : 0,
                    ...
                    stopMoving: function () {
                        (d.container.style.cursor = null),
                            ...
                            u(),
                            ruler.prototype.utils.removeClasss(i, [
                                "rul_line_dragged",
                            ]);
                    },
                };
            ...
            s = function (a) {
                d.enableToolTip &&
                    ruler.prototype.utils.addClasss(i, "rul_tooltip");
            },
            t = function (a, b) {
                i.dataset.tip = b
                    ? "Y: " +
                      Math.round((b - d.rulerHeight - 1 - l) * j) +
                      " px"
                    : "X: " +
                      Math.round((a - d.rulerHeight - 1 - l) * j) +
                      " px";
            },
            u = function (a) {
