!(function t(e, r) {
    ...
    return (function (t) {
        function e(i) {
            ...
            return (
                t[i].call(n.exports, n, n.exports, e),
                (n.loaded = !0),
                n.exports
            );
        }
            ...
            (i = [r(2)]),
                (n = function (t) {
                    function e(r) {
                        ...
                        if (e.is(r, Q))
                            return e._engine.create[z](
                                e,
                                r.splice(0, 3 + e.is(r[0], $))
                            ).add(r);
                    ...
                    function p(t, r, i) {
                        ...
                        for (
                            ...
                            var x = e.findDotsAtSegment.apply(
                                e,
                                t.concat(v / h)
                            );
                    ...
                    var w,
                        ...
                        F =
                            ...
                            (T.win.DocumentTouch &&
                                T.doc instanceof DocumentTouch),
                        R = "",
                        j = " ",
                        I = String,
                        q = "split",
                    ...
                    (e.getRGB = n(function (t) {
                        ...
                        !(
                            vt[A](t.toLowerCase().substring(0, 2)) ||
                            "#" == t.charAt()
                        ) && (t = Pt(t));
                        var r,
                            i,
                        ...
                        (e.getColor = function (t) {
                            var e = (this.getColor.start = this.getColor
                                    .start || { h: 0, s: 1, b: t || 0.75 }),
                            ...
                            ve = function (e) {
                                for (
                                    ...
                                    T.win.opera && p.removeChild(u),
                                        ...
                                        (c = s.el.paper.getElementByPoint(
                                            r,
                                            i
                                        )),
                                        (u.style.display = d),
                    ...
                    (ye.data = function (r, i) {
                        ...
                        if (1 == arguments.length) {
                            ...
                            return (
                                t("raphael.data.get." + this.id, this, n[r], r),
                                n[r]
                            );
                        }
                        return (
                    ...
                    (ye.drag = function (r, i, n, a, s, o) {
                        function l(l) {
                            ...
                            var h = l.clientX,
                                ...
                                f =
                                    ...
                                    T.doc.body.scrollLeft;
                            if (
                                ((this._drag.id = l.identifier), F && l.touches)
                            )
                        ...
                        (ye.undrag = function () {
                            ...
                            !be.length && e.unmousemove(ve).unmouseup(xe),
                                (ge = []);
                        }),
                        (N.circle = function (t, r, i) {
                            var n = e._engine.circle(
                                this,
                                t || 0,
                                r || 0,
                                i || 0
                        ...
                        (N.path = function (t) {
                            ...
                            var r = e._engine.path(
                                e.format[z](e, arguments),
                                this
                            );
                        ...
                        (N.setViewBox = function (t, r, i, n, a) {
                            return e._engine.setViewBox.call(
                                this,
                                t,
                                r,
                                i,
                    ...
                    (N.getElementByPoint = function (t, e) {
                        ...
                        for (
                            ;
                            n.parentNode && n != i.parentNode && !n.raphael;
                    ...
                    (ye.animateWith = function (t, r, i, n, a, s) {
                        ...
                        (ye.animate = function (t, r, i, n) {
                            ...
                            var s =
                                t instanceof m ? t : e.animation(t, r, i, n);
                    ...
                    return (
                        ...
                        (Pe.splice = function (t, e, r) {
                            ...
                            for (s = 0; s < o + i.length; s++)
                                this.items[t + s] = this[t + s] =
                                    s < o ? a[s] : i[s - o];
                            for (
                                s = this.items.length = this.length -= e - o;
                                this[s];
                        ...
                        (Pe.animate = function (t, r, i, n) {
                            ...
                            for (o = this.items[--s].animate(u); s--; )
                                this.items[s] &&
                                    ...
                                    (this.items[s] && !this.items[s].removed) ||
                                        a--;
                            return this;
                        }),
                        ...
                        (N.print = function (t, r, i, n, a, s, o, l) {
                            ...
                            var h = I(i)[q](R),
                                ...
                                p;
                            if (
                                (e.is(n, "string") && (n = this.getFont(n)), n)
                            ) {
                        ...
                        (N.add = function (t) {
                            if (e.is(t, "array"))
                                for (
                                    var r = this.set(), i = 0, n = t.length, a;
                                    i < n;
                                    i++
                                )
                                    (a = t[i] || {}),
                                        B[A](a.type) &&
                                            r.push(this[a.type]().attr(a));
                            return r;
                        }),
            ...
            !(function (r) {
                ...
                (eve = function (t, e) {
                    ...
                    for (var b = 0, _ = a.length; b < _; b++)
                        "zIndex" in a[b] &&
                            (h.push(a[b].zIndex),
                            a[b].zIndex < 0 && (u[a[b].zIndex] = a[b]));
                    for (h.sort(c); h[s] < 0; )
                        if (((l = u[h[s++]]), x.push(l.apply(e, n)), p))
                            return (p = i), x;
                    for (b = 0; b < _; b++)
                        ...
                        for (
                            ...
                            !(function (t) {
                                for (
                                    ...
                                    (i = i.n),
                                        (i =
                                            (i.hasOwnProperty(r[a]) &&
                                                i[r[a]]) ||
                                            (i[r[a]] = { n: {} }));
                                for (
                                    i.f = i.f || [], a = 0, s = i.f.length;
                                    a < s;
                                    a++
                                )
                                    if (i.f[a] == e) {
                    ...
                    if (!t || t.svg) {
                        ...
                        var v = function (i, n) {
                                if (n) {
                                    ...
                                    (i = t._g.doc.createElementNS(
                                        ...
                                        i.style &&
                                            (i.style.webkitTapHighlightColor =
                                                "rgba(0,0,0,0)");
                                return i;
                            },
                            x = function (e, n) {
                                ...
                                if ("path" == i.type) {
                                    ...
                                    if (
                                        ...
                                        i._.arrows
                                            ? a
                                                ? (i._.arrows.endPath &&
                                                      g[i._.arrows.endPath]--,
                                                  i._.arrows.endMarker &&
                                                      g[i._.arrows.endMarker]--)
                                                : (i._.arrows.startPath &&
                                                      g[i._.arrows.startPath]--,
                            ...
                            k = function (t, e, i) {
                                if ((e = w[r(e).toLowerCase()])) {
                                    ...
                                    v(t.node, { "stroke-dasharray": "none" });
                            },
                            B = function (i, a) {
                                var l = i.node,
                                    u = i.attrs,
                            ...
                            S = function (i, a) {
                                if (
                                    ...
                                    if (a[e]("text")) {
                                        ...
                                        for (
                                            u = o.getElementsByTagName("tspan"),
                                                p = 0,
                                                d = u.length;
                                            p < d;
                                            p++
                        ...
                        (T.prototype = E),
                            ...
                            (E.remove = function () {
                                ...
                                if (!this.removed && e.parentNode) {
                                    ...
                                    r.__set__ && r.__set__.exclude(this),
                                        ...
                                        this.gradient &&
                                            r.defs.removeChild(this.gradient),
                                        t._tear(this, r),
                            ...
                            (E.attr = function (r, i) {
                                ...
                                for (p in this.paper.customAttributes)
                                    if (
                                        ...
                                        f[e](p) &&
                                        t.is(
                                            this.paper.customAttributes[p],
                                            "function"
                                        )
                                    ) {
                                        var d = this.paper.customAttributes[
                                            p
                                        ].apply(this, [].concat(f[p]));
                                        this.attrs[p] = f[p];
                                        for (var g in d)
                                            d[e](g) && (f[g] = d[g]);
                                    }
                            ...
                            (E.toFront = function () {
                                ...
                                var r = this.paper;
                                return (
                                    r.top != this && t._tofront(this, r), this
                                );
                            }),
                            (E.toBack = function () {
                                if (this.removed) return this;
                            ...
                            (E.blur = function (e) {
                                ...
                                if (0 !== +e) {
                                    ...
                                    r._blur &&
                                        (r._blur.parentNode.removeChild(
                                            r._blur
                                        ),
                                        delete r._blur,
                                        delete r.attrs.blur),
                            ...
                            (t._engine.text = function (e, r, i, n) {
                                ...
                                return (
                                    (s.attrs = {
                                        ...
                                        text: n,
                                        "font-family":
                                            t._availableAttrs["font-family"],
                                        "font-size":
                                            t._availableAttrs["font-size"],
                                        stroke: "none",
                                        fill: "#000",
                                    }),
                                    (s.type = "text"),
                ...
                (n = function (t) {
                    if (!t || t.vml) {
                        ...
                        var S = function (t, e, i) {
                                ...
                                var u =
                                    t.node.getElementsByTagName("stroke")[0];
                                (u[a + "arrow"] = o),
                                    (u[a + "arrowlength"] = l),
                                    (u[a + "arrowwidth"] = h);
                            },
                            A = function (n, l) {
                                    ...
                                    l.font && (R.font = l.font),
                                        l["font-family"] &&
                                            (R.fontFamily =
                                                ...
                                                '"'),
                                        l["font-size"] &&
                                            (R.fontSize = l["font-size"]),
                                        l["font-weight"] &&
                                            (R.fontWeight = l["font-weight"]),
                                        l["font-style"] &&
                                ...
                                if ("text" == m.type) {
                                    ...
                                    (g = X.style),
                                        ...
                                        f["font-family"] &&
                                            (g.fontFamily = f["font-family"]),
                                        f["font-weight"] &&
                                            (g.fontWeight = f["font-weight"]),
                                        f["font-style"] &&
                                            (g.fontStyle = f["font-style"]),
                                        ($ =
                                            i(f["font-size"] || ($ && $[0])) ||
                                            10),
                                        (g.fontSize = $ * U + "px"),
                            ...
                            T = function (e, a, s) {
                                ...
                                if (((e = e.shape || e.node), v.length)) {
                                    ...
                                    for (
                                        var x = [], y = 0, m = v.length;
                                        y < m;
                                        y++
                                    )
                                        v[y].offset &&
                                            x.push(
                                                v[y].offset + p + v[y].color
                                            );
                                    (s.colors = x.length
                                        ? x.join()
                                        : "0% " + s.color),
                        ...
                        (E.prototype = M),
                            ...
                            (M.getBBox = function () {
                                ...
                                if (this.paper && this.paper._viewBoxShift) {
                                    ...
                                    return (
                                        (e.x =
                                            t.x - this.paper._viewBoxShift.dx),
                                        (e.x *= r),
                                        (e.y =
                                            t.y - this.paper._viewBoxShift.dy),
                                        (e.y *= r),
                                        (e.width = t.width * r),
                                        (e.height = t.height * r),
                                        (e.x2 = e.x + e.width),
                            ...
                            (M.remove = function () {
                                if (!this.removed && this.node.parentNode) {
                                    this.paper.__set__ &&
                                        ...
                                        this.shape &&
                                            this.shape.parentNode.removeChild(
                                                this.shape
                                            );
                                    for (var e in this)
                                        this[e] =
                                ...
                                if (p) {
                                    for (d in this.paper.customAttributes)
                                        if (
                                            ...
                                            p[e](d) &&
                                            t.is(
                                                this.paper.customAttributes[d],
                                                "function"
                                            )
                                        ) {
                                            var g = this.paper.customAttributes[
                                                d
                                            ].apply(this, [].concat(p[d]));
                                            this.attrs[d] = p[d];
                                            for (var v in g)
                                                g[e](v) && (p[v] = g[v]);
                                        }
                            ...
                            (M.toFront = function () {
                                return (
                                    !this.removed &&
                                        this.node.parentNode.appendChild(
                                            this.node
                                        ),
                                    this.paper &&
                                        this.paper.top != this &&
