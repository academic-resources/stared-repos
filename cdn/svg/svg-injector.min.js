...
!(function (t, e) {
    ...
    var n = "file:" === t.location.protocol,
        ...
        v = function (e, r) {
            if (void 0 !== a[e])
                a[e] instanceof SVGSVGElement ? r(f(a[e])) : p(e, r);
            else {
                if (!t.XMLHttpRequest)
                ...
                (i.onreadystatechange = function () {
                    if (4 === i.readyState) {
                        ...
                        if (i.responseXML instanceof Document)
                            a[e] = i.responseXML.documentElement;
        ...
        h = function (e, n, a, u) {
            ...
            if (!/\.svg/i.test(f))
                return void u(
                    "Attempted to inject a file with a non-svg extension: " + f
                );
            if (!i) {
                var p =
                    e.getAttribute("data-fallback") ||
                    e.getAttribute("data-png");
                return void (p
                    ? (e.setAttribute("src", p), u(null))
                    : a
                    ? (e.setAttribute(
                          "src",
                          a + "/" + f.split("/").pop().replace(".svg", ".png")
                      ),
                      u(null))
                    : u(
            ...
            -1 === s.indexOf(e) &&
                ...
                v(f, function (i) {
                    ...
                    Object.keys(w).forEach(function (t) {
                        (g = t),
                            (b = w[t]),
                            (m = i.querySelectorAll("defs " + g + "[id]"));
                    ...
                    for (
                        ...
                        (S = k[G].getAttribute("type")),
                            (S &&
                                ...
                                ((x = k[G].innerText || k[G].textContent),
                                j.push(x),
                                i.removeChild(k[G]));
                    if (
                        j.length > 0 &&
