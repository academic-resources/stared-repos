    ...
    function e(b, c) {
        [].forEach.call(b.getElementsByTagName("li"), function (a) {
            (c && b !== a.parentNode) ||
                ...
                a.addEventListener("click", g.bind(null, a)),
                f(a));
        });
    }
    function g(b, c) {
        for (var a = c.target; "LI" !== a.nodeName; ) a = a.parentNode;
        a === b && f(b);
    }
    function f(b) {
        ...
        0 < a.length &&
            b.classList.add("collapsibleList" + (c ? "Open" : "Closed"));
    }
    return {
        apply: function (b) {
            [].forEach.call(document.getElementsByTagName("ul"), function (c) {
                c.classList.contains("collapsibleList") &&
                    (e(c, !0),
                    b ||
                        [].forEach.call(
                            c.getElementsByTagName("ul"),
                            function (a) {
