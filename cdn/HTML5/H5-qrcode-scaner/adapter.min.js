            ...
            7: [
                function (e, t, r) {
                    ...
                    t.exports = function (e) {
                        var t = function (t) {
                            ...
                            if (
                                ...
                                switch (t.iceTransportPolicy) {
                                    case "all":
                                    case "relay":
                                        this.iceOptions.gatherPolicy =
                                            t.iceTransportPolicy;
                                }
                            (this.usingBundle =
                                t && "max-bundle" === t.bundlePolicy),
                                t &&
                                    t.iceServers &&
                                    (this.iceOptions.iceServers = i(
                                        t.iceServers,
                                        e
                                    )),
                                (this._config = t || {}),
                        ...
                        return (
                            (t.prototype._emitGatheringStateChange =
                                function () {
                                    var e = new Event(
                            ...
                            (t.prototype._emitBufferedCandidates = function () {
                                ...
                                this._localIceCandidatesBuffer.forEach(
                                    function (r) {
                                        if (
                                            r.candidate &&
                                            0 !==
                                                Object.keys(r.candidate).length
                                        )
                                            ...
                                            for (var n = 1; n < t.length; n++)
                                                -1 ===
                                                    ...
                                                    (t[n] +=
                                                        "a=end-of-candidates\r\n");
                                        if (
                                            ((e.localDescription.sdp =
                                                t.join("")),
                                            e.dispatchEvent(r),
                                            null !== e.onicecandidate &&
                                                e.onicecandidate(r),
                                            !r.candidate &&
                                                "complete" !==
                                                    e.iceGatheringState)
                            ...
                            (t.prototype._getCommonCapabilities = function (
                                e,
                                t
                            ) {
                                var r = {
                            ...
                            (t.prototype._createIceAndDtlsTransports =
                                function (e, t) {
                                    var r = this,
                                        ...
                                        d
                                            ...
                                            : ((c.component =
                                              ...
                                              (s.candidate.candidate =
                                                  a.writeCandidate(c)));
                                        var p = a.splitSections(
                                            r.localDescription.sdp
                                        );
                            ...
                            (t.prototype._disposeIceAndDtlsTransports =
                                function (e) {
                            ...
                            (t.prototype._transceive = function (t, r, n) {
                                ...
                                r &&
                                    ...
                                    t.recvEncodingParameters.length &&
                                        (i.rtcp.ssrc =
                                            t.recvEncodingParameters[0].ssrc),
                                    t.rtpSender.send(i)),
                                    n &&
                                        t.rtpReceiver &&
                                        ("video" === t.kind &&
                                            ...
                                            e < 15019 &&
                                            t.recvEncodingParameters.forEach(
                                                function (e) {
                                                    delete e.rtx;
                                                }
                                            ),
                            ...
                            (t.prototype.setLocalDescription = function (e) {
                                ...
                                if ("offer" === e.type)
                                    ...
                                    (t = a.splitSections(
                                        n.remoteDescription.sdp
                                    )),
                                        (r = t.shift());
                                    var i =
                                        a.matchPrefix(r, "a=ice-lite").length >
                                        0;
                                    t.forEach(function (e, t) {
                                        ...
                                        if (
                                            ...
                                            i && (l.role = "server"),
                                                (n.usingBundle && 0 !== t) ||
                                                    ...
                                                    d.start(l));
                                            var m = n._getCommonCapabilities(
                                                p,
                                                u
                                            );
                                            n._transceive(
                                    ...
                                    c.then(function () {
                                        o ||
                                            ("new" === n.iceGatheringState &&
                                                ...
                                                n._emitGatheringStateChange()),
                                            window.setTimeout(
                                                n._emitBufferedCandidates.bind(
                                                    n
                                                ),
                                                500
                                            ));
                            ...
                            (t.prototype.setRemoteDescription = function (t) {
                                var r = this,
                                    ...
                                    s = o.shift(),
                                    c =
                                        a.matchPrefix(s, "a=ice-lite").length >
                                        0,
                                    d =
                                        a.matchPrefix(s, "a=group:BUNDLE ")
                                            .length > 0,
                                    ...
                                    o.forEach(function (o, p) {
                                        ...
                                        if ("offer" !== t.type || l)
                                            "answer" !== t.type ||
                                                ...
                                                (d &&
                                                    p > 0 &&
                                                    (r._disposeIceAndDtlsTransports(
                                                        p
                                                    ),
                                                    (r.transceivers[
                                                        p
                                            ...
                                            if (
                                                (!L ||
                                                    (d && 0 !== p) ||
                                                    _.iceTransport.setRemoteCandidates(
                                                        j
                                                    ),
                                                (E =
                                                ...
                                                r.localStreams.length > 0 &&
                                                    r.localStreams[0].getTracks()
                                                        .length >= p)
                                            ) {
                                                var U;
                                                "audio" === f
                                                    ? (U =
                                                          r.localStreams[0].getAudioTracks()[0])
                                                    : "video" === f &&
                                                      (U =
                                                          r.localStreams[0].getVideoTracks()[0]),
                                                    U &&
                                                        (e >= 15019 &&
                                                            "video" === f &&
                                                            (S[0].rtx = {
                            ...
                            (t.prototype._maybeFireNegotiationNeeded =
                                function () {
                            ...
                            (t.prototype._updateConnectionState = function () {
                                ...
                                if (
                                    (this.transceivers.forEach(function (e) {
                                        r[e.iceTransport.state]++,
                                            r[e.dtlsTransport.state]++;
                                    }),
                            ...
                            (t.prototype.createOffer = function () {
                                ...
                                if (
                                    (this.localStreams.length &&
                                        ...
                                        (s = this.localStreams.reduce(function (
                                            e,
                                            t
                                        ) {
                                            return (
                                                e + t.getVideoTracks().length
                                            );
                                        },
                                        0))),
                                    r)
                                    ...
                                    var i = r.track,
                                        ...
                                        c =
                                            t.usingBundle && n > 0
                                                ...
                                                : t._createIceAndDtlsTransports(
                                                      s,
                                                      n
                                                  ),
                                        p = RTCRtpSender.getCapabilities(o);
                                    e < 15019 &&
                                        (p.codecs = p.codecs.filter(function (
                                            e
                                        ) {
                                            return "rtx" !== e.name;
                                        })),
                                ...
                                this.usingBundle &&
                                    ...
                                    this.transceivers.forEach(function (r) {
                                        ...
                                        !n.codecs.filter(function (e) {
                                            return (
                                                "rtx" === e.name.toLowerCase()
                                            );
                                        }).length &&
                                            r.sendEncodingParameters[0].rtx &&
                                            delete r.sendEncodingParameters[0]
                                                .rtx,
                            ...
                            (t.prototype.addIceCandidate = function (e) {
                                if (e) {
                                    ...
                                    if (e.sdpMid)
                                        for (
                                            var r = 0;
                                            r < this.transceivers.length;
                                            r++
                                        )
                                            if (
                                                this.transceivers[r].mid ===
                                                e.sdpMid
                                            ) {
                                                t = r;
                                                break;
                    ...
                    var n = {
                        ...
                        shimGetUserMedia: function () {
                            navigator.getUserMedia ||
                                (navigator.webkitGetUserMedia
                                    ? (navigator.getUserMedia =
                                          navigator.webkitGetUserMedia.bind(
                                              navigator
                                          ))
                                    : navigator.mediaDevices &&
                                      navigator.mediaDevices.getUserMedia &&
                        ...
                        i = {
                            ...
                            shimCreateObjectURL: function () {
                                if (
                                    ...
                                    var a =
                                        HTMLMediaElement.prototype.setAttribute;
                                    HTMLMediaElement.prototype.setAttribute =
                                        function () {
                                            return (
                                                2 === arguments.length &&
