...
!(function (t) {
            ...
            return function (n, c, p) {
                for (
                    var d,
                        ...
                        E = u(S.length),
                        O = 0,
                        m = r ? v(n, E) : a ? v(n, 0) : void 0;
                    E > O;
                    O++
                )
                    if ((h || O in S) && ((y = _((d = S[O]), O, g)), t))
                        if (r) m[O] = y;
                        else if (y)
                            switch (t) {
                                case 3:
        ...
        if (r(6)) {
            var e = r(30),
                ...
                Ft = {
                    ...
                    fill: function (t) {
                        return G.apply(xt(this), arguments);
                    },
                    filter: function (t) {
                        return Nt(
                            this,
                ...
                Dt = function (t, n) {
                    return Nt(this, lt.call(xt(this), t, n));
                },
                Ct = function (t) {
                    xt(this);
                ...
                kt = function (t, n) {
                    return jt(t, (n = S(n, !0))) ? l(2, t[n]) : W(t, n);
                },
                Ut = function (t, n, r) {
                    return !(jt(t, (n = S(n, !0))) && O(r) && _(r, "value")) ||
                        _(r, "get") ||
                        _(r, "set") ||
                        r.configurable ||
                ...
                (t.exports = function (t, n, r, a) {
                        ...
                        ? ((p = r(function (t, r, e, i) {
                              ...
                              if (O(r)) {
                                  if (
                                      ...
                                      return _t in r ? It(p, r) : Tt.call(p, r);
                                  (o = r), (v = wt(e, n));
                                  var g = r.byteLength;
                                  if (void 0 === i) {
                    ...
                    h(p, yt, !0),
                        ...
                        "BYTES_PER_ELEMENT" in b ||
                            h(b, "BYTES_PER_ELEMENT", n),
                        u(u.P, f, Ft),
                        C(f),
                        u(u.P + u.F * bt, f, { set: Ct }),
                        u(u.P + u.F * !M, f, Gt),
                        e || b.toString == ht || (b.toString = ht),
                        u(
                            u.P +
                                u.F *
                                    o(function () {
    ...
    function (t, n, r) {
        ...
        (e.DOM_queryAll = function () {
            ...
            (n.default = e);
        var i = e.DOM_queryAll,
            o = e.DOM_query;
        (n.DOM_query = o), (n.DOM_queryAll = i), (n.$qs = o), (n.$qsa = i);
    },
    function (t, n, r) {
        var e = r(7).f,
            i = r(14),
            ...
            if (
                ...
                N ||
                    (((_ = n(function (n, r) {
                        f(n, _, t);
                        var e = p(new S(), n, _);
                        return void 0 != r && a(r, y, e[E], e), e;
                    })).prototype = O),
                    (O.constructor = _)),
                    (P || I) && (b("delete"), b("has"), y && b("get")),
                    (I || x) && b(E),
                    g && O.clear && delete O.clear;
            } else
                (_ = d.getConstructor(n, t, y, E)),
                    u(_.prototype, r),
                    (c.NEED = !0);
            return (
                v(_, t),
    ...
    function (t, n, r) {
        ...
        t.exports = function (t, n, r, p, d, y, g) {
            ...
            var S,
                ...
                w = !1,
                x = t.prototype,
                P = x[l] || x["@@iterator"] || (d && x[d]),
                N = P || O(d),
                I = d ? (b ? O("entries") : N) : void 0,
                M = ("Array" == n && x.entries) || P;
            if (
                (M &&
                    (E = s(M.call(new t()))) !== Object.prototype &&
                    E.next &&
                    (f(E, m, !0), e || "function" == typeof E[l] || u(E, l, v)),
                b &&
                    P &&
                    "values" !== P.name &&
                    ((w = !0),
    ...
    function (t, n, r) {
        ...
        function e(t, n, r) {
            ...
            for (
                (t = G(t)) != t || t === D
                    ...
                    : ((e = k(U(t) / B)),
                      t * (o = j(2, -e)) < 1 && (e--, (o *= 2)),
                      (t += e + f >= 1 ? s / o : s * j(2, 1 - f)) * o >= 2 &&
                          (e++, (o /= 2)),
                      e + f >= a
                          ? ((i = 0), (e = a))
                          : e + f >= 1
                          ? ((i = (t * o - 1) * j(2, n)), (e += f))
                          : ((i = t * j(2, f - 1) * j(2, n)), (e = 0)));
                n >= 8;
                u[l++] = 255 & i, i /= 256, n -= 8
            );
            for (
        ...
        function v(t, n, r, e, i, o) {
            var u = w(+r);
            if (u + n > t[H]) throw F(T);
            for (var c = t[W]._b, a = u + t[V], f = e(+i), s = 0; s < n; s++)
                c[a + s] = f[o ? s : n - s - 1];
        }
        var p = r(2),
            d = r(6),
        ...
        if (g.ABV) {
            if (
                ...
                E(function () {
                    return (
                        new A(), new A(1.5), new A(NaN), "ArrayBuffer" != A.name
                    );
                })
            ) {
                for (
            ...
            (A = function (t) {
                ...
                var n = w(t);
                (this._b = N.call(new Array(n), 0)), (this[H] = n);
            }),
                (R = function (t, n, r) {
                    O(this, R, "DataView"), O(t, A, "DataView");
                    var e = t[H],
                        i = m(n);
                    if (i < 0 || i > e) throw F("Wrong offset!");
                    if (i + (r = void 0 === r ? e - i : b(r)) > e)
                        throw F("Wrong length!");
                    (this[W] = t), (this[V] = i), (this[H] = r);
                }),
                d &&
                    (l(A, "byteLength", "_l"),
                    l(R, "buffer", "_b"),
    ...
    function (t, n, r) {
        t.exports =
            ...
            !r(3)(function () {
                return (
                    7 !=
                    Object.defineProperty(r(65)("div"), "a", {
                        get: function () {
                            return 7;
                        },
                    }).a
    ...
    function (t, n, r) {
        r(6) &&
            "g" != /./g.flags &&
            r(7).f(RegExp.prototype, "flags", { configurable: !0, get: r(56) });
    },
    function (t, n) {
        t.exports = function (t) {
            try {
    ...
    function (t, n, r) {
        ...
        var e,
            ...
            S = (t.exports = r(60)("WeakMap", y, g, a, !0, !0));
        s(function () {
            return 7 != new S().set((Object.freeze || Object)(d), 7).get(d);
        }) &&
    ...
    function (t, n, r) {
        ...
        t.exports = function t(n, r, a, f, s, l, h, v) {
            for (var p, d, y = s, g = 0, S = !!h && u(h, v, 3); g < f; ) {
                if (g in a) {
                    if (
                        ((p = S ? S(a[g], g, r) : a[g]),
                        (d = !1),
    ...
    function (t, n, r) {
        ...
        t.exports = function (t) {
            return function (n) {
                for (
                    var r, u = i(n), c = e(u), a = c.length, f = 0, s = [];
                    a > f;
    ...
    function (t, n, r) {
        "use strict";
        Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.supportImport = n.HTMLGenerator = void 0),
            r(370);
        var e = function () {
                var t =
                        arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    r = document
                        .querySelector('link[data-rel="' + t + '"]')
                        .import.querySelector(
                            '[data-div="templates-' + t + '"]'
                        );
                n.appendChild(r);
                var e = document.querySelector(
                        '[data-template="template-script-' + t + '"]'
                    ),
                    i = document.querySelector(
                        '[data-template="template-style-' + t + '"]'
                    );
                (e.src = e.dataset.src), (i.href = i.dataset.href);
            },
            i = "import" in document.createElement("link");
        (n.default = e), (n.HTMLGenerator = e), (n.supportImport = i);
    },
    function (t, n, r) {
        "use strict";
        function e(t) {
        ...
        (n.default = i),
            (n.SearchParams = i),
            (n.SearchParamsGenerator = function () {
                var t =
                        arguments.length > 0 && void 0 !== arguments[0]
                            ? arguments[0]
                            : "",
                ...
                return { result: r, entries: i, keys: o, values: u };
            });
    },
    function (t, n, r) {
        "use strict";
    ...
    function (t, n, r) {
        ...
        var e = r(2),
            ...
            X = function (t, n) {
                S(t);
                for (var r, e = y((n = E(n))), i = 0, o = e.length; o > i; )
                    q(t, (r = e[i++]), n[r]);
                return t;
            },
            z = function (t) {
            ...
            $ = function (t) {
                for (var n, r = T(E(t)), e = [], o = 0; r.length > o; )
                    i(j, (n = r[o++])) || n == F || n == a || e.push(n);
                return e;
            },
            Q = function (t) {
                for (
                    var n, r = t === U, e = T(r ? k : E(t)), o = [], u = 0;
                    e.length > u;

                )
                    !i(j, (n = e[u++])) || (r && !i(U, n)) || o.push(j[n]);
                return o;
            };
        B ||
            (c(
                (A = function () {
                    ...
                    return (
                        o && H && V(U, t, { configurable: !0, set: n }), K(t)
                    );
                }).prototype,
                "toString",
                function () {
            ...
            (r(48).f = z),
            (r(52).f = Q),
            o && !r(30) && c(U, "propertyIsEnumerable", z, !0),
            (p.f = function (t) {
                return K(v(t));
            })),
            u(u.G + u.W + u.F * !B, { Symbol: A });
        for (
            var Z =
            ...
            v(Z[tt++]);
        for (var nt = N(v.store), rt = 0; nt.length > rt; ) d(nt[rt++]);
        u(u.S + u.F * !B, "Symbol", {
            for: function (t) {
                return i(G, (t += "")) ? G[t] : (G[t] = A(t));
            },
            keyFor: function (t) {
            ...
            A.prototype[D] || r(11)(A.prototype, D, A.prototype.valueOf),
            l(A, "Symbol"),
            l(Math, "Math", !0),
            l(e.JSON, "JSON", !0);
    },
    ...
    function (t, n, r) {
        var e = r(0);
        e(e.S + e.F * !r(6), "Object", { defineProperties: r(95) });
    },
    function (t, n, r) {
        var e = r(15),
            i = r(16).f;
    ...
    function (t, n, r) {
        var e = r(0);
        e(e.S, "Object", { setPrototypeOf: r(70).set });
    },
    function (t, n, r) {
        "use strict";
        var e = r(49),
    ...
    function (t, n, r) {
        ...
        e(e.S, "Math", {
            hypot: function (t, n) {
                for (
                    var r, e, o = 0, u = 0, c = arguments.length, a = 0;
                    u < c;
    ...
    function (t, n, r) {
        var e = r(0);
        e(e.P, "Array", { copyWithin: r(108) }), r(31)("copyWithin");
    },
    function (t, n, r) {
        var e = r(0);
            ...
            if (
                ...
                e = function (t, n) {
                    ...
                    for (
                        ...
                        (a = y.exec(r)) &&
                        !(
                            (f = a.index + a[0].length) > p &&
                            (h.push(r.slice(p, a.index)),
                            !c &&
                                a.length > 1 &&
    ...
    function (t, n, r) {
        ...
        A ||
            ((N = function (t) {
                p(this, N, "Promise", "_h"), v(t), e.call(this);
                try {
                    t(f(j, this, 1), f(G, this, 1));
                } catch (t) {
                    G.call(this, t);
                }
            }),
            ...
            (o = function () {
                var t = new e();
                (this.promise = t),
                    (this.resolve = f(j, t, 1)),
                    (this.reject = f(G, t, 1));
            }),
            (_.f = T =
                function (t) {
                    return t === N || t === u ? new o(t) : i(t);
                })),
            l(l.G + l.W + l.F * !A, { Promise: N }),
            r(43)(N, "Promise"),
            r(38)("Promise"),
            (u = r(18).Promise),
            l(l.S + l.F * !A, "Promise", {
    ...
    function (t, n, r) {
        var e = r(0);
        e(e.G + e.W + e.F * !r(61).ABV, { DataView: r(90).DataView });
    },
    function (t, n, r) {
    ...
    function (t, n, r) {
        ...
        var e = r(0),
            ...
            _ = function (t, n) {
                f(t), (this._c = void 0), (this._o = t), (t = new E(this));
                try {
                    var r = n(t),
                        e = r;
                    null != r &&
        ...
        l(O.prototype, {
            ...
            l(O, {
                from: function (t) {
                    var n = "function" == typeof this ? this : O,
                        r = d(f(t)[c]);
                    if (r) {
                        var e = f(r.call(t));
                ...
                of: function () {
                    for (
                        var t = 0, n = arguments.length, r = new Array(n);
                        t < n;

                    )
                        r[t] = arguments[t++];
                    return new ("function" == typeof this ? this : O)(function (
                        t
                    ) {
                        var n = !1;
                        return (
    ...
    function (t, n, r) {
        for (
            ...
            var y,
                ...
                _ = u[g],
                E = _ && _.prototype;
            if (E && (E[s] || c(E, s, h), E[l] || c(E, l, g), (a[g] = h), S))
                for (y in e) E[y] || o(E, y, e[y], !0);
        }
    },
    function (t, n, r) {
        (function (n) {
            !(function (n) {
                ...
                var d,
                    ...
                    m = "object" == typeof t,
                    b = n.regeneratorRuntime;
                if (b) m && (t.exports = b);
                else {
                    (b = n.regeneratorRuntime = m ? t.exports : {}).wrap = r;
                    ...
                    (o.prototype = R.constructor = u),
                        ...
                        (b.AsyncIterator = a),
                        (b.async = function (t, n, e, i) {
                            var o = new a(r(t, n, e, i));
                            return b.isGeneratorFunction(n)
                                ? o
    ...
    function (t, n) {
        t.exports = {
            button: "f10_index_button",
            "button-turquoise": "f10_index_button-turquoise",
        };
    },
    ,
    ,
    ...
    function (t, n, r) {
        ...
        e.supportImport
            ? (console.log(
                  "YES! The browser supports the HTML imports template!"
              ),
              setTimeout(function () {
                  (0, e.HTMLGenerator)("latest-news");
                  var t = [
                          "--body-background",
                          "--title-box-border",
                      ...
                      r = (0, i.SearchParams)(n).skin || "white";
                  (0, u.$qs)('[data-action="change-skin"]').addEventListener(
                      "click",
                      function () {
                          (r = "white" === r ? "black" : "white"),
                              (0, o.autoChangeSkin)(t, r);
                      }
                  );
              }, 0))
            : console.error(
                  "Oops! The browser supports the HTML imports template!"
              );
    },
    ,
    ,
