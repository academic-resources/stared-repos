...
<html lang="en">
    <head>
        ...
        />
        <link
            href="https://cdn.bootcss.com/smalot-bootstrap-datetimepicker/2.3.11/css/bootstrap-datetimepicker.min.css"
            rel="stylesheet"
        />
    </head>
    <body>
        <div class="good-search search-detail">
            <div
                class="search-info search-time search-id fl-l"
                data-box="data-box"
            >
                <label class="search-text" data-search="data-search"
                    >开始时间</label
                >
                <input
                    class="search-input from-picker"
                    data-timepicker="thisBegin"
