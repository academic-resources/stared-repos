...
(function (e) {
    ...
    (e.cleanData = (function (t) {
        ...
        (e.widget.extend = function (t) {
            for (
                var i, s, n = u.call(arguments, 1), a = 0, o = n.length;
                o > a;
                a++
            )
                for (i in n[a])
            ...
            e.fn[t] = function (n) {
                ...
                return (
                    a
                        ...
                        : (o.length &&
                              (n = e.widget.extend.apply(null, [n].concat(o))),
                          this.each(function () {
                              var t = e.data(this, s);
                              t
                ...
                getScrollInfo: function (t) {
                    var i =
                        ...
                        n =
                            "scroll" === i ||
                            ("auto" === i &&
                                t.width < t.element[0].scrollWidth),
                        a =
                            "scroll" === s ||
                            ("auto" === s &&
                                t.height < t.element[0].scrollHeight);
                    return {
                            ...
                            !this.mouseHandled &&
                                ...
                                i.has(".ui-menu").length
                                    ...
                                    : !this.element.is(":focus") &&
                                      e(this.document[0].activeElement).closest(
                                          ".ui-menu"
                                      ).length &&
            ...
            for (
                ...
                for (k = "", this.maxRows = 4, T = 0; K[1] > T; T++) {
                    if (
                        ...
                        if (
                            ((M += "<div class='ui-datepicker-group"), K[1] > 1)
                        )
                            switch (T) {
                                case 0:
                    ...
                    n.containment
                        ? "window" === n.containment
                            ? ((this.containment = [
                                  ...
                                  e(window).scrollTop() +
                                      (e(window).height() ||
                                          a.body.parentNode.scrollHeight) -
                                      this.helperProportions.height -
                                      this.margins.top,
                              ]),
                              void 0)
                    ...
                    (a.positionAbs = s.positionAbs),
                        ...
                        n
                            ? (a.isOver ||
                                  ...
                                  (a.fromOutside = s)),
                              a.currentItem &&
                                  (a._mouseDrag(t), (i.position = a.position)))
                            : a.isOver &&
                              ((a.isOver = 0),
                ...
                o !== r && "HTML" !== o.tagName
                    ? ((n.axis && "x" === n.axis) ||
                          ...
                          n.scrollSensitivity
                              ...
                              : t.pageY - s.overflowOffset.top <
                                    n.scrollSensitivity &&
                                (o.scrollTop = a =
                                    o.scrollTop - n.scrollSpeed)),
                      (n.axis && "y" === n.axis) ||
                          (s.overflowOffset.left + o.offsetWidth - t.pageX <
                          n.scrollSensitivity
                              ? (o.scrollLeft = a =
                                    o.scrollLeft + n.scrollSpeed)
                              : t.pageX - s.overflowOffset.left <
                                    n.scrollSensitivity &&
                                (o.scrollLeft = a =
                                    o.scrollLeft - n.scrollSpeed)))
                    : ((n.axis && "x" === n.axis) ||
                          (t.pageY - e(r).scrollTop() < n.scrollSensitivity
                              ? (a = e(r).scrollTop(
                                    e(r).scrollTop() - n.scrollSpeed
                                ))
                              : e(window).height() -
                                    (t.pageY - e(r).scrollTop()) <
                                    n.scrollSensitivity &&
                                (a = e(r).scrollTop(
                                    e(r).scrollTop() + n.scrollSpeed
                                ))),
                    ...
                    this._helper &&
                        ...
                        (h =
                            parseInt(u.element.css("top"), 10) +
                                (u.position.top - u.originalPosition.top) ||
                            null),
                        l.animate ||
                            this.element.css(e.extend(o, { top: h, left: r })),
        ...
        e.ui.plugin.add("resizable", "containment", {
            ...
            resize: function (t) {
                ...
                c[0] !== document &&
                    ...
                    (a = /relative|absolute/.test(
                        o.containerElement.css("position")
                    )),
                    n && a
                        ? ((o.offset.left =
                              o.parentData.left + o.position.left),
                    ...
                    (i = Math.abs(
                        o.sizeDiff.width +
                            (o._helper
                                ? o.offset.left - d.left
                                : o.offset.left - h.left)
                    )),
                    (s = Math.abs(
                        o.sizeDiff.height +
                            (o._helper
                    ...
                    this._on(this.uiDialog, {
                        keydown: function (t) {
                            if (
                                ...
                                return (
                                    t.preventDefault(), this.close(t), void 0
                                );
                            if (
    ...
    (e.effects = { effect: {} }),
        (function (e, t) {
            ...
            function s(i) {
                ...
                return (
                    ...
                    n.length
                        ? ("0,0,0,0" === n.join() && e.extend(n, a.transparent),
                          s)
                        : a[i]
                );
            }
            ...
            function i(t, i) {
                ...
                for (s in i)
                    (a = i[s]),
                        t[s] !== a &&
                            (n[s] ||
                                ((e.fx.step[s] || !isNaN(parseFloat(a))) &&
                                    (o[s] = a)));
                return o;
            }
        ...
        (e.effects.effect.bounce = function (t, i) {
            ...
            for (
                (u || l) && r.push("opacity"),
                    ...
                    c ||
                        (c =
                            o["top" === v ? "outerHeight" : "outerWidth"]() /
                            3),
                    u &&
                        ((a = { opacity: 1 }),
                        (a[v] = 0),
        ...
        (e.effects.effect.fold = function (t, i) {
            ...
            e.effects.save(a, o),
                ...
                h &&
                    s.css(
                        c ? { height: 0, width: u } : { height: u, width: 0 }
                    ),
                (g[f[0]] = h ? n[0] : u),
                (v[f[1]] = h ? n[1] : 0),
        ...
        e.widget("ui.selectmenu", {
            ...
            _documentClick: {
                mousedown: function (t) {
                    this.isOpen &&
                        (e(t.target).closest(
                            ".ui-selectmenu-menu, #" + this.ids.button
                        ).length ||
                            this.close(t));
                },
            },
            ...
            _getItemsAsjQuery: function (t) {
                ...
                if (l && t)
                    for (s = l.length - 1; s >= 0; s--)
                        for (
                            a = e(l[s], this.document[0]), n = a.length - 1;
                            n >= 0;
                            n--
                        )
            ...
            _refreshItems: function (t) {
                ...
                if (c && this.ready)
                    for (i = c.length - 1; i >= 0; i--)
                        for (
                            n = e(c[i], this.document[0]), s = n.length - 1;
                            s >= 0;
                            s--
                        )
                ...
                for (i = d.length - 1; i >= 0; i--)
                    for (
                        o = d[i][1], r = d[i][0], s = 0, l = r.length;
                        l > s;
                        s++
                    )
                        (h = e(r[s])),
                        ...
                        element: function () {
                            ...
                            return (
                                "tbody" === s
                                    ...
                                    : "img" === s &&
                                      n.attr("src", t.currentItem.attr("src")),
            ...
            _setContainment: function () {
                ...
                "parent" === n.containment &&
                    ...
                    /^(document|window|parent)$/.test(n.containment) ||
                        ...
                        (this.containment = [
                            i.left +
                                (parseInt(e(t).css("borderLeftWidth"), 10) ||
                                    0) +
                                (parseInt(e(t).css("paddingLeft"), 10) || 0) -
                                this.margins.left,
                            i.top +
                                (parseInt(e(t).css("borderTopWidth"), 10) ||
                                    0) +
        ...
        e.widget("ui.spinner", {
                ...
                "mousedown .ui-spinner-button": function (t) {
                    ...
                    (s =
                        ...
                        this._start(t) !== !1 &&
                            this._repeat(
                                null,
                                e(t.currentTarget).hasClass("ui-spinner-up")
                                    ? 1
                                    : -1,
                                t
                            );
            ...
            _spin: function (e, t) {
                ...
                this.counter || (this.counter = 1),
                    ...
                    (this.spinning &&
                        this._trigger("spin", t, { value: i }) === !1) ||
        ...
        e.widget("ui.tooltip", {
            ...
            open: function (t) {
                var i = this,
                    s = e(t ? t.target : this.element).closest(
                        this.options.items
                    );
                s.length &&
            ...
            _open: function (t, i, s) {
                ...
                if (s) {
                    if ((a = this._find(i)))
                        return (
                            a.tooltip.find(".ui-tooltip-content").html(s),
                            void 0
                        );
                    i.is("[title]") &&
                        (t && "mouseover" === t.type
