...
(function (C) {
    ...
    function pa(a, b) {
        ...
        var f = [],
            g = [];
        if (b) {
            if ($d(b) || "[object ArrayBuffer]" === ma.call(b))
                throw xa("cpta");
            if (a === b) throw xa("cpi");
            L(b)
                ? (b.length = 0)
    ...
    function fe(a, b) {
        ...
        d &&
            ((e.strictDi = null !== ee(d, "strict-di")), b(d, c ? [c] : [], e));
    }
    function Bc(a, b, d) {
        D(d) || (d = {});
        d = S({ strictDi: !1 }, d);
    ...
    function wb(a, b) {
        ...
        if (a.querySelectorAll)
            for (
                var d = a.querySelectorAll("*"), c = 0, e = d.length;
                c < e;
                c++
            )
                eb(d[c]);
    ...
    function eb(a, b) {
        ...
        c &&
            (b
                ? delete c.data[b]
                : (c.handle &&
                      (c.events.$destroy && c.handle({}, "$destroy"), Rc(a)),
                  delete fb[d],
                  (a.ng339 = void 0)));
    }
    function xb(a, b) {
            ...
            function c(a) {
                ...
                var f = b.template || b.templateUrl ? b.template : "",
                    g = {
                        controller: d,
                        controllerAs:
                            Xc(b.controller) || b.controllerAs || "$ctrl",
                        template: e(f),
        ...
        this.$get = [
            ...
            function (a, b, c, e, n, t, K, M, H, E) {
                ...
                function oa(a, b, d, e, f, g, h, k, l) {
                    function m(a, b, c, d) {
                        if (a) {
                            ...
                            a.require = x.require;
                            a.directiveName = I;
                            if (u === x || x.$$isolateScope)
                                a = ja(a, { isolateScope: !0 });
                            h.push(a);
                        }
                        if (b) {
                            c && (b = Zc(b, c, d));
                    ...
                    function p(a, e, f, g, l) {
                        ...
                        for (n in t) {
                            ...
                            x.bindingInfo =
                                x.identifier && Zb
                                    ? ka(B, g, x.instance, Zb, E)
                                    : {};
                            var K = x();
                            K !== x.instance &&
                                ((x.instance = K),
                                I.data("$" + E.name + "Controller", K),
                                x.bindingInfo.removeWatches &&
                                    x.bindingInfo.removeWatches(),
                        ...
                        for (E = h.length; n < E; n++)
                            (x = h[n]),
                                la(
                                    ...
                                    g,
                                    x.require &&
                                        ib(x.directiveName, x.require, I, t),
                                    P
                                );
                        var s = e;
                        ...
                        if (x.templateUrl)
                            ...
                            try {
                                ...
                                z(s)
                                    ? m(null, ab(Y, s), G, hb)
                                    : s &&
                                      m(ab(Y, s.pre), ab(Y, s.post), G, hb);
                            } catch (ca) {
                                c(ca, ya(t));
                            }
                        x.terminal &&
                            ((p.terminal = !0), (n = Math.max(n, x.priority)));
                    }
                    p.scope = r && !0 === r.scope;
                ...
                function ea(a, b, c) {
                    ...
                    F.hasData(d) &&
                        (F.data(c, F.data(d)), F(d).off("$destroy"));
                ...
                function n(c, d) {
                    ...
                    y(I) &&
                        ((I = id(c.url)
                            ...
                            : void 0) &&
                            (Da[c.xsrfHeaderName || a.xsrfHeaderName] = I),
                        e(
                            c.method,
                            P,
                            d,
        ...
        return function (e, h, k, l, m, n, p, u, R, B) {
            ...
            if ("jsonp" === Q(e))
                ...
                t.onload = function () {
                    ...
                    0 === c &&
                        (c = b ? 200 : "file" == Y(h).protocol ? 404 : 0);
        ...
        this.$get = [
            ...
            function (a, b) {
                ...
                if (l) {
                    ...
                    !e ||
                        (m && n) ||
                        ((m = G(l.webkitTransition)),
                        (n = G(l.webkitAnimation)));
                }
                return {
                    history: !(!c || 4 > e || f),
                    hasEvent: function (a) {
                ...
                return {
                    ...
                    predicateValues: k.map(function (c) {
                        ...
                        if (null === e) (c = "string"), (e = "null");
                            ...
                            a: {
                                if (z(e.valueOf) && ((e = e.valueOf()), d(e)))
                                    break a;
    ...
    q(
        {
            ...
            isolateScope: function (a) {
                return (
                    F.data(a, "$isolateScope") ||
                    F.data(a, "$isolateScopeNoTemplate")
                );
            },
            controller: Sc,
            injector: function (a) {
                ...
                if (c !== Ma && 2 !== c && 8 !== c)
                    if (((c = Q(b)), Eb[c]))
                        if (w(d))
                            ...
                            return a[b] ||
                                (a.attributes.getNamedItem(b) || A).specified
                                ? c
                                : void 0;
                    else if (w(d)) a.setAttribute(b, d);
                    else if (a.getAttribute)
                        return (
                            (a = a.getAttribute(b, 2)), null === a ? void 0 : a
                        );
            },
            prop: function (a, b, d) {
                if (w(d)) a[b] = d;
            ...
            on: function (a, b, d, c) {
                ...
                if (Nc(a)) {
                    ...
                    for (
                        ...
                        (b = c[g]),
                            yb[b] ? (h(yb[b], Tf), h(b, void 0, !0)) : h(b);
                }
            },
            off: Rc,
            one: function (a, b, d) {
        ...
        jf = function () {
            this.$get = [
                ...
                function (a) {
                    return function (b) {
                        b
                            ? !b.nodeType && b instanceof F && (b = b[0])
                            : (b = a[0].body);
            ...
            if (!f && w(a.watchId))
                ...
                switch (a.type) {
                    ...
                    case s.Identifier:
                        ...
                        (k.state.expensiveChecks || Jb(a.name)) &&
                            ...
                            function () {
                                k.if_(
                                    ...
                                    function () {
                                        e &&
                                            1 !== e &&
                                            k.addEnsureSafeAssignContext(g);
                                        if (a.computed)
                                            (h = k.nextId()),
            ...
            switch (a.type) {
                ...
                case s.MemberExpression:
                    return (
                        ...
                        a.computed ||
                            (Sa(a.property.name, f.expression),
                            (e = a.property.name)),
                            ...
                            : function (a, c, d, m) {
                                  ...
                                  if (null != n.value) {
                                      ...
                                      for (var q = 0; q < g.length; ++q)
                                          p.push(
                                              ra(g[q](a, c, d, m), f.expression)
                                          );
                                      p = ra(
                                          n.value.apply(n.context, p),
                                          f.expression
                                      );
                                  }
                                  return b ? { value: p } : p;
            ...
            function (a, b, d, c, e, f, g, h, k, l) {
                ...
                this.$$setOptions = function (a) {
                    if ((r.$options = a) && a.getterSetter) {
                        ...
                        throw nb("nonassign", d.ngModel, ya(c));
                };
                this.$render = A;
                ...
                this.$$updateEmptyClasses = function (a) {
                    r.$isEmpty(a)
                        ? (f.removeClass(c, "ng-not-empty"),
                          f.addClass(c, "ng-empty"))
                        : (f.removeClass(c, "ng-empty"),
                    ...
                    if (c) {
                        ...
                        d.$observe("pattern", function (a) {
                            G(a) &&
                                ...
                                (a = new RegExp("^" + a + "$"));
                            if (a && !a.test)
                                throw N("ngPattern")("noregexp", f, a, ya(b));
                            e = a || void 0;
                            c.$validate();
                        });
