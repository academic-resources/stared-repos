    ...
    return (
        ...
        (function () {
            ...
            o.Utf16LE = {
                stringify: function (t) {
                    for (
                        var e = t.words, i = t.sigBytes, n = [], o = 0;
                        o < i;
                        o += 2
                    ) {
                ...
                c = (o.PBKDF2 = i.extend({
                    ...
                    compute: function (t, r) {
                        for (
                            ...
                            i.reset();
                            for (
                                var d = u.words, v = d.length, p = u, _ = 1;
                                _ < f;
                                _++
                            ) {
        ...
        (function (r) {
            ...
            var d = (c.SHA3 = o.extend({
                ...
                _doProcessBlock: function (t, r) {
                    for (
                        var e = this._state, i = this.blockSize / 2, n = 0;
                        n < i;
                        n++
                    ) {
                        var o = t[r + 2 * n],
        ...
        (t.pad.Iso10126 = {
            pad: function (r, e) {
                var i = 4 * e,
                    n = i - (r.sigBytes % i);
                r.concat(t.lib.WordArray.random(n - 1)).concat(
                ...
                _ = (n.AES = i.extend({
                    _doReset: function () {
                        if (
                            ...
                            for (
                                var h = (this._invKeySchedule = []), l = 0;
                                l < n;
                                l++
                            ) {
                                var a = n - l;
        ...
        (function () {
            ...
            var i = t,
                ...
                d = (a.DES = s.extend({
                    _doReset: function () {
                        for (
                            var t = this._key, r = t.words, e = [], i = 0;
                            i < 56;
                            i++
                        ) {
                            var n = c[i] - 1;
                ...
                _doReset: function () {
                    ...
                    (this._des1 = d.createEncryptor(o.create(r.slice(0, 2)))),
                        (this._des2 = d.createEncryptor(
                            o.create(r.slice(2, 4))
                        )),
                        (this._des3 = d.createEncryptor(
                            o.create(r.slice(4, 6))
                        ));
                },
                encryptBlock: function (t, r) {
        ...
        (function () {
            function r() {
                for (
                    var t = this._S, r = this._i, e = this._j, i = 0, n = 0;
                    n < 4;
                    n++
                ) {
