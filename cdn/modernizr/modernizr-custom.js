...
!(function (e, t, n) {
    ...
    function f() {
        var e = t.body;
        return e || ((e = u(_ ? "svg" : "body")), (e.fake = !0)), e;
    }
    function c(e, n, r, o) {
        var i,
            a,
    ...
    function h(e, t, o, i) {
        ...
        for (
            var c, p, m, h, v, g = ["modernizr", "tspan", "samp"];
            !z.style && g.length;

        )
            (c = !0), (z.modElem = u(g.shift())), (z.style = z.modElem.style);
        for (m = e.length, p = 0; m > p; p++)
            if (
                ...
                if (z.style[h] != v) return s(), "pfx" == t ? h : !0;
            }
        return s(), !1;
    }
    function v(e, t, n, o, i) {
        ...
        return r(t, "string") || r(t, "undefined")
            ? h(s, t, o, i)
            : ((s = (e + " " + w.join(a + " ") + a).split(" ")), m(s, t, n));
    }
    function g(e, t, r) {
        return v(e, n, n, t, r);
    }
    function y(e, t) {
        if ("object" == typeof e) for (var n in e) L(e, n) && y(n, e[n]);
        else {
            e = e.toLowerCase();
            var r = e.split("."),
                o = Modernizr[r[0]];
    ...
    _ ||
        !(function (e, t) {
            ...
            function s(e, n) {
                ...
                n = n || i(e);
                for (
                    var o = n.frag.cloneNode(), a = 0, s = r(), u = s.length;
                    u > a;
                    a++
                )
                    o.createElement(s[a]);
            ...
            function c(e) {
                for (
                    var t,
                        n = e.attributes,
                        r = n.length,
                        o = e.ownerDocument.createElement(N + ":" + e.nodeName);
                    r--;
    ...
    C._domPrefixes = w;
    var N = C._config.usePrefixes ? x.split(" ") : [];
    C._cssomPrefixes = N;
    var T = function (t) {
        var r,
            o = F.length,
    ...
    C.prefixedCSSValue = j;
    var P = ((C.testStyles = c), { elem: u("modernizr") });
    ...
    var A = (function () {
        function e(e, t) {
            var o;
            return e
                ? ((t && "string" != typeof t) || (t = u(t || "div")),
                  (e = "on" + e),
                  (o = e in t),
                  !o &&
                      r &&
                      (t.setAttribute || (t = u("div")),
                      t.setAttribute(e, ""),
