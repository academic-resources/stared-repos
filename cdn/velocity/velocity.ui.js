        ...
        Velocity.RegisterEffect = Velocity.RegisterUI = function (
            ...
            function animateParentHeight(
                ...
                Velocity.animate(
                    ...
                    },
                    {
                        ...
                        easing: "ease-in-out",
                        duration:
                            totalDuration * (direction === "In" ? 0.6 : 1),
                    }
                );
            }
            ...
            Velocity.Redirects[effectName] = function (
                ...
                if (typeof properties.defaultDuration === "function") {
                    ...
                    properties.defaultDuration = parseFloat(
                        properties.defaultDuration
                    );
                }
                ...
                for (
                        ...
                        if (elementsIndex === 0) {
                            opts.begin = function () {
                               ...
                               and the first RAF tick. */
                                ...
                                if (
                                    redirectOptions.animateParentHeight &&
                                    direction
                                ) {
                                    animateParentHeight(
                                        elements,
                    ...
                    if (callIndex === properties.calls.length - 1) {
                        ...
                        function injectFinalCallbacks() {
                            ...
                            redirectOptions.complete &&
                                redirectOptions.complete.call(
                                    elements,
                                    elements
                                );
                ...
                $.each(sequence.reverse(), function (i, currentCall) {
                    ...
                    if (nextCall) {
                       ...
                       in the previous call's complete callback. */
                        var currentCallOptions =
                                currentCall.o || currentCall.options,
                            nextCallOptions = nextCall.o || nextCall.options;

                        var timing =
                                currentCallOptions &&
                                currentCallOptions.sequenceQueue === false
                                    ? "begin"
                                    : "complete",
                            callbackOriginal =
                        ...
                        options[timing] = function () {
                            var nextCallElements =
                                nextCall.e || nextCall.elements;
