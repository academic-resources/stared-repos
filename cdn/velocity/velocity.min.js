            ...
            (c.fn = c.prototype =
                {
                    ...
                    position: function () {
                        ...
                        return (
                            ...
                            a.style &&
                                ((e.top +=
                                    parseFloat(a.style.borderTopWidth) || 0),
                                (e.left +=
                                    parseFloat(a.style.borderLeftWidth) || 0)),
            ...
            var w = function () {
                ...
                function e() {
                    function a() {
                        ...
                        function n() {
                            ...
                            if (e && d)
                                ...
                                t.init(j),
                                    ...
                                    (i.emToPx = I.lastEmToPx =
                                        (parseFloat(
                                            v.getPropertyValue(j, "paddingLeft")
                                        ) || 1) / h),
                            ...
                            return (
                                ...
                                null === I.vwToPx &&
                                    ((I.vwToPx =
                                        parseFloat(b.innerWidth) / 100),
                                    (I.vhToPx =
                                        parseFloat(b.innerHeight) / 100)),
                                (i.remToPx = I.remToPx),
                                (i.vwToPx = I.vwToPx),
                                (i.vhToPx = I.vhToPx),
                                t.debug >= 1 &&
                                    console.log(
                                        "Unit ratios: " + JSON.stringify(i),
                                        f
                                    ),
                                i
                            );
                        ...
                        if ("scroll" === C) {
                            ...
                            h.container
                                ? p.isWrapped(h.container) ||
                                  p.isNode(h.container)
                                    ? ((h.container =
                                          h.container[0] || h.container),
                                      (u = h.container["scroll" + A]),
                                      (z =
                                          u +
                                          m(f).position()[A.toLowerCase()] +
                                          D))
                                    : (h.container = null)
                                : ((u =
                                      t.State.scrollAnchor[
                                          t.State["scrollProperty" + A]
                                      ]),
                                  (w =
                                      t.State.scrollAnchor[
                                          t.State[
                            ...
                            for (var F in E)
                                if ("element" !== F) {
                                    ...
                                    (E[F].startValue = E[F].currentValue =
                                        E[F].endValue),
                                        (E[F].endValue = G),
                                        p.isEmptyObject(s) ||
                                            (E[F].easing = h.easing),
                        ...
                        i.element &&
                            ...
                            J.push(i),
                            "" === h.queue &&
                                ((g(f).tweensContainer = i), (g(f).opts = h)),
                            (g(f).isAnimating = !0),
                            y === x - 1
                                ? (t.State.calls.push([
                                      J,
                ...
                if (
                    ...
                    var x = o.length,
                        y = 0;
                    if (
                        !/^(stop|finish|finishAll)$/i.test(q) &&
                        !m.isPlainObject(s)
                    ) {
                        var z = n + 1;
                        s = {};
                        for (var A = z; A < arguments.length; A++)
                            ...
                            (!/^(fast|normal|slow)$/i.test(arguments[A]) &&
                                !/^\d/.test(arguments[A]))
                                ? p.isString(arguments[A]) ||
                                  p.isArray(arguments[A])
                                    ? (s.easing = arguments[A])
                                    : p.isFunction(arguments[A]) &&
                                      (s.complete = arguments[A])
                                    ...
                                    return (
                                        ...
                                        m.each(o, function (a, b) {
                                            parseFloat(E.stagger)
                                                ? (E.delay =
                                                      G +
                                                      parseFloat(E.stagger) * a)
                                                : p.isFunction(E.stagger) &&
                                                  (E.delay =
                                                      G +
                                                      E.stagger.call(b, a, x)),
                                                E.drag &&
                                                    ((E.duration =
                                                        parseFloat(F) ||
