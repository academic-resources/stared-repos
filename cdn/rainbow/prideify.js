...
Prideify.prototype.prideifyImage = function (image) {
    ...
    switch (typeof this.options.crossOriginProxy) {
        ...
        case "boolean":
            if (this.options.crossOriginProxy)
                tmpImage.src = "http://crossorigin.me/" + tmpImage.src;
    }
    ...
    tmpImage.onload = function () {
        ...
        if (typeof this.options.afterRender === "function")
            this.options.afterRender(image);
    }.bind(this);
};
...
Prideify.prototype._stripeThickness = function (image) {
    return (
        (this.options.vertical ? image.width : image.height) /
        this.stripes.length
    );
};
...
if (window.jQuery) {
    jQuery.fn.prideify = function (options) {
        Prideify(this, options);
    };
}
