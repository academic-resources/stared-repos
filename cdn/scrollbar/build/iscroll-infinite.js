...
(function (window, document, Math) {
  ...
  */
    ...
    function IScroll(el, options) {
        ...
        this.options.infiniteUseTransform =
            this.options.infiniteUseTransform && this.options.useTransform;
    ...
    IScroll.prototype = {
        ...
        refresh: function () {
            ...
            var limit;
            if (this.options.infiniteElements) {
                this.options.infiniteLimit =
                    this.options.infiniteLimit ||
                    Math.floor(2147483645 / this.infiniteElementHeight);
                limit =
                    -this.options.infiniteLimit * this.infiniteElementHeight +
                    this.wrapperHeight;
            }
            this.maxScrollY =
                limit !== undefined
            ...
            if (utils.hasPointer && !this.options.disablePointer) {
                ...
                this.wrapper.style[utils.style.touchAction] =
            ...
            this.on("refresh", function () {
                ...
                if (this.options.snap === true) {
                    ...
                    for (; i < l; i++) {
                        ...
                        if (
                            i === 0 ||
                            rect.left <= utils.getRect(el[i - 1]).left
                        ) {
                            m = 0;
                            n++;
                        }
        ...
        _initInfinite: function () {
            ...
            this.infiniteElementHeight = utils.getRect(
                this.infiniteMaster
            ).height;
            this.infiniteHeight =
                this.infiniteLength * this.infiniteElementHeight;
            ...
            this.on("refresh", function () {
                var elementsPerPage = Math.ceil(
                    this.wrapperHeight / this.infiniteElementHeight
                );
                this.infiniteUpperBufferSize = Math.floor(
                    (this.infiniteLength - elementsPerPage) / 2
                );
        ...
        reorderInfinite: function () {
            ...
            var minorPhase = Math.max(
                    Math.floor(-this.y / this.infiniteElementHeight) -
                        this.infiniteUpperBufferSize,
                    0
                ),
            ...
            while (i < this.infiniteLength) {
                top =
                    i * this.infiniteElementHeight +
                    majorPhase * this.infiniteHeight;
                ...
                if (this.infiniteElements[i]._top !== top) {
                    this.infiniteElements[i]._phase =
                        top / this.infiniteElementHeight;
            ...
            if (
                ...
                this.options.dataset.call(
                    this,
                    Math.max(
                        cachePhase * this.infiniteCacheBuffer -
        ...
        updateContent: function (els) {
            ...
            for (var i = 0, l = els.length; i < l; i++) {
                this.options.dataFiller.call(
                    this,
                    els[i],
                    this.infiniteCache[els[i]._phase]
                );
            }
        },
