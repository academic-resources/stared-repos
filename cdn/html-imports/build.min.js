 ...
 * https://modernizr.com/download/?-htmlimports-setclasses !*/
!(function (n, e, t) {
    function o(n, e) {
        return typeof n === e;
    }
    function s() {
        ...
        for (var u in f)
            if (f.hasOwnProperty(u)) {
                ...
                for (
                    s = o(e.fn, "function") ? e.fn() : e.fn, i = 0;
                    i < n.length;
                    i++
                )
                    (a = n[i]),
    ...
    function r(n, e) {
        if ("object" == typeof n) for (var t in n) c(n, t) && r(t, n[t]);
        else {
            n = n.toLowerCase();
            var o = n.split("."),
                s = Modernizr[o[0]];
    ...
    !(function () {
        ...
        c =
            o(n, "undefined") || o(n.call, "undefined")
                ? function (n, e) {
                      return (
                          e in n && o(n.constructor.prototype[e], "undefined")
                      );
                  }
                : function (e, t) {
                      return n.call(e, t);
        ...
        (u._trigger = function (n, e) {
            if (this._l[n]) {
                var t = this._l[n];
                setTimeout(function () {
                    var n, o;
                    for (n = 0; n < t.length; n++) (o = t[n])(e);
                }, 0),
                    delete this._l[n];
            }
        }),
        ...
        r("htmlimports", "import" in a("link")),
        s(),
        i(l),
        delete u.addTest,
