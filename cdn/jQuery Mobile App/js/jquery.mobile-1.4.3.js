    ...
    (function ($, undefined) {
        ...
        $.mobile.path = path = {
            ...
            isSameDomain: function (absUrl1, absUrl2) {
                return (
                    path.parseUrl(absUrl1).domain ===
                    path.parseUrl(absUrl2).domain
                );
            },
        ...
        $.widget("mobile.pagecontainer", {
            ...
            _handleNavigate: function (url, data) {
                ...
                var to = $.mobile.path.stripHash(url),
                    ...
                    transition =
                        history.stack.length === 0 ? "none" : undefined,
                ...
                $.extend(changePageOptions, data, {
                    transition:
                        (history.getLast() || {}).transition || transition,
                });
    ...
    (function ($, undefined) {
        $.widget("mobile.toolbar", $.mobile.toolbar, {
            ...
            _destroy: function () {
                ...
                $el.closest(".ui-page").removeClass(
