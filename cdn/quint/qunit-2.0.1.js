        ...
        hooks: function (handler) {
            ...
            function processHooks(test, module) {
                ...
                if (
                    ...
                    hooks.push(
                        test.queueHook(
                            module.testEnvironment[handler],
                            handler,
                            module
                        )
                    );
...
(function () {
    ...
    function applyUrlParams() {
        ...
        window.location = setUrl({
            ...
            moduleId:
                selectedModules.length === 0 ? undefined : selectedModules,
