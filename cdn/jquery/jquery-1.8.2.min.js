            ...
            c === "margin" && (f += p.css(a, c + bV[e], !0)),
                d
                    ? (c === "content" &&
                      ...
                      c !== "margin" &&
                          (f -=
                              parseFloat(bH(a, "border" + bV[e] + "Width")) ||
                              0))
                    : ((f += parseFloat(bH(a, "padding" + bV[e])) || 0),
                      c !== "padding" &&
                          (f +=
    ...
    (p.fn = p.prototype =
        {
            ...
            eq: function (a) {
                return (
                    (a = +a), a === -1 ? this.slice(a) : this.slice(a, a + 1)
                );
            },
            first: function () {
                return this.eq(0);
        ...
        p.extend({
                    ...
                    : (typeof b == "boolean" && ((c = b), (b = 0)),
                      ...
                      (d = v.exec(a))
                          ...
                          : ((d = p.buildFragment([a], b, c ? null : [])),
                            p.merge(
                                [],
                                (d.cacheable ? p.clone(d.fragment) : d.fragment)
                                    .childNodes
                            )));
            },
            ...
            each: function (a, c, d) {
                ...
                if (d) {
                    ...
                    for (; f < g; ) if (c.call(a[f], f, a[f++]) === !1) break;
                return a;
            },
            trim:
                o && !o.call("﻿ ")
    ...
    p.extend({
        ...
        data: function (a, c, d, e) {
            ...
            return (
                ...
                i
                    ? ((g = f[c]), g == null && (g = f[p.camelCase(c)]))
                    : (g = f),
                g
            );
        },
                    ...
                    : ((d = a.split(".", 2)),
                      ...
                      p.access(
                          ...
                          function (c) {
                              if (c === b)
                                  return (
                                      (k = this.triggerHandler("getData" + e, [
                                          d[0],
                                      ])),
                                      k === b &&
                                          i &&
            ...
            if (!arguments.length) {
                if (f)
                    return (
                        (c =
                            p.valHooks[f.type] ||
                            p.valHooks[f.nodeName.toLowerCase()]),
                    ...
                    (n = p.extend(
                        {
                            ...
                            selector: f,
                            needsContext:
                                f && p.expr.match.needsContext.test(f),
                            namespace: m.join("."),
                        },
                        o
                    )),
            ...
            if (!f || (f.nodeType !== 3 && f.nodeType !== 8)) {
                ...
                return (
                    ...
                    !g &&
                        ...
                        (!n._default ||
                            n._default.apply(f.ownerDocument, d) === !1) &&
                ...
                for (
                    ...
                    if (
                        ...
                        (c.data = l.data),
                            (c.handleObj = l),
                            (g = (
                                (p.event.special[l.origType] || {}).handle ||
                                l.handler
                            ).apply(i.elem, r)),
                            g !== b &&
                                ((c.result = g),
                        ...
                        if ((j = e[1])) {
                            ...
                            if (e[2])
                                return (
                                    w.apply(
                                        c,
                                        x.call(b.getElementsByTagName(a), 0)
                                    ),
                                    c
                                );
                            if ((j = e[3]) && _ && b.getElementsByClassName)
                                return (
                                    w.apply(
                                        c,
                                        x.call(b.getElementsByClassName(j), 0)
                                    ),
                                    c
                                );
                        }
                ...
                (e = bc.selectors =
                    {
                        ...
                        find: {
                            ...
                            CLASS:
                                ...
                                function (a, b, c) {
                                    if (
                                        typeof b.getElementsByClassName !== n &&
                                        !c
                                    )
    ...
    p.fn.extend({
        ...
        p.extend({
            ...
            style: function (a, c, d, e) {
                ...
                if (d === b)
                    return h && "get" in h && (f = h.get(a, !1, e)) !== b
                        ? f
                        : j[c];
                (g = typeof d),
                    g === "string" &&
            ...
            ((p.expr.filters.hidden = function (a) {
                return (
                    ...
                    (!p.support.reliableHiddenOffsets &&
                        ((a.style && a.style.display) || bH(a, "display")) ===
                            "none")
                );
            }),
            ...
            ajax: function (a, c) {
                function y(a, c, f, i) {
                    ...
                    (x.status = a),
                        ...
                        (r = b),
                        j &&
                            n.trigger("ajax" + (k ? "Success" : "Error"), [
                                x,
                                l,
                                k ? s : t,
                            ]),
    ...
    (p.Animation = p.extend(cW, {
        ...
        (cZ.prototype = {
            ...
            cur: function () {
                ...
                return a && a.get
                    ? a.get(this)
                    : cZ.propHooks._default.get(this);
            },
            run: function (a) {
                var b,
