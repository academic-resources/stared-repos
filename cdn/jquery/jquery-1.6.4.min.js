...
(function (a, b) {
    ...
    f.extend({
        ...
        data: function (a, c, d, e) {
            if (!!f.acceptData(a)) {
                ...
                j
                    ? ((h = g[c]), h == null && (h = g[f.camelCase(c)]))
                    : (h = g);
                return h;
            }
        },
    ...
    f.fn.extend({
        ...
        closest: function (a, b) {
            ...
            var l =
                S.test(a) || typeof a != "string" ? f(a, b || this.context) : 0;
            for (d = 0, e = this.length; d < e; d++) {
                g = this[d];
                while (g) {
