                ...
                for (
                    ...
                    if (
                        ...
                        (c.data = k.data),
                            (c.handleObj = k),
                            (g = (
                                (p.event.special[k.origType] || {}).handle ||
                                k.handler
                            ).apply(i.elem, q)),
                            g !== b &&
                                ((c.result = g),
                        ...
                        if ((j = e[1])) {
                            ...
                            if (e[2])
                                return (
                                    u.apply(
                                        c,
                                        t.call(b.getElementsByTagName(a), 0)
                                    ),
                                    c
                                );
                            if ((j = e[3]) && X && b.getElementsByClassName)
                                return (
                                    u.apply(
                                        c,
                                        t.call(b.getElementsByClassName(j), 0)
                                    ),
                                    c
                                );
                        }
            ...
            function bf(a, b, c) {
                ...
                for (; (d = a[g]); g++)
                    f.relative[d.part]
                        ...
                        : (e = be(
                              e,
                              f.filter[d.part].apply(
                                  null,
                                  d.captures.concat(b, c)
                              )
                          ));
                return e;
            }
