            ...
            c === "margin" && (f += p.css(a, c + bU[e], !0)),
                d
                    ? (c === "content" &&
                      ...
                      c !== "margin" &&
                          (f -=
                              parseFloat(bH(a, "border" + bU[e] + "Width")) ||
                              0))
                    : ((f += parseFloat(bH(a, "padding" + bU[e])) || 0),
                      c !== "padding" &&
                          (f +=
        ...
        (function (a, b) {
                ...
                for (; (d = a[f]); f++)
                    $.relative[d.part]
                        ...
                        : (d.captures.push(b, c),
                          (e = bi(
                              e,
                              $.filter[d.part].apply(null, d.captures)
                          )));
                return e;
            }
            function bk(a) {
            ...
            var c,
                ...
                R = function (a) {
                    return function (b) {
                        return (
                            b.nodeName.toLowerCase() === "input" && b.type === a
                        );
                    };
                },
                S = function (a) {
                            ...
                            if ((i = e[1])) {
                                ...
                                if (e[2])
                                    return (
                                        o.apply(
                                            c,
                                            n.call(b.getElementsByTagName(a), 0)
                                        ),
                                        c
                                    );
                ...
                for (g = b === e && bA; (h = a[s]) != null; s++) {
                    ...
                    if (typeof h == "string")
                        if (!br.test(h)) h = b.createTextNode(h);
                            ...
                            (g = g || bk(b)),
                                (l =
                                    l || g.appendChild(b.createElement("div"))),
                                (h = h.replace(bo, "<$1></$2>")),
    ...
    (p.Animation = p.extend(cV, {
        ...
        (cY.prototype = {
            ...
            cur: function () {
                ...
                return a && a.get
                    ? a.get(this)
                    : cY.propHooks._default.get(this);
            },
            run: function (a) {
                var b,
