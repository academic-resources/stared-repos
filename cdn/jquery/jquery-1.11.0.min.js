...
!(function (a, b) {
            ...
            if (n && !e) {
                if ((f = Z.exec(a)))
                    if ((h = f[1])) {
                        if (9 === i) {
                            if (
                                ((g = b.getElementById(h)), !g || !g.parentNode)
                            )
                                return d;
        ...
        function ub(a) {
            for (
                ...
                if ((c = d.relative[a[j].type])) m = [qb(rb(m), c)];
                    ...
                    if (
                        ((c = d.filter[a[j].type].apply(null, a[j].matches)),
                        c[s])
                    ) {
                        for (e = ++j; f > e; e++)
        ...
        function xb(a, b, e, f) {
            ...
            if (!f && 1 === m.length) {
                if (
                    ...
                    if (
                        ((b = (d.find.ID(j.matches[0].replace(ab, bb), b) ||
                            [])[0]),
                        !b)
                    )
                        return e;
            ...
            return (
                g(a, m)(f, b, !n, e, ($.test(a) && mb(b.parentNode)) || b), e
            );
        }
        return (
    ...
    function J() {
        z.addEventListener
            ...
            : (z.detachEvent("onreadystatechange", K),
    ...
    (n.event = {
        ...
        trigger: function (b, c, d, e) {
            ...
            if (
                ...
                3 !== d.nodeType &&
                    ...
                    (b = b[n.expando]
                        ? b
                        : new n.Event(p, "object" == typeof b && b)),
                    (b.isTrigger = e ? 2 : 3),
                    (b.namespace = q.join(".")),
                ...
                while ((f = h[b++]) && !a.isPropagationStopped()) {
                    ...
                    while (
                        ...
                        (!a.namespace_re || a.namespace_re.test(e.namespace)) &&
                            ...
                            (a.data = e.data),
                            (c = (
                                (n.event.special[e.origType] || {}).handle ||
                                e.handler
                            ).apply(f.elem, i)),
                            void 0 !== c &&
                                (a.result = c) === !1 &&
        ...
        l.changeBubbles ||
            (n.event.special.change = {
                ...
                teardown: function () {
                    return (
                        n.event.remove(this, "._change"), !Y.test(this.nodeName)
                    );
                },
            }),
        l.focusinBubbles ||
    ...
    n.extend({
        ...
        n.fn.extend({
            ...
            domManip: function (a, b) {
                ...
                if (
                    ...
                    for (
                        g = n.map(vb(i, "script"), yb), f = g.length;
                        k > j;
                        j++
                    )
                        (d = i),
        ...
        n.each(
            ...
            function (a, b) {
                n.fn[a] = function (a) {
                    for (
                        var c, d = 0, e = [], g = n(a), h = g.length - 1;
                        h >= d;
                        d++
                    )
        ...
        return (
            c ||
                ...
                ("none" !== c && c) ||
                    ...
                    (b = (Db[0].contentWindow || Db[0].contentDocument)
                        .document),
                    b.write(),
                    b.close(),
                    (c = Fb(a, b)),
                ...
                if (null == b) {
                    ...
                    (f =
                        ...
                        typeof e.style.zoom !== L &&
                            ((e.style.cssText =
                                d + ";width:1px;padding:1px;zoom:1"),
                            (e.innerHTML = "<div></div>"),
        ...
        function k() {
            ...
            h &&
                ...
                a.getComputedStyle &&
                    ...
                    (e =
                        "4px" ===
                        (a.getComputedStyle(c, null) || { width: "4px" })
                            .width)),
                h.removeChild(b),
                (c = h = null));
        }
                ...
                if (a && 3 !== f && 8 !== f && 2 !== f)
                    return typeof a.getAttribute === L
                        ...
                        : ((1 === f && n.isXMLDoc(a)) ||
                              ...
                              (d =
                                  n.attrHooks[b] ||
                                  (n.expr.match.bool.test(b) ? oc : nc))),
                          void 0 === c
        ...
        (n.expr.filters.hidden = function (a) {
            return (
                ...
                (!l.reliableHiddenOffsets() &&
                    "none" ===
                        ((a.style && a.style.display) || n.css(a, "display")))
            );
        }),
            ...
            return h || "jsonp" === b.dataTypes[0]
                ? ((e = b.jsonpCallback =
                  ...
                  d.always(function () {
                      (a[e] = f),
                          b[e] &&
                              ((b.jsonpCallback = c.jsonpCallback), ad.push(e)),
