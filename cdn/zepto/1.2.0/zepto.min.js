        ...
        return (
                              ...
                              if (1 === this.nodeType)
                                  if (R(t)) for (n in t) G(this, n, t[n]);
                                      ...
                                      G(
                                          this,
                                          t,
                                          Y(this, r, e, this.getAttribute(t))
                                      );
                          })
                        : 0 in this &&
                          1 == this[0].nodeType &&
                        ...
                        if (L(t)) {
                            ...
                            return (
                                r.each(t, function (t, e) {
                                    o[e] =
                                        i.style[O(e)] || s.getPropertyValue(e);
                                }),
                                o
                            );
                        }
                ...
                position: function () {
                    if (this.length) {
                        ...
                        return (
                            ...
                            (n.left -=
                                parseFloat(r(t).css("margin-left")) || 0),
                            (i.top +=
                                parseFloat(r(e[0]).css("border-top-width")) ||
                                0),
                            (i.left +=
                                parseFloat(r(e[0]).css("border-left-width")) ||
                                0),
            ...
            x.forEach(function (n, i) {
                ...
                (r.fn[n] = function () {
                    ...
                    (r.fn[o ? n + "To" : "insert" + (i ? "Before" : "After")] =
                        function (t) {
                ...
                return (
                    (n || !t.isDefaultPrevented) &&
                        ...
                        e.each(w, function (e, r) {
                            ...
                            (t[e] = function () {
                                return (
                                    (this[r] = b), i && i.apply(n, arguments)
                                );
                            }),
                                (t[r] = E);
                        }),
