...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.state = {
      board: new _minesweeper__WEBPACK_IMPORTED_MODULE_1__["Board"](SIZE, BOMBS)
    };
  ...
  _createClass(Game, [{
    ...
    key: "render",
    value: function render() {
      var message = this.gameOver() ? this.state.board.won() ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "You have won!") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "You have lost!") : "";
      var btn = this.gameOver() ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        onClick: this.restart.bind(this)
      }, "Play Again!") : "";
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "game"
      }, message, btn, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_board__WEBPACK_IMPORTED_MODULE_2__["default"], {
        board: this.state.board,
