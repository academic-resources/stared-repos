package com.lambdaschool.oauth2.logging;
...
{
    @Around(value = "@within(com.lambdaschool.oauth2.logging.Loggable) || @annotation(com.lambdaschool.oauth2.logging.Loggable)")
