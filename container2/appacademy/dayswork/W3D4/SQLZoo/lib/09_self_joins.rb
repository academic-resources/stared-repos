...
def craiglockhart_to_sighthill
  ...
  execute(<<-SQL)
    ...
    FROM routes AS a
    LEFT JOIN routes AS b ON (a.company = b.company AND a.num = b.num)
    LEFT JOIN stops AS stopb ON (stopb.id = b.stop_id)
    LEFT JOIN routes AS c ON (c.stop_id = stopb.id)
    LEFT JOIN routes AS d ON (c.company = d.company AND c.num = d.num)
    ...
    GROUP BY a.num, a.company, stopb.name, d.num, d.company
  SQL
end
