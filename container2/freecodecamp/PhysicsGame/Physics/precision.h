 ...
 * @file
 *
 * Because physics is designed to work at either single or double
 ...
 * physics at a different precision.
 */
...
namespace physics {
    ...
    /**
     * Defines a real number precision. physics can be compiled in
