 ...
 */
#ifndef PHYSICS_PWORLD_H
#define PHYSICS_PWORLD_H
...
namespace physics {
     ...
     */
    class GroundContacts : public physics::ParticleContactGenerator
    {
        physics::ParticleWorld::Particles *particles;

    public:
        void init(physics::ParticleWorld::Particles *particles);

        virtual unsigned addContact(physics::ParticleContact *contact,
            unsigned limit) const;
    };

} // namespace physics

#endif // physics_PWORLD_H
