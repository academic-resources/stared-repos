...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["style_id"], ["styles.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["template_id"], ["templates.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["field_id"], ["fields.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["template_id"], ["templates.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["resume_id"], ["resumes.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_tag_id"], ["user_tags.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
