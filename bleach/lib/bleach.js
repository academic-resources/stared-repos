...
var bleach = {
  ...
  sanitize: function (html, options) {
    ...
    if (
      (mode == "white" && list.indexOf("script") == -1) ||
    ...
    if (
      (mode == "white" && list.indexOf("style") == -1) ||
