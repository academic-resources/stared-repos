...
""",
        ...
        + [
            FTL.Message(
                ...
                value=REPLACE(
                    index, "Android", {"Android": TERM_REFERENCE("brand-name-android")}
                ),
            ),
            FTL.Message(
                id=FTL.Identifier("firefox-channel-ios"),
                value=REPLACE(index, "iOS", {"iOS": TERM_REFERENCE("brand-name-ios")}),
            ),
        ]
        + transforms_from(
            """
        ...
        [
            ...
            FTL.Message(
                ...
                value=REPLACE(
                    ...
                    {
                        "Firefox Developer Edition": TERM_REFERENCE(
            ...
            FTL.Message(
                ...
                value=REPLACE(
                    ...
                    {
                        "Developer Edition": TERM_REFERENCE(
