...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        recipe_parser = subparsers.add_parser(
            "recipe", description="Create migration recipe from template"
        )
        recipe_parser.add_argument("template", type=Path)

        ftl_parser = subparsers.add_parser(
            "ftl", description="Create Fluent file with existing recipe"
        )
        ...
        template_parser = subparsers.add_parser(
            "template", description="Create template_ftl.html file with existing recipe"
        )
