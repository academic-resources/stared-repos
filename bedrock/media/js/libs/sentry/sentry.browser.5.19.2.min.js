...
var Sentry = (function (t) {
    ...
    function N(t, n, r) {
        (t.exception = t.exception || {}),
            ...
            (t.exception.values[0].type =
                t.exception.values[0].type || r || "Error");
    }
    function C(t, n) {
        void 0 === n && (n = {});
        try {
    ...
    var q = Date.now(),
        ...
        H = (function () {
            if (S())
                try {
                    return ((t = module), (n = "perf_hooks"), t.require(n))
                        .performance;
                } catch (t) {
                    return L;
                }
            ...
            return r && r.now
                ? (void 0 === r.timeOrigin &&
                      (r.timeOrigin =
                          (r.timing && r.timing.navigationStart) || q),
                  r)
                : L;
        })();
    function F() {
            ...
            return (
                ...
                (t.prototype.W = function (t) {
                    (t.fingerprint = t.fingerprint
                        ...
                        : []),
                        this.H &&
                            (t.fingerprint = t.fingerprint.concat(this.H)),
                        t.fingerprint &&
        ...
        Ct = (function () {
            ...
            return (
                ...
                (t.prototype.captureEvent = function (t, n) {
                    var r = (this.J = _());
                    return (
                        this.G("captureEvent", t, e({}, n, { event_id: r })), r
                    );
                }),
                        ...
                        if (!(a <= 0)) {
                            var s = F(),
                                ...
                                h = u
                                    ...
                                    : f;
                            null !== h &&
                                r.scope.addBreadcrumb(h, Math.min(a, 100));
                        }
                    }
                }),
                (t.prototype.setUser = function (t) {
                ...
                (t.prototype.V = function (t) {
                    ...
                    if (
                        e &&
                        e.extensions &&
                        "function" == typeof e.extensions[t]
                    )
    ...
    var Xt = (function () {
            ...
            return (
                ...
                (t.prototype.getEnvelopeEndpointWithUrlEncodedAuth =
                    function () {
                ...
                (t.prototype.getReportDialogEndpoint = function (t) {
                    ...
                    for (var i in (e.push("dsn=" + n.toString()), t))
                        if ("user" === i) {
                            ...
                            t.user.name &&
                                e.push(
                                    "name=" + encodeURIComponent(t.user.name)
                                ),
                                t.user.email &&
                                    e.push(
                                        "email=" +
                                            encodeURIComponent(t.user.email)
                                    );
                        } else
                            e.push(
    ...
    function $t(t) {
        ...
        return (
            (function (t) {
                var n =
                        (t.defaultIntegrations && u(t.defaultIntegrations)) ||
                        [],
                    r = t.integrations,
                    e = [];
                if (Array.isArray(r)) {
        ...
        Gt = (function () {
            ...
            return (
                ...
                (t.prototype.st = function () {
                    return (
                        !1 !== this.getOptions().enabled && void 0 !== this.ot
                    );
                }),
                (t.prototype.ft = function (t, n, r) {
                    ...
                    r &&
                        r.captureContext &&
                        (a = Dt.clone(a).update(r.captureContext));
                    var s = ot.resolve(c);
                    return (
                        a && (s = a.applyToEvent(c, r)),
                        s.then(function (t) {
                            return "number" == typeof u && u > 0
                                ? i.lt(t, u)
                                : t;
                        })
                    );
            ...
            return (
                ...
                (t.prototype.wt = function (t) {
                    return (
                        void 0 === t && (t = {}),
                        {
                            ...
                            ignoreInternal:
                                void 0 === this.it.ignoreInternal ||
                                this.it.ignoreInternal,
                        }
                    );
                }),
                (t.prototype.Tt = function (t) {
                    ...
                    if (t.exception)
                        try {
                            ...
                            return (
                                V.error(
                                    "Cannot extract message for event " + R(t)
                                ),
                                []
                            );
                        }
                ...
                (t.prototype.kt = function (t) {
                    try {
                        ...
                        return (
                            V.error("Cannot extract url for event " + R(t)),
                            null
                        );
                    }
                }),
                ...
                (n = (function (t) {
                    ...
                    for (
                        ...
                        (n = e.exec(o[c]))
                            ...
                            a &&
                                (!a.func && a.line && (a.func = tn), u.push(a));
                    }
                    if (!u.length) return null;
                    return { message: fn(t), name: t.name, stack: u };
                })(t))
            )
                return sn(n, r);
        } catch (t) {}
        try {
            if (
                (n = (function (t) {
                    ...
                    return { message: fn(t), name: t.name, stack: i };
                })(t))
            )
                return sn(n, r);
        } catch (t) {}
        return { message: fn(t), name: t && t.name, stack: [], failed: !0 };
    }
    function sn(t, n) {
        try {
        ...
        xn = (function (n) {
            ...
            return (
                ...
                (i.prototype.bt = function () {
                    ...
                    var t = e({}, this.it.transportOptions, {
                        dsn: this.it.dsn,
                    });
                ...
                (i.prototype.eventFromException = function (n, r) {
                    var e = pn(n, (r && r.syntheticException) || void 0, {
                ...
                (i.prototype.eventFromMessage = function (n, r, e) {
                    ...
                    var i = yn(n, (e && e.syntheticException) || void 0, {
                        attachStacktrace: this.it.attachStacktrace,
                    });
                    return (
                        (i.level = r),
                ...
                throw (
                    ...
                    Pt(function (r) {
                        r.addEventProcessor(function (t) {
                            ...
                            return (
                                n.mechanism &&
                                    (N(r, void 0, void 0), C(r, n.mechanism)),
    ...
    var Tn = (function () {
            ...
            return (
                (n.prototype.setupOnce = function () {
                    (Error.stackTraceLimit = 50),
                        this.it.onerror &&
                            (V.log("Global Handler attached: onerror"),
                            this.It()),
        ...
        _n = (function () {
            ...
            return (
                ...
                (t.prototype.setupOnce = function () {
                    var t = O();
                    (this.it.setTimeout &&
                        Q(t, "setTimeout", this.qt.bind(this)),
                    this.it.setInterval &&
                        Q(t, "setInterval", this.qt.bind(this)),
                ...
                (t.prototype.setupOnce = function () {
                    It(function (n) {
                        if (qt().getIntegration(t)) {
                            if (!Cn.navigator || !Cn.location) return n;
                            var r = n.request || {};
                            return (
                                (r.url = r.url || Cn.location.href),
                                (r.headers = r.headers || {}),
                                (r.headers["User-Agent"] =
                                    Cn.navigator.userAgent),
                                e({}, n, { request: r })
                            );
                        }
                        return n;
        ...
        Un = (function (t) {
            function n(n) {
                return void 0 === n && (n = {}), t.call(this, xn, n) || this;
            }
            return (
                r(n, t),
    ...
    var Hn = {},
        Fn = O();
    Fn.Sentry && Fn.Sentry.Integrations && (Hn = Fn.Sentry.Integrations);
    var Pn = e({}, Hn, Zt, An);
    return (
        (t.BrowserClient = Un),
        (t.Hub = Ct),
        ...
        (t.showReportDialog = function (t) {
            void 0 === t && (t = {}),
                t.eventId || (t.eventId = qt().lastEventId());
            var n = qt().getClient();
