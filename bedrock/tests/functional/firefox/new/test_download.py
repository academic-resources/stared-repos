...
@pytest.mark.skip_if_firefox(
    reason="http://saucelabs.com/jobs/5a8a62a7620f489d92d6193fa67cf66b"
)
@pytest.mark.skip_if_internet_explorer(
    reason="https://github.com/SeleniumHQ/selenium/issues/448"
)
@pytest.mark.nondestructive
...
@pytest.mark.skip_if_not_firefox(
    reason="Join Firefox form is only displayed to Firefox users"
)
