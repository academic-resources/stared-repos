...
@pytest.mark.skip_if_firefox(
    reason="Download button is displayed only to non-Firefox users"
)
...
@pytest.mark.skip_if_not_firefox(
    reason="App Store badges are displayed only to Firefox users"
)
...
@pytest.mark.skip_if_not_firefox(
    reason="Facebook Container button is displayed only to Firefox users"
)
