...
UA_IOS = {
    "User-Agent": "Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3 like Mac OS X; de-de) "
...
URLS = flatten(
    (
        ...
        url_test(
            ...
            query={"utm_medium": "referral", "utm_source": "mozilla.org"},
        ),
        # bug 874913
        url_test(
            "/en-US/{,products/}download.html{,?stuff=whatnot}", "/en-US/firefox/new/"
        ),
        ...
        # bug 874526, 877698
        url_test(
            "/projects/security/components/any-random-thing",
        ...
        # bug 964107
        url_test(
            "/firefox/video/random/stuff/", "https://www.youtube.com/firefoxchannel"
        ),
        # bug 948520
        url_test(
            "/firefox/livebookmarks/random/stuff/",
            "https://support.mozilla.org/kb/Live%20Bookmarks",
        ),
        # bug 782333
        url_test(
            "/firefox/backtoschool/",
        ...
        url_test(
            "/ports/other-things/", "http://www-archive.mozilla.org/ports/other-things/"
        ),
        # bug 1205632
        url_test(
            "/js/language/",
        ...
        url_test(
            "/js/language/E262-3-errata.html",
        ...
        url_test(
            "/plugincheck/more_info.html",
            "https://support.mozilla.org/kb/npapi-plugins/",
        ),
        # bug 854561, Issue 7448
        url_test(
            "/projects/mozilla-based{.html,/}",
            "https://developer.mozilla.org/docs/Archive/List_of_Mozilla-Based_Applications",
        ),
        url_test(
            "/about/mozilla-based/",
            "https://developer.mozilla.org/docs/Archive/List_of_Mozilla-Based_Applications",
        ...
        url_test(
            "/firefox/android/nightly/all/", "/firefox/all/#product-android-nightly"
        ),
        url_test(
            "/projects/firefox/3.6.10/whatsnew/bunny-lebowski/",
            "/firefox/3.6.10/whatsnew/bunny-lebowski/",
        ),
        url_test("/projects/firefox/4.0/firstrun/", "/firefox/4.0/firstrun/"),
        url_test(
            "/projects/firefox/4.0a2/firstrun/stuff", "/firefox/nightly/firstrun/stuff"
        ),
        # bug 1275483
        ...
        url_test(
            "/{beta,aurora,nightly}/",
            "/firefox/channel/desktop/#{beta,aurora,nightly}",
            resp_headers={"Cache-Control": "max-age=0"},
        ),
        url_test(
        ...
        url_test(
            "/firefox/all-{beta,rc}{/,.html}", "/firefox/all/#product-desktop-beta"
        ),
        url_test(
            "/firefox/all-aurora{/,.html}", "/firefox/all/#product-desktop-developer"
        ),
        url_test(
            "/firefox/aurora/{notes,system-requirements}/",
            "/firefox/developer/{notes,system-requirements}/",
        ),
        url_test(
            "/firefox/organizations/all.html", "/firefox/all/#product-desktop-esr"
        ),
        # bug 729329
        url_test("/mobile/sync/is/da/best/", "/firefox/sync/"),
        # bug 882845
        url_test(
            "/firefox/toolkit/download-to-your-devices/because-i-say-so/",
            "/firefox/new/",
        ),
        # bug 1014823
        url_test(
            "/pt-BR/{products/,}firefox/releases/whatsnew/", "/pt-BR/firefox/whatsnew/"
        ),
        # bug 929775
        url_test(
        ...
        # bug 868182
        url_test(
            "/firefox/mobile/faq/?os=firefox-os",
            "https://support.mozilla.org/products/firefox-os",
        ),
        # Bug 986174
        url_test("/{m,{firefox/,}mobile}/features/", "/firefox/mobile/"),
        url_test(
            "/{m,{firefox/,}mobile}/faq/", "https://support.mozilla.org/products/mobile"
        ),
        # bug 885799, 952429
        url_test(
            "/projects/calendar/holidays.html",
            "https://www.thunderbird.net/calendar/holidays/",
        ),
        url_test(
            "/en-US/projects/calendar/random/stuff/",
        ...
        url_test(
            ...
            "https://www.thunderbird.net/thunderbird/52.6.0/releasenotes/",
        ),
        url_test(
            "/thunderbird/52.6.0/system-requirements/",
            "https://www.thunderbird.net/thunderbird/52.6.0/system-requirements/",
        ),
        # bug 1211007
        url_test("/thunderbird/download", "https://www.thunderbird.net/"),
        # bug 1124038
        url_test(
            "/thunderbird/organizations/{all-esr.html,faq/}",
            "https://www.thunderbird.net/organizations/",
        ),
        # bug 1123399, 1150649
        url_test(
            "/thunderbird/all.htm", "https://www.thunderbird.net/thunderbird/all/"
        ),
        url_test(
            "/thunderbird/all-beta.html",
            "https://www.thunderbird.net/thunderbird/beta/all/",
        ),
        url_test(
            "/thunderbird/early_releases/downloads/",
            "https://www.thunderbird.net/thunderbird/beta/all/",
        ),
        url_test(
            "/thunderbird/early_releases/",
            "https://www.thunderbird.net/thunderbird/beta/all/",
        ),
        ...
        # bug 1124042
        url_test(
            "/thunderbird/features/email_providers.html",
            "https://www.thunderbird.net/email-providers/",
        ),
        # bug 1133266
        url_test("/thunderbird/legal/privacy/", "/privacy/thunderbird/"),
        url_test(
            "/thunderbird/about/privacy-policy/",
            "/privacy/archive/thunderbird/2010-06/",
        ),
        # bug 1196578
        url_test("/thunderbird/about/legal/eula/", "/about/legal/eula/"),
        url_test(
            "/thunderbird/about/legal/eula/thunderbird2.html",
            "/about/legal/eula/thunderbird-2/",
        ),
        url_test(
            "/thunderbird/about/legal/eula/thunderbird.html",
        ...
        url_test(
            "/thunderbird/about/{careers,contact,get-involved}/",
        ...
        url_test(
            "/firefox/{46.0,46.0.1,46.0a1,46.0a2}/hello/start",
        ...
        # bug 876810
        url_test(
            "/hacking/commit-access-policy/",
            "/about/governance/policies/commit/access-policy/",
        ),
        url_test(
            "/hacking/committer/{,faq.html}", "/about/governance/policies/commit/"
        ),
        ...
        url_test(
            "/hacking/notification/acceptance-email.txt",
            "https://static.mozilla.com/foundation/documents/commit-access/acceptance-email.txt",
        ),
        # bug 1165344
        url_test(
            "/hacking/CVS-Contributor-Form.{pdf,ps}",
            "/about/governance/policies/commit/",
        ),
        url_test(
            "/hacking/{form,getting-cvs-write-access}.html",
            "/about/governance/policies/commit/",
        ),
        url_test(
        ...
        url_test(
            "/hacking/rules.html", "https://developer.mozilla.org/docs/mozilla-central"
        ),
        url_test(
            "/hacking/{module-ownership,reviewers}.html",
            "/about/governance/policies/{module-ownership,reviewers}/",
        ),
        url_test(
            "/hacking/regression-policy.html", "/about/governance/policies/regressions/"
        ),
        # Bug 1040970
        url_test(
            "/mozillacareers",
        ...
        url_test(
            "/firefox/{performance,happy,speed,memory}/", "/firefox/features/fast/"
        ),
        ...
        url_test(
            "/press/mozilla-2004-09-14-02.html",
        ...
        url_test(
            "/press/mozilla-2004-10-01-02.html",
        ...
        url_test(
            "/press/mozilla-2006-10-24-02.html",
        ...
        url_test(
            "/about/policies/participation.html",
        ...
        # bug 818321
        url_test(
            "/projects/security/tld-idn-policy-list.html",
            "https://wiki.mozilla.org/IDN_Display_Algorithm",
        ),
        url_test(
            "/projects/security/membership-policy.html",
            "/about/governance/policies/security-group/membership/",
        ),
        url_test(
            "/projects/security/secgrouplist.html",
            "/about/governance/policies/security-group/",
        ),
        url_test(
            "/projects/security/security-bugs-policy.html",
            "/about/governance/policies/security-group/bugs/",
        ),
        # bug 818316, 1128579
        url_test(
            "/projects/security/certs/",
            "/about/governance/policies/security-group/certs/",
        ),
        url_test(
            "/projects/security/certs/included/",
            "https://wiki.mozilla.org/CA:IncludedCAs",
        ),
        url_test(
            "/projects/security/certs/pending/",
            "https://wiki.mozilla.org/CA:PendingCAs",
        ),
        url_test(
            "/about/governance/policies/security-group/certs/included/",
            "https://wiki.mozilla.org/CA:IncludedCAs",
        ),
        url_test(
            "/about/governance/policies/security-group/certs/pending/",
            "https://wiki.mozilla.org/CA:PendingCAs",
        ),
        url_test(
        ...
        url_test(
            "/projects/security/certs/policy/EnforcementPolicy.html",
            "/about/governance/policies/security-group/certs/policy/enforcement/",
        ),
        url_test(
            "/projects/security/certs/policy/MaintenancePolicy.html",
            "/about/governance/policies/security-group/certs/policy/maintenance/",
        ),
        url_test(
            "/projects/security/certs/policy/InclusionPolicy.html",
        ...
        url_test(
            "/projects/security/older-vulnerabilities.html",
            "/security/known-vulnerabilities/older-vulnerabilities/",
        ),
        # bug 1017564
        url_test(
            "/mobile/RANDOM-STUFF/system-requirements/",
            "https://support.mozilla.org/kb/will-firefox-work-my-mobile-device",
        ),
        ...
        url_test(
            "/security/iSECPartners_Phishing.pdf",
            "http://website-archive.mozilla.org/www.mozilla.org/security/security"
        ...
        url_test(
            "/MPL/boilerplate-1.1/stuff.html",
        ...
        url_test(
            "/mobile/{23,28,29}.0/releasenotes/",
            "/firefox/android/{23,28,29}.0/releasenotes/",
        ),
        url_test(
            "/mobile/{3,4}2.0beta/{aurora,release}notes/",
            "/firefox/android/{3,4}2.0beta/{aurora,release}notes/",
        ),
        # bug 724682
        url_test(
            "/projects/mathml/demo/texvsmml.html",
        ...
        url_test(
            "/mobile/{{beta,aurora}/,}notes/",
            "/firefox/android/{{beta,aurora}/,}notes/",
        ),
        url_test(
            "/firefox/{{beta,aurora,organizations}/,}system-requirements.html",
        ...
        url_test(
            "/contribute/local/northamerica.html", "/contact/communities/north-america/"
        ),
        url_test("/contribute/local/europe.html", "/contact/communities/europe/"),
        url_test(
            "/contribute/local/latinamerica.html", "/contact/communities/latin-america/"
        ),
        url_test(
            "/contribute/local/africamideast.html",
            "/contact/communities/africa-middle-east/",
        ),
        url_test(
            "/contribute/local/asia.html", "/contact/communities/asia-south-pacific/"
        ),
        url_test(
            "/contribute/local/southpole.html", "/contact/communities/antarctica/"
        ),
        # bug 1393622
        ...
        # bug 878926
        url_test(
            "/{de/,}firefoxflicks/{,stuff}",
            "https://firefoxflicks.mozilla.org/{de/,}{,stuff}",
        ),
        # bug 849426
        url_test("/about/history.html", "/about/history/"),
        url_test(
            "/about/bookmarks.html", "https://wiki.mozilla.org/Historical_Documents"
        ),
        ...
        # bug 856077
        url_test(
            "/projects/toolkit/", "https://developer.mozilla.org/docs/Toolkit_API"
        ),
        # bug 877165
        ...
        # Bug 1209643
        url_test(
            "/legal/bylaws_amendment_1.html",
            "/foundation/documents/bylaws-amendment-1/",
        ),
        url_test(
            "/legal/bylaws_amendment_2.html",
            "/foundation/documents/bylaws-amendment-2/",
        ),
        url_test(
            "/legal/articles.html", "/foundation/documents/articles-of-incorporation/"
        ),
        url_test(
            "/legal/amendment.html",
        ...
        # bug 790784
        url_test(
            "/{about/policies/,foundation/,}privacy-policy{/,.html,}",
            "/privacy/websites/",
        ),
        url_test(
            "/privacy-policy.pdf",
        ...
        url_test(
            "/legal/privacy/firefox-third-party",
            "/privacy/archive/firefox/third-party/",
        ),
        url_test("/legal/privacy/notices-firefox", "/legal/firefox/"),
        url_test(
            "/privacy/policies/{facebook,firefox-os,websites}/",
        ...
        # bug 1034859
        url_test(
            "/en-US/about/buttons/dude.jpg", "/media/img/careers/buttons/dude.jpg"
        ),
        # bug 1003737
        ...
        url_test(
            "/{en-US,fr,ja}/about/legal/impressum/",
        ...
        # working.)
        url_test(
            "/foundation/documents/random-stuff.pdf",
            "https://static.mozilla.com/foundation/documents/random-stuff.pdf",
        ),
        url_test(
            "/foundation/donate_form.pdf",
        ...
        url_test(
            "/foundation/{about,careers,licensing,moco,mocosc}.html",
        ...
        url_test(
            "/foundation/documents/{index,mozilla-2002-financial-faq}.html",
        ...
        # bug 1239960, 1329931
        url_test(
            "/firefox/partners/", "https://support.mozilla.org/products/firefox-os"
        ),
        ...
        url_test(
            "/mobile/37.0{,beta,a2}/releasenotes",
            "/firefox/android/37.0{,beta,a2}/releasenotes/",
        ),
        ...
        # Bug 804810
        url_test(
            "/foundation/identity-guidelines/{,index.html}",
            "https://mozilla.design/mozilla/",
        ),
        # Bug 1243060
        url_test(
            "/firefox/tiles/", "https://support.mozilla.org/kb/about-tiles-new-tab"
        ),
        # Bug 1252332
        ...
        url_test(
            "/projects/string/", "https://developer.mozilla.org/en/XPCOM_string_guide"
        ),
        ...
        url_test(
            "/projects/webservices/examples/babelfish-wsdl/",
            "https://developer.mozilla.org/docs/SOAP_in_Gecko-based_Browsers",
        ),
        url_test(
            "/projects/xbl/", "https://developer.mozilla.org/docs/Mozilla/Tech/XBL"
        ),
        url_test(
            "/projects/xforms/", "https://developer.mozilla.org/docs/Archive/Web/XForms"
        ),
        url_test(
            "/projects/xpcom/", "https://developer.mozilla.org/docs/Mozilla/Tech/XPCOM"
        ),
        url_test(
            "/projects/xpinstall/",
        ...
        url_test(
            "/projects/xul/", "https://developer.mozilla.org/docs/Mozilla/Tech/XUL"
        ),
        ...
        url_test(
            "/research/{,projects/,researchers/}", "https://research.mozilla.org/"
        ),
        # Bug 1260423
        url_test("/firefox/choose", "/firefox/new/"),
        url_test(
            "/firefox/{,46.0/,46.0.1/,47.0/,47.0.1/}secondrun", "/firefox/mobile/"
        ),
        # bug 1288647, 1722760
        ...
        # Bug 1293539
        url_test(
            "/firefox/{48.0,48.0.1,49.0a1,49.0a2}/tour",
        ...
        # Bug 1262593
        url_test(
            "/unix/remote.html", "http://www-archive.mozilla.org/unix/remote.html"
        ),
        # Bug 1313023
        ...
        url_test(
            "/digital-inclusion", "https://foundation.mozilla.org/internet-health/"
        ),
        # Bug 1333146
        ...
        # Bug 1329931
        url_test(
            "/firefox/os/{,devices/}", "https://support.mozilla.org/products/firefox-os"
        ),
        # Bug 1324504
        url_test(
            "/contribute/studentambassadors/{,join/,thanks/}",
        ...
        url_test(
            ...
            "/privacy/archive/persona/2017-07/#terms-of-service",
        ),
        # Bug 1386112
        url_test(
            "/firefox/android/faq/", "https://support.mozilla.org/products/mobile"
        ),
        # bug 1392796
        ...
        # bug 960651, 1436973
        url_test(
            "/{firefox,mobile}/{5.0,5.0.1,4.0beta,latest}/details/{,index.html,from-3.6.html}",
            "/firefox/unsupported-systems/",
        ),
        url_test(
            "/firefox/unsupported/{,warning/,details/,EOL/,mac/,win/}",
            "/firefox/unsupported-systems/",
        ),
        # Bug 1428783
        url_test(
        ...
        url_test(
            "/firefox/geolocation/",
            "https://support.mozilla.org/kb/does-firefox-share-my-location-web-sites",
        ),
        ...
        url_test(
            "/teach/{,smarton/}", "https://foundation.mozilla.org/internet-health/"
        ),
        url_test(
            "/teach/smarton/{tracking,security,surveillance}/",
        ...
        url_test(
            "/foundation/documents/domain-name-license.pdf",
            "/foundation/trademarks/policy/",
        ),
        url_test(
            "/about/partnerships/distribution/",
            "/foundation/trademarks/distribution-policy/",
        ),
        url_test(
            "/foundation/trademarks/poweredby/faq/", "/foundation/trademarks/policy/"
        ),
        url_test(
            "/foundation/trademarks/l10n-website-policy/",
            "/foundation/trademarks/policy/",
        ),
        # Issue 6209
        ...
        url_test(
            ...
            "https://foundation.mozilla.org/about/public-records/",
        ),
        ...
        url_test(
            "/contribute/task/{,devtools-challenger/, firefox-mobile/}",
        ...
        # Issue 7436
        url_test(
            "/firefox/feedback/", "https://support.mozilla.org/questions/new/desktop"
        ),
        # Issue 7491
        ...
        # Issue #8206
        url_test(
            "/firefox/{69.0/,69.0.1/,69.0a2/,69.0.1a1/,}tracking-protection/start/",
            "https://support.mozilla.org/kb/tracking-protection",
        ),
        url_test(
            "/firefox/{69.0/,69.0.1/,69.0a2/,69.0.1a1/,}content-blocking/start/",
            "https://support.mozilla.org/kb/content-blocking",
        ),
        # Issue 7840
        url_test("/developer/", "https://developer.mozilla.com/"),
        url_test(
            "/developer/browsertest/",
            "https://developer.mozilla.org/docs/Learn/Tools_and_testing/Cross_browser_testing/Automated_testing",
        ),
        url_test(
            "/developer/css-grid/",
            "https://developer.mozilla.org/docs/Learn/CSS/CSS_layout/Grids",
        ...
        # issue 8596
        url_test(
            "/firefox/xr/", "https://support.mozilla.org/kb/webxr-permission-info-page"
        ),
        # bug 1404926, Issue 8418
        url_test(
            "/styleguide/identity/firefox-family/{,overview/}",
            "https://mozilla.design/firefox/",
        ),
        url_test(
            "/styleguide/identity/firefox/branding/", "https://mozilla.design/firefox/"
        ),
        url_test(
            "/styleguide/identity/firefox/channels/", "https://mozilla.design/firefox/"
        ),
        url_test(
            "/styleguide/identity/firefox/color/", "https://mozilla.design/firefox/"
        ),
        # Bug 1255785, Issue 8418
        url_test(
            "/styleguide/identity/mozilla/logo-prototype/",
            "https://mozilla.design/mozilla/",
        ),
        ...
        url_test(
            "/styleguide/identity/mozilla/branding/", "https://mozilla.design/mozilla/"
        ),
        url_test(
            "/styleguide/identity/mozilla/color/", "https://mozilla.design/mozilla/"
        ),
        # Bug 1329931, Issue 8418
        url_test(
            "/styleguide/products/firefox-os/{,subpages/}",
            "https://mozilla.design/firefox/",
        ),
        # Bug 1329931 & 1342043, Issue 8418
        url_test(
            "/styleguide/identity/firefoxos/{,subpages/}",
            "https://mozilla.design/firefox/",
        ),
        ...
        # Issue 8419
        url_test(
            "/firefox/this-browser-comes-highly-recommended/", "/firefox/developer/"
        ),
        # Issue 8420
        url_test(
            "/firefox/dedicated-profiles/",
            "https://support.mozilla.org/kb/dedicated-profiles-firefox-installation",
        ),
        # Issue 8668
        url_test(
            "/contact/communities/{,north-america/,canada/}",
            "https://community.mozilla.org/groups/",
        ),
        # Issue 8641
        url_test(
            "/technology/what-is-a-browser/", "/firefox/browsers/what-is-a-browser/"
        ),
        url_test(
            "/technology/update-your-browser/", "/firefox/browsers/update-your-browser/"
        ),
        url_test(
            "/technology/incognito-browser/", "/firefox/browsers/incognito-browser/"
        ),
        ...
        # Issue 8536
        url_test(
            "/etc/firefox/retention/{thank-you-a/,thank-you-b/,thank-you-referral/}",
        ...
        # Issue 8375
        url_test(
            "/internet-health/{,privacy-security/}",
            "https://foundation.mozilla.org/internet-health/",
        ),
        # Issue 8949
        url_test(
            "/donate/",
            "https://donate.mozilla.org/?utm_source=mozilla.org&utm_content=shortlink",
        ),
        url_test(
            "/about/governance/policies/security/plugin-whitelist-policy/",
        ...
        # Unfck campaign
        url_test(
            "/firefox/{unfuck,love,liebe,rendonslenetplusnet}/", "/firefox/unfck/"
        ),
