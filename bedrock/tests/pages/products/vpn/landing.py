...
class VPNLandingPage(BasePage):
    ...
    # Hero
    _get_vpn_hero_button_locator = (
        By.CSS_SELECTOR,
        ".vpn-hero .js-vpn-scroll-to-pricing .mzp-c-button",
    )
    _join_waitlist_hero_button_locator = (
        By.CSS_SELECTOR,
        ".vpn-hero .js-vpn-waitlist .mzp-c-button",
    )

    # Navigation
    _get_vpn_navigation_button_locator = (
        By.CSS_SELECTOR,
        ".c-navigation-shoulder .js-vpn-scroll-to-pricing .mzp-c-button",
    )
    _join_waitlist_navigation_button_locator = (
        By.CSS_SELECTOR,
        ".c-navigation-shoulder .js-target-navigation-cta .mzp-c-button",
    )

    # Pricing section
    _get_vpn_monthly_button_locator = (
        By.CSS_SELECTOR,
        ".vpn-pricing-monthly .mzp-c-button",
    )
    _get_vpn_6_months_button_locator = (
        By.CSS_SELECTOR,
        ".vpn-pricing-6-months .mzp-c-button",
    )
    _get_vpn_12_months_button_locator = (
        By.CSS_SELECTOR,
        ".vpn-pricing-12-months .mzp-c-button",
    )

    # Waitlist features section
    _join_waitlist_features_button_locator = (
        By.CSS_SELECTOR,
        ".js-vpn-waitlist-feature-block .mzp-c-button",
    )

    # Connect section
    _get_vpn_conntect_now_button_locator = (
        By.CSS_SELECTOR,
        ".js-connect-to-countries-and-servers .js-vpn-scroll-to-pricing .mzp-c-button",
    )
    _join_waitlist_coming_soon_button_locator = (
        By.CSS_SELECTOR,
        ".js-more-countries-coming-soon .mzp-c-button",
    )

    # Footer
    _get_vpn_footer_button_locator = (
        By.CSS_SELECTOR,
        ".vpn-footer .js-vpn-scroll-to-pricing .mzp-c-button",
    )
    _join_waitlist_footer_button_locator = (
        By.CSS_SELECTOR,
        ".vpn-footer .js-vpn-waitlist .mzp-c-button",
    )
    ...
    def is_join_waitlist_coming_soon_button_displayed(self):
        return self.is_element_displayed(
            *self._join_waitlist_coming_soon_button_locator
        )
