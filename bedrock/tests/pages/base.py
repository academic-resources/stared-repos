...
class BasePage(ScrollElementIntoView, Page):
    ...
    def wait_for_page_to_load(self):
        ...
        browser_version = self.selenium.capabilities.get(
            "browserVersion"
    ...
    class Navigation(BaseRegion):
        ...
        _firefox_menu_locator = (
            By.CSS_SELECTOR,
            '.c-menu-title[aria-controls="c-menu-panel-firefox"]',
        )
        _products_menu_locator = (
            By.CSS_SELECTOR,
            '.c-menu-title[aria-controls="c-menu-panel-products"]',
        )
        _about_menu_locator = (
            By.CSS_SELECTOR,
            '.c-menu-title[aria-controls="c-menu-panel-about"]',
        )
        _innovation_menu_locator = (
            By.CSS_SELECTOR,
            '.c-menu-title[aria-controls="c-menu-panel-innovation"]',
        )
        _firefox_desktop_page_locator = (
            By.CSS_SELECTOR,
            '.c-menu-item-link[data-link-name="Firefox Desktop Browser"]',
        )
        _developer_edition_page_locator = (
            By.CSS_SELECTOR,
            '.c-menu-item-link[data-link-name="Firefox Developer Edition"]',
        )
        _manifesto_page_locator = (
            By.CSS_SELECTOR,
            '.c-menu-item-link[data-link-name="Mozilla Manifesto"]',
        )
        _firefox_download_button_locator = (
            By.CSS_SELECTOR,
            "#protocol-nav-download-firefox > .download-link",
        )
        _mozilla_vpn_button_locator = (
            By.CSS_SELECTOR,
        ...
        def is_displayed(self):
            ...
            return self.find_element(
                *self._menu_locator
            ).is_displayed() and "is-active" in toggle.get_attribute("class")
        ...
        def open_firefox_desktop_page(self):
            ...
            self.page.set_attribute(
                link, att_name="href", att_value=href + "?automation=true"
            )
            link.click()
