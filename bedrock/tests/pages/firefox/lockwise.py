...
class LockwisePage(BasePage):
    ...
    _app_store_button_locator = (
        By.CSS_SELECTOR,
        '.mobile-download-buttons > a[data-cta-text="apple-app-store"]',
    )
    _play_store_button_locator = (
        By.CSS_SELECTOR,
        '.mobile-download-buttons > a[data-cta-text="google-play-store"]',
    )
