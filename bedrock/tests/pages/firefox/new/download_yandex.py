...
class YandexDownloadPage(BasePage):
    ...
    def is_yandex_download_button_displayed(self):
        ...
        return button.is_displayed() and "https://yandex.ru/firefox/mozilla/" in button.get_attribute(
            "href"
        )
