...
class FirefoxReleaseNotesPage(BasePage):
    ...
    _secondary_download_button_aurora_locator = (
        By.ID,
        "download-dev-edition-secondary",
    )
    _primary_download_button_dev_edition_locator = (
        By.ID,
        "download-dev-edition-primary",
    )
    _secondary_download_button_dev_edition_locator = (
        By.ID,
        "download-dev-edition-secondary",
    )
    ...
    _primary_download_button_android_beta_locator = (
        By.ID,
        "download-android-beta-primary",
    )
    _secondary_download_button_android_beta_locator = (
        By.ID,
        "download-android-beta-secondary",
    )
    _primary_download_button_android_nightly_locator = (
        By.ID,
        "download-android-nightly-primary",
    )
    _secondary_download_button_android_nightly_locator = (
        By.ID,
        "download-android-nightly-secondary",
    )
