    ...
    describe("updateBouncerLinks", function () {
        ...
        beforeEach(function () {
            var downloadMarkup =
                ...
                '<li><a id="link-transitional" class="download-link" data-download-version="win" href="' +
                transitionalUrl +
                '" data-direct-link="' +
                winUrl +
                '">Download</a></li>' +
                '<li><a id="link-direct-win" class="download-link" data-download-version="win" href="' +
                winUrl +
                '">Download</a></li>' +
                '<li><a id="link-direct-win64" class="download-link" data-download-version="win64" href="' +
                win64Url +
                '">Download</a></li>' +
                "</ul>";
