...
describe("mozilla-client.js", function () {
    ...
    describe("isFirefoxOutOfDate", function () {
        it("should return true if client version is equal to or less than the major version considered out of date", function () {
            ...
            var result3 = Mozilla.Client.isFirefoxOutOfDate(
                "54.0a1",
                2,
                "56.0.1a1"
            );
            ...
            var result4 = Mozilla.Client.isFirefoxOutOfDate(
                "55.0.1",
                1,
                "56.0"
            );
        ...
        it("should return false if client version is greater than the major version considered out of date", function () {
            ...
            var result2 = Mozilla.Client.isFirefoxOutOfDate(
                "58.0a2",
                2,
                "56.0.1"
            );
    ...
    describe("isFirefoxURLOutOfDate", function () {
        it("should return true if URL version is equal to or less than the major version considered out of date", function () {
            var result = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                "/firefox/54.0/",
                "56.0"
            );
            ...
            var result2 = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                "/firefox/54.0a1/",
                "56.0"
            );
            ...
            var result3 = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                "/firefox/54.0a2/",
                "56.0"
            );
            ...
            var result4 = Mozilla.Client.isFirefoxURLOutOfDate(
                1,
                "/firefox/55.0.1/",
                "56.0"
            );
            ...
            var result5 = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                "/firefox/53.0/",
                "56.0"
            );
