...
urlpatterns = (
    ...
    url(
        ...
        LegalDocView.as_view(
            template_name="legal/terms/betterweb.html",
            legal_doc_name="better_web_terms",
        ),
    ...
    url(
        r"^terms/mozilla/$",
        LegalDocView.as_view(
            template_name="legal/terms/mozilla.html", legal_doc_name="Websites_ToU"
        ),
    ...
    url(
        r"^terms/mozilla-vpn/$",
        LegalDocView.as_view(
            template_name="legal/terms/mozilla-vpn.html",
            legal_doc_name="Mozilla_VPN_ToS",
        ),
    ...
    url(
        ...
        LegalDocView.as_view(
            ...
            legal_doc_name="firefox_about_rights",
        ),
    ...
    url(
        ...
        LegalDocView.as_view(
            template_name="legal/terms/firefox-lite.html",
            legal_doc_name="firefox_lite_contentservices_ToS",
        ),
    ...
    url(
        ...
        LegalDocView.as_view(
            template_name="legal/terms/firefox-lite-reward.html",
            legal_doc_name="firefox_lite_contentservices_reward",
        ),
    ...
    url(
        ...
        LegalDocView.as_view(
            template_name="legal/terms/firefox-reality.html",
            legal_doc_name="firefox_reality_about_rights",
        ),
    ...
    url(
        ...
        LegalDocView.as_view(
            template_name="legal/terms/firefox-private-network.html",
            legal_doc_name="Firefox_Private_Network_ToS",
        ),
    ...
    url(
        ...
        LegalDocView.as_view(
            template_name="legal/terms/firefox-relay.html",
            legal_doc_name="firefox_relay_ToS",
        ),
    ...
    url(
        r"^terms/thunderbird/$",
        LegalDocView.as_view(
            template_name="legal/terms/thunderbird.html",
            legal_doc_name="thunderbird_about_rights",
        ),
    ...
    url(
        r"^terms/services/$",
        LegalDocView.as_view(
            template_name="legal/terms/services.html",
            legal_doc_name="firefox_cloud_services_ToS",
        ),
    ...
    url(
        r"^acceptable-use/$",
        LegalDocView.as_view(
            template_name="legal/terms/acceptable-use.html",
            legal_doc_name="acceptable_use_policy",
        ),
    ...
    url(
        ...
        LegalDocView.as_view(
            template_name="legal/report-infringement.html",
            legal_doc_name="report_infringement",
        ),
