...
class TestContentCardModel(TestCase):
    ...
    def test_get_page_cards(self):
        ...
        self.assertTrue(
            all(name in cards for name in ["card_%d" % i for i in range(1, 6)])
        )
        self.assertDictEqual(
            cards["card_2"],
            {
    ...
    def test_html_content(self):
        ...
        self.assertEqual(
            card2.content, "<p>This is the converted <em>Markdown</em></p>"
        )
        self.assertEqual(
            card2.html, Markup("<p>This is the converted <em>Markdown</em></p>")
        )
