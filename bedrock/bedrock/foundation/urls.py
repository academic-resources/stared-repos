...
urlpatterns = (
    ...
    redirect(
        r"^annualreport/$",
        "foundation.annualreport.2019.index",
    ...
    page(
        "documents/mozilla-2006-financial-faq",
        "foundation/documents/mozilla-2006-financial-faq.html",
    ),
    page(
        "documents/mozilla-2007-financial-faq",
        "foundation/documents/mozilla-2007-financial-faq.html",
    ),
    page(
        "documents/mozilla-2008-financial-faq",
        "foundation/documents/mozilla-2008-financial-faq.html",
    ),
    # ported from PHP in Bug 960689
    page(
        "documents/bylaws-amendment-1", "foundation/documents/bylaws-amendment-1.html"
    ),
    page(
        "documents/bylaws-amendment-2", "foundation/documents/bylaws-amendment-2.html"
    ),
    page(
        "documents/articles-of-incorporation",
        "foundation/documents/articles-of-incorporation.html",
    ),
    page(
        "documents/articles-of-incorporation/amendment",
        "foundation/documents/articles-of-incorporation-amendment.html",
    ),
    ...
    # was .html
    page(
        "annualreport/2009/a-competitive-world",
        "foundation/annualreport/2009/a-competitive-world.html",
    ),
    # was .html
    page(
        "annualreport/2009/broadening-our-scope",
        "foundation/annualreport/2009/broadening-our-scope.html",
    ),
    # was .html
    page(
        "annualreport/2009/sustainability",
        "foundation/annualreport/2009/sustainability.html",
    ),
    ...
    page(
        "annualreport/2010/opportunities",
        "foundation/annualreport/2010/opportunities.html",
    ),
    ...
    page(
        "licensing/binary-components",
        "foundation/licensing/binary-components/index.html",
    ),
    page(
        "licensing/binary-components/rationale",
        "foundation/licensing/binary-components/rationale.html",
    ),
    ...
    page(
        "trademarks/distribution-policy",
        "foundation/trademarks/distribution-policy.html",
    ),
    page(
        "trademarks/community-edition-permitted-changes",
        "foundation/trademarks/community-edition-permitted-changes.html",
    ),
    page(
        "trademarks/community-edition-policy",
        "foundation/trademarks/community-edition-policy.html",
    ),
