...
redirectpatterns = (
    # bug 818323
    redirect(
        r"^projects/security/known-vulnerabilities\.html$",
        "security.known-vulnerabilities",
    ),
    redirect(
        r"^projects/security/older-vulnerabilities\.html$",
        "security.older-vulnerabilities",
    ),
    # bug 1090468
    redirect(
    ...
    redirect(
        r"^security/iSECPartners_Phishing\.pdf$",
