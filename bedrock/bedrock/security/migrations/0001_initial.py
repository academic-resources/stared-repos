        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        max_length=8, serialize=False, primary_key=True, db_index=True
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="advisories", to="security.Product"
                    ),
                ),
            ],
            options={"ordering": ("-year", "-order"), "get_latest_by": "last_modified"},
            bases=(models.Model,),
        ),
    ]
