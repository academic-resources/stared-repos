...
class TestViews(TestCase):
    ...
    def test_product_view_min_version(self):
        ...
        with patch.dict(pview.minimum_versions, {"firefox": Version("4.2")}):
            self.assertListEqual(
                pview.get_queryset(), [self.pvs[5], self.pvs[4], self.pvs[3]]
            )
    ...
    def test_product_version_view_filter_major(self):
        ...
        self.assertListEqual(
            pview.get_queryset(), [self.pvs[4], self.pvs[3], self.pvs[2], self.pvs[1]]
        )
...
class TestOldAdvisories(TestCase):
    ...
    def test_old_urls(self):
        ...
        self._test_redirect(
            "/security/announce/mfsa2005-31.html", "/security/advisories/mfsa2005-31/"
        )
        self._test_redirect(
            "/security/announce/2005/mfsa2005-40.html",
            "/security/advisories/mfsa2005-40/",
        )
        self._test_redirect(
            "/security/advisories/2008/mfsa2008-47.html",
            "/security/advisories/mfsa2008-47/",
        )
        self._test_redirect(
            "/security/advisories/mfsa2008-66/mfsa2008-37.html",
