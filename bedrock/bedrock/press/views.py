...
SPEAKER_REQUEST_EMAIL_FROM = (
    PRESS_INQUIRY_EMAIL_FROM
) = "Mozilla.com <noreply@mozilla.com>"
...
class PressInquiryView(FormView):
    ...
    def send_email(self, form):
        ...
        msg = render_to_string(
            "press/emails/press-inquiry.txt", form.cleaned_data, request=self.request
        )
    ...
    def render_to_response(self, context, **response_kwargs):
        return l10n_utils.render(
            self.request, self.get_template_names(), context, **response_kwargs
        )
...
class SpeakerRequestView(FormView):
    ...
    def send_email(self, form):
        ...
        msg = render_to_string(
            "press/emails/speaker-request.txt", form.cleaned_data, request=self.request
        )
