...
redirectpatterns = (
    ...
    redirect(
        r"^press/mozilla-2004-09-14-02\.html$",
        "https://blog.mozilla.org/press/2004/09/"
    ...
    redirect(
        r"^press/mozilla-2004-10-01-02\.html$",
    ...
    redirect(
        r"^press/mozilla-2004-11-22\.html$",
    ...
    redirect(
        r"^press/mozilla-2004-12-7\.html$",
    ...
    redirect(
        r"^press/mozilla-2006-03-02\.html$",
    ...
    redirect(
        r"^press/mozilla-2006-10-24-02\.html$",
    ...
    redirect(
        r"^press/mozilla-2006-12-11\.html$",
    ...
    redirect(
        r"^press/mozilla-2007-03-27\.html$",
    ...
    redirect(
        r"^press/mozilla-2007-04-19\.html$",
    ...
    redirect(
        r"^press/mozilla-2008-06-17-faq\.html$",
        "https://blog.mozilla.org/press/2008/06/mozilla-releases-firefox-3-and-redefines-the-web-experience/",
    ),
    redirect(
        r"^press/mozilla-2008-06-17\.html$",
        "https://blog.mozilla.org/press/2008/06/mozilla-releases-firefox-3-and-redefines-the-web-experience/",
    ),
    redirect(
        r"^press/mozilla-2008-07-02\.html$",
    ...
    # en-GB
    redirect(
        r"^en-GB/press/?$", "https://blog.mozilla.org/press-uk/", locale_prefix=False
    ),
    redirect(
        r"^en-GB/press/media/?$",
    ...
    redirect(
        r"^en-GB/press/media/logos/?$",
        "https://blog.mozilla.org/press-uk/media-library/",
        locale_prefix=False,
    ),
    redirect(
        r"^en-GB/press/media/screenshots/?$",
        "https://blog.mozilla.org/press-uk/media-library/product-screenshots/",
        locale_prefix=False,
    ),
    redirect(
        r"^en-GB/press/media/images/?$",
        "https://blog.mozilla.org/press-uk/media-library/",
        locale_prefix=False,
    ),
    redirect(
        r"^en-GB/press/media/videos/?$",
        "https://blog.mozilla.org/press-uk/media-library/videos/",
        locale_prefix=False,
    ),
    # de
    redirect(
        r"^de/press/?$", "https://blog.mozilla.org/press-de/", locale_prefix=False
    ),
    redirect(
        r"^de/press/media/?$",
    ...
    redirect(
        r"^de/press/media/logos/?$",
        "https://blog.mozilla.org/press-de/medienbibliothek/",
        locale_prefix=False,
    ),
    redirect(
        r"^de/press/media/screenshots/?$",
        "https://blog.mozilla.org/press-de/medienbibliothek/produkt-screenshots/",
        locale_prefix=False,
    ),
    redirect(
        r"^de/press/media/images/?$",
        "https://blog.mozilla.org/press-de/medienbibliothek/",
        locale_prefix=False,
    ),
    redirect(
        r"^de/press/media/videos/?$",
        "https://blog.mozilla.org/press-de/medienbibliothek/videos/",
        locale_prefix=False,
    ),
    redirect(
        r"^de/press/media/bios/?$",
        "https://blog.mozilla.org/press/media-library/bios/",
        locale_prefix=False,
    ),
    # fr
    redirect(
        r"^fr/press/?$", "https://blog.mozilla.org/press-fr/", locale_prefix=False
    ),
    redirect(
        r"^fr/press/media/?$",
    ...
    redirect(
        r"^fr/press/media/logos/?$",
        "https://blog.mozilla.org/press-fr/bibliotheque-mozilla/",
        locale_prefix=False,
    ),
    redirect(
        r"^fr/press/media/screenshots/?$",
        "https://blog.mozilla.org/press-fr/bibliotheque-mozilla/captures-decran-produits/",
        locale_prefix=False,
    ),
    redirect(
        r"^fr/press/media/images/?$",
        "https://blog.mozilla.org/press-fr/bibliotheque-mozilla/",
        locale_prefix=False,
    ),
    redirect(
        r"^fr/press/media/videos/?$",
        "https://blog.mozilla.org/press-fr/bibliotheque-mozilla/videos/",
        locale_prefix=False,
    ),
    redirect(
        r"^fr/press/media/bios/?$",
        "https://blog.mozilla.org/press/media-library/bios/",
        locale_prefix=False,
    ),
    # it
    redirect(
        r"^it/press/?$", "https://blog.mozilla.org/press-it/", locale_prefix=False
    ),
    redirect(
        r"^it/press/media/?$",
    ...
    redirect(
        r"^es(-[A-Z]{2})?/press/media/images/?$",
        "https://blog.mozilla.org/press-es/galeria-multimedia-de-mozilla/",
        locale_prefix=False,
    ),
    redirect(
        r"^es(-[A-Z]{2})?/press/media/videos/?$",
        "https://blog.mozilla.org/press-es/galeria-multimedia-de-mozilla/videos/",
        locale_prefix=False,
    ),
    redirect(
        r"^es(-[A-Z]{2})?/press/media/bios/?$",
        "https://blog.mozilla.org/press/media-library/bios/",
        locale_prefix=False,
    ),
    # pl
    redirect(
        r"^pl/press/?$", "https://blog.mozilla.org/press-pl/", locale_prefix=False
    ),
    redirect(
        r"^pl/press/media/?$",
    ...
    redirect(
        r"^press/media/bios/?$", "https://blog.mozilla.org/press/media-library/bios/"
    ),
    redirect(
        r"^press/media/screenshots/?$",
        "https://blog.mozilla.org/press/media-library/screenshots/",
    ),
    redirect(
        r"^press/media/videos/?$",
