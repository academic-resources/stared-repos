...
urlpatterns = (
    ...
    url(
        "^newsletter/confirm/(?P<token>%s)/$" % uuid_regex,
        views.confirm,
        name="newsletter.confirm",
    ),
    # Update country
    url(
        "^newsletter/country/(?P<token>%s)/$" % uuid_regex,
        views.set_country,
    ...
    page(
        "newsletter/mozilla",
        "newsletter/mozilla.html",
        ftl_files=["mozorg/newsletters"],
    ),
    page(
        "newsletter/firefox",
        "newsletter/firefox.html",
        ftl_files=["mozorg/newsletters"],
    ),
    page(
        "newsletter/developer",
        "newsletter/developer.html",
        ftl_files=["mozorg/newsletters"],
    ),
    page(
        "newsletter/country/success",
        "newsletter/country_success.html",
        ftl_files=["mozorg/newsletters"],
    ),
    page(
        "newsletter/fxa-error",
        "newsletter/fxa-error.html",
        ftl_files=["mozorg/newsletters"],
    ),
)
