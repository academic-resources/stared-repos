...
class TestPageUtil(TestCase):
    ...
    def test_locale_redirect(self, l10n_mock):
        ...
        l10n_mock.render.assert_called_with(
            ANY,
            "walter/abides.html",
            {"urlname": "walter.abides", "donny": "ashes"},
            ftl_files=None,
        )
    ...
    def test_locale_redirect_works_home_page(self, l10n_mock):
        ...
        l10n_mock.render.assert_called_with(
            ANY, "index.html", {"urlname": "index"}, ftl_files=None
        )
    ...
    def test_url_name_set_from_param(self, l10n_mock):
        ...
        url = page(
            "lebowski/urban_achievers",
            "lebowski/achievers.html",
