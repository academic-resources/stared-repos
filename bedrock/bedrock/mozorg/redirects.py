...
redirectpatterns = (
    ...
    redirect(
        r"^start/",
        ua_redirector(
            "seamonkey", "http://www.seamonkey-project.org/start/", "firefox.new"
        ),
        cache_timeout=0,
    ),
    ...
    # bug 885797
    redirect(
        r"^community/(directory|wikis|blogs|websites)\.html$",
        "https://wiki.mozilla.org/Websites/Directory",
        locale_prefix=False,
    ),
    # bug 885856
    redirect(
        r"^projects/index\.(de|fr|hr|sq)\.html$", "/{}/firefox/", locale_prefix=False
    ),
    # bug 856075
    redirect(
        r"^projects/technologies\.html$",
    ...
    # bug 874526, 877698
    redirect(
        r"^projects/security/components/same-origin\.html$",
        "https://developer.mozilla.org/docs/Web/Security/Same-origin_policy",
    ),
    redirect(
        r"^projects/security/components(?P<path>.*)$",
    ...
    # bug 948520
    redirect(
        r"^firefox/livebookmarks", "https://support.mozilla.org/kb/Live%20Bookmarks"
    ),
    # bug 782333
    redirect(
        r"^firefox/backtoschool/?$",
    ...
    redirect(
        r"^foundation/identity-guidelines(/.*)?", "https://mozilla.design/mozilla/"
    ),
    ...
    # Bug 1209643
    redirect(
        r"^legal/bylaws_amendment_(?P<n>[12])(\.html|/)?",
        "/foundation/documents/bylaws-amendment-{n}/",
    ),
    redirect(
        r"^legal/articles(\.html|/)?", "foundation.documents.articles-of-incorporation"
    ),
    redirect(
        r"^legal/amendment(\.html|/)?",
    ...
    # Bug 1073269
    redirect(
        r"^dnt/?$", "https://support.mozilla.org/kb/how-do-i-turn-do-not-track-feature"
    ),
    # bug 1205632
    redirect(
        r"^js/language(?:/|/index\.html)?$",
    ...
    redirect(
        r"^js/language(?P<path>.*)$", "http://www-archive.mozilla.org/js/language{path}"
    ),
    ...
    # bug 876810
    redirect(
        r"^hacking/commit-access-policy/?$",
        "mozorg.about.governance.policies.commit.access-policy",
    ),
    redirect(
        r"^hacking/committer(/|/faq\.html)?$", "mozorg.about.governance.policies.commit"
    ),
    ...
    redirect(
        r"^hacking/notification/acceptance-email\.txt$",
        "https://static.mozilla.com/foundation/documents/commit-access/acceptance-email.txt",
    ),
    # bug 1165344
    redirect(
        r"^hacking/CVS-Contributor-Form\.(?:pdf|ps)$",
        "mozorg.about.governance.policies.commit",
    ),
    redirect(
        r"^hacking/(?:form|getting-cvs-write-access)\.html$",
        "mozorg.about.governance.policies.commit",
    ),
    redirect(
        r"^hacking/portable-cpp\.html$",
        "https://developer.mozilla.org/docs/Mozilla/C++_Portability_Guide",
    ),
    redirect(
        r"^hacking/rules\.html$", "https://developer.mozilla.org/docs/mozilla-central"
    ),
    redirect(
        r"^hacking/(?P<page>module-ownership|reviewers)\.html$",
        "/about/governance/policies/{page}/",
    ),
    redirect(
        r"^hacking/regression-policy\.html$",
        "mozorg.about.governance.policies.regressions",
    ),
    # Bug 1040970
    redirect(
        r"^mozillacareers$",
    ...
    # bug 818321
    redirect(
        r"^projects/security/tld-idn-policy-list\.html$",
        "https://wiki.mozilla.org/IDN_Display_Algorithm",
    ),
    redirect(
        r"^projects/security/membership-policy\.html$",
        "/about/governance/policies/security-group/membership/",
    ),
    redirect(
        r"^projects/security/secgrouplist\.html$",
        "/about/governance/policies/security-group/",
    ),
    redirect(
        r"^projects/security/security-bugs-policy\.html$",
        "/about/governance/policies/security-group/bugs/",
    ),
    # bug 818316, 1128579
    redirect(
        r"^projects/security/certs(?:/(?:index\.html)?)?$",
        "/about/governance/policies/security-group/certs/",
    ),
    redirect(
        r"^projects/security/certs/included(?:/(?:index\.html)?)?$",
        "https://wiki.mozilla.org/CA:IncludedCAs",
    ),
    redirect(
        r"^projects/security/certs/pending(?:/(?:index\.html)?)?$",
        "https://wiki.mozilla.org/CA:PendingCAs",
    ),
    redirect(
        r"^projects/security/certs/policy(?:/(?:index\.html)?)?$",
        "/about/governance/policies/security-group/certs/policy/",
    ),
    redirect(
        r"^projects/security/certs/policy/EnforcementPolicy\.html$",
        "/about/governance/policies/security-group/certs/policy/enforcement/",
    ),
    redirect(
        r"^projects/security/certs/policy/MaintenancePolicy\.html$",
        "/about/governance/policies/security-group/certs/policy/maintenance/",
    ),
    redirect(
        r"^projects/security/certs/policy/InclusionPolicy\.html$",
        "/about/governance/policies/security-group/certs/policy/inclusion/",
    ),
    redirect(
        r"^about/governance/policies/security-group/certs/included(?:/(?:index\.html)?)?$",
        "https://wiki.mozilla.org/CA:IncludedCAs",
    ),
    redirect(
        r"^about/governance/policies/security-group/certs/pending(?:/(?:index\.html)?)?$",
        "https://wiki.mozilla.org/CA:PendingCAs",
    ),
    # bug 1068931
    ...
    redirect(
        r"^about/policies/participation\.html$",
    ...
    redirect(
        r"^contribute/local/northamerica\.html$", "/contact/communities/north-america/"
    ),
    redirect(r"^contribute/local/europe\.html$", "/contact/communities/europe/"),
    redirect(
        r"^contribute/local/latinamerica\.html$", "/contact/communities/latin-america/"
    ),
    redirect(
        r"^contribute/local/africamideast\.html$",
        "/contact/communities/africa-middle-east/",
    ),
    redirect(
        r"^contribute/local/asia\.html$", "/contact/communities/asia-south-pacific/"
    ),
    redirect(r"^contribute/local/southpole\.html$", "/contact/communities/antarctica/"),
    # bug 1393622
    redirect(
        r"contact/spaces/(?:auckland|tokyo|taipei|london|mountain-view|vancouver)/?$",
        "/contact/spaces/",
    ),
    ...
    # bug 878926
    redirect(
        r"^firefoxflicks/?(?P<p>.*)$", "https://firefoxflicks.mozilla.org/{locale}{p}"
    ),
    # bug 849426
    redirect(r"^about/history(\.html)?$", "/about/history/"),
    redirect(
        r"^about/bookmarks\.html$", "https://wiki.mozilla.org/Historical_Documents"
    ),
    ...
    redirect(
        r"^about/manifesto\.(.*)\.html$", "/{}/about/manifesto/", locale_prefix=False
    ),
    # bug 856077
    redirect(r"^projects/toolkit/?$", "https://developer.mozilla.org/docs/Toolkit_API"),
    redirect(
        r"^rhino/download\.html$",
    ...
    redirect(
        r"^(about/policies/|foundation/)?privacy-policy(/|\.html)?$",
        "/privacy/websites/",
    ),
    redirect(
        r"^privacy-policy\.pdf$",
    ...
    # working.)
    redirect(
        r"^foundation/documents/(?P<pdf>[^/]+)\.pdf$",
        "https://static.mozilla.com/foundation/documents/{pdf}.pdf",
        re_flags="i",
    ),
    redirect(
        r"^foundation/donate_form\.pdf$",
    ...
    redirect(
        r"^foundation/openwebfund/(index\.html)?$",
        "https://donate.mozilla.org/?source=owf_redirect",
        re_flags="i",
    ),
    redirect(
        r"^foundation/donate\.html$",
    ...
    redirect(
        r"^foundation/(?P<page>about|careers|licensing|moco|mocosc)\.html$",
        "/foundation/{page}/",
        re_flags="i",
    ),
    ...
    redirect(
        r"^foundation/documents/(?P<page>index|mozilla-200.-financial-faq)\.html$",
        "/foundation/{page}/",
        re_flags="i",
    ),
    redirect(
        r"^foundation/(?P<page>(?:annualreport|documents|feed-icon-guidelines|"
        r"licensing|openwebfund|trademarks)/.*)\.html$",
        "/foundation/{page}/",
        re_flags="i",
    ),
    # bug 442671
    redirect(
        r"^foundation/trademarks/l10n-policy/?$",
    ...
    redirect(
        r"^legal/privacy/firefox-third-party", "/privacy/archive/firefox/third-party/"
    ),
    redirect(r"^legal/privacy/notices-firefox", "/legal/firefox/"),
    redirect(
        r"^privacy/policies/(?P<page>facebook|firefox-os|websites)/?$",
        "/privacy/{page}/",
    ),
    # bug 1034859
    redirect(
        r"^about/buttons/(?P<file>.*)$",
        "/media/img/careers/buttons/{file}",
    ...
    # Bug 682619
    redirect(
        r"^support/thunderbird(/.*)?$",
        "https://support.mozilla.org/products/thunderbird",
    ),
    redirect(
        r"^support/firefox(/.*)?$", "https://support.mozilla.org/products/firefox"
    ),
    # bug 1236910
    ...
    redirect(
        r"^about/patents/license/1\.0/?$", "mozorg.about.policy.patents.license-1.0"
    ),
    ...
    redirect(
        r"^digital-inclusion/?$", "https://foundation.mozilla.org/internet-health/"
    ),
    ...
    redirect(
        r"^/contribute/studentambassadors(/.*)?", "https://campus.mozilla.community/"
    ),
    ...
    redirect(
        r"^lightbeam(/.*)?", "https://addons.mozilla.org/firefox/addon/lightbeam/"
    ),
    # Bug 1428150
    ...
    redirect(
        r"^about/partnerships/contentservices(/.*)?$", "mozorg.contact.contact-landing"
    ),
    redirect(r"^about/partnerships\.html", "mozorg.contact.contact-landing"),
    redirect(
        r"^about/partnerships/distribution/?$",
    ...
    redirect(
        r"^teach/smarton/(?:tracking|security|surveillance)/?$",
    ...
    redirect(
        r"^decentralization/?$", "https://foundation.mozilla.org/internet-health/"
    ),
    # issue 6971
    ...
    # Issue 8375
    redirect(
        r"^internet-health(/.*)?", "https://foundation.mozilla.org/internet-health/"
    ),
    # Issue 8949
    redirect(
        r"^donate/?$",
    ...
    redirect(
        r"^about/governance/policies/security/plugin-whitelist-policy/?$",
        "https://wiki.mozilla.org/Plugins/Firefox_Whitelist",
    ),
    redirect(
        r"^about/governance/policies/security-group/tld-idn/?$",
        "https://wiki.mozilla.org/IDN_Display_Algorithm",
    ),
    # Issue 9560
    redirect(
    ...
    # Bug 1673476
    redirect(
        r"^/about/governance/policies/security-group/certs/?$",
    ...
    # Issue 9984
    redirect(
        r"^/about/legal/fraud-report/?$", "/about/legal/defend-mozilla-trademarks/"
    ),
    # Issue 10335
