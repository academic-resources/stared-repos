...
urlpatterns = (
    ...
    page(
        "about/manifesto",
        "mozorg/about/manifesto.html",
        ftl_files=["mozorg/about/manifesto"],
    ),
    page(
        "about/manifesto/details",
        "mozorg/about/manifesto-details.html",
        ftl_files=["mozorg/about/manifesto"],
    ),
    page("about/leadership", "mozorg/about/leadership.html"),
    page("about/policy/lean-data", "mozorg/about/policy/lean-data/index.html"),
    page(
        "about/policy/lean-data/build-security",
        "mozorg/about/policy/lean-data/build-security.html",
    ),
    page(
        "about/policy/lean-data/stay-lean",
        "mozorg/about/policy/lean-data/stay-lean.html",
    ),
    page(
        "about/policy/lean-data/engage-users",
        "mozorg/about/policy/lean-data/engage-users.html",
    ),
    ...
    page(
        "about/policy/patents/license/1.0",
        "mozorg/about/policy/patents/license-1.0.html",
    ),
    ...
    page(
        "about/history", "mozorg/about/history.html", ftl_files=["mozorg/about/history"]
    ),
    ...
    page(
        ...
        "mozorg/about/governance/policies/commit.html",
    ),
    page(
    ...
    page(
        "about/governance/policies/commit/requirements",
    ...
    page(
        "about/governance/organizations", "mozorg/about/governance/organizations.html"
    ),
    page(
    ...
    page(
        "about/governance/policies/module-ownership",
        "mozorg/about/governance/policies/module-ownership.html",
    ),
    page(
        "about/governance/policies/regressions",
    ...
    page(
        "about/policy/transparency/jul-dec-2019",
        "mozorg/about/policy/transparency/jul-dec-2019.html",
    ),
    page(
        "about/policy/transparency/jan-jun-2020",
        "mozorg/about/policy/transparency/jan-jun-2020.html",
    ),
    page(
        "about/policy/transparency/jul-dec-2020",
        "mozorg/about/policy/transparency/jul-dec-2020.html",
    ),
    page(
        "about/policy/transparency/jan-jun-2021",
    ...
    page(
        "MPL/2.0/permissive-code-into-mpl",
        "mozorg/mpl/2.0/permissive-code-into-mpl.html",
    ),
    ...
    url(
        r"^keymaster/gatekeeper/there\.is\.only\.xul$",
        views.namespaces,
        {"namespace": "xul"},
    ),
