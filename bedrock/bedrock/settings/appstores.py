...
GOOGLE_PLAY_FIREFOX_LINK_UTMS = (
    GOOGLE_PLAY_FIREFOX_LINK
    + "&referrer="
    + urlquote("utm_source=mozilla&utm_medium=Referral&" "utm_campaign=mozilla-org")
)
...
APPLE_APPSTORE_FIREFOX_LINK = (
    "https://itunes.apple.com/{country}/app/firefox-private-safe-browser/id989804926"
)
...
APPLE_APPSTORE_LOCKWISE_LINK = (
    "https://itunes.apple.com/{country}/app/id1314000270?mt=8"
)
