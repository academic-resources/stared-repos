...
class TestPrefixer(TestCase):
    ...
    @override_settings(
        LANGUAGE_URL_MAP={"en-gb": "en-GB", "en-us": "en-US", "es-ar": "es-AR"},
    ...
    @override_settings(
        LANGUAGE_URL_MAP={"en-ar": "en-AR", "en-gb": "en-GB", "en-us": "en-US"},
...
@override_settings(
    LANGUAGE_URL_MAP={"es-ar": "es-AR", "en-gb": "en-GB", "es-us": "es-US"},
    CANONICAL_LOCALES={"es": "es-ES", "en": "en-US"},
)
