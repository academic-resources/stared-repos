...
def send_to_device_ajax(request):
    ...
    data = {"platform": request.POST.get("platform"), "email": email}
...
def firefox_all(request):
        ...
        "android_release_full_builds": [
            {
                ...
                "platforms": {
                    "android": {"download_url": settings.GOOGLE_PLAY_FIREFOX_LINK_UTMS}
                },
            }
        ],
        ...
        "android_beta_full_builds": [
            {
                ...
                "name_native": lang_multi,
                "platforms": {
                    "android": {"download_url": settings.GOOGLE_PLAY_FIREFOX_BETA_LINK}
                },
            }
        ],
        ...
        "ios_release_full_builds": [
            {
                ...
                "platforms": {
                    "ios": {
                        "download_url": settings.APPLE_APPSTORE_FIREFOX_LINK.replace(
                            "/{country}/", "/"
                        )
                    }
                },
    ...
    return l10n_utils.render(
        request, "firefox/all-unified.html", context, ftl_files=ftl_files
    )
...
class WhatsnewView(L10nTemplateView):
    ...
    ftl_files_map = {
        ...
        "firefox/whatsnew/index-account.html": [
        ...
        "firefox/whatsnew/whatsnew-fx86-en.html": [
            "firefox/whatsnew/whatsnew-s2d",
            "firefox/whatsnew/whatsnew",
        ],
        ...
        "firefox/whatsnew/whatsnew-mobile-qrcode-de.html": [
            "firefox/whatsnew/whatsnew"
        ],
        ...
        "firefox/whatsnew/whatsnew-fx90-eu.html": [
            "firefox/whatsnew/whatsnew-fx90.ftl",
            "firefox/whatsnew/whatsnew",
        ],
        ...
        "firefox/whatsnew/whatsnew-fx92-fr.html": [
            "firefox/whatsnew/whatsnew-account",
            "firefox/whatsnew/whatsnew",
        ],
        "firefox/whatsnew/whatsnew-fx92-vpn-en.html": [
            "firefox/whatsnew/whatsnew",
            "products/vpn/shared",
        ],
        "firefox/whatsnew/whatsnew-fx92-vpn-fr.html": [
            "firefox/whatsnew/whatsnew",
            "products/vpn/shared",
        ],
    }
    ...
    def get_context_data(self, **kwargs):
        ...
        if (
            version.startswith("87.")
            or version.startswith("88.")
            and locale in ["de", "fr"]
        ):
        ...
        ctx[
            "utm_params"
        ] = "utm_source={0}&utm_medium=referral&utm_campaign={1}&entrypoint={2}".format(
...
class WhatsNewEnglishView(WhatsnewView):
    def get_template_names(self):
        template = super().get_template_names()
        if switch("firefox-whatsnew-92-vpn-pricing") and template == [
...
class DownloadThanksView(L10nTemplateView):
    ...
    activation_files = ["firefox/new/download", "firefox/new/desktop"]
...
def firefox_welcome_page1(request):
    ...
    return l10n_utils.render(
        request, template_name, context, ftl_files="firefox/welcome/page1"
    )
