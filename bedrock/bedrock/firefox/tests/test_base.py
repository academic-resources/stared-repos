...
class TestFirefoxAll(TestCase):
    ...
    def test_all_builds_results(self):
        ...
        assert (
            len(doc('.c-locale-list[data-product="desktop_release"] > li'))
            == desktop_release_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="desktop_release"] > li[data-language="en-US"] > ul > li > a'
                )
            )
            == 8
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="desktop_beta"] > li'))
            == desktop_beta_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="desktop_beta"] > li[data-language="en-US"] > ul > li > a'
                )
            )
            == 8
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="desktop_developer"] > li'))
            == desktop_developer_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="desktop_developer"] > li[data-language="en-US"] > ul > li > a'
                )
            )
            == 8
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="desktop_nightly"] > li'))
            == desktop_nightly_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="desktop_nightly"] > li[data-language="en-US"] > ul > li > a'
                )
            )
            == 8
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="desktop_esr"] > li'))
            == desktop_esr_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="desktop_esr"] > li[data-language="en-US"] > ul > li > a'
                )
            )
            == 8
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="android_release"] > li'))
            == android_release_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="android_release"] > li[data-language="multi"] > ul > li > a'
                )
            )
            == 2
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="android_beta"] > li'))
            == android_beta_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="android_beta"] > li[data-language="multi"] > ul > li > a'
                )
            )
            == 1
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="android_nightly"] > li'))
            == android_nightly_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="android_nightly"] > li[data-language="multi"] > ul > li > a'
                )
            )
            == 1
        )
        ...
        assert (
            len(doc('.c-locale-list[data-product="ios_release"] > li'))
            == ios_release_builds
        )
        assert (
            len(
                doc(
                    '.c-locale-list[data-product="ios_release"] > li[data-language="multi"] > ul > li > a'
                )
            )
            == 2
        )
...
class TestWhatsNew(TestCase):
    ...
    def test_context_variables_whatsnew(self, render_mock):
        ...
        assert ctx["utm_params"] == (
            "utm_source=mozilla.org-whatsnew70&utm_medium=referral"
    ...
    def test_context_variables_whatsnew_nightly(self, render_mock):
        ...
        assert ctx["utm_params"] == (
            "utm_source=mozilla.org-whatsnew72nightly&utm_medium=referral"
