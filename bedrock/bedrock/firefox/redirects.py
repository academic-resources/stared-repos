...
def firefox_channel(*args, **kwargs):
    return platform_redirector(
        "firefox.channel.desktop", "firefox.channel.android", "firefox.channel.ios"
    )
...
redirectpatterns = (
    ...
    redirect(
        r"^firefox/developer/all/?$", "firefox.all", anchor="product-desktop-developer"
    ),
    redirect(
        r"^firefox/aurora/all/?$", "firefox.all", anchor="product-desktop-developer"
    ),
    redirect(
        r"^firefox/nightly/all/?$", "firefox.all", anchor="product-desktop-nightly"
    ),
    redirect(
        r"^firefox/organizations/all/?$", "firefox.all", anchor="product-desktop-esr"
    ),
    redirect(
        r"^firefox/android/all/?$", "firefox.all", anchor="product-android-release"
    ),
    redirect(
        r"^firefox/android/beta/all/?$", "firefox.all", anchor="product-android-beta"
    ),
    redirect(
    ...
    redirect(
        r"^mwc/?$", "https://support.mozilla.org/products/firefox-os", re_flags="i"
    ),
    # bug 748503
    redirect(
        r"^projects/firefox/[^/]+a[0-9]+/firstrun(?P<p>.*)$",
    ...
    redirect(
        r"^(firefox/)?aurora/?$", firefox_channel(), cache_timeout=0, anchor="aurora"
    ),
    redirect(
        r"^(firefox/)?nightly/?$", firefox_channel(), cache_timeout=0, anchor="nightly"
    ),
    ...
    # bug 1155870
    redirect(
        r"^firefox/os/(releases|notes)/?$",
        "https://developer.mozilla.org/Firefox_OS/Releases",
    ),
    redirect(
        r"^firefox/os/(?:release)?notes/(?P<v>[^/]+)/?$",
    ...
    redirect(
        r"^firefox/aurora/(?P<page>all|notes|system-requirements)/?$",
    ...
    redirect(
        r"^firefox/(?:performance|happy|speed|memory)/?$", "firefox.features.fast"
    ),
    ...
    # bug 858315
    redirect(
        r"^projects/devpreview/firstrun(?:/(?:index\.html)?)?$", "/firefox/firstrun/"
    ),
    redirect(
    ...
    redirect(
        r"^projects/seamonkey/artwork\.html$",
        "http://www.seamonkey-project.org/dev/artwork",
    ),
    redirect(
        r"^projects/seamonkey/community\.html$",
        "http://www.seamonkey-project.org/community",
    ),
    redirect(
        r"^projects/seamonkey/get-involved\.html$",
        "http://www.seamonkey-project.org/dev/get-involved",
    ),
    redirect(r"^projects/seamonkey/index\.html$", "http://www.seamonkey-project.org/"),
    redirect(
        r"^projects/seamonkey/news\.html$", "http://www.seamonkey-project.org/news"
    ),
    redirect(
        r"^projects/seamonkey/project-areas\.html$",
        "http://www.seamonkey-project.org/dev/project-areas",
    ),
    redirect(
        r"^projects/seamonkey/releases/$", "http://www.seamonkey-project.org/releases/"
    ),
    redirect(
        r"^projects/seamonkey/releases/index\.html$",
        "http://www.seamonkey-project.org/releases/",
    ),
    redirect(
        r"^projects/seamonkey/review-and-flags\.html$",
        "http://www.seamonkey-project.org/dev/review-and-flags",
    ),
    redirect(
        r"^projects/seamonkey/releases/(?P<vers>1\..*)\.html$",
        "http://www.seamonkey-project.org/releases/{vers}",
    ),
    redirect(
        r"^projects/seamonkey/releases/seamonkey(?P<x>.*)/index\.html$",
        "http://www.seamonkey-project.org/releases/seamonkey{x}/",
    ),
    redirect(
        r"^projects/seamonkey/releases/seamonkey(?P<x>.*/.*)\.html$",
        "http://www.seamonkey-project.org/releases/seamonkey{x}",
    ),
    redirect(
        r"^projects/seamonkey/releases/updates/(?P<x>.*)$",
    ...
    # Bug 1238248
    redirect(
        r"^firefox/push/?$", "https://support.mozilla.org/kb/push-notifications-firefox"
    ),
    # Bug 1239960
    redirect(
        r"^firefox/partners/?$", "https://support.mozilla.org/products/firefox-os"
    ),
    # Bug 1243060
    redirect(
        r"^firefox/tiles/?$", "https://support.mozilla.org/kb/about-tiles-new-tab"
    ),
    # Bug 1239863, 1329931
    ...
    redirect(
        r"^projects/plugins/npruntime\.html$",
    ...
    redirect(
        r"^projects/embedding/embedoverview/EmbeddingBasics\.html$",
    ...
    redirect(
        r"^projects/embedding/examples/",
        "https://developer.mozilla.org/docs/Gecko/Embedding_Mozilla/Roll_your_own_browser",
    ),
    # Bug 1255882
    redirect(
        r"^projects/bonecho/anti-phishing/?$",
        "https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work",
    ),
    ...
    redirect(
        r"^projects/plugins(/.*)?$", "https://developer.mozilla.org/Add-ons/Plugins"
    ),
    ...
    redirect(
        r"^projects/tech-evangelism(/.*)?$", "https://wiki.mozilla.org/Evangelism"
    ),
    redirect(
        r"^projects/venkman(/.*)?$",
    ...
    redirect(
        r"^projects/webservices/examples/babelfish-wsdl(/.*)?$",
        "https://developer.mozilla.org/docs/SOAP_in_Gecko-based_Browsers",
    ),
    redirect(
        r"^projects/xbl(/.*)?$", "https://developer.mozilla.org/docs/Mozilla/Tech/XBL"
    ),
    redirect(
        r"^projects/xforms(/.*)?$",
        "https://developer.mozilla.org/docs/Archive/Web/XForms",
    ),
    redirect(
        r"^projects/xpcom(/.*)?$",
        "https://developer.mozilla.org/docs/Mozilla/Tech/XPCOM",
    ),
    redirect(
        r"^projects/xpinstall(/.*)?$",
    ...
    redirect(
        r"^projects/xul(/.*)?$", "https://developer.mozilla.org/docs/Mozilla/Tech/XUL"
    ),
    ...
    redirect(
        r"^products/firefox/add-engines\.html$",
    ...
    redirect(
        r"^products/firefox/mirrors\.html$",
        "http://www-archive.mozilla.org/mirrors.html",
    ),
    ...
    redirect(
        r"^products/firefox/shelf\.html$", "https://blog.mozilla.org/press/awards/"
    ),
    redirect(
        r"^products/firefox/smart-keywords\.html$",
    ...
    redirect(
        r"^products/firefox/text-zoom\.html$",
    ...
    redirect(
        r"^products/firefox/ui-customize\.html$",
        "https://support.mozilla.org/kb/customize-firefox-controls-buttons-and-toolbars",
    ),
    ...
    redirect(
        r"^firefox(?:\/\d+\.\d+(?:\.\d+)?(?:a\d+)?)?/secondrun(?:/.*)?",
        "firefox.mobile.index",
        query=False,
    ),
    # bug 1293539
    redirect(
        r"^firefox(?:\/\d+\.\d+(?:\.\d+)?(?:a\d+)?)?/tour/?$",
    ...
    redirect(
        r"^firefox(?:\/\d+\.\d+(?:\.\d+)?(?:a\d+)?)?/hello/start/?$",
    ...
    redirect(
        ...
        "/firefox/android/{version}/releasenotes/",
    ),
    ...
    # issue 7436
    redirect(
        r"^firefox/feedback/?$", "https://support.mozilla.org/questions/new/desktop"
    ),
    # issue 7491
    ...
    # issue #7424
    redirect(
        r"^firefox(?:\/\d+\.\d+(?:\.\d+)?(?:a\d+)?)?/content-blocking/start/?$",
        "https://support.mozilla.org/kb/content-blocking",
    ),
    # issue #7424
    redirect(
        r"^firefox(?:\/\d+\.\d+(?:\.\d+)?(?:a\d+)?)?/tracking-protection/start/?$",
        "https://support.mozilla.org/kb/tracking-protection",
    ),
    # issue 8596
    redirect(
        r"firefox/xr/?$", "https://support.mozilla.org/kb/webxr-permission-info-page"
    ),
    # issue 8419
    redirect(
        r"firefox/this-browser-comes-highly-recommended/?$", "firefox.developer.index"
    ),
    # issue 8420
    redirect(
    ...
    redirect(
        r"^(unfu?ck|love|liebe|rendonslenetplusnet)/?$", "firefox.campaign.unfck.index"
    ),
    # issue 9148
    ...
    # issue 10292
    redirect(
        r"^firefox/(?P<version>[^/]+)/whatsnew/(india|africa)/?$",
        "/firefox/{version}/whatsnew/",
    ),
