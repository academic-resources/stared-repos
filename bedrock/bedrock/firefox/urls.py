...
urlpatterns = (
    ...
    page(
        ...
        "firefox/channel/android.html",
        ftl_files=["firefox/channel"],
    ),
    page(
        "firefox/channel/ios", "firefox/channel/ios.html", ftl_files=["firefox/channel"]
    ),
    page(
        "firefox/developer",
        "firefox/developer/index.html",
        ftl_files=["firefox/developer"],
    ),
    page(
        "firefox/enterprise",
        "firefox/enterprise/index.html",
        ftl_files=["firefox/enterprise"],
    ),
    page(
        "firefox/facebookcontainer",
        "firefox/facebookcontainer/index.html",
        ftl_files=["firefox/facebook_container"],
    ),
    page(
        "firefox/features",
    ...
    page(
        "firefox/features/bookmarks",
        "firefox/features/bookmarks.html",
    ...
    page(
        "firefox/features/independent",
        "firefox/features/independent.html",
        ftl_files=["firefox/features/shared", "firefox/features/independent"],
    ),
    page(
        "firefox/features/memory",
        "firefox/features/memory.html",
    ...
    url(
        r"^firefox/download/thanks/$",
        views.DownloadThanksView.as_view(),
        name="firefox.download.thanks",
    ),
    page(
        "firefox/nightly/firstrun",
        "firefox/nightly/firstrun.html",
        ftl_files=["firefox/nightly/firstrun"],
    ),
    url(
    ...
    url(
        whatsnew_re_china,
        views.WhatsNewChinaView.as_view(),
        name="firefox.whatsnew.china",
    ),
    url(
        whatsnew_re_en, views.WhatsNewEnglishView.as_view(), name="firefox.whatsnew.en"
    ),
    url(
        whatsnew_re_france,
        views.WhatsNewFranceView.as_view(),
        name="firefox.whatsnew.france",
    ),
    url(whatsnew_re_all, views.WhatsnewView.as_view(), name="firefox.whatsnew.all"),
    # Release notes
    url(
        "^firefox/(?:%s/)?(?:%s/)?notes/$" % (platform_re, channel_re),
        bedrock.releasenotes.views.latest_notes,
        name="firefox.notes",
    ),
    url(
        "^firefox/nightly/notes/feed/$",
        bedrock.releasenotes.views.nightly_feed,
        name="firefox.nightly.notes.feed",
    ),
    url(
    ...
    url(
        ...
        name="firefox.desktop.releasenotes",
    ),
    url(
        android_releasenotes_re,
        bedrock.releasenotes.views.release_notes,
        {"product": "Firefox for Android"},
        name="firefox.android.releasenotes",
    ),
    url(
        ios_releasenotes_re,
        bedrock.releasenotes.views.release_notes,
        {"product": "Firefox for iOS"},
        name="firefox.ios.releasenotes",
    ),
    url(
        sysreq_re,
    ...
    url(
        ...
        bedrock.releasenotes.views.system_requirements,
        {"product": "Firefox for iOS"},
        name="firefox.ios.system_requirements",
    ),
    url(
        "^firefox/releases/$",
    ...
    url(
        "^firefox/stub_attribution_code/$",
        views.stub_attribution_code,
        name="firefox.stub_attribution_code",
    ),
    url(
        r"^firefox/welcome/1/$",
        views.firefox_welcome_page1,
        name="firefox.welcome.page1",
    ),
    page(
        "firefox/welcome/2",
        "firefox/welcome/page2.html",
        ftl_files=["firefox/welcome/page2"],
    ),
    page(
        "firefox/welcome/3",
        "firefox/welcome/page3.html",
        ftl_files=["firefox/welcome/page3"],
    ),
    page(
        "firefox/welcome/4",
        "firefox/welcome/page4.html",
        ftl_files=["firefox/welcome/page4"],
    ),
    page(
        "firefox/welcome/5",
        "firefox/welcome/page5.html",
        ftl_files=["firefox/welcome/page5"],
    ),
    page(
        "firefox/welcome/6",
        "firefox/welcome/page6.html",
        ftl_files=["firefox/welcome/page6"],
    ),
    page(
        "firefox/welcome/7",
        "firefox/welcome/page7.html",
        ftl_files=["firefox/welcome/page7"],
    ),
    url(
        r"^firefox/welcome/8/$",
    ...
    page(
        "firefox/welcome/9", "firefox/welcome/page9.html", active_locales=["de", "fr"]
    ),
    ...
    page(
        ...
        ftl_files=[
            "firefox/browsers/compare/chrome",
            "firefox/browsers/compare/shared",
        ],
    ),
    page(
    ...
    page(
        ...
        "firefox/browsers/best-browser.html",
        ftl_files=["firefox/browsers/best-browser"],
    ),
    page(
        "firefox/browsers/browser-history",
        "firefox/browsers/browser-history.html",
        ftl_files=["firefox/browsers/history/browser-history"],
    ),
    page(
        "firefox/browsers/incognito-browser", "firefox/browsers/incognito-browser.html"
    ),
    page(
        "firefox/browsers/update-your-browser", "firefox/browsers/update-browser.html"
    ),
    page(
        "firefox/browsers/what-is-a-browser",
        "firefox/browsers/what-is-a-browser.html",
        ftl_files=["firefox/browsers/history/what-is-a-browser"],
    ),
    page(
        "firefox/browsers/windows-64-bit",
        "firefox/browsers/windows-64-bit.html",
        ftl_files=["firefox/browsers/windows-64-bit"],
    ),
    # Lockwise
    page(
        "firefox/lockwise",
        "firefox/products/lockwise.html",
        ftl_files=["firefox/products/lockwise"],
    ),
    # Issue 7765, 7709
    page(
        "firefox/privacy",
        "firefox/privacy/index.html",
        ftl_files=["firefox/privacy-hub"],
    ),
    page(
        "firefox/privacy/products",
        "firefox/privacy/products.html",
        ftl_files=["firefox/privacy-hub"],
    ),
    page(
        "firefox/privacy/safe-passwords",
        "firefox/privacy/passwords.html",
        ftl_files=["firefox/privacy-hub", "firefox/privacy/passwords"],
    ),
    # Issue 8432
    page(
        "firefox/set-as-default/thanks",
        "firefox/set-as-default/thanks.html",
        ftl_files="firefox/set-as-default/thanks",
    ),
    # Default browser campaign
    page(
        "firefox/set-as-default",
        "firefox/set-as-default/landing.html",
        ftl_files="firefox/set-as-default/landing",
    ),
    # Issue 8536
    page(
        "firefox/retention/thank-you",
        "firefox/retention/thank-you.html",
        ftl_files="firefox/retention/thank-you",
    ),
    # Unfck campaign
    page(
        "firefox/unfck",
        "firefox/campaign/unfck/index.html",
        active_locales=["de", "en-US", "fr"],
    ),
    # Issue #9490 - Evergreen Content for SEO
    page("firefox/more", "firefox/more.html", ftl_files="firefox/more"),
    page(
        "firefox/browsers/quantum",
        "firefox/browsers/quantum.html",
        ftl_files="firefox/browsers/quantum",
    ),
    page("firefox/faq", "firefox/faq.html", ftl_files="firefox/faq"),
    page(
        "firefox/browsers/chromebook",
        "firefox/browsers/chromebook.html",
        ftl_files="firefox/browsers/chromebook",
    ),
    page("firefox/sync", "firefox/sync.html", ftl_files="firefox/sync"),
    page(
        "firefox/privacy/book",
        "firefox/privacy/book.html",
        ftl_files="firefox/privacy/book",
    ),
    # Issue 9957
    page(
        "firefox/more/misinformation",
        "firefox/more/misinformation.html",
        ftl_files="firefox/more/misinformation",
    ),
)
