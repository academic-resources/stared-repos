...
def vpn_landing_page(request):
    ...
    pricing_params = settings.VPN_VARIABLE_PRICING.get(
        locale, settings.VPN_VARIABLE_PRICING["us"]
    )
    ...
    if entrypoint_experiment and entrypoint_variation:
        template_name = "products/vpn/variations/cta-{}.html".format(
