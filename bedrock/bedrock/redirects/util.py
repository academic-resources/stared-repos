...
def header_redirector(
    header_name, regex, match_dest, nomatch_dest, case_sensitive=False
):
...
def ua_redirector(regex, match_dest, nomatch_dest, case_sensitive=False):
    return header_redirector(
        "user-agent", regex, match_dest, nomatch_dest, case_sensitive
    )
