...
redirectpatterns = (
    ...
    redirect(
        r"^build/jar-packaging\.html$", "http://developer.mozilla.org/en/JAR_Packaging"
    ),
    redirect(
        r"^build/mac-build-system\.html$",
    ...
    redirect(
        r"^build/make-build\.html$", "http://developer.mozilla.org/en/Build_and_Install"
    ),
    redirect(
        r"^build/making-additions\.html$",
        "http://developer.mozilla.org/en/Adding_Files_to_the_Build",
    ),
    redirect(
        r"^build/release-build-notes\.html$",
        "http://developer.mozilla.org/en/Mozilla_Release_Build_Notes",
    ),
    redirect(
        r"^build/release-checklist\.html$",
        "http://developer.mozilla.org/en/Mozilla_Release_Checklist",
    ),
    redirect(
        r"^build/revised-user-agent-strings\.html$",
        "http://developer.mozilla.org/en/User_Agent_Strings_Reference",
    ),
    redirect(
        r"^build/sheriff-schedule\.html$", "http://wiki.mozilla.org/Sheriff_Schedule"
    ),
    redirect(r"^build/sheriff\.html$", "http://wiki.mozilla.org/Sheriff_Duty"),
    redirect(
        r"^build/sheriff/sheriff-schedule\.html$",
        "http://wiki.mozilla.org/Sheriff_Schedule",
    ),
    redirect(
        r"^build/unix-cheatsheet\.html$",
        "http://developer.mozilla.org/en/Linux_Cheat_Sheet_for_Mac_and_Windows_Programmers",
    ),
    redirect(
        r"^build/unix-details\.html$",
        "http://developer.mozilla.org/En/Unix_Detailed_Build_Instructions",
    ),
    redirect(
        r"^build/unix\.html$",
        "http://developer.mozilla.org/en/Linux_Build_Prerequisites",
    ),
    redirect(
        r"^build/win32-debugging-faq\.html$",
    ...
    redirect(
        r"^docs/hybrid-cd\.html$",
        "http://developer.mozilla.org/en/Creating_a_hybrid_CD",
    ),
    redirect(r"^docs/jargon\.html$", "http://developer.mozilla.org/en/Glossary"),
    redirect(r"^docs/mdp/$", "/contribute/writing/"),
    redirect(
        r"^docs/modunote\.htm$",
        "http://developer.mozilla.org/en/Modularization_Techniques",
    ),
    redirect(
        r"^docs/mozilla-faq\.html$",
        "http://developer.mozilla.org/en/Mozilla_Release_FAQ",
    ),
    redirect(
        r"^docs/netlib/(necko|new-handler)\.html$",
    ...
    redirect(
        r"^docs/scripting-plugins\.html$",
        "http://developer.mozilla.org/en/Scripting_Plugins_in_Mozilla",
    ),
    redirect(
        r"^docs/source-directories-overview\.html$",
        "http://developer.mozilla.org/en/Source_code_directories_overview",
    ),
    redirect(
        r"^docs/tplist/catBuild/portable-cpp\.html$", "/hacking/portable-cpp.html"
    ),
    redirect(r"^docs/tplist/catFAQ$", "/classic"),
    redirect(r"^docs/tplist/tplist\.html$", "https://developer.mozilla.org/"),
    redirect(
        r"^docs/tutorials/sitenav/$", "http://developer.mozilla.org/en/Using_Remote_XUL"
    ),
    redirect(
        r"^docs/tutorials/tinderstatus/tinderstatus\.xpi$",
    ...
    redirect(
        r"^hacking/bonsai\.html$", "http://developer.mozilla.org/en/Hacking_with_Bonsai"
    ),
    redirect(
        r"^hacking/code-review-faq\.html$",
        "http://developer.mozilla.org/en/Code_Review_FAQ",
    ),
    redirect(
        r"^hacking/coding-introduction\.html$",
        "http://developer.mozilla.org/en/Mozilla_Hacker%27s_Getting_Started_Guide",
    ),
    redirect(
        r"^hacking/cvs_over_ssh_plan\.html$",
        "http://developer.mozilla.org/En/Using_SSH_to_connect_to_CVS",
    ),
    redirect(
        r"^hacking/development-strategies\.html$",
        "http://developer.mozilla.org/en/Mozilla_Development_Strategies",
    ),
    redirect(
        r"^hacking/life-cycle\.html$", "http://developer.mozilla.org/en/Hacking_Mozilla"
    ),
    redirect(
        r"^hacking/mozilla-style-guide\.html$",
        "http://developer.mozilla.org/En/Mozilla_Coding_Style_Guide",
    ),
    redirect(
        r"^hacking/new-features\.html$",
        "http://developer.mozilla.org/en/Developing_New_Mozilla_Features",
    ),
    redirect(r"^index2\.html$", "/"),
    redirect(
        r"^js/spidermonkey/apidoc/complete-frameset\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/guide\.html$",
        "http://developer.mozilla.org/en/Embedding_SpiderMonkey",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/jsguide\.html$",
        "http://developer.mozilla.org/en/JavaScript_C_Engine_Embedder%27s_Guide",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/jsref\.htm$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/sparse-frameset\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-BOOLEAN_TO_JSVAL\.html$",
        "http://developer.mozilla.org/en/BOOLEAN_TO_JSVAL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-DOUBLE_TO_JSVAL\.html$",
        "http://developer.mozilla.org/en/DOUBLE_TO_JSVAL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-INT_FITS_IN_JSVAL\.html$",
        "http://developer.mozilla.org/en/INT_FITS_IN_JSVAL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-INT_TO_JSVAL\.html$",
        "http://developer.mozilla.org/en/INT_TO_JSVAL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSCLASS_HAS_PRIVATE\.html$",
        "http://developer.mozilla.org/en/JSCLASS_HAS_PRIVATE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSCLASS_NEW_ENUMERATE\.html$",
        "http://developer.mozilla.org/en/JSCLASS_NEW_ENUMERATE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSCLASS_NEW_RESOLVE\.html$",
        "http://developer.mozilla.org/en/JSCLASS_NEW_RESOLVE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSClass\.html$",
        "http://developer.mozilla.org/en/JSClass",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSConstDoubleSpec\.html$",
        "http://developer.mozilla.org/en/JSConstDoubleSpec",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSErrorReport\.html$",
        "http://developer.mozilla.org/en/JSErrorReport",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSFUN_BOUND_METHOD\.html$",
        "http://developer.mozilla.org/en/JSFUN_BOUND_METHOD",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSFUN_GLOBAL_PARENT\.html$",
        "http://developer.mozilla.org/en/JSFUN_GLOBAL_PARENT",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSFunctionSpec\.html$",
        "http://developer.mozilla.org/en/JSFunctionSpec",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSIdArray\.html$",
        "http://developer.mozilla.org/en/JSIdArray",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSObjectOps\.html$",
        "http://developer.mozilla.org/en/JSObjectOps",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPRINCIPALS_DROP\.html$",
        "http://developer.mozilla.org/en/JSPRINCIPALS_DROP",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPRINCIPALS_HOLD\.html$",
        "http://developer.mozilla.org/en/JSPRINCIPALS_HOLD",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPROP_ENUMERATE\.html$",
        "http://developer.mozilla.org/en/JSPROP_ENUMERATE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPROP_EXPORTED\.html$",
        "http://developer.mozilla.org/en/JSPROP_EXPORTED",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPROP_INDEX\.html$",
        "http://developer.mozilla.org/en/JSPROP_INDEX",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPROP_PERMANENT\.html$",
        "http://developer.mozilla.org/en/JSPROP_PERMANENT",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPROP_READONLY\.html$",
        "http://developer.mozilla.org/en/JSPROP_READONLY",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPrincipals\.html$",
        "http://developer.mozilla.org/en/JSPrincipals",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSProperty\.html$",
        "http://developer.mozilla.org/en/JSProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSPropertySpec\.html$",
        "http://developer.mozilla.org/en/JSPropertySpec",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSRESOLVE_ASSIGNING\.html$",
        "http://developer.mozilla.org/en/JSRESOLVE_ASSIGNING",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSRESOLVE_QUALIFIED\.html$",
        "http://developer.mozilla.org/en/JSRESOLVE_QUALIFIED",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_FALSE\.html$",
        "http://developer.mozilla.org/en/JSVAL_FALSE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_BOOLEAN\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_BOOLEAN",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_DOUBLE\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_DOUBLE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_GCTHING\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_GCTHING",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_INT\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_INT",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_NULL\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_NULL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_NUMBER\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_NUMBER",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_OBJECT\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_OBJECT",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_PRIMITIVE\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_PRIMITIVE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_STRING\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_STRING",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_IS_VOID\.html$",
        "http://developer.mozilla.org/en/JSVAL_IS_VOID",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_LOCK\.html$",
        "http://developer.mozilla.org/en/JSVAL_LOCK",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_NULL\.html$",
        "http://developer.mozilla.org/en/JSVAL_NULL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_ONE\.html$",
        "http://developer.mozilla.org/en/JSVAL_ONE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TO_BOOLEAN\.html$",
        "http://developer.mozilla.org/en/JSVAL_TO_BOOLEAN",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TO_DOUBLE\.html$",
        "http://developer.mozilla.org/en/JSVAL_TO_DOUBLE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TO_GCTHING\.html$",
        "http://developer.mozilla.org/en/JSVAL_TO_GCTHING",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TO_INT\.html$",
        "http://developer.mozilla.org/en/JSVAL_TO_INT",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TO_OBJECT\.html$",
        "http://developer.mozilla.org/en/JSVAL_TO_OBJECT",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TO_PRIVATE\.html$",
        "http://developer.mozilla.org/en/JSVAL_TO_PRIVATE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TO_STRING\.html$",
        "http://developer.mozilla.org/en/JSVAL_TO_STRING",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_TRUE\.html$",
        "http://developer.mozilla.org/en/JSVAL_TRUE",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_UNLOCK\.html$",
        "http://developer.mozilla.org/en/JSVAL_UNLOCK",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_VOID\.html$",
        "http://developer.mozilla.org/en/JSVAL_VOID",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JSVAL_ZERO\.html$",
        "http://developer.mozilla.org/en/JSVAL_ZERO",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_AddNamedRoot\.html$",
        "http://developer.mozilla.org/en/JS_AddNamedRoot",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_AddRoot\.html$",
        "http://developer.mozilla.org/en/JS_AddRoot",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_AliasElement\.html$",
        "http://developer.mozilla.org/en/JS_AliasElement",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_AliasProperty\.html$",
        "http://developer.mozilla.org/en/JS_AliasProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_BeginRequest\.html$",
        "http://developer.mozilla.org/en/JS_BeginRequest",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CallFunction\.html$",
        "http://developer.mozilla.org/en/JS_CallFunction",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CallFunctionName\.html$",
        "http://developer.mozilla.org/en/JS_CallFunctionName",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CallFunctionValue\.html$",
        "http://developer.mozilla.org/en/JS_CallFunctionValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CheckAccess\.html$",
        "http://developer.mozilla.org/en/JS_CheckAccess",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ClearContextThread\.html$",
        "http://developer.mozilla.org/en/JS_ClearContextThread",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ClearScope\.html$",
        "http://developer.mozilla.org/en/JS_ClearScope",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CloneFunctionObject\.html$",
        "http://developer.mozilla.org/en/JS_CloneFunctionObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompareStrings\.html$",
        "http://developer.mozilla.org/en/JS_CompareStrings",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileFile\.html$",
        "http://developer.mozilla.org/en/JS_CompileFile",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileFunction\.html$",
        "http://developer.mozilla.org/en/JS_CompileFunction",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileFunctionForPrincipals\.html$",
        "http://developer.mozilla.org/en/JS_CompileFunctionForPrincipals",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileScript\.html$",
        "http://developer.mozilla.org/en/JS_CompileScript",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileScriptForPrincipals\.html$",
        "http://developer.mozilla.org/en/JS_CompileScriptForPrincipals",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileUCFunction\.html$",
    ...
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileUCScript\.html$",
        "http://developer.mozilla.org/en/JS_CompileUCScript",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_CompileUCScriptForPrincipals\.html$",
        "http://developer.mozilla.org/en/JS_CompileUCScriptForPrincipals",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ConstructObject\.html$",
        "http://developer.mozilla.org/en/JS_ConstructObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ContextIterator\.html$",
        "http://developer.mozilla.org/en/JS_ContextIterator",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ConvertArguments\.html$",
        "http://developer.mozilla.org/en/JS_ConvertArguments",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ConvertStub\.html$",
        "http://developer.mozilla.org/en/JS_ConvertStub",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ConvertValue\.html$",
        "http://developer.mozilla.org/en/JS_ConvertValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DecompileFunction\.html$",
        "http://developer.mozilla.org/en/JS_DecompileFunction",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DecompileFunctionBody\.html$",
        "http://developer.mozilla.org/en/JS_DecompileFunctionBody",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DecompileScript\.html$",
        "http://developer.mozilla.org/en/JS_DecompileScript",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineConstDoubles\.html$",
        "http://developer.mozilla.org/en/JS_DefineConstDoubles",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineElement\.html$",
        "http://developer.mozilla.org/en/JS_DefineElement",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineFunction\.html$",
        "http://developer.mozilla.org/en/JS_DefineFunction",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineFunctions\.html$",
        "http://developer.mozilla.org/en/JS_DefineFunctions",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineObject\.html$",
        "http://developer.mozilla.org/en/JS_DefineObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineProperties\.html$",
        "http://developer.mozilla.org/en/JS_DefineProperties",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineProperty\.html$",
        "http://developer.mozilla.org/en/JS_DefineProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefinePropertyWithTinyId\.html$",
        "http://developer.mozilla.org/en/JS_DefinePropertyWithTinyId",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineUCProperty\.html$",
        "http://developer.mozilla.org/en/JS_DefineUCProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DefineUCPropertyWithTinyID\.html$",
        "http://developer.mozilla.org/en/JS_DefineUCPropertyWithTinyID",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DeleteElement\.html$",
        "http://developer.mozilla.org/en/JS_DeleteElement",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DeleteElement2\.html$",
        "http://developer.mozilla.org/en/JS_DeleteElement2",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DeleteProperty\.html$",
        "http://developer.mozilla.org/en/JS_DeleteProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DeleteProperty2\.html$",
        "http://developer.mozilla.org/en/JS_DeleteProperty2",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DeleteUCProperty2\.html$",
        "http://developer.mozilla.org/en/JS_DeleteUCProperty2",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DestroyContext\.html$",
        "http://developer.mozilla.org/en/JS_DestroyContext",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DestroyIdArray\.html$",
        "http://developer.mozilla.org/en/JS_DestroyIdArray",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DestroyRuntime\.html$",
        "http://developer.mozilla.org/en/JS_DestroyRuntime",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DestroyScript\.html$",
        "http://developer.mozilla.org/en/JS_DestroyScript",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_DumpNamedRoots\.html$",
        "http://developer.mozilla.org/en/JS_DumpNamedRoots",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_EndRequest\.html$",
        "http://developer.mozilla.org/en/JS_EndRequest",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_Enumerate\.html$",
        "http://developer.mozilla.org/en/JS_Enumerate",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_EnumerateStub\.html$",
        "http://developer.mozilla.org/en/JS_EnumerateStub",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_EvaluateScript\.html$",
        "http://developer.mozilla.org/en/JS_EvaluateScript",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_EvaluateScriptForPrincipals\.html$",
        "http://developer.mozilla.org/en/JS_EvaluateScriptForPrincipals",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_EvaluateUCScript\.html$",
        "http://developer.mozilla.org/en/JS_EvaluateUCScript",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_EvaluateUCScriptForPrincipals\.html$",
        "http://developer.mozilla.org/en/JS_EvaluateUCScriptForPrincipals",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ExecuteScript\.html$",
        "http://developer.mozilla.org/en/JS_ExecuteScript",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_FinalizeStub\.html$",
        "http://developer.mozilla.org/en/JS_FinalizeStub",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_Finish\.html$",
        "http://developer.mozilla.org/en/JS_Finish",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GC\.html$",
        "http://developer.mozilla.org/en/JS_GC",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetArrayLength\.html$",
        "http://developer.mozilla.org/en/JS_GetArrayLength",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetClass\.html$",
        "http://developer.mozilla.org/en/JS_GetClass",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetConstructor\.html$",
        "http://developer.mozilla.org/en/JS_GetConstructor",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetContextPrivate\.html$",
        "http://developer.mozilla.org/en/JS_GetContextPrivate",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetContextThread\.html$",
        "http://developer.mozilla.org/en/JS_GetContextThread",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetElement\.html$",
        "http://developer.mozilla.org/en/JS_GetElement",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetEmptyStringValue\.html$",
        "http://developer.mozilla.org/en/JS_GetEmptyStringValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetFunctionName\.html$",
        "http://developer.mozilla.org/en/JS_GetFunctionName",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetFunctionObject\.html$",
        "http://developer.mozilla.org/en/JS_GetFunctionObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetGlobalObject\.html$",
        "http://developer.mozilla.org/en/JS_GetGlobalObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetImplementationVersion\.html$",
        "http://developer.mozilla.org/en/JS_GetImplementationVersion",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetInstancePrivate\.html$",
        "http://developer.mozilla.org/en/JS_GetInstancePrivate",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetNaNValue\.html$",
        "http://developer.mozilla.org/en/JS_GetNaNValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetNegativeInfinityValue\.html$",
        "http://developer.mozilla.org/en/JS_GetNegativeInfinityValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetParent\.html$",
        "http://developer.mozilla.org/en/JS_GetParent",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetPositiveInfinityValue\.html$",
        "http://developer.mozilla.org/en/JS_GetPositiveInfinityValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetPrivate\.html$",
        "http://developer.mozilla.org/en/JS_GetPrivate",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetProperty\.html$",
        "http://developer.mozilla.org/en/JS_GetProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetPropertyAttributes\.html$",
        "http://developer.mozilla.org/en/JS_GetPropertyAttributes",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetPrototype\.html$",
        "http://developer.mozilla.org/en/JS_GetPrototype",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetRuntime\.html$",
        "http://developer.mozilla.org/en/JS_GetRuntime",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetScopeChain\.html$",
        "http://developer.mozilla.org/en/JS_GetScopeChain",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetStringBytes\.html$",
        "http://developer.mozilla.org/en/JS_GetStringBytes",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetStringChars\.html$",
        "http://developer.mozilla.org/en/JS_GetStringChars",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetStringLength\.html$",
        "http://developer.mozilla.org/en/JS_GetStringLength",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetTypeName\.html$",
        "http://developer.mozilla.org/en/JS_GetTypeName",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetUCProperty\.html$",
        "http://developer.mozilla.org/en/JS_GetUCProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_GetVersion\.html$",
        "http://developer.mozilla.org/en/JS_GetVersion",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_HasArrayLength\.html$",
        "http://developer.mozilla.org/en/JS_HasArrayLength",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_IdToValue\.html$",
        "http://developer.mozilla.org/en/JS_IdToValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_Init\.html$",
        "http://developer.mozilla.org/en/JS_Init",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_InitClass\.html$",
        "http://developer.mozilla.org/en/JS_InitClass",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_InitStandardClasses\.html$",
        "http://developer.mozilla.org/en/JS_InitStandardClasses",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_InstanceOf\.html$",
        "http://developer.mozilla.org/en/JS_InstanceOf",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_InternString\.html$",
        "http://developer.mozilla.org/en/JS_InternString",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_InternUCString\.html$",
        "http://developer.mozilla.org/en/JS_InternUCString",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_InternUCStringN\.html$",
        "http://developer.mozilla.org/en/JS_InternUCStringN",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_IsArrayObject\.html$",
        "http://developer.mozilla.org/en/JS_IsArrayObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_IsConstructing\.html$",
        "http://developer.mozilla.org/en/JS_IsConstructing",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_IsRunning\.html$",
        "http://developer.mozilla.org/en/JS_IsRunning",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_Lock\.html$",
        "http://developer.mozilla.org/en/JS_Lock",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_LockGCThing\.html$",
        "http://developer.mozilla.org/en/JS_LockGCThing",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_LookupElement\.html$",
        "http://developer.mozilla.org/en/JS_LookupElement",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_LookupProperty\.html$",
        "http://developer.mozilla.org/en/JS_LookupProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_LookupUCProperty\.html$",
        "http://developer.mozilla.org/en/JS_LookupUCProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_MaybeGC\.html$",
        "http://developer.mozilla.org/en/JS_MaybeGC",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewArrayObject\.html$",
        "http://developer.mozilla.org/en/JS_NewArrayObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewContext\.html$",
        "http://developer.mozilla.org/en/JS_NewContext",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewDouble\.html$",
        "http://developer.mozilla.org/en/JS_NewDouble",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewDoubleValue\.html$",
        "http://developer.mozilla.org/en/JS_NewDoubleValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewFunction\.html$",
        "http://developer.mozilla.org/en/JS_NewFunction",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewIdArray\.html$",
        "http://developer.mozilla.org/en/JS_NewIdArray",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewNumberValue\.html$",
        "http://developer.mozilla.org/en/JS_NewNumberValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewObject\.html$",
        "http://developer.mozilla.org/en/JS_NewObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewRuntime\.html$",
        "http://developer.mozilla.org/en/JS_NewRuntime",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewScriptObject\.html$",
        "http://developer.mozilla.org/en/JS_NewScriptObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewString\.html$",
        "http://developer.mozilla.org/en/JS_NewString",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewStringCopyN\.html$",
        "http://developer.mozilla.org/en/JS_NewStringCopyN",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewStringCopyZ\.html$",
        "http://developer.mozilla.org/en/JS_NewStringCopyZ",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewUCString\.html$",
        "http://developer.mozilla.org/en/JS_NewUCString",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewUCStringCopyN\.html$",
        "http://developer.mozilla.org/en/JS_NewUCStringCopyN",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_NewUCStringCopyZ\.html$",
        "http://developer.mozilla.org/en/JS_NewUCStringCopyZ",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_PropertyStub\.html$",
        "http://developer.mozilla.org/en/JS_PropertyStub",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_RemoveRoot\.html$",
        "http://developer.mozilla.org/en/JS_RemoveRoot",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ReportError\.html$",
        "http://developer.mozilla.org/en/JS_ReportError",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ReportOutOfMemory\.html$",
        "http://developer.mozilla.org/en/JS_ReportOutOfMemory",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ResolveStub\.html$",
        "http://developer.mozilla.org/en/JS_ResolveStub",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ResumeRequest\.html$",
        "http://developer.mozilla.org/en/JS_ResumeRequest",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetArrayLength\.html$",
        "http://developer.mozilla.org/en/JS_SetArrayLength",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetBranchCallback\.html$",
        "http://developer.mozilla.org/en/JS_SetBranchCallback",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetContextPrivate\.html$",
        "http://developer.mozilla.org/en/JS_SetContextPrivate",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetContextThread\.html$",
        "http://developer.mozilla.org/en/JS_SetContextThread",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetElement\.html$",
        "http://developer.mozilla.org/en/JS_SetElement",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetErrorReporter\.html$",
        "http://developer.mozilla.org/en/JS_SetErrorReporter",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetGCCallback\.html$",
        "http://developer.mozilla.org/en/JS_SetGCCallback",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetGlobalObject\.html$",
        "http://developer.mozilla.org/en/JS_SetGlobalObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetParent\.html$",
        "http://developer.mozilla.org/en/JS_SetParent",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetPrivate\.html$",
        "http://developer.mozilla.org/en/JS_SetPrivate",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetProperty\.html$",
        "http://developer.mozilla.org/en/JS_SetProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetPropertyAttributes\.html$",
        "http://developer.mozilla.org/en/JS_SetPropertyAttributes",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetPrototype\.html$",
        "http://developer.mozilla.org/en/JS_SetPrototype",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetUCProperty\.html$",
        "http://developer.mozilla.org/en/JS_SetUCProperty",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SetVersion\.html$",
        "http://developer.mozilla.org/en/JS_SetVersion",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_SuspendRequest\.html$",
        "http://developer.mozilla.org/en/JS_SuspendRequest",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_TypeOfValue\.html$",
        "http://developer.mozilla.org/en/JS_TypeOfValue",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_Unlock\.html$",
        "http://developer.mozilla.org/en/JS_Unlock",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_UnlockGCThing\.html$",
        "http://developer.mozilla.org/en/JS_UnlockGCThing",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToBoolean\.html$",
        "http://developer.mozilla.org/en/JS_ValueToBoolean",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToECMAInt32\.html$",
        "http://developer.mozilla.org/en/JS_ValueToECMAInt32",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToECMAUint32\.html$",
        "http://developer.mozilla.org/en/JS_ValueToECMAUint32",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToFunction\.html$",
        "http://developer.mozilla.org/en/JS_ValueToFunction",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToId\.html$",
        "http://developer.mozilla.org/en/JS_ValueToId",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToInt32\.html$",
        "http://developer.mozilla.org/en/JS_ValueToInt32",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToNumber\.html$",
        "http://developer.mozilla.org/en/JS_ValueToNumber",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToObject\.html$",
        "http://developer.mozilla.org/en/JS_ValueToObject",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToString\.html$",
        "http://developer.mozilla.org/en/JS_ValueToString",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_ValueToUint16\.html$",
        "http://developer.mozilla.org/en/JS_ValueToUint16",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_free\.html$",
        "http://developer.mozilla.org/en/JS_free",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_malloc\.html$",
        "http://developer.mozilla.org/en/JS_malloc",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_realloc\.html$",
        "http://developer.mozilla.org/en/JS_realloc",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-JS_strdup\.html$",
        "http://developer.mozilla.org/en/JS_strdup",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-OBJECT_TO_JSVAL\.html$",
        "http://developer.mozilla.org/en/OBJECT_TO_JSVAL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-PRIVATE_TO_JSVAL\.html$",
        "http://developer.mozilla.org/en/PRIVATE_TO_JSVAL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/api-STRING_TO_JSVAL\.html$",
        "http://developer.mozilla.org/en/STRING_TO_JSVAL",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/complete-toc-abc\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/complete-toc-grp\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/complete-toc\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/complete\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/sidebar-toc\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/sparse-toc-abc\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/sparse-toc-grp\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/apidoc/gen/sparse-toc\.html$",
        "http://developer.mozilla.org/en/JSAPI_Reference",
    ),
    redirect(
        r"^js/spidermonkey/gctips\.html$",
        "http://developer.mozilla.org/en/SpiderMonkey_Garbage_Collection_Tips",
    ),
    redirect(r"^mailman$", "https://mail.mozilla.org"),
    redirect(
        r"^mailnews/ABSyncClientDesign\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Address_book_sync_client_design",
    ),
    redirect(
        r"^mailnews/arch/ABSyncClientDesign\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Address_book_sync_client_design",
    ),
    redirect(
        r"^mailnews/arch/accountmanager\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Using_the_Multiple_Accounts_API",
    ),
    redirect(
        r"^mailnews/arch/addrbook/hiddenprefs\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Hidden_address_book_prefs",
    ),
    redirect(
        r"^mailnews/arch/compose-backend\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Mail_composition_back_end",
    ),
    redirect(
        r"^mailnews/arch/compose/cached\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Cached_compose_window_FAQ",
    ),
    redirect(
        r"^mailnews/arch/compose/hiddenprefs\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Hidden_prefs",
    ),
    redirect(
        r"^mailnews/arch/events\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Mail_event_system",
    ),
    redirect(
        r"^mailnews/arch/hiddenprefs\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Hidden_prefs",
    ),
    redirect(
        r"^mailnews/arch/libmime-content-type-handlers\.html$",
        "https://developer.mozilla.org/en/Thunderbird/libmime_content_type_handlers",
    ),
    redirect(
        r"^mailnews/arch/libmime-description\.html$",
        "https://developer.mozilla.org/en/Thunderbird/The_libmime_module",
    ),
    redirect(
        r"^mailnews/arch/overview\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Mail_client_architecture_overview",
    ),
    redirect(
        r"^mailnews/arch/rdf\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Mail_and_RDF",
    ),
    redirect(
        r"^mailnews/arch/spam/$",
        "https://developer.mozilla.org/en/Thunderbird/Spam_filtering",
    ),
    redirect(
        r"^mailnews/compose-backend\.html$",
        "https://developer.mozilla.org/en/Thunderbird/Mail_composition_back_end",
    ),
    redirect(
        r"^mailnews/libmime-content-type-handlers\.html$",
        "https://developer.mozilla.org/en/Thunderbird/libmime_content_type_handlers",
    ),
    redirect(
        r"^mailnews/libmime-description\.html$",
        "https://developer.mozilla.org/en/Thunderbird/The_libmime_module",
    ),
    redirect(
        r"^mailnews/review-mail\.html$",
        "https://developer.mozilla.org/en/Mailnews_and_Mail_code_review_requirements",
    ),
    redirect(
        r"^mailnews/review\.html$",
        "https://developer.mozilla.org/en/Mailnews_and_Mail_code_review_requirements",
    ),
    ...
    redirect(
        r"^newlayout/bugathon\.html$", "http://developer.mozilla.org/en/Gecko_BugAThon"
    ),
    ...
    redirect(
        r"^newlayout/glossary\.html$", "https://developer.mozilla.org/en/Gecko_Glossary"
    ),
    ...
    redirect(
        r"^performance/tinderbox-tests\.html$",
        "http://wiki.mozilla.org/Performance:Tinderbox_Tests",
    ),
    redirect(
        r"^performance/leak-brownbag\.html$",
    ...
    redirect(
        r"^projects/calendar/holidays/$",
        "https://www.thunderbird.net/calendar/holidays/",
    ),
    # bug 885799, 952429
    redirect(
        r"^projects/calendar/holidays\.html$",
        "https://www.thunderbird.net/calendar/holidays/",
    ),
    redirect(
        r"^products/camino/badges/$", "http://caminobrowser.org/community/promotion/"
    ),
    redirect(
        r"^products/camino/features/searchCustomization\.html$",
        "http://caminobrowser.org/help/",
    ),
    redirect(
        r"^products/camino/features/tipsTricks\.html$", "http://caminobrowser.org/help/"
    ),
    redirect(r"^products/camino/$", "http://caminobrowser.org/"),
    redirect(
        r"^products/camino/releases/0\.8\.1\.html$",
        "http://caminobrowser.org/releases/0.8.1/",
    ),
    redirect(
        r"^products/camino/releases/0\.8\.2\.html$",
        "http://caminobrowser.org/releases/0.8.2/",
    ),
    redirect(
        r"^products/camino/releases/0\.8\.3\.html$",
        "http://caminobrowser.org/releases/0.8.3/",
    ),
    redirect(
        r"^products/camino/releases/0\.8\.4\.html$",
        "http://caminobrowser.org/releases/0.8.4/",
    ),
    redirect(
        r"^products/camino/releases/0\.8\.5\.html$",
        "http://caminobrowser.org/releases/0.8.5/",
    ),
    redirect(
        r"^products/camino/releases/0\.8\.html$",
        "http://caminobrowser.org/releases/0.8/",
    ),
    redirect(
        r"^products/camino/releases/0\.8b\.html$",
        "http://caminobrowser.org/releases/0.8b/",
    ),
    redirect(
        r"^products/camino/releases/0\.9a1\.html$",
        "http://caminobrowser.org/releases/0.9a1/",
    ),
    redirect(
        r"^products/camino/releases/0\.9a2\.html$",
        "http://caminobrowser.org/releases/0.9a2/",
    ),
    redirect(
        r"^products/camino/releases/1\.0\.1\.html$",
        "http://caminobrowser.org/releases/1.0.1/",
    ),
    redirect(
        r"^products/camino/releases/1\.0\.2\.html$",
        "http://caminobrowser.org/releases/1.0.2/",
    ),
    redirect(
        r"^products/camino/releases/1\.0\.3\.html$",
        "http://caminobrowser.org/releases/1.0.3/",
    ),
    redirect(
        r"^products/camino/releases/1\.0\.4\.html$",
        "http://caminobrowser.org/releases/1.0.4/",
    ),
    redirect(
        r"^products/camino/releases/1\.0\.5\.html$",
        "http://caminobrowser.org/releases/1.0.5/",
    ),
    redirect(
        r"^products/camino/releases/1\.0\.6\.html$",
        "http://caminobrowser.org/releases/1.0.6/",
    ),
    redirect(
        r"^products/camino/releases/1\.0\.html$",
        "http://caminobrowser.org/releases/1.0/",
    ),
    redirect(
        r"^products/camino/releases/1\.0a1\.html$",
        "http://caminobrowser.org/releases/1.0a1/",
    ),
    redirect(
        r"^products/camino/releases/1\.0b1\.html$",
        "http://caminobrowser.org/releases/1.0b1/",
    ),
    redirect(
        r"^products/camino/releases/1\.0b2\.html$",
        "http://caminobrowser.org/releases/1.0b2/",
    ),
    redirect(
        r"^products/camino/releases/1\.0rc1\.html$",
    ...
    redirect(
        r"^products/thunderbird/global-inbox\.html$",
        "http://kb.mozillazine.org/Global_Inbox",
    ),
    redirect(
        r"^products/thunderbird/junkmail\.html$",
        "http://kb.mozillazine.org/Junk_Mail_Controls",
    ),
    redirect(
        r"^products/thunderbird/message-grouping\.html$",
        "http://kb.mozillazine.org/Message_Grouping",
    ),
    redirect(
        r"^products/thunderbird/privacy-protection\.html$",
        "http://kb.mozillazine.org/Privacy_basics_%28Thunderbird%29",
    ),
    redirect(r"^products/thunderbird/releases(/.*)?$", "/thunderbird/releases/"),
    redirect(
        r"^products/thunderbird/rss\.html$",
        "http://kb.mozillazine.org/RSS_basics_%28Thunderbird%29",
    ),
    redirect(
        r"^products/thunderbird/search-folders\.html$",
        "http://kb.mozillazine.org/Saved_Search",
    ),
    redirect(
        r"^products/thunderbird/sysreq\.html$", "/thunderbird/system-requirements/"
    ),
    redirect(r"^products/thunderbird(/.*)?$", "/thunderbird/"),
    redirect(
        r"^profilemanager/isp-rdf-info\.txt$",
        "https://developer.mozilla.org/docs/Isp_Data",
    ),
    ...
    redirect(
        r"^projects/camino/damagedBookmarks\.html$",
        "http://wiki.caminobrowser.org/QA:Damaged_Bookmarks",
    ),
    redirect(
        r"^projects/camino/development\.html$", "http://caminobrowser.org/contribute/"
    ),
    redirect(r"^projects/camino/docs/$", "http://caminobrowser.org/help/"),
    redirect(
        r"^projects/camino/docs/miscfeatures\.html$",
        "http://caminobrowser.org/documentation/",
    ),
    redirect(
        r"^projects/camino/docs/profileprefs\.html$",
        "http://caminobrowser.org/documentation/hiddenprefs/",
    ),
    redirect(
        r"^projects/camino/docs/proxies\.html$",
    ...
    redirect(
        r"^projects/camino/releasenotes\.html$", "http://caminobrowser.org/releases/"
    ),
    redirect(
        r"^projects/camino/shortcuts\.html$",
    ...
    redirect(
        r"^projects/firebird/0\.1-release-notes\.html$",
        "/products/firefox/releases/0.1.html",
    ),
    redirect(
        r"^projects/firebird/0\.2-release-notes\.html$",
        "/products/firefox/releases/0.2.html",
    ),
    redirect(
        r"^projects/firebird/0\.3-release-notes\.html$",
        "/products/firefox/releases/0.3.html",
    ),
    redirect(
        r"^projects/firebird/0\.4-release-notes\.html$",
        "/products/firefox/releases/0.4.html",
    ),
    redirect(
        r"^projects/firebird/0\.5-release-notes\.html$",
        "/products/firefox/releases/0.5.html",
    ),
    redirect(
        r"^projects/firebird/0\.6-release-notes\.html$",
        "/products/firefox/releases/0.6.html",
    ),
    redirect(
        r"^projects/firebird/0\.6\.1-release-notes\.html$",
        "/products/firefox/releases/0.6.1.html",
    ),
    redirect(
        r"^projects/firebird/0\.7-release-notes\.html$",
        "/products/firefox/releases/0.7.html",
    ),
    redirect(
        r"^projects/firebird/0\.7\.1-release-notes\.html$",
    ...
    redirect(
        r"^projects/firebird/installer/build\.html$",
        "/projects/firefox/installer/build.html",
    ),
    redirect(
        r"^projects/firebird/qa/downloads\.html$", "/projects/firefox/qa/downloads.html"
    ),
    ...
    redirect(
        r"^projects/firebird/releases\.html$",
    ...
    redirect(
        r"^projects/firefox/l10n/installer-encodings\.html$",
        "http://developer.mozilla.org/en/Encodings_for_localization_files",
    ),
    redirect(
        r"^projects/firefox/l10n/l10n-step-by-step\.html$",
        "https://wiki.mozilla.org/L10n",
    ),
    redirect(
        r"^projects/firefox/l10n/localize-release\.html$",
        "https://wiki.mozilla.org/L10n",
    ),
    redirect(
        r"^projects/firefox/l10n/using-cvs\.html$", "https://wiki.mozilla.org/L10n"
    ),
    ...
    redirect(
        r"^projects/intl/xul-styleguide\.html$", "/projects/l10n/xul-styleguide.html"
    ),
    redirect(r"^projects/intl/fonts\.html$", "http://wiki.mozilla.org/Font_selection"),
    redirect(
        r"^projects/l10n/customizable-code\.html$",
        "https://developer.mozilla.org/en/Writing_localizable_code",
    ),
    redirect(
        r"^projects/l10n/mlp_docs\.html$",
        "https://wiki.mozilla.org/L10n:Localization_Process",
    ),
    redirect(
        r"^projects/l10n/mlp_howto_Firefox\.html$",
        "https://wiki.mozilla.org/L10n:Localization_Process",
    ),
    redirect(
        r"^projects/l10n/mlp_status\.html$",
    ...
    redirect(
        r"^projects/marketing/banners\.html$",
        "http://www.spreadfirefox.com/affiliates/homepage",
    ),
    redirect(
        r"^projects/marketing/buttons\.html$",
        "http://www.spreadfirefox.com/affiliates/homepage",
    ),
    redirect(
    ...
    redirect(
        r"^projects/mathml/start-hebrew\.xhtml$", "/projects/mathml/start-hebrew.html"
    ),
    redirect(
        r"^projects/mathml/start-thai\.xhtml$", "/projects/mathml/start-thai.html"
    ),
    redirect(
    ...
    redirect(
        r"^projects/mathml/demo/basics\.xhtml$", "/projects/mathml/demo/basics.html"
    ),
    redirect(
        r"^projects/mathml/demo/extras\.xhtml$", "/projects/mathml/demo/extras.html"
    ),
    redirect(
        r"^projects/mathml/demo/mfrac\.xhtml$", "/projects/mathml/demo/mfrac.html"
    ),
    redirect(
        r"^projects/mathml/demo/mmultiscripts\.xhtml$",
        "/projects/mathml/demo/mmultiscripts.html",
    ),
    redirect(r"^projects/mathml/demo/mo\.xhtml$", "/projects/mathml/demo/mo.html"),
    redirect(
        r"^projects/mathml/demo/mspace\.xhtml$", "/projects/mathml/demo/mspace.html"
    ),
    redirect(
        r"^projects/mathml/demo/mtable\.xhtml$", "/projects/mathml/demo/mtable.html"
    ),
    redirect(
        r"^projects/mathml/demo/texvsmml\.xhtml$", "/projects/mathml/demo/texvsmml.html"
    ),
    redirect(
        r"^projects/mathml/demo/roots\.xhtml$", "/projects/mathml/demo/roots.html"
    ),
    ...
    redirect(
        r"^projects/phoenix/0\.1-release-notes\.html$",
        "/products/firefox/releases/0.1.html",
    ),
    redirect(
        r"^projects/phoenix/0\.2-release-notes\.html$",
        "/products/firefox/releases/0.2.html",
    ),
    redirect(
        r"^projects/phoenix/0\.3-release-notes\.html$",
        "/products/firefox/releases/0.3.html",
    ),
    redirect(
        r"^projects/phoenix/0\.4-release-notes\.html$",
        "/products/firefox/releases/0.5.html",
    ),
    redirect(
        r"^projects/phoenix/0\.5-release-notes\.html$",
        "/products/firefox/releases/0.5.html",
    ),
    redirect(
        r"^projects/phoenix/0\.6-release-notes\.html$",
        "/products/firefox/releases/0.6.html",
    ),
    redirect(
        r"^projects/phoenix/extensions/$", "http://texturizer.net/firefox/extensions/"
    ),
    redirect(r"^projects/phoenix/$", "/projects/firefox/"),
    redirect(
        r"^projects/phoenix/phoenix-advantages\.html$", "/products/firefox/releases/"
    ),
    redirect(
        r"^projects/phoenix/phoenix-roadmap\.html$", "/projects/firefox/roadmap.html"
    ),
    ...
    redirect(
        r"^projects/svg/status\.html$",
        "https://developer.mozilla.org/en/Mozilla_SVG_Status",
    ),
    redirect(
        r"^projects/svg/build\.html$",
        "https://developer.mozilla.org/en/Developer_Guide/Build_Instructions",
    ),
    redirect(
        r"^projects/thunderbird/?$", "https://wiki.mozilla.org/Thunderbird:Home_Page"
    ),
    redirect(
        r"^projects/thunderbird/build\.html$",
    ...
    redirect(
        r"^projects/ui/accessibility/slides/moz_accslides\.html$", "/access/slideshow/"
    ),
    redirect(r"^projects/ui/accessibility/slides$", "/access/slideshow"),
    redirect(
        r"^projects/ui/accessibility/moz_accslides_text_version\.html$",
        "/access/slideshow/text",
    ),
    redirect(r"^projects/ui/accessibility/index-users\.html$", "/access/users"),
    redirect(
        r"^projects/ui/accessibility/Accessibility_Features_in_Mozilla\.html$",
        "/access/features",
    ),
    redirect(
        r"^projects/ui/accessibility/index-procurement\.html$", "/access/evaluators"
    ),
    redirect(r"^projects/ui/accessibility/index-authors\.html$", "/access/authors"),
    redirect(
        r"^projects/ui/accessibility/dynamic-accessibility\.html$",
        "/access/dynamic-content",
    ),
    redirect(
        r"^projects/ui/accessibility/index-atvendors\.html$", "/access/at-vendors"
    ),
    redirect(r"^projects/ui/accessibility/index-qa-ui\.html$", "/access/qa"),
    redirect(
        r"^projects/ui/accessibility/index-frontend-coders\.html$",
        "/access/ui-developers",
    ),
    redirect(
        r"^projects/ui/accessibility/index-core-hackers\.html$",
        "/access/core-developers",
    ),
    redirect(
        r"^projects/ui/accessibility/index-external-developers\.html$",
        "/access/external-developers",
    ),
    redirect(
        r"^projects/ui/accessibility/toolkit-checklist\.html$",
        "/access/toolkit-checklist",
    ),
    redirect(
        r"^projects/ui/accessibility/msaa-server-impl\.html$",
        "/access/windows/msaa-server",
    ),
    redirect(
        r"^projects/ui/accessibility/accessible-xul-authoring\.html$",
        "/access/xul-guidelines",
    ),
    redirect(
        r"^projects/ui/accessibility/window-eyes-status\.html$",
        "/access/windows/window-eyes",
    ),
    redirect(r"^projects/ui/accessibility/typeaheadfind\.html$", "/access/type-ahead"),
    redirect(
        r"^projects/ui/accessibility/planning-ahead-for-accessibility\.html$",
        "/access/planning",
    ),
    redirect(
        r"^projects/ui/accessibility/zoomtext-status\.html$", "/access/windows/zoomtext"
    ),
    redirect(
        r"^projects/ui/accessibility/keyboard-status\.html$", "/access/keyboard/testing"
    ),
    redirect(
        r"^projects/ui/accessibility/vendors-win\.html$", "/access/windows/at-apis"
    ),
    ...
    redirect(
        r"^projects/ui/accessibility/span-checkbox\.html$",
    ...
    redirect(
        r"^projects/ui/accessibility/accesskey\.html$", "/access/keyboard/accesskey"
    ),
    redirect(r"^projects/ui/accessibility/mozkeyintro\.html$", "/access/keyboard/"),
    redirect(
        r"^projects/ui/accessibility/Javascript-nsIAccessible\.html$",
        "/access/samples/js-nsIAccessible",
    ),
    redirect(
        r"^projects/ui/accessibility/Javascript-nsIAccessible\.js$",
        "/access/samples/js-nsIAccessible.js",
    ),
    redirect(
        r"^projects/ui/accessibility/mozkeyplan\.html$", "/access/keyboard/interactive"
    ),
    redirect(
        r"^projects/ui/accessibility/mozkeylist\.html$", "/access/keyboard/mozilla"
    ),
    redirect(
        r"^projects/ui/accessibility/mozkeyboard\.html$", "/access/keyboard/layout"
    ),
    redirect(
        r"^projects/ui/accessibility/Javascript-nsIAccessible-notes\.html$",
        "/access/samples/js-nsIAccessible-notes",
    ),
    redirect(
        r"^projects/ui/accessibility/accessible-architecture\.html$",
        "/access/architecture",
    ),
    redirect(
        r"^projects/ui/accessibility/accessible-events\.html$", "/access/event-flow"
    ),
    redirect(
        r"^projects/ui/accessibility/cross-ref-apis\.html$", "/access/platform-apis"
    ),
    redirect(r"^projects/ui/accessibility/resources\.html$", "/access/resources"),
    redirect(
        r"^projects/ui/accessibility/access-mozilla\.png$", "/access/access-mozilla.png"
    ),
    redirect(
        r"^projects/ui/accessibility/powerbraille\.jpg$", "/access/powerbraille.jpg"
    ),
    redirect(r"^projects/ui/accessibility/vpduo2\.jpg$", "/access/vpduo2.jpg"),
    redirect(
        r"^projects/ui/accessibility/qa/taf_acceptance\.html$",
        "/access/type-ahead/basic",
    ),
    redirect(
        r"^projects/ui/accessibility/qa/taf_functional\.html$",
        "/access/type-ahead/full",
    ),
    redirect(
        r"^projects/ui/accessibility/qa/taf_qa\.html$", "/access/type-ahead/testing"
    ),
    redirect(
        r"^projects/ui/accessibility/tabindex\.html$", "/access/keyboard/tabindex"
    ),
    redirect(
        r"^projects/ui/accessibility/embedaccess\.html$", "/access/prefs-and-apis"
    ),
    redirect(
        r"^projects/ui/accessibility/accessible-hierarchy\.html$",
    ...
    redirect(
        r"^projects/ui/accessibility/unix/introduction\.html$", "/access/unix/team/"
    ),
    ...
    redirect(
        r"^projects/ui/accessibility/unix/architecture\.html$",
    ...
    redirect(
        r"^rdf/50-words\.html$",
        "http://developer.mozilla.org/en/RDF_in_Fifty_Words_or_Less",
    ),
    redirect(
        r"^rdf/doc/aggregate\.html$",
        "http://developer.mozilla.org/en/Aggregating_the_In-Memory_Datasource",
    ),
    redirect(
        r"^rdf/doc/faq\.html$", "http://developer.mozilla.org/en/RDF_in_Mozilla_FAQ"
    ),
    ...
    redirect(
        r"^report\.html$", "http://bugzilla.mozilla.org/enter_bug.cgi?format=guided"
    ),
    redirect(r"^roadmap\.html$", "https://wiki.mozilla.org/Roadmap_Scratchpad"),
    redirect(
        r"^scriptable/agnostic\.html$",
        "http://wiki.mozilla.org/Roadmap_for_language_agnostic_scripting_support",
    ),
    redirect(
        r"^scriptable/avoiding-leaks\.html$",
        "http://developer.mozilla.org/en/Using_XPCOM_in_JavaScript_without_leaking",
    ),
    redirect(
        r"^scriptable/components_object\.html$",
        "http://developer.mozilla.org/en/Components_object",
    ),
    redirect(
        r"^scriptable/XPCShell\.html$",
        "https://developer.mozilla.org/en/XPCShell_Reference",
    ),
    redirect(
        r"^scriptable/xpjs-components\.html$",
        "http://developer.mozilla.org/en/XPJS_Components_Proposal",
    ),
    redirect(
        r"^scriptable/xptcall-faq\.html$", "http://developer.mozilla.org/en/xptcall_FAQ"
    ),
    ...
    # bug 1124038
    redirect(
        r"^thunderbird/organizations/(?:all-esr\.html|faq/?)$",
        "https://www.thunderbird.net/organizations/",
    ),
    # bug 1123399, 1150649
    redirect(
        r"^thunderbird/all\.html?$", "https://www.thunderbird.net/thunderbird/all/"
    ),
    redirect(
        r"^thunderbird/all-beta\.html?$",
        "https://www.thunderbird.net/thunderbird/beta/all/",
    ),
    redirect(
        r"^thunderbird/early_releases/?$",
        "https://www.thunderbird.net/thunderbird/beta/all/",
    ),
    redirect(
        r"^thunderbird/early_releases/downloads/?$",
        "https://www.thunderbird.net/thunderbird/beta/all/",
    ),
    # bug 1124042
    redirect(
        r"^thunderbird/features/email_providers\.html$",
    ...
    redirect(
        r"^thunderbird/(?P<version>(?:\d|[12]\d)\.[^/]+)/"
    ...
    redirect(
        r"^thunderbird/about/privacy-policy/?$", "privacy.archive.thunderbird-2010-06"
    ),
    # bug 1196578
    redirect(r"^thunderbird/about/legal/eula/?$", "legal.eula"),
    redirect(
        r"^thunderbird/about/legal/eula/thunderbird2", "legal.eula.thunderbird-2-eula"
    ),
    redirect(
        r"^thunderbird/about/legal/eula/thunderbird", "legal.eula.thunderbird-1.5-eula"
    ),
    # bug 1204579
    redirect(r"^thunderbird/2\.0\.0\.0/eula/?$", "legal.eula.thunderbird-2-eula"),
    redirect(r"^thunderbird/about/legal/?$", "legal.terms.mozilla"),
    redirect(
        r"^thunderbird/about(/mission)?/?$", "https://wiki.mozilla.org/Thunderbird"
    ),
    redirect(
        r"^thunderbird/(about/(careers|contact|get-involved)|community)/?$",
    ...
    redirect(
        r"^thunderbird/beta/(?P<path>.*)$",
        "https://www.thunderbird.net/thunderbird/beta/{path}",
    ),
    redirect(
        r"^thunderbird/(?P<version>[^/]+)/releasenotes/$",
        "https://www.thunderbird.net/thunderbird/{version}/releasenotes/",
    ),
    redirect(
        r"^thunderbird/(?P<version>[^/]+)/system-requirements/$",
    ...
    redirect(
        r"^tools\.html$", "http://developer.mozilla.org/en/Mozilla_Development_Tools"
    ),
    redirect(r"^university/courses\.html$", "http://education.mozilla.org"),
    redirect(
        r"^university/courses/appdev1/overview\.html$", "http://education.mozilla.org"
    ),
    redirect(
        r"^university/courses/appdev2/overview\.html$", "http://education.mozilla.org"
    ),
    redirect(
        r"^university/demos/xslt/demo_topic1\.xml$", "http://education.mozilla.org"
    ),
    redirect(
        r"^university/demos/xslt/demo_topic2\.xml$", "http://education.mozilla.org"
    ),
    redirect(
        r"^university/demos/xslt/demo_topic3\.xml$", "http://education.mozilla.org"
    ),
    redirect(
        r"^university/demos/xslt/demo_topic4\.xml$", "http://education.mozilla.org"
    ),
    redirect(
        r"^university/demos/xslt/demo_topic5\.xml$", "http://education.mozilla.org"
    ),
    ...
    redirect(
        r"^xpfe/xptoolkit/overlays\.html$",
        "http://developer.mozilla.org/en/XUL_Overlays",
    ),
    redirect(
        r"^xpfe/xptoolkit/xulintro\.html$",
