...
class ColorSettings extends Component {
  ...
  render() {
    ...
    return (
      <div
        style={{ backgroundColor: configColors["Primary Background"] }}
            ...
            <React.Fragment key={name}>
              <div
                ...
                style={{
                  ...
                  backgroundColor: configColors["Primary Background"],
                }}
              >
                ...
                <div className="column is-one-third has-text-centered">
                  <button
                    style={{
                      backgroundColor: defaults[name],
                      color: configColors["Primary Background"],
                    }}
                ...
                <div className="column is-one-third has-text-right">
                  ...
                  >
                    <figure className="image is-4by4">
                      <img
                        src={
                          process.env.PUBLIC_URL + "/baseline-brush-24px.svg"
                        }
                        alt=""
                      />
                    </figure>
