    ...
    return (
      <div className={`modal ${store.settings.editing && "is-active"}`}>
        <div
          ...
          onClick={() => store.settings.stopEdit()}
        ></div>
        <div
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => store.settings.stopEdit()}
              className="delete close-settings"
              aria-label="close"
            ></button>
          </header>
                ...
                return (
                  ...
                  >
                    <a
                      ...
                      style={{
                        color: active
                          ? store.settings.configColors["Code Highlight"]
                          : store.settings.configColors["Code"],
                      }}
                    >
                      {name}
                    </a>
