  ...
  return class PQ {
    ...
    constructor(arg1: any[] | compareFn, arg2?: compareFn) {
      ...
      if (typeof arg1 === "function") {
        ...
        arg1 &&
        typeof arg1 === "object" &&
        typeof arg1[Symbol.iterator] === "function"
      ) {
        runner.ignore(true);
        items = [...arg1];
        runner.ignore(false);
    ...
    private _siftUp(idx: number) {
      ...
      while (
        idx > 0 &&
        (this.display = this._compare(this.heap[idx], this.heap[parent]))
      ) {
    ...
    private _siftDown(idx: number, end: number) {
      ...
      while (child1 <= end) {
        ...
        if (
          child2 !== -1 &&
          (this.display = this._compare(this.heap[child2], this.heap[child1]))
        ) {
          swapIdx = child2;
        }
        if (
          (this.display = this._compare(this.heap[swapIdx], this.heap[idx]))
        ) {
