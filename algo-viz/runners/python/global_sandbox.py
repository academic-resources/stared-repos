...
import_overrrides = {"viz": viz, "heapq": myheapq, "queue": myqueue}
...
def create(_name, runner, imports):
    sandbox = {_name: runner, "type": type_override, "print": lambda *args: None}
    for n in dir(typing):
        if n[0] == "_":
            continue
    ...
    for imp in imports:
        ...
        mod = (
            import_overrrides[name]
            if name in import_overrrides
