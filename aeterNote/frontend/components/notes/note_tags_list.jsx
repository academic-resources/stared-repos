          ...
          {tags.map((tag) => {
            return tagIds.includes(tag.id) ? (
              <li
                ...
                onClick={() =>
                  this.props
                    .deleteTagging({ note_id: noteId, tag_id: tag.id })
                    .then(() => this.props.resetNote(noteId))
                }
              >
                {tag.label}
              </li>
              ...
              <li
                ...
                onClick={() =>
                  this.props
                    .addTagging({ note_id: noteId, tag_id: tag.id })
                    .then(() => this.props.resetNote(noteId))
                }
              >
                {tag.label}
...
const mapStateToProps = (state) => {
  ...
  const tagIds = currentNote ? currentNote.tag_ids : [];
  return {
