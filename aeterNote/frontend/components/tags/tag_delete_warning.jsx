...
class TagDelete extends React.Component {
  ...
  handleSubmit(e) {
    ...
    this.props.processForm(this.props.id).then((newTag) => {
        ...
        <div className="container">
          ...
          <form className="notebook-form" onSubmit={this.handleSubmit}>
            <h3 className="delete-script">
              ...
              <p className="delete-title">{label}?</p>
            </h3>
...
const mapStateToProps = (state) => {
  const revealIndex = state.ui.tag_delete_warning
    ? "reveal-tag-delete-warning"
    : "hide-tag-delete-warning";
