...
const mapStateToProps = (state) => {
  ...
  const revealModal = state.ui.notebook_tab
    ? "reveal-modal-bg"
    : "hide-modal-bg";
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateNotebookSelected: (notebookId) =>
      dispatch(updateNotebookSelected(notebookId)),
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(NotebookIndex)
);
