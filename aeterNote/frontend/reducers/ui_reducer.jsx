...
import { REMOVE_NOTEBOOK, RECEIVE_NOTEBOOK } from "../actions/notebook_actions";
  ...
  switch (action.type) {
    ...
    case UPDATE_NOTEBOOK_FORM_MODAL:
      Object.assign(newState, {
        notebook_form_modal: !newState.notebook_form_modal,
      });
      if (newState.notebook_selector) {
        Object.assign(newState, { notebook_selector: false });
      }
      return newState;
    case UPDATE_NOTEBOOK_SELECTED:
      Object.assign(newState, { current_notebook: action.notebookId });
      Object.assign(newState, {
        notebook_selected: Boolean(newState.current_notebook),
      });
    ...
    case UPDATE_EDIT_NOTEBOOK:
      return Object.assign(newState, {
        edit_notebook: !newState.edit_notebook,
      });
    ...
    case UPDATE_NOTE_DELETE_WARNING:
      return Object.assign(newState, {
        note_delete_warning: !newState.note_delete_warning,
      });
    case REMOVE_NOTE:
      return Object.assign(newState, { selected_note: false });
    case UPDATE_NOTEBOOK_SELECTOR:
      return Object.assign(newState, {
        notebook_selector: !newState.notebook_selector,
      });
    case UPDATE_TAG_FORM_MODAL:
      Object.assign(newState, { tag_form: !newState.tag_form });
      if (newState.tag_selector) {
        Object.assign(newState, { tag_selector: false });
      }
      return newState;
    ...
    case UPDATE_TAG_DELETE_WARNING:
      return Object.assign(newState, {
        tag_delete_warning: !newState.tag_delete_warning,
      });
    case UPDATE_TAG_TAB:
