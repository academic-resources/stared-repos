...
def generateRc(
    rcContent, addAdditionalAliases, formatDeletedFunction, formatNewFunction, header
):
    rc = "".join(header) + "\n"
    ...
    functionsWithDeletedBlock = getBlocks(functionsWithAliases.keys(), deletedFunctions)
    ...
    newAliasDefs = getNewAliasDefinitions(
        unchangedFunctions,
        functionsWithAliases,
        functionsWithDeletedBlock,
        functionsWithNewBlock,
...
def generateUsersRc():
    generateRc(
        usersRcContent,
        addAdditionalAliasesForUsersRc,
        signifyDeletedFunction,
        signifyNewFunction,
        usersHeader,
    )
