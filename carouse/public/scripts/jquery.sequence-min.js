...
- Modernizr 2.6.1 Custom Build (http://modernizr.com/)
  ...
  function n(n, s, o, f) {
    function d() {
      l.afterLoaded();
      l.settings.hideFramesUntilPreloaded &&
        l.settings.preloader !== undefined &&
        l.settings.preloader !== !1 &&
        l.frames.show();
      if (l.settings.preloader !== undefined && l.settings.preloader !== !1)
        if (l.settings.hidePreloaderUsingCSS && l.transitionsSupported) {
          l.prependPreloadingCompleteTo =
            l.settings.prependPreloadingComplete === !0
              ? l.settings.preloader
              : e(l.settings.prependPreloadingComplete);
          l.prependPreloadingCompleteTo.addClass("preloading-complete");
          setTimeout(S, l.settings.hidePreloaderDelay);
        } else
          l.settings.preloader.fadeOut(
            l.settings.hidePreloaderDelay,
            function () {
    ...
    function g(t, n) {
      ...
      if (!n)
        for (var i = t; i > 0; i--)
          l.frames
            .eq(l.settings.preloadTheseFrames[i - 1] - 1)
            .find("img")
            .each(function () {
              r.push(e(this)[0]);
            });
        ...
        for (var s = t; s > 0; s--)
          r.push(
            e("body").find(
              'img[src="' + l.settings.preloadTheseImages[s - 1] + '"]'
            )
          );
      return r;
    }
    ...
    function S() {
      ...
      function o(e) {
        ...
        if (p) {
          ...
          if (Math.abs(i) >= l.settings.swipeThreshold) {
            s();
            i > 0
              ? r(l, l.settings.swipeEvents.left)
              : r(l, l.settings.swipeEvents.right);
          } else if (Math.abs(o) >= l.settings.swipeThreshold) {
            s();
            o > 0
              ? r(l, l.settings.swipeEvents.down)
              : r(l, l.settings.swipeEvents.up);
          }
        }
      }
      function f(e) {
      ...
      l.nextButton !== undefined &&
        l.nextButton !== !1 &&
        l.settings.showNextButtonOnInit === !0 &&
        l.nextButton.show();
      l.prevButton !== undefined &&
        l.prevButton !== !1 &&
        l.settings.showPrevButtonOnInit === !0 &&
        l.prevButton.show();
      l.pauseButton !== undefined &&
        l.pauseButton !== !1 &&
        l.settings.showPauseButtonOnInit === !0 &&
        l.pauseButton.show();
      ...
      if (l.settings.hashTags === !0) {
        ...
        if (l.currentHashTag === undefined || l.currentHashTag === "")
          l.nextFrameID = l.settings.startingFrameID;
        else {
      ...
      l.pagination !== undefined &&
        e(l.paginationLinks[l.settings.startingFrameID - 1]).addClass(
          "current"
        );
      if (l.transitionsSupported)
        if (!l.settings.animateStartingFrameIn) {
          l.currentFrameID = l.nextFrameID;
          l.settings.moveActiveFrameToTop &&
            l.nextFrame.css("z-index", l.numberOfFrames);
          ...
          l.settings.reverseAnimationsWhenNavigatingBackwards &&
          l.settings.autoPlayDirection - 1 &&
          l.settings.animateStartingFrameIn
        ) {
          i(l.prefix, l.nextFrameChildren, "0s");
        ...
        l.frames
          .not(":eq(" + (l.nextFrameID - 1) + ")")
          .css({ display: "none", opacity: 0 });
        u(l, !0, l.settings.autoPlayDelay);
      }
      l.nextButton !== undefined &&
        l.nextButton.bind("click.sequence", function () {
          l.next();
        });
      l.prevButton !== undefined &&
        l.prevButton.bind("click.sequence", function () {
          l.prev();
        });
      l.pauseButton !== undefined &&
        l.pauseButton.bind("click.sequence", function () {
          l.pause(!0);
        });
      if (l.settings.keyNavigation) {
        ...
        e(document).bind("keydown.sequence", function (e) {
          ...
          if (
            n > 0 &&
            n <= l.numberOfFrames &&
            l.settings.numericKeysGoToFrames
          ) {
            l.nextFrameID = n;
    ...
    (l.prefix = h[Modernizr.prefixed("transition")]),
      (l.transitionProperties = {}),
      (l.transitionEnd = p[Modernizr.prefixed("transition")]),
      (l.numberOfFrames = l.frames.length),
      (l.transitionsSupported = l.prefix !== undefined ? !0 : !1),
      (l.hasTouch = "ontouchstart" in window ? !0 : !1),
      (l.isPaused = !1),
      (l.isBeingHoveredOver = !1),
      l.container.removeClass("sequence-destroyed");
    (l.paused = function () {}),
      (l.unpaused = function () {}),
      (l.beforeNextFrameAnimatesIn = function () {}),
      (l.afterNextFrameAnimatesIn = function () {}),
      (l.beforeCurrentFrameAnimatesOut = function () {}),
      (l.afterCurrentFrameAnimatesOut = function () {}),
      (l.afterLoaded = function () {});
    ...
    l.settings.unpauseDelay =
      l.settings.unpauseDelay === null
        ? l.settings.autoPlayDelay
        : l.settings.unpauseDelay;
    l.getHashTagFrom = l.settings.hashDataAttribute
  ...
  n.prototype = {
    ...
    prev: function () {
      var e = this;
      e.nextFrameID =
        e.currentFrameID === 1 ? e.numberOfFrames : e.currentFrameID - 1;
      e.active === !1 || e.active === undefined
        ? e.goTo(e.nextFrameID, -1)
        : e.goTo(e.nextFrameID, -1, !0);
    },
    goTo: function (t, n, r) {
      ...
      if (
        t === o.currentFrameID ||
        (o.settings.navigationSkip && o.navigationSkipThresholdActive) ||
        (!o.settings.navigationSkip && o.active) ||
        (!o.transitionsSupported && o.active) ||
        (!o.settings.cycle &&
          n === 1 &&
          o.currentFrameID === o.numberOfFrames) ||
        (!o.settings.cycle && n === -1 && o.currentFrameID === 1) ||
        (o.settings.preventReverseSkipping && o.direction !== n && o.active)
      )
        return !1;
      if (o.settings.navigationSkip && o.active) {
        o.navigationSkipThresholdActive = !0;
        o.settings.fadeFrameWhenSkipped &&
          o.nextFrame.stop().animate({ opacity: 0 }, o.settings.fadeFrameTime);
      ...
      if (!o.active || o.settings.navigationSkip) {
        ...
        u(o);
        n === undefined
          ? (o.direction = t > o.currentFrameID ? 1 : -1)
          : (o.direction = n);
        ...
        if (o.transitionsSupported) {
          if (o.currentFrame.length !== undefined) {
            ...
            if (
              !o.settings.reverseAnimationsWhenNavigatingBackwards ||
              o.direction === 1
            ) {
          ...
          o.settings.fadeFrameWhenSkipped &&
            o.settings.navigationSkip &&
            o.nextFrame.css("opacity", 1);
          o.beforeNextFrameAnimatesIn();
          o.settings.moveActiveFrameToTop &&
            o.nextFrame.css("z-index", o.numberOfFrames);
          if (
            !o.settings.reverseAnimationsWhenNavigatingBackwards ||
            o.direction === 1
          ) {
            setTimeout(function () {
              ...
              (o.afterCurrentFrameAnimatesOut !== "function () {}" ||
                (o.settings.transitionThreshold === !0 && r !== !0)) &&
                f(o, o.currentFrame, o.currentFrameChildren, "out", !0, 1);
            }, 50);
            setTimeout(function () {
              if (
                o.settings.transitionThreshold === !1 ||
                o.settings.transitionThreshold === 0 ||
                r === !0
              ) {
                ...
                o.currentFrame.toggleClass("animate-out animate-in");
                o.settings.transitionThreshold !== !0 &&
                  (o.transitionThresholdTimer = setTimeout(function () {
                    o.nextFrame.addClass("animate-in");
                  }, a));
              }
            }, 50);
          ...
          switch (o.settings.fallback.theme) {
            case "fade":
              o.frames.css({ position: "relative" });
              o.beforeCurrentFrameAnimatesOut();
              o.currentFrame = o.frames.eq(o.currentFrameID - 1);
              o.currentFrame.animate(
                { opacity: 0 },
                o.settings.fallback.speed,
                function () {
                  o.currentFrame.css({ display: "none", "z-index": "1" });
                  o.afterCurrentFrameAnimatesOut();
                  o.beforeNextFrameAnimatesIn();
                  o.nextFrame
                    .css({ display: "block", "z-index": o.numberOfFrames })
  ...
  var r = function (e, t) {
    ...
    s = function (t) {
      ...
      t.currentFrameChildren.each(function () {
        n.push(
          parseFloat(
            e(this)
              .css(t.prefix + "transition-duration")
              .replace("s", "")
          ) +
            parseFloat(
              e(this)
                .css(t.prefix + "transition-delay")
                .replace("s", "")
            )
        );
      });
      ...
      var i = Math.max.apply(Math, n),
        ...
        a = 0,
        f = 0;
      u < 0 && !t.settings.preventDelayWhenReversingAnimations
        ? (a = Math.abs(u))
        : u > 0 && (f = Math.abs(u));
    ...
    a = function (t, n, r) {
      switch (n) {
        case !1:
          return undefined;
        case !0:
          r === ".sequence-preloader" &&
            c.defaultPreloader(t.container, t.transitionsSupported, t.prefix);
          return e(r);
        default:
          return e(n);
      }
    ...
    f = function (t, n, r, i, s, o) {
      if (i === "out")
        var u = function () {
          ...
          t.settings.transitionThreshold === !0 &&
            (o === 1
              ? t.nextFrame.addClass("animate-in")
              : o === -1 && t.nextFrame.toggleClass("animate-out animate-in"));
        };
      else if (i === "in")
        var u = function () {
    ...
    l = function (t) {
      if (t.settings.hashTags) {
        ...
        if (
          t.frameHashIndex !== -1 &&
          (t.settings.hashChangesOnFirstFrame ||
            !t.isStartingFrame ||
            !t.transitionsSupported)
        ) {
        ...
        window.Modernizr = (function (e, t, n) {
          ...
          !s(L, "undefined") && !s(L.call, "undefined")
            ...
            (S.svg = function () {
              return (
                !!t.createElementNS &&
                !!t.createElementNS(E.svg, "svg").createSVGRect
              );
            });
          for (var O in S)
            A(S, O) &&
            ...
            (c.addTest = function (e, t) {
              if (typeof e == "object")
                ...
                (t = typeof t == "function" ? t() : t),
                  enableClasses && (h.className += " " + (t ? "" : "no-") + e),
                  (c[e] = t);
              }
              return c;
            }),
  ...
  e.fn.sequence = function (t) {
    return this.each(function () {
      e.data(this, "sequence") ||
        e.data(this, "sequence", new n(e(this), t, h, c));
    });
  };
})(jQuery);
