...
class News(TranslatableMixin, models.Model):
    ...
    headline = models.CharField(
        max_length=300, help_text="Title of the article, post or media clip"
    )
    outlet = models.CharField(
        max_length=300, help_text="Source of the article or media clip"
    )
    date = models.DateField(help_text="Publish date of the media")
    link = models.URLField(
        max_length=500, help_text="URL link to the article/media clip"
    )
    ...
    is_video = models.BooleanField(
        help_text="Is this news piece a video?", default=False, null=False, blank=False
    )
