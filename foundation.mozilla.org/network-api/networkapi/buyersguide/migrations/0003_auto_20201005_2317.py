...
class Migration(migrations.Migration):
    ...
    dependencies = [("buyersguide", "0002_auto_20200923_1817")]
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name="generalproduct", name="child_rules_helptext"
        ),
        # Then, remove the fields from their incorrect classes
        migrations.RemoveField(model_name="product", name="ai_helptext"),
        migrations.RemoveField(model_name="product", name="ai_is_transparent"),
        migrations.RemoveField(model_name="product", name="ai_uses_personal_data"),
        migrations.RemoveField(model_name="product", name="biometric_data_collected"),
        migrations.RemoveField(model_name="product", name="company_track_record"),
        migrations.RemoveField(model_name="product", name="data_control_policy_is_bad"),
        migrations.RemoveField(
            model_name="product", name="how_can_you_control_your_data"
        ),
        migrations.RemoveField(model_name="product", name="offline_capable"),
        migrations.RemoveField(model_name="product", name="offline_use_description"),
        migrations.RemoveField(model_name="product", name="personal_data_collected"),
        migrations.RemoveField(model_name="product", name="social_data_collected"),
        migrations.RemoveField(model_name="product", name="track_record_details"),
        migrations.RemoveField(model_name="product", name="track_record_is_bad"),
        migrations.RemoveField(model_name="product", name="uses_ai"),
