...
SOCIAL_SIGNIN = (
    SOCIAL_AUTH_GOOGLE_OAUTH2_KEY is not None
    and SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET is not None
)
...
MIDDLEWARE = list(
    filter(
        ...
        [
            ...
            "networkapi.utility.middleware.XRobotsTagMiddleware"
            if XROBOTSTAG_ENABLED
            else None,
...
LOCALE_PATHS = (
    ...
    os.path.join(
        BASE_DIR, "networkapi/wagtailpages/templates/wagtailpages/pages/locale"
    ),
    os.path.join(
        BASE_DIR,
...
LOGGING = {
    ...
    "loggers": {
        ...
        "django.server": {"handlers": ["debug"], "level": "DEBUG"},
        ...
        "networkapi": {"handlers": ["info"], "level": "INFO"},
    },
}
