...
def generate_basic_image_field():
    ...
    return generate_field("image", {"image": image_id, "altText": alt_text})
...
def generate_image_text_mini_field():
    ...
    return generate_field(
        "image_text_mini", {"image": image_id, "text": image_text, "altText": alt_text}
    )
...
def generate_double_image_field():
    ...
    return generate_field(
        "double_image",
        {"image_1": image_1, "image_1_caption": image_1_caption, "image_2": image_2},
    )
...
def generate_quote_field():
    ...
    return generate_field(
        "quote", {"quotes": [{"quote": quote, "attribution": attribution}]}
    )
...
def generate_linkbutton_field():
    ...
    return generate_field(
        "linkbutton", {"label": label, "URL": url, "styling": styling}
    )
...
def generate_full_width_image_field():
    ...
    return generate_field("full_width_image", {"image": image, "caption": caption})
