...
class MozfestPrimaryPage(
    FoundationMetadataPageMixin, FoundationBannerInheritanceMixin, Page
):
    ...
    subpage_types = ["MozfestPrimaryPage"]
...
class MozfestHomepage(MozfestPrimaryPage):
    ...
    subpage_types = ["MozfestPrimaryPage", "MozfestHomepage"]
