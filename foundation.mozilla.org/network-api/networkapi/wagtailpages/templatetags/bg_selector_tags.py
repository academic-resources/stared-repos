...
def track_record(value):
    ...
    if value == "Great":
        return pgettext(
            "This is a rating for a company's history concerning privacy", "Great"
        )
    if value == "Average":
        return pgettext(
            "This is a rating for a company's history concerning privacy", "Average"
        )
    if value == "Needs Improvement":
        return pgettext(
            "This is a rating for a company's history concerning privacy",
            "Needs Improvement",
        )
    if value == "Bad":
        return pgettext(
            "This is a rating for a company's history concerning privacy", "Bad"
        )
    return value
