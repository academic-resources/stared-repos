...
class ProductSerializer(AirtableSerializer):
    ...
    signup_requirement_explanation = serializers.CharField(
        required=False, max_length=5000
    )
    how_does_it_use_data_collected = serializers.CharField(
        required=False, max_length=5000
    )
    ...
    user_friendly_privacy_policy_helptext = serializers.CharField(
        required=False, max_length=5000
    )
    ...
    manage_vulnerabilities_helptext = serializers.CharField(
        required=False, max_length=5000
    )
...
class GeneralProductPageSerializer(ProductSerializer):
    ...
    how_can_you_control_your_data = serializers.CharField(
        required=False, max_length=5000
    )
    data_control_policy_is_bad = serializers.BooleanField(
        default=False, required=False
    )  # TODO: Test a blank import
    company_track_record = TrackRecordChoicesSerializer(
        default="Average"
    )  # TODO: Test this imports correctly
...
class SoftwareProductPageSerializer(ProductSerializer):
    ...
    medical_privacy_compliant_helptext = serializers.CharField(
        required=False, max_length=5000
    )
    ...
    easy_to_learn_and_use_helptext = serializers.CharField(
        required=False, max_length=5000
    )
