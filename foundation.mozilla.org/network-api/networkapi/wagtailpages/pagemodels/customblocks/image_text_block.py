...
class ImageTextBlock(ImageBlock):
    ...
    url = blocks.CharBlock(
        required=False, help_text="Optional URL that this image should link out to."
    )
    top_divider = blocks.BooleanBlock(
        required=False, help_text="Optional divider above content block."
    )
    bottom_divider = blocks.BooleanBlock(
        required=False, help_text="Optional divider below content block."
    )
