...
from ..utils import set_main_site_nav_information, get_page_tree_information
...
class ModularPage(FoundationMetadataPageMixin, Page):
    ...
    settings_panels = Page.settings_panels + [
        MultiFieldPanel([FieldPanel("narrowed_page_content")], classname="collapsible"),
        MultiFieldPanel([FieldPanel("zen_nav")], classname="collapsible"),
    ]
