...
from networkapi.wagtailpages.models import CampaignPage, CampaignIndexPage
...
def generate(seed):
    ...
    campaigns = [
        CampaignPageFactory.create(parent=campaign_index_page) for i in range(5)
    ]
    ...
    try:
        ...
        multi_page_campaign = CampaignPageFactory(
            parent=campaign_index_page, title="multi-page"
        )
