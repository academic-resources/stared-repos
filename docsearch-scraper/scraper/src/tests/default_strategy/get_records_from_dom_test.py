...
class TestGetRecordsFromDom:
    ...
    def test_backward_compatibility_selectors(self):
        # Given
        strategy = get_strategy({"strip_chars": ",."})
    ...
    def test_multiple_selectors_set(self):
        ...
        strategy = get_strategy(
            {
                "selectors": {
                    "api": {"lvl0": "h1", "lvl1": "h2", "lvl2": "h3", "content": "p"},
                    "guide": {"lvl0": "h1"},
                },
                "start_urls": [
                    {"url": "http://test.com/docs/guide", "selectors_key": "guide"},
                    {"url": "http://test.com/docs/api", "selectors_key": "api"},
                ],
            }
        )
        ...
        strategy = get_strategy(
            {
                ...
                "start_urls": [
                    {"url": "http://test.com/docs/guides", "selectors_key": "guides"},
                    {"url": "http://test.com/docs/api", "selectors_key": "api"},
                ],
            }
        )
    ...
    def test_stop_content(self):
        # Given
        strategy = get_strategy(
            {"start_urls": ["http://test.com/docs/guides"], "stop_content": "404"}
        )
        ...
        response = TextResponse(
            "http://test.com/docs/guides", body=html, encoding="utf-8"
        )
        # When
    ...
    def test_selectors_exclude_tail(self):
        ...
        strategy = get_strategy(
            {
                ...
                "start_urls": ["http://test.com/docs/guides"],
            }
        )
        ...
        strategy.dom = strategy.remove_from_dom(
            strategy.dom, strategy.config.selectors_exclude
        )
    ...
    def test_objectID(self):
        ...
        assert actual[0]["objectID"] == "9d2d056ef5f45585b2ed5121e6487c8e04c63da4"

        assert actual[1]["objectID"] is not None
        assert actual[1]["objectID"] == "5f6c974da7435f903a7f3e8d441b42107c5ddb23"

        assert actual[2]["objectID"] is not None
        assert actual[2]["objectID"] == "71980d31d18995da99751933a79075e35b1a68bc"

    def test_current_level(self):
        # Given
        strategy = get_strategy({"start_urls": ["http://test.com/docs/guides"]})
