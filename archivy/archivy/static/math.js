...
function texmath(e, t) {
  const n = (t && t.delimiters) || "dollars",
    a = (t && t.katexOptions) || { throwOnError: !1 };
  if (
    ((a.macros = (t && t.macros) || a.macros),
    texmath.katex ||
    ...
    for (const t of texmath.rules[n].inline)
      e.inline.ruler.before("escape", t.name, texmath.inline(t)),
        (e.renderer.rules[t.name] = (e, n) =>
          t.tmpl.replace(
            /\$1/,
            texmath.render(e[n].content, !!t.displayMode, a)
          ));
    for (const t of texmath.rules[n].block)
      e.block.ruler.before("fence", t.name, texmath.block(t)),
        (e.renderer.rules[t.name] = (e, n) =>
          t.tmpl
            .replace(/\$2/, e[n].info)
            .replace(/\$1/, texmath.render(e[n].content, !0, a)));
  }
}
(texmath.inline = (e) =>
  function (t, n) {
    const a = t.pos,
      m = t.src,
      o =
        m.startsWith(e.tag, (e.rex.lastIndex = a)) &&
        (!e.pre || e.pre(m, a)) &&
        e.rex.exec(m),
      s =
        !!o &&
        a < e.rex.lastIndex &&
        (!e.post || e.post(m, e.rex.lastIndex - 1));
    if (s) {
      if (!n) {
        const n = t.push(e.name, "math", 0);
        (n.content = o[1]), (n.markup = e.tag);
      }
  ...
  (texmath.block = (e) =>
    function (t, n, a, m) {
      const o = t.bMarks[n] + t.tShift[n],
        s = t.src,
        r =
          s.startsWith(e.tag, (e.rex.lastIndex = o)) &&
          (!e.pre || e.pre(s, o)) &&
          e.rex.exec(s),
        l =
          !!r &&
          o < e.rex.lastIndex &&
          (!e.post || e.post(s, e.rex.lastIndex - 1));
      if (l && !m) {
        const m = e.rex.lastIndex - 1;
        let o;
        for (
          o = n;
          o < a && !(m >= t.bMarks[o] + t.tShift[o] && m <= t.eMarks[o]);
          o++
        );
        const s = t.lineMax,
          l = t.parentType;
        (t.lineMax = o),
          (t.parentType = "math"),
          "blockquote" === l && (r[1] = r[1].replace(/(\n*?^(?:\s*>)+)/gm, ""));
        let c = t.push(e.name, "math", 1);
        (c.block = !0),
          (c.markup = e.tag),
          (c.content = r[1]),
          (c.info = r[r.length - 1]),
          (c.map = [n, o]),
          ((c = t.push(e.name + "_end", "math", -1)).block = !0),
          (c.markup = e.tag),
          (t.parentType = l),
          (t.lineMax = s),
          (t.line = o + 1);
  ...
  (texmath.render = function (e, t, n) {
    ...
    try {
      ...
      a = e + ": " + t.message.replace("<", "&lt;");
    }
    return a;
  }),
  (texmath.use = function (e) {
    return (texmath.katex = e), texmath;
  }),
  (texmath.inlineRuleNames = ["math_inline", "math_inline_double"]),
  (texmath.blockRuleNames = ["math_block", "math_block_eqno"]),
  (texmath.$_pre = (e, t) => {
    const n = t > 0 && e[t - 1].charCodeAt(0);
    return !n || (92 !== n && (n < 48 || n > 57));
  }),
  (texmath.$_post = (e, t) => {
    const n = e[t + 1] && e[t + 1].charCodeAt(0);
    return !n || n < 48 || n > 57;
  }),
  (texmath.rules = {
    brackets: {
  ...
  "object" == typeof module && module.exports && (module.exports = texmath);
