...
!(function (e, r) {
  ...
  (M.prototype.__find__ = function (e) {
    ...
    (M.prototype.before = function (e, r, t, n) {
    ...
    (M.prototype.after = function (e, r, t, n) {
      var s = this.__find__(e),
        o = n || {};
      if (-1 === s) throw new Error("Parser rule not found: " + e);
    ...
    (M.prototype.push = function (e, r, t) {
      var n = t || {};
      this.__rules__.push({ name: e, enabled: !0, fn: r, alt: n.alt || [] }),
        (this.__cache__ = null);
    }),
    (M.prototype.enable = function (e, r) {
      Array.isArray(e) || (e = [e]);
      var t = [];
      return (
    ...
    (M.prototype.enableOnly = function (e, r) {
      Array.isArray(e) || (e = [e]),
    ...
    (M.prototype.disable = function (e, r) {
      Array.isArray(e) || (e = [e]);
      var t = [];
      return (
        e.forEach(function (e) {
    ...
    (M.prototype.getRules = function (e) {
      return (
  ...
  var _e = w.normalizeReference,
    ...
    ye = {
      ...
      HTML_OPEN_CLOSE_TAG_RE: new RegExp("^(?:" + ve + "|" + Ce + ")"),
    },
    Ae = ye.HTML_OPEN_CLOSE_TAG_RE,
    xe = [
  ...
  var Ee = we,
    qe = [
      [
        "table",
        function (e, r, t, n) {
          var s, o, i, a, c, l, u, p, h, f, d, m, g, _, b, k;
          if (r + 2 > t) return !1;
          ...
          if (124 !== (s = e.src.charCodeAt(i++)) && 45 !== s && 58 !== s)
            return !1;
          for (; i < e.eMarks[l]; ) {
            if (
      ...
      [
        ...
        function (e, r, t, n) {
          ...
          for (
            ...
            s < xe.length && !xe[s][0].test(a);
            s++
          );
          if (s === xe.length) return !1;
          if (n) return xe[s][2];
          if (((o = r + 1), !xe[s][1].test(a)))
  ...
  for (var ze = w.isSpace, Te = w.isSpace, Ie = [], Re = 0; Re < 256; Re++)
    Ie.push(0);
  ...
  var Be = {
    ...
    postProcess: function (e) {
      ...
      for (Me(e, e.delimiters), r = 0; r < n; r++)
        t[r] && t[r].delimiters && Me(e, t[r].delimiters);
    },
  };
  function Ne(e, r) {
    var t, n, s, o, i, a;
  ...
  function Qe(e, r) {
    ...
    for (t = 0; t < p; t++)
      if ((((s = r[t]).length = s.length || 0), s.close)) {
        for (
          u.hasOwnProperty(s.marker) || (u[s.marker] = [-1, -1, -1]),
            i = u[s.marker][s.length % 3],
            a = n = t - s.jump - 1;
          n > i;
          n -= o.jump + 1
        )
  ...
  function Br(e) {
    return Fr(e, function (e) {
      return yr.test(e) ? Rr(e.slice(4).toLowerCase()) : e;
    });
  }
  function Nr(e) {
    return Fr(e, function (e) {
      return Ar.test(e) ? "xn--" + Mr(e) : e;
    });
  }
  var Or = "1.4.1",
...
!(function (n, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
    ? define(e)
    : ((n = n || self).markdownItAnchor = e());
})(this, function () {
  var n = { false: "push", true: "unshift" },
      ...
      if (r && e.call(t, u))
        throw Error(
          "User defined id attribute '" +
            n +
            "' is NOT unique. Please fix it in your markdown to continue."
        );
      for (; e.call(t, u); ) u = n + "-" + o++;
      return (t[u] = !0), u;
    },
    r = function n(e, r) {
      (r = Object.assign({}, n.defaults, r)),
        e.core.ruler.push("anchor", function (n) {
          var e,
            i = {},
            u = n.tokens,
            o = Array.isArray(r.level)
              ? ((e = r.level),
                function (n) {
                  return e.includes(n);
                })
          ...
          u.filter(function (n) {
            ...
            .forEach(function (e) {
              var o = u[u.indexOf(e) + 1].children
                  .filter(function (n) {
              ...
              (c =
                null == c
                  ? t(r.slugify(o), i, !1, r.uniqueSlugStartIndex)
                  : t(c, i, !0, r.uniqueSlugStartIndex)),
                e.attrSet("id", c),
                r.permalink && r.renderPermalink(c, r, n, u.indexOf(e)),
                r.callback && r.callback(e, { slug: c, title: o });
            });
        });
    };
  return (
    (r.defaults = {
      ...
      permalink: !1,
      renderPermalink: function (e, t, r, i) {
        var u,
          o = [
            Object.assign(new r.Token("link_open", "a", 1), {
              attrs: [].concat(
                t.permalinkClass ? [["class", t.permalinkClass]] : [],
                [["href", t.permalinkHref(e, r)]],
                Object.entries(t.permalinkAttrs(e, r))
              ),
            }),
            Object.assign(new r.Token("html_block", "", 0), {
              content: t.permalinkSymbol,
            }),
            new r.Token("link_close", "a", -1),
          ];
        t.permalinkSpace &&
          o[n[!t.permalinkBefore]](
            Object.assign(new r.Token("text", "", 0), { content: " " })
          ),
          (u = r.tokens[i + 1].children)[n[t.permalinkBefore]].apply(u, o);
      },
...
!(function (e, n) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
    ? define(n)
    : ((e = e || self).markdownItTocDoneRight = n());
})(this, function () {
  function e(e) {
    return encodeURIComponent(
  ...
  return function (t, r) {
    ...
    var i = new RegExp("^" + r.placeholder + "$", "i");
    (t.renderer.rules.tocOpen = function (e, t) {
      var l = Object.assign({}, r);
      return (
        e && t >= 0 && (l = Object.assign(l, e[t].inlineOptions)),
        "<nav" +
          (l.containerId ? ' id="' + n(l.containerId) + '"' : "") +
          ' class="' +
          n(l.containerClass) +
          '">'
      );
    }),
      (t.renderer.rules.tocClose = function () {
        return "</nav>";
      }),
      (t.renderer.rules.tocBody = function (e, t) {
        var i = Object.assign({}, r);
        e && t >= 0 && (i = Object.assign(i, e[t].inlineOptions));
        var o,
          s = {},
          c = Array.isArray(i.level)
            ? ((o = i.level),
              function (e) {
                return o.includes(e);
              })
        ...
        return (function e(t) {
          var l = i.listClass ? ' class="' + n(i.listClass) + '"' : "",
            o = i.itemClass ? ' class="' + n(i.itemClass) + '"' : "",
            a = i.linkClass ? ' class="' + n(i.linkClass) + '"' : "";
          if (0 === t.c.length) return "";
          var u = "";
          return (
            (0 === t.l || c(t.l)) && (u += "<" + (n(i.listType) + l) + ">"),
            t.c.forEach(function (t) {
              c(t.l)
                ? (u +=
                    ...
                    (function (e) {
                      for (
                        var n = e, t = i.uniqueSlugStartIndex;
            ...
            (0 === t.l || c(t.l)) && (u += "</" + n(i.listType) + ">"),
            u
          );
        })(l);
      }),
      t.core.ruler.push("generateTocAst", function (e) {
        (l = (function (e) {
          for (
            var n = { l: 0, n: "", c: [] }, t = [n], r = 0, l = e.length;
            r < l;
            r++
          ) {
            var i = e[r];
            if ("heading_open" === i.type) {
              var o = e[r + 1].children
                  .filter(function (e) {
                ...
                s = { l: parseInt(i.tag.substr(1), 10), n: o, c: [] };
              if (s.l > t[0].l) t[0].c.push(s), t.unshift(s);
              else if (s.l === t[0].l) t[1].c.push(s), (t[0] = s);
              else {
                for (; s.l <= t[0].l; ) t.shift();
                t[0].c.push(s), t.unshift(s);
              }
            }
          }
          return n;
          ...
          "function" == typeof r.callback &&
            r.callback(
              t.renderer.rules.tocOpen() +
                t.renderer.rules.tocBody() +
                t.renderer.rules.tocClose(),
              l
            );
      }),
      t.block.ruler.before(
        ...
        function (e, n, t, r) {
          var l,
            o = e.src
              .slice(e.bMarks[n] + e.tShift[n], e.eMarks[n])
              .split(" ")[0];
          ...
          return (
            (e.line = n + 1),
            ((l = e.push("tocOpen", "nav", 1)).markup = ""),
            (l.map = [n, e.line]),
            (l.inlineOptions = c),
            ((l = e.push("tocBody", "", 0)).markup = ""),
            (l.map = [n, e.line]),
            (l.inlineOptions = c),
            (l.children = []),
            ((l = e.push("tocClose", "nav", -1)).markup = ""),
            !0
          );
        },
            ...
            function n(e, n) {
              ...
              for (t = 0; t < u; t++)
                61 === (r = n[t]).marker &&
                  -1 !== r.end &&
                  ((i = n[r.end]),
                  ((s = e.tokens[r.token]).type = "mark_open"),
                  (s.tag = "mark"),
                  (s.nesting = 1),
                  (s.markup = "=="),
                  (s.content = ""),
                  ((s = e.tokens[i.token]).type = "mark_close"),
                  (s.tag = "mark"),
                  (s.nesting = -1),
                  (s.markup = "=="),
                  (s.content = ""),
