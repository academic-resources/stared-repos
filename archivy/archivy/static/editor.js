                    ...
                    n.open(
                      ...
                      (n.onload = function () {
                        4 === n.readyState &&
                          ...
                          i.num_loaded++,
                          2 == i.num_loaded &&
                            (i.typo = new r("en_US", i.aff_data, i.dic_data, {
                              platform: "any",
                            })));
                      }),
                      n.send(null);
                    ...
                    (r.timeout = setTimeout(i, r.delay)),
                      (r.hurry = function () {
                        clearTimeout(r.timeout),
                          (r.timeout = setTimeout(i, 50));
                      }),
                      e.on(window, "mouseup", r.hurry),
                      e.on(window, "keyup", r.hurry);
                  })(n, (n.state.autoRefresh = { delay: r.delay || 250 }));
            });
          })(
                          ...
                          if (1 == e.lineCount()) {
                            ...
                            r =
                              "TEXTAREA" == i.nodeName
                                ? !e.getLine(0).length
                                : !/[^\u200b]/.test(
                                    i.querySelector(".CodeMirror-line")
                                      .textContent
                                  );
                          }
                          r ? n(e) : t(e);
            ...
            String.prototype.normalize
              ...
              (p.prototype = {
                ...
                find: function (t) {
                    ...
                    t
                      ? n.from.ch
                        ...
                        : (n =
                            n.from.line == this.doc.firstLine()
                              ...
                              : this.matches(
                                  t,
                                  this.doc.clipPos(r(n.from.line - 1))
                                ))
                      ...
                      : (n =
                          n.to.line == this.doc.lastLine()
                            ? null
                            : this.matches(t, r(n.to.line + 1, 0)));
                  if (n)
                    return (
                      (this.pos = n),
                      (this.atOccurrence = !0),
                  ...
                  return (
                    (this.pos = { from: i, to: i }), (this.atOccurrence = !1)
                  );
                },
                from: function () {
              ...
              e.defineExtension("selectMatches", function (t, n) {
                for (
                  var r = [],
                    i = this.getSearchCursor(t, this.getCursor("from"), n);
        ...
        function (e, t, n) {
          !(function (e, r) {
            ...
            function Ee(e) {
              if (null == Se) {
                var t = T("span", "​");
                E(e, T("span", [t, document.createTextNode("x")])),
            ...
            function Te(e) {
              ...
              return (
                A(e), !(!n || n.left == n.right) && (Fe = r.right - n.right < 3)
              );
            }
            var Le,
              Me =
              ...
              Ne =
                "oncopy" in (Le = T("div")) ||
                (Le.setAttribute("oncopy", "return;"),
                "function" == typeof Le.oncopy),
              Oe = null;
            var Ie = {},
              ze = {};
            function He(e, t) {
            ...
            function Ze(e) {
              ...
              for (
                var t = e.parent, n = _(t.lines, e), r = t.parent;
                r;
                t = r, r = r.parent
              )
              ...
              var o = (function (e, t, n) {
                  for (
                    ...
                    if (
                      u &&
                      (!n ||
                        l + (u instanceof ut ? u.lookAhead : 0) <=
                          o.modeFrontier)
                    )
                      return l;
            ...
            (ct.prototype.lookAhead = function (e) {
              ...
              (ct.fromSaved = function (e, t, n) {
                return t instanceof ut
                  ? new ct(e, je(e.mode, t.state), n, t.lookAhead)
                  : new ct(e, je(e.mode, t), n);
              }),
            ...
            function xt(e, t, n, r) {
              ...
              for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); )
                (c.start = c.pos),
                  (i = gt(l, c, u.state)),
                  r && o.push(new vt(c, i, je(a.mode, u.state)));
              ...
              if (!u) {
                ...
                if (x > 0 && l)
                  for (var y = 0; y < l.length; ++y)
                    null == l[y].to &&
                      (v || (v = [])).push(new wt(l[y].marker, null, null));
            ...
            function Yt(e, t) {
              ...
              for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                ...
                (r.pos = 0),
                  ...
                  (r.map = []),
                  nn(o, r, ht(e, o, t != e.display.externalMeasured && Ze(o))),
                  o.styleClasses &&
                    (o.styleClasses.bgClass &&
                      (r.bgClass = O(o.styleClasses.bgClass, r.bgClass || "")),
                  ...
                  0 == r.map.length &&
                    r.map.push(
                      0,
                      0,
                      r.content.appendChild(Ee(e.display.measure))
                    ),
                  0 == i
              ...
              return (
                ...
                r.pre.className &&
                  (r.textClass = O(r.pre.className, r.textClass || "")),
                r
              );
            }
            function Qt(e) {
            ...
            function en(e, t) {
              return function (n, r, i, o, a, l, s) {
                ...
                for (var u = n.pos, c = u + r.length; ; ) {
                  ...
                  e(n, r.slice(0, d.to - u), i, o, null, l, s),
                    (o = null),
                    (r = r.slice(d.to - u)),
                    (u = d.to);
                }
                  ...
                  if (v == p) {
                    ...
                    if (y)
                      for (var k = 0; k < y.length; k += 2)
                        y[k + 1] == v && (u += " " + y[k]);
                    if (!d || d.from == p)
                      for (var S = 0; S < x.length; ++S) tn(t, 0, x[S]);
                    if (d && (d.from || 0) == p) {
                      if (
                        (tn(
                          t,
            ...
            function rn(e, t, n) {
              (this.line = t),
                ...
                (this.size = this.rest ? Ze(K(this.rest)) - n + 1 : 1),
            ...
            function Dn(e) {
              ...
              if (!M(document.body, e.node)) {
                ...
                e.coverGutter &&
                  ...
                  E(t.display.measure, T("div", [e.node], null, n));
              }
            ...
            function An(e) {
              return (
                e.display.scroller.clientWidth - Fn(e) - e.display.barWidth
              );
            }
            function En(e) {
              return (
                e.display.scroller.clientHeight - Fn(e) - e.display.barHeight
              );
            }
            function Tn(e, t, n) {
              if (e.line == t)
                    ...
                    (o = (function (e, t, n, r) {
                      ...
                      if (3 == s.nodeType) {
                        for (var h = 0; h < 4; h++) {
                          for (
                            ;
                            u && re(t.line.text.charAt(o.coverStart + u));
                          ...
                          if (
                            (i =
                              ...
                              c == o.coverEnd - o.coverStart
                                ...
                                : Hn(S(s, u, c).getClientRects(), r)).left ||
                            i.right ||
                            0 == u
                          )
                            break;
            ...
            function Gn(e, t, n, r, i) {
              return (
                r || (r = Ge(e.doc, t.line)), Un(e, r, Ln(e, r, t.ch, i), n)
              );
            }
            ...
            function Qn(e, t, n, r) {
              return (
                n || (n = Bn(e, t)),
                Yn(e, t, n, Un(e, t, Nn(e, n, r), "line").top)
              );
            }
            function Jn(e, t, n, r) {
              return (
            ...
            function lr(e) {
              var t = rr(e.display),
                ...
                r =
                  ...
                  Math.max(
                    5,
                    e.display.scroller.clientWidth / ir(e.display) - 3
                  );
              return function (i) {
            ...
            function ur(e, t, n, r) {
              var i = e.display;
              if (!n && "true" == we(t).getAttribute("cm-not-content"))
                return null;
              var o,
                a,
              ...
              if (
                r &&
                u.xRel > 0 &&
                (s = Ge(e.doc, u.line).text).length == u.ch
              ) {
                ...
                u = et(
                  ...
                  Math.max(
                    0,
                    Math.round((o - Sn(e.display).left) / ir(e.display)) - c
                  )
                );
              }
              return u;
            ...
            function dr(e, t, n, r) {
              ...
              if (
                ...
                Ct && Pt(e.doc, t) < i.viewTo && fr(e);
              else if (n <= i.viewFrom)
                Ct && _t(e.doc, n + r) > i.viewFrom
                  ? fr(e)
            ...
            function pr(e, t, n, r) {
              var i,
                o = cr(e, t),
                a = e.display.view;
              if (!Ct || n == e.doc.first + e.doc.size)
            ...
            function br(e, t, n) {
              var r = e.display,
                ...
                l = a.left,
                s =
                  Math.max(r.sizerWidth, An(e) - r.sizer.offsetLeft) - a.right,
                u = "ltr" == i.direction;
              function c(e, t, n, r) {
                t < 0 && (t = 0),
                  (t = Math.round(t)),
            ...
            function Cr(e) {
              e.hasFocus() ||
                (e.display.input.focus(), e.state.focused || kr(e));
            }
            function wr(e) {
            ...
            function Fr(e) {
              for (
                ...
                if (!i.hidden) {
                  ...
                  if (
                    (h > 0.005 || h < -0.005) &&
                    (Xe(i.line, s), Ar(i.line), i.rest)
                  )
                    for (var f = 0; f < i.rest.length; f++) Ar(i.rest[f]);
            ...
            function Er(e, t, n) {
              ...
              if (n && n.ensure) {
                ...
                l < o
                  ? ((o = l),
                    (a = Ye(t, qt(Ge(t, l)) + e.wrapper.clientHeight)))
                  : Math.min(s, t.lastLine()) >= a &&
                    ((o = Ye(t, qt(Ge(t, s)) - e.wrapper.clientHeight)),
                    (a = s));
              }
            ...
            function Nr(e) {
              ...
              t &&
                ...
                Or(e, Kn(e, t.from), Kn(e, t.to), t.margin));
            }
            function Or(e, t, n, r) {
              var i = Tr(e, {
            ...
            function Ir(e, t) {
              Math.abs(e.doc.scrollTop - t) < 2 ||
                (n || si(e, { top: t }), zr(e, t, !0), n && si(e), ri(e, 100));
            }
            function zr(e, t, n) {
              (t = Math.max(
                0,
            ...
            function Wr(e, t) {
              ...
              for (
                ...
                n != e.display.barWidth && e.options.lineWrapping && Fr(e),
                  jr(e, Rr(e)),
            ...
            (_r.prototype.update = function () {
              ...
              (_r.prototype.setScrollLeft = function () {}),
              (_r.prototype.setScrollTop = function () {}),
              (_r.prototype.clear = function () {});
            var qr = { native: Pr, null: _r };
            function Ur(e) {
              ...
              e.updatedDisplay && Fr(t),
                ...
                n.maxLineChanged &&
                  ...
                  (e.maxScrollLeft = Math.max(
                    0,
                    n.sizer.offsetLeft + e.adjustWidthTo - An(t)
                  ))),
            ...
            function Qr(e) {
              ...
              null != e.scrollTop && zr(t, e.scrollTop, e.forceScroll),
                  ...
                  if (!me(e, "scrollCursorIntoView")) {
                    ...
                    if (
                      ...
                      var o = T(
                        ...
                        null,
                        "position: absolute;\n                         top: " +
                          (t.top - n.viewOffset - wn(e.display)) +
                          "px;\n                         height: " +
            ...
            function ri(e, t) {
              e.doc.highlightFrontier < e.display.viewTo &&
                e.state.highlight.set(t, z(ii, e));
            }
            function ii(e) {
              var t = e.doc;
            ...
            function ai(e, t) {
              ...
              !(function (e, t, n) {
                ...
                (n.viewOffset = qt(Ge(e.doc, n.viewFrom))),
              ...
              return (
                ...
                (function (e, t, n) {
                  ...
                  function l(t) {
                    var n = t.nextSibling;
                    return (
                      s && x && e.display.currentWheelTarget == t
            ...
            function li(e, t) {
              for (var n = t.viewport, r = !0; ; r = !1) {
                if (r && e.options.lineWrapping && t.oldDisplayWidth != An(e))
                  r && (t.visible = Er(e.display, e.doc, n));
                else if (
                  (n &&
                    null != n.top &&
                    (n = {
                      top: Math.min(
                        e.doc.height + kn(e.display) - En(e),
                        n.top
                      ),
                    }),
                  (t.visible = Er(e.display, e.doc, n)),
            ...
            function gi(e, t, r, i) {
              ...
              (this.input = r),
                ...
                (o.lineDiv = L("div", null, "CodeMirror-code")),
                (o.selectionDiv = T(
                  "div",
                  null,
                  null,
            ...
            function Di(e, t) {
              ...
              if ((i && u) || (o && c)) {
                ...
                if (i && !n && !d && null != xi)
                  return (
                    o && c && Ir(e, Math.max(0, l.scrollTop + o * xi)),
                    Hr(e, Math.max(0, l.scrollLeft + i * xi)),
                    (!o || (o && c)) && ye(t),
            ...
            function Ni(e, t, n, r) {
              ...
              if (t.full)
                ...
                if (1 == u.length)
                  ...
                  g.push(new Gt(h + c.text.slice(s.ch), f, r)),
            ...
            function zi(e) {
              ("rtl" == e.doc.direction
                ? N
                : F)(e.display.lineDiv, "CodeMirror-rtl");
            }
            function Hi(e) {
              (this.done = []),
                (this.undone = []),
            ...
            function Ki(e, t, n, r, i) {
              null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
                Ji(e, new Ci([Vi(e.sel.primary(), t, n, i)], 0), r);
            }
            function Xi(e, t, n) {
              for (
              ...
              (ve(e, "beforeSelectionChange") ||
                ...
                (t = (function (e, t, n) {
                  ...
                  return (
                    ...
                    r.ranges != t.ranges
                      ? ki(e.cm, r.ranges, r.ranges.length - 1)
                      : t
                  );
                })(e, t, n));
              var r =
            ...
            function ro(e, t, n, r) {
              for (var i, o = 0; o < t.ranges.length; o++) {
                ...
                (i || s != a.anchor || u != a.head) &&
                  (i || (i = t.ranges.slice(0, o)), (i[o] = new wi(s, u)));
              }
              ...
              if (o.markedSpans)
                for (var a = 0; a < o.markedSpans.length; ++a) {
                  ...
                  if (
                    ...
                    if (
                      i &&
                      (pe(s, "beforeCursorEnter"), s.explicitlyCleared)
                    ) {
                      if (o.markedSpans) {
                        --a;
                        continue;
                    ...
                    return (
                      (r < 0 ? u : c) &&
                        (f = ao(e, f, r, f.line == t.line ? o : null)),
                      f ? io(e, f, t, r, i) : null
                    );
                  }
                }
            ...
            function co(e, t) {
              if (
                ...
                Oi(e, function (e, n) {
                  n ||
                    -1 != _(r, e.history) ||
                    (xo(e.history, t), r.push(e.history)),
                    po(e, t, null, Ft(e, t));
                });
              }
            }
              ...
              if (!r || n) {
                ...
                if (u != l.length) {
                  for (o.lastOrigin = o.lastSelOrigin = null; ; ) {
                    ...
                    if ((ji(i, s), n && !i.equals(e.sel)))
                      return void Ji(e, i, { clearRedo: !1 });
                    a = i;
                  }
                  var c = [];
                  ji(a, s),
                    ...
                    var d =
                      ...
                      h = function (n) {
                        ...
                        po(e, r, o, $i(e, r)),
                          !n &&
                            e.cm &&
                            e.cm.scrollIntoView({ from: r.from, to: Fi(r) });
                        var a = [];
                        Oi(e, function (e, t) {
                          t ||
                            -1 != _(a, e.history) ||
                            (xo(e.history, r), a.push(e.history)),
                            po(e, r, null, $i(e, r));
                        });
                      },
            ...
            function yo(e, t, n, r) {
              var i = t,
                o = t;
              return (
                "number" == typeof t ? (o = Ge(e, at(e, t))) : (i = Ze(t)),
            ...
            (Co.prototype.clear = function () {
              ...
              (Co.prototype.changed = function () {
                ...
                var i = Dn(this) - t;
                i &&
                  (Wt(this.doc, r) || Xe(r, r.height + i),
                  n &&
                    Jr(n, function () {
                      (n.curOp.forceUpdate = !0),
                        wo(n, r, i),
                        sn(n, "lineWidgetChanged", n, e, Ze(r));
                    }));
              }),
              xe(Co);
            var ko = 0,
            ...
            function Fo(e, t, n, r, i) {
              ...
              var o = new So(e, i),
                a = tt(t, n);
              if (
                (r && H(r, o, !1), a > 0 || (0 == a && !1 !== o.clearWhenEmpty))
              )
                return o;
              if (
                (o.replacedWith &&
                ...
                if (
                  Ht(e, t.line, t, n, o) ||
                  (t.line != n.line && Ht(e, n.line, t, n, o))
                )
                  throw new Error(
              ...
              o.addToHistory &&
                _i(e, { from: t, to: n, origin: "markText" }, e.sel, NaN);
              var l,
                s = t.line,
                u = e.cm;
              if (
                ...
                if ((l && (u.curOp.updateMaxLine = !0), o.collapsed))
                  ...
                  for (var c = t.line; c <= n.line; c++) hr(u, c, "text");
            ...
            (So.prototype.clear = function () {
              ...
              (So.prototype.find = function (e, t) {
                ...
                for (var i = 0; i < this.lines.length; ++i) {
                  ...
                  if (
                    null != a.from &&
                    ((n = et(t ? o : Ze(o), a.from)), -1 == e)
                  )
                    return n;
                  if (null != a.to && ((r = et(t ? o : Ze(o), a.to)), 1 == e))
                    return r;
                }
              ...
              (So.prototype.detachLine = function (e) {
                if (
                  (this.lines.splice(_(this.lines, e), 1),
            ...
            var Lo = 0,
              Mo = function (e, t, n, r, i) {
                ...
                null == n && (n = 0),
                  Do.call(this, [new bo([new Gt("", null)])]),
                  (this.first = n),
            ...
            (Mo.prototype = Y(Do.prototype, {
              ...
              setSelections: ni(function (e, t, n) {
                if (e.length) {
                  ...
                  null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
                    Ji(this, ki(this.cm, r, t), n);
                }
              }),
              addSelection: ni(function (e, t, n) {
                var r = this.sel.ranges.slice(0);
                r.push(new wi(lt(this, e), lt(this, t || e))),
                  Ji(this, ki(this.cm, r, r.length - 1), n);
              }),
              ...
              setGutterMarker: ni(function (e, t, n) {
                return yo(this, e, "gutter", function (e) {
                  ...
                  return (
                    (r[t] = n), !n && te(r) && (e.gutterMarkers = null), !0
                  );
                });
              }),
                        ...
                        s = function () {
                          ++l == i &&
                            ei(t, function () {
                              ...
                              uo(t.doc, e),
                                Qi(t.doc, Si(lt(t.doc, n), lt(t.doc, Fi(e))));
                            })();
                        },
                        u = function (e, n) {
                          if (
            ...
            for (var Wo = 65; Wo <= 90; Wo++) Po[Wo] = String.fromCharCode(Wo);
            ...
            function ga(e) {
              ...
              if (!(me(t, e) || (n.activeTouch && n.input.supportsTouch())))
                if ((n.input.ensurePolled(), (n.shift = e.shiftKey), Cn(n, e)))
                  s ||
                    ...
                    o = r
                      ? (function (e, t) {
                          ...
                          return pa && pa.compare(n, e, t)
                            ? ((fa = pa = null), "triple")
                            : fa && fa.compare(n, e, t)
                            ? ((pa = new ma(n, e, t)), (fa = null), "double")
                            : ((fa = new ma(n, e, t)), (pa = null), "single");
                        })(r, i)
                      : "single";
                  window.focus(),
                    ...
                    (r &&
                      ...
                      (1 == i
                          ...
                          ? (function (e, t, n, r) {
                              ...
                              (tt(i.to(), t) > 0 || t.xRel < 0)
                                ...
                                : (function (e, t, n, r) {
                                    ...
                                    r.addNew && !r.extend
                                      ? ((s = o.sel.contains(n)),
                                        (l = s > -1 ? c[s] : new wi(n, n)))
                                      : ((l = o.sel.primary()),
                                        (s = o.sel.primIndex));
                                    if ("rectangle" == r.unit)
                                      r.addNew || (l = new wi(n, n)),
                                        (n = ur(e, t, !0, !0)),
                                        (s = -1);
                                    else {
                                      var d = va(e, n, r.unit);
                                      l = r.extend
                                        ? Vi(l, d.anchor, d.head, r.extend)
                                        : d;
                                    }
                                    r.addNew
                                      ? -1 == s
                                        ? ((s = c.length),
                                          Ji(o, ki(e, c.concat([l]), s), {
                                            scroll: !1,
                                            origin: "*mouse",
                                          }))
                                        : c.length > 1 &&
                        ...
                        : 3 == i &&
                          (w ? t.display.input.onContextMenu(e) : wr(t)));
                }
            }
            function va(e, t, n) {
              ...
              if ("line" == n)
                return new wi(et(t.line, 0), lt(e.doc, et(t.line + 1, 0)));
              var r = n(e, t);
            ...
            function Fa(e) {
              e.options.lineWrapping
                ...
                : (F(e.display.wrapper, "CodeMirror-wrap"), $t(e)),
                sr(e),
                dr(e),
                _n(e),
                setTimeout(function () {
            ...
            function Aa(e, t) {
              ...
              var r = t.value;
              "string" == typeof r
                ? (r = new Mo(r, t.mode, null, t.lineSeparator, t.direction))
              ...
              (function (e) {
                ...
                de(t.scroller, "touchstart", function (i) {
                  ...
                  de(t.scroller, "scroll", function () {
                    t.scroller.clientHeight &&
                      (Ir(e, t.scroller.scrollTop),
                      Hr(e, t.scroller.scrollLeft, !0),
                      pe(e, "scroll", e));
                  }),
                  ...
                  (t.dragFunctions = {
                    ...
                    start: function (t) {
                      return (function (e, t) {
                        if (
                          a &&
                          (!e.state.draggingText || +new Date() - Bo < 100)
                        )
                          Ce(t);
                        else if (
                          !me(e, t) &&
                ...
                de(u, "keyup", function (t) {
                  ...
                  de(u, "keydown", ei(e, ca)),
                  de(u, "keypress", ei(e, ha)),
            ...
            function Ta(e, t, n, r) {
              ...
              null == n && (n = "add"),
                "smart" == n &&
                  (o.mode.indent ? (i = ft(e, t).state) : (n = "prev"));
              ...
              if (r || /\S/.test(l.text)) {
                if (
                  "smart" == n &&
                  ((u = o.mode.indent(i, l.text.slice(c.length), l.text)) ==
                    W ||
                    u > 150)
                ) {
                  if (!r) return;
              ...
              "prev" == n
                ? (u = t > o.first ? R(Ge(o, t - 1).text, null, a) : 0)
                : "add" == n
              ...
              if ((h < u && (d += V(u - h)), d != c))
                return (
                  mo(o, d, et(t, 0), et(t, c.length), "+input"),
                  (l.stateAfter = null),
                  !0
                );
            ...
            function Ba(e, t, n, r, i) {
              ...
              for (
                var d = e.curOp.updateInput, h = r.ranges.length - 1;
                h >= 0;
                h--
              ) {
                var f = r.ranges[h],
                ...
                f.empty() &&
                  (n && n > 0
                    ...
                    ? (m = et(
                        m.line,
                        Math.min(Ge(o, m.line).text.length, m.ch + K(s).length)
                      ))
                    : l &&
                      La &&
                      La.lineWise &&
              ...
              function u(o) {
                ...
                if (null == a) {
                  if (
                    ...
                    (u = t.line + s) < e.first ||
                    u >= e.first + e.size ||
                    ((t = new et(u, t.ch, t.sticky)), !(l = Ge(e, u)))
                  )
                    return !1;
            ...
            (_a.prototype.init = function (e) {
              ...
              function a(e) {
                if (o(e) && !me(r, e)) {
                  if (r.somethingSelected())
                    Ma({ lineWise: !1, text: r.getSelections() }),
              ...
              (_a.prototype.showMultipleSelections = function (e) {
                E(this.cm.display.cursorDiv, e.cursors),
                  E(this.cm.display.selectionDiv, e.selection);
              }),
              ...
              (_a.prototype.focus = function () {
                "nocursor" != this.cm.options.readOnly &&
                  ((this.selectionInEditor() && B() == this.div) ||
              ...
              (_a.prototype.pollContent = function () {
                ...
                if (
                  ...
                  l.ch == Ge(r.doc, l.line).text.length &&
                    l.line < r.lastLine() &&
                    (l = et(l.line + 1, 0)),
                ...
                a.line == i.viewFrom || 0 == (e = cr(r, a.line))
                  ? ((t = Ze(i.view[0].line)), (n = i.view[0].node))
                  : ((t = Ze(i.view[e].line)),
                ...
                for (
                  var d = r.doc.splitLines(
                    ...
                    h = Ve(r.doc, et(t, 0), et(s, Ge(r.doc, s).text.length));
                  d.length > 1 && h.length > 1;

                )
                  if (K(d) == K(h)) d.pop(), h.pop(), s--;
                  else {
                    if (d[0] != h[0]) break;
                    d.shift(), h.shift(), t++;
                  }
                ...
                return d.length > 1 || d[0] || tt(D, C)
                  ? (mo(r.doc, d, D, C, "+input"), !0)
                  : void 0;
              }),
            ...
            ($a.prototype.init = function (e) {
              ...
              ($a.prototype.showSelection = function (e) {
                ...
                E(t.cursorDiv, e.cursors),
                  E(t.selectionDiv, e.selection),
                  null != e.teTop &&
              ...
              (function (e) {
                ...
                (e.defineOption = n),
                  ...
                  n(
                    ...
                    [],
                    function (e, t) {
                      (e.display.gutterSpecs = fi(t, e.options.lineNumbers)),
                        mi(e);
                    },
                    !0
                  ),
                  ...
                  n("workTime", 100),
                  n("workDelay", 100),
                  n("flattenSpans", !0, Mi, !0),
                  n("addModeClass", !1, Mi, !0),
                  n("pollInterval", 100),
              ...
              (function (e) {
                ...
                (e.prototype = {
                    ...
                    for (
                      ...
                      if (i.empty())
                        i.head.line > n &&
                          ...
                          (n = i.head.line),
                          r == this.doc.sel.primIndex && Mr(this));
                      else {
                        var o = i.from(),
                          a = i.to(),
                          l = Math.max(n, o.line);
                        ...
                        0 == o.ch &&
                          t.length == u.length &&
                          u[r].from().ch > 0 &&
                          Zi(this.doc, r, new wi(o, u[r].to()), j);
                      }
                    }
                  }),
                  ...
                  heightAtLine: function (e, t, n) {
                    ...
                    return (
                      Un(this, r, { top: 0, left: 0 }, t || "page", n || i)
                        .top + (i ? this.doc.height - qt(r) : 0)
                    );
                  },
                  ...
                  addWidget: function (e, t, n, r, i) {
                    ...
                    (t.style.top = u + "px"),
                      ...
                      n &&
                        ...
                        null != (l = Tr(o, a)).scrollTop && Ir(o, l.scrollTop),
                        null != l.scrollLeft && Hr(o, l.scrollLeft));
                  },
                  ...
                  findPosH: function (e, t, n, r) {
                    ...
                    for (
                      ...
                      a < t && !(o = Ra(this.doc, o, i, n, r)).hitSide;
                      ++a
                    );
                    return o;
                  },
                  moveH: ti(function (e, t) {
                    ...
                    this.extendSelectionsBy(function (r) {
                      return n.display.shift || n.doc.extend || r.empty()
                        ? Ra(n.doc, r.head, e, t, n.options.rtlMoveVisually)
                        : e < 0
                        ? r.from()
                        : r.to();
                    }, U);
                  ...
                  getScrollInfo: function () {
                    ...
                    return {
                      ...
                      top: e.scrollTop,
                      height:
                        e.scrollHeight - Fn(this) - this.display.barHeight,
                  ...
                  setSize: ti(function (e, t) {
                    ...
                    null != e && (this.display.wrapper.style.width = r(e)),
                      ...
                      this.options.lineWrapping && Pn(this);
            ...
            return (
              xe(Mo),
              (Aa.inputStyles = { textarea: $a, contenteditable: _a }),
              ...
              (function (e) {
                (e.off = fe),
                  ...
                  (e.normalizeKeyMap = $o),
                  (e.StringStream = $e),
                  (e.SharedTextMarker = Ao),
                  (e.TextMarker = So),
                  (e.LineWidget = Co),
                  (e.e_preventDefault = ye),
                  (e.e_stopPropagation = be),
                  (e.e_stop = Ce),
                  (e.addClass = N),
                  (e.contains = M),
                  (e.rmClass = F),
      ...
      12: [
        function (e, t, n) {
          ...
          (r = function (e) {
              ...
              function (t, n) {
                ...
                function y(r, i) {
                  ...
                  if (
                    ...
                    for (
                      i.list = null;
                      w < i.listStack[i.listStack.length - 1];
                  ...
                  if (
                    ...
                    var A = F[1] ? "ol" : "ul";
                    return (
                      (i.indentation = w + r.current().length),
                      (i.list = !0),
                      (i.quote = 0),
                      ...
                      (i.code = !1),
                      (i.strikethrough = !1),
                      n.taskLists && r.match(u, !1) && (i.taskList = !0),
                      (i.f = i.inline),
                      n.highlightFormatting &&
                        (i.formatting = ["list", "list-" + A]),
                      C(i)
                    );
                  }
                  return h && i.indentation <= b && (F = r.match(f, !0))
                    ? ((i.quote = 0),
                      (i.fencedEndRE = new RegExp(F[1] + "+ *$")),
                      (i.localMode =
                ...
                function k(t, i) {
                  ...
                  if (
                    ...
                    return (
                      n.highlightFormatting && (i.formatting = "header"), C(i)
                    );
                  var l = t.next();
                  if (i.linkTitle) {
                    i.linkTitle = !1;
                  ...
                  if (
                    ...
                    return (
                      t.backUp(1), (i.htmlState = e.startState(r)), v(t, i, b)
                    );
                  }
            ...
            "object" == typeof n && "object" == typeof t
              ? r(e("../../lib/codemirror"), e("../xml/xml"), e("../meta"))
              : r(CodeMirror);
        },
        ...
        function (e, t, n) {
          (function (e) {
            ...
            e.defineMode("xml", function (r, i) {
              ...
              function y(e, t, n) {
                return "word" == e
                  ? ((n.tagName = t.current()), (a = "tag"), w)
                  : s.allowMissingTagName && "endTag" == e
                  ? ((a = "tag bracket"), w(e, 0, n))
                  : ((a = "error"), y);
              }
              function b(e, t, n) {
                if ("word" == e) {
              ...
              function k(e, t, n) {
                return "equals" == e
                  ? S
                  : (s.allowMissing || (a = "error"), w(e, 0, n));
              }
              function S(e, t, n) {
                return "string" == e
                  ? F
          ...
          !(function (e, r) {
            ...
            function H(e, t, n) {
              var r = t.href,
                ...
                o = e[1].replace(/\\([\[\]])/g, "$1");
              return "!" !== e[0].charAt(0)
                ? { type: "link", raw: n, href: r, title: i, text: o }
                : { type: "image", raw: n, href: r, title: i, text: I(o) };
            }
            var R = (function () {
                function e(e) {
                  this.options = e || B;
                ...
                return (
                          ...
                          this.options.pedantic ||
                            ((c = n.match(
                              ...
                              ((a =
                                ...
                                c.index +
                                m.slice(x + 1).join("\n").length),
                              (p.raw = p.raw.substring(0, p.raw.length - a)),
                              (d = n = n.substring(0, c.index)),
                              (v = x + 1))),
                          x !== v - 1)
                        ) {
                          if (
                            ((o = this.rules.block.listItemStart.exec(
                              m[x + 1]
                            )),
                            this.options.pedantic
                  ...
                  (t.escape = function (e) {
                    ...
                    if (t) return { type: "escape", raw: t[0], text: I(t[1]) };
                  }),
                    ...
                    if (i)
                      return (
                        (r =
                          "@" === i[2]
                            ? "mailto:" +
                              (n = I(this.options.mangle ? t(i[1]) : i[1]))
                            : (n = I(i[1]))),
                        {
                          type: "link",
                          raw: i[0],
                  ...
                  (t.url = function (e, t) {
                    ...
                    if ((n = this.rules.inline.url.exec(e))) {
                      ...
                      if ("@" === n[2])
                        i =
                          "mailto:" +
                          (r = I(this.options.mangle ? t(n[0]) : n[0]));
                      else {
                        var o;
                        do {
                          (o = n[0]),
                        ...
                        (r = t
                          ? this.options.sanitize
                            ? this.options.sanitizer
                              ...
                              : I(i[0])
                            : i[0]
                          : I(this.options.smartypants ? n(i[0]) : i[0])),
            ...
            (j.def = _(j.def)
              ...
              (j.bullet = /(?:[*+-]|\d{1,9}[.)])/),
              (j.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
              (j.item = _(j.item, "gm").replace(/bull/g, j.bullet).getRegex()),
              (j.listItemStart = _(/^( *)(bull) */)
                .replace("bull", j.bullet)
                .getRegex()),
              (j.list = _(j.list)
              ...
              (j.pedantic = W({}, j.normal, {
                ...
                heading: /^(#{1,6})(.*)(?:\n+|$)/,
                fences: P,
                paragraph: _(j.normal._paragraph)
                  .replace("hr", j.hr)
                  .replace("heading", " *#{1,6} *[^\n]")
            ...
            (q.punctuation = _(q.punctuation)
              .replace(/punctuation/g, q._punctuation)
              .getRegex()),
              (q.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
              (q.escapedEmSt = /\\\*|\\_/g),
              (q._comment = _(j._comment)
                .replace("(?:--\x3e|$)", "--\x3e")
                .getRegex()),
              (q.emStrong.lDelim = _(q.emStrong.lDelim)
                .replace(/punct/g, q._punctuation)
                .getRegex()),
              (q.emStrong.rDelimAst = _(q.emStrong.rDelimAst, "g")
                .replace(/punct/g, q._punctuation)
                .getRegex()),
              (q.emStrong.rDelimUnd = _(q.emStrong.rDelimUnd, "g")
                .replace(/punct/g, q._punctuation)
                .getRegex()),
              (q._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
              ...
              (q.link = _(q.link)
                ...
                .getRegex()),
              (q.reflink = _(q.reflink).replace("label", q._label).getRegex()),
              (q.reflinkSearch = _(q.reflinkSearch, "g")
                .replace("reflink", q.reflink)
                .replace("nolink", q.nolink)
                .getRegex()),
              (q.normal = W({}, q)),
              (q.pedantic = W({}, q.normal, {
                strong: {
                  start: /^__|\*\*/,
                  middle:
            ...
            var Y = (function () {
                function t(e) {
                  ...
                  var t = { block: G.normal, inline: V.normal };
                  this.options.pedantic
                    ? ((t.block = G.pedantic), (t.inline = V.pedantic))
                    : this.options.gfm &&
                      ((t.block = G.gfm),
                      this.options.breaks
                        ? (t.inline = V.breaks)
                    ...
                    for (
                      ...
                      if ((r = this.tokenizer.space(e)))
                        ...
                        (e = e.substring(r.raw.length)),
                          (a = t[t.length - 1]) && "paragraph" === a.type
                            ? ((a.raw += "\n" + r.raw),
                              (a.text += "\n" + r.text))
                            : t.push(r);
                    ...
                    for (; e; )
                      if (
                        ...
                        (e = e.substring(i.raw.length)),
                          ...
                          (r = i.inRawBlock);
                        var d = t[t.length - 1];
                        d && "text" === i.type && "text" === d.type
                          ? ((d.raw += i.raw), (d.text += i.text))
                          : t.push(i);
                        ...
                        "link" === i.type
                          ? ((i.tokens = this.inlineTokens(i.text, [], !0, r)),
                            t.push(i))
                          : h && "text" === i.type && "text" === h.type
                          ? ((h.raw += i.raw), (h.text += i.text))
                          : t.push(i);
                      } else if ((i = this.tokenizer.emStrong(e, u, s)))
                        (e = e.substring(i.raw.length)),
                        ...
                        (e = e.substring(i.raw.length)),
                          (i.tokens = this.inlineTokens(i.text, [], n, r)),
                          t.push(i);
                      else if ((i = this.tokenizer.autolink(e, Z)))
                        (e = e.substring(i.raw.length)), t.push(i);
                      else if (n || !(i = this.tokenizer.url(e, Z))) {
                        if ((i = this.tokenizer.inlineText(e, r, X)))
                          (e = e.substring(i.raw.length)),
                            "_" !== i.raw.slice(-1) && (s = i.raw.slice(-1)),
                            (l = !0),
              ...
              te = (function () {
                ...
                return (
                  ...
                  (t.link = function (e, t, n) {
                    if (
                      null ===
                      (e = J(this.options.sanitize, this.options.baseUrl, e))
                    )
                      return n;
                    var r = '<a href="' + ee(e) + '"';
                    return (
                      ...
                      switch ((d = e[n]).type) {
                        ...
                        case "heading":
                          b += this.renderer.heading(
                            ...
                            d.depth,
                            oe(this.parseInline(d.tokens, this.textRenderer)),
                            this.slugger
                          );
                          continue;
                        case "code":
                        ...
                        case "table":
                          ...
                          for (
                            ...
                            for (
                              s = "", a = (l = d.tokens.cells[r]).length, i = 0;
                              i < a;
                              i++
                            )
                              s += this.renderer.tablecell(
                                this.parseInline(l[i]),
                            ...
                            (v = (g = d.items[r]).checked),
                              ...
                              g.task &&
                                ...
                                p
                                  ...
                                  : (m += y)),
                              (m += this.parse(g.tokens, p)),
                              (c += this.renderer.listitem(m, x, v));
            ...
            function fe(e, t, n) {
              ...
              try {
                var l = Y.lex(e, t);
                return (
                  t.walkTokens && fe.walkTokens(l, t.walkTokens), ae.parse(l, t)
                );
              } catch (e) {
                if (
                  ((e.message +=
            ...
            return (
              ...
              (fe.parseInline = function (e, t) {
                ...
                try {
                  ...
                  return (
                    t.walkTokens && fe.walkTokens(n, t.walkTokens),
                    ae.parseInline(n, t)
                  );
                } catch (e) {
                  if (
              ...
              !(function () {
                ...
                (r = function (e, t, r, i) {
                  ...
                  function p() {
                    ...
                    (c.dictionaryTable = c._parseDIC(r)),
                    c.compoundRuleCodes))
                    ...
                    (c.loaded = !0),
                      i.asyncLoad && i.loadedCallback && i.loadedCallback(c);
                  }
                  return (
                    e &&
                      ((c.dictionary = e),
                  ...
                  _parseAFF: function (e) {
                    ...
                    for (i = 0, a = u.length; i < a; i++) {
                      ...
                      if ("PFX" == d || "SFX" == d) {
                        ...
                        (s[h] = { type: d, combineable: "Y" == f, entries: p }),
                          (i += n);
                      } else if ("COMPOUNDRULE" === d) {
                        for (
                          o = i + 1, l = i + 1 + (n = parseInt(c[1], 10));
                          o < l;
                          o++
                        )
                          (r = (t = u[o]).split(/\s+/)),
                            this.compoundRules.push(r[1]);
                        i += n;
                      } else
                        "REP" === d
                          ? 3 === (r = t.split(/\s+/)).length &&
                            this.replacementTable.push([r[1], r[2]])
                          : (this.flags[d] = c[1]);
                    }
                    return s;
                  },
                  _removeAffixComments: function (e) {
                    return (e = (e = (e = (e = e.replace(/^\s*#.*$/gm, ""))
                      .replace(/^\s\s*/m, "")
                    ...
                    if (void 0 === r) {
                      ...
                      if ("object" == typeof r)
                        for (t = 0, n = r.length; t < n; t++)
                          if (!this.hasFlag(e, "ONLYINCOMPOUND", r[t]))
                            return !0;
                    }
                    return !1;
                  },
                  ...
                  suggest: function (e, t) {
                    ...
                    for (
                      var r = 0, i = this.replacementTable.length;
                      r < i;
                      r++
                    ) {
      ...
      18: [
        function (e, t, n) {
          ...
          function v(e, t, n, r, i, o) {
            ...
            (l.className = e.name),
              l.setAttribute("type", i),
              (n = null == n || n),
              e.name && e.name in r && (s[e.name] = e.action),
              e.title &&
                n &&
            ...
            l.tabIndex = -1;
            for (
              var p = document.createElement("i"), m = 0;
              m < c.length;
              m++
            ) {
              var g = c[m];
          ...
          function D(e) {
            ...
            var n = t.getWrapperElement(),
              r = n.nextSibling;
            if (/editor-preview-active-side/.test(r.className))
              if (!1 === e.options.sideBySideFullscreen) {
                var i = n.parentNode;
                t.getOption("fullScreen")
                  ? m(i, "sided--no-fullscreen")
                  : p(i, "sided--no-fullscreen");
              } else q(e);
            if (
              ...
              void 0 !== e.options.maxHeight &&
                (t.getOption("fullScreen")
                  ...
                  : ((t.getScrollerElement().style.height =
                      e.options.maxHeight),
              ...
              /active/.test(o.className)
                ? (o.className = o.className.replace(/\s*active\s*/g, ""))
                : (o.className += " active");
            }
          }
          function C(e) {
            ...
            function i(e, t, i, o, a) {
              (i = i || e.getLineHandle(t)),
                ...
                (a =
                  a ||
                  (!!i.text &&
                    e.getTokenAt({ line: t, ch: i.text.length - 1 })));
              var l = o.type ? o.type.split(" ") : [];
              return a && r(a).indentedCode
                ? "indented"
                : -1 !== l.indexOf("comment") &&
                    (r(o).fencedChars || r(a).fencedChars || n(i)
                      ? "fenced"
                      : "single");
            }
            var o,
            ...
            if ("single" === f) {
              ...
              if (u.line !== c.line || u.ch !== c.ch) {
                ...
                var g,
                  ...
                  x,
                  y,
                  b = r(s.getTokenAt({ line: o, ch: 1 })).fencedChars;
          ...
          function I(e) {
            var t = e.codemirror,
              ...
              r = e.options,
              i = "https://";
            if (r.promptURLs && !(i = prompt(r.promptTexts.link, "https://")))
              return !1;
          ...
          function z(e) {
            var t = e.codemirror,
              ...
              r = e.options,
              i = "https://";
            if (r.promptURLs && !(i = prompt(r.promptTexts.image, "https://")))
              return !1;
          ...
          function R(e, t) {
            ...
            if (["png", "jpg", "jpeg", "gif", "svg"].includes(a))
              $(n, r.image, i.insertTexts.uploadedImage, t);
            else {
          ...
          function U(e) {
            ...
            if (
              (/editor-preview-active-side/.test(a.className) && q(e),
              !o || !/editor-preview-full/.test(o.className))
            ) {
              if (
                ...
                if (Array.isArray(e.options.previewClass))
                  for (var l = 0; l < e.options.previewClass.length; l++)
                    o.className += " " + e.options.previewClass[l];
                else
                  "string" == typeof e.options.previewClass &&
                    (o.className += " " + e.options.previewClass);
              n.appendChild(o);
            }
          ...
          function $(e, t, n, r) {
            if (
              ...
              Object.assign(l, e.getCursor("start")),
                ...
                t
                  ? ((o = (i = e.getLine(l.line)).slice(0, l.ch)),
                    (a = i.slice(l.ch)),
            ...
            if (
              ...
              for (
                ...
                !(function (n) {
                  ...
                  i[t]
                    ? (r = r.replace(l[t], "$1"))
                    : ("unordered-list" == t && (r = s("ordered-list", r, !0)),
                      (r = s(t, r, !1)),
                      (u += 1)),
                    e.replaceRange(
                      r,
          ...
          function K(e, t, n, r) {
            if (
              ...
              var i,
                ...
                c = o.getCursor("end");
              a[t]
                ? ((l = (i = o.getLine(u.line)).slice(0, u.ch)),
                  (s = i.slice(u.ch)),
                  "bold" == t
          ...
          function Y(e) {
            for (var t = 1; t < arguments.length; t++) e = Z(e, arguments[t]);
            return e;
          }
          function Q(e) {
            var t = e.match(
          ...
          function ae(e) {
            ...
            if (
              ...
              (e.insertTexts = Y({}, ee, e.insertTexts || {})),
              (e.promptTexts = Y({}, te, e.promptTexts || {})),
              (e.blockStyles = Y({}, re, e.blockStyles || {})),
              null != e.autosave &&
                (e.autosave.timeFormat = Y(
                  {},
                  ne,
                  e.autosave.timeFormat || {}
                )),
              (e.shortcuts = Y({}, u, e.shortcuts || {})),
              ...
              (e.imageTexts = Y({}, ie, e.imageTexts || {})),
              (e.errorMessages = Y({}, oe, e.errorMessages || {})),
              null != e.autosave &&
          ...
          (ae.prototype.uploadImages = function (e, t, n) {
            ...
            (ae.prototype.uploadImagesUsingCustomFunction = function (e, t) {
              if (0 !== t.length) {
                for (var n = [], r = 0; r < t.length; r++)
                  n.push(t[r].name),
                    this.uploadImageUsingCustomFunction(e, t[r]);
                this.updateStatusBar(
                  "upload-image",
                  this.options.imageTexts.sbOnDrop.replace(
                    "#images_names#",
              ...
              if (o) {
                ...
                return (
                  this.options.renderingConfig &&
                    ...
                    (r = this.options.renderingConfig.sanitizerFunction.call(
                      this,
                      r
                    )),
                  (r = (function (e) {
            ...
            (ae.prototype.render = function (e) {
              if (
                ...
                if (
                  ...
                  o.overlayMode
                    ? (r.defineMode("overlay-mode", function (e) {
            ...
            (ae.prototype.uploadImage = function (e, t, n) {
              ...
              function o(t) {
                ...
                return t
                  ...
                  .replace("#image_max_size#", X(r.options.imageMaxSize, n));
              }
              if (
                ((t =
                  t ||
                ...
                var a = new FormData();
                a.append("image", e),
                  r.options.imageCSRFToken &&
                    a.append("csrfmiddlewaretoken", r.options.imageCSRFToken);
                ...
                (l.upload.onprogress = function (t) {
                  if (t.lengthComputable) {
                    ...
                    r.updateStatusBar(
                      "upload-image",
                      r.options.imageTexts.sbProgress
                ...
                function (e) {
                  var r = (function (e) {
                    ...
                    return e
                      ...
                      .replace("#image_size#", X(t.size, r))
                      .replace(
                        "#image_max_size#",
                        X(n.options.imageMaxSize, r)
                      );
                  })(e);
                  ...
                  if (
                    ...
                    if ("|" === e[t]) {
                      for (var o = !1, a = t + 1; a < e.length; a++)
                        "|" === e[a] ||
                          (r.options.hideIcons &&
                            -1 != r.options.hideIcons.indexOf(e[a].name)) ||
                          (o = !0);
                      if (!o) continue;
                    }
                    !(function (e) {
            ...
            (ae.prototype.createStatusbar = function (e) {
              ...
              if (e && 0 !== e.length) {
                ...
                for (
                  u.className = "editor-statusbar", r = 0;
                  r < l.length;
                  r++
                ) {
                  var c = l[r],
            ...
            (ae.toggleBold = C),
            (ae.toggleItalic = w),
            (ae.toggleStrikethrough = k),
            (ae.toggleBlockquote = F),
            (ae.toggleHeadingSmaller = A),
            (ae.toggleHeadingBigger = E),
            (ae.toggleHeading1 = T),
            (ae.toggleHeading2 = L),
            (ae.toggleHeading3 = M),
            (ae.toggleCodeBlock = S),
            (ae.toggleUnorderedList = B),
            (ae.toggleOrderedList = N),
            (ae.cleanBlock = O),
            (ae.drawLink = I),
            (ae.drawImage = z),
            (ae.drawUploadedImage = H),
            (ae.drawTable = P),
            (ae.drawHorizontalRule = _),
            (ae.undo = W),
            (ae.redo = j),
            (ae.togglePreview = U),
            (ae.toggleSideBySide = q),
            (ae.toggleFullScreen = D),
            (ae.prototype.toggleBold = function () {
              C(this);
            }),
