      ...
      const n = ((t) => {
        const n = t.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }),
          ...
          c = {
            ...
            contains: [
              { begin: /\\\n/, relevance: 0 },
              t.inherit(i, { className: "meta-string" }),
              {
          ...
          l = { className: "title", begin: e(r) + t.IDENT_RE, relevance: 0 },
          d = e(r) + t.IDENT_RE + "\\s*\\(",
          u = {
            keyword:
          ...
          m = [c, s, n, t.C_BLOCK_COMMENT_MODE, o, i],
          p = {
            variants: [
              { begin: /=/, end: /;/ },
              { begin: /\(/, end: /\)/ },
    ...
    return (t) => {
      const n = ((t) => {
        const n = t.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }),
          ...
          p = [o, s, n, t.C_BLOCK_COMMENT_MODE, c, i],
          m = {
            variants: [
              { begin: /=/, end: /;/ },
              { begin: /\(/, end: /\)/ },
      ...
      return (
        (n.disableAutodetect = !1),
        (n.name = "C++"),
        (n.aliases = ["cc", "c++", "h++", "hpp", "hh", "hxx", "cxx"]),
        n
      );
    };
  })()
          ...
          contains: [
            {
              ...
              contains: [e.inherit(r, { className: "meta-string" })],
            },
          ],
        },
        o = a,
  ...
  (() => {
    ...
    return (n) => {
      const t = /[dualxmsipn]{0,12}/,
        ...
        r = { className: "subst", begin: "[$@]\\{", end: "\\}", keywords: s },
        i = { begin: /->\{/, end: /\}/ },
        a = {
          variants: [
            { begin: /\$\d/ },
      ...
      return (
        (r.contains = c),
        (i.contains = c),
        { name: "Perl", aliases: ["pl", "pm"], keywords: s, contains: c }
      );
    };
  })()
);
        ...
        b = ((r) => {
          ...
          return {
            ...
            contains: [
              ...
              {
                begin:
                  "(" + r.RE_STARTERS_RE + "|\\b(case|return|throw)\\b)\\s*",
                keywords: "return throw case",
                contains: [
                  y,
                  r.REGEXP_MODE,
              ...
              },
              {
                ...
                excludeEnd: !0,
                keywords: l,
                contains: ["self", r.inherit(r.TITLE_MODE, { begin: c }), A],
                illegal: /%/,
              },
              {
                beginKeywords: "while if switch catch for",
              },
              {
                ...
                begin:
                  ...
                  "\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",
                returnBegin: !0,
                contains: [A, r.inherit(r.TITLE_MODE, { begin: c })],
              },
              {
                variants: [
                  {
              ...
              },
              {
                ...
                excludeEnd: !0,
                contains: [r.inherit(r.TITLE_MODE, { begin: c }), "self", A],
              },
              {
                begin: "(get|set)\\s+(?=" + c + "\\()",
                end: /\{/,
                keywords: "get set",
                contains: [
                  r.inherit(r.TITLE_MODE, { begin: c }),
                  { begin: /\(\)/ },
                  A,
                ],
              },
