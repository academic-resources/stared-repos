...
class PLPyQuery:
    ...
    def execute(
        self, arg_dict: Mapping[str, Any], all_keys_required=True
    ) -> Sequence[skytools.dbdict]:
        try:
...
def run_query(
    cur: Cursor, sql: str, params: Optional[Mapping[str, Any]] = None, **kwargs: Any
