...
def test_magic_insert():
    ...
    res = magic_insert(
        None, "tbl", [[1, "1"], [2, "2"]], ["col1", "col2"], use_insert=True
    )
    ...
    res = magic_insert(
        None, 'tbl."1"', [[1, "1"], [2, "2"]], ["col1", "col2"], quoted_table=True
    )
    ...
    res = magic_insert(
        None, "tbl", [[1, "a"]], ["col1", "col2", "col3"], use_insert=True
    )
...
def test_mk_delete_sql():
    ...
    res = mk_delete_sql(
        {"a": 1, "b": 2, "c": 3}, "tablename", ["a", "b"], {"a": "aa", "b": "bb"}
    )
