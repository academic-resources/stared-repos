...
def make_object_list_from_subdir(np_dir, frame_context_name, frame_timestamp_micros):
  ...
  * scores.npy: a N-dim float array with the scores in [0, 1] for all the
  ...
  """
    ...
    for i in range(num_objs):
        ...
        if (
            obj.score < 0.03
            or obj.object.box.length < 0.01
            or obj.object.box.width < 0.01
            or (obj.object.box.HasField("height") and obj.object.box.height < 0.01)
        ):
