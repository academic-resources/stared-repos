/* algorithms.js v0.8.1 | (c) 2014 Felipe Ribeiro | https://github.com/felipernb/algorithms.js/blob/master/LICENSE */
!(function (t, r) {
  (r.true = t),
    !(function (e) {
      ...
      return (function t(r, e, n) {
      ...
      })(
        {
          1: [
            function (t, r) {
              ...
              function e(t, r) {
                ...
                for (var h; a != u; ) {
                  (h = i[a++]), (o[h] = !1);
                  for (var c = t.neighbors(h), f = 0; f < c.length; f++) {
                    var l = c[f],
                      p = e[h] + t.edge(h, l);
                    if (
                      p < e[l] &&
            ...
            function (t, r) {
              ...
              var e = function (t, r) {
                var e = {},
                  ...
                  i = [],
                  o = 0;
                t.vertices.forEach(function (r) {
                  t.neighbors(r).forEach(function (e) {
                    i.push({ source: r, target: e, weight: t.edge(r, e) });
                  }),
                    (e[r] = 1 / 0),
                    ++o;
                }),
                ...
                for (u = 0; o > u; ++u) {
                  for (var c = !1, f = 0; h > f; f++)
                    (s = e[i[f].source] + i[f].weight),
                      (a = e[i[f].target]),
                      a > s &&
                        ((c = !0),
                        (e[i[f].target] = s),
                        (n[i[f].target] = i[f].source));
                  if (!c) break;
                }
                return u == o ? { distance: {} } : { distance: e, previous: n };
              };
              r.exports = e;
            },
            {},
              ...
              var e = t("./breadth_first_search"),
                n = function (t, r) {
                  ...
                  return (
                    (n[r] = 0),
                    e(t, r, {
                      onTraversal: function (t, r) {
                        (n[r] = n[t] + 1), (i[r] = t);
                      },
                    }),
                    { distance: n, previous: i }
                  );
                };
              r.exports = n;
            },
              ...
              var e = t("../../data_structure/queue"),
                ...
                i = function (t, r, i) {
                  ...
                  for (
                    var s,
                      a = function (t) {
                        i.allowTraversal(s, t) &&
                          (i.onTraversal(s, t), o.push(t));
                      };
                    !o.isEmpty();
          ...
          5: [
            function (t, r) {
              ...
              var e = function (t, r) {
                ...
                i = function t(r, e, n) {
                  n.enterVertex(e),
                    r.neighbors(e).forEach(function (i) {
                      n.allowTraversal(e, i) &&
                        (n.beforeTraversal(e, i),
                        t(r, i, n),
                        n.afterTraversal(e, i));
                    }),
                    n.leaveVertex(e);
                };
              r.exports = n;
            ...
            function (t, r) {
              ...
              function e(t, r) {
                ...
                for (
                  var s,
                    a = function (r) {
                      var n = e[s] + t.edge(s, r);
                      n < e[r] &&
                        ((e[r] = n), (i[r] = s), o.changePriority(r, e[r]));
                    };
                  !o.isEmpty();
          ...
          7: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structure/graph"),
                n = t("../../algorithms/graph/depth_first_search"),
                i = function (t) {
                  var r = {};
                  if (
                    (t.vertices.forEach(function (e) {
                      r[e] = t.neighbors(e).length;
                    }),
                    t.directed)
                  )
                    t.vertices.forEach(function (e) {
                      t.neighbors(e).forEach(function (t) {
                        r[t] -= 1;
                      });
                    });
                  else {
                ...
                o = function (t) {
                  ...
                  return (
                    ...
                    n(t, r.start, {
                      allowTraversal: function (t, r) {
                        return !s.edge(t, r);
                      },
                      beforeTraversal: function (t, r) {
                        s.addEdge(t, r);
                      },
                      afterTraversal: function (t) {
                        o.push(t);
                      },
                    }),
                    t.vertices.forEach(function (r) {
          ...
          8: [
            function (t, r) {
              ...
              var e = function (t) {
                ...
                var n = function (t, n) {
                  if (!Number.isFinite(r[t][n])) return null;
                  var i = [t];
                  return (
                    t != n &&
                      !(function t(r, n) {
                        if (void 0 === e[r][n]) i.push(n);
                        else {
                          var o = e[r][n];
                          t(r, o), t(o, n);
                        }
          ...
          9: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structure/disjoint_set_forest"),
                ...
                i = function (t) {
                  ...
                  return (
                    ...
                    o
                      ...
                      .forEach(function (t) {
                        r.sameSubset(t.ends[0], t.ends[1]) ||
                          (i.addEdge(t.ends[0], t.ends[1], t.weight),
                          r.merge(t.ends[0], t.ends[1]));
                      }),
                    i
                  );
                };
          ...
          10: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structure/priority_queue"),
                n = t("../../data_structure/graph"),
                i = function (t) {
                  if (t.directed)
                    throw new Error("Can't build MST of a directed graph.");
                  ...
                  for (
                    ...
                    var a = o.extract(!0),
                      u = a.item,
                      h = a.priority;
                    i[u] ? r.addEdge(i[u], u, h) : r.addVertex(u),
                      t.neighbors(u).forEach(s);
                  }
                  return r;
                };
              r.exports = i;
                    ...
                    t.vertices.forEach(function (e) {
                      i[e] ||
                        n(t, e, {
                          ...
                          enterVertex: function (t) {
                            i[t] = ++o;
                          },
                          leaveVertex: function (t) {
                            r.push(t);
                          },
                        });
                    }),
            ...
            function (t, r) {
              ...
              var e = t("./fast_power"),
                ...
                s = function (t) {
                  ...
                  return Math.floor(Math.pow(r, t) / Math.sqrt(5) + 0.5);
                },
                a = function (t) {
                  var r = [
                      [1, 1],
            ...
            function (t, r) {
              ...
              var e = function (t) {
                for (var r = t.length - 1; r > 0; r--) {
                  var e = Math.floor(Math.random() * (r + 1)),
                    n = t[r];
                  (t[r] = t[e]), (t[e] = n);
                }
              };
          ...
          18: [
            function (t, r) {
              "use strict";
              var e = t("../../util/comparator"),
                n = function (t, r) {
                  if (!t.length) return !1;
                  for (
                    var n = new e(r), i = t.length - 1;
                    i && n.greaterThanOrEqual(t[i - 1], t[i]);

                  )
                    i -= 1;
                  if (!i) return !1;
                  for (
                    var o = t[--i], s = t.length - 1;
                    n.lessThanOrEqual(t[s], o);

                  )
                    s -= 1;
                  (t[i] = t[s]), (t[s] = o);
                  for (var a = i, u = t.length; ++a < --u; ) {
                    var h = t[a];
                    (t[a] = t[u]), (t[u] = h);
                  }
                  return !0;
          ...
          19: [
            function (t, r) {
              ...
              var e = function (t) {
                  ...
                  for (var r = [], e = [], n = 0; n < t.length; n++) e[n] = !0;
                  for (n = 0; n < Math.pow(2, t.length); n++) {
                    r.push([]);
                    for (var i = 0; i < t.length; i++)
                      n % Math.pow(2, i) === 0 && (e[i] = !e[i]),
                        e[i] && r[n].push(t[i]);
                  }
                  return r;
                },
          ...
          22: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structure/queue.js"),
                n = function (t, r) {
                  var n = new e();
                  n.push(t);
                  for (var i; !n.isEmpty(); )
                    (i = n.pop()),
                      r(i.value),
                      i.left && n.push(i.left),
                      i.right && n.push(i.right);
                };
              r.exports = n;
            },
          ...
          25: [
            function (t, r) {
              ...
              var e = t("../../util/comparator"),
                n = function (t, r) {
                  for (
                    var n = new e(r), i = t.length, o = i - 1, s = !1, a = 0;
                    i - 1 > a;
                    a++
                  ) {
          ...
          26: [
            function (t, r) {
              ...
              var e = function (t) {
                  ...
                  for (o = 0; r >= o; o++)
                    if (void 0 !== e[o])
                      for (var u = e[o].length, h = 0; u > h; h++)
                        t[a++] = e[o][h];
                  return t;
                },
                n = function (t) {
          ...
          27: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structure/heap").MinHeap,
                n = function (t, r) {
                  var n = new e(r);
                  n.heapify(t);
                  for (var i = []; !n.isEmpty(); ) i.push(n.extract());
                  return i;
                };
              r.exports = n;
            },
          ...
          28: [
            function (t, r) {
              ...
              var e = t("../../util/comparator"),
                n = function (t, r) {
                  for (var n = new e(r), i = 1, o = t.length; o > i; i++) {
                    for (
                      var s = t[i], a = i;
                      a > 0 && n.lessThan(s, t[a - 1]);
          ...
          31: [
            function (t, r) {
              ...
              var e = function (t) {
                  for (
                    var r = i(t),
                      e =
                        0 === r
                          ? 1
                          : 1 + Math.floor(Math.log(r) / Math.log(10)),
                      o = 0;
                    e > o;
                    o++
                  )
                ...
                n = function (t, r) {
                  for (var e = t.length, n = [], i = 0; 10 > i; i++) n[i] = [];
                  for (i = 0; e > i; i++) {
                    var o =
                      parseInt((t[i].key / Math.pow(10, r)).toFixed(r)) % 10;
                    n[o].push(t[i]);
                  }
                  var s = 0;
                  for (i = 0; 10 > i; i++)
                    for (var a = n[i].length, u = 0; a > u; u++)
                      t[s++] = n[i][u];
                  return t;
                },
                i = function (t) {
          ...
          32: [
            function (t, r) {
              ...
              var e = t("../../util/comparator"),
                n = function (t, r) {
                  for (var n = new e(r), i = t.length, o = 0; i - 1 > o; o++) {
              ...
              (e.encode = function (t, r) {
                ...
                for (
                  ...
                  var l = c(),
                    p = c();
                  (l.code = "0"), (p.code = "1");
                  var g = { count: l.count + p.count, parts: [l, p] };
                  a.push(g);
                }
                var d = c();
                (d.code = n.length > 1 ? "" : "0"),
                ...
                var v = n.reduce(function (t, r) {
                  ...
                  _ = t
                    ...
                    .join("");
                return { encoding: v, value: r ? i(_) : _ };
              }),
                (e.decode = function (t, r) {
                  Array.isArray(r) && (r = o(r));
                  var e = Object.keys(t).reduce(function (r, e) {
                      return (r[t[e]] = e), r;
                    }, {}),
                    n = [],
                    i = r.split("").reduce(function (t, r) {
                      t += r;
                      var i = e[t];
            ...
            function (t, r) {
              ...
              var e = function (t, r) {
                var e,
                  n,
                  i = [];
                for (e = 0; e <= t.length; e++) (i[e] = []), (i[e][0] = e);
                for (n = 0; n <= r.length; n++) i[0][n] = n;
                for (e = 1; e <= t.length; e++)
                  for (n = 1; n <= r.length; n++)
                    i[e][n] =
                      Math.min(i[e - 1][n - 1], i[e - 1][n], i[e][n - 1]) +
                      (t[e - 1] != r[n - 1] ? 1 : 0);
            ...
            function (t, r) {
              ...
              var e = 997,
                n = function (t, r) {
                  ...
                  for (
                    var n, o = i(r), s = t.substring(0, r.length), a = r.length;
                    a <= t.length;
                    a++
                  )
                    if (
                      (void 0 === n
                        ? (n = i(s))
                        : ((n -= s.charCodeAt(0) * Math.pow(e, r.length - 1)),
                          (n *= e),
                          (n += t.charCodeAt(a)),
                          (s = s.substring(1) + t[a])),
                      o === n && r === s)
          ...
          42: [
            function (t, r) {
              ...
              (e.prototype.insert = function (t, r) {
                ...
                var e = this._comparator.lessThan(t, r.value)
                  ? "left"
                  : "right";
                r[e]
                  ? this.insert(t, r[e])
                ...
                (e.prototype._findMin = function (t) {
          ...
          45: [
            function (t, r) {
              ...
              (e.prototype.hash = function (t) {
                ...
                (e.prototype._findInList = function (t, r) {
                  for (var e = t && t.head; e; ) {
            ...
            function (t, r) {
              ...
              (e.prototype._swap = function (t, r) {
                ...
                (e.prototype.heapify = function (t) {
                  ...
                  for (var r = this.n >> 1; r > 0; r--) this._siftDown(r);
                }),
                (e.prototype.forEach = function (t) {
                  var r,
                    e = [];
          ...
          47: [
            function (t, r) {
              ...
              (e.prototype.isEmpty = function () {
                ...
                (e.prototype.forEach = function (t) {
                  for (var r = this.head; r; ) t(r.value), (r = r.next);
                }),
                (r.exports = e);
            },
            {},
              ...
              (e.prototype = new n()),
                (e.prototype.insert = function (t, r) {
                  return void 0 !== this._priority[t]
                    ...
                    : ((this._priority[t] = r),
                      void n.prototype.insert.call(this, t));
                }),
                (e.prototype.extract = function (t) {
                  var r = n.prototype.extract.call(this);
          ...
          50: [
            function (t, r) {
              ...
              var e = t("./hash_table"),
                n = function () {
                  (this._elements = new e(arguments.length)),
              ...
              (n.prototype.add = function () {
                for (var t = 0; t < arguments.length; t++)
                  this._elements.put(arguments[t], !0);
                return this;
              }),
                (n.prototype.remove = function () {
                  for (var t = 0; t < arguments.length; t++)
                    this._elements.del(arguments[t]);
                  return this;
                }),
