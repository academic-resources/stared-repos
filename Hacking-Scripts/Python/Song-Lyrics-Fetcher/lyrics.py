...
if os.path.exists(filename):  # If the file already exists
    ...
    try:
        ...
        print('Lyrics of "' + title + '"', "found and saved to the file", filename)
        ...
        print(
            'Error finding the lyrics of the song "' + title + '" by', artist
        )  # Print an error if the lyrics are not found
