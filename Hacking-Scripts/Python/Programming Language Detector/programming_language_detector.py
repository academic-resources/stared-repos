...
def extract_url():
    ...
    if re.search(
        r"public static void main\(String args\[\]\)|System\.out\.println|import java\..+?;",
        input_text,
    ):
    ...
    mbox.showinfo(
        "Detected Language", "Detected Programming Language :\n\n" + detected_language
    )
...
# top label
start1 = tk.Label(
    text="Programming Lang. Detector", font=("Arial", 50), fg="magenta"
)  # same way bg
start1.place(x=60, y=10)

# top second label
enter_label = Label(
    window, text="Write code snippets and detect...", font=("Arial", 30), fg="brown"
)
