...
movies = {
    "Horror": ["The Nun", "Dracula Untold", "Feral", "Shin Godzilla", "Black Death"],
...
class Application(tk.Tk):
    ...
    def createWidgets(self):
        headingLabel = tk.Label(
            self, text="MOVIE BOOKING", font=("Arial", 50), fg="magenta", underline=0
        )
        ...
        self.genreCombo = tkinter.ttk.Combobox(
            self,
            width=15,
        ...
        self.movieCombo = tkinter.ttk.Combobox(
            width=15, font=("Arial", 20), state="readonly"
        )
    ...
    def createTimeButtons(self, event=None):
        ...
        timelbl = tk.Label(
            self, text="Select Time Slot", font=("Arial", 30), fg="green"
        )
        ...
        tk.Button(
            self,
            text=times[0],
            command=lambda: self.seatSelection(times[0]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[1],
            command=lambda: self.seatSelection(times[1]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[2],
            command=lambda: self.seatSelection(times[2]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[3],
            command=lambda: self.seatSelection(times[3]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[4],
            command=lambda: self.seatSelection(times[4]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[5],
            command=lambda: self.seatSelection(times[5]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[6],
            command=lambda: self.seatSelection(times[6]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[7],
            command=lambda: self.seatSelection(times[7]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[8],
            command=lambda: self.seatSelection(times[8]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[9],
            command=lambda: self.seatSelection(times[9]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[10],
            command=lambda: self.seatSelection(times[10]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[11],
            command=lambda: self.seatSelection(times[11]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[12],
            command=lambda: self.seatSelection(times[12]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
        ...
        tk.Button(
            self,
            text=times[13],
            command=lambda: self.seatSelection(times[13]),
            font=("Arial", 20),
            bg="light green",
            fg="blue",
            borderwidth=3,
    ...
    def seatSelection(self, ti):
        ...
        checkoutHeading = tk.Label(
            window1, text="SEATS SELECTION", font=("Arial", 50), fg="magenta"
        )
        ...
        tk.Button(
            ...
            text="01",
            bg="Green",
            command=lambda: self.selected("01"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="02",
            bg="Green",
            command=lambda: self.selected("02"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="03",
            bg="Green",
            command=lambda: self.selected("03"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="04",
            bg="Green",
            command=lambda: self.selected("04"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="05",
            bg="Green",
            command=lambda: self.selected("05"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="06",
            bg="Green",
            command=lambda: self.selected("06"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="07",
            bg="Green",
            command=lambda: self.selected("07"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="08",
            bg="Green",
            command=lambda: self.selected("08"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
        ...
        tk.Button(
            ...
            text="09",
            bg="Green",
            command=lambda: self.selected("09"),
            font=("Arial", 20),
            fg="yellow",
            borderwidth=3,
            relief="raised",
