...
level1b = Button(
    f1,
    text="LEVEL-1",
    command=lambda: level1.show(text_enter),
    font=("Arial", 20),
    bg="light green",
    fg="blue",
    borderwidth=3,
...
level2b = Button(
    f2,
    text="LEVEL-2",
    command=lambda: level2.show(text_enter),
    font=("Arial", 20),
    bg="light green",
    fg="blue",
    borderwidth=3,
...
level3b = Button(
    f3,
    text="LEVEL-3",
    command=lambda: level3.show(text_enter),
    font=("Arial", 20),
    bg="light green",
    fg="blue",
    borderwidth=3,
...
level4b = Button(
    f4,
    text="LEVEL-4",
    command=lambda: level4.show(text_enter),
    font=("Arial", 20),
    bg="light green",
    fg="blue",
    borderwidth=3,
...
def des_f5():
    ...
    score1 = Label(
        f6, text=str(cnt) + "/100", font=("Arial", 100), fg="green", bg="white"
    )
    score1.place(x=250, y=230)

    correct1 = Label(
        f6,
        text="Correct Answer : " + str(cr) + "/5",
        font=("Arial", 40),
        fg="brown",
        bg="white",
    )
...
level5b = Button(
    f5,
    text="LEVEL-5",
    command=lambda: level5.show(text_enter),
    font=("Arial", 20),
    bg="light green",
    fg="blue",
    borderwidth=3,
