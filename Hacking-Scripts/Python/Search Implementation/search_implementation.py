...
def search_text():
    ...
    for i in range(0, len(word_in_entered)):
        if word_in_entered[i] == search_entered:
            ...
            if (
                pos_in_entered[i] == "NN"
                or pos_in_entered[i] == "NNP"
                or pos_in_entered[i] == "NNS"
                or pos_in_entered[i] == "NNPS"
            ):  # noun
            ...
            if (
                pos_in_entered[i] == "VB"
                or pos_in_entered[i] == "VBD"
                or pos_in_entered[i] == "VBG"
                or pos_in_entered[i] == "VBN"
                or pos_in_entered[i] == "VBP"
                or pos_in_entered[i] == "VBZ"
            ):  # verb
                pos_in_entered[i] = "Verb"
            if (
                pos_in_entered[i] == "JJ"
                or pos_in_entered[i] == "JJR"
                or pos_in_entered[i] == "JJS"
            ):  # adjective
                pos_in_entered[i] = "Adjective"
            if (
                pos_in_entered[i] == "RB"
                or pos_in_entered[i] == "RBR"
                or pos_in_entered[i] == "RBS"
            ):  # adverb
...
enter_label = Label(
    window,
    text="Enter Your text or paragraph here and search text...",
    font=("Arial", 30),
    fg="brown",
)
