...
frameCnt = 3
frames = [
    PhotoImage(file="Images/time.gif", format="gif -index %i" % (i))
...
# top label
start1 = tk.Label(
    text="TIME ZONE CONVERTER", font=("Arial", 50), fg="magenta", underline=0
)  # same way bg
start1.place(x=100, y=10)

# label for entering time ---------------------------------------------------------------------------------
time1 = tk.Label(
    text="Enter Time here : ", font=("Arial", 30), fg="brown"
)  # same way bg
...
# label for entering time ---------------------------------------------------------------------------------
time1 = tk.Label(
    text="Select Conversion : ", font=("Arial", 30), fg="brown"
)  # same way bg
