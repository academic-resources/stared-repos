...
# top label
start1 = tk.Label(
    text="COUNTRY  LOCATION", font=("Arial", 50), fg="magenta", underline=0
)  # same way bg
start1.place(x=150, y=10)

# label for country code ---------------------------------------------------------------------------------
codelbl = tk.Label(
    text="Get By Country Code : ", font=("Arial", 30), fg="brown"
)  # same way bg
...
# label for country code ---------------------------------------------------------------------------------
countrylbl = tk.Label(
    text="Get By Country Name : ", font=("Arial", 30), fg="brown"
)  # same way bg
