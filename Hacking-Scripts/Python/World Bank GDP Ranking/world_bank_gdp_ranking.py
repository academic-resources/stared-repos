...
frameCnt = 4
frames = [
    PhotoImage(file="Images/gdp.gif", format="gif -index %i" % (i))
...
def get_status():
    mbox.showinfo(
        "INDIA",
        "India is among the first 5 largest economy in the world.\n\nTHE FIRST 5 LARGEST ECONOMY IN THE WORLD :\n1.)  United States\n2.)  China\n3.)  Japan\n4.)  Germany\n5.)  India",
    )
...
# top label
start1 = tk.Label(
    text="WORLD BANK GDP RANK", font=("Arial", 50), fg="magenta", underline=0
)  # same way bg
start1.place(x=100, y=10)

# label for country code ---------------------------------------------------------------------------------
sel_label = tk.Label(
    text="Select Country Code : ", font=("Arial", 30), fg="brown"
)  # same way bg
