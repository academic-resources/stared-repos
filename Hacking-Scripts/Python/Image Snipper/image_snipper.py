...
# top label
start1 = tk.Label(
    text="IMAGE  SNIPPER", font=("Arial", 50), fg="magenta"
)  # same way bg
...
# top label
sec1 = tk.Label(
    text="Select any image &\nsnip some part of it...", font=("Arial", 40), fg="green"
)  # same way bg
...
# exit Button
exitb = Button(
    window1, text="EXIT", command=exit_win1, font=("Arial", 25), bg="red", fg="blue"
)
