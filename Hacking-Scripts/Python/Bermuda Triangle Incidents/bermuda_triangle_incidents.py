...
frameCnt = 7
frames = [
    PhotoImage(file="Images/bermuda.gif", format="gif -index %i" % (i))
...
# top label
start1 = tk.Label(
    text="BERMUDA TRIANGLE INCIDENTS", font=("Arial", 40), fg="magenta", underline=0
)  # same way bg
start1.place(x=80, y=10)

# label for country code ---------------------------------------------------------------------------------
sel_label = tk.Label(
    text="Select Incident Year  :  ", font=("Arial", 30), fg="brown"
)  # same way bg
