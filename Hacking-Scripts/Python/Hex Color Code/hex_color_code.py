...
# top label
start1 = tk.Label(
    text="HEX COLOR CODE", font=("Arial", 50), fg="magenta", underline=0
)  # same way bg
...
# preview1 label
top1 = Label(
    window, text="PREVIEW AREA", font=("Arial", 40), fg="black", bg="white"
)  # same way bg
...
top2 = Label(
    window,
    text="Chosen Color will be previed here...",
    font=("Arial", 25),
    fg="black",
    bg="white",
)  # same way bg
...
sel_label = tk.Label(
    text="COLOR NAME : ", font=("Arial", 35), fg="brown"
)  # same way bg
