...
frameCnt = 3
frames = [
    PhotoImage(file="Images/laptops.gif", format="gif -index %i" % (i))
...
# top label
start1 = tk.Label(
    text="ALL LAPTOP DETAILER", font=("Arial", 50), fg="magenta", underline=0
)  # same way bg
start1.place(x=120, y=10)

# label for laptop product ---------------------------------------------------------------------------------
modellbl = tk.Label(
    text="LAPTOP PRODUCT : ", font=("Arial", 30), fg="brown"
)  # same way bg
