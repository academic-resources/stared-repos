...
apps_lbl.bind(
    "<Button-1>", lambda e: callback("https://about.google/intl/en/products/")
)
...
drive_lbl.bind(
    "<Button-1>", lambda e: callback("https://drive.google.com/drive/u/0/my-drive")
)
...
i_word.bind(
    "<Button-1>", lambda e: callback("https://www.google.co.in/imghp?hl=en&tab=wi&ogbl")
)
...
text = Text(
    root, width=90, height=2, relief=RIDGE, font=("roboto", 10, "bold"), borderwidth=2
)
...
lang = Label(
    root, text="हिन्दी বাংলা తెలుగు मराठी தமிழ் ગુજરાતી ಕನ್ನಡ മലയാളം ਪੰਜਾਬੀ", fg="blue"
)
...
business_lbl.bind(
    "<Button-1>", lambda e: callback("https://www.google.com/intl/en_in/business/")
)

# how search works label
search_work_lbl = Label(root, text="How Search works", cursor="hand2")
search_work_lbl.place(x=250, y=650)
search_work_lbl.bind(
    "<Button-1>",
    lambda e: callback("https://www.google.com/search/howsearchworks/?fg=1"),
)
...
privacy_lbl.bind(
    "<Button-1>",
    lambda e: callback("https://policies.google.com/privacy?hl=en-IN&fg=1"),
)
...
terms_lbl.bind(
    "<Button-1>", lambda e: callback("https://policies.google.com/terms?hl=en-IN&fg=1")
)
