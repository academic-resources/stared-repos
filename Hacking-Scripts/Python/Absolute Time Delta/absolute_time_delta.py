...
# top label
start1 = tk.Label(
    text="ABSOLUTE  TIME  DELTA", font=("Arial", 45), fg="magenta"
)  # same way bg
...
# Day Entry Box
day_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
day_time1_entry.place(x=350, y=140)
day_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
# Date Entry Box
date_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
date_time1_entry.place(x=350, y=200)
date_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
# Month Entry Box
month_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
month_time1_entry.place(x=350, y=260)
month_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
# Year Entry Box
year_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
year_time1_entry.place(x=350, y=320)
year_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
# Hour Entry Box
hour_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
hour_time1_entry.place(x=350, y=380)
hour_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
# Minute Entry Box
minute_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
minute_time1_entry.place(x=350, y=440)
minute_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
# Second Entry Box
second_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
second_time1_entry.place(x=350, y=500)
second_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
# Day Entry Box
zone_time1_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
zone_time1_entry.place(x=350, y=560)
zone_time2_entry = Entry(
    window, font=("Arial", 25), fg="orange", bg="light yellow", borderwidth=3, width=13
)
...
def get_delta():
    global valid
    time1 = (
        str(day_time1_entry.get())
        + " "
        + str(date_time1_entry.get())
        + " "
        + str(month_time1_entry.get())
        + " "
        + str(year_time1_entry.get())
        + " "
        + str(hour_time1_entry.get())
        + ":"
        + str(minute_time1_entry.get())
        + ":"
        + str(second_time1_entry.get())
        + " "
        + str(zone_time1_entry.get())
    )
    time2 = (
        str(day_time2_entry.get())
        + " "
        + str(date_time2_entry.get())
        + " "
        + str(month_time2_entry.get())
        + " "
        + str(year_time2_entry.get())
        + " "
        + str(hour_time2_entry.get())
        + ":"
        + str(minute_time2_entry.get())
        + ":"
        + str(second_time2_entry.get())
        + " "
        + str(zone_time2_entry.get())
    )
    valid = True
    ...
    if valid:
        ...
        mbox.showinfo(
            ...
            + time2
            + "\n\nAbsolute Time Delta :\n\nIn seconds  :  "
            + str(abs(int((t1 - t2).total_seconds()))),
        )
    else:
