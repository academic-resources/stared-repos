...
frameCnt = 3
frames = [
    PhotoImage(file="Images/regex.gif", format="gif -index %i" % (i))
...
def start_fun():
    ...
    # top label
    start1 = tk.Label(
        f1, text="REGEX CHECKER", font=("Arial", 55), fg="magenta"
    )  # same way bg
    ...
    sec1 = tk.Label(
        f1,
        text="Enter Any Regex and Check its Correctness...",
        font=("Arial", 30),
        fg="brown",
    )  # same way bg
