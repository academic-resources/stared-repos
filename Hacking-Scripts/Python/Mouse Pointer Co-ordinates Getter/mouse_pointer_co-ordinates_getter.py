...
top1 = Label(
    window,
    text="GET MOUSE POINTER CO-ORDINATES",
    font=("Arial", 35, "underline"),
    fg="magenta",
)
...
top1 = Label(
    window,
    text="Move the mouse on the screen and it will display\nthe co-ordinates of mouse cursor on the screen",
    font=("Arial", 30),
    fg="green",
)
...
def update_label():
    ...
    coordinates = (
        "( X , Y )  :  ( " + str(coordinates[1]) + " , " + str(coordinates[0]) + " )"
    )
