...
if __name__ == "__main__":
    ...
    label1 = Label(
        root, text="City name : ", fg="red", bg="light pink", font="Times 16"
    )

    label2 = Label(
        root, text="Temperature :", fg="red", bg="light pink", font="Times 16"
    )

    label3 = Label(
        root, text="atm pressure :", fg="red", bg="light pink", font="Times 16"
    )

    label4 = Label(root, text="humidity :", fg="red", bg="light pink", font="Times 16")

    label5 = Label(
        root, text="description  :", fg="red", bg="light pink", font="Times 16"
    )
    label6 = Label(
        root, text="Minimun Temp", fg="red", bg="light pink", font="Times 16"
    )
    label7 = Label(
        root, text="Maximum Temp", fg="red", bg="light pink", font="Times 16"
    )
    ...
    button1 = Button(
        root, text="Submit", bg="red", fg="black", command=tell_weather, font="Times 18"
    )

    button2 = Button(
        root, text="Clear", bg="red", fg="black", command=clear_all, font="Times 18"
    )
