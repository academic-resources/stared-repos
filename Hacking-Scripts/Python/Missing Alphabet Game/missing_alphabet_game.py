...
def next_switch():
    ...
    if cnt == -1:
        ...
        see1 = Label(
            f1,
            text="SEE HOW WELL YOU KNOW COUNTRY NAME",
            font=("Arial", 30),
            fg="brown",
            bg="light yellow",
        )
        ...
        see2 = Label(
            f1,
            text="Correct Answer :" + str(correct_cnt) + "/20",
            font=("Arial", 30),
            fg="orange",
            bg="white",
        )
        ...
        see3 = Label(
            f1,
            text="Wrong Answer :" + str(wrong_cnt) + "/20",
            font=("Arial", 30),
            fg="blue",
            bg="white",
        )
        ...
        see4 = Label(
            f1,
            text="Skipped Country :" + str(skip_cnt) + "/20",
            font=("Arial", 30),
            fg="green",
            bg="white",
        )
...
start1 = tk.Label(
    text="MISSING ALPHABET", font=("Arial", 40), fg="magenta", underline=0
)  # same way bg
...
missing_lbl = Label(
    window, text="SELECT MISSING ALPHABET : ", font=("Arial", 30), fg="green"
)
