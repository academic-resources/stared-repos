...
answer = input(
    "Which way would you like to go? left or right! please provide a appropriate input else you will loose "
).lower()

# if left was answered
if answer == "left":
    answer = input(
        "You come to a river, you can walk around the river  or swim accross the river?\n Type walk to walk around and swim to swim accross: "
    )
            ...
            if answer == "back":
                ...
                if m == 0:
                    ...
                    print(
                        "wow "
                        + name
                        + " you won . you are damn strong and courageous.so you won man"
                    )
    else:
...
# if right was answered
    ...
    if answer == "back":
        ...
        if answer == "yes":
            print(
                "Ya They are the nice strangers .You talk to the stanger and they tell you the exact direction where you want to go. You WIN!"
            )
        elif answer == "no":
            answer = input(
            ...
            if answer == "left":
                ...
                print(
                    "now"
                    + name
                    + "last end ,one direction is correct and one will lead to death choose wisely"
                )
