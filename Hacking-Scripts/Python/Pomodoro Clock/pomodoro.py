...
name = Label(
    ...
    bg=LIGHT_GREEN,
    width=30,
    font=("Courier New", 20, "bold underline"),
)
...
time_label = Label(
    lbl,
    text="Enter the time in min:sec format",
    bg=LIGHT_GREEN,
    width=35,
    height=2,
...
min_entry = Entry(
    clk, textvariable=min, bg=LIGHT_GREEN, width=5, font=("Courier New", 45)
)
min_entry.grid(row=1, column=1, padx=10)

sec_entry = Entry(
    clk, textvariable=sec, width=5, bg=LIGHT_GREEN, font=("Courier New", 45)
)
...
strt = Button(
    ...
    width=8,
    height=2,
    font=("Courier New", 15, "italic bold"),
    command=timer_start,
)
