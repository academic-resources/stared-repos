...
class videoGUI:
    ...
    def __init__(self, window):
        ...
        self.lbl1 = tk.Label(
            self.window, text="File Path : ", font=("Arial", 27), fg="brown"
        )  # same way bg
        ...
        self.lbl1 = tk.Label(
            self.window,
            text="Selected Video Will\nAppear & Start Playing Here...",
            font=("Arial", 45),
            fg="green",
        )  # same way bg
    ...
    def open_file(self):
        ...
        mbox.showinfo(
            "Status", "File Selected successfully, click on PLAY button to play video."
        )
    ...
    def pause_video(self):
        self.pause = True
        mbox.showinfo(
            "Status", "Video Paused, click on RESUME button to resume playing."
        )
