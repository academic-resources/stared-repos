...
def get_zodiac_sign():
    ...
    if year == "Leap":
        if (
            (month == 2 and date > 29)
            or (month == 4 and date > 30)
            or (month == 6 and date > 30)
            or (month == 8 and date > 30)
            or (month == 9 and date > 30)
            or (month == 11 and date > 30)
        ):
            valid = False
    else:
        if (
    ...
    if valid:
        ...
        if (month == 3 and date >= 21) or (month == 4 and date <= 19):
            ...
            zodiac_name = Label(
                f1, text="SAGITTARIUS", font=("Arial", 35), fg="magenta"
            )
            zodiac_name.place(x=50, y=150)
...
# starting label
start1 = Label(
    window, text="ZODIAC SIGNS", font=("Arial", 35), fg="magenta", underline=0
)
...
# starting label
dob = Label(
    window, text="Choose Date and Month of your D.O.B.", font=("Arial", 25), fg="brown"
)
