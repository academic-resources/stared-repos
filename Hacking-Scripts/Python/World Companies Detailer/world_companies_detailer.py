...
frameCnt = 5
frames = [
    PhotoImage(file="Images/company.gif", format="gif -index %i" % (i))
...
# top label
start1 = tk.Label(
    text="WORLD COMPANIES DETAILER", font=("Arial", 40), fg="magenta", underline=0
)  # same way bg
start1.place(x=100, y=10)

# label for company name ---------------------------------------------------------------------------------
sel_label = tk.Label(
    text="Company Name : ", font=("Arial", 30), fg="brown"
)  # same way bg
...
livenewsb = Button(
    window,
    text="LIVE NEWS",
    command=lambda: callback("https://www.bbc.com/news/business/companies"),
    font=("Arial", 20),
    bg="light green",
    fg="blue",
    borderwidth=3,
