...
frameCnt = 4
frames = [
    PhotoImage(file="Images/trains.gif", format="gif -index %i" % (i))
...
# top label
start1 = tk.Label(
    text="ALL INDIAN TRAINS", font=("Arial", 50), fg="magenta", underline=0
)  # same way bg
start1.place(x=180, y=10)

# label for train name ---------------------------------------------------------------------------------
sel_label = tk.Label(
    text="Train Name : ", font=("Arial", 30), fg="brown"
)  # same way bg
