...
def next_switch():
    ...
    if cnt == -1:
        ...
        score1 = Label(
            f2, text=str(cr * 10) + "/150", font=("Arial", 100), fg="green", bg="white"
        )
        score1.place(x=350, y=250)

        see1 = Label(
            f2,
            text="SEE HOW WELL YOU CAN SEARCH WORDS",
            font=("Arial", 30),
            fg="brown",
            bg="light yellow",
        )
