...
def calcluate_pof():
    ...
    mbox.showinfo(
        ...
        + adverbs
        + "\n\nPrepositions : "
        + str(len(prepositions1))
        + "\nPrepositions are : "
        + prepositions
        + "\n\nConjunctions : "
        + str(len(conjunctions1))
        + "\nConjunctions are : "
        + conjunctions
        + "\n\nInterjection : "
        + str(len(interjections1))
        + "\nInterjections are : "
        + interjections,
    )
...
start1 = Label(
    window,
    text="Part of Speech Calculator",
    font=("Arial", 35),
    fg="magenta",
    underline=0,
)
...
enter_label = Label(
    window, text="Enter Your text or paragraph here...", font=("Arial", 30), fg="brown"
)
