...
def sentence_segment():
    ...
    for i in range(n):
        ...
        if (
            letter == "."
            and not quotes_open
            and not single_quotes_open
            and next_letter != "."
            and word_length > 1
            and (word_length > 2 or text_list[word_pointer].islower())
        ):
    ...
    # top label
    start1 = tk.Label(
        window1, text="SENTENCE SEGMENTER", font=("Arial", 55), fg="magenta"
    )  # same way bg
    start1.place(x=50, y=10)

    # second label
    sec1 = tk.Label(
        window1, text="Sentence After Segmenting...", font=("Arial", 30), fg="brown"
    )  # same way bg
...
# top label
start1 = tk.Label(
    text="SENTENCE SEGMENTER", font=("Arial", 55), fg="magenta"
)  # same way bg
start1.place(x=50, y=10)

# second label
sec1 = tk.Label(
    text="Enter Any Paragraph and Segment it...", font=("Arial", 30), fg="brown"
)  # same way bg
