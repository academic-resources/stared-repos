...
def def_start():
    def basic_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Basic Info", font=("Arial", 50), fg="green"
        )  # same way bg
    ...
    def edu_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Education", font=("Arial", 50), fg="green"
        )  # same way bg
    ...
    def skill_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Skills", font=("Arial", 50), fg="green"
        )  # same way bg
    ...
    def exp_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Experience", font=("Arial", 50), fg="green"
        )  # same way bg
        top1.place(x=340, y=10)
    ...
    def proj_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Projects", font=("Arial", 50), fg="green"
        )  # same way bg
    ...
    def canda_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Certificates and Awards", font=("Arial", 50), fg="green"
        )  # same way bg
    ...
    def link_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Important Links", font=("Arial", 50), fg="green"
        )  # same way bg
    ...
    def handi_fun():
        ...
        # for top label
        top1 = tk.Label(
            window1, text="Hobbies and Interests", font=("Arial", 50), fg="green"
        )  # same way bg
    ...
    # for top label
    start1 = tk.Label(
        f1, text="RESUME GENERATOR", font=("Arial", 50), fg="magenta"
    )  # same way bg
    start1.place(x=120, y=10)

    # for basic label
    basic1 = tk.Label(
        f1, text="Enter Your Basic Details  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
    ...
    # for education label
    edu1 = tk.Label(
        f1, text="Enter Your Education  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
    ...
    # for skill label
    skill1 = tk.Label(
        f1, text="Enter Your Skills  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
    ...
    exp1 = tk.Label(
        f1, text="Enter Your Experience  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
    ...
    # for Projects label
    proj1 = tk.Label(
        f1, text="Enter Your Projects  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
    ...
    canda1 = tk.Label(
        f1, text="Enter Your Certificates & Awards  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
    ...
    # for Links label
    link1 = tk.Label(
        f1, text="Enter Important Links  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
    ...
    handi1 = tk.Label(
        f1, text="Enter Your Hobbies & Interests  :  ", font=("Arial", 30), fg="green"
    )  # same way bg
...
# top label
start1 = tk.Label(
    text="RESUME GENERATOR", font=("Arial", 55), fg="magenta"
)  # same way bg
...
templateb = Button(
    window,
    text="TEMPLATE",
    command=lambda: callback("https://novoresume.com/resume-templates"),
    font=("Arial", 30),
    bg="orange",
    fg="blue",
    borderwidth=3,
