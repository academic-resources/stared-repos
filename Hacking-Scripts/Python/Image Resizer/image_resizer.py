...
# top label
start1 = tk.Label(
    text="Image  Resizer", font=("Arial", 40), fg="magenta", underline=0
)  # same way bg
start1.place(x=500, y=10)

# original image label
start1 = tk.Label(
    text="Original\nImage", font=("Arial", 50), fg="magenta"
)  # same way bg
...
# Entry Box
width_entry = Entry(
    window, font=("Arial", 25), fg="brown", bg="light yellow", borderwidth=3, width=9
)
