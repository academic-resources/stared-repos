...
var FS = require("fs"),
  ...
  SECURITY_READ_WRITE_ERROR = new Error(
  ...
  updateFileProperties = function (a, b) {
    ...
    (b = b.substring(c)),
      b[0] === "/" &&
        b[1] === "/" &&
        ((b = b.replace(/[\/]/g, "\\")), (b = b.substring(0, b.length - 1))),
      (a._isAbsolute = b[0] === SLASH),
      (a._path = d + b),
      (a._usablePath = a._isAbsolute ? a._path : d + PATH.join(a._relative, b));
  },
  File = function (a) {
    var b = process.mainModule.filename,
      ...
      e = this;
    (this._relative = d),
      (this._removeOnExit = !1),
      (this._removeOnExitCallback = function (a) {
      ...
      (this._removeOnExitCallback.first = !0),
      updateFileProperties(this, a);
  },
  checkPermission = function (a, b, c, d) {
    FS.stat(a, function (a, d) {
      a
        ...
        : c(
            null,
            !!(b & parseInt((d.mode & parseInt("777", 8)).toString(8)[0]))
          );
    });
  },
...
(File.prototype.canExecute = function (a) {
  ...
  if (!(checkSecurity(this._usablePath) & SecurityManager.READ.id))
    return a(SECURITY_READ_ERROR, !1);
  ...
  (File.prototype.checksum = function (a, b, c) {
    ...
    if (!(checkSecurity(this._usablePath) & SecurityManager.READ.id))
      return c(SECURITY_READ_ERROR, null);
    var d = this;
    ...
    var f = this,
      ...
      h = function () {
        FS.mkdir(a, function (a) {
          a
            ? c && c(a, !1)
            : FS.readdir(f._usablePath, function (a, b) {
                if (a) c && c(a, !1);
                else {
                  var d = b.length,
                    g = 0;
                  b.forEach(function (a) {
                    new File(PATH.join(f._path, a)).copy(
                      PATH.join(e, a),
                      function (a, b) {
      ...
      d
        ...
        : PATH.exists(a, function (a) {
            a && !b
              ...
              : f.isDirectory() &&
                (a && b
                  ? new File(e).remove(function (a, b) {
                      a ? c && c(a, !1) : h();
                    })
                  : h());
          });
  ...
  (File.createTempFile = function (a, b) {
    ...
    var c = "",
      ...
      e = ".";
    a &&
      ((c = a.prefix ? a.prefix : c),
      (d = a.suffix ? a.suffix : d),
      (e = a.directory ? a.directory.toString() : e));
  ...
  (File.prototype.equals = function (a) {
    var b =
      a instanceof File ? a.getAbsolutePath() : new File(a).getAbsolutePath();
  ...
  (File.prototype.getAbsolutePath = function () {
    return this._path
      ? this._isAbsolute
        ? this._path
        : PATH.join(PATH.dirname(process.mainModule.filename), this._path)
      : null;
  }),
  ...
  (File.prototype.getPermissions = function (a) {
    ...
    if (!(checkSecurity(this._usablePath) & SecurityManager.READ.id))
      return a(SECURITY_READ_ERROR, null);
  ...
  (File.prototype.list = function (a, b) {
    ...
    if (!(checkSecurity(this._usablePath) & SecurityManager.READ.id))
      return b(SECURITY_READ_ERROR, null);
    var d = this;
            ...
            i.forEach(function (g) {
              ...
              FS.stat(PATH.join(a, g), function (b, i) {
                ...
                i.isFile()
                  ...
                  : i.isDirectory() &&
                    ((c[g] = {}),
                    f(PATH.join(a, g), h, c[g], d, function (a, b) {
  ...
  (File.prototype.remove = function (a) {
    ...
    FS.stat(this._usablePath, function (c, d) {
      ...
      d.isFile()
        ? FS.unlink(b._usablePath, function (b) {
            a && (b ? a(b, !1) : a(null, !0));
          })
        : d.isDirectory() &&
          FS.readdir(b._usablePath, function (c, d) {
            if (c) {
              a && a(c, !1);
              return;
            }
            var e = d.length,
              ...
              g = function () {
                return e === f
                  ? (FS.rmdir(b._usablePath, function (b) {
                      a && (b ? a(b, !1) : a(null, !0));
                    }),
                    !0)
                  : !1;
            ...
            if (g()) return;
            for (var h in d)
              new File(PATH.join(b._path, d[h])).remove(function (b, c) {
                b ? a && a(b, !1) : (f++, g());
              });
          });
    });
...
var removeSynchronous = function (a) {
  if (!a._path) return !1;
  if (!(checkSecurity(a._usablePath) & SecurityManager.WRITE.id))
...
(File.prototype.removeOnExit = function (a, b) {
  var c = arguments.length;
  c === 0 ? (a = !0) : c === 1 && typeof a == "function" && ((b = a), (a = !0)),
    b && (b = b.bind(this)),
    (this._removeOnExit = a);
  ...
  (File.prototype.size = function (a) {
    ...
    if (!(checkSecurity(this._usablePath) & SecurityManager.READ.id))
      return a(SECURITY_READ_ERROR, 0);
    var b = 0,
      c = this,
      d = function (a) {
        FS.stat(c._usablePath, function (d, e) {
          d
            ...
            ? a(null, e.size)
            : e.isDirectory() &&
              FS.readdir(c._usablePath, function (d, e) {
                var f = e.length,
                  g = 0,
                  h = function () {
...
var checkSecurity = function (a) {
      ...
      c = function (c, d) {
        ...
        for (var f in c) {
          ...
          a.match(i) &&
            (!e.dir || !e.dir.match(i)) &&
            ((e.dir = h),
            (e.perm = d ? b(g.permissions.id) : g.permissions.id));
        }
        return e.perm;
      },
      d = c(SM._deny, !0);
    return d !== null
      ? d
      : ((d = c(SM._allow, !1)), d !== null ? d : SecurityManager.READ.id);
  },
...
(SecurityManager.prototype.allow = function (a, b) {
  ...
  (module.exports = { File: File, SecurityManager: SecurityManager });
