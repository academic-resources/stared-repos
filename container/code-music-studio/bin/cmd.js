...
var port =
  parseInt(process.env.PORT) || argv.port || parseInt(argv._[0]) || 8000;
...
var server = http.createServer(function (req, res) {
  var u = url.parse(req.url),
    m = req.method;
  try {
    var parts = decodeURIComponent(u.pathname).split("/").slice(1);
  } catch (err) {
