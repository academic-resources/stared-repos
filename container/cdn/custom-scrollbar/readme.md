...
::-webkit-scrollbar-corner {
    background-image: url(https://cdn.xgqfrms.xyz/img/chrome-srollbar/corner.png);
    background-repeat: no-repeat;
}

::-webkit-scrollbar-corner:window-inactive {
    background-image: url(https://cdn.xgqfrms.xyz/img/chrome-srollbar/corner-inactive.png);
}

::-webkit-resizer {
    background-image: url(https://cdn.xgqfrms.xyz/img/chrome-srollbar/resizer.png);
    background-repeat: no-repeat;
    background-position: bottom right;
}

::-webkit-resizer:window-inactive {
    background-image: url(https://cdn.xgqfrms.xyz/img/chrome-srollbar/resizer-inactive.png);
}
...
[data-demo="scrollbar-box"]::-webkit-scrollbar:horizontal:corner-present {
    border-right-width: 0;
}

[data-demo="scrollbar-box"]::-webkit-scrollbar-track:horizontal:disabled:corner-present {
    margin-right: 5px;
}
...
[data-demo="scrollbar-box"]::-webkit-scrollbar:vertical:corner-present {
    border-bottom-width: 0;
}

[data-demo="scrollbar-box"]::-webkit-scrollbar-track:vertical:disabled:corner-present {
    margin-bottom: 5px;
}
