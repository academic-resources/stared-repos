/******/ (function (modules) {
  ...
  /******/ [
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__game__ =
        __webpack_require__(2);

      document.addEventListener("DOMContentLoaded", () => {
        const canvasEl = document.getElementsByTagName("canvas")[0];
        canvasEl.width =
          __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].DIM_X;
        canvasEl.height =
          __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */].DIM_Y;
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      "use strict";
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pill__ =
        __webpack_require__(3);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__virus__ =
        __webpack_require__(4);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__audio__ =
      ...
      class Game {
        constructor(ctx) {
          ...
          this.audio = new __WEBPACK_IMPORTED_MODULE_2__audio__[
            "a" /* default */
          ]();
        }
        ...
        randomizeViruses(ctx, board) {
          for (let i = 0; i < this.level * 10; i++) {
            ...
            const virus = new __WEBPACK_IMPORTED_MODULE_1__virus__[
              "a" /* default */
            ](ctx, board, [randomY, randomX], virusColor);
        ...
        newPill(ctx, board) {
          if (
            this.board[0][3] !== undefined ||
            this.board[0][4] !== undefined
          ) {
            this.gameOver = true;
          }
          const pill = new __WEBPACK_IMPORTED_MODULE_0__pill__[
            "a" /* default */
          ](ctx, board);
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      "use strict";
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__audio__ =
        __webpack_require__(0);
      ...
      class Pill {
        constructor(ctx, board) {
          ...
          this.audio = new __WEBPACK_IMPORTED_MODULE_0__audio__[
            "a" /* default */
          ]();

          this.pill1 = new PillBlock(
            ctx,
            board,
            [0, 3],
            ["yellow", "blue", "red"][Math.floor(Math.random() * 3)],
            "left"
          );
          this.pill2 = new PillBlock(
            ctx,
            board,
            [0, 4],
            ["yellow", "blue", "red"][Math.floor(Math.random() * 3)],
        ...
        drop() {
          if (
            this.board1[0] < 15 &&
            this.board2[0] < 15 &&
            (this.board[this.board1[0] + 1][this.board1[1]] === undefined ||
              this.board1[0] + 1 === this.board2[0]) &&
            (this.board[this.board2[0] + 1][this.board2[1]] === undefined ||
              this.board2[0] + 1 === this.board1[0])
          ) {
          ...
          if (this.active) {
            ...
            if (k === "right") {
              if (
                ...
                (this.board[this.board1[0]][this.board1[1] + 1] === undefined ||
                  this.board1[1] + 1 == this.board2[1]) &&
                (this.board[this.board2[0]][this.board2[1] + 1] === undefined ||
                  this.board2[1] + 1 == this.board1[1])
              ) {
                this.board[this.board1[0]][this.board1[1]] = undefined;
                this.board[this.board2[0]][this.board2[1]] = undefined;
            ...
            if (k === "z") {
              if (this.horizontal) {
                ...
                if (
                  this.board[this.board1[0]][this.board1[1] + 1] ===
                    undefined &&
                  this.board1[1] < 7
                ) {
                  this.board[this.board2[0]][this.board2[1]] = undefined;
