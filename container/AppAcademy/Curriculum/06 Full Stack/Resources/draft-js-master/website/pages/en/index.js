      ...
      <div>
        <div className="hero">
          <div className="wrap">
            ...
            <div className="minitext">Rich Text Editor Framework for React</div>
          </div>
        </div>
        ...
        <section className="content wrap">
          <section className="home-section home-getting-started">
            ...
            <p>
              ...
              whether you're just looking to support a few inline text styles or
              building a complex text editor for composing long-form articles.
            </p>
