...
describe("Anchor Preview TestCase", function () {
    ...
    describe("anchor preview element", function () {
        it("should be displayed on hover of a link element", function () {
            ...
            expect(
                anchorPreview.getPreviewElement().querySelector("a").innerHTML
            ).toBe(document.getElementById("test-link").attributes.href.value);
            ...
            nextRange.selectNodeContents(
                document.getElementById("another-element")
            );
            sel.removeAllRanges();
        ...
        it("should be displayed on hover of a link element with markup inside", function () {
            ...
            expect(
                ...
                document.getElementById("test-markup-link").attributes.href
                    .value
            );
        });
        ...
        it("should show the unencoded link", function () {
            ...
            expect(
                ...
                document.getElementById("test-symbol-link").attributes.href
                    .value
            );
        });
        ...
        it("should display different urls when hovering over different links consecutively", function () {
            ...
            expect(
                anchorPreview
                    .getPreviewElement()
                    .classList.contains("medium-editor-anchor-preview-active")
            ).toBe(false);
        ...
        it("should display the anchor form with target checkbox checked in the toolbar when clicked", function () {
            ...
            // show preview
            fireEvent(
                document.getElementById("text-target-blank-link"),
                "mouseover"
            );
        ...
        it("should display the anchor form with custom class checkbox checked in the toolbar when clicked", function () {
            ...
            // show preview
            fireEvent(
                document.getElementById("text-custom-class-link"),
                "mouseover"
            );
        ...
        it("should be displayed when the link has data attribute to disable preview", function () {
            ...
            fireEvent(
                document.getElementById("test-link-disable-preview"),
                "mouseover"
            );
            ...
            expect(
                anchorPreview
                    .getPreviewElement()
                    .classList.contains("medium-toolbar-arrow-over")
            ).toBe(false);
        });
        ...
        it("should display the anchor form in the toolbar when clicked when showWhenToolbarIsVisible is set to true and toolbar is visible", function () {
            ...
            expect(clickEvent.defaultPrevented).toBe(
                true,
                "link navigation was not prevented on click of the anchor-preview"
            );

            // anchor form should be visible in toolbar
            expect(toolbar.isDisplayed()).toBe(true);
            expect(anchor.isDisplayed()).toBe(
                true,
                "anchor form to edit link is not visible"
            );
            expect(
                anchorPreview
                    .getPreviewElement()
        ...
        it("should NOT be present when anchorPreview option is set to false", function () {
            ...
            expect(
                document.querySelector(".medium-editor-anchor-preview")
            ).toBeNull();
        });
        ...
        it("should be removed from the document when editor is destroyed", function () {
            ...
            expect(
                document.querySelector(".medium-editor-anchor-preview-active")
            ).toBeNull();
        ...
        it("should correctly set preview position even if elementsContainer is absolute", function () {
            ...
            anchorPreview = editor
                .getExtensionByName("anchor-preview")
                .getPreviewElement();
