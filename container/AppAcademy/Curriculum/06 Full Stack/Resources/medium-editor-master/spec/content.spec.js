...
describe("Content TestCase", function () {
    ...
    describe("when the tab key is pressed", function () {
        it("should indent when within an <li>", function () {
            ...
            if (!isFirefox()) {
                expect(this.el.innerHTML).toBe(
                    "<ol><li>lorem</li><ol><li>ipsum</li></ol></ol>"
                );
            }
        });
        ...
        it("with shift key, should outdent when within an <li>", function () {
            this.el.innerHTML =
                "<ol><li>lorem</li><ol><li><span><span>ipsum</span></span></li></ol></ol>";
            var editor = this.newMediumEditor(".editor"),
                target =
                    editor.elements[0].querySelector("ol").lastChild.firstChild
                        .firstChild;
            spyOn(document, "execCommand").and.callThrough();
            selectElementContents(target);
            fireEvent(target, "keydown", {
    ...
    describe("when the space key is pressed", function () {
        ...
        it("should allow one space at the end of a line when disableExtraSpaces options is true", function () {
            ...
            placeCursorInsideElement(
                editor.elements[0].getElementsByTagName("p")[0],
                1
            );
    ...
    describe("when the enter key is pressed", function () {
        ...
        it("should allow a line to be added when pressed enter at end of the <p> tag when disableDoubleReturn is true and contains <br> as the previous sibling", function () {
            this.el.innerHTML =
                "<p>it is a test</p><br><p>because tests are great..!!</p>";
            var editor = this.newMediumEditor(".editor", {
                    disableDoubleReturn: true,
                }),
        ...
        it("should call formatBlock when inside a non-header and non-anchor", function () {
            ...
            var editor = this.newMediumEditor(".editor"),
                targetNode =
                    editor.elements[0].querySelector("span").firstChild;
            spyOn(document, "execCommand").and.callThrough();
            placeCursorInsideElement(
                targetNode,
                targetNode.textContent.length - 1
            );
        ...
        it("should not call formatBlock when inside a figCaption", function () {
            var html =
                '<figure><img src="../demo/img/medium-editor.jpg"><figcaption>ipsum</figcaption></figure>';
            this.el.innerHTML = html;
            var editor = this.newMediumEditor(".editor"),
                targetNode =
                    editor.elements[0].querySelector("figCaption").firstChild;
            spyOn(document, "execCommand").and.callThrough();
            placeCursorInsideElement(
                targetNode,
                targetNode.textContent.length - 1
        ...
        describe("within a blockquote element", function () {
            it("at the end of the blockquote, p tag should be created next, not blockquote", function () {
                ...
                var editor = this.newMediumEditor(".editor"),
                    target =
                        editor.elements[0].querySelector(
                            "blockquote"
                        ).firstChild;
                ...
                expect(this.el.innerHTML).toBe(
                    "<blockquote>lorem ipsum</blockquote><p><br></p>"
                );
            });
    ...
    describe("when backspace is pressed", function () {
        ...
        describe("within an empty first list item", function () {
            it("should insert a paragraph before the list if it is the first element in the editor", function () {
                ...
                expect(this.el.innerHTML).toBe(
                    "<p><br></p><ul><li>lorem ipsum</li></ul>"
                );
                range = document.getSelection().getRangeAt(0);
                expect(
                    range.commonAncestorContainer.nodeName.toLowerCase()
                ).toBe("p");
            });

            it("should not insert a paragraph before the list if it is NOT the first element in the editor", function () {
                this.el.innerHTML =
                    "<p>lorem ipsum</p><ul><li></li><li>lorem ipsum</li></ul>";
                var editor = this.newMediumEditor(".editor"),
                    target = editor.elements[0].querySelector("li");
                placeCursorInsideElement(target, 0);
                fireEvent(target, "keydown", {
    ...
    describe("with header tags", function () {
        it("should insert a breaking paragraph before header when hitting enter key at front of header", function () {
            ...
            expect(this.el.innerHTML).toBe(
                "<h2>lorem</h2><p><br></p><h3>ipsum</h3>"
            );
        });
    ...
    it("should not throw an error when keyup occurs within a non-div editor", function () {
        ...
        expect(errorCount).toBe(
            0,
            "there was an error thrown when calling document.execCommand()"
        );
    });
    ...
    describe("justify actions", function () {
        it("should not replace line breaks inside header elements with div elements", function () {
            this.el.innerHTML =
                "<h2>lorem ipsum<br />lorem ipsum<br />lorem ipsum<br /></h2><ul><li>item 1</li><li>item 2</li><li>item 3</li></ul>";
            var editor = this.newMediumEditor(".editor"),
                h2 = this.el.querySelector("h2");
            selectElementContentsAndFire(h2.firstChild);
            editor.execAction("justifyRight");
            h2 = this.el.querySelector("h2");
            expect(h2.querySelectorAll("br").length).toBe(
                3,
                "Some of the <br> elements have been removed from the <h2>"
            );
            expect(h2.querySelectorAll("div").length).toBe(
                0,
                "Some <br> elements were replaced with <div> elements within the <h2>"
            );
        });

        it("should not replace line breaks inside blockquote elements with div elements", function () {
            this.el.innerHTML =
                "<ul><li>item 1</li><li>item 2</li></ul><blockquote>lorem ipsum<br />lorem ipsum<br />lorem ipsum<br /></blockquote><ul><li>item 1</li><li>item 2</li><li>item 3</li></ul>";
            var editor = this.newMediumEditor(".editor"),
            ...
            expect(blockquote.querySelectorAll("br").length).toBeGreaterThan(
                2,
                "Some of the <br> elements have been removed from the <blockquote>"
            );
            expect(blockquote.querySelectorAll("div").length).toBe(
                0,
                "Some <br> elements were replaced with <div> elements within the <blckquote>"
            );
        });

        it("should not replace line breaks inside pre elements with div elements", function () {
            this.el.innerHTML =
                "<ul><li>item 1</li><li>item 2</li></ul><pre>lorem ipsum<br />lorem ipsum<br />lorem ipsum<br /></pre><ul><li>item 1</li><li>item 2</li><li>item 3</li></ul>";
            var editor = this.newMediumEditor(".editor"),
                pre = this.el.querySelector("pre");
            selectElementContentsAndFire(pre);
            editor.execAction("justifyCenter");
            pre = this.el.querySelector("pre");
            expect(pre.querySelectorAll("br").length).toBe(
                3,
                "Some of the <br> elements have been removed from the <pre>"
            );
            expect(pre.querySelectorAll("div").length).toBe(
                0,
                "Some <br> elements were replaced with <div> elements within the <pre>"
            );
        });

        it("should not replace line breaks inside p elements with div elements", function () {
            this.el.innerHTML =
                "<ul><li>item 1</li><li>item 2</li></ul><p>lorem ipsum<br />lorem ipsum<br />lorem ipsum<br /></p><ul><li>item 1</li><li>item 2</li><li>item 3</li></ul>";
            var editor = this.newMediumEditor(".editor"),
                para = this.el.querySelector("p");
            selectElementContentsAndFire(para);
            editor.execAction("justifyCenter");
            para = this.el.querySelector("p");
            expect(para.querySelectorAll("br").length).toBe(
                3,
                "Some of the <br> elements have been removed from the <p>"
            );
            expect(para.querySelectorAll("div").length).toBe(
                0,
                "Some <br> elements were replaced with <div> elements within the <p>"
            );
        });
    });
    ...
    describe("when list element is unlisted", function () {
        it("should fix markup when one list element is unlisted", function () {
            ...
            if (getEdgeVersion() > 0) {
                ...
                expect(this.el.innerHTML).toBe(
                    "<div>lorem</div><ul><li>ipsum</li><li>dolor</li></ul>"
                );
            } else {
                // Other browsers should wrap them in p
                expect(this.el.innerHTML).toBe(
                    "<p>lorem</p><ul><li>ipsum</li><li>dolor</li></ul>"
                );
            }
        });
        ...
        it("should fix markup when miltiple list elements are unlisted", function () {
            ...
            if (getEdgeVersion() > 0) {
                // Edge wraps elements in div
                expect(this.el.innerHTML).toBe(
                    "<div>lorem</div><div>ipsum</div><ol><li>dolor</li></ol>"
                );
            } else {
                // Other browsers should wrap them in p
                expect(this.el.innerHTML).toBe(
                    "<p>lorem</p><p>ipsum</p><ol><li>dolor</li></ol>"
                );
            }
        });
