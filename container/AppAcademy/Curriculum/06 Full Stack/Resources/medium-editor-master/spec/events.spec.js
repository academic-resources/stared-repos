...
describe("MediumEditor.Events TestCase", function () {
    ...
    describe("ExecCommand Listener", function () {
        ...
        it("should notify all listeners when execCommand is called", function () {
            ...
            expect(origExecCommand).toHaveBeenCalledWith(
                "bold",
                false,
                "something"
            );
    ...
    describe("Custom EditableInput Listener", function () {
        function runEditableInputTests(inputSupported) {
            var namePrefix = inputSupported
                ? "when Input is supported"
                : "when Input is NOT supported";

            it(
                namePrefix +
                    " should trigger with the corresponding editor element passed as an argument",
                function () {
                    var originalInputSupport =
                        MediumEditor.Events.prototype
                            .InputEventOnContenteditableSupported;
                    ...
                    var editableTwo = this.createElement(
                            "div",
                            "editor",
                            "lore ipsum"
                        ),
            ...
            it(
                namePrefix +
                    " should only trigger when the content has actually changed",
                function () {
                    var originalInputSupport =
                        MediumEditor.Events.prototype
                            .InputEventOnContenteditableSupported;
            ...
            it(
                namePrefix +
                    ",setContent should fire editableInput when content changes",
                function () {
                    var originalInputSupport =
                        MediumEditor.Events.prototype
                            .InputEventOnContenteditableSupported;
            ...
            it(
                namePrefix +
                    ", setContent should not fire editableInput when content doesn't change",
                function () {
                    var originalInputSupport =
                        MediumEditor.Events.prototype
                            .InputEventOnContenteditableSupported;
