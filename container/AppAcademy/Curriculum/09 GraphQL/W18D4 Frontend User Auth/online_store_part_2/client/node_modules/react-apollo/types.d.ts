import ApolloClient, { ApolloQueryResult, ApolloError, FetchPolicy, WatchQueryFetchPolicy, ErrorPolicy, FetchMoreOptions, UpdateQueryOptions, FetchMoreQueryOptions, SubscribeToMoreOptions, PureQueryOptions, MutationUpdaterFn } from 'apollo-client';
...
export interface GraphqlQueryControls<TGraphQLVariables = OperationVariables> extends QueryControls<any, TGraphQLVariables> {
}
export declare type MutationFunc<TData = any, TVariables = OperationVariables> = MutationFn<TData, TVariables>;
