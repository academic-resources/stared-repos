...
/*!**********************!*\
  !*** ./src/clock.js ***!
  \**********************/
/*! exports provided: clockUIUpdate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clockUIUpdate\", function() { return clockUIUpdate; });\nclass Clock {\n  constructor() {\n    const currentTime = new Date();\n\n    this.hours = currentTime.getHours();\n    this.minutes = currentTime.getMinutes();\n    this.seconds = currentTime.getSeconds();\n\n\n    // Schedule the tick at 1 second intervals.\n    setInterval(this._tick.bind(this), 1000);\n  }\n\n  printTime() {\n    // Format the time in HH:MM:SS\n    const timeString = [this.hours, this.minutes, this.seconds].join(\":\");\n\n    // Now we'll return the string instead of printing it.\n    return timeString;\n  }\n\n  _tick() {\n    this._incrementSeconds();\n  }\n\n  _incrementSeconds() {\n    // 1. Increment the time by one second.\n    this.seconds += 1;\n    if (this.seconds === 60) {\n      this.seconds = 0;\n      this._incrementMinutes();\n    }\n  }\n\n  _incrementMinutes() {\n    this.minutes += 1;\n    if (this.minutes === 60) {\n      this.minutes = 0;\n      this._incrementHours();\n    } \n  }\n\n  _incrementHours() {\n    this.hours = (this.hours + 1) % 24;\n  }\n}\n\n// Grab onto the Element we want to use for the Clock.\nconst clockElement = document.getElementById('clock');\n\n// Since we are in the main scope  we can set the initial time to be visible now\n// That way we can safely use setInterval and not worry about our clock not \n// showing up for that first second.\nconst clock = new Clock();\nclockElement.innerHTML = clock.printTime();\n\n// This is what is actualy responsible for the clock being show to the \n// user as ticking\nconst clockUIUpdate = setInterval(() => {\n  clockElement.innerHTML = clock.printTime();\n}, 1000);\n\n//# sourceURL=webpack:///./src/clock.js?");
