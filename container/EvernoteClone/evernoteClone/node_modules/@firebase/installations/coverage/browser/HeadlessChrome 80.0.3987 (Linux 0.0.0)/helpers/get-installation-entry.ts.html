...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (registrationPromise) {
      return registrationPromise;
    } else {
      // if there is no registrationPromise, entry is registered.
<span class="cstat-no" title="statement not covered" >      return installationEntry as RegisteredInstallationEntry;</span>
    }
  }
&nbsp;
  return entry;
