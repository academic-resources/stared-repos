...
<html lang="en">
<head>
    <title>Code coverage report for helpers/fid-changed.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">helpers</a> fid-changed.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!callbackSet) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
  callbackSet.delete(callback);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (callbackSet.size === 0) {
<span class="cstat-no" title="statement not covered" >    fidChangeCallbacks.delete(key);</span>
  }
&nbsp;
...
function broadcastFidChange(key: string, fid: string): void {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (channel) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Feb 28 2020 15:34:56 GMT-0800 (Pacific Standard Time)
</div>
</div>
