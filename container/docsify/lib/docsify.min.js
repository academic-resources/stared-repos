!(function () {
  ...
  function $(e) {
    ...
    !E &&
      ...
      (t = i
        ? (t = parseInt(E.style.width || 0, 10) + i) > 80
          ? 80
          : t
        : Math.floor((n / r) * 100)),
      (E.style.opacity = 1),
      (E.style.width = t >= 95 ? "100%" : t + "%"),
      t >= 95 &&
        (clearTimeout(A),
        ...
        then: function (n, r) {
          if ((void 0 === r && (r = a), t)) {
            var s = setInterval(function (e) {
              return $({ step: Math.floor(5 * Math.random() + 1) });
            }, 500);
            o("progress", $),
          ...
          o("error", r),
            o("load", function (t) {
              ...
              if (a.status >= 400) r(a);
                ...
                var o = (T[e] = {
                  content: a.response,
                  opt: { updatedAt: i.getResponseHeader("last-modified") },
                });
                n(o.content, o.opt);
              }
            });
        ...
        (n.rules = t),
          ...
          (n.prototype.token = function (e, n, r) {
            ...
            for (e = e.replace(/^ +$/gm, ""); e; )
              if (
                ...
                for (
                  e = e.substring(o[0].length),
                    ...
                    i = !1,
                    p = (o = o[0].match(this.rules.item)).length,
                    h = 0;
                  h < p;
                  h++
                )
                  (u = (c = o[h]).length),
                    ~(c = c.replace(/^ *([*+-]|\d+\.) +/, "")).indexOf("\n ") &&
                      ...
                      (c = this.options.pedantic
                        ? c.replace(/^ {1,4}/gm, "")
                        : c.replace(new RegExp("^ {1," + u + "}", "gm"), ""))),
                    this.options.smartLists &&
                      h !== p - 1 &&
                      (s === (l = t.bullet.exec(o[h + 1])[0]) ||
                        (s.length > 1 && l.length > 1) ||
                        ((e = o.slice(h + 1).join("\n") + e), (h = p - 1))),
                    (a = i || /\n\n(?!\s*$)/.test(c)),
                    h !== p - 1 &&
                      ((i = "\n" === c.charAt(c.length - 1)), a || (a = i)),
                    this.tokens.push({
              ...
              else if (!r && n && (o = this.rules.def.exec(e)))
                (e = e.substring(o[0].length)),
                ...
                for (h = 0; h < c.cells.length; h++)
                  c.cells[h] = c.cells[h]
                    ...
                    .split(/ *\| */);
                this.tokens.push(c);
              } else if (n && (o = this.rules.paragraph.exec(e)))
                (e = e.substring(o[0].length)),
                  this.tokens.push({
                    type: "paragraph",
                    text:
        ...
        function i(e, t) {
          ...
          this.options.gfm
            ? this.options.breaks
              ? (this.rules = r.breaks)
              : (this.rules = r.gfm)
            : this.options.pedantic && (this.rules = r.pedantic);
        }
        (i.rules = r),
            ...
            for (var t, n, r, i, a = ""; e; )
              if ((i = this.rules.escape.exec(e)))
                ...
                if ((i = this.rules.tag.exec(e)))
                  ...
                  (e = e.substring(i[0].length)),
                    (a += this.renderer.codespan(s(i[2].trim(), !0)));
                  ...
                  (e = e.substring(i[0].length)),
                    (a += this.renderer.text(s(this.smartypants(i[0]))));
                else if (e)
                  throw new Error("Infinite loop on byte: " + e.charCodeAt(0));
              } else
                (e = e.substring(i[0].length)),
            ...
            r = (t.Prism = {
              ...
              highlightAllUnder: function (e, t, n) {
                ...
                for (
                  ...
                  r.highlightElement(a, !0 === t, i.callback);
              },
                      ...
                      for (
                        ...
                        if (!(w instanceof l)) {
                          ...
                          if (!(A = p.exec(w)) && f && y != t.length - 1) {
                            ...
                            for (
                              var _ = A.index + (g ? A[1].length : 0),
                                S = A.index + A[0].length,
                                C = y,
                                L = k,
                                E = t.length;
                              C < E &&
                              (L < S || (!t[C].type && !t[C - 1].greedy));
                              ++C
                            )
                          ...
                          if (A) {
                            ...
                            if (
                              ...
                              1 != x && r.matchGrammar(e, t, n, y, k, !0, c),
                              o)
                            )
                              break;
                          } else if (o) break;
                  ...
                  t.addEventListener(
                    ...
                    function (e) {
                      var n = JSON.parse(e.data),
                        ...
                        a = n.code,
                        o = n.immediateClose;
                      t.postMessage(r.highlight(a, r.languages[i], i)),
                        o && t.close();
                    },
                    !1
                  ),
    ...
    return (
      e.forEach(function (e) {
        var i = e.level || 1,
          a = i - 1;
        i > t ||
          (r[a] ? (r[a].children = (r[a].children || []).concat(e)) : n.push(e),
          (r[i] = e));
      }),
      n
    );
  ...
  function U(e) {
    ...
    var t = e
      ...
      r = z[t];
    return (
      (r = n.call(z, t) ? r + 1 : 0), (z[t] = r), r && (t = t + "-" + r), t
    );
  }
  U.clear = function () {
    z = {};
  ...
  function X(e, t) {
    ...
    for (var r in e)
      t.indexOf(r) > -1 ||
        n.push(e[r] ? (W(r) + "=" + W(e[r])).toLowerCase() : W(r));
  ...
  var ne = {
    ...
    re = function (t, n) {
      (this.config = t),
        ...
        (this.contentBase = n.getBasePath());
      var a,
        s = this._initRenderer(),
        c = t.markdown || {};
      o(c)
        ? (a = c(R, s))
        : (R.setOptions(r(c, { renderer: r(s, c.renderer) })), (a = R)),
        (this._marked = a),
        (this.compile = e(function (e) {
          var n = "";
          if (!e) return e;
          (n = i(e) ? a(e) : a.parser(e)),
            (n = t.noEmoji
              ? n
              : ((r = n),
                r
                  ...
                  .replace(/:(\w+?):/gi, (l && window.emojify) || D)
                  .replace(/__colon__/g, ":")));
          var r;
          return U.clear(), n;
        }));
  ...
  (re.prototype.compileEmbed = function (e, t) {
    ...
    (re.prototype._initRenderer = function () {
      ...
      (a.heading = e.heading =
        function (e, t) {
          var r = { level: t, title: e };
          /{docsify-ignore}/g.test(e) &&
            ((e = e.replace("{docsify-ignore}", "")),
            (r.title = e),
            (r.ignoreSubHeading = !0)),
            /{docsify-ignore-all}/g.test(e) &&
              ((e = e.replace("{docsify-ignore-all}", "")),
              (r.title = e),
              (r.ignoreAllSubs = !0));
          var a = U(e),
            o = n.toURL(n.getCurrentPath(), { id: a });
          return (
            (r.slug = o),
            i.toc.push(r),
            "<h" +
        ...
        (a.link = e.link =
          function (e, r, a) {
            ...
            return (
              (r = l),
              Q(e) || i._matchNotCompileLink(e) || c.ignore
                ? (o += ' target="' + t + '"')
                : (e === i.config.homepage && (e = "README"),
                  (e = n.toURL(e, null, n.getCurrentPath()))),
              c.target && (o += " target=" + c.target),
              c.disabled && ((o += " disabled"), (e = "javascript:void(0)")),
              r && (o += ' title="' + r + '"'),
              '<a href="' + e + '"' + o + ">" + a + "</a>"
            );
          }),
        (a.paragraph = e.paragraph =
          function (e) {
            return /^!&gt;/.test(e)
              ? L("tip", e)
              : /^\?&gt;/.test(e)
        ...
        (a.image = e.image =
          function (e, t, i) {
            var a = e,
              ...
              c = s.config;
            (t = l),
              c["no-zoom"] && (o += " data-no-zoom"),
              t && (o += ' title="' + t + '"');
            var u = c.size;
            if (u) {
              var h = u.split("x");
              h[1]
                ? (o += "width=" + h[0] + " height=" + h[1])
                : (o += "width=" + h[0]);
            }
            return (
              Q(e) || (a = J(r, V(n.getCurrentPath()), e)),
              '<img src="' +
                a +
                '"data-origin="' +
                e +
    ...
    (re.prototype.sidebar = function (e, t) {
      ...
      if (e) r = this.compile(e);
        ...
        (r = C(i, "<ul>{inner}</ul>")), (this.cacheTree[n] = i);
      }
      return r;
    }),
  ...
  function oe(e, t, n, r) {
    ...
    return (
      ...
      r && (d.title = i ? i.title || i.innerText + " - " + ie : ie),
      i
    );
  }
  var se = (function () {
  ...
  var le = (function () {
      function e() {
        ...
        !(function (e, t) {
          ...
          (this.duration = t.duration || 1e3),
          (this.ease = t.easing || this._defaultEase),
          (this.start = t.start),
          (this.end = t.end),
          (this.frame = null),
          (this.next = null),
    ...
    if (pe) {
      ...
      if (t) {
        ...
        if (
          ...
          (a = h),
          !ue && g.classList.contains("sticky"))
        ) {
          var d = n.clientHeight,
            f = a.offsetTop + a.clientHeight + 40,
            b = f - 0 < d,
            y =
              a.offsetTop >= i.scrollTop && f <= i.scrollTop + d
                ? i.scrollTop
                : b
                ? 0
                : f - d;
      ...
      "paragraph" === e.type &&
        (e.text = e.text.replace(
          ...
          function (e, r, i, a) {
            ...
            return o
              ? (("markdown" !== o.type && "code" !== o.type) ||
                  c.push({ index: t, embed: o }),
                o.code)
              : e;
          }
        ));
        ...
        var s = (function (e) {
          return function (n) {
            ...
            n &&
              ...
              t({ token: e, embedToken: r }),
              ++o >= a && t({});
          };
        })(n);
        P(n.embed.url).then(s);
      }
    })({ compile: s, embedTokens: c, fetch: o }, function (e) {
      var n = e.embedToken,
        a = e.token;
      if (a) {
        var o = a.index + p;
        r(h, n.links),
          (l = l.slice(0, o).concat(n, l.slice(o + 1))),
          (p += n.length - 1);
        ...
        "function" == typeof n
          ...
          ? (function (e) {
              var t = [],
                n = 0;
              return (
                e.replace(O, function (r, i, a) {
                  t.push(e.substring(n, a - 1)),
                    (n = a += r.length + 1),
                    t.push(function (e) {
                      return (
                        "00" + ("string" == typeof M[r] ? e[M[r]]() : M[r](e))
                      ).slice(-r.length);
                    });
                }),
  ...
  function _e(e) {
    ...
    (e.compiler = new re(t, e.router)),
      l && (window.__current_docsify_compiler__ = e.compiler);
    var n = t.el || "#app",
      r = m("nav") || b("nav"),
      i = m(n),
      a = "",
      ...
      ? (t.repo &&
        ...
        t.coverpage &&
          (a +=
            ...
            ", 100%, 85%) 0%,hsl(" +
            Math.floor(255 * Math.random()) +
            ', 100%, 85%) 100%)"><div class="cover-main">\x3c!--cover--\x3e</div><div class="mask"></div></section>'),
        t.logo && (t.logo = J(e.router.getBasePath(), t.logo)),
        (a += (function (e) {
          var t =
      ...
      t.themeColor &&
        (d.head.appendChild(
          b(
            "div",
            ((u = t.themeColor),
            "<style>:root{--theme-color: " + u + ";}</style>")
          ).firstElementChild
        ),
        (function (e) {
          if (
  ...
  (Ce.prototype.getBasePath = function () {
    ...
    (Ce.prototype.getCurrentPath = function () {}),
    (Ce.prototype.normalize = function () {}),
    (Ce.prototype.parse = function () {}),
    (Ce.prototype.toURL = function (e, t, n) {
      var i = n && "#" === e[0],
        a = this.parse(K(e));
      if (
        ((a.query = r({}, a.query, t)),
        (e = (e = a.path + X(a.query)).replace(/\.md(\?)|\.md$/, "$1")),
        i)
      ) {
        var o = n.indexOf("?");
      ...
      return (
        ...
        (t.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e, !0), query: G(t) }
          );
        }),
      ...
      return (
        ...
        (t.prototype.parse = function (e) {
          ...
          return (
            ...
            { path: e, file: this.getFile(e), query: G(t) }
          );
        }),
        t
      );
  ...
  function Te(e) {
    e.router.normalize(),
      ...
      g.setAttribute("data-page", e.route.file);
  }
  function Pe(e) {
    !(function (e) {
      var t = function (e) {
  ...
  function Fe(e, t, n, r, i, a) {
    (e = a ? e : e.replace(/\/$/, "")),
      (e = V(e)) &&
        P(i.router.getFile(e + n) + t, !1, i.config.requestHeaders).then(
          r,
          function (a) {
            return Fe(e, t, n, r, i);
          }
    ...
    s(this, "init"),
      (function (e) {
        var t,
          n = e.config;
        (t =
          "history" === (n.routerMode || "hash") && u ? new Ae(n) : new Ee(n)),
          (e.router = t),
          Te(e),
          ($e = e.route),
      ...
      (function (e) {
        ...
        if (e.rendered) {
          ...
          t && n && (n.parentNode.innerHTML += window.__SUB_SIDEBAR__),
            e._bindEventOnRendered(n),
            e.$resetEvents(),
            s(e, "doneEach"),
            s(e, "ready");
        } else
  ...
  ((je = Ne)._renderTo = function (e, t, n) {
    ...
    (je._bindEventOnRendered = function (e) {
      ...
      if (
        ((function (e) {
          ...
          for (
            var n = p(".sidebar"), r = v(n, "li"), i = 0, a = r.length;
            i < a;
            i += 1
          ) {
            var o = r[i],
    ...
    (je._renderMain = function (e, t, n) {
      ...
      s(this, "beforeEach", e, function (i) {
        var a,
          o = function () {
            t.updatedAt && (a = we(a, t.updatedAt, r.config.formatUpdated)),
              s(r, "afterEach", a, function (e) {
                return xe.call(r, e);
              });
          };
        r.isHTML
          ? ((a = r.result = e), o(), n())
          : ye({ compiler: r.compiler, raw: i }, function (e) {
      ...
      if ((_(p("main"), t ? "add" : "remove", "hidden"), e)) {
        ...
        if (i) {
          if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");
            ...
            var a = i[1];
            _(n, "add", "has-mask"),
              Q(i[1]) || (a = J(this.router.getBasePath(), i[1])),
  ...
  !(function (e) {
    ...
    (e._loadSideAndNav = function (e, t, n, r) {
          ...
          return (
            o
              ? ((o = this.router.getFile(a + o)),
                ...
                P(o + X(i, ["id"]), !1, r).then(function (t) {
      ...
      (e._fetch404 = function (e, t, r) {
        ...
        if (c) {
          ...
          return (
            n(this.router.getFile(h), 0, l).then(
              function (e, t) {
    ...
    (Ne.$resetEvents = function () {
      me(this.route.path, this.route.query.id),
        this.config.loadNavbar && oe(this.router, "nav");
    });
  (window.Docsify = { util: Oe, dom: S, get: P, slugify: U }),
