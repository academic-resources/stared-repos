  ...
  function tinydate(str) {
    ...
    str.replace(RGX, function (key, _, idx) {
      ...
      parts.push(function (d) {
        return (
          "00" + (typeof dict[key] === "string" ? d[dict[key]]() : dict[key](d))
        ).slice(-key.length);
      });
    });
    ...
    (function () {
      ...
      InlineLexer.prototype.output = function (src) {
        ...
        while (src) {
          ...
          // reflink, nolink
          if (
            (cap = this$1.rules.reflink.exec(src)) ||
      ...
      (function () {
        return (
          this || (typeof window !== "undefined" ? window : commonjsGlobal)
        );
      })()
    ));
  });
...
********************************************** */
  ...
  Compiler.prototype._matchNotCompileLink = function _matchNotCompileLink(
    link
  ) {
  ...
  function prerenderEmbed(ref, done) {
    ...
    var moveIndex = 0;
    walkFetchEmbed(
      { compile: compile, embedTokens: embedTokens, fetch: fetch },
      function (ref) {
  ...
  function getFileName(path, ext) {
    return new RegExp("\\.(" + ext.replace(/^\./, "") + "|html)$", "g").test(
      path
    )
      ? path
      : /\/$/g.test(path)
  ...
  var HashHistory = (function (History$$1) {
    ...
    HashHistory.prototype.toURL = function toURL(path, params, currentRoute) {
      return (
        "#" + History$$1.prototype.toURL.call(this, path, params, currentRoute)
      );
    };
  ...
  function fetchMixin(proto) {
    ...
    proto._fetch = function (cb) {
      ...
      req.then(
        ...
        function (_) {
          this$1._fetchFallbackPage(file, qs, cb) ||
