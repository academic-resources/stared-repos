    ...
    d = function (d) {
      var a =
        ...
        y = function () {
          if (A.original) {
            if (
              (A.original.dispatchEvent(h("show")),
              (N =
                window.pageYOffset ||
              ...
              (A.template = document.createElement("div")),
                A.template.appendChild(e.content.cloneNode(!0)),
            ...
            if (
              ...
              A.zoomed.classList.add("medium-zoom-image--open"),
              A.zoomed.addEventListener("click", z),
              A.zoomed.addEventListener("transitionend", w),
              A.original.getAttribute("data-zoom-target"))
            ) {
              (A.zoomedHd = A.zoomed.cloneNode()),
                (A.zoomedHd.src = A.zoomed.getAttribute("data-zoom-target")),
                (A.zoomedHd.onerror = function () {
                  clearInterval(t),
                    console.error(
                      "Unable to reach the zoom image target " + A.zoomedHd.src
                    ),
                    (A.zoomedHd = null),
                    k();
                });
              var t = setInterval(function () {
                A.zoomedHd.naturalWidth &&
                  (clearInterval(t),
                  A.zoomedHd.classList.add("medium-zoom-image--open"),
                  A.zoomedHd.addEventListener("click", z),
        ...
        z = function e() {
          var t =
            ...
            o = function () {
              S ||
                !A.original ||
                (A.original.dispatchEvent(h("hide")),
                (S = !0),
                document.body.classList.remove("medium-zoom--open"),
                (A.zoomed.style.transform = ""),
                A.zoomedHd &&
                  ((A.zoomedHd.style.transform = ""),
                  A.zoomedHd.removeEventListener("click", e)),
                A.template &&
                  ((A.template.style.transition = "opacity 150ms"),
                  (A.template.style.opacity = 0)),
                A.zoomed.removeEventListener("click", e),
                A.zoomed.addEventListener("transitionend", L));
            };
          0 < t ? setTimeout(o, t) : o();
        },
        b = function (e) {
          e && e.target
            ? ((A.original = e.target), y())
            : A.original
            ? z()
            : ((A.original = T[0]), y());
        },
        E = function (e) {
          return (e.metaKey || e.ctrlKey) && O.metaClick
            ? window.open(
            ...
            : (e.preventDefault(), void b(e));
        },
        w = function e() {
          (S = !1),
            A.zoomed.removeEventListener("transitionend", e),
            A.original.dispatchEvent(h("shown"));
        },
        L = function e() {
          A.original &&
            ...
            A.zoomed.classList.remove("medium-zoom-image--open"),
            A.template && document.body.removeChild(A.template),
            (S = !1),
            A.zoomed.removeEventListener("transitionend", e),
            A.original.dispatchEvent(h("hidden")),
            (A.original = null),
            (A.zoomed = null),
            (A.zoomedHd = null),
            (A.template = null));
          ...
          if (A.original) {
            ...
            if (O.container)
              if (O.container instanceof Object)
                e(i, O.container),
                  (o = i.width - i.left - i.right - 2 * O.margin),
                  (n = i.height - i.top - i.bottom - 2 * O.margin);
              else {
                var d = (
                    r(O.container)
                      ? O.container
                  ...
                  c = d.left,
                  m = d.top;
                e(i, { width: a, height: l, left: c, top: m });
              }
            (o = o || i.width - 2 * O.margin),
              (n = n || i.height - 2 * O.margin);
            var s = A.zoomedHd || A.original,
              ...
              w =
                ...
                E +
                ") translate3d(" +
                ((o - z) / 2 - y + O.margin + i.left) / E +
                "px, " +
                ((n - b) / 2 - h + O.margin + i.top) / E +
                "px, 0)";
            (A.zoomed.style.transform = w),
              A.zoomedHd && (A.zoomedHd.style.transform = w);
          }
        },
        O = {
          margin: c,
            ...
            return Array.isArray(e)
              ...
              : ((o = e),
                ...
                HTMLCollection.prototype.isPrototypeOf(o)
                  ? Array.apply(null, e).filter(n)
                  : r(e)
                  ? [e].filter(n)
                  : "string" == typeof e
                  ? Array.apply(null, document.querySelectorAll(e)).filter(n)
                  : Array.apply(
                      null,
          ...
          update: function () {
            var t =
              0 < arguments.length && void 0 !== arguments[0]
                ...
                : {};
            return (
              t.background && (x.style.backgroundColor = t.background),
              t.container &&
                t.container instanceof Object &&
                (t.container = e({}, O.container, t.container)),
              e(O, t)
            );
          },
