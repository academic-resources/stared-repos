...
module.exports = function (params) {
  ...
  var sustain, cutoff;
  if (params.sustain) {
    // refers to some segment of the envelope
    if (Object.prototype.toString.call(params.sustain) === "[object Object]") {
      // sustain is its own envelope
      console.log("ehll;");
      ...
      // sustain is a static amplitude value
      sustain = function () {
