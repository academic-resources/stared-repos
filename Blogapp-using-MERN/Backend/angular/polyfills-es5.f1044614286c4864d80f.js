                ...
                for (var m = 0, k = 0, E = []; k < p.length; ) {
                  ...
                  if (
                    ...
                    for (var _ = 1; _ <= x.length - 1; _++)
                      if ((E.push(x[_]), E.length === b)) return E;
                    k = m = S;
                  }
                }
                    ...
                    (i.set = function (t) {
                      ...
                      e || n !== h || (e = h),
                        e &&
                          ...
                          u && u.apply(e, v),
                          "function" == typeof t
                            ? ((e[l] = t), e.addEventListener(s, S, !1))
                            : (e[l] = null));
                    }),
                    (i.get = function () {
                      var t = this;
