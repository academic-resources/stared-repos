...
!(function (a, b) {
          ...
          return "undefined" == typeof a.getAttribute
            ...
            : ((1 === f && r.isXMLDoc(a)) ||
                (e =
                  ...
                  (r.expr.match.bool.test(b) ? Ya : void 0)),
              void 0 !== c
                ? null === c
      ...
      propHooks: {
        tabIndex: {
          get: function (a) {
            ...
            return b
              ? parseInt(b, 10)
              : $a.test(a.nodeName) || (_a.test(a.nodeName) && a.href)
              ? 0
              : -1;
          },
        },
    ...
    trigger: function (b, c, e, f) {
      ...
      if (
        ...
        if (!f && !n.noBubble && !r.isWindow(e)) {
          for (
            j = n.delegateType || p, db.test(j + p) || (h = h.parentNode);
            h;
            h = h.parentNode
          )
            o.push(h), (i = h);
  ...
  function ib(a, b, c, d) {
    ...
    else for (e in b) ib(a + "[" + e + "]", b[e], c, d);
  }
