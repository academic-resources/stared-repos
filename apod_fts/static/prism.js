/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+java+json+latex+makefile+markdown+perl+php+python+sql&plugins=line-numbers+highlight-keywords */
var _self =
                  ...
                  if (!(v instanceof a)) {
                    ...
                    if (!b && h && m != r.length - 1) {
                      ...
                      for (
                        ...
                        (P += (r[S].matchedStr || r[S]).length),
                          w >= P && (++m, (y = P));
                      if (r[m] instanceof a || r[S - 1].greedy) continue;
                      (k = S - m), (v = e.slice(y, P)), (b.index -= y);
                    }
                    if (b) {
                      g && (f = b[1].length);
                      var w = b.index + f,
                        ...
                        j = [m, k];
                      x && j.push(x);
                      var N = new a(i, c ? n.tokenize(b, c) : b, d, b, h);
                      j.push(N),
                        O && j.push(O),
      ...
      r &&
        ...
        document.addEventListener &&
          ...
          ("loading" !== document.readyState
            ? requestAnimationFrame(n.highlightAll, 0)
