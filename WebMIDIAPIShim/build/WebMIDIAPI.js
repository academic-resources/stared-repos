...
})(
    {
        ...
        2: [
            function (require, module, exports) {
                ...
                var _midimessage_event2 =
                    _interopRequireDefault(_midimessage_event);

                var _midiconnection_event = require("./midi/midiconnection_event");

                var _midiconnection_event2 = _interopRequireDefault(
                    _midiconnection_event
                );
                    ...
                    if (!navigator.requestMIDIAccess) {
                        ...
                        navigator.requestMIDIAccess = function () {
                            ...
                            if (midiAccess === undefined) {
                                ...
                                scope.MIDIMessageEvent =
                                    _midimessage_event2.default;
                                scope.MIDIConnectionEvent =
                                    _midiconnection_event2.default;
                            }
                            return midiAccess;
                        };
        ...
        3: [
            function (require, module, exports) {
                ...
                function createMIDIPort(type, name, callback) {
                    (0, _jazz_instance.getJazzInstance)(
                        type,
                        function (instance) {
                            var port = void 0;
                            var info = [name, "", ""];
                            if (type === "input") {
                                ...
                                port = new _midi_output2.default(
                                    info,
                                    instance
                                );
                ...
                function dispatchEvent(port) {
                    port.dispatchEvent(
                        new _midiconnection_event2.default(port, port)
                    );

                    var evt = new _midiconnection_event2.default(
                        midiAccess,
                        port
                    );
            ...
            function (require, module, exports) {
                ...
                var MIDIInput = (function () {
                    function MIDIInput(info, instance) {
                        ...
                        this.id = (0, _midi_access.getMIDIDeviceId)(
                            info[0],
                            "input"
                        );
                        this.name = info[0];
                        ...
                        this._listeners = new _store2.default()
                            .set("midimessage", new _store2.default())
                            .set("statechange", new _store2.default());
                    ...
                    _createClass(MIDIInput, [
                        ...
                        },
                        {
                            ...
                            value: function open() {
                                ...
                                if (
                                    (0, _util.getDevice)().platform !== "linux"
                                ) {
                                    this._jazzInstance.MidiInOpen(
                                        this.name,
                                        midiProc.bind(this)
                        ...
                        },
                        {
                            ...
                            value: function _bufferLongSysex(
                                data,
                                initialOffset
                            ) {
                                var j = initialOffset;
                                while (j < data.length) {
                                    if (data[j] == 0xf7) {
                                        // end of sysex!
                                        j += 1;
                                        this._appendToSysexBuffer(
                                            data.slice(initialOffset, j)
                                        );
                                        return j;
                                    }
                                    j += 1;
                ...
                midiProc = function midiProc(timestamp, data) {
                    ...
                    for (i = 0; i < data.length; i += length) {
                        ...
                        if (isSysexMessage || this._inLongSysexMessage) {
                            ...
                            evt.data = new Uint8Array(
                                data.slice(i, length + i)
                            );
                        }
                        ...
                        if (nodejs) {
                            ...
                            var e = new _midimessage_event2.default(
                                this,
                                evt.data,
                                evt.receivedTime
                            );
...
*/
                ...
                var jazzPluginInitTime =
                    (0, _util.getDevice)().browser === "firefox" ? 200 : 100; // 200 ms timeout for Firefox v.55
        ...
        */
                        ...
                        activeX.id = id + "ie";
                        activeX.classid =
                            "CLSID:1ACE1618-1C7D-4561-AEE1-34842AA85E90";
                        ...
                        p.appendChild(
                            document.createTextNode("This page requires the ")
                        );
                        ...
                        var insertionPoint =
                            document.getElementById("MIDIPlugin");
                        if (!insertionPoint) {
                ...
                (function (process, global) {
                    ...
                    var polyfillPerformance = function polyfillPerformance() {
                        ...
                        if (typeof scope.performance.now === "undefined") {
                            ...
                            if (
                                typeof scope.performance.timing !==
                                    "undefined" &&
                                typeof scope.performance.timing
                    ...
                    var polyfillPromise = function polyfillPromise() {
                        ...
                        if (typeof scope.Promise !== "function") {
                            ...
                            scope.Promise.prototype.then = function then(
                                resolve,
                                reject
                            ) {
