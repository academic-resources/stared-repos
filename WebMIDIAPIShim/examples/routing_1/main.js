window.onload = function () {
                ...
                midiAccess.onstatechange = function (e) {
                    ...
                    var listener =
                        port.type === "input"
                            ...
                            : checkboxMIDIOutOnChange;
                    var activePorts =
                        port.type === "input" ? activeInputs : activeOutputs;
    ...
    // browsers without WebMIDI API or Jazz plugin
        ...
        divInputs.innerHTML =
            "No access to MIDI devices: browser does not support WebMIDI API, please use the WebMIDIAPIShim together with the Jazz plugin";
        divOutputs.innerHTML = "";
    }

    function showMIDIPorts() {
        var html, checkbox, checkboxes, inputs, outputs, i, maxi;
    ...
    function inputListener(midimessageEvent) {
        ...
        divLog.innerHTML =
            type + " " + data1 + " " + data2 + "<br>" + divLog.innerHTML;
