...
class DjangoSearchModelTests(TestCase):
    def setUp(self):
        self.test_instance = TestModel.objects.create(text="searchable text goes here")
    ...
    def test_init(self):
        ...
        self.assertEqual(
            self.test_instance.text_vector, "'goe':3 'searchabl':1 'text':2"
        )
    ...
    def test_get_searchable_fields(self):
        ...
        self.assertTrue(
            all(
                isinstance(field, SearchableTextField)
