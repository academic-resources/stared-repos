...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    t.default = function () {
      return r.default.createElement(
        "div",
        null,
        r.default.createElement(c.Route, { path: "/", component: o.default }),
        r.default.createElement(c.Route, {
          exact: !0,
          path: "/",
          component: a.default,
        }),
        r.default.createElement(s.ProtectedRoute, {
          path: "/chirps",
          component: i.default,
        }),
        r.default.createElement(s.AuthRoute, {
          path: "/signup",
          component: u.default,
        })
      );
      ...
      var t = e.currentUser,
        ...
        r = t
          ? i.default.createElement(
              ...
              i.default.createElement("button", { onClick: n }, "Logout")
            )
          : i.default.createElement(
              "div",
              null,
  ...
  function (e, t, n) {
    ...
    var o = (t.RECEIVE_CURRENT_USER = "RECEIVE_CURRENT_USER"),
    ...
    (t.createNewUser = function (e) {
      return function (t) {
        return r.postUser(e).then(function (e) {
          return t(a(e));
        });
      };
    }),
      (t.login = function (e) {
        return function (t) {
          return r.postSession(e).then(function (e) {
            return t(a(e));
          });
        };
      }),
      (t.logout = function () {
        return function (e) {
          return r.deleteSession().then(function () {
            return e({ type: i });
          });
        };
      });
  ...
  function (e, t, n) {
    ...
    (t.postUser = function (e) {
      return $.ajax({ url: "/api/users", method: "POST", data: { user: e } });
    }),
  ...
  function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.ProtectedRoute = t.AuthRoute = void 0);
    var r,
      o = n(1),
      i = (r = o) && r.__esModule ? r : { default: r },
      a = n(34),
      u = n(56);
    var s = function (e) {
      return { loggedIn: Boolean(e.session.currentUser) };
    };
        ...
        (0, a.connect)(s)(function (e) {
          ...
          return i.default.createElement(u.Route, {
            ...
            render: function (e) {
              return t
                ? i.default.createElement(r, e)
                : i.default.createElement(u.Redirect, { to: "/signup" });
            },
          });
        })
      ));
