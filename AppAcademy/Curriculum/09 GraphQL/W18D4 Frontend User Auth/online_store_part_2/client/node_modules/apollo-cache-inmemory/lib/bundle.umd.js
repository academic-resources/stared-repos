(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "tslib", "apollo-cache", "apollo-utilities", "optimism", "ts-invariant"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("tslib"), require("apollo-cache"), require("apollo-utilities"), require("optimism"), require("ts-invariant"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.tslib, global.apolloCache, global.apolloUtilities, global.optimism, global.tsInvariant);
    global.unknown = mod.exports;
  }
})(this, function (_exports, _tslib, _apolloCache, _apolloUtilities, _optimism, _tsInvariant) {

  _exports.__esModule = true;
  _exports.assertIdValue = assertIdValue;
  _exports.defaultDataIdFromObject = defaultDataIdFromObject;
  _exports.defaultNormalizedCacheFactory = defaultNormalizedCacheFactory$1;
  _exports.enhanceErrorWithDocument = enhanceErrorWithDocument;
  _exports.WriteError = _exports.StoreWriter = _exports.StoreReader = _exports.ObjectCache = _exports.IntrospectionFragmentMatcher = _exports.InMemoryCache = _exports.HeuristicFragmentMatcher = void 0;
  var testMap = new Map();
  ...
  _exports.HeuristicFragmentMatcher = HeuristicFragmentMatcher;
  ...
  var IntrospectionFragmentMatcher = function () {
    ...
    IntrospectionFragmentMatcher.prototype.match = function (idValue, typeCondition, context) {
      process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)(this.isReady, 10) : (0, _tsInvariant.invariant)(this.isReady, 'FragmentMatcher.match() was called before FragmentMatcher.init()');
      var obj = context.store.get(idValue.id);
      var isRootQuery = idValue.id === 'ROOT_QUERY';
      ...
      process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)(__typename, 11) : (0, _tsInvariant.invariant)(__typename, "Cannot match fragment because __typename property is missing: " + JSON.stringify(obj));
  ...
  _exports.IntrospectionFragmentMatcher = IntrospectionFragmentMatcher;
    ...
    StoreReader.prototype.diffQueryAgainstStore = function (_a) {
      ...
      if (hasMissingFields && !returnPartialData) {
        execResult.missing.forEach(function (info) {
          ...
          throw process.env.NODE_ENV === "production" ? new _tsInvariant.InvariantError(2) : new _tsInvariant.InvariantError("Can't find field " + info.fieldName + " on object " + JSON.stringify(info.object, null, 2) + ".");
        });
      }
      ...
      selectionSet.selections.forEach(function (selection) {
        ...
        if ((0, _apolloUtilities.isField)(selection)) {
          ...
          if ((0, _apolloUtilities.isInlineFragment)(selection)) {
            ...
            if (!fragment) {
              throw process.env.NODE_ENV === "production" ? new _tsInvariant.InvariantError(3) : new _tsInvariant.InvariantError("No fragment named " + selection.name.value);
            }
          }
  ...
  _exports.StoreReader = StoreReader;

  function assertSelectionSetForIdValue(field, value) {
    if (!field.selectionSet && (0, _apolloUtilities.isIdValue)(value)) {
      throw process.env.NODE_ENV === "production" ? new _tsInvariant.InvariantError(4) : new _tsInvariant.InvariantError("Missing selection set for object of type " + value.typename + " returned for query field " + field.name.value);
    }
  }
  ...
  function assertIdValue(idValue) {
    process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)((0, _apolloUtilities.isIdValue)(idValue), 5) : (0, _tsInvariant.invariant)((0, _apolloUtilities.isIdValue)(idValue), "Encountered a sub-selection on the query, but the store doesn't have an object reference. This should never happen during normal use unless you have custom code that is directly manipulating the store; please file an issue.");
  }
  ...
  _exports.ObjectCache = ObjectCache;
  ...
  _exports.WriteError = WriteError;
      ...
      selectionSet.selections.forEach(function (selection) {
        ...
        if ((0, _apolloUtilities.isField)(selection)) {
          ...
          if ((0, _apolloUtilities.isInlineFragment)(selection)) {
            ...
            fragment = (fragmentMap || {})[selection.name.value];
            process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)(fragment, 6) : (0, _tsInvariant.invariant)(fragment, "No fragment named " + selection.name.value + ".");
          }
    ...
    StoreWriter.prototype.writeFieldToStore = function (_a) {
      ...
      if (!field.selectionSet || value === null) {
        ...
        if (dataIdFromObject) {
          ...
          process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)(!semanticId || !isGeneratedId(semanticId), 7) : (0, _tsInvariant.invariant)(!semanticId || !isGeneratedId(semanticId), 'IDs returned by dataIdFromObject cannot begin with the "$" character.');
        ...
        if (escapedId !== storeValue && (0, _apolloUtilities.isIdValue)(escapedId)) {
          ...
          process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)(!generated || escapedId.generated || typenameChanged, 8) : (0, _tsInvariant.invariant)(!generated || escapedId.generated || typenameChanged, "Store error: the application attempted to write an object with no provided id but the store already contains an id of " + escapedId.id + " for this object. The selectionSet that was trying to be written is:\n" + JSON.stringify(field));
          process.env.NODE_ENV === "production" ? (0, _tsInvariant.invariant)(!hadTypename || hasTypename, 9) : (0, _tsInvariant.invariant)(!hadTypename || hasTypename, "Store error: the application attempted to write an object with no provided typename but the store already contains an object with typename of " + escapedId.typename + " for the object of id " + escapedId.id + ". The selectionSet that was trying to be written is:\n" + JSON.stringify(field));
  ...
  _exports.StoreWriter = StoreWriter;
  ...
  _exports.InMemoryCache = InMemoryCache;
});
