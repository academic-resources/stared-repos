...
describe("MediumEditor.selection TestCase", function () {
    ...
    describe("exportSelection", function () {
        it("should not export a position indicating the cursor is before an empty paragraph", function () {
            this.el.innerHTML =
                "<p><span>www.google.com</span></p><p><br /></p><p>Whatever</p>";
            placeCursorInsideElement(this.el.querySelector("span"), 1); // end of first span
            var exportedSelection = MediumEditor.selection.exportSelection(
                this.el,
                document
            );
        ...
        it("should export a position indicating the cursor is at the beginning of a paragraph", function () {
            this.el.innerHTML =
                "<p><span>www.google.com</span></p><p><b>Whatever</b></p>";
        ...
        it("should not export a position indicating the cursor is after an empty paragraph", function () {
            this.el.innerHTML =
                "<p><span>www.google.com</span></p><p><br /></p>" +
                '<p class="target">Whatever</p>';
            // After the 'W' in whatever
            placeCursorInsideElement(
                this.el.querySelector("p.target").firstChild,
                1
            );
            var exportedSelection = MediumEditor.selection.exportSelection(
                this.el,
        ...
        it("should not export a position indicating the cursor is after an empty paragraph (in a complicated markup case)", function () {
            this.el.innerHTML =
                "<p><span>www.google.com</span></p><p><br /></p>" +
                '<p>What<span class="target">ever</span></p>';
            // Before the 'e' in whatever
            placeCursorInsideElement(
                this.el.querySelector("span.target").firstChild,
                0
            );
            var exportedSelection = MediumEditor.selection.exportSelection(
                this.el,
        ...
        it(
            "should not export a position indicating the cursor is after an empty paragraph " +
                "(in a complicated markup with selection on the element)",
            function () {
                this.el.innerHTML =
                    "<p><span>www.google.com</span></p><p><br /></p>" +
                    '<p>What<span class="target">ever</span></p>';
                // Before the 'e' in whatever
                placeCursorInsideElement(
                    this.el.querySelector("span.target"),
                    0
                );
                var exportedSelection = MediumEditor.selection.exportSelection(
                    this.el,
        ...
        it("should export a position indicating the cursor is after an empty block element", function () {
            this.el.innerHTML =
                "<p><span>www.google.com</span></p><h1><br /></h1><h2><br /></h2><p>Whatever</p>";
        ...
        it("should export a selection that specifies an image is the selection", function () {
            this.el.innerHTML =
                '<p>lorem ipsum <a href="#"><img src="../demo/img/medium-editor.jpg" /></a> dolor</p>';
        ...
        it("should export a selection that can be imported when the selection starts with an image", function () {
            this.el.innerHTML =
                '<p>lorem ipsum <a href="#"><img src="../demo/img/medium-editor.jpg" />img</a> dolor</p>';
            selectElementContents(this.el.querySelector("a"));
            var exportedSelection = MediumEditor.selection.exportSelection(
                this.el,
                document
            ...
            if (range.startContainer.nodeName.toLowerCase() === "a") {
                ...
                expect(range.startContainer.nextSibling).toBe(
        ...
        it("should export a selection that specifies an image is at the end of a selection", function () {
            this.el.innerHTML =
                '<p>lorem ipsum <a href="#">img<b><img src="../demo/img/medium-editor.jpg" /><img src="../demo/img/roman.jpg" /></b></a> dolor</p>';
            selectElementContents(this.el.querySelector("a"));
            var exportedSelection = MediumEditor.selection.exportSelection(
                this.el,
                document
    ...
    describe("importSelection", function () {
        it("should be able to import an exported selection", function () {
            ...
            expect(Object.keys(exportedSelection).sort()).toEqual([
                "end",
                "start",
            ]);

            selectElementContents(this.el);
            expect(exportedSelection).not.toEqual(
                MediumEditor.selection.exportSelection(this.el, document)
            );
        ...
        it("should be able to import an exported selection that contain nodeTypes > 3", function (done) {
            this.el.innerHTML =
                "<div><p>stuff here <!-- comment nodeType is 8 --> additional stuff here </p></div>";
        ...
        it("should import an exported selection outside any anchor tag", function () {
            this.el.innerHTML =
                '<p id=1>Hello world: <a href="#">http://www.example.com</a></p><p id=2><br></p>';
            var link = this.el.getElementsByTagName("a")[0];

            placeCursorInsideElement(
                link.childNodes[0],
                link.childNodes[0].nodeValue.length
            );
            expect(
            ...
            if (!isSafari()) {
                expect(MediumEditor.util.isDescendant(link, node, true)).toBe(
                    false
                );
            }
        ...
        it("should import an exported non-collapsed selection after an empty paragraph", function () {
            this.el.innerHTML =
                '<p>This is <a href="#">a link</a></p><p><br/></p><p>not a link</p>';
            ...
            expect(
                range.startContainer === lastTextNode ||
                    range.startContainer === lastTextNode.parentNode
            ).toBe(true, "The selection is starting at the wrong element");
            expect(range.startOffset).toBe(
                0,
                "The start of the selection is not at the beginning of the text node"
            );
            expect(
                range.endContainer === lastTextNode ||
                    range.endContainer === lastTextNode.parentNode
            ).toBe(true, "The selection is ending at the wrong element");
            expect(range.endOffset).toBe(
                "not a link".length,
                "The end of the selection is not at the end of the text node"
            );
        });
        ...
        it("should import a position with the cursor in an empty paragraph", function () {
            ...
            var startParagraph = MediumEditor.util.getClosestTag(
                window.getSelection().getRangeAt(0).startContainer,
                "p"
            );
            expect(startParagraph).toBe(
                this.el.getElementsByTagName("p")[1],
                "empty paragraph"
            );
        });
        ...
        it("should import a position with the cursor after an empty paragraph", function () {
            ...
            expect(startParagraph).toBe(
                this.el.getElementsByTagName("p")[2],
                "paragraph after empty paragraph"
            );
        });
        ...
        it("should import a position with the cursor after an empty block element", function () {
            ...
            expect(startParagraph).toBe(
                ...
                "block element after empty block element"
            );
        });

        it("should import a position with the cursor after an empty block element when there are nested block elements", function () {
            this.el.innerHTML =
                "<blockquote><p><span>www.google.com</span></p></blockquote><h1><br /></h1><h2><br /></h2><p>Whatever</p>";
            MediumEditor.selection.importSelection(
                {
                    start: 14,
                    end: 14,
        ...
        it("should import a position with the cursor after an empty block element inside an element with various children", function () {
            this.el.innerHTML =
                "<p><span>www.google.com</span></p><h1><br /></h1><h2><br /></h2><p><b><i>Whatever</i></b></p>";
            MediumEditor.selection.importSelection(
                {
                    start: 14,
                    end: 14,
            ...
            var innerElement = window
                .getSelection()
                .getRangeAt(0).startContainer;
            expect(
                MediumEditor.util.isDescendant(
                    this.el.querySelector("i"),
                    innerElement,
                    true
                )
            ).toBe(
                true,
                "nested inline elment inside block element after empty block element"
            );
        });

        ["br", "img"].forEach(function (tagName) {
            it(
                "should not import a selection into focusing on the element '" +
                    tagName +
                    "' that cannot have children",
                function () {
                    this.el.innerHTML =
                        "<p>Hello</p><p><" + tagName + " /></p><p>World<p>";
                    MediumEditor.selection.importSelection(
                        {
                            start: 5,
                            end: 5,
                    ...
                    var innerElement = window
                        .getSelection()
                        .getRangeAt(0).startContainer;
                    expect(innerElement.nodeName.toLowerCase()).toBe(
                        "p",
                        "focused element nodeName"
                    );
                    expect(innerElement).toBe(
                        window.getSelection().getRangeAt(0).endContainer
                    );
                    expect(
                        innerElement.previousSibling.nodeName.toLowerCase()
                    ).toBe("p", "previous sibling name");
                    expect(
                        innerElement.nextSibling.nodeName.toLowerCase()
                    ).toBe("p", "next sibling name");
                }
            );
        });
        ...
        it("should not import a selection into focusing on an empty element in a table", function () {
            this.el.innerHTML =
                "<p>Hello</p><table><colgroup><col /></colgroup>" +
        ...
        it("should not import a selection beyond any block elements that have text, even when emptyBlocksIndex indicates it should ", function () {
            this.el.innerHTML =
                "<p><span>www.google.com</span></p><h1><br /></h1><h2>Not Empty</h2><p><b><i>Whatever</i></b></p>";
            ...
            expect(
                MediumEditor.util.isDescendant(
                    this.el.querySelectorAll("p")[1],
                    innerElement,
                    true
                )
            ).toBe(false, "moved selection beyond non-empty block element");
            expect(
                MediumEditor.util.isDescendant(
                    this.el.querySelector("h2"),
                    innerElement,
                ...
                true,
                "moved selection to element to incorrect block element"
            );
        });
        ...
        it("should support a selection correctly when space + newlines are separating block elements", function () {
            ...
            var selectionData = MediumEditor.selection.exportSelection(
                this.el,
                document
            );
            ...
            expect(range.toString()).toBe(
                "target",
                "The selection is around the wrong element"
            );
            expect(
                MediumEditor.util.isDescendant(
                    lastLi,
            ...
            ).toBe(true, "The start of the selection is invalid");
            expect(
                MediumEditor.util.isDescendant(lastLi, range.endContainer, true)
            ).toBe(true, "The end of the selection is invalid");
        });
        ...
        it("should support a selection that specifies an image is the selection", function () {
            ...
            ).toBe(true, "the image is not within the selection");
        });
        ...
        it("should support a selection that starts with an image", function () {
            this.el.innerHTML =
                '<p>lorem ipsum <a href="#"><img src="../demo/img/medium-editor.jpg" />img</a> dolor</p>';
            MediumEditor.selection.importSelection(
                { start: 12, end: 15, startsWithImage: true },
                this.el,
                document
            );
            var range = window.getSelection().getRangeAt(0);
        ...
        it("should support a selection that ends with an image", function () {
            this.el.innerHTML =
                '<p>lorem ipsum <a href="#">img<img src="../demo/img/medium-editor.jpg" /><img src="../demo/img/roman.jpg" /></a> dolor</p>';
            MediumEditor.selection.importSelection(
                { start: 12, end: 15, trailingImageCount: 2 },
                this.el,
                document
            );
            var range = window.getSelection().getRangeAt(0);
        ...
        it("should support a selection that is after white-space at the beginning of a paragraph", function () {
            this.el.innerHTML =
                '   <p>one two<br><a href="transindex.hu">three</a><br></p><p><a href="amazon.com">one</a> two three</p>';
            ...
            var exported = MediumEditor.selection.exportSelection(
                this.el,
                document
            );
    ...
    describe("getSelectedParentElement", function () {
        it("should return null on bad range", function () {
            expect(MediumEditor.selection.getSelectedParentElement(null)).toBe(
                null
            );
            expect(MediumEditor.selection.getSelectedParentElement(false)).toBe(
                null
            );
        });
        ...
        it("should select the document", function () {
            this.el.innerHTML =
                "<p>lorem <i>ipsum</i> dolor <span>hello</span> <b>you</b> </p>";
    ...
    describe("selectionContainsContent", function () {
        it("should return true for non-empty text", function () {
            ...
            expect(
                MediumEditor.selection.selectionContainsContent(document)
            ).toBe(true);
        });
        ...
        it("should return true for image with link selections", function () {
            this.el.innerHTML =
                '<p>this is <a href="#"><img src="../demo/img/medium-editor.jpg" /></a> image test</p>';
            selectElementContents(this.el.querySelector("a"));
