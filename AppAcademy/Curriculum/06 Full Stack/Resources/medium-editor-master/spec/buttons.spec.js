...
describe("Buttons TestCase", function () {
    ...
    beforeAll(function () {
        ...
        textarea.innerHTML =
            "Ignore me please, placed here to make create an image test pass in Gecko";
    ...
    describe("Button default config", function () {
        it("should be accesible via defaults property of the button prototype", function () {
            expect(
                MediumEditor.extensions.button.prototype.defaults["bold"]
            ).toBeTruthy();
            expect(
                MediumEditor.extensions.button.prototype.defaults["anchor"]
            ).toBeFalsy();
        });

        it("should be check-able via static Button.isBuiltInButton() method", function () {
            expect(MediumEditor.extensions.button.isBuiltInButton("bold")).toBe(
                true
            );
            expect(
                MediumEditor.extensions.button.isBuiltInButton("anchor")
            ).toBe(false);
        });
    });
    ...
    describe("Button constructor", function () {
        it("should accept a set of config options", function () {
            var italicConfig =
                    MediumEditor.extensions.button.prototype.defaults["italic"],
        ...
        it("should accept a built-in button name", function () {
            var italicButtonOne = new MediumEditor.extensions.button(
                    MediumEditor.extensions.button.prototype.defaults["italic"]
                ),
    ...
    describe("Button options", function () {
        it("should support overriding defaults", function () {
            ...
            expect(
                toolbar.getToolbarElement().querySelectorAll("button").length
            ).toBe(3);

            var button = toolbar
                    .getToolbarElement()
                    .querySelector(".medium-editor-action-h1"),
                buttonTwo = toolbar
                    .getToolbarElement()
                    .querySelector(".medium-editor-action-h2");
            ...
            expect(button.getAttribute("data-custom-attr")).toBe(
                "custom-value"
            );
            ...
            selectElementContentsAndFire(
                editor.elements[0].querySelector("h2").firstChild
            );
            expect(
                button.classList.contains("medium-editor-button-active")
            ).toBe(true);
            expect(
                buttonTwo.classList.contains("medium-editor-button-active")
            ).toBe(false);
            ...
            selectElementContentsAndFire(
                editor.elements[0].querySelector("h3"),
                { eventToFire: "mouseup" }
            );
            expect(
                button.classList.contains("medium-editor-button-active")
    ...
    describe("Buttons with various labels", function () {
        ...
        tempEl = document.createElement("div");
        tempEl.innerHTML =
            MediumEditor.extensions.anchor.prototype.contentDefault;
        ...
        tempEl.innerHTML =
            MediumEditor.extensions.fontSize.prototype.contentDefault;
        ...
        customLabels["fontsize"] =
            MediumEditor.extensions.fontSize.prototype.aria;
        customButtons.push({
            name: "fontsize",
        ...
        it("should have aria-label and title attributes set", function () {
            ...
            Object.keys(customLabels).forEach(function (buttonName) {
                button = toolbar
                    .getToolbarElement()
                    .querySelector(".medium-editor-action-" + buttonName);
                expect(button).not.toBeUndefined();
                expect(button.getAttribute("aria-label")).toBe(
                    customLabels[buttonName]
                );
    ...
    describe("AppendEl", function () {
        it("should call the document.execCommand method when button action is append", function () {
            ...
            button = toolbar
                .getToolbarElement()
                .querySelector('[data-action="append-h3"]');
            fireEvent(button, "click");
            if (isIE()) {
    ...
    describe("First and Last", function () {
        it("should add a special class to the first and last buttons", function () {
            ...
            expect(buttons[buttons.length - 1].className).toContain(
                "medium-editor-button-last"
            );
        });
    });
        ...
        it("button should be active for other cases when text is bold", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    ...
                    .querySelector('[data-action="bold"]');
            this.el.innerHTML =
                '<p><span id="bold-span" style="font-weight: bold">lorem ipsum</span></p>';
            ...
            expect(
                !isOldIE() &&
                    this.el.innerHTML !==
                        '<p><span id="bold-span">lorem ipsum</span></p>'
            ).toBe(false);
        });
    });
        ...
        it("button should be active for other cases when text is italic", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    ...
                    .querySelector('[data-action="italic"]');
            this.el.innerHTML =
                '<p><span id="italic-span" style="font-style: italic">lorem ipsum</span></p>';

            selectElementContentsAndFire(
                document.getElementById("italic-span")
            );
            expect(
                button.classList.contains("medium-editor-button-active")
            ).toBe(true);
            ...
            expect(
                !isOldIE() &&
                    this.el.innerHTML !==
                        '<p><span id="italic-span">lorem ipsum</span></p>'
            ).toBe(false);
        });
    });
        ...
        it("button should be active for other cases when text is underlined", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    ...
                    .querySelector('[data-action="underline"]');
            this.el.innerHTML =
                '<p><span id="underline-span" style="text-decoration: underline">lorem ipsum</span></p>';

            selectElementContentsAndFire(
                document.getElementById("underline-span")
            );
            expect(
                button.classList.contains("medium-editor-button-active")
            ).toBe(true);
            ...
            expect(
                !isOldIE() &&
                    this.el.innerHTML !==
                        '<p><span id="underline-span">lorem ipsum</span></p>'
            ).toBe(false);
        });
    });
    ...
    describe("Strikethrough", function () {
        it("button should be active if the selection already has the element", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="strikethrough"]');
        ...
        it("button should be active for other cases when text is strikethrough", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    ...
                    .querySelector('[data-action="strikethrough"]');
            this.el.innerHTML =
                '<p><span id="strike-span" style="text-decoration: line-through">lorem ipsum</span></p>';

            selectElementContentsAndFire(
                document.getElementById("strike-span")
            );
            expect(
                button.classList.contains("medium-editor-button-active")
            ).toBe(true);
            ...
            expect(
                !isOldIE() &&
                    this.el.innerHTML !==
                        '<p><span id="strike-span">lorem ipsum</span></p>'
            ).toBe(false);
        });
    });
    ...
    describe("Superscript", function () {
        it("button should be active if the selection already has the element", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="superscript"]');
    ...
    describe("Subscript", function () {
        it("button should be active if the selection already has the element", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="subscript"]');
    ...
    describe("Anchor", function () {
        it("button should be active if the selection already has the element", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="createLink"]');
            this.el.innerHTML =
                '<p><span id="span-lorem">lorem</span> <a href="#" id="link">ipsum</a></p>';
            ...
            selectElementContentsAndFire(
                document.getElementById("span-lorem"),
                { eventToFire: "mouseup" }
            );
            expect(
                button.classList.contains("medium-editor-button-active")
        ...
        it("button should call the anchorExtension.showForm() method", function () {
            ...
            fireEvent(button, "click");
            expect(
                editor.getExtensionByName("anchor").showForm
            ).toHaveBeenCalled();
        });
    });
    ...
    describe("Quote", function () {
        it("button should not be active if the selection is not inside a blockquote", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="append-blockquote"]');
    ...
    describe("Image", function () {
        it("should create an image", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="image"]');
            spyOn(document, "execCommand").and.callThrough();
            this.el.innerHTML =
                '<span id="span-image">http://i.imgur.com/twlXfUq.jpg  \n\n</span>';

            selectElementContentsAndFire(document.getElementById("span-image"));

            fireEvent(button, "click");

            expect(this.el.innerHTML).toContain(
                '<img src="http://i.imgur.com/twlXfUq.jpg">'
            );
            expect(document.execCommand).toHaveBeenCalledWith(
                "insertImage",
                false,
                "http://i.imgur.com/twlXfUq.jpg"
            );
        });
    });
    ...
    describe("Html", function () {
        it("should create an evaluated html tag", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="html"]');
            spyOn(document, "execCommand").and.callThrough();
            this.el.innerHTML =
                '<span id="span-html">&lt;iframe width="854" height="480" src="https://www.youtube.com/embed/QHH3iSeDBLo" frameborder="0" allowfullscreen&gt;&lt;/iframe&gt;  \n\n</span>';
            ...
            expect(this.el.innerHTML).toMatch(
                /<iframe(?: width="854"| height="480"| src="https:\/\/www.youtube.com\/embed\/QHH3iSeDBLo"| frameborder="0"| allowfullscreen=""){5}>(<br>)?<\/iframe>/gi
            );
        });
    });
    ...
    describe("OrderedList", function () {
        it("button should be active if the selection already has the element", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="insertorderedlist"]');
            ...
            expect(
                toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="insertunorderedlist"]')
                    .classList.contains("medium-editor-button-active")
            ).toBe(false);
    ...
    describe("Pre", function () {
        it("button should be active if the selection already has the element", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="append-pre"]');
            this.el.innerHTML =
                '<pre><span id="span-lorem">lorem ipsum</span></pre>';
    ...
    describe("Justify", function () {
        it("button should be activated based on text-align values", function () {
            this.el.innerHTML =
                '<div><p id="justify-para-one">lorem ipsum</p></div>';
            ...
            try {
                var editor = this.newMediumEditor(".editor", {
                    ...
                    rightButton = toolbar
                        .getToolbarElement()
                        .querySelector('[data-action="justifyRight"]'),
                    centerButton = toolbar
                        .getToolbarElement()
                        .querySelector('[data-action="justifyCenter"]');

                selectElementContentsAndFire(
                    document.getElementById("justify-para-one")
                );
                expect(
                ...
                expect(
                    centerButton.classList.contains(
                        "medium-editor-button-active"
                    )
                ).toBe(true);
        ...
        it("buttons should deactivate other justify buttons", function () {
            this.el.innerHTML =
                '<p id="justify-para-one">lorem ipsum</p>' +
            ...
            var editor = this.newMediumEditor(".editor", {
                ...
                leftButton = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="justifyLeft"]'),
                rightButton = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="justifyRight"]'),
                centerButton = toolbar
                ...
                fullButton = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="justifyFull"]');
            ...
            expect(
                rightButton.classList.contains("medium-editor-button-active")
            ).toBe(false);
            expect(
                centerButton.classList.contains("medium-editor-button-active")
            ).toBe(false);
            expect(
                fullButton.classList.contains("medium-editor-button-active")
            ).toBe(false);

            // Trigger justify full, only it should be active
            fireEvent(fullButton, "click");
            expect(
                leftButton.classList.contains("medium-editor-button-active")
            ).toBe(false);
            expect(
                rightButton.classList.contains("medium-editor-button-active")
            ).toBe(false);
            ...
            selectElementContentsAndFire(
                document.getElementById("justify-para-two"),
                { eventToFire: "mouseup" }
            );
            expect(
                leftButton.classList.contains("medium-editor-button-active")
            ...
            selectElementContentsAndFire(
                document.getElementById("justify-para-three"),
                { eventToFire: "mouseup" }
            );
            expect(
                leftButton.classList.contains("medium-editor-button-active")
            ...
            selectElementContentsAndFire(
                document.getElementById("justify-para-four"),
                { eventToFire: "mouseup" }
            );
            expect(
                leftButton.classList.contains("medium-editor-button-active")
            ...
            selectElementContentsAndFire(
                document.getElementById("justify-para-five"),
                { eventToFire: "mouseup" }
            );
            expect(
                leftButton.classList.contains("medium-editor-button-active")
    ...
    describe("Remove Formatting", function () {
        it("should unwrap basic things", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                button = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="removeFormat"]');

            expect(button).toBeTruthy();
            this.el.innerHTML =
                "<p>foo<b>bar</b><i>baz</i><strong>bam</strong></p>";
            ...
            this.el.innerHTML =
                "<div><p><b>foo</b></p><p><i>bar</i></p><ul><li>on<b>e</b></li></ul></div>";
            selectElementContentsAndFire(
                editor.elements[0].querySelector("div")
            );
            fireEvent(button, "click");
            expect(this.el.innerHTML).toBe(
                "<div><p>foo</p><p>bar</p><ul><li>one</li></ul></div>"
            );

            // TODO: IE does not unwrap something like <p><span style='color:red'>bar</span></p>
            this.el.innerHTML =
                "<div><h2>b<i>a</i>r</h2><p><em><strong><u><sub><sup>foo</sup></sub></u></strong></em></p><pre>foo<i>bar</i>baz</pre></div>";
            selectElementContentsAndFire(
                editor.elements[0].querySelector("div")
            );
            fireEvent(button, "click");
            expect(this.el.innerHTML).toBe(
                "<div><h2>bar</h2><p>foo</p><pre>foobarbaz</pre></div>"
            );
        });
    });
    ...
    describe("Header", function () {
        it("buttons should be active if the selection already has the element", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                buttonTwo = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="append-h4"]');

            this.el.innerHTML = "<h2>lorem</h2><h3>ipsum</h3><h4>dolor</h4>";
            selectElementContentsAndFire(
                editor.elements[0].querySelector("h2")
            );
            expect(
                buttonOne.classList.contains("medium-editor-button-active")
            ).toBe(false);
            expect(
                buttonTwo.classList.contains("medium-editor-button-active")
            ).toBe(false);
            ...
            selectElementContentsAndFire(
                editor.elements[0].querySelector("h4"),
                { eventToFire: "mouseup" }
            );
            expect(
                buttonOne.classList.contains("medium-editor-button-active")
        ...
        it("buttons should be active if the selection already custom defined element types", function () {
            var editor = this.newMediumEditor(".editor", {
                ...
                buttonOne = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="append-h1"]'),
                buttonTwo = toolbar
                    .getToolbarElement()
                    .querySelector('[data-action="append-h5"]');
            ...
            selectElementContentsAndFire(
                editor.elements[0].querySelector("h1")
            );
            expect(
                buttonOne.classList.contains("medium-editor-button-active")
            ).toBe(true);
            ...
            selectElementContentsAndFire(
                editor.elements[0].querySelector("h5"),
                { eventToFire: "mouseup" }
            );
            expect(
                buttonOne.classList.contains("medium-editor-button-active")
