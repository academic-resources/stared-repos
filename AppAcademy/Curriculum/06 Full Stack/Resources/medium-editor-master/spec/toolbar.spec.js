...
describe("MediumEditor.extensions.toolbar TestCase", function () {
    ...
    describe("Initialization", function () {
        ...
        it("should create a new element for the editor toolbar", function () {
            expect(
                document.querySelectorAll(".medium-editor-toolbar").length
            ).toBe(0);
            var editor = this.newMediumEditor(".editor"),
                toolbar = editor
                    .getExtensionByName("toolbar")
                    .getToolbarElement();
        ...
        it("should not create an anchor form element or anchor extension if anchor is not passed as a button", function () {
            expect(
                document.querySelectorAll(".medium-editor-toolbar-form-anchor")
                    .length
            ).toBe(0);
            var editor = this.newMediumEditor(".editor", {
                    toolbar: {
            ...
            expect(
                toolbar
                    .getToolbarElement()
                    .querySelectorAll(".medium-editor-toolbar-form-anchor")
                    .length
            ).toBe(0);
    ...
    describe("Toolbars", function () {
        it("should enable bold button in toolbar when bold text is selected", function () {
            var editor = null,
                newElement = this.createElement(
                    "div",
                    "",
                    'lorem ipsum <b><div id="bold_dolorOne">dolor</div></b>'
                );

            newElement.id = "editor-for-toolbar-test";

            editor = this.newMediumEditor(
                document.getElementById("editor-for-toolbar-test"),
                { delay: 0 }
            );
            var toolbar = editor.getExtensionByName("toolbar");
            selectElementContentsAndFire(
                document.getElementById("bold_dolorOne")
            );
        ...
        it("should not activate buttons in toolbar when stopSelectionUpdates has been called, but should activate buttons after startSelectionUpdates is called", function () {
            this.el.innerHTML =
                'lorem ipsum <b><div id="bold_dolorTwo">dolor</div></b>';

            var editor = this.newMediumEditor(
            ...
            selectElementContentsAndFire(
                document.getElementById("bold_dolorTwo")
            );
            expect(
                toolbar
                    .getToolbarElement()
        ...
        it("should not hide when selecting a link containing only an image", function () {
            this.el.innerHTML =
                '<p>Here is an <a href="#"><img src="../demo/img/medium-editor.jpg"></a> image</p>';
            var editor = this.newMediumEditor(".editor"),
                toolbar = editor.getExtensionByName("toolbar");
        ...
        it("should hide when clicking outside the toolbar on an element that does not clear selection", function () {
            this.el.innerHTML = "lorem ipsum";
            var outsideElement = this.createElement(
                    "div",
                    "",
                    "Click Me, I don't clear selection"
                ),
                editor = this.newMediumEditor(".editor"),
                toolbar = editor.getExtensionByName("toolbar");
        ...
        it("should hide when selecting multiple paragraphs and the allowMultiParagraphSelection option is false", function () {
            this.el.innerHTML =
                '<p id="p-one">lorem ipsum</p><p id="p-two">lorem ipsum</p>';
            var editor = this.newMediumEditor(".editor", {
                    toolbar: {
        ...
        it("should hide if selection is empty", function () {
            ...
            toolbar
                .getToolbarElement()
                .classList.add("medium-editor-toolbar-active");
            expect(
                toolbar
                    .getToolbarElement()
                    .classList.contains("medium-editor-toolbar-active")
        ...
        it("should correctly update position even if elementsContainer is absolute", function () {
            ...
            selectElementContentsAndFire(this.el);
            expect(
                toolbar.classList.contains("medium-editor-toolbar-active")
            ).toBe(true);
    ...
    describe("Static Toolbars", function () {
        it("should let the user click outside of the selected area to leave", function () {
            this.el.innerHTML =
                "This is my text<span>and this is some other text</span>";
            var editor = this.newMediumEditor(".editor", {
                    toolbar: {
                        static: true,
            ...
            expect(
                this.el.getAttribute("medium-editor-focused")
            ).not.toBeTruthy();
        });
        ...
        it("should be hidden for one medium-editor instance when another medium-editor instance shows its toolbar", function () {
            var editorOne,
                editorTwo,
                elTwo = this.createElement(
                    "div",
                    "",
                    '<span id="editor-span-2">lorem ipsum</span>'
                );
            ...
            editorTwo = this.newMediumEditor(
                document.getElementById("editor-div-two"),
                {
                    toolbar: {
                        static: true,
                    },
        ...
        it("should update button states when updateOnEmptySelection is true and the selection is empty", function () {
            ...
            expect(
                editor.getExtensionByName("toolbar").setToolbarButtonStates
            ).toHaveBeenCalled();
        });
    });
    ...
    describe("Disable", function () {
        it("should not show the toolbar on elements when toolbar option is set to false", function () {
            ...
            expect(
                document.getElementsByClassName("medium-editor-toolbar-actions")
                    .length
            ).toBe(0);
        });
        ...
        it('should not display toolbar when selected text within an element with contenteditable="false"', function () {
            ...
            this.el.innerHTML =
                'lorem ipsum <div id="cef_el" contenteditable="false">dolor</div>';
    ...
    describe("Resizing", function () {
        ...
        it("should reset toolbar position", function () {
            ...
            selectElementContentsAndFire(editor.elements[0]);
            expect(
                toolbar.getToolbarElement().className.indexOf("active")
            ).toBeGreaterThan(-1);
    ...
    describe("Relative Toolbars", function () {
        it("should contain relative toolbar class", function () {
            ...
            expect(
                toolbar
                    .getToolbarElement()
                    .classList.contains("medium-editor-relative-toolbar")
            ).toBe(true);
        });
        ...
        it("should be included in relative node", function () {
            ...
            var editor = this.newMediumEditor(".editor", {
                ...
                toolbarHTML = editor
                    .getExtensionByName("toolbar")
                    .getToolbarElement().outerHTML;

            expect(document.getElementById("someRelativeDiv").innerHTML).toBe(
                toolbarHTML
            );
        });
    });
