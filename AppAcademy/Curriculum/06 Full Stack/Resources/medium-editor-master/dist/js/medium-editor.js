    ...
    (function () {
        ...
        (function (window) {
                    ...
                    if (source) {
                        for (prop in source) {
                            if (
                                ...
                                (overwrite ||
                                    dest.hasOwnProperty(prop) === false)
                            ) {
            ...
            var Util = {
                    ...
                    for (var i = 0; i < element.childNodes.length; i++) {
                        ...
                        if (child.nodeType === 3) {
                            ...
                            if (blockElements.length === 0) {
                                ...
                                toRet = toRet.concat(
                                    MediumEditor.util.splitByBlockElements(
                                        child
                                    )
                                );
                            }
                ...
                isDescendant: function isDescendant(
                    ...
                    if (
                        nodeContainsWorksWithTextNodes ||
                        child.nodeType !== 3
                    ) {
                ...
                setTargetBlank: function (el, anchorUrl) {
                    ...
                    if (el.nodeName.toLowerCase() === "a") {
                        ...
                        for (i = 0; i < el.length; i += 1) {
                            if (
                                false === url ||
                                url === el[i].attributes.href.value
                            ) {
                                el[i].target = "_blank";
                ...
                isListItem: function (node) {
                    ...
                    while (
                        tagName === "li" ||
                        (!Util.isBlockContainer(parentNode) &&
                            tagName !== "div")
                    ) {
                        if (tagName === "li") {
                            return true;
                        ...
                        while (targetNode) {
                            ...
                            if (targetNode === splitOnNode) {
                                if (!targetNode.hasChildNodes()) {
                                    targetNode.parentNode.removeChild(
                                        targetNode
                                    );
                                } else {
                ...
                moveTextRangeIntoElement: function (
                    ...
                    var afterLast = lastChild.nextSibling,
                        fragment =
                            rootNode.ownerDocument.createDocumentFragment();
                ...
                getTopBlockContainer: function (element) {
                    var topBlock = Util.isBlockContainer(element)
                        ? element
                        : false;
                ...
                _getFirstTextNode: function (element) {
                    ...
                    for (var i = 0; i < element.childNodes.length; i++) {
                        var textNode = Util._getFirstTextNode(
        ...
        (function () {
            ...
            var Selection = {
                findMatchingSelectionParent: function (
                    ...
                    return MediumEditor.util.traverseUp(
                        current,
                        testElementFunction
                    );
                },
                        ...
                        if (node.nodeType === 3 && !foundEnd) {
                            ...
                            if (selectionState.trailingImageCount && foundEnd) {
                                ...
                                if (
                                    ...
                                    var endIndex = 0;
                                    while (
                                        node.parentNode.childNodes[endIndex] !==
                                        node
                                    ) {
                                        endIndex++;
                                    }
                ...
                importSelectionMoveCursorPastBlocks: function (
                    ...
                    range.setStart(
                        MediumEditor.util.getFirstSelectableLeafNode(
                            targetNode
                        ),
                        0
                    );
                ...
                getIndexRelativeToAdjacentEmptyBlocks: function (
                    ...
                    if (
                        cursorContainer.textContent.length > 0 &&
                        cursorOffset > 0
                    ) {
                        return -1;
                    }
                    ...
                    if (node) {
                        ...
                        if (
                            !MediumEditor.util.isElementAtBeginningOfBlock(node)
                        ) {
                            return -1;
                        }
                ...
                selectionInContentEditableFalse: function (contentWindow) {
                    ...
                    var sawtrue,
                        sawfalse = this.findMatchingSelectionParent(function (
                            el
                        ) {
                ...
                getSelectedParentElement: function (range) {
                    ...
                    if (
                        ...
                        return range.startContainer.childNodes[
                            range.startOffset
                        ];
                    }
        ...
        (function () {
            ...
            function isElementDescendantOfExtension(extensions, element) {
                ...
                return extensions.some(function (extension) {
                    if (
                        typeof extension.getInteractionElements !== "function"
                    ) {
                        return false;
                    }
            ...
            Events.prototype = {
                InputEventOnContenteditableSupported:
                    !MediumEditor.util.isIE && !MediumEditor.util.isEdge,
                ...
                attachDOMEvent: function (
                    ...
                    targets =
                        MediumEditor.util.isElement(targets) ||
                        [win, doc].indexOf(targets) > -1
                            ? [targets]
                            : targets;
                ...
                indexOfCustomListener: function (event, listener) {
                    if (
                        !this.customEvents[event] ||
                        !this.customEvents[event].length
                    ) {
                        return -1;
                    }
                ...
                detachExecCommand: function () {
                    ...
                    var index = doc.execCommand.listeners.indexOf(
                        this.execCommandListener
                    );
                    if (index !== -1) {
                ...
                wrapExecCommand: function () {
                    ...
                    var callListeners = function (args, result) {
                            if (doc.execCommand.listeners) {
                                doc.execCommand.listeners.forEach(function (
                                    listener
                                ) {
                                    listener({
                                        command: args[0],
                        ...
                        // 3) Return the result
                        wrapper = function () {
                            var result = doc.execCommand.orig.apply(
                                this,
                                arguments
                            );
                        ...
                        case "editableInput":
                            ...
                            if (!this.InputEventOnContenteditableSupported) {
                                ...
                                this.attachDOMEvent(
                                    document,
                                    "selectionchange",
                                    this.handleDocumentSelectionChange.bind(
                                        this
                                    )
                                );
                ...
                updateFocus: function (target, eventObj) {
                    ...
                    if (
                        ...
                        (MediumEditor.util.isDescendant(
                            ...
                            isElementDescendantOfExtension(
                ...
                handleKeydown: function (event) {
                    ...
                    if (
                        ...
                        return this.triggerCustomEvent(
        ...
        (function () {
            ...
            var Button = MediumEditor.Extension.extend({
                ...
                init: function () {
                    MediumEditor.Extension.prototype.init.apply(
                        this,
                        arguments
                    );
                ...
                queryCommandState: function () {
                    ...
                    if (this.useQueryState) {
                        queryState = this.base.queryCommandState(
                            this.getAction()
                        );
                    }
                    return queryState;
                ...
                isAlreadyApplied: function (node) {
                    ...
                    if (tagNames && tagNames.length > 0) {
                        isMatch =
                            tagNames.indexOf(node.nodeName.toLowerCase()) !==
                            -1;
                    }
                    ...
                    if (!isMatch && this.style) {
                        ...
                        styleVals.forEach(function (val) {
                            if (!this.knownState) {
                                ...
                                if (
                                    isMatch ||
                                    this.style.prop !== "text-decoration"
                                ) {
        ...
        (function () {
            ...
            var FormExtension = MediumEditor.extensions.button.extend({
                ...
                isDisplayed: function () {
                    if (this.hasForm) {
                        return this.getForm().classList.contains(
                            this.activeClass
                        );
                    }
                    return false;
        ...
        (function () {
            ...
            var AnchorForm = MediumEditor.extensions.form.extend({
                ...
                init: function () {
                    MediumEditor.extensions.form.prototype.init.apply(
                        this,
                        arguments
                    );
                ...
                handleClick: function (event) {
                    ...
                    var range = MediumEditor.selection.getSelectionRange(
                        this.document
                    );
                    ...
                    if (
                        ...
                        MediumEditor.util.getClosestTag(
                            MediumEditor.selection.getSelectedParentElement(
                                range
                            ),
                            "a"
                        )
        ...
        (function () {
            ...
            var AnchorPreview = MediumEditor.Extension.extend({
                    ...
                    if (anchorExtension && activeAnchor) {
                        ...
                        this.base.delay(
                            function () {
                                if (activeAnchor) {
                                    var opts = {
                                        value: activeAnchor.attributes.href
                                            .value,
                                        target: activeAnchor.getAttribute(
                                            "target"
                                        ),
                                        buttonClass:
                                            activeAnchor.getAttribute("class"),
                                    };
                ...
                handleEditableMouseover: function (event) {
                    var target = MediumEditor.util.getClosestTag(
                        event.target,
                        "a"
                    );
        ...
        (function () {
            ...
            var AutoLink = MediumEditor.Extension.extend({
                ...
                isLastInstance: function () {
                    ...
                    for (
                        var i = 0;
                        i < this.window._mediumEditors.length;
                        i++
                    ) {
                        var editor = this.window._mediumEditors[i];
                        if (
                            editor !== null &&
                            editor.getExtensionByName("autoLink") !== undefined
                        ) {
                            activeInstances++;
                        }
                    }
            ...
            */
                    ...
                    for (var i = 0; i < blockElements.length; i++) {
                        documentModified =
                            this.removeObsoleteAutoLinkSpans(
                                blockElements[i]
                            ) || documentModified;
                        documentModified =
                            this.performLinkingWithinElement(
                                blockElements[i]
                            ) || documentModified;
                    }
                ...
                removeObsoleteAutoLinkSpans: function (element) {
                    ...
                    var spans = element.querySelectorAll(
                    ...
                    for (var i = 0; i < spans.length; i++) {
                        ...
                        if (textContent.indexOf("://") === -1) {
                            textContent =
                                MediumEditor.util.ensureUrlHasProtocol(
                                    textContent
                                );
                        }
                        if (
                            spans[i].getAttribute("data-href") !==
                                textContent &&
                            nodeIsNotInsideAnchorTag(spans[i])
                        ) {
                            documentModified = true;
                            var trimmedTextContent = textContent.replace(
                                /\s+$/,
                                ""
                            );
                            if (
                                ...
                                var charactersTrimmed =
                                        textContent.length -
                                        trimmedTextContent.length,
                                    subtree = MediumEditor.util.splitOffDOMTree(
                                        spans[i],
                                        this.splitTextBeforeEnd(
                                            spans[i],
                                            charactersTrimmed
                                        )
                                    );
                                spans[i].parentNode.insertBefore(
                                    subtree,
                                    spans[i].nextSibling
                                );
                            } else {
                ...
                splitTextBeforeEnd: function (element, characterCount) {
                    var treeWalker = this.document.createTreeWalker(
                            element,
                            NodeFilter.SHOW_TEXT,
                            null,
                            false
                    ...
                    while (characterCount > 0 && previousNode !== null) {
                        ...
                        if (currentNodeValue.length > characterCount) {
                            previousNode = currentNode.splitText(
                                currentNodeValue.length - characterCount
                            );
                            characterCount = 0;
                        } else {
                ...
                shouldNotLink: function (textNodes) {
                    ...
                    for (
                        var i = 0;
                        i < textNodes.length && shouldNotLink === false;
                        i++
                    ) {
                        // Do not link if the text node is either inside an anchor or inside span[data-auto-link]
                        shouldNotLink = !!MediumEditor.util.traverseUp(
                            textNodes[i],
                            function (node) {
                                return (
                                    node.nodeName.toLowerCase() === "a" ||
                                    (node.getAttribute &&
                                        node.getAttribute("data-auto-link") ===
                                            "true")
                                );
                            }
                        );
                ...
                findLinkableText: function (contenteditable) {
                    ...
                    while ((match = LINK_REGEXP.exec(textContent)) !== null) {
                        ...
                        matchOk =
                            (match.index === 0 ||
                                WHITESPACE_CHARS.indexOf(
                                    textContent[match.index - 1]
                                ) !== -1) &&
                            (matchEnd === textContent.length ||
                                WHITESPACE_CHARS.indexOf(
                                    textContent[matchEnd]
                                ) !== -1);
                        // If the regexp detected a bare domain that doesn't use one of our expected TLDs, bail out.
                        matchOk =
                            matchOk &&
                            (match[0].indexOf("/") !== -1 ||
                                KNOWN_TLDS_REGEXP.test(
                                    match[0].split(".").pop().split("?").shift()
                                ));
        ...
        (function () {
            ...
            function clearClassNames(element) {
                var editable =
                        MediumEditor.util.getContainerEditorElement(element),
                    existing = Array.prototype.slice.call(
                        editable.parentElement.querySelectorAll(
                            "." + CLASS_DRAG_OVER
                        )
                    );
            ...
            var FontNameForm = MediumEditor.extensions.form.extend({
                ...
                handleClick: function (event) {
                    ...
                    if (!this.isDisplayed()) {
                        ...
                        var fontName =
                            this.document.queryCommandValue("fontName") + "";
            ...
            var FontSizeForm = MediumEditor.extensions.form.extend({
                ...
                handleClick: function (event) {
                    ...
                    if (!this.isDisplayed()) {
                        ...
                        var fontSize =
                            this.document.queryCommandValue("fontSize") + "";
    ...
    */
            ...
            var PasteHandler = MediumEditor.Extension.extend({
                ...
                doPaste: function (pastedHTML, pastedPlain, editable) {
                    ...
                    if (
                        !(
                            ...
                            (editable &&
                                editable.getAttribute("data-disable-return"))
                        )
                    ) {
                        ...
                        if (paragraphs.length > 1) {
                            for (p = 0; p < paragraphs.length; p += 1) {
                                if (paragraphs[p] !== "") {
                                    html +=
                                        "<p>" +
                                        MediumEditor.util.htmlEntities(
                                            paragraphs[p]
                                        ) +
                                        "</p>";
                                }
                ...
                createPasteBin: function (editable) {
                    var rects,
                        range = MediumEditor.selection.getSelectionRange(
                            this.document
                        ),
                        top = this.window.pageYOffset;
                ...
                removePasteBin: function () {
                    if (null !== lastRange) {
                        MediumEditor.selection.selectRange(
                            this.document,
                            lastRange
                        );
                        lastRange = null;
                ...
                getPasteBinHtml: function () {
                    ...
                    if (
                        !pasteBinHtml ||
                        pasteBinHtml === pasteBinDefaultContent
                    ) {
                        return false;
                    }
                ...
                pasteHTML: function (html, options) {
                    ...
                    for (i = 0; i < elList.length; i += 1) {
                        ...
                        MediumEditor.util.cleanupAttrs(
                            workEl,
                            options.cleanAttrs
                        );
                        MediumEditor.util.cleanupTags(
                            workEl,
                            options.cleanTags
                        );
                        MediumEditor.util.unwrapTags(
                            workEl,
                            options.unwrapTags
                        );
                    }
        ...
        (function () {
            ...
            var Placeholder = MediumEditor.Extension.extend({
                ...
                handleInput: function (event, element) {
                    ...
                    var dontShow =
                        this.hideOnClick &&
                        element === this.base.getFocusedElement();
            ...
            var Toolbar = MediumEditor.Extension.extend({
                ...
                createToolbarButtons: function () {
                    ...
                    this.buttons.forEach(function (button) {
                        ...
                        if (
                            extension &&
                            typeof extension.getButton === "function"
                        ) {
                    ...
                    if (buttons.length > 0) {
                        ...
                        buttons[buttons.length - 1].classList.add(
                ...
                multipleBlockElementsSelected: function () {
                    var regexEmptyHTMLTags = /<[^\/>][^>]*><\/[^>]+>/gim, // http://stackoverflow.com/questions/3129738/remove-empty-tags-using-regex
                        ...
                        hasMultiParagraphs =
                            selectionHTML.match(regexBlockElements); // Find how many block elements are within the html

                    return (
                        !!hasMultiParagraphs && hasMultiParagraphs.length > 1
                    );
                },
                ...
                checkState: function () {
                    ...
                    if (
                        !selectionElement ||
                        this.getEditorElements().indexOf(selectionElement) ===
                            -1 ||
                ...
                checkActiveButtons: function () {
                    var manualStateChecks = [],
                        ...
                        updateExtensionState = function (extension) {
                            if (typeof extension.checkState === "function") {
                                ...
                                typeof extension.isActive === "function" &&
                                typeof extension.isAlreadyApplied ===
                                    "function" &&
                    ...
                    while (parentNode) {
                        ...
                        if (
                            MediumEditor.util.isMediumEditorElement(parentNode)
                        ) {
                            break;
                        }
                        parentNode = parentNode.parentNode;
                ...
                positionToolbar: function (selection) {
                    ...
                    if (boundary.top < buttonHeight) {
                        ...
                        positions.top +=
                            buttonHeight + boundary.height - this.diffTop;
                    } else {
                        toolbarElement.classList.add(
                            "medium-toolbar-arrow-under"
                        );
        ...
        (function () {
            ...
            function handleDisableExtraSpaces(event) {
                var node = MediumEditor.selection.getSelectionStart(
                    ...
                    caretPositions =
                        MediumEditor.selection.getCaretOffsets(node);
            ...
            function handleBlockDeleteKeydowns(event) {
                ...
                if (
                    ...
                    if (
                        ...
                        p.innerHTML = "<br>";
                        node.previousElementSibling.parentNode.insertBefore(
                            p,
                            node
                        );
                        event.preventDefault();
                    ...
                    isHeader.test(
                        node.nextElementSibling.nodeName.toLowerCase()
                    )
                ) {
                    ...
                    MediumEditor.util.getClosestTag(node, "blockquote") !==
                        false &&
                    MediumEditor.selection.getCaretOffsets(node).left === 0
                ) {
                    ...
                    event.preventDefault();
                    MediumEditor.util.execFormatBlock(
                        this.options.ownerDocument,
                        "p"
                    );
                } else if (
                    ...
                    MediumEditor.util.isMediumEditorElement(
                        node.parentElement
                    ) &&
                    !node.previousElementSibling &&
                    node.nextElementSibling &&
                ...
                if (textarea.form) {
                    this.on(
                        ...
                        function (event) {
                            if (!event.defaultPrevented) {
                                this.resetContent(
                                    this.options.ownerDocument.getElementById(
                                        uniqueId
                                    )
                                );
                            }
                    ...
                    childDivs.forEach(function (div) {
                        if (div.style.textAlign === textAlign) {
                            ...
                            if (lastChild) {
                                ...
                                var br =
                                    this.options.ownerDocument.createElement(
                                        "BR"
                                    );
            ...
            MediumEditor.prototype = {
                ...
                addBuiltInExtension: function (name, opts) {
                    ...
                    switch (name) {
                        case "anchor":
                            ...
                            extension = new MediumEditor.extensions.anchor(
                                merged
                            );
                            break;
                        case "anchor-preview":
                            extension =
                                new MediumEditor.extensions.anchorPreview(
                        ...
                        case "fileDragging":
                            extension =
                                new MediumEditor.extensions.fileDragging(opts);
                            break;
                        case "fontname":
                        ...
                        case "keyboardCommands":
                            extension =
                                new MediumEditor.extensions.keyboardCommands(
                        ...
                        default:
                            ...
                            if (
                                MediumEditor.extensions.button.isBuiltInButton(
                                    name
                                )
                            ) {
                                if (opts) {
                                    ...
                                    extension =
                                        new MediumEditor.extensions.button(
                                            merged
                                        );
                                } else {
                                    extension =
                    ...
                    if (extension) {
                        this.extensions.push(
                            initExtension(extension, name, this)
                        );
                    }
                ...
                queryCommandState: function (action) {
                    ...
                    try {
                        queryState =
                            this.options.ownerDocument.queryCommandState(
                                action
                            );
                    } catch (exc) {
                        queryState = null;
                ...
                getSelectedParentElement: function (range) {
                    if (range === undefined) {
                        range = this.options.contentWindow
                            .getSelection()
                            .getRangeAt(0);
                    }
                    return MediumEditor.selection.getSelectedParentElement(
                        range
                    );
                },
                ...
                getFocusedElement: function () {
                    ...
                    this.elements.some(function (element) {
                        ...
                        if (
                            !focused &&
                            element.getAttribute("data-medium-focused")
                        ) {
                            focused = element;
                        }
                ...
                exportSelection: function () {
                    ...
                    if (selectionState !== null && editableElementIndex !== 0) {
                        selectionState.editableElementIndex =
                            editableElementIndex;
                    }
                                ...
                                if (
                                    ...
                                    if (currentEditor === parentElement) {
                                        ...
                                        MediumEditor.selection.select(
                                            ...
                                            parentElement.lastChild.nodeType ===
                                                3
                                                ? parentElement.lastChild
                                                      .nodeValue.length
                                                : parentElement.lastChild
                ...
                resetContent: function (element) {
                    ...
                    this.elements.forEach(function (el, idx) {
                        this.setContent(
                            initialContent[
                                el.getAttribute("medium-editor-index")
                            ],
                            idx
                        );
                    }, this);
            ...
            MediumEditor.getEditorFromElement = function (element) {
                var index = element.getAttribute(
                        "data-medium-editor-editor-index"
                    ),
                    win =
                        element &&
        ...
        MediumEditor.parseVersionString = function (release) {
            ...
            return {
                ...
                toString: function () {
                    return (
                        [version[0], version[1], version[2]].join(".") +
                        (preRelease ? "-" + preRelease : "")
                    );
                },
            };
