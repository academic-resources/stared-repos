var TableExtension = MediumEditor.extensions.anchor.extend({
    ...
    createForm: function () {
        ...
        columnInput.className =
            "medium-editor-toolbar-input medium-editor-toolbar-input-columns";
        ...
        rowInput.className =
            "medium-editor-toolbar-input medium-editor-toolbar-input-rows";
        ...
        save.innerHTML =
            this.base.options.buttonLabels === "fontawesome"
    ...
    getColumnsInput: function () {
        return this.getForm().querySelector(
            "input.medium-editor-toolbar-input-columns"
        );
    },

    getRowsInput: function () {
        return this.getForm().querySelector(
            "input.medium-editor-toolbar-input-rows"
        );
    },
});
