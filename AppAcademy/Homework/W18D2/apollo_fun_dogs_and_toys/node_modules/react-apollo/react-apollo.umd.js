(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('ts-invariant'), require('tslib'), require('apollo-client'), require('lodash.isequal'), require('hoist-non-react-statics')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'ts-invariant', 'tslib', 'apollo-client', 'lodash.isequal', 'hoist-non-react-statics'], factory) :
    ...
    var ApolloProvider = (function (_super) {
        tslib.__extends(ApolloProvider, _super);
    ...
    var Query = (function (_super) {
        ...
        function Query(props, context) {
            ...
            _this.getQueryResult = function () {
                ...
                if (_this.props.skip) {
                    data = tslib.__assign({}, data, { data: undefined, error: undefined, loading: false });
                }
                else {
        ...
        Query.prototype.fetchData = function () {
            if (this.props.skip)
                return false;
            var _a = this.props, children = _a.children, ssr = _a.ssr, displayName = _a.displayName, skip = _a.skip, client = _a.client, onCompleted = _a.onCompleted, onError = _a.onError, partialRefetch = _a.partialRefetch, opts = tslib.__rest(_a, ["children", "ssr", "displayName", "skip", "client", "onCompleted", "onError", "partialRefetch"]);
            ...
            var observable = this.client.watchQuery(tslib.__assign({}, opts, { fetchPolicy: fetchPolicy }));
    ...
    var Mutation = (function (_super) {
        ...
        function Mutation(props, context) {
            ...
            _this.mutate = function (options) {
                ...
                return _this.client.mutate(tslib.__assign({ mutation: mutation,
    ...
    function getMarkupFromTree(_a) {
        ...
        var RenderPromisesProvider = (function (_super) {
            tslib.__extends(RenderPromisesProvider, _super);
            function RenderPromisesProvider() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            RenderPromisesProvider.prototype.getChildContext = function () {
                return tslib.__assign({}, context, { renderPromises: renderPromises });
            };
