...
var ObservableQuery = (function (_super) {
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        if (!apollo_utilities_1.isEqual(this.variables, variables)) {
            this.variables = tslib_1.__assign({}, this.variables, variables);
        }
        if (!apollo_utilities_1.isEqual(this.options.variables, this.variables)) {
            this.options.variables = tslib_1.__assign({}, this.options.variables, this.variables);
        }
        return this.queryManager.fetchQuery(this.queryId, tslib_1.__assign({}, this.options, { fetchPolicy: fetchPolicy }), types_1.FetchType.refetch);
    };
    ObservableQuery.prototype.fetchMore = function (fetchMoreOptions) {
        ...
        var combinedOptions = tslib_1.__assign({}, (fetchMoreOptions.query ? fetchMoreOptions : tslib_1.__assign({}, this.options, fetchMoreOptions, { variables: tslib_1.__assign({}, this.variables, fetchMoreOptions.variables) })), { fetchPolicy: 'network-only' });
    ...
    ObservableQuery.prototype.setOptions = function (opts) {
        ...
        this.options = tslib_1.__assign({}, this.options, opts);
