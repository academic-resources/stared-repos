...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    var r = n(3),
      o = n(10),
      i = (n(2), n(48), Object.prototype.hasOwnProperty),
      a = n(49),
      ...
      _renderSubtreeIntoContainer: function (e, t, n, o) {
        ...
        if (c) {
          ...
          if (b(l, t)) {
            ...
            return L._updateRootComponent(c, s, i, n, f), p;
          }
        ...
        if (n) {
          ...
          for (var s in (n.hasOwnProperty(a) && l.mixins(e, n.mixins), n))
            if (n.hasOwnProperty(s) && s !== a) {
              ...
              if ((p(d, s), l.hasOwnProperty(s))) l[s](e, c);
              else {
                var f = u.hasOwnProperty(s);
                if ("function" != typeof c || f || d || !1 === n.autobind)
                  if (d) {
                    var v = u[s];
                    i(
  ...
  function (e, t, n) {
    ...
    var r = n(35),
      o = {
        processChildrenUpdates: n(113).dangerouslyProcessChildrenUpdates,
          ...
          for (r in t) {
            ...
            if (t.hasOwnProperty(r) && p !== d && (null != p || null != d))
              if ("style" === r)
                ...
                I.hasOwnProperty(r) || l.setValueForAttribute(T(this), r, p);
        ...
        updateComponent: function (e, t, n, o, i) {
          ...
          this._pendingForceUpdate ||
            (a.shouldComponentUpdate
              ...
              : this._compositeType === v && (d = !f(c, l) || !f(a.state, p))),
            (this._updateBatchNumber = null),
            d
              ? ((this._pendingForceUpdate = !1),
  ...
  function (e, t, n) {
        ...
        return (
          ...
          ((n =
            ...
            ("object" !== u(o) && "function" != typeof o)
              ? p(r)
              : o).state = { count: 0, previousCounts: [] }),
          (n.click = n.click.bind(p(n))),
          (n.reset = n.reset.bind(p(n))),
          n
        );
      }
      var n, r, i;
      return (
        ...
        (r = [
          ...
          },
          {
            ...
            value: function (e) {
              e.preventDefault();
              var t = this.state.previousCounts;
              t.push(this.state.count),
                this.setState({ count: 0, previousCounts: t });
            },
          },
          {
            key: "render",
            value: function () {
              return o.a.createElement(
                ...
                o.a.createElement("span", null, this.state.count),
                o.a.createElement("br", null),
                o.a.createElement("button", { onClick: this.reset }, "Reset!"),
                o.a.createElement(s, {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      a.a.render(o.a.createElement(f, null), e);
    });
  },
]);
