...
describe("Autolinker", function () {
	...
	describe("link() method", function () {
		var autolinker, twitterAutolinker;
		...
		describe("URL linking", function () {
			describe("protocol-prefixed URLs (i.e. URLs starting with http:// or https://)", function () {
				it("should automatically link URLs in the form of http://yahoo.com", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com">yahoo.com</a>'
					);
				});
				...
				it("should automatically link localhost URLs when there is a protocol", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://localhost">localhost</a> today'
					);
				});

				it("should automatically link localhost URLs when there is a protocol and port", function () {
					var result = autolinker.link(
						"Joe went to http://localhost:8000 today"
					);
					expect(result).toBe(
						'Joe went to <a href="http://localhost:8000">localhost:8000</a> today'
					);
				});

				it("should automatically link localhost URLs when there is a protocol, port, and path", function () {
					var result = autolinker.link(
						"Joe went to http://localhost:8000/abc today"
					);
					expect(result).toBe(
						'Joe went to <a href="http://localhost:8000/abc">localhost:8000/abc</a> today'
					);
				});
				...
				it("should not include [?!:,.;] chars if at the end of the URL", function () {
					var result1 = autolinker.link(
						"Joe went to http://localhost:8000? today"
					);
					expect(result1).toBe(
						'Joe went to <a href="http://localhost:8000">localhost:8000</a>? today'
					);
					var result2 = autolinker.link(
						"Joe went to http://localhost:8000! today"
					);
					expect(result2).toBe(
						'Joe went to <a href="http://localhost:8000">localhost:8000</a>! today'
					);
					var result3 = autolinker.link(
						"Joe went to http://localhost:8000: today"
					);
					expect(result3).toBe(
						'Joe went to <a href="http://localhost:8000">localhost:8000</a>: today'
					);
					var result4 = autolinker.link(
						"Joe went to http://localhost:8000, today"
					);
					expect(result4).toBe(
						'Joe went to <a href="http://localhost:8000">localhost:8000</a>, today'
					);
					var result5 = autolinker.link(
						"Joe went to http://localhost:8000. today"
					);
					expect(result5).toBe(
						'Joe went to <a href="http://localhost:8000">localhost:8000</a>. today'
					);
					var result6 = autolinker.link(
						"Joe went to http://localhost:8000; today"
					);
					expect(result6).toBe(
						'Joe went to <a href="http://localhost:8000">localhost:8000</a>; today'
				...
				it("should exclude invalid chars after TLD", function () {
					var result1 = autolinker.link(
						"Joe went to http://www.yahoo.com's today"
					);
					expect(result1).toBe(
						'Joe went to <a href="http://www.yahoo.com">yahoo.com</a>\'s today'
					);
					var result2 = autolinker.link(
						"Joe went to https://www.yahoo.com/foo's today"
					);
					expect(result2).toBe(
						"Joe went to <a href=\"https://www.yahoo.com/foo's\">yahoo.com/foo's</a> today"
					);
					var result3 = autolinker.link(
						"Joe went to http://www.yahoo.com's/foo today"
					);
					expect(result3).toBe(
						'Joe went to <a href="http://www.yahoo.com">yahoo.com</a>\'s/foo today'
					);
				});
				...
				it("should automatically link URLs in the form of http://www.yahoo.com (i.e. protocol and 'www' prefix)", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://www.yahoo.com">yahoo.com</a>'
					);
				});
				...
				it("should automatically link https URLs in the form of https://yahoo.com", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="https://www.yahoo.com">yahoo.com</a>'
					);
				});
				...
				it("should automatically link URLs with IP addresses and a port number", function () {
					...
					expect(result).toBe(
						'<a href="http://10.0.0.108:9000/">10.0.0.108:9000</a>'
					);
				});
				...
				it("should automatically link 'yahoo.xyz' (a known TLD), but not 'sencha.etc' (an unknown TLD)", function () {
					var result = autolinker.link(
						"yahoo.xyz should be linked, sencha.etc should not",
						{ newWindow: false }
					);
					expect(result).toBe(
				...
				it("should automatically link 'a.museum' (a known TLD), but not 'abc.123'", function () {
					var result = autolinker.link(
						"a.museum should be linked, but abc.123 should not",
						{ newWindow: false }
					);
					expect(result).toBe(
				...
				it("should automatically link URLs with a port number", function () {
					var result = autolinker.link(
						"Joe went to http://yahoo.com:8000 today."
					);
					expect(result).toBe(
				...
				it("should automatically link URLs with a port number and a path", function () {
					var result = autolinker.link(
						"Joe went to http://yahoo.com:8000/mysite/page today."
					);
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com:8000/mysite/page">yahoo.com:8000/mysite/page</a> today.'
					);
				});

				it("should automatically link a localhost URL with a port number and a path", function () {
					var result = autolinker.link(
						"Joe went to http://localhost:8000/my-page today."
					);
					expect(result).toBe(
						'Joe went to <a href="http://localhost:8000/my-page">localhost:8000/my-page</a> today.'
					);
				});

				it("should automatically link URLs with a port number and a query string", function () {
					var result = autolinker.link(
						"Joe went to http://yahoo.com:8000?page=index today."
					);
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com:8000?page=index">yahoo.com:8000?page=index</a> today.'
					);
				});

				it("should automatically link a localhost URL with a port number and a query string", function () {
					var result = autolinker.link(
						"Joe went to http://localhost:8000?page=index today."
					);
					expect(result).toBe(
						'Joe went to <a href="http://localhost:8000?page=index">localhost:8000?page=index</a> today.'
					);
				});
				...
				it("should automatically link domain names, paths, query strings, and hashes with numbers in them", function () {
					var result = autolinker.link(
						"Joe went to https://abc123def.org/path1/2path?param1=value1#hash123z"
					);
					expect(result).toBe(
						'Joe went to <a href="https://abc123def.org/path1/2path?param1=value1#hash123z">abc123def.org/path1/2path?param1=value1#hash123z</a>'
					);
				});

				it("should automatically link domain names, paths, query strings, and hashes with dashes in them", function () {
					var result = autolinker.link(
						"Joe went to https://abc-def.org/his-path/?the-param=the-value#the-hash"
					);
					expect(result).toBe(
						'Joe went to <a href="https://abc-def.org/his-path/?the-param=the-value#the-hash">abc-def.org/his-path/?the-param=the-value#the-hash</a>'
					);
				});
				...
				it("should automatically link domain names, paths, query strings, and hashes with the set of allowed special characters in them", function () {
					var result = autolinker.link(
						"Link: https://abc123def.org/-+&@#/%=~_()|'$*[]?!:,.;/?param1=value-+&@#/%=~_()|'$*[]?!:,.;#hash-+&@#/%=~_()|'$*[]?!:,.;z"
					);
					expect(result).toBe(
						"Link: <a href=\"https://abc123def.org/-+&@#/%=~_()|'$*[]?!:,.;/?param1=value-+&@#/%=~_()|'$*[]?!:,.;#hash-+&@#/%=~_()|'$*[]?!:,.;z\">abc123def.org/-+&@#/%=~_()|'$*[]?!:,.;/?param1=value-+&@#/%=~_()|'$*[]?!:,.;#hash-+&@#/%=~_()|'$*[]?!:,.;z</a>"
					);
				});
				...
				it("should match local urls with numbers when prefixed with http://", function () {
					...
					var result2 = autolinker.link(
						"http://suus111.w10:8090/display/test/AI"
					);
					expect(result2).toBe(
				...
				describe("protocol linking", function () {
					it("should NOT include preceding ':' introductions without a space", function () {
						...
						expect(result).toBe(
							'the link:<a href="http://example.com/">example.com</a>'
						);
					});
					...
					it("should autolink protocols with at least one character", function () {
						...
						expect(result).toBe(
							'link this: <a href="g://example.com/">g://example.com</a>'
						);
					});
					...
					it("should autolink protocols with more than 9 characters (as was the previous upper bound, but it seems protocols may be longer)", function () {
						var result = autolinker.link(
							"link this: opaquelocktoken://example"
						);
						expect(result).toBe(
					...
					it("should autolink protocols with digits, dashes, dots, and plus signs in their names", function () {
						...
						expect(result1).toBe(
							'link this: <a href="a1://example">a1://example</a>'
						);
						...
						expect(result3).toBe(
							'link this: <a href="iris.xpc://example">iris.xpc://example</a>'
						);
						...
						var result5 = autolinker.link(
							"link this: test+proto-col.123://example"
						);
						expect(result5).toBe(
					...
					it("should NOT autolink protocols that start with a digit, dash, plus sign, or dot, as per http://tools.ietf.org/html/rfc3986#section-3.1", function () {
						var result = autolinker.link(
							"do not link first char: 1a://example"
						);
						expect(result).toBe(
							'do not link first char: 1<a href="a://example">a://example</a>'
						);

						var result2 = autolinker.link(
							"do not link first char: -a://example"
						);
						expect(result2).toBe(
							'do not link first char: -<a href="a://example">a://example</a>'
						);
						...
						var result5 = autolinker.link(
							"do not link first char: .aa://example"
						);
						expect(result5).toBe(
					...
					it("should NOT autolink possible URLs with the 'javascript:' URI scheme", function () {
						var result = autolinker.link(
							"do not link javascript:window.alert('hi') please"
						);
						expect(result).toBe(
							"do not link javascript:window.alert('hi') please"
						);
					...
					it("should NOT autolink possible URLs with the 'vbscript:' URI scheme", function () {
						var result = autolinker.link(
							"do not link vbscript:window.alert('hi') please"
						);
						expect(result).toBe(
							"do not link vbscript:window.alert('hi') please"
						);
					...
					it("should NOT automatically link strings of the form 'git:d' (using the heuristic that the domain name does not have a '.' in it)", function () {
						var result = autolinker.link(
							"Something like git:d should not be linked as a URL"
						);
						expect(result).toBe(
							"Something like git:d should not be linked as a URL"
						);
					...
					it("should NOT automatically link these 'abc:def' style strings", function () {
						...
						for (i = 0; i < len; i++) {
							str = strings[i];
							expect(autolinker.link("test " + str + " test")).toBe(
								"test " + str + " test"
							); // none should be autolinked
						}
					});
				});
			});
			...
			describe("'www.' prefixed URLs", function () {
				...
				it("should automatically link URLs in the form of 'www.yahoo.com:8000' (with a port number)", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://www.yahoo.com:8000">yahoo.com:8000</a> today'
					);
				});

				it("should automatically link URLs in the form of 'www.yahoo.com:8000/abc' (with a port number and path)", function () {
					var result = autolinker.link(
						"Joe went to www.yahoo.com:8000/abc today"
					);
					expect(result).toBe(
						'Joe went to <a href="http://www.yahoo.com:8000/abc">yahoo.com:8000/abc</a> today'
					);
				});
				...
				it("should automatically link capitalized URLs", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://WWW.YAHOO.COM">YAHOO.COM</a> today'
					);
				});
				...
				it("should exclude invalid chars after TLD", function () {
					...
					var result2 = autolinker.link(
						"Joe went to www.yahoo.com/foo's today"
					);
					expect(result2).toBe(
						"Joe went to <a href=\"http://www.yahoo.com/foo's\">yahoo.com/foo's</a> today"
					);
					var result3 = autolinker.link(
						"Joe went to www.yahoo.com's/foo today"
					);
					expect(result3).toBe(
						'Joe went to <a href="http://www.yahoo.com">yahoo.com</a>\'s/foo today'
					);
				...
				it("should automatically link a URL with accented characters", function () {
					var result = autolinker.link(
						"Joe went to http://www.mañana.com today."
					);
					expect(result).toBe(
						'Joe went to <a href="http://www.mañana.com">mañana.com</a> today.'
					);
				});
			});
			...
			describe("URLs with no protocol prefix, and no 'www' (i.e. URLs with known TLDs)", function () {
				...
				it("should automatically link URLs in the form of yahoo.co.uk, prepending the http:// in this case", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.co.uk">yahoo.co.uk</a>'
					);
				});
				...
				it("should automatically link URLs in the form of yahoo.ru, prepending the http:// in this case", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.ru">yahoo.ru</a>'
					);
				});
				...
				it("should not include [?!:,.;] chars if at the end of the URL", function () {
					...
					expect(result1).toBe(
						'Joe went to <a href="http://yahoo.com">yahoo.com</a>? today'
					);
				...
				it("should exclude invalid chars after TLD", function () {
					...
					expect(result1).toBe(
						'Joe went to <a href="http://yahoo.com">yahoo.com</a>\'s today'
					);
				...
				it("should automatically link a URL with accented characters", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://mañana.com">mañana.com</a> today.'
					);
				});
			});
			...
			describe("protocol-relative URLs (i.e. URLs starting with only '//')", function () {
				...
				it("should automatically link protocol-relative URLs in the form of //yahoo.com in the middle of the string", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="//yahoo.com">yahoo.com</a> yesterday'
					);
				});
				...
				it("should automatically link protocol-relative URLs in the form of //yahoo.com at the end of the string", function () {
					var result = autolinker.link("Joe went to //yahoo.com");
					expect(result).toBe(
						'Joe went to <a href="//yahoo.com">yahoo.com</a>'
					);
				});
				...
				it("should automatically link supposed protocol-relative URLs as long as the character before the '//' is a non-word character", function () {
					...
					expect(result).toBe(
						'Joe went to abc-<a href="//yahoo.com">yahoo.com</a>'
					);
				});
			});
			...
			describe("parenthesis handling", function () {
				it("should include parentheses in URLs", function () {
					var result = autolinker.link(
						"TLDs come from en.wikipedia.org/wiki/IANA_(disambiguation)."
					);
					expect(result).toBe(
						'TLDs come from <a href="http://en.wikipedia.org/wiki/IANA_(disambiguation)">en.wikipedia.org/wiki/IANA_(disambiguation)</a>.'
					);

					result = autolinker.link(
						"MSDN has a great article at http://msdn.microsoft.com/en-us/library/aa752574(VS.85).aspx."
					);
					expect(result).toBe(
						'MSDN has a great article at <a href="http://msdn.microsoft.com/en-us/library/aa752574(VS.85).aspx">msdn.microsoft.com/en-us/library/aa752574(VS.85).aspx</a>.'
					);
				});
				...
				it("should not include a final closing paren in the URL, if it doesn't match an opening paren in the url", function () {
					var result = autolinker.link(
						"Click here (google.com) for more details"
					);
					expect(result).toBe(
						'Click here (<a href="http://google.com">google.com</a>) for more details'
					);
				});

				it("should not include a final closing paren in the URL when a path exists", function () {
					var result = autolinker.link(
						"Click here (google.com/abc) for more details"
					);
					expect(result).toBe(
						'Click here (<a href="http://google.com/abc">google.com/abc</a>) for more details'
					);
				});

				it("should not include a final closing paren in the URL when a query string exists", function () {
					var result = autolinker.link(
						"Click here (google.com?abc=1) for more details"
					);
					expect(result).toBe(
						'Click here (<a href="http://google.com?abc=1">google.com?abc=1</a>) for more details'
					);
				});
			...
			describe("Special character handling", function () {
				...
				it("should include ' in URLs with query strings", function () {
					var result = autolinker.link(
						"Test google search https://www.google.com/#q=test's"
					);
					expect(result).toBe(
						"Test google search <a href=\"https://www.google.com/#q=test's\">google.com/#q=test's</a>"
					);
				});
				...
				it("should HTML-encode escape-encoded special characters", function () {
					var result = autolinker.link(
						"Link: http://example.com/%3c%3E%22%27%26"
					);
			...
			describe("URL path, query string, and hash handling", function () {
				it("should automatically link URLs in the form of yahoo.com/path/to/file.html, handling the path", function () {
					var result = autolinker.link(
						"Joe went to yahoo.com/path/to/file.html"
					);
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com/path/to/file.html">yahoo.com/path/to/file.html</a>'
					);
				});
				...
				it("should automatically link URLs in the form of yahoo.com?hi=1, handling the query string", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com?hi=1">yahoo.com?hi=1</a>'
					);
				});
				...
				it("should automatically link URLs in the form of yahoo.com#index1, handling the hash", function () {
					...
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com#index1">yahoo.com#index1</a>'
					);
				});
				...
				it("should automatically link URLs in the form of yahoo.com/path/to/file.html?hi=1, handling the path and the query string", function () {
					var result = autolinker.link(
						"Joe went to yahoo.com/path/to/file.html?hi=1"
					);
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com/path/to/file.html?hi=1">yahoo.com/path/to/file.html?hi=1</a>'
					);
				});
				...
				it("should automatically link URLs in the form of yahoo.com/path/to/file.html#index1, handling the path and the hash", function () {
					var result = autolinker.link(
						"Joe went to yahoo.com/path/to/file.html#index1"
					);
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com/path/to/file.html#index1">yahoo.com/path/to/file.html#index1</a>'
					);
				});
				...
				it("should automatically link URLs in the form of yahoo.com/path/to/file.html?hi=1#index1, handling the path, query string, and hash", function () {
					var result = autolinker.link(
						"Joe went to yahoo.com/path/to/file.html?hi=1#index1"
					);
					expect(result).toBe(
						'Joe went to <a href="http://yahoo.com/path/to/file.html?hi=1#index1">yahoo.com/path/to/file.html?hi=1#index1</a>'
					);
				});

				it("should automatically link a URL with a complex hash (such as a Google Analytics url)", function () {
					var result = autolinker.link(
						"Joe went to https://www.google.com/analytics/web/?pli=1#my-reports/Obif-Y6qQB2xAJk0ZZE1Zg/a4454143w36378534p43704543/%3F.date00%3D20120314%26_.date01%3D20120314%268534-table.rowStart%3D0%268534-table.rowCount%3D25/ and analyzed his analytics"
					);
					expect(result).toBe(
						'Joe went to <a href="https://www.google.com/analytics/web/?pli=1#my-reports/Obif-Y6qQB2xAJk0ZZE1Zg/a4454143w36378534p43704543/%3F.date00%3D20120314%26_.date01%3D20120314%268534-table.rowStart%3D0%268534-table.rowCount%3D25/">google.com/analytics/web/?pli=1#my-reports/Obif-Y6qQB2xAJk0ZZE1Zg/a4454143w36378534p43704543/?.date00=20120314&amp;_.date01=20120314&amp;8534-table.rowStart=0&amp;8534-table.rowCount=25</a> and analyzed his analytics'
					);
				});
			...
			it("should automatically link multiple URLs in the same input string", function () {
				var result = autolinker.link(
					"Joe went to http://yahoo.com and http://google.com"
				);
				expect(result).toBe(
					'Joe went to <a href="http://yahoo.com">yahoo.com</a> and <a href="http://google.com">google.com</a>'
				);
			});
		});
		...
		describe("email address linking", function () {
			...
			it("should automatically link email addresses at the start of the string", function () {
				...
				expect(result).toBe(
					'<a href="mailto:joe@joe.com">joe@joe.com</a> is Joe\'s email'
				);
			});
			...
			it("should automatically link an email address in the middle of the string", function () {
				...
				expect(result).toBe(
					'Joe\'s email is <a href="mailto:joe@joe.com">joe@joe.com</a> because it is'
				);
			});
			...
			it("should automatically link email addresses at the end of the string", function () {
				...
				expect(result).toBe(
					'Joe\'s email is <a href="mailto:joe@joe.com">joe@joe.com</a>'
				);
			});
			...
			it("should automatically link email addresses with a period in the 'local part'", function () {
				...
				expect(result).toBe(
					'Joe\'s email is <a href="mailto:joe.smith@joe.com">joe.smith@joe.com</a>'
				);
			});
			...
			it("should properly link an email address with underscores", function () {
				...
				expect(result).toBe(
					'Joe\'s email is (<a href="mailto:joe_roe@joe.com">joe_roe@joe.com</a>)'
				);
			});
			...
			it("should properly link an email address with an apostrophe", function () {
				...
				expect(result).toBe(
					"Joe's email is (<a href=\"mailto:joe'roe@joe.com\">joe'roe@joe.com</a>)"
				);
			});
			...
			it("should automatically link an email address with accented characters", function () {
				...
				expect(result).toBe(
					'Joe\'s email is <a href="mailto:mañana@mañana.com">mañana@mañana.com</a>'
				);
			});
			...
			it("should automatically link an email address with cyrillic characters", function () {
				...
				expect(result).toBe(
					'Joe\'s email is <a href="mailto:Кириллица@Кириллица.com">Кириллица@Кириллица.com</a>'
				);
			});
		...
		describe("mention linking", function () {
			...
			it("should automatically link a twitter handle with underscores in it", function () {
				...
				expect(result).toBe(
					'<a href="https://twitter.com/joe_the_man12">@joe_the_man12</a>'
				);
			});
			...
			it("should automatically link twitter handles at the beginning of a string", function () {
				...
				expect(result).toBe(
					'<a href="https://twitter.com/greg">@greg</a> is my twitter handle'
				);
			});

			it("should automatically link twitter handles in the middle of a string", function () {
				var result = twitterAutolinker.link(
					"Joe's twitter is @joe_the_man12 today, but what will it be tomorrow?"
				);
				expect(result).toBe(
					'Joe\'s twitter is <a href="https://twitter.com/joe_the_man12">@joe_the_man12</a> today, but what will it be tomorrow?'
				);
			});
			...
			it("should automatically link twitter handles at the end of a string", function () {
				...
				expect(result).toBe(
					'Joe\'s twitter is <a href="https://twitter.com/joe_the_man12">@joe_the_man12</a>'
				);
			});

			it("should automatically link twitter handles surrounded by parentheses", function () {
				var result = twitterAutolinker.link(
					"Joe's twitter is (@joe_the_man12)"
				);
				expect(result).toBe(
					'Joe\'s twitter is (<a href="https://twitter.com/joe_the_man12">@joe_the_man12</a>)'
				);
			...
			it("should automatically link multiple twitter handles in a string", function () {
				var result = twitterAutolinker.link(
					"@greg is tweeting @joe with @josh"
				);
				expect(result).toBe(
			...
			it("should automatically link username handles with accented characters", function () {
				...
				expect(result).toBe(
					'Hello <a href="https://twitter.com/mañana">@mañana</a> how are you?'
				);
			});
			...
			it("should automatically link username handles with cyrillic characters", function () {
				...
				expect(result).toBe(
					'Hello <a href="https://twitter.com/Кириллица">@Кириллица</a> how are you?'
				);
			});
		...
		describe("phone number linking", function () {
			...
			it("should automatically link a phone number contained in a larger string", function () {
				var result = autolinker.link(
					"Here's my number: (555)666-7777, so call me maybe?"
				);
				expect(result).toBe(
		...
		describe("hashtag linking", function () {
			...
			beforeEach(function () {
				twitterHashtagAutolinker = new Autolinker({
					hashtag: "twitter",
					newWindow: false,
				});
				facebookHashtagAutolinker = new Autolinker({
					hashtag: "facebook",
					newWindow: false,
				});
				instagramHashtagAutolinker = new Autolinker({
					hashtag: "instagram",
					newWindow: false,
				});
			});
			...
			it("should automatically link hashtags to facebook when the `hashtag` option is 'facebook'", function () {
				...
				expect(result).toBe(
					'<a href="https://www.facebook.com/hashtag/test">#test</a>'
				);
			});
			...
			it("should automatically link hashtags to instagram when the `hashtag` option is 'instagram'", function () {
				...
				expect(result).toBe(
					'<a href="https://instagram.com/explore/tags/test">#test</a>'
				);
			});

			it("should automatically link hashtags which are part of a full string", function () {
				var result = twitterHashtagAutolinker.link(
					"my hashtag is #test these days"
				);

				expect(result).toBe(
					'my hashtag is <a href="https://twitter.com/hashtag/test">#test</a> these days'
				);
			});
			...
			it("should automatically link hashtags that are longer than 15 chars (original version of hashtag implementation limited to 15 chars, now it's at 139 chars)", function () {
				var result = twitterHashtagAutolinker.link(
					"my hashtag is #AHashtagThatIsWorthyOfMordorAndStuff these days"
				);

				expect(result).toBe(
					'my hashtag is <a href="https://twitter.com/hashtag/AHashtagThatIsWorthyOfMordorAndStuff">#AHashtagThatIsWorthyOfMordorAndStuff</a> these days'
				);
			});
			...
			it("should automatically link a hashtag with underscores", function () {
				...
				expect(result).toBe(
					'Yay, <a href="https://twitter.com/hashtag/hello_world">#hello_world</a>'
				);
			});
			...
			it("should automatically link a hashtag with accented characters", function () {
				...
				expect(result).toBe(
					'Yay, <a href="https://twitter.com/hashtag/mañana">#mañana</a>'
				);
			});
			...
			it("should automatically link a hashtag with cyrillic characters", function () {
				...
				expect(result).toBe(
					'Yay, <a href="https://twitter.com/hashtag/Кириллица">#Кириллица</a>'
				);
			});
			...
			it("should NOT automatically link a hashtag that is actually a named anchor within a URL **when URL linking is turned off**", function () {
				var noUrlTwitterHashtagAutolinker = new Autolinker({
						urls: false,
						hashtag: "twitter",
						newWindow: false,
					}),
					result = noUrlTwitterHashtagAutolinker.link(
		...
		describe("mention linking", function () {
			var twitterMentionAutolinker, instagramMentionAutolinker;

			beforeEach(function () {
				twitterMentionAutolinker = new Autolinker({
					mention: "twitter",
					newWindow: false,
				});
				instagramMentionAutolinker = new Autolinker({
					mention: "instagram",
					newWindow: false,
				});
			});
			...
			it("should automatically link mentions which are part of a full string", function () {
				var result = twitterMentionAutolinker.link(
					"my handle is @test these days"
				);

				expect(result).toBe(
					'my handle is <a href="https://twitter.com/test">@test</a> these days'
				);
			});
			...
			it("should automatically link a mention with underscores", function () {
				...
				expect(result).toBe(
					'Yay, <a href="https://twitter.com/hello_world">@hello_world</a>'
				);
			});
			...
			it("should NOT automatically link a mention that is actually part of an email address **when email address linking is turned off**", function () {
				var noUsernameAutolinker = new Autolinker({
						email: false,
						mention: "twitter",
						newWindow: false,
					}),
		...
		describe("proper handling of HTML in the input string", function () {
			...
			it("should handle &nbsp; after a url and not treat it as a query string", function () {
				var html =
					"<p>Joe went to yahoo.com&nbsp;and google.com&nbsp;today</p>";
		...
		describe("`stripPrefix` option", function () {
			...
			it("should leave the original text as-is when the `stripPrefix` option is `false`", function () {
				var result1 = Autolinker.link("My url.com", {
					stripPrefix: false,
					newWindow: false,
				});
				expect(result1).toBe('My <a href="http://url.com">url.com</a>');

				var result2 = Autolinker.link("My www.url.com", {
					stripPrefix: false,
					newWindow: false,
				});
				expect(result2).toBe('My <a href="http://www.url.com">www.url.com</a>');

				var result3 = Autolinker.link("My http://url.com", {
					stripPrefix: false,
					newWindow: false,
				});
				expect(result3).toBe('My <a href="http://url.com">http://url.com</a>');

				var result4 = Autolinker.link("My http://www.url.com", {
					stripPrefix: false,
					newWindow: false,
				});
				expect(result4).toBe(
					'My <a href="http://www.url.com">http://www.url.com</a>'
				);
			});
			...
			it(
				...
				function () {
					...
					expect(result).toBe(
						'Test <a href="http://www.url.com">www.url.com</a>'
					);
				}
			);
			...
			it(
				...
				function () {
					...
					expect(result).toBe(
						'Test <a href="http://www.url.com">http://url.com</a>'
					);
				}
			);
			...
			it(
				...
				function () {
					...
					expect(result).toBe(
						'Test <a href="http://url.com">http://url.com</a>'
					);
				}
			);
		...
		describe("`stripTrailingSlash` option", function () {
			...
			it(
				"when provided as `false`, should not remove (i.e. retain) the " +
					"trailing slash",
				function () {
					var result = Autolinker.link("http://google.com/", {
						stripPrefix: false,
		...
		describe("`className` option", function () {
			...
			it("should add className to email links", function () {
				var result = Autolinker.link("Iggy's email is mr@iggypop.com", {
					newWindow: false,
					email: true,
					className: "myLink",
				});
			...
			it("should add className to twitter links", function () {
				var result = Autolinker.link("hi from @iggypopschest", {
					newWindow: false,
					mention: "twitter",
					className: "myLink",
				});
		...
		describe("`replaceFn` option", function () {
			...
			it("should populate an EmailMatch object with the appropriate properties", function () {
				var replaceFnCallCount = 0;
				var result = Autolinker.link("Email: asdf@asdf.com ", {
					// purposeful trailing space
					replaceFn: function (match) {
						replaceFnCallCount++;
			...
			it("should populate a HashtagMatch object with the appropriate properties", function () {
				var replaceFnCallCount = 0;
				var result = Autolinker.link("Hashtag: #myHashtag ", {
					// purposeful trailing space
					hashtag: "twitter",
					replaceFn: function (match) {
						replaceFnCallCount++;
			...
			it("should populate a TwitterMatch object with the appropriate properties", function () {
				var replaceFnCallCount = 0;
				var result = Autolinker.link("Twitter: @myTwitter ", {
					// purposeful trailing space
					mention: "twitter",
					replaceFn: function (match) {
						replaceFnCallCount++;
			...
			it("should populate a MentionMatch object with the appropriate properties", function () {
				var replaceFnCallCount = 0;
				var result = Autolinker.link("Mention: @myTwitter ", {
					// purposeful trailing space
					mention: "twitter",
					replaceFn: function (match) {
						replaceFnCallCount++;
			...
			it("should replace the match as Autolinker would normally do when `true` is returned from the `replaceFn`", function () {
				var result = Autolinker.link(
					"Website: asdf.com, Email: asdf@asdf.com, Twitter: @asdf",
					{
						mention: "twitter",
			...
			it("should leave the match as-is when `false` is returned from the `replaceFn`", function () {
				...
				expect(result).toBe(
					["Website: asdf.com", "Email: asdf@asdf.com", "Twitter: @asdf"].join(
						", "
					)
				);
			});
			...
			describe("special cases which check the `prefixStr` and `suffixStr` vars in the code", function () {
				it("should leave the match as-is when the `replaceFn` returns `false` for a Twitter match", function () {
					...
					var result2 = Autolinker.link("Twitter: @asdf", {
						mention: "twitter",
						replaceFn: returnFalseFn,
					});
				...
				it("should leave the match as-is when the `replaceFn` returns `false`, and the URL was wrapped in parenthesis", function () {
					var result = Autolinker.link("Go to (yahoo.com) my friend", {
						replaceFn: returnFalseFn,
					});
	...
	describe("all match types tests", function () {
		var testCases = {
			schemeUrl: {
				...
				linked:
					'<a href="http://google.com/path?param1=value1&param2=value2#hash">http://google.com/path?param1=value1&param2=value2#hash</a>',
			},
			wwwUrl: {
				unlinked: "www.google.com/path?param1=value1&param2=value2#hash",
				linked:
					'<a href="http://www.google.com/path?param1=value1&param2=value2#hash">www.google.com/path?param1=value1&param2=value2#hash</a>',
			},
			tldUrl: {
				unlinked: "google.com/path?param1=value1&param2=value2#hash",
				linked:
					'<a href="http://google.com/path?param1=value1&param2=value2#hash">google.com/path?param1=value1&param2=value2#hash</a>',
			},
			email: {
		...
		it("should replace matches appropriately in a paragraph of text, using a variety of enabled matchers. Want to make sure that when one match type is disabled (such as emails), that other ones don't accidentally link part of them (such as from the url matcher)", function () {
			...
			function generateExpectedLines(cfg) {
				var expectedLines = paragraphTpl({
					...
					wwwUrl: cfg.wwwMatches
						? testCases.wwwUrl.linked
						: testCases.wwwUrl.unlinked,
	...
	describe("static parse()", function () {
		...
		describe("custom Phone.prototype.matcherRegex", function () {
			const matcherRegexOriginal =
				Autolinker.matcher.Phone.prototype.matcherRegex;

			beforeEach(function () {
				const phoneInTextRegex = /(\+?852\-?)?[569]\d{3}\-?\d{4}/g;
				Autolinker.matcher.Phone.prototype.matcherRegex = phoneInTextRegex;
				Autolinker.matcher.Phone.prototype.testMatch = function () {
					return true;
				};
			});
