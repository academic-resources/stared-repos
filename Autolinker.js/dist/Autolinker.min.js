	...
	var e = function (t) {
		(t = t || {}),
			...
			(this.decodePercentEncoding =
				"boolean" != typeof t.decodePercentEncoding || t.decodePercentEncoding);
		var r = this.mention;
	...
	return (
		...
		(e.prototype = {
			...
			parse: function (e) {
				for (
					...
					if ("element" === c && "a" === o.getTagName())
						...
						var h = this.parseText(o.getText(), o.getOffset());
						a.push.apply(a, h);
					}
				}
				return (
			...
			getMatchers: function () {
				...
				var t = e.matcher,
					...
					n = [
						new t.Hashtag({ tagBuilder: r, serviceName: this.hashtag }),
						new t.Email({ tagBuilder: r }),
						new t.Phone({ tagBuilder: r }),
						new t.Mention({ tagBuilder: r, serviceName: this.mention }),
						new t.Url({
							tagBuilder: r,
		...
		(e.RegexLib = (function () {
			var e =
				...
				s = function (e) {
					return "(?:" + i(e) + "(?:\\." + i(e + 1) + "){0,126}|" + n + ")";
				};
			return { alphaNumericCharsStr: r, alphaCharsStr: e, getDomainNameStr: s };
		})()),
			...
			parse: function (e) {
				for (
					...
					var s = t[0],
						...
						l = t.index,
						u = e.substring(a, l);
					u && ((r = this.parseTextAndEntityNodes(a, u)), i.push.apply(i, r)),
						o
		...
		(e.match.Url = e.Util.extend(e.match.Match, {
			constructor: function (t) {
				e.match.Match.prototype.constructor.call(this, t),
					...
					(this.decodePercentEncoding = t.decodePercentEncoding);
			},
		...
		(e.matcher.Email = e.Util.extend(e.matcher.Matcher, {
			matcherRegex: (function () {
				var t = e.RegexLib.alphaNumericCharsStr,
					...
					o = e.RegexLib.getDomainNameStr,
					c = e.tldRegex;
				return new RegExp([s.source, o(1), "\\.", c.source].join(""), "gi");
			})(),
		...
		(e.matcher.Url = e.Util.extend(e.matcher.Matcher, {
			...
			parseMatches: function (t) {
				for (
					...
					var h = r[0],
						...
						p = t.charAt(f - 1);
					if (
						e.matcher.UrlMatchValidator.isValid(h, l) &&
						!(
							(f > 0 && "@" === p) ||
							(f > 0 && d && this.wordCharRegExp.test(p))
						)
					) {
						if (
							(/\?$/.test(h) && (h = h.substr(0, h.length - 1)),
							this.matchHasUnbalancedClosingParen(h))
						)
							h = h.substr(0, h.length - 1);
						else {
							var x = this.matchHasInvalidCharAfterTld(h, l);
							x > -1 && (h = h.substr(0, x));
						}
			...
			matchHasUnbalancedClosingParen: function (e) {
				...
				if (")" === t) {
					var r = e.match(this.openParensRe),
			...
			matchHasInvalidCharAfterTld: function (t, r) {
				...
				var a = e.RegexLib.alphaNumericCharsStr,
					i = new RegExp(
						"^((.?//)?[-." + a + "]*[-" + a + "]\\.[-" + a + "]+)"
					),
					s = i.exec(t);
		...
		(e.truncate.TruncateSmart = function (e, t, r) {
			...
			if (h.fragment) {
				...
				if ((u + f).length >= c) {
					...
					var d = c - u.length;
					return (u + o(f, d)).substr(0, c + n);
				}
				u += f;
			}
			if (h.scheme && h.host) {
				var p = h.scheme + "://";
				if ((u + p).length < c) return (p + u).substr(0, t);
			}
