Ext.data.JsonP.Autolinker_htmlParser_CommentNode({
	tagname: "class",
	name: "Autolinker.htmlParser.CommentNode",
	autodetected: {},
	files: [
		{
			filename: "CommentNode.js",
			href: "CommentNode.html#Autolinker-htmlParser-CommentNode",
		},
	],
	...
	members: [
		{
			name: "comment",
			tagname: "cfg",
			owner: "Autolinker.htmlParser.CommentNode",
			id: "cfg-comment",
			meta: { required: true },
		},
		{
	...
	alternateClassNames: [],
	aliases: {},
	id: "class-Autolinker.htmlParser.CommentNode",
	short_doc:
		"Represents an HTML comment node that has been parsed by the\nAutolinker.htmlParser.HtmlParser. ...",
	component: false,
	superclasses: ["Autolinker.htmlParser.HtmlNode"],
	subclasses: [],
	mixedInto: [],
	mixins: [],
	parentMixins: [],
