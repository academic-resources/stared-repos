Ext.data.JsonP.Autolinker_match_Match({
	tagname: "class",
	name: "Autolinker.match.Match",
	autodetected: {},
	files: [{ filename: "Match.js", href: "Match.html#Autolinker-match-Match" }],
	abstract: true,
	members: [
		{
			name: "matchedText",
	...
	alternateClassNames: [],
	aliases: {},
	id: "class-Autolinker.match.Match",
	short_doc:
		"Represents a match found in an input string which should be Autolinked. ...",
	component: false,
	superclasses: [],
	subclasses: [
		"Autolinker.match.Email",
		"Autolinker.match.Hashtag",
		"Autolinker.match.Mention",
		"Autolinker.match.Phone",
		"Autolinker.match.Url",
	],
	mixedInto: [],
	mixins: [],
	parentMixins: [],
