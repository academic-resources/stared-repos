Ext.data.JsonP.Autolinker_matcher_Email({
	...
	autodetected: {},
	files: [
		{ filename: "Email.js", href: "Email2.html#Autolinker-matcher-Email" },
	],
	...
	members: [
		{
			name: "tagBuilder",
			tagname: "cfg",
			owner: "Autolinker.matcher.Matcher",
			id: "cfg-tagBuilder",
			meta: { required: true },
		},
		{
			name: "matcherRegex",
			tagname: "property",
			owner: "Autolinker.matcher.Email",
			id: "property-matcherRegex",
			meta: { private: true },
		},
		{
			name: "constructor",
		...
		},
		{
			...
			tagname: "method",
			owner: "Autolinker.matcher.Email",
			id: "method-parseMatches",
			meta: {},
		},
	],
	alternateClassNames: [],
	aliases: {},
	id: "class-Autolinker.matcher.Email",
	short_doc: "Matcher to find email matches in an input string. ...",
	component: false,
	superclasses: ["Autolinker.matcher.Matcher"],
	subclasses: [],
	mixedInto: [],
	mixins: [],
	parentMixins: [],
