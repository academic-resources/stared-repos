Ext.data.JsonP.Autolinker_htmlParser_HtmlNode({
	tagname: "class",
	name: "Autolinker.htmlParser.HtmlNode",
	autodetected: {},
	files: [
		{
			filename: "HtmlNode.js",
			href: "HtmlNode.html#Autolinker-htmlParser-HtmlNode",
		},
	],
	abstract: true,
	members: [
		{
			name: "offset",
			tagname: "cfg",
			owner: "Autolinker.htmlParser.HtmlNode",
			id: "cfg-offset",
			meta: { required: true },
		},
		{
	...
	alternateClassNames: [],
	aliases: {},
	id: "class-Autolinker.htmlParser.HtmlNode",
	short_doc: "Represents an HTML node found in an input string. ...",
	component: false,
	superclasses: [],
	subclasses: [
		"Autolinker.htmlParser.CommentNode",
		"Autolinker.htmlParser.ElementNode",
		"Autolinker.htmlParser.EntityNode",
		"Autolinker.htmlParser.TextNode",
	],
	mixedInto: [],
	mixins: [],
	parentMixins: [],
