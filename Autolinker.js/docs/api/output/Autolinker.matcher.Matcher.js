Ext.data.JsonP.Autolinker_matcher_Matcher({
	tagname: "class",
	name: "Autolinker.matcher.Matcher",
	autodetected: {},
	files: [
		{ filename: "Matcher.js", href: "Matcher.html#Autolinker-matcher-Matcher" },
	],
	abstract: true,
	members: [
		{
	...
	alternateClassNames: [],
	aliases: {},
	id: "class-Autolinker.matcher.Matcher",
	short_doc:
		"An abstract class and interface for individual matchers to find matches in\nan input string with linkified versions of...",
	component: false,
	superclasses: [],
	subclasses: [
		"Autolinker.matcher.Email",
		"Autolinker.matcher.Hashtag",
		"Autolinker.matcher.Mention",
		"Autolinker.matcher.Phone",
		"Autolinker.matcher.Url",
	],
	mixedInto: [],
	mixins: [],
	parentMixins: [],
