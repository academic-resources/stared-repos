...
(function (LiveExample) {
	...
	var Option = (function () {
		...
		Option.prototype.getApiDocLink = function () {
			...
			return (
				"http://gregjacobs.github.io/Autolinker.js/api/#!/api/Autolinker-cfg-" +
				configName
			);
		};
		/**
...
(function (LiveExample) {
	...
	var RadioOption = (function (_super) {
		...
		RadioOption.prototype.createRadiosHtml = function (options, defaultValue) {
			...
			return options.map(function (option, idx) {
				return (
					...
					'" name="' +
					_this.containerId +
					'-radio" data-option-idx="' +
					idx +
					'" ' +
					(option === _this.defaultValue ? "checked" : "") +
					'> \n\t\t\t\t\t<label for="' +
					_this.containerId +
					"-radio-" +
					option +
		...
		RadioOption.prototype.getValue = function () {
			var optionIdx = this.$containerEl
				.find(":radio:checked")
				.data("option-idx");
...
$(document).ready(function () {
	...
	function init() {
		...
		mentionOption = new RadioOption({
			...
			options: [false, "twitter", "instagram"],
			defaultValue: false,
		}).onChange(autolink);
		hashtagOption = new RadioOption({
			name: "hashtag",
			description: "Hashtags",
			options: [false, "twitter", "facebook", "instagram"],
			defaultValue: false,
		}).onChange(autolink);
